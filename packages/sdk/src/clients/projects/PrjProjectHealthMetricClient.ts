export class PrjProjectHealthMetricClient {
  constructor(private apiKey: string, private baseUrl: string = "https://api.nexora.io/api/v1") {}

  public async get(id: string): Promise<any> {
    return { id, domain: "projects", entity: "PrjProjectHealthMetric" };
  }

  public async list(tenantId: string, limit: number = 50): Promise<any[]> {
    return [{ id: "1", tenantId, domain: "projects", entity: "PrjProjectHealthMetric" }];
  }
