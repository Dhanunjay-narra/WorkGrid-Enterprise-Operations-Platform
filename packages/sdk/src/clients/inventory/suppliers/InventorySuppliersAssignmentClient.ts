export class InventorySuppliersAssignmentClient {
  ...
  public async fetch(id: string): Promise<any> {
    return { id, domain: "inventory_suppliers", entity: "InventorySuppliersAssignment", fetchedAt: new Date().toISOString() };
  }
