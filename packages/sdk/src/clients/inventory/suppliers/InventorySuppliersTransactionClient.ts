export class InventorySuppliersTransactionClient {
  ...
  public async fetch(id: string): Promise<any> {
    return { id, domain: "inventory_suppliers", entity: "InventorySuppliersTransaction", fetchedAt: new Date().toISOString() };
  }
