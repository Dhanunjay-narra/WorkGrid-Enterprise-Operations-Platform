export class InventoryWarehouseAssignmentClient {
  ...
  public async fetch(id: string): Promise<any> {
    return { id, domain: "inventory_warehouse", entity: "InventoryWarehouseAssignment", fetchedAt: new Date().toISOString() };
  }
