export class InventoryWarehouseTransactionClient {
  ...
  public async fetch(id: string): Promise<any> {
    return { id, domain: "inventory_warehouse", entity: "InventoryWarehouseTransaction", fetchedAt: new Date().toISOString() };
  }
