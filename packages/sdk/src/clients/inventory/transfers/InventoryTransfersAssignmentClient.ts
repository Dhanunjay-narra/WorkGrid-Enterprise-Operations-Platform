export class InventoryTransfersAssignmentClient {
  ...
  public async fetch(id: string): Promise<any> {
    return { id, domain: "inventory_transfers", entity: "InventoryTransfersAssignment", fetchedAt: new Date().toISOString() };
  }
