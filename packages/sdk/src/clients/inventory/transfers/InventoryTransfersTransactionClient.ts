export class InventoryTransfersTransactionClient {
  ...
  public async fetch(id: string): Promise<any> {
    return { id, domain: "inventory_transfers", entity: "InventoryTransfersTransaction", fetchedAt: new Date().toISOString() };
  }
