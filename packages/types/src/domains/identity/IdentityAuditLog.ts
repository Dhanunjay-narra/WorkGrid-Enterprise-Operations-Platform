export interface IdentityAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityAuditLogValidator {
  public static validate(data: Partial<IdentityAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
