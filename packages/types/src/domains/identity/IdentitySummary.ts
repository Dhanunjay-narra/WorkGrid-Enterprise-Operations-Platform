export interface IdentitySummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentitySummaryValidator {
  public static validate(data: Partial<IdentitySummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
