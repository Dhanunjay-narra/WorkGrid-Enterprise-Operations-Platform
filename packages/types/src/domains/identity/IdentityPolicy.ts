export interface IdentityPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityPolicyValidator {
  public static validate(data: Partial<IdentityPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
