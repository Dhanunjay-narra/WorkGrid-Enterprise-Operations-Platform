export interface IdentityBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityBatchValidator {
  public static validate(data: Partial<IdentityBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
