export interface IdentityAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityAssignmentValidator {
  public static validate(data: Partial<IdentityAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
