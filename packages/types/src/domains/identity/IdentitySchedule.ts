export interface IdentityScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityScheduleValidator {
  public static validate(data: Partial<IdentityScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
