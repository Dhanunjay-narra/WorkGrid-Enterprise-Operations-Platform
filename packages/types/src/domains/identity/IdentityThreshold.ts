export interface IdentityThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityThresholdValidator {
  public static validate(data: Partial<IdentityThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
