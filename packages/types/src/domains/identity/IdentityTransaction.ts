export interface IdentityTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityTransactionValidator {
  public static validate(data: Partial<IdentityTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
