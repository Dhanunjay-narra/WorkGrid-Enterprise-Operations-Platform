export interface IdentitySessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentitySessionValidator {
  public static validate(data: Partial<IdentitySessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
