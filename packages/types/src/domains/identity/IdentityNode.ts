export interface IdentityNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityNodeValidator {
  public static validate(data: Partial<IdentityNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
