export interface IdentityRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityRuleValidator {
  public static validate(data: Partial<IdentityRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
