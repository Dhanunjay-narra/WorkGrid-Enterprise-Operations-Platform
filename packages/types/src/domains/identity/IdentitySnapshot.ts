export interface IdentitySnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentitySnapshotValidator {
  public static validate(data: Partial<IdentitySnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
