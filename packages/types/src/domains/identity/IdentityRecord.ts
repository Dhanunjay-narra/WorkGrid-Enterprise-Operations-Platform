export interface IdentityRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityRecordValidator {
  public static validate(data: Partial<IdentityRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
