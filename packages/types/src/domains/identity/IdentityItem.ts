export interface IdentityItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityItemValidator {
  public static validate(data: Partial<IdentityItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
