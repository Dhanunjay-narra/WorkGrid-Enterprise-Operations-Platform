export interface IdentityEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityEventValidator {
  public static validate(data: Partial<IdentityEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
