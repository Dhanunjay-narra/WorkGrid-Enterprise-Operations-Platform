export interface IdentityMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityMetricValidator {
  public static validate(data: Partial<IdentityMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
