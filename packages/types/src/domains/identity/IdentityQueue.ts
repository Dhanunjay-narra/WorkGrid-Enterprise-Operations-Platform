export interface IdentityQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityQueueValidator {
  public static validate(data: Partial<IdentityQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
