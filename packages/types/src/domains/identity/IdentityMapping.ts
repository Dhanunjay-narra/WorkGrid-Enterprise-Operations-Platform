export interface IdentityMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityMappingValidator {
  public static validate(data: Partial<IdentityMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
