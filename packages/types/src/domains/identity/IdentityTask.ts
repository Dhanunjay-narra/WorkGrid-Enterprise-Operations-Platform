export interface IdentityTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityTaskValidator {
  public static validate(data: Partial<IdentityTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
