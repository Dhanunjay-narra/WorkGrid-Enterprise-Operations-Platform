export interface IdentityEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityEntryValidator {
  public static validate(data: Partial<IdentityEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
