export interface IdentityPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IdentityPayloadValidator {
  public static validate(data: Partial<IdentityPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
