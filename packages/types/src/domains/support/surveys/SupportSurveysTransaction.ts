export interface SupportSurveysTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysTransactionValidator {
  public static validate(data: Partial<SupportSurveysTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
