export interface SupportSurveysBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysBatchValidator {
  public static validate(data: Partial<SupportSurveysBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
