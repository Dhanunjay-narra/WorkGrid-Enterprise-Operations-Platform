export interface SupportSurveysQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysQueueValidator {
  public static validate(data: Partial<SupportSurveysQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
