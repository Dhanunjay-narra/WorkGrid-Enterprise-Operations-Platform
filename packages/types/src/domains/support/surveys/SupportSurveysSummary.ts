export interface SupportSurveysSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysSummaryValidator {
  public static validate(data: Partial<SupportSurveysSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
