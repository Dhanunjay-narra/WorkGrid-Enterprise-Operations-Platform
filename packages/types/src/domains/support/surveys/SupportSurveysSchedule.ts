export interface SupportSurveysScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysScheduleValidator {
  public static validate(data: Partial<SupportSurveysScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
