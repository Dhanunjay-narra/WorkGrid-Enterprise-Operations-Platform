export interface SupportSurveysPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysPayloadValidator {
  public static validate(data: Partial<SupportSurveysPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
