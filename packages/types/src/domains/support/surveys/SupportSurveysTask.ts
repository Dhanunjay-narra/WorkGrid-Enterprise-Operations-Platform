export interface SupportSurveysTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysTaskValidator {
  public static validate(data: Partial<SupportSurveysTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
