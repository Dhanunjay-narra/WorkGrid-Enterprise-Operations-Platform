export interface SupportSurveysAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysAssignmentValidator {
  public static validate(data: Partial<SupportSurveysAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
