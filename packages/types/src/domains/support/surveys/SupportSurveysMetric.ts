export interface SupportSurveysMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysMetricValidator {
  public static validate(data: Partial<SupportSurveysMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
