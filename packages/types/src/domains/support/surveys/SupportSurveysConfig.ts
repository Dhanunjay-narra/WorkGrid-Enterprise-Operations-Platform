export interface SupportSurveysConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysConfigValidator {
  public static validate(data: Partial<SupportSurveysConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
