export interface SupportSurveysRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysRecordValidator {
  public static validate(data: Partial<SupportSurveysRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
