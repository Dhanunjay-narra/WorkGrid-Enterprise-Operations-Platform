export interface SupportSurveysSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysSnapshotValidator {
  public static validate(data: Partial<SupportSurveysSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
