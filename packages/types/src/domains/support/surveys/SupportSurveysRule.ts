export interface SupportSurveysRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysRuleValidator {
  public static validate(data: Partial<SupportSurveysRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
