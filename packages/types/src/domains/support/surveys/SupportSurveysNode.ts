export interface SupportSurveysNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysNodeValidator {
  public static validate(data: Partial<SupportSurveysNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
