export interface SupportSurveysThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysThresholdValidator {
  public static validate(data: Partial<SupportSurveysThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
