export interface SupportSurveysEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysEntryValidator {
  public static validate(data: Partial<SupportSurveysEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
