export interface SupportSurveysReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysReportValidator {
  public static validate(data: Partial<SupportSurveysReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
