export interface SupportSurveysStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysStateValidator {
  public static validate(data: Partial<SupportSurveysStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
