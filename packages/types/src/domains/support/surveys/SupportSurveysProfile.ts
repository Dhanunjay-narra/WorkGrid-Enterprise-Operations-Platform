export interface SupportSurveysProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysProfileValidator {
  public static validate(data: Partial<SupportSurveysProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
