export interface SupportSurveysMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysMappingValidator {
  public static validate(data: Partial<SupportSurveysMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
