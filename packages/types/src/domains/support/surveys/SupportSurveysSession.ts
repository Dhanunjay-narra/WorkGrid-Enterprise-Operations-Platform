export interface SupportSurveysSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysSessionValidator {
  public static validate(data: Partial<SupportSurveysSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
