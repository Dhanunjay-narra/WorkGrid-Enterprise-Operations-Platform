export interface SupportSurveysEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysEventValidator {
  public static validate(data: Partial<SupportSurveysEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
