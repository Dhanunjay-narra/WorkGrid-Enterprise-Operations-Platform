export interface SupportSurveysItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysItemValidator {
  public static validate(data: Partial<SupportSurveysItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
