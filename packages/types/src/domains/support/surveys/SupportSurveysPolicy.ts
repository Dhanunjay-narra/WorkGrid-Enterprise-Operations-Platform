export interface SupportSurveysPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSurveysPolicyValidator {
  public static validate(data: Partial<SupportSurveysPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
