export interface SupportEscalationAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationAuditLogValidator {
  public static validate(data: Partial<SupportEscalationAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
