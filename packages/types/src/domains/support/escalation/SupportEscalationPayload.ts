export interface SupportEscalationPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationPayloadValidator {
  public static validate(data: Partial<SupportEscalationPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
