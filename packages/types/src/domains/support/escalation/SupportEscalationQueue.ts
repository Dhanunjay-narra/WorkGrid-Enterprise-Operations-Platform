export interface SupportEscalationQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationQueueValidator {
  public static validate(data: Partial<SupportEscalationQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
