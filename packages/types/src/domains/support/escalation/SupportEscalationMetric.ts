export interface SupportEscalationMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationMetricValidator {
  public static validate(data: Partial<SupportEscalationMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
