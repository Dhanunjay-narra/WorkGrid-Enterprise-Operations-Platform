export interface SupportEscalationSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationSessionValidator {
  public static validate(data: Partial<SupportEscalationSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
