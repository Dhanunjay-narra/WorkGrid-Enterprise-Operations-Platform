export interface SupportEscalationPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationPolicyValidator {
  public static validate(data: Partial<SupportEscalationPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
