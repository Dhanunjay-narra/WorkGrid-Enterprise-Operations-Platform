export interface SupportEscalationConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationConfigValidator {
  public static validate(data: Partial<SupportEscalationConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
