export interface SupportEscalationStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationStateValidator {
  public static validate(data: Partial<SupportEscalationStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
