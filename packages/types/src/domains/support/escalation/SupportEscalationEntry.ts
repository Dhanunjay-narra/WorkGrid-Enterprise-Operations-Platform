export interface SupportEscalationEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationEntryValidator {
  public static validate(data: Partial<SupportEscalationEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
