export interface SupportEscalationItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationItemValidator {
  public static validate(data: Partial<SupportEscalationItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
