export interface SupportEscalationProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationProfileValidator {
  public static validate(data: Partial<SupportEscalationProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
