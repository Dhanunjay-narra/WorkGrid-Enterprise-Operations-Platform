export interface SupportEscalationEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationEventValidator {
  public static validate(data: Partial<SupportEscalationEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
