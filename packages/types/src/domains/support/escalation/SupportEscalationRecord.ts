export interface SupportEscalationRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationRecordValidator {
  public static validate(data: Partial<SupportEscalationRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
