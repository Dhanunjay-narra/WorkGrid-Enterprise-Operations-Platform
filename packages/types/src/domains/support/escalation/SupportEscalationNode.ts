export interface SupportEscalationNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationNodeValidator {
  public static validate(data: Partial<SupportEscalationNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
