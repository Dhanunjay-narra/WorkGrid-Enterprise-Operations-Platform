export interface SupportEscalationScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationScheduleValidator {
  public static validate(data: Partial<SupportEscalationScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
