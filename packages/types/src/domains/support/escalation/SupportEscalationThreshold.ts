export interface SupportEscalationThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationThresholdValidator {
  public static validate(data: Partial<SupportEscalationThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
