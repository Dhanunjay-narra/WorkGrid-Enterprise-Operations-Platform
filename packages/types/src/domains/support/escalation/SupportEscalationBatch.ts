export interface SupportEscalationBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationBatchValidator {
  public static validate(data: Partial<SupportEscalationBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
