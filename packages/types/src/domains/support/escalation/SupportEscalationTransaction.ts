export interface SupportEscalationTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationTransactionValidator {
  public static validate(data: Partial<SupportEscalationTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
