export interface SupportEscalationSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationSummaryValidator {
  public static validate(data: Partial<SupportEscalationSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
