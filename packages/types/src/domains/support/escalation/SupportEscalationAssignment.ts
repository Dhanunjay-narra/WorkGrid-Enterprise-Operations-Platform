export interface SupportEscalationAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationAssignmentValidator {
  public static validate(data: Partial<SupportEscalationAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
