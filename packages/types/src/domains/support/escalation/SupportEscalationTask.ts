export interface SupportEscalationTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationTaskValidator {
  public static validate(data: Partial<SupportEscalationTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
