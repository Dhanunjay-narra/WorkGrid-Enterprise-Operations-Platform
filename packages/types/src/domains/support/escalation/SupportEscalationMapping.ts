export interface SupportEscalationMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationMappingValidator {
  public static validate(data: Partial<SupportEscalationMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
