export interface SupportEscalationRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationRuleValidator {
  public static validate(data: Partial<SupportEscalationRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
