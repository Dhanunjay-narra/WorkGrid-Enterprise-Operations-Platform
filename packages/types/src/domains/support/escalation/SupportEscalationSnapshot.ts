export interface SupportEscalationSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationSnapshotValidator {
  public static validate(data: Partial<SupportEscalationSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
