export interface SupportEscalationReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportEscalationReportValidator {
  public static validate(data: Partial<SupportEscalationReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
