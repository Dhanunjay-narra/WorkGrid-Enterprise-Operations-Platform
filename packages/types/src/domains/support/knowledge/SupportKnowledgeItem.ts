export interface SupportKnowledgeItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeItemValidator {
  public static validate(data: Partial<SupportKnowledgeItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
