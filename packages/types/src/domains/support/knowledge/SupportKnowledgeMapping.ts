export interface SupportKnowledgeMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeMappingValidator {
  public static validate(data: Partial<SupportKnowledgeMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
