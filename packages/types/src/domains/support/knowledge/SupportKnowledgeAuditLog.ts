export interface SupportKnowledgeAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeAuditLogValidator {
  public static validate(data: Partial<SupportKnowledgeAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
