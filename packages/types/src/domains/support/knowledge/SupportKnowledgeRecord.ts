export interface SupportKnowledgeRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeRecordValidator {
  public static validate(data: Partial<SupportKnowledgeRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
