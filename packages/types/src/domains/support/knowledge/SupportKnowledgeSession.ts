export interface SupportKnowledgeSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeSessionValidator {
  public static validate(data: Partial<SupportKnowledgeSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
