export interface SupportKnowledgeProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeProfileValidator {
  public static validate(data: Partial<SupportKnowledgeProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
