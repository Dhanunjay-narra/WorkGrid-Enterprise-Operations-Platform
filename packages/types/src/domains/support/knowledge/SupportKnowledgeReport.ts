export interface SupportKnowledgeReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeReportValidator {
  public static validate(data: Partial<SupportKnowledgeReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
