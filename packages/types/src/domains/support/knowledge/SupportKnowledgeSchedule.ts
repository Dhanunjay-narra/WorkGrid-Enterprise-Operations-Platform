export interface SupportKnowledgeScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeScheduleValidator {
  public static validate(data: Partial<SupportKnowledgeScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
