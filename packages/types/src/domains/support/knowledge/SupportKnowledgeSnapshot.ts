export interface SupportKnowledgeSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeSnapshotValidator {
  public static validate(data: Partial<SupportKnowledgeSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
