export interface SupportKnowledgeAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeAssignmentValidator {
  public static validate(data: Partial<SupportKnowledgeAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
