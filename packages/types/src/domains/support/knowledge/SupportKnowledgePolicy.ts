export interface SupportKnowledgePolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgePolicyValidator {
  public static validate(data: Partial<SupportKnowledgePolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
