export interface SupportKnowledgeNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeNodeValidator {
  public static validate(data: Partial<SupportKnowledgeNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
