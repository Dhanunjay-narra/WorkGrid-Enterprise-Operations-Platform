export interface SupportKnowledgePayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgePayloadValidator {
  public static validate(data: Partial<SupportKnowledgePayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
