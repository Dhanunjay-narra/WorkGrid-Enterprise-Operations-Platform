export interface SupportKnowledgeMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeMetricValidator {
  public static validate(data: Partial<SupportKnowledgeMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
