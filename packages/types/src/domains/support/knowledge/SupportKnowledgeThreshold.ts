export interface SupportKnowledgeThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeThresholdValidator {
  public static validate(data: Partial<SupportKnowledgeThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
