export interface SupportKnowledgeEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeEntryValidator {
  public static validate(data: Partial<SupportKnowledgeEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
