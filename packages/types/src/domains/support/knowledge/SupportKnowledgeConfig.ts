export interface SupportKnowledgeConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeConfigValidator {
  public static validate(data: Partial<SupportKnowledgeConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
