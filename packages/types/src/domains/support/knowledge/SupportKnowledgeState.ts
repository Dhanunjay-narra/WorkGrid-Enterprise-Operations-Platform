export interface SupportKnowledgeStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeStateValidator {
  public static validate(data: Partial<SupportKnowledgeStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
