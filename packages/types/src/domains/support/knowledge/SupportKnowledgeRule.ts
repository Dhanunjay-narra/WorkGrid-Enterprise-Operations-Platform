export interface SupportKnowledgeRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeRuleValidator {
  public static validate(data: Partial<SupportKnowledgeRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
