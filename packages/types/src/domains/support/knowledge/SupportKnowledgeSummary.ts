export interface SupportKnowledgeSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeSummaryValidator {
  public static validate(data: Partial<SupportKnowledgeSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
