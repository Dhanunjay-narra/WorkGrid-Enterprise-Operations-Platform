export interface SupportKnowledgeBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeBatchValidator {
  public static validate(data: Partial<SupportKnowledgeBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
