export interface SupportKnowledgeQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeQueueValidator {
  public static validate(data: Partial<SupportKnowledgeQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
