export interface SupportKnowledgeTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeTransactionValidator {
  public static validate(data: Partial<SupportKnowledgeTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
