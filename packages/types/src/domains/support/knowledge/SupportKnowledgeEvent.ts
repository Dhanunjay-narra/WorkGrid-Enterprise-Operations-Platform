export interface SupportKnowledgeEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeEventValidator {
  public static validate(data: Partial<SupportKnowledgeEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
