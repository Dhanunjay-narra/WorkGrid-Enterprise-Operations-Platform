export interface SupportKnowledgeTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportKnowledgeTaskValidator {
  public static validate(data: Partial<SupportKnowledgeTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
