export interface SupportSlaProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaProfileValidator {
  public static validate(data: Partial<SupportSlaProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
