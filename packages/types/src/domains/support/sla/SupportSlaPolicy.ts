export interface SupportSlaPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaPolicyValidator {
  public static validate(data: Partial<SupportSlaPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
