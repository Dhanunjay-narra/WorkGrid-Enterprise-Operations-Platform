export interface SupportSlaTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaTransactionValidator {
  public static validate(data: Partial<SupportSlaTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
