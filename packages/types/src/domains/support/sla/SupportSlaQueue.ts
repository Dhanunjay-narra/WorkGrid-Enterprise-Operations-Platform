export interface SupportSlaQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaQueueValidator {
  public static validate(data: Partial<SupportSlaQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
