export interface SupportSlaSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaSessionValidator {
  public static validate(data: Partial<SupportSlaSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
