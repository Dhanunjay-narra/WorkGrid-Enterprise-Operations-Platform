export interface SupportSlaThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaThresholdValidator {
  public static validate(data: Partial<SupportSlaThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
