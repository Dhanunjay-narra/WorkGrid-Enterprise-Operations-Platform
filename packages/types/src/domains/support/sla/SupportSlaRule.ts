export interface SupportSlaRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaRuleValidator {
  public static validate(data: Partial<SupportSlaRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
