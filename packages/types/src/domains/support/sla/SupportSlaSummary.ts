export interface SupportSlaSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaSummaryValidator {
  public static validate(data: Partial<SupportSlaSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
