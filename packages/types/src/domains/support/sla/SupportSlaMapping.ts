export interface SupportSlaMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaMappingValidator {
  public static validate(data: Partial<SupportSlaMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
