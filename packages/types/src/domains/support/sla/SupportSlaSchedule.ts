export interface SupportSlaScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaScheduleValidator {
  public static validate(data: Partial<SupportSlaScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
