export interface SupportSlaEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaEventValidator {
  public static validate(data: Partial<SupportSlaEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
