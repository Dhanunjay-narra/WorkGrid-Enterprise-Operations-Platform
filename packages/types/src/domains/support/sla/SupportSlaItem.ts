export interface SupportSlaItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaItemValidator {
  public static validate(data: Partial<SupportSlaItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
