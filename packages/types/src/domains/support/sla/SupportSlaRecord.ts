export interface SupportSlaRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaRecordValidator {
  public static validate(data: Partial<SupportSlaRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
