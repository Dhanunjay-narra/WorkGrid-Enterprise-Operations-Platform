export interface SupportSlaNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaNodeValidator {
  public static validate(data: Partial<SupportSlaNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
