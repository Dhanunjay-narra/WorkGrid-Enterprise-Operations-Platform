export interface SupportSlaBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaBatchValidator {
  public static validate(data: Partial<SupportSlaBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
