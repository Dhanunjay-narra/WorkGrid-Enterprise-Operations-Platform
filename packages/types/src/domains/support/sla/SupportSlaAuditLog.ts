export interface SupportSlaAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaAuditLogValidator {
  public static validate(data: Partial<SupportSlaAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
