export interface SupportSlaEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaEntryValidator {
  public static validate(data: Partial<SupportSlaEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
