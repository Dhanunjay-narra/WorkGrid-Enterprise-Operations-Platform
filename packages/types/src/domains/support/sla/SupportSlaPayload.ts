export interface SupportSlaPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaPayloadValidator {
  public static validate(data: Partial<SupportSlaPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
