export interface SupportSlaStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaStateValidator {
  public static validate(data: Partial<SupportSlaStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
