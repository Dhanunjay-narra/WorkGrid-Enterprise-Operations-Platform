export interface SupportSlaMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaMetricValidator {
  public static validate(data: Partial<SupportSlaMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
