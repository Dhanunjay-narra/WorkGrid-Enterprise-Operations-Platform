export interface SupportSlaConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaConfigValidator {
  public static validate(data: Partial<SupportSlaConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
