export interface SupportSlaReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaReportValidator {
  public static validate(data: Partial<SupportSlaReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
