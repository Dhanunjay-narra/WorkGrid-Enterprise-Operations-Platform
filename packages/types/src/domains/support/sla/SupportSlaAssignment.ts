export interface SupportSlaAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaAssignmentValidator {
  public static validate(data: Partial<SupportSlaAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
