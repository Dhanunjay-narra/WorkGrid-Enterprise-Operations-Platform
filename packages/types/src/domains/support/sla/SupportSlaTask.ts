export interface SupportSlaTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaTaskValidator {
  public static validate(data: Partial<SupportSlaTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
