export interface SupportSlaSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportSlaSnapshotValidator {
  public static validate(data: Partial<SupportSlaSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
