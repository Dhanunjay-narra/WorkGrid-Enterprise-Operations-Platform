export interface SupportCsatSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatSnapshotValidator {
  public static validate(data: Partial<SupportCsatSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
