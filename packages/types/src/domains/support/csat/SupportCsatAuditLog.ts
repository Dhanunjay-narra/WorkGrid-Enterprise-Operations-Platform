export interface SupportCsatAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatAuditLogValidator {
  public static validate(data: Partial<SupportCsatAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
