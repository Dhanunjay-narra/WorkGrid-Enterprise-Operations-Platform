export interface SupportCsatEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatEventValidator {
  public static validate(data: Partial<SupportCsatEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
