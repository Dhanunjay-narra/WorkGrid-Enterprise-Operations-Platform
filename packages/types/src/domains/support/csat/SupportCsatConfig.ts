export interface SupportCsatConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatConfigValidator {
  public static validate(data: Partial<SupportCsatConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
