export interface SupportCsatThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatThresholdValidator {
  public static validate(data: Partial<SupportCsatThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
