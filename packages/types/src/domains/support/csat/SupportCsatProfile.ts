export interface SupportCsatProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatProfileValidator {
  public static validate(data: Partial<SupportCsatProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
