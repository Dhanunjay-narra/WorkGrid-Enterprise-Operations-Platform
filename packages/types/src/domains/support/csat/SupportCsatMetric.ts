export interface SupportCsatMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatMetricValidator {
  public static validate(data: Partial<SupportCsatMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
