export interface SupportCsatRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatRuleValidator {
  public static validate(data: Partial<SupportCsatRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
