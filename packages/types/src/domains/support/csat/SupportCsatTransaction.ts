export interface SupportCsatTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatTransactionValidator {
  public static validate(data: Partial<SupportCsatTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
