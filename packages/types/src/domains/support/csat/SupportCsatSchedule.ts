export interface SupportCsatScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatScheduleValidator {
  public static validate(data: Partial<SupportCsatScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
