export interface SupportCsatSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatSummaryValidator {
  public static validate(data: Partial<SupportCsatSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
