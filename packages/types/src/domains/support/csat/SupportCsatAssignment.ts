export interface SupportCsatAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatAssignmentValidator {
  public static validate(data: Partial<SupportCsatAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
