export interface SupportCsatMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatMappingValidator {
  public static validate(data: Partial<SupportCsatMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
