export interface SupportCsatPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatPolicyValidator {
  public static validate(data: Partial<SupportCsatPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
