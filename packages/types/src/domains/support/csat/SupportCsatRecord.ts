export interface SupportCsatRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatRecordValidator {
  public static validate(data: Partial<SupportCsatRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
