export interface SupportCsatBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatBatchValidator {
  public static validate(data: Partial<SupportCsatBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
