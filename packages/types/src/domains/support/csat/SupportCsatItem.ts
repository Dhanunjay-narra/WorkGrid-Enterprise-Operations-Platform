export interface SupportCsatItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatItemValidator {
  public static validate(data: Partial<SupportCsatItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
