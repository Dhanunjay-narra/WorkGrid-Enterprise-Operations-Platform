export interface SupportCsatEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatEntryValidator {
  public static validate(data: Partial<SupportCsatEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
