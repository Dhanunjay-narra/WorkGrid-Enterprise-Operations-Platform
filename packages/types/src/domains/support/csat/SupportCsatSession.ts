export interface SupportCsatSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatSessionValidator {
  public static validate(data: Partial<SupportCsatSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
