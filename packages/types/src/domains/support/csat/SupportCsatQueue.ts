export interface SupportCsatQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatQueueValidator {
  public static validate(data: Partial<SupportCsatQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
