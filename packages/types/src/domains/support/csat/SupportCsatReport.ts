export interface SupportCsatReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatReportValidator {
  public static validate(data: Partial<SupportCsatReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
