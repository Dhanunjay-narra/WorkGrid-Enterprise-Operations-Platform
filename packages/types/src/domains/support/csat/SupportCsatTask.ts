export interface SupportCsatTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatTaskValidator {
  public static validate(data: Partial<SupportCsatTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
