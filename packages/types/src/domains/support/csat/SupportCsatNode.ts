export interface SupportCsatNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatNodeValidator {
  public static validate(data: Partial<SupportCsatNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
