export interface SupportCsatPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatPayloadValidator {
  public static validate(data: Partial<SupportCsatPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
