export interface SupportCsatStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportCsatStateValidator {
  public static validate(data: Partial<SupportCsatStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
