export interface SupportQueuesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesConfigValidator {
  public static validate(data: Partial<SupportQueuesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
