export interface SupportQueuesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesAssignmentValidator {
  public static validate(data: Partial<SupportQueuesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
