export interface SupportQueuesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesQueueValidator {
  public static validate(data: Partial<SupportQueuesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
