export interface SupportQueuesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesRuleValidator {
  public static validate(data: Partial<SupportQueuesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
