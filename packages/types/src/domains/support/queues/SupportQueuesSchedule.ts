export interface SupportQueuesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesScheduleValidator {
  public static validate(data: Partial<SupportQueuesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
