export interface SupportQueuesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesThresholdValidator {
  public static validate(data: Partial<SupportQueuesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
