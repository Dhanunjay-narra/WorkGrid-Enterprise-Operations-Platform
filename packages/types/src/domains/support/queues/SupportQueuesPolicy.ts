export interface SupportQueuesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesPolicyValidator {
  public static validate(data: Partial<SupportQueuesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
