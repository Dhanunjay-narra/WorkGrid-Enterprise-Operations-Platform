export interface SupportQueuesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesMetricValidator {
  public static validate(data: Partial<SupportQueuesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
