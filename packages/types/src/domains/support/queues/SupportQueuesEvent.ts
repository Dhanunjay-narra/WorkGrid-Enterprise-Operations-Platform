export interface SupportQueuesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesEventValidator {
  public static validate(data: Partial<SupportQueuesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
