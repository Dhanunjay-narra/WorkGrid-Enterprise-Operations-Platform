export interface SupportQueuesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesItemValidator {
  public static validate(data: Partial<SupportQueuesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
