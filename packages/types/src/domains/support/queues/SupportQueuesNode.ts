export interface SupportQueuesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesNodeValidator {
  public static validate(data: Partial<SupportQueuesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
