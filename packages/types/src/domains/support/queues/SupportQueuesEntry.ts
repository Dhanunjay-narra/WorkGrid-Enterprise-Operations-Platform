export interface SupportQueuesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesEntryValidator {
  public static validate(data: Partial<SupportQueuesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
