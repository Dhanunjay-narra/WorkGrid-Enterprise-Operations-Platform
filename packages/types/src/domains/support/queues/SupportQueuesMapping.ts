export interface SupportQueuesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesMappingValidator {
  public static validate(data: Partial<SupportQueuesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
