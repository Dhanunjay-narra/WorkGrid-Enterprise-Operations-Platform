export interface SupportQueuesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesRecordValidator {
  public static validate(data: Partial<SupportQueuesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
