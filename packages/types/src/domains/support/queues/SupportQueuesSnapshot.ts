export interface SupportQueuesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesSnapshotValidator {
  public static validate(data: Partial<SupportQueuesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
