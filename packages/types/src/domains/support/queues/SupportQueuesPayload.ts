export interface SupportQueuesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesPayloadValidator {
  public static validate(data: Partial<SupportQueuesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
