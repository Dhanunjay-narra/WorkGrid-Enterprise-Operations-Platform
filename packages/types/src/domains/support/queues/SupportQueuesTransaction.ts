export interface SupportQueuesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesTransactionValidator {
  public static validate(data: Partial<SupportQueuesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
