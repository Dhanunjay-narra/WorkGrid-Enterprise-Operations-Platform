export interface SupportQueuesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesStateValidator {
  public static validate(data: Partial<SupportQueuesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
