export interface SupportQueuesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesProfileValidator {
  public static validate(data: Partial<SupportQueuesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
