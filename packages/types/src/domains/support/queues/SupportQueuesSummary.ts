export interface SupportQueuesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesSummaryValidator {
  public static validate(data: Partial<SupportQueuesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
