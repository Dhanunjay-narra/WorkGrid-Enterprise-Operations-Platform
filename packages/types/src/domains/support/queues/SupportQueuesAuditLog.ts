export interface SupportQueuesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesAuditLogValidator {
  public static validate(data: Partial<SupportQueuesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
