export interface SupportQueuesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesBatchValidator {
  public static validate(data: Partial<SupportQueuesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
