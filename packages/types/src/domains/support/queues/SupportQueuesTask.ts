export interface SupportQueuesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesTaskValidator {
  public static validate(data: Partial<SupportQueuesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
