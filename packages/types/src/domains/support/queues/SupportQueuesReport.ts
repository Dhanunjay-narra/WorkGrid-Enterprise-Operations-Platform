export interface SupportQueuesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesReportValidator {
  public static validate(data: Partial<SupportQueuesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
