export interface SupportQueuesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportQueuesSessionValidator {
  public static validate(data: Partial<SupportQueuesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
