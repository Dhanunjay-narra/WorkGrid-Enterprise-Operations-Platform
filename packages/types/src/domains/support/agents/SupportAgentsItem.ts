export interface SupportAgentsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsItemValidator {
  public static validate(data: Partial<SupportAgentsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
