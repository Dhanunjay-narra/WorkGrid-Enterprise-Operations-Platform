export interface SupportAgentsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsTaskValidator {
  public static validate(data: Partial<SupportAgentsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
