export interface SupportAgentsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsPayloadValidator {
  public static validate(data: Partial<SupportAgentsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
