export interface SupportAgentsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsQueueValidator {
  public static validate(data: Partial<SupportAgentsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
