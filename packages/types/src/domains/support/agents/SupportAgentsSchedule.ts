export interface SupportAgentsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsScheduleValidator {
  public static validate(data: Partial<SupportAgentsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
