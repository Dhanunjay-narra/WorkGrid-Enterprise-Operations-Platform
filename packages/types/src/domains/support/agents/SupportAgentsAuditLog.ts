export interface SupportAgentsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsAuditLogValidator {
  public static validate(data: Partial<SupportAgentsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
