export interface SupportAgentsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsEntryValidator {
  public static validate(data: Partial<SupportAgentsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
