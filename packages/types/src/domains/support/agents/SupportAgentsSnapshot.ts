export interface SupportAgentsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsSnapshotValidator {
  public static validate(data: Partial<SupportAgentsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
