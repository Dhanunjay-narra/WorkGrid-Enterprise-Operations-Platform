export interface SupportAgentsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsReportValidator {
  public static validate(data: Partial<SupportAgentsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
