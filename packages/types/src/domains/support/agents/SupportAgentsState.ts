export interface SupportAgentsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsStateValidator {
  public static validate(data: Partial<SupportAgentsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
