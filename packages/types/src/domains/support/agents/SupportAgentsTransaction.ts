export interface SupportAgentsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsTransactionValidator {
  public static validate(data: Partial<SupportAgentsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
