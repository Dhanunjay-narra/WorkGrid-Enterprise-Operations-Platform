export interface SupportAgentsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsMappingValidator {
  public static validate(data: Partial<SupportAgentsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
