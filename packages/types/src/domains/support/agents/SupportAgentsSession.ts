export interface SupportAgentsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsSessionValidator {
  public static validate(data: Partial<SupportAgentsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
