export interface SupportAgentsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsProfileValidator {
  public static validate(data: Partial<SupportAgentsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
