export interface SupportAgentsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsRuleValidator {
  public static validate(data: Partial<SupportAgentsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
