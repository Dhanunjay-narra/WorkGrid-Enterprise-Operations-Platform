export interface SupportAgentsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsNodeValidator {
  public static validate(data: Partial<SupportAgentsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
