export interface SupportAgentsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsThresholdValidator {
  public static validate(data: Partial<SupportAgentsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
