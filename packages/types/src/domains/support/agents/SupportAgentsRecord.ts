export interface SupportAgentsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsRecordValidator {
  public static validate(data: Partial<SupportAgentsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
