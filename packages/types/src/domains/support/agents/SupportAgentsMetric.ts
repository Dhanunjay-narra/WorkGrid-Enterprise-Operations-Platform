export interface SupportAgentsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsMetricValidator {
  public static validate(data: Partial<SupportAgentsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
