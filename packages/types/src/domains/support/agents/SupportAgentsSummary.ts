export interface SupportAgentsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsSummaryValidator {
  public static validate(data: Partial<SupportAgentsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
