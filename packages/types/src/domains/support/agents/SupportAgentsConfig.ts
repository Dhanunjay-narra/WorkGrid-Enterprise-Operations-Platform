export interface SupportAgentsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsConfigValidator {
  public static validate(data: Partial<SupportAgentsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
