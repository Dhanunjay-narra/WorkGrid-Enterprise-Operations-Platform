export interface SupportAgentsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsPolicyValidator {
  public static validate(data: Partial<SupportAgentsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
