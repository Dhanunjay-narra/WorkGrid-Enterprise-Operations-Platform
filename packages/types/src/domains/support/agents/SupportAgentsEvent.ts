export interface SupportAgentsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsEventValidator {
  public static validate(data: Partial<SupportAgentsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
