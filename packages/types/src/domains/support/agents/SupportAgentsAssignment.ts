export interface SupportAgentsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportAgentsAssignmentValidator {
  public static validate(data: Partial<SupportAgentsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
