export interface SupportTicketsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsSummaryValidator {
  public static validate(data: Partial<SupportTicketsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
