export interface SupportTicketsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsProfileValidator {
  public static validate(data: Partial<SupportTicketsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
