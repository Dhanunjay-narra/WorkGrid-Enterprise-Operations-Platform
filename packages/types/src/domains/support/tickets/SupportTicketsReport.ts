export interface SupportTicketsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsReportValidator {
  public static validate(data: Partial<SupportTicketsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
