export interface SupportTicketsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsEventValidator {
  public static validate(data: Partial<SupportTicketsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
