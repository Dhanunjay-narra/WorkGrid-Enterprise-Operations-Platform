export interface SupportTicketsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsStateValidator {
  public static validate(data: Partial<SupportTicketsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
