export interface SupportTicketsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsAuditLogValidator {
  public static validate(data: Partial<SupportTicketsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
