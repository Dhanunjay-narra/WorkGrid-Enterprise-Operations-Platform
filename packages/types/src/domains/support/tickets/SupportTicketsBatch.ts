export interface SupportTicketsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsBatchValidator {
  public static validate(data: Partial<SupportTicketsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
