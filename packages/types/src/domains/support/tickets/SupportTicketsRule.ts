export interface SupportTicketsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsRuleValidator {
  public static validate(data: Partial<SupportTicketsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
