export interface SupportTicketsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsQueueValidator {
  public static validate(data: Partial<SupportTicketsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
