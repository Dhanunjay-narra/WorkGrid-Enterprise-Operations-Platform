export interface SupportTicketsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsThresholdValidator {
  public static validate(data: Partial<SupportTicketsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
