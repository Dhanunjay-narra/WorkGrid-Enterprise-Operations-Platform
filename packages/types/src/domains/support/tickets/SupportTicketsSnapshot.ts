export interface SupportTicketsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsSnapshotValidator {
  public static validate(data: Partial<SupportTicketsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
