export interface SupportTicketsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsItemValidator {
  public static validate(data: Partial<SupportTicketsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
