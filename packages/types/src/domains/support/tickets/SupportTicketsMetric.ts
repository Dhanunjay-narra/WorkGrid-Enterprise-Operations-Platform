export interface SupportTicketsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsMetricValidator {
  public static validate(data: Partial<SupportTicketsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
