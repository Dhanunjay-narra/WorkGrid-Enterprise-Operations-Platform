export interface SupportTicketsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsNodeValidator {
  public static validate(data: Partial<SupportTicketsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
