export interface SupportTicketsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsEntryValidator {
  public static validate(data: Partial<SupportTicketsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
