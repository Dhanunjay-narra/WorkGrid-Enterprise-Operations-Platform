export interface SupportTicketsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsPayloadValidator {
  public static validate(data: Partial<SupportTicketsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
