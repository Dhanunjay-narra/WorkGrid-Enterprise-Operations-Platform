export interface SupportTicketsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsRecordValidator {
  public static validate(data: Partial<SupportTicketsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
