export interface SupportTicketsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsScheduleValidator {
  public static validate(data: Partial<SupportTicketsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
