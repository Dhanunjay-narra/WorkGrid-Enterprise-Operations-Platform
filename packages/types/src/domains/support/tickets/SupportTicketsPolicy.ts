export interface SupportTicketsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsPolicyValidator {
  public static validate(data: Partial<SupportTicketsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
