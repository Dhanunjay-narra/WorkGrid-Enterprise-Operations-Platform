export interface SupportTicketsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsTransactionValidator {
  public static validate(data: Partial<SupportTicketsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
