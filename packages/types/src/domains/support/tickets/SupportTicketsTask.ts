export interface SupportTicketsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsTaskValidator {
  public static validate(data: Partial<SupportTicketsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
