export interface SupportTicketsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsConfigValidator {
  public static validate(data: Partial<SupportTicketsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
