export interface SupportTicketsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsSessionValidator {
  public static validate(data: Partial<SupportTicketsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
