export interface SupportTicketsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsMappingValidator {
  public static validate(data: Partial<SupportTicketsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
