export interface SupportTicketsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SupportTicketsAssignmentValidator {
  public static validate(data: Partial<SupportTicketsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
