export interface EventsIdempotencySessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencySessionValidator {
  public static validate(data: Partial<EventsIdempotencySessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
