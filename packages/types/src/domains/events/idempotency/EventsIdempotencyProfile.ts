export interface EventsIdempotencyProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyProfileValidator {
  public static validate(data: Partial<EventsIdempotencyProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
