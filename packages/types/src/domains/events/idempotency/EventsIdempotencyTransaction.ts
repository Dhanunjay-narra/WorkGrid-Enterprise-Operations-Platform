export interface EventsIdempotencyTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyTransactionValidator {
  public static validate(data: Partial<EventsIdempotencyTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
