export interface EventsIdempotencyTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyTaskValidator {
  public static validate(data: Partial<EventsIdempotencyTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
