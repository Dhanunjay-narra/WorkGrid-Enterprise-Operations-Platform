export interface EventsIdempotencyPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyPayloadValidator {
  public static validate(data: Partial<EventsIdempotencyPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
