export interface EventsIdempotencyRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyRecordValidator {
  public static validate(data: Partial<EventsIdempotencyRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
