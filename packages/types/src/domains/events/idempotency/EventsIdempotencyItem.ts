export interface EventsIdempotencyItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyItemValidator {
  public static validate(data: Partial<EventsIdempotencyItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
