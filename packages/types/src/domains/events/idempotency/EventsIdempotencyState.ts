export interface EventsIdempotencyStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyStateValidator {
  public static validate(data: Partial<EventsIdempotencyStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
