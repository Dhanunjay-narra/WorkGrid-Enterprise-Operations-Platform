export interface EventsIdempotencyMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyMetricValidator {
  public static validate(data: Partial<EventsIdempotencyMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
