export interface EventsIdempotencyReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyReportValidator {
  public static validate(data: Partial<EventsIdempotencyReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
