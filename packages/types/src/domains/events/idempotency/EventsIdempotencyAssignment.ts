export interface EventsIdempotencyAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyAssignmentValidator {
  public static validate(data: Partial<EventsIdempotencyAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
