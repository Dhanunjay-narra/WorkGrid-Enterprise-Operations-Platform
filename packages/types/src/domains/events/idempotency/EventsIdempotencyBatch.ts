export interface EventsIdempotencyBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyBatchValidator {
  public static validate(data: Partial<EventsIdempotencyBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
