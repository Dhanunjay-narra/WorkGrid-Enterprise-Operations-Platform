export interface EventsIdempotencyThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyThresholdValidator {
  public static validate(data: Partial<EventsIdempotencyThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
