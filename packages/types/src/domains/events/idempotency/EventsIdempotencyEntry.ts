export interface EventsIdempotencyEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyEntryValidator {
  public static validate(data: Partial<EventsIdempotencyEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
