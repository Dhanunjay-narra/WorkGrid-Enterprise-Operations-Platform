export interface EventsIdempotencyQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyQueueValidator {
  public static validate(data: Partial<EventsIdempotencyQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
