export interface EventsIdempotencyConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyConfigValidator {
  public static validate(data: Partial<EventsIdempotencyConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
