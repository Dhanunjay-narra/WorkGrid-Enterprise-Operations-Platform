export interface EventsIdempotencySnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencySnapshotValidator {
  public static validate(data: Partial<EventsIdempotencySnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
