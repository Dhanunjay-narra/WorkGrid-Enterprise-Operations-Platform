export interface EventsIdempotencyNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyNodeValidator {
  public static validate(data: Partial<EventsIdempotencyNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
