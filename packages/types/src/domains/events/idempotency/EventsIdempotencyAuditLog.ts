export interface EventsIdempotencyAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyAuditLogValidator {
  public static validate(data: Partial<EventsIdempotencyAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
