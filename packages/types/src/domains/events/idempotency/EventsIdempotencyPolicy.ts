export interface EventsIdempotencyPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyPolicyValidator {
  public static validate(data: Partial<EventsIdempotencyPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
