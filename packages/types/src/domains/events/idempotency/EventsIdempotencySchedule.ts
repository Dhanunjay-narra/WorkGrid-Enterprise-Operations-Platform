export interface EventsIdempotencyScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyScheduleValidator {
  public static validate(data: Partial<EventsIdempotencyScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
