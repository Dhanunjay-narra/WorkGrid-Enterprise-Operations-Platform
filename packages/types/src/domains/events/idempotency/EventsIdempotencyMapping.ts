export interface EventsIdempotencyMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyMappingValidator {
  public static validate(data: Partial<EventsIdempotencyMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
