export interface EventsIdempotencyRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyRuleValidator {
  public static validate(data: Partial<EventsIdempotencyRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
