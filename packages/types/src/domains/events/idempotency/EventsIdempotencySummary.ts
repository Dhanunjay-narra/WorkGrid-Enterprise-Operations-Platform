export interface EventsIdempotencySummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencySummaryValidator {
  public static validate(data: Partial<EventsIdempotencySummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
