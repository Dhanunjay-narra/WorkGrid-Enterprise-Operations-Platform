export interface EventsIdempotencyEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsIdempotencyEventValidator {
  public static validate(data: Partial<EventsIdempotencyEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
