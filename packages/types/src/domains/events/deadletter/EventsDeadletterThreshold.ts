export interface EventsDeadletterThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterThresholdValidator {
  public static validate(data: Partial<EventsDeadletterThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
