export interface EventsDeadletterAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterAssignmentValidator {
  public static validate(data: Partial<EventsDeadletterAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
