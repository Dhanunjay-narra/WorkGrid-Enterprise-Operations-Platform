export interface EventsDeadletterBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterBatchValidator {
  public static validate(data: Partial<EventsDeadletterBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
