export interface EventsDeadletterMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterMappingValidator {
  public static validate(data: Partial<EventsDeadletterMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
