export interface EventsDeadletterScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterScheduleValidator {
  public static validate(data: Partial<EventsDeadletterScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
