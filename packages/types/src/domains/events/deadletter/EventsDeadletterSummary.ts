export interface EventsDeadletterSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterSummaryValidator {
  public static validate(data: Partial<EventsDeadletterSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
