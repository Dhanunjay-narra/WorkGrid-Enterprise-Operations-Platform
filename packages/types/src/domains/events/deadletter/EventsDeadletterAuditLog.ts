export interface EventsDeadletterAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterAuditLogValidator {
  public static validate(data: Partial<EventsDeadletterAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
