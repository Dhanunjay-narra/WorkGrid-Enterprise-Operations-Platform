export interface EventsDeadletterItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterItemValidator {
  public static validate(data: Partial<EventsDeadletterItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
