export interface EventsDeadletterProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterProfileValidator {
  public static validate(data: Partial<EventsDeadletterProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
