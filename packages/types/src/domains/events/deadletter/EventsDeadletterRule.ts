export interface EventsDeadletterRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterRuleValidator {
  public static validate(data: Partial<EventsDeadletterRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
