export interface EventsDeadletterMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterMetricValidator {
  public static validate(data: Partial<EventsDeadletterMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
