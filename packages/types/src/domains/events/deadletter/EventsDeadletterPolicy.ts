export interface EventsDeadletterPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterPolicyValidator {
  public static validate(data: Partial<EventsDeadletterPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
