export interface EventsDeadletterEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterEntryValidator {
  public static validate(data: Partial<EventsDeadletterEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
