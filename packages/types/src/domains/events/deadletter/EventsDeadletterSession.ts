export interface EventsDeadletterSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterSessionValidator {
  public static validate(data: Partial<EventsDeadletterSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
