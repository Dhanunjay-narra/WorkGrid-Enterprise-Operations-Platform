export interface EventsDeadletterQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterQueueValidator {
  public static validate(data: Partial<EventsDeadletterQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
