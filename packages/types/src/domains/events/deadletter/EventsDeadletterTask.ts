export interface EventsDeadletterTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterTaskValidator {
  public static validate(data: Partial<EventsDeadletterTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
