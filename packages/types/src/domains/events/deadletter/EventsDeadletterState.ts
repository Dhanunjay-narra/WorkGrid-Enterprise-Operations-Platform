export interface EventsDeadletterStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterStateValidator {
  public static validate(data: Partial<EventsDeadletterStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
