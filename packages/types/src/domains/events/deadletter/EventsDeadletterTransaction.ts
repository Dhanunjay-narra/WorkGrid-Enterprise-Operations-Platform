export interface EventsDeadletterTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterTransactionValidator {
  public static validate(data: Partial<EventsDeadletterTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
