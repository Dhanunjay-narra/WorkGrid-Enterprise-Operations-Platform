export interface EventsDeadletterSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterSnapshotValidator {
  public static validate(data: Partial<EventsDeadletterSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
