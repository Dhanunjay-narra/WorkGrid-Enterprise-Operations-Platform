export interface EventsDeadletterPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterPayloadValidator {
  public static validate(data: Partial<EventsDeadletterPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
