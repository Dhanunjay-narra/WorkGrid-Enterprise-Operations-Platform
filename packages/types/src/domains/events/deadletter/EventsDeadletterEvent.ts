export interface EventsDeadletterEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterEventValidator {
  public static validate(data: Partial<EventsDeadletterEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
