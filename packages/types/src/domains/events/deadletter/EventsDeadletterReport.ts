export interface EventsDeadletterReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterReportValidator {
  public static validate(data: Partial<EventsDeadletterReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
