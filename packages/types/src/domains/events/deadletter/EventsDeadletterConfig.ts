export interface EventsDeadletterConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterConfigValidator {
  public static validate(data: Partial<EventsDeadletterConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
