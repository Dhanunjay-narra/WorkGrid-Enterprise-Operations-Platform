export interface EventsDeadletterNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsDeadletterNodeValidator {
  public static validate(data: Partial<EventsDeadletterNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
