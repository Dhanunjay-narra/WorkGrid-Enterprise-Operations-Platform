export interface EventsSchemaMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaMappingValidator {
  public static validate(data: Partial<EventsSchemaMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
