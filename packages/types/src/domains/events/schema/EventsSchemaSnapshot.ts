export interface EventsSchemaSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaSnapshotValidator {
  public static validate(data: Partial<EventsSchemaSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
