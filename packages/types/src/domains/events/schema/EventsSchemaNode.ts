export interface EventsSchemaNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaNodeValidator {
  public static validate(data: Partial<EventsSchemaNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
