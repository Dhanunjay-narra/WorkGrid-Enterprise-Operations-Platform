export interface EventsSchemaTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaTaskValidator {
  public static validate(data: Partial<EventsSchemaTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
