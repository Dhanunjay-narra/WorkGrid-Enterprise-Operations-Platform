export interface EventsSchemaAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaAssignmentValidator {
  public static validate(data: Partial<EventsSchemaAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
