export interface EventsSchemaStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaStateValidator {
  public static validate(data: Partial<EventsSchemaStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
