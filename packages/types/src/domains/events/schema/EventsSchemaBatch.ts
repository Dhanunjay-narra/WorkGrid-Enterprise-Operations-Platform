export interface EventsSchemaBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaBatchValidator {
  public static validate(data: Partial<EventsSchemaBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
