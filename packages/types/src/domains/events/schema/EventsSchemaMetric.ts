export interface EventsSchemaMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaMetricValidator {
  public static validate(data: Partial<EventsSchemaMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
