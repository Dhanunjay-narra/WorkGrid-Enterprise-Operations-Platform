export interface EventsSchemaThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaThresholdValidator {
  public static validate(data: Partial<EventsSchemaThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
