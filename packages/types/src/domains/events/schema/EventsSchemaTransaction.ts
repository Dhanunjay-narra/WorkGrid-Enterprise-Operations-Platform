export interface EventsSchemaTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaTransactionValidator {
  public static validate(data: Partial<EventsSchemaTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
