export interface EventsSchemaSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaSessionValidator {
  public static validate(data: Partial<EventsSchemaSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
