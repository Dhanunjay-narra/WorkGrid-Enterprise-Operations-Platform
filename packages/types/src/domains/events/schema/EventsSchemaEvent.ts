export interface EventsSchemaEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaEventValidator {
  public static validate(data: Partial<EventsSchemaEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
