export interface EventsSchemaPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaPolicyValidator {
  public static validate(data: Partial<EventsSchemaPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
