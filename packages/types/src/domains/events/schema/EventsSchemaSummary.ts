export interface EventsSchemaSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaSummaryValidator {
  public static validate(data: Partial<EventsSchemaSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
