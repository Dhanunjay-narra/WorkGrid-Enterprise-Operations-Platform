export interface EventsSchemaEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaEntryValidator {
  public static validate(data: Partial<EventsSchemaEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
