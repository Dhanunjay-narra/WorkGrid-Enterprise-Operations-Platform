export interface EventsSchemaConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaConfigValidator {
  public static validate(data: Partial<EventsSchemaConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
