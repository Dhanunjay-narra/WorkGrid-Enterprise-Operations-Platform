export interface EventsSchemaPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaPayloadValidator {
  public static validate(data: Partial<EventsSchemaPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
