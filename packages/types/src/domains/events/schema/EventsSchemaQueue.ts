export interface EventsSchemaQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaQueueValidator {
  public static validate(data: Partial<EventsSchemaQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
