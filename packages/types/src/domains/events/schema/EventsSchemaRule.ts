export interface EventsSchemaRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaRuleValidator {
  public static validate(data: Partial<EventsSchemaRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
