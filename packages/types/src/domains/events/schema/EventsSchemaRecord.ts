export interface EventsSchemaRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaRecordValidator {
  public static validate(data: Partial<EventsSchemaRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
