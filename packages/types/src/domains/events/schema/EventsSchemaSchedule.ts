export interface EventsSchemaScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaScheduleValidator {
  public static validate(data: Partial<EventsSchemaScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
