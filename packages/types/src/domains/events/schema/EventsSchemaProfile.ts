export interface EventsSchemaProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaProfileValidator {
  public static validate(data: Partial<EventsSchemaProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
