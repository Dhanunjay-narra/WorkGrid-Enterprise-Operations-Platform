export interface EventsSchemaItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaItemValidator {
  public static validate(data: Partial<EventsSchemaItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
