export interface EventsSchemaReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaReportValidator {
  public static validate(data: Partial<EventsSchemaReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
