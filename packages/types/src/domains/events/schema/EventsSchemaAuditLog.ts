export interface EventsSchemaAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsSchemaAuditLogValidator {
  public static validate(data: Partial<EventsSchemaAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
