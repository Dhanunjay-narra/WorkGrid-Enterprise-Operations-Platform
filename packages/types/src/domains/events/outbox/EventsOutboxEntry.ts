export interface EventsOutboxEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxEntryValidator {
  public static validate(data: Partial<EventsOutboxEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
