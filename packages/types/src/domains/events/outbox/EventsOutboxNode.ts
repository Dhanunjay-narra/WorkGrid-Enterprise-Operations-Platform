export interface EventsOutboxNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxNodeValidator {
  public static validate(data: Partial<EventsOutboxNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
