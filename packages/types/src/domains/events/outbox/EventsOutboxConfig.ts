export interface EventsOutboxConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxConfigValidator {
  public static validate(data: Partial<EventsOutboxConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
