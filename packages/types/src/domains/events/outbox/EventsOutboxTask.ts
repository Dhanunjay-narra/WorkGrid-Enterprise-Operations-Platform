export interface EventsOutboxTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxTaskValidator {
  public static validate(data: Partial<EventsOutboxTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
