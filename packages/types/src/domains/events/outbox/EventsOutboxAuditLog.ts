export interface EventsOutboxAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxAuditLogValidator {
  public static validate(data: Partial<EventsOutboxAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
