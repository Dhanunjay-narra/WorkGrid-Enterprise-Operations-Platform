export interface EventsOutboxRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxRuleValidator {
  public static validate(data: Partial<EventsOutboxRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
