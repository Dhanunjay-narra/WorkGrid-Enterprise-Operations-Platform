export interface EventsOutboxRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxRecordValidator {
  public static validate(data: Partial<EventsOutboxRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
