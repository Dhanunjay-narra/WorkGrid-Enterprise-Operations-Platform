export interface EventsOutboxQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxQueueValidator {
  public static validate(data: Partial<EventsOutboxQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
