export interface EventsOutboxScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxScheduleValidator {
  public static validate(data: Partial<EventsOutboxScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
