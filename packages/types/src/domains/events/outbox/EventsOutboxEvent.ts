export interface EventsOutboxEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxEventValidator {
  public static validate(data: Partial<EventsOutboxEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
