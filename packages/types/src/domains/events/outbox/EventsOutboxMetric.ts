export interface EventsOutboxMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxMetricValidator {
  public static validate(data: Partial<EventsOutboxMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
