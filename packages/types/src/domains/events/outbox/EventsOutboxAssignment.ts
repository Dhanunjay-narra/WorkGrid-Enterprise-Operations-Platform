export interface EventsOutboxAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxAssignmentValidator {
  public static validate(data: Partial<EventsOutboxAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
