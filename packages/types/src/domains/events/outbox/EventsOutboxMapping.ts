export interface EventsOutboxMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxMappingValidator {
  public static validate(data: Partial<EventsOutboxMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
