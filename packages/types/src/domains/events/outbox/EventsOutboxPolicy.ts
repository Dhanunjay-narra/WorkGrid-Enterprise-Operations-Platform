export interface EventsOutboxPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxPolicyValidator {
  public static validate(data: Partial<EventsOutboxPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
