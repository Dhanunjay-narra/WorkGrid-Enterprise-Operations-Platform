export interface EventsOutboxSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxSnapshotValidator {
  public static validate(data: Partial<EventsOutboxSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
