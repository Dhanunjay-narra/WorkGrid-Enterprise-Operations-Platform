export interface EventsOutboxBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxBatchValidator {
  public static validate(data: Partial<EventsOutboxBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
