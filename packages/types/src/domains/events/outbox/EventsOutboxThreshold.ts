export interface EventsOutboxThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxThresholdValidator {
  public static validate(data: Partial<EventsOutboxThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
