export interface EventsOutboxReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxReportValidator {
  public static validate(data: Partial<EventsOutboxReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
