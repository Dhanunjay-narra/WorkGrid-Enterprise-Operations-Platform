export interface EventsOutboxSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxSessionValidator {
  public static validate(data: Partial<EventsOutboxSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
