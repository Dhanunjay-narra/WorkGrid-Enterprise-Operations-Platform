export interface EventsOutboxProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxProfileValidator {
  public static validate(data: Partial<EventsOutboxProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
