export interface EventsOutboxStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxStateValidator {
  public static validate(data: Partial<EventsOutboxStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
