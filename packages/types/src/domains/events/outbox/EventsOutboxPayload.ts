export interface EventsOutboxPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxPayloadValidator {
  public static validate(data: Partial<EventsOutboxPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
