export interface EventsOutboxTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxTransactionValidator {
  public static validate(data: Partial<EventsOutboxTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
