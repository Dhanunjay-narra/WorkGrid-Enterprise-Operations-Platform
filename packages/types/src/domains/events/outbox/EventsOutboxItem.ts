export interface EventsOutboxItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxItemValidator {
  public static validate(data: Partial<EventsOutboxItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
