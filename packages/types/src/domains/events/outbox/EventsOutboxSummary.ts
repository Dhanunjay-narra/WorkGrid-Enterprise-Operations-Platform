export interface EventsOutboxSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsOutboxSummaryValidator {
  public static validate(data: Partial<EventsOutboxSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
