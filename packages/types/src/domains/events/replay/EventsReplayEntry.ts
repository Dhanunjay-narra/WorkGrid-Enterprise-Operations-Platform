export interface EventsReplayEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayEntryValidator {
  public static validate(data: Partial<EventsReplayEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
