export interface EventsReplayMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayMappingValidator {
  public static validate(data: Partial<EventsReplayMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
