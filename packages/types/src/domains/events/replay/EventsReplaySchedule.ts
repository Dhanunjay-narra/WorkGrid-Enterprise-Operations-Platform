export interface EventsReplayScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayScheduleValidator {
  public static validate(data: Partial<EventsReplayScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
