export interface EventsReplayPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayPolicyValidator {
  public static validate(data: Partial<EventsReplayPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
