export interface EventsReplayTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayTransactionValidator {
  public static validate(data: Partial<EventsReplayTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
