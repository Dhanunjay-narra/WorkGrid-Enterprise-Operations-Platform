export interface EventsReplayThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayThresholdValidator {
  public static validate(data: Partial<EventsReplayThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
