export interface EventsReplayBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayBatchValidator {
  public static validate(data: Partial<EventsReplayBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
