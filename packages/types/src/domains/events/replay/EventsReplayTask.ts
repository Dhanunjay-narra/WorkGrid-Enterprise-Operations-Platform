export interface EventsReplayTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayTaskValidator {
  public static validate(data: Partial<EventsReplayTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
