export interface EventsReplayConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayConfigValidator {
  public static validate(data: Partial<EventsReplayConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
