export interface EventsReplaySnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplaySnapshotValidator {
  public static validate(data: Partial<EventsReplaySnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
