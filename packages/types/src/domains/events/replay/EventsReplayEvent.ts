export interface EventsReplayEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayEventValidator {
  public static validate(data: Partial<EventsReplayEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
