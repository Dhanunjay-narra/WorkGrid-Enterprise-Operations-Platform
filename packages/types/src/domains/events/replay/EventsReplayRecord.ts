export interface EventsReplayRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayRecordValidator {
  public static validate(data: Partial<EventsReplayRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
