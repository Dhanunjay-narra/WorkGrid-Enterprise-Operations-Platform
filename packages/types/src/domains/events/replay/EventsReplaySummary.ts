export interface EventsReplaySummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplaySummaryValidator {
  public static validate(data: Partial<EventsReplaySummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
