export interface EventsReplayProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayProfileValidator {
  public static validate(data: Partial<EventsReplayProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
