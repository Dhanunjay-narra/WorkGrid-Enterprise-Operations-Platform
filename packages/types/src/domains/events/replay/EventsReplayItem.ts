export interface EventsReplayItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayItemValidator {
  public static validate(data: Partial<EventsReplayItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
