export interface EventsReplayAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayAssignmentValidator {
  public static validate(data: Partial<EventsReplayAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
