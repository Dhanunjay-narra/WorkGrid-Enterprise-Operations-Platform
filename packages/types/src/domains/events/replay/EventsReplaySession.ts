export interface EventsReplaySessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplaySessionValidator {
  public static validate(data: Partial<EventsReplaySessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
