export interface EventsReplayMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayMetricValidator {
  public static validate(data: Partial<EventsReplayMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
