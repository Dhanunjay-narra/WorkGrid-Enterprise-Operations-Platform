export interface EventsReplayNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayNodeValidator {
  public static validate(data: Partial<EventsReplayNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
