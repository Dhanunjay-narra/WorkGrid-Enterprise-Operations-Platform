export interface EventsReplayRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayRuleValidator {
  public static validate(data: Partial<EventsReplayRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
