export interface EventsReplayQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayQueueValidator {
  public static validate(data: Partial<EventsReplayQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
