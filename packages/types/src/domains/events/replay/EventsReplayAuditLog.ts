export interface EventsReplayAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayAuditLogValidator {
  public static validate(data: Partial<EventsReplayAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
