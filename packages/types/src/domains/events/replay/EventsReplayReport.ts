export interface EventsReplayReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayReportValidator {
  public static validate(data: Partial<EventsReplayReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
