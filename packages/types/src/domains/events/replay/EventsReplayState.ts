export interface EventsReplayStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsReplayStateValidator {
  public static validate(data: Partial<EventsReplayStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
