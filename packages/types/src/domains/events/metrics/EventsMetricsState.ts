export interface EventsMetricsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsStateValidator {
  public static validate(data: Partial<EventsMetricsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
