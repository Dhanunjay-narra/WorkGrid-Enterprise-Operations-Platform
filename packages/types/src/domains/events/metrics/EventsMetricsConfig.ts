export interface EventsMetricsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsConfigValidator {
  public static validate(data: Partial<EventsMetricsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
