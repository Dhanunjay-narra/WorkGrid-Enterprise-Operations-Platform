export interface EventsMetricsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsPolicyValidator {
  public static validate(data: Partial<EventsMetricsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
