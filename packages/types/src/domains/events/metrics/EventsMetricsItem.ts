export interface EventsMetricsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsItemValidator {
  public static validate(data: Partial<EventsMetricsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
