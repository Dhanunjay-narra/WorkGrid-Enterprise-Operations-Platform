export interface EventsMetricsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsQueueValidator {
  public static validate(data: Partial<EventsMetricsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
