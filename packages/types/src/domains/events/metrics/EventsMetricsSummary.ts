export interface EventsMetricsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsSummaryValidator {
  public static validate(data: Partial<EventsMetricsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
