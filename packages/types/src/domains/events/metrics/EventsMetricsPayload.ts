export interface EventsMetricsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsPayloadValidator {
  public static validate(data: Partial<EventsMetricsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
