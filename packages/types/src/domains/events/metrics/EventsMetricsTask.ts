export interface EventsMetricsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsTaskValidator {
  public static validate(data: Partial<EventsMetricsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
