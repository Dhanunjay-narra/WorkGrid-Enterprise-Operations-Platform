export interface EventsMetricsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsAssignmentValidator {
  public static validate(data: Partial<EventsMetricsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
