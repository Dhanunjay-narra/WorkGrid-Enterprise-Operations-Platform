export interface EventsMetricsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsThresholdValidator {
  public static validate(data: Partial<EventsMetricsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
