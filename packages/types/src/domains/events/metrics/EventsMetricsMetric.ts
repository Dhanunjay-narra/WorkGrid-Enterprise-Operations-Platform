export interface EventsMetricsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsMetricValidator {
  public static validate(data: Partial<EventsMetricsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
