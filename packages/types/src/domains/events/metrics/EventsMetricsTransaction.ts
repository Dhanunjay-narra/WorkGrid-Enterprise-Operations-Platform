export interface EventsMetricsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsTransactionValidator {
  public static validate(data: Partial<EventsMetricsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
