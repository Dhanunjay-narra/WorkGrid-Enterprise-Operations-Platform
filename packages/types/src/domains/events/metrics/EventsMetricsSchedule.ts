export interface EventsMetricsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsScheduleValidator {
  public static validate(data: Partial<EventsMetricsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
