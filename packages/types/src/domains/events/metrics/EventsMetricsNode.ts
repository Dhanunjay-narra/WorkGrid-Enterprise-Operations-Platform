export interface EventsMetricsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsNodeValidator {
  public static validate(data: Partial<EventsMetricsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
