export interface EventsMetricsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsBatchValidator {
  public static validate(data: Partial<EventsMetricsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
