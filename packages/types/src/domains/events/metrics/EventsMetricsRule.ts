export interface EventsMetricsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsRuleValidator {
  public static validate(data: Partial<EventsMetricsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
