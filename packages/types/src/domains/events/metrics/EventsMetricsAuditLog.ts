export interface EventsMetricsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsAuditLogValidator {
  public static validate(data: Partial<EventsMetricsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
