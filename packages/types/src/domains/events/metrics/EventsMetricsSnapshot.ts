export interface EventsMetricsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsSnapshotValidator {
  public static validate(data: Partial<EventsMetricsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
