export interface EventsMetricsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsEntryValidator {
  public static validate(data: Partial<EventsMetricsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
