export interface EventsMetricsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsProfileValidator {
  public static validate(data: Partial<EventsMetricsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
