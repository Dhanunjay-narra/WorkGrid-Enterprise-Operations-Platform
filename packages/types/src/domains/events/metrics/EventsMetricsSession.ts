export interface EventsMetricsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsSessionValidator {
  public static validate(data: Partial<EventsMetricsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
