export interface EventsMetricsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsReportValidator {
  public static validate(data: Partial<EventsMetricsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
