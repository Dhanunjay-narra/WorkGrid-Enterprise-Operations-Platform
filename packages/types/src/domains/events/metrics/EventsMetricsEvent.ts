export interface EventsMetricsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsEventValidator {
  public static validate(data: Partial<EventsMetricsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
