export interface EventsMetricsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsMappingValidator {
  public static validate(data: Partial<EventsMetricsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
