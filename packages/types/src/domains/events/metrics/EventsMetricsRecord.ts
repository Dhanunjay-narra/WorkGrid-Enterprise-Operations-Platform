export interface EventsMetricsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsMetricsRecordValidator {
  public static validate(data: Partial<EventsMetricsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
