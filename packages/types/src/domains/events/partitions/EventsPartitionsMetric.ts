export interface EventsPartitionsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsMetricValidator {
  public static validate(data: Partial<EventsPartitionsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
