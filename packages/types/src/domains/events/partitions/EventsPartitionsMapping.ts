export interface EventsPartitionsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsMappingValidator {
  public static validate(data: Partial<EventsPartitionsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
