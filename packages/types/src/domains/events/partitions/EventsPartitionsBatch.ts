export interface EventsPartitionsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsBatchValidator {
  public static validate(data: Partial<EventsPartitionsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
