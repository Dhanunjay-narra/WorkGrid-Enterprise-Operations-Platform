export interface EventsPartitionsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsEntryValidator {
  public static validate(data: Partial<EventsPartitionsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
