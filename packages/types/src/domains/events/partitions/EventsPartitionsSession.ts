export interface EventsPartitionsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsSessionValidator {
  public static validate(data: Partial<EventsPartitionsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
