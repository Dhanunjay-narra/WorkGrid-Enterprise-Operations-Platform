export interface EventsPartitionsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsThresholdValidator {
  public static validate(data: Partial<EventsPartitionsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
