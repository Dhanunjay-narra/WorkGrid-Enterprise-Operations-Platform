export interface EventsPartitionsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsAssignmentValidator {
  public static validate(data: Partial<EventsPartitionsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
