export interface EventsPartitionsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsNodeValidator {
  public static validate(data: Partial<EventsPartitionsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
