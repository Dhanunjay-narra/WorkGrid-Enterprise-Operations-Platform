export interface EventsPartitionsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsStateValidator {
  public static validate(data: Partial<EventsPartitionsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
