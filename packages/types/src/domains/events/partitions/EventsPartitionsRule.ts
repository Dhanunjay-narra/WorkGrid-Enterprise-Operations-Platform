export interface EventsPartitionsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsRuleValidator {
  public static validate(data: Partial<EventsPartitionsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
