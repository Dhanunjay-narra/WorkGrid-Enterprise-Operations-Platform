export interface EventsPartitionsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsRecordValidator {
  public static validate(data: Partial<EventsPartitionsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
