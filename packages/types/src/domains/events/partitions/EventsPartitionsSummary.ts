export interface EventsPartitionsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsSummaryValidator {
  public static validate(data: Partial<EventsPartitionsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
