export interface EventsPartitionsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsPolicyValidator {
  public static validate(data: Partial<EventsPartitionsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
