export interface EventsPartitionsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsProfileValidator {
  public static validate(data: Partial<EventsPartitionsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
