export interface EventsPartitionsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsItemValidator {
  public static validate(data: Partial<EventsPartitionsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
