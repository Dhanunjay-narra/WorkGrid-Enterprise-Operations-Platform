export interface EventsPartitionsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsScheduleValidator {
  public static validate(data: Partial<EventsPartitionsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
