export interface EventsPartitionsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsPayloadValidator {
  public static validate(data: Partial<EventsPartitionsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
