export interface EventsPartitionsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsReportValidator {
  public static validate(data: Partial<EventsPartitionsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
