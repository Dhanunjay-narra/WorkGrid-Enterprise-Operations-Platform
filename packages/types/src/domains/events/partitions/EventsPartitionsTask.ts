export interface EventsPartitionsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsTaskValidator {
  public static validate(data: Partial<EventsPartitionsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
