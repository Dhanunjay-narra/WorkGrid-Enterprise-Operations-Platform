export interface EventsPartitionsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsQueueValidator {
  public static validate(data: Partial<EventsPartitionsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
