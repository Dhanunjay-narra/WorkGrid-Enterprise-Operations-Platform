export interface EventsPartitionsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsConfigValidator {
  public static validate(data: Partial<EventsPartitionsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
