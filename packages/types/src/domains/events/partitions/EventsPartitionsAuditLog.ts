export interface EventsPartitionsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsAuditLogValidator {
  public static validate(data: Partial<EventsPartitionsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
