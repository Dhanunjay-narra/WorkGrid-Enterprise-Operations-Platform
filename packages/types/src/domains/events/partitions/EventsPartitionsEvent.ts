export interface EventsPartitionsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsEventValidator {
  public static validate(data: Partial<EventsPartitionsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
