export interface EventsPartitionsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsTransactionValidator {
  public static validate(data: Partial<EventsPartitionsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
