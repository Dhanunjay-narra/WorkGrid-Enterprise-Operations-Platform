export interface EventsPartitionsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsPartitionsSnapshotValidator {
  public static validate(data: Partial<EventsPartitionsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
