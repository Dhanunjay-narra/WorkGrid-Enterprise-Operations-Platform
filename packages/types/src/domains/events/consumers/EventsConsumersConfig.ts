export interface EventsConsumersConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersConfigValidator {
  public static validate(data: Partial<EventsConsumersConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
