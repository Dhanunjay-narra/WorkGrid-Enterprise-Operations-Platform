export interface EventsConsumersReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersReportValidator {
  public static validate(data: Partial<EventsConsumersReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
