export interface EventsConsumersScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersScheduleValidator {
  public static validate(data: Partial<EventsConsumersScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
