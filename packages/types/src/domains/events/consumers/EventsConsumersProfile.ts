export interface EventsConsumersProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersProfileValidator {
  public static validate(data: Partial<EventsConsumersProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
