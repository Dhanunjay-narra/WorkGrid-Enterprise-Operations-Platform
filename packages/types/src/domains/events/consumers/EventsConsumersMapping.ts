export interface EventsConsumersMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersMappingValidator {
  public static validate(data: Partial<EventsConsumersMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
