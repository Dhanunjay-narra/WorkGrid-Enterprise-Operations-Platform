export interface EventsConsumersRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersRuleValidator {
  public static validate(data: Partial<EventsConsumersRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
