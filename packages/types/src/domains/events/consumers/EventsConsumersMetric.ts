export interface EventsConsumersMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersMetricValidator {
  public static validate(data: Partial<EventsConsumersMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
