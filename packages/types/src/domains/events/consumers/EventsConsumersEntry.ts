export interface EventsConsumersEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersEntryValidator {
  public static validate(data: Partial<EventsConsumersEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
