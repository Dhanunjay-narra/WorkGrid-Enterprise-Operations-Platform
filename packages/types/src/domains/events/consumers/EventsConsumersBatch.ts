export interface EventsConsumersBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersBatchValidator {
  public static validate(data: Partial<EventsConsumersBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
