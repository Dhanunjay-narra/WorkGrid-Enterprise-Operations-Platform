export interface EventsConsumersSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersSummaryValidator {
  public static validate(data: Partial<EventsConsumersSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
