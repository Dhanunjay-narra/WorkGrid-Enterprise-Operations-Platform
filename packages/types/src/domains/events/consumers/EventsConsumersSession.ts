export interface EventsConsumersSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersSessionValidator {
  public static validate(data: Partial<EventsConsumersSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
