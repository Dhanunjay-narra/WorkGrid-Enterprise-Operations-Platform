export interface EventsConsumersSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersSnapshotValidator {
  public static validate(data: Partial<EventsConsumersSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
