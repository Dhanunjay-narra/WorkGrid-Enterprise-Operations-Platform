export interface EventsConsumersRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersRecordValidator {
  public static validate(data: Partial<EventsConsumersRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
