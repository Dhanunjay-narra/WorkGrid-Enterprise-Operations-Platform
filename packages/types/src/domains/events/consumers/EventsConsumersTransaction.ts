export interface EventsConsumersTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersTransactionValidator {
  public static validate(data: Partial<EventsConsumersTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
