export interface EventsConsumersItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersItemValidator {
  public static validate(data: Partial<EventsConsumersItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
