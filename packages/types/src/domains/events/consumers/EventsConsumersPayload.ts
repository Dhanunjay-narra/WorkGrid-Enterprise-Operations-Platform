export interface EventsConsumersPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersPayloadValidator {
  public static validate(data: Partial<EventsConsumersPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
