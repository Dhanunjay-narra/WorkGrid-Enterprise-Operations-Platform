export interface EventsConsumersNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersNodeValidator {
  public static validate(data: Partial<EventsConsumersNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
