export interface EventsConsumersPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersPolicyValidator {
  public static validate(data: Partial<EventsConsumersPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
