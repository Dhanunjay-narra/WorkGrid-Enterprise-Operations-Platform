export interface EventsConsumersQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersQueueValidator {
  public static validate(data: Partial<EventsConsumersQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
