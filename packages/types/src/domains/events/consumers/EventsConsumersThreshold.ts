export interface EventsConsumersThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersThresholdValidator {
  public static validate(data: Partial<EventsConsumersThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
