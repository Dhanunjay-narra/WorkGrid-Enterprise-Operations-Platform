export interface EventsConsumersAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersAuditLogValidator {
  public static validate(data: Partial<EventsConsumersAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
