export interface EventsConsumersTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersTaskValidator {
  public static validate(data: Partial<EventsConsumersTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
