export interface EventsConsumersAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersAssignmentValidator {
  public static validate(data: Partial<EventsConsumersAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
