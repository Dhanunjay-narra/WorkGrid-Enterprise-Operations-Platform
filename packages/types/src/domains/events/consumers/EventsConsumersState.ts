export interface EventsConsumersStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersStateValidator {
  public static validate(data: Partial<EventsConsumersStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
