export interface EventsConsumersEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class EventsConsumersEventValidator {
  public static validate(data: Partial<EventsConsumersEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
