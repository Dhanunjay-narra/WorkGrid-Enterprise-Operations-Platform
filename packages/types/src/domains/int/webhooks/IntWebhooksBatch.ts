export interface IntWebhooksBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksBatchValidator {
  public static validate(data: Partial<IntWebhooksBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
