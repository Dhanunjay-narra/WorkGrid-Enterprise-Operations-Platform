export interface IntWebhooksEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksEventValidator {
  public static validate(data: Partial<IntWebhooksEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
