export interface IntWebhooksScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksScheduleValidator {
  public static validate(data: Partial<IntWebhooksScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
