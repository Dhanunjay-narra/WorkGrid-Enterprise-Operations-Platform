export interface IntWebhooksRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksRuleValidator {
  public static validate(data: Partial<IntWebhooksRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
