export interface IntWebhooksPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksPolicyValidator {
  public static validate(data: Partial<IntWebhooksPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
