export interface IntWebhooksReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksReportValidator {
  public static validate(data: Partial<IntWebhooksReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
