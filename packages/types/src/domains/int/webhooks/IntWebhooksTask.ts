export interface IntWebhooksTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksTaskValidator {
  public static validate(data: Partial<IntWebhooksTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
