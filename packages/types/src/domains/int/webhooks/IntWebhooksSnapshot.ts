export interface IntWebhooksSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksSnapshotValidator {
  public static validate(data: Partial<IntWebhooksSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
