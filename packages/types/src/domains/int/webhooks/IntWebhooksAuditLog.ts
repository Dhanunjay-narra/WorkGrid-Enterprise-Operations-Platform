export interface IntWebhooksAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksAuditLogValidator {
  public static validate(data: Partial<IntWebhooksAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
