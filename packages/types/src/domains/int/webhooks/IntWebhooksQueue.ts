export interface IntWebhooksQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksQueueValidator {
  public static validate(data: Partial<IntWebhooksQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
