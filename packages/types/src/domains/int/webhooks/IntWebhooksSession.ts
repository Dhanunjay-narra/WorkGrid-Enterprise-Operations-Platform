export interface IntWebhooksSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksSessionValidator {
  public static validate(data: Partial<IntWebhooksSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
