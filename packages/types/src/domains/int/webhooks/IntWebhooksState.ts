export interface IntWebhooksStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksStateValidator {
  public static validate(data: Partial<IntWebhooksStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
