export interface IntWebhooksPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksPayloadValidator {
  public static validate(data: Partial<IntWebhooksPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
