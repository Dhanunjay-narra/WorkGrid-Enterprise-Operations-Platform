export interface IntWebhooksNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksNodeValidator {
  public static validate(data: Partial<IntWebhooksNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
