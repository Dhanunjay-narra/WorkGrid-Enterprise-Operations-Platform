export interface IntWebhooksProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksProfileValidator {
  public static validate(data: Partial<IntWebhooksProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
