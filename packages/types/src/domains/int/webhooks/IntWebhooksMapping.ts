export interface IntWebhooksMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksMappingValidator {
  public static validate(data: Partial<IntWebhooksMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
