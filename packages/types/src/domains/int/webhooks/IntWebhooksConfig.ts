export interface IntWebhooksConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksConfigValidator {
  public static validate(data: Partial<IntWebhooksConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
