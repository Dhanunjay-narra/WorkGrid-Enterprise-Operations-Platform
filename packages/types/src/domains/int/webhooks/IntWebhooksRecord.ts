export interface IntWebhooksRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksRecordValidator {
  public static validate(data: Partial<IntWebhooksRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
