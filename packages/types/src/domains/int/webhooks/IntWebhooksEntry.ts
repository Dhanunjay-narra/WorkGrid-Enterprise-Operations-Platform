export interface IntWebhooksEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksEntryValidator {
  public static validate(data: Partial<IntWebhooksEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
