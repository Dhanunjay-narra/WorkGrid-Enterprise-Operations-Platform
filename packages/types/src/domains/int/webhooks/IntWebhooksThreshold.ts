export interface IntWebhooksThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksThresholdValidator {
  public static validate(data: Partial<IntWebhooksThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
