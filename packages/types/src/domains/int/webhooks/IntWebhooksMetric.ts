export interface IntWebhooksMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksMetricValidator {
  public static validate(data: Partial<IntWebhooksMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
