export interface IntWebhooksSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksSummaryValidator {
  public static validate(data: Partial<IntWebhooksSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
