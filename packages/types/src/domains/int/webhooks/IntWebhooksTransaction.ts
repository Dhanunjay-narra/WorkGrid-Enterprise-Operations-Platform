export interface IntWebhooksTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksTransactionValidator {
  public static validate(data: Partial<IntWebhooksTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
