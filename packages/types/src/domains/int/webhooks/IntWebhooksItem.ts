export interface IntWebhooksItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksItemValidator {
  public static validate(data: Partial<IntWebhooksItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
