export interface IntWebhooksAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntWebhooksAssignmentValidator {
  public static validate(data: Partial<IntWebhooksAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
