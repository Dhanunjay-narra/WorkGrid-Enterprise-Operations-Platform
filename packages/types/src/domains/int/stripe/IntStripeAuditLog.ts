export interface IntStripeAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeAuditLogValidator {
  public static validate(data: Partial<IntStripeAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
