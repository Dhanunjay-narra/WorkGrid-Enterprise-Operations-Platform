export interface IntStripePayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripePayloadValidator {
  public static validate(data: Partial<IntStripePayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
