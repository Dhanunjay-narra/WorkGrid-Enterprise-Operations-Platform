export interface IntStripeSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeSnapshotValidator {
  public static validate(data: Partial<IntStripeSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
