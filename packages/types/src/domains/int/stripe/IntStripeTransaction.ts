export interface IntStripeTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeTransactionValidator {
  public static validate(data: Partial<IntStripeTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
