export interface IntStripeSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeSessionValidator {
  public static validate(data: Partial<IntStripeSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
