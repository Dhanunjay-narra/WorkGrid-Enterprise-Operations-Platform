export interface IntStripeConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeConfigValidator {
  public static validate(data: Partial<IntStripeConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
