export interface IntStripeEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeEntryValidator {
  public static validate(data: Partial<IntStripeEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
