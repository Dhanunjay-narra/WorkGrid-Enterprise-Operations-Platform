export interface IntStripeItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeItemValidator {
  public static validate(data: Partial<IntStripeItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
