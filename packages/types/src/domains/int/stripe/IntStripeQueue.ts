export interface IntStripeQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeQueueValidator {
  public static validate(data: Partial<IntStripeQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
