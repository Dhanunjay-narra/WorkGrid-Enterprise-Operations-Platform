export interface IntStripeMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeMetricValidator {
  public static validate(data: Partial<IntStripeMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
