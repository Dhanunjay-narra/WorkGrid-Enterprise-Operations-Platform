export interface IntStripeStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeStateValidator {
  public static validate(data: Partial<IntStripeStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
