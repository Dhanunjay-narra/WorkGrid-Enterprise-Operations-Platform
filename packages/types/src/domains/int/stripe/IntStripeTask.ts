export interface IntStripeTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeTaskValidator {
  public static validate(data: Partial<IntStripeTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
