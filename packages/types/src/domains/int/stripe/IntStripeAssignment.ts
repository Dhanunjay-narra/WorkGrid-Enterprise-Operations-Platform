export interface IntStripeAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeAssignmentValidator {
  public static validate(data: Partial<IntStripeAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
