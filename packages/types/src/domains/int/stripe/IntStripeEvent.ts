export interface IntStripeEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeEventValidator {
  public static validate(data: Partial<IntStripeEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
