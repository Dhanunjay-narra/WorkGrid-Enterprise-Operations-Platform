export interface IntStripeBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeBatchValidator {
  public static validate(data: Partial<IntStripeBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
