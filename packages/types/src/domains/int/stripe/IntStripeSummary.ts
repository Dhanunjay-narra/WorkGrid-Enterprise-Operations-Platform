export interface IntStripeSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeSummaryValidator {
  public static validate(data: Partial<IntStripeSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
