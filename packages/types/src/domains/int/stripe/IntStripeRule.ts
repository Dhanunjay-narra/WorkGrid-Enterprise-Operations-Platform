export interface IntStripeRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeRuleValidator {
  public static validate(data: Partial<IntStripeRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
