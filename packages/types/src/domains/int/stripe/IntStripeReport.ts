export interface IntStripeReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeReportValidator {
  public static validate(data: Partial<IntStripeReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
