export interface IntStripePolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripePolicyValidator {
  public static validate(data: Partial<IntStripePolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
