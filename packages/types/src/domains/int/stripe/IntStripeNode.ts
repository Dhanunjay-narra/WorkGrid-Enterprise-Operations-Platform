export interface IntStripeNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeNodeValidator {
  public static validate(data: Partial<IntStripeNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
