export interface IntStripeRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeRecordValidator {
  public static validate(data: Partial<IntStripeRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
