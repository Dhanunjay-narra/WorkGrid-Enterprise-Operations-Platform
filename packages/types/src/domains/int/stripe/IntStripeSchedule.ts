export interface IntStripeScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeScheduleValidator {
  public static validate(data: Partial<IntStripeScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
