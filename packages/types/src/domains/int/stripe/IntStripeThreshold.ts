export interface IntStripeThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeThresholdValidator {
  public static validate(data: Partial<IntStripeThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
