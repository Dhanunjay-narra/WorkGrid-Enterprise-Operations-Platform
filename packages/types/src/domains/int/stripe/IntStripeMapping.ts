export interface IntStripeMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeMappingValidator {
  public static validate(data: Partial<IntStripeMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
