export interface IntStripeProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntStripeProfileValidator {
  public static validate(data: Partial<IntStripeProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
