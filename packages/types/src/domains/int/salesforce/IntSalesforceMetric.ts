export interface IntSalesforceMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceMetricValidator {
  public static validate(data: Partial<IntSalesforceMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
