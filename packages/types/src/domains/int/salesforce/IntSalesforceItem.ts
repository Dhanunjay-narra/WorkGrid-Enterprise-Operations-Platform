export interface IntSalesforceItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceItemValidator {
  public static validate(data: Partial<IntSalesforceItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
