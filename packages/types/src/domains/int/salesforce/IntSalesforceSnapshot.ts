export interface IntSalesforceSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceSnapshotValidator {
  public static validate(data: Partial<IntSalesforceSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
