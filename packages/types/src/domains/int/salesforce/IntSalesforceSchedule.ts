export interface IntSalesforceScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceScheduleValidator {
  public static validate(data: Partial<IntSalesforceScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
