export interface IntSalesforcePayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforcePayloadValidator {
  public static validate(data: Partial<IntSalesforcePayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
