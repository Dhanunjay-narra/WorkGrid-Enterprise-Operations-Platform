export interface IntSalesforceMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceMappingValidator {
  public static validate(data: Partial<IntSalesforceMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
