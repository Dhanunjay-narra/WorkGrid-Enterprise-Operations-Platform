export interface IntSalesforceBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceBatchValidator {
  public static validate(data: Partial<IntSalesforceBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
