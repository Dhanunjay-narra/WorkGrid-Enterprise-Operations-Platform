export interface IntSalesforceConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceConfigValidator {
  public static validate(data: Partial<IntSalesforceConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
