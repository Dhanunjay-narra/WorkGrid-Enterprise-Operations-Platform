export interface IntSalesforceEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceEventValidator {
  public static validate(data: Partial<IntSalesforceEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
