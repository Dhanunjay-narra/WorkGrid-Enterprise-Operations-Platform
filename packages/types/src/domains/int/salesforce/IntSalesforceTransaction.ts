export interface IntSalesforceTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceTransactionValidator {
  public static validate(data: Partial<IntSalesforceTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
