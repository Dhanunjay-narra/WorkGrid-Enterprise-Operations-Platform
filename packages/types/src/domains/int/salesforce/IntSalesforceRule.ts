export interface IntSalesforceRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceRuleValidator {
  public static validate(data: Partial<IntSalesforceRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
