export interface IntSalesforceTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceTaskValidator {
  public static validate(data: Partial<IntSalesforceTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
