export interface IntSalesforceSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceSessionValidator {
  public static validate(data: Partial<IntSalesforceSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
