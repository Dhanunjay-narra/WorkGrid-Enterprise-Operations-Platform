export interface IntSalesforceProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceProfileValidator {
  public static validate(data: Partial<IntSalesforceProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
