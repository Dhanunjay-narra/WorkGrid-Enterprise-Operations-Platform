export interface IntSalesforceThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceThresholdValidator {
  public static validate(data: Partial<IntSalesforceThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
