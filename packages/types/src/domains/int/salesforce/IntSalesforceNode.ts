export interface IntSalesforceNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceNodeValidator {
  public static validate(data: Partial<IntSalesforceNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
