export interface IntSalesforceEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceEntryValidator {
  public static validate(data: Partial<IntSalesforceEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
