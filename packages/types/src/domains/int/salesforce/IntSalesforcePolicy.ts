export interface IntSalesforcePolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforcePolicyValidator {
  public static validate(data: Partial<IntSalesforcePolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
