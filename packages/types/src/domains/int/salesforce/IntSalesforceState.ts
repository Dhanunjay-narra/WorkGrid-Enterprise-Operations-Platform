export interface IntSalesforceStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceStateValidator {
  public static validate(data: Partial<IntSalesforceStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
