export interface IntSalesforceAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceAssignmentValidator {
  public static validate(data: Partial<IntSalesforceAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
