export interface IntSalesforceQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceQueueValidator {
  public static validate(data: Partial<IntSalesforceQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
