export interface IntSalesforceSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceSummaryValidator {
  public static validate(data: Partial<IntSalesforceSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
