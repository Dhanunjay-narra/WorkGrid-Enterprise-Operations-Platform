export interface IntSalesforceReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceReportValidator {
  public static validate(data: Partial<IntSalesforceReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
