export interface IntSalesforceAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSalesforceAuditLogValidator {
  public static validate(data: Partial<IntSalesforceAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
