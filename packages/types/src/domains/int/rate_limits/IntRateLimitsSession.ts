export interface IntRateLimitsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsSessionValidator {
  public static validate(data: Partial<IntRateLimitsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
