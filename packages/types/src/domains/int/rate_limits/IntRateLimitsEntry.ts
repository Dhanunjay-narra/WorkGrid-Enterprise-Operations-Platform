export interface IntRateLimitsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsEntryValidator {
  public static validate(data: Partial<IntRateLimitsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
