export interface IntRateLimitsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsConfigValidator {
  public static validate(data: Partial<IntRateLimitsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
