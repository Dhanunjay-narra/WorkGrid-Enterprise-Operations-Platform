export interface IntRateLimitsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsNodeValidator {
  public static validate(data: Partial<IntRateLimitsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
