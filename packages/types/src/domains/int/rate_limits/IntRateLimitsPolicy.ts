export interface IntRateLimitsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsPolicyValidator {
  public static validate(data: Partial<IntRateLimitsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
