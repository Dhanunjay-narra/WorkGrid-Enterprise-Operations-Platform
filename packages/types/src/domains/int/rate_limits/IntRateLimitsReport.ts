export interface IntRateLimitsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsReportValidator {
  public static validate(data: Partial<IntRateLimitsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
