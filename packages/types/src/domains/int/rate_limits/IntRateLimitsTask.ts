export interface IntRateLimitsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsTaskValidator {
  public static validate(data: Partial<IntRateLimitsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
