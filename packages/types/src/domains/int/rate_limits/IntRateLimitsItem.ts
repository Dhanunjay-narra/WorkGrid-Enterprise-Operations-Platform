export interface IntRateLimitsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsItemValidator {
  public static validate(data: Partial<IntRateLimitsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
