export interface IntRateLimitsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsEventValidator {
  public static validate(data: Partial<IntRateLimitsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
