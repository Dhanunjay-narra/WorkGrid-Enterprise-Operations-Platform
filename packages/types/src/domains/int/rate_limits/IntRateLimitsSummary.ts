export interface IntRateLimitsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsSummaryValidator {
  public static validate(data: Partial<IntRateLimitsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
