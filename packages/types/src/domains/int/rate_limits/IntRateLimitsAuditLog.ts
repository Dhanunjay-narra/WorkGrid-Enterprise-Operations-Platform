export interface IntRateLimitsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsAuditLogValidator {
  public static validate(data: Partial<IntRateLimitsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
