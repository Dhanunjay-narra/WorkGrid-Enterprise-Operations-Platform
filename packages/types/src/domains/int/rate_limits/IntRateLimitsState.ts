export interface IntRateLimitsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsStateValidator {
  public static validate(data: Partial<IntRateLimitsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
