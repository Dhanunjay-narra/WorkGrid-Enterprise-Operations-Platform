export interface IntRateLimitsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsRuleValidator {
  public static validate(data: Partial<IntRateLimitsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
