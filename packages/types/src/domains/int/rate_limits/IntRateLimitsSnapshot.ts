export interface IntRateLimitsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsSnapshotValidator {
  public static validate(data: Partial<IntRateLimitsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
