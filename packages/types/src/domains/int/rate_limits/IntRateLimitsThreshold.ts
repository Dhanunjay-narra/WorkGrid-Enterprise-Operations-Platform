export interface IntRateLimitsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsThresholdValidator {
  public static validate(data: Partial<IntRateLimitsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
