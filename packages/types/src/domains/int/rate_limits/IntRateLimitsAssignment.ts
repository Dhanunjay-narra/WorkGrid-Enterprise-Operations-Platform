export interface IntRateLimitsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsAssignmentValidator {
  public static validate(data: Partial<IntRateLimitsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
