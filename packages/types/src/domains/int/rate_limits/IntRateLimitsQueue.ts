export interface IntRateLimitsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsQueueValidator {
  public static validate(data: Partial<IntRateLimitsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
