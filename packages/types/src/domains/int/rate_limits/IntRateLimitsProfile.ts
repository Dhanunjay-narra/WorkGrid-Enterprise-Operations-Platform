export interface IntRateLimitsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsProfileValidator {
  public static validate(data: Partial<IntRateLimitsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
