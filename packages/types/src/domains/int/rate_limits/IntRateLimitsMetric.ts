export interface IntRateLimitsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsMetricValidator {
  public static validate(data: Partial<IntRateLimitsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
