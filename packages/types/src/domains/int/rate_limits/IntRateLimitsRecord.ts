export interface IntRateLimitsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsRecordValidator {
  public static validate(data: Partial<IntRateLimitsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
