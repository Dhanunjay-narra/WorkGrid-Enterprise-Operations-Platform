export interface IntRateLimitsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsMappingValidator {
  public static validate(data: Partial<IntRateLimitsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
