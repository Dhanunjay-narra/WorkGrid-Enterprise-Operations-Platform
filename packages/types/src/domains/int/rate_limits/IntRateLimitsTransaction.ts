export interface IntRateLimitsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsTransactionValidator {
  public static validate(data: Partial<IntRateLimitsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
