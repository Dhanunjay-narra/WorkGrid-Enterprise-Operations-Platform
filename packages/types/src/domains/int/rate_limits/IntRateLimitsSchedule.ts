export interface IntRateLimitsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsScheduleValidator {
  public static validate(data: Partial<IntRateLimitsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
