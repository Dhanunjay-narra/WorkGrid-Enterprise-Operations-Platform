export interface IntRateLimitsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntRateLimitsPayloadValidator {
  public static validate(data: Partial<IntRateLimitsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
