export interface IntSyncMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncMetricValidator {
  public static validate(data: Partial<IntSyncMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
