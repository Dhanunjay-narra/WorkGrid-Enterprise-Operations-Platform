export interface IntSyncPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncPolicyValidator {
  public static validate(data: Partial<IntSyncPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
