export interface IntSyncRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncRecordValidator {
  public static validate(data: Partial<IntSyncRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
