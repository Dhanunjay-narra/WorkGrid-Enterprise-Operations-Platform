export interface IntSyncThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncThresholdValidator {
  public static validate(data: Partial<IntSyncThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
