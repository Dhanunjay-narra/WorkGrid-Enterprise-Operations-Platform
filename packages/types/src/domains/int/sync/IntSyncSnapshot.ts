export interface IntSyncSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncSnapshotValidator {
  public static validate(data: Partial<IntSyncSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
