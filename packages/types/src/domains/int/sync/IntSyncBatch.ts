export interface IntSyncBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncBatchValidator {
  public static validate(data: Partial<IntSyncBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
