export interface IntSyncSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncSummaryValidator {
  public static validate(data: Partial<IntSyncSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
