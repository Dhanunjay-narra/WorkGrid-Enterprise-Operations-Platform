export interface IntSyncPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncPayloadValidator {
  public static validate(data: Partial<IntSyncPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
