export interface IntSyncEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncEventValidator {
  public static validate(data: Partial<IntSyncEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
