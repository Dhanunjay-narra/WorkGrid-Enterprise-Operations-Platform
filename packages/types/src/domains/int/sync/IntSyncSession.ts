export interface IntSyncSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncSessionValidator {
  public static validate(data: Partial<IntSyncSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
