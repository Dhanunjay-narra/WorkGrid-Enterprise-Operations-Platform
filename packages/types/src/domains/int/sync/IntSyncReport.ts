export interface IntSyncReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncReportValidator {
  public static validate(data: Partial<IntSyncReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
