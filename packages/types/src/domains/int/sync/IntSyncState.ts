export interface IntSyncStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncStateValidator {
  public static validate(data: Partial<IntSyncStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
