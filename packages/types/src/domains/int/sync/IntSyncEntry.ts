export interface IntSyncEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncEntryValidator {
  public static validate(data: Partial<IntSyncEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
