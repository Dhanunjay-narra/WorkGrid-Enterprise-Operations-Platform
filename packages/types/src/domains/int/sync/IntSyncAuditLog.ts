export interface IntSyncAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncAuditLogValidator {
  public static validate(data: Partial<IntSyncAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
