export interface IntSyncConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncConfigValidator {
  public static validate(data: Partial<IntSyncConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
