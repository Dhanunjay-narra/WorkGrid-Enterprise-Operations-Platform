export interface IntSyncTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncTransactionValidator {
  public static validate(data: Partial<IntSyncTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
