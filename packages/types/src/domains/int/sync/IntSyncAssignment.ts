export interface IntSyncAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncAssignmentValidator {
  public static validate(data: Partial<IntSyncAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
