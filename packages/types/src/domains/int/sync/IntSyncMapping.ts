export interface IntSyncMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncMappingValidator {
  public static validate(data: Partial<IntSyncMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
