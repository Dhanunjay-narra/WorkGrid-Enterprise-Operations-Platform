export interface IntSyncScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncScheduleValidator {
  public static validate(data: Partial<IntSyncScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
