export interface IntSyncProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncProfileValidator {
  public static validate(data: Partial<IntSyncProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
