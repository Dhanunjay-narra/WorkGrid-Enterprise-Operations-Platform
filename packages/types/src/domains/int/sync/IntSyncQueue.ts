export interface IntSyncQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSyncQueueValidator {
  public static validate(data: Partial<IntSyncQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
