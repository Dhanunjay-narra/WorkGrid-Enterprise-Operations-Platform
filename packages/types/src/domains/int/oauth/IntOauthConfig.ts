export interface IntOauthConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthConfigValidator {
  public static validate(data: Partial<IntOauthConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
