export interface IntOauthAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthAuditLogValidator {
  public static validate(data: Partial<IntOauthAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
