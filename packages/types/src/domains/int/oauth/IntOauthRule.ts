export interface IntOauthRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthRuleValidator {
  public static validate(data: Partial<IntOauthRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
