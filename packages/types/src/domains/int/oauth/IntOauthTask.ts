export interface IntOauthTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthTaskValidator {
  public static validate(data: Partial<IntOauthTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
