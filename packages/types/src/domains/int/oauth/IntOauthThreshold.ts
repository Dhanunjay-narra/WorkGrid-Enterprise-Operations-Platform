export interface IntOauthThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthThresholdValidator {
  public static validate(data: Partial<IntOauthThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
