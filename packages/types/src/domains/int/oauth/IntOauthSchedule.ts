export interface IntOauthScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthScheduleValidator {
  public static validate(data: Partial<IntOauthScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
