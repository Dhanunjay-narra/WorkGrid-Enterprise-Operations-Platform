export interface IntOauthEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthEventValidator {
  public static validate(data: Partial<IntOauthEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
