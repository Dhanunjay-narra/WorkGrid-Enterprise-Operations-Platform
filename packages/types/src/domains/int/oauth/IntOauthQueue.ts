export interface IntOauthQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthQueueValidator {
  public static validate(data: Partial<IntOauthQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
