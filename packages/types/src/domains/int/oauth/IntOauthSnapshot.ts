export interface IntOauthSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthSnapshotValidator {
  public static validate(data: Partial<IntOauthSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
