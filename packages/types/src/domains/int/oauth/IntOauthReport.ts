export interface IntOauthReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthReportValidator {
  public static validate(data: Partial<IntOauthReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
