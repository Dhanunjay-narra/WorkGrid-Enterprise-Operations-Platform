export interface IntOauthEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthEntryValidator {
  public static validate(data: Partial<IntOauthEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
