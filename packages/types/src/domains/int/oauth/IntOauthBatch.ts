export interface IntOauthBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthBatchValidator {
  public static validate(data: Partial<IntOauthBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
