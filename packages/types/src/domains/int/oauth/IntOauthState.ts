export interface IntOauthStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthStateValidator {
  public static validate(data: Partial<IntOauthStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
