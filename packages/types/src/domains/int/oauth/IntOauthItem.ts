export interface IntOauthItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthItemValidator {
  public static validate(data: Partial<IntOauthItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
