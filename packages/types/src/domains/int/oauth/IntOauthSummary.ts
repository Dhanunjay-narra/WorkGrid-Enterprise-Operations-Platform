export interface IntOauthSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthSummaryValidator {
  public static validate(data: Partial<IntOauthSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
