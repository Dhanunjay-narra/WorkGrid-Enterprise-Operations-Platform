export interface IntOauthProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthProfileValidator {
  public static validate(data: Partial<IntOauthProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
