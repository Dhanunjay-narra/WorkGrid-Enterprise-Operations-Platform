export interface IntOauthSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthSessionValidator {
  public static validate(data: Partial<IntOauthSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
