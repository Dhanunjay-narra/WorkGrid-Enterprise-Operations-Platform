export interface IntOauthPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthPolicyValidator {
  public static validate(data: Partial<IntOauthPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
