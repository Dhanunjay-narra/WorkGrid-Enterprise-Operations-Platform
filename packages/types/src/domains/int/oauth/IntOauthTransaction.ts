export interface IntOauthTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthTransactionValidator {
  public static validate(data: Partial<IntOauthTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
