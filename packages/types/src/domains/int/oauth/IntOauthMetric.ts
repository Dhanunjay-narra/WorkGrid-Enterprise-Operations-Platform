export interface IntOauthMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthMetricValidator {
  public static validate(data: Partial<IntOauthMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
