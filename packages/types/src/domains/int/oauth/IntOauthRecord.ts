export interface IntOauthRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthRecordValidator {
  public static validate(data: Partial<IntOauthRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
