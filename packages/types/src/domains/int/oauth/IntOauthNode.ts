export interface IntOauthNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthNodeValidator {
  public static validate(data: Partial<IntOauthNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
