export interface IntOauthMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthMappingValidator {
  public static validate(data: Partial<IntOauthMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
