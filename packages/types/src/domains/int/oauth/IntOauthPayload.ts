export interface IntOauthPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthPayloadValidator {
  public static validate(data: Partial<IntOauthPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
