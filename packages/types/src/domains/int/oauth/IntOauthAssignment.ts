export interface IntOauthAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntOauthAssignmentValidator {
  public static validate(data: Partial<IntOauthAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
