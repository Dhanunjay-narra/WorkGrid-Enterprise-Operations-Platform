export interface IntMappingsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsSummaryValidator {
  public static validate(data: Partial<IntMappingsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
