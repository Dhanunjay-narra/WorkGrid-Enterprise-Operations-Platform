export interface IntMappingsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsScheduleValidator {
  public static validate(data: Partial<IntMappingsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
