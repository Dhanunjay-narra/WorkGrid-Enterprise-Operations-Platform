export interface IntMappingsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsTransactionValidator {
  public static validate(data: Partial<IntMappingsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
