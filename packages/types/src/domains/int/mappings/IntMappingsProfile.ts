export interface IntMappingsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsProfileValidator {
  public static validate(data: Partial<IntMappingsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
