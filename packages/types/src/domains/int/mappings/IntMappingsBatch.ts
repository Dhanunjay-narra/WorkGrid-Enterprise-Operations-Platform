export interface IntMappingsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsBatchValidator {
  public static validate(data: Partial<IntMappingsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
