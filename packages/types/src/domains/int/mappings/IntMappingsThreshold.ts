export interface IntMappingsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsThresholdValidator {
  public static validate(data: Partial<IntMappingsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
