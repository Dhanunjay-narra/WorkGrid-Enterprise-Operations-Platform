export interface IntMappingsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsAuditLogValidator {
  public static validate(data: Partial<IntMappingsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
