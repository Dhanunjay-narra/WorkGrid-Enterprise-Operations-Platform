export interface IntMappingsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsConfigValidator {
  public static validate(data: Partial<IntMappingsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
