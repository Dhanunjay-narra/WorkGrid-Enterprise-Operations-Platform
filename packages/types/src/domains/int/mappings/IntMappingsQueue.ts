export interface IntMappingsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsQueueValidator {
  public static validate(data: Partial<IntMappingsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
