export interface IntMappingsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsPayloadValidator {
  public static validate(data: Partial<IntMappingsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
