export interface IntMappingsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsTaskValidator {
  public static validate(data: Partial<IntMappingsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
