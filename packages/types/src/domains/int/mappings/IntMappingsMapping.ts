export interface IntMappingsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsMappingValidator {
  public static validate(data: Partial<IntMappingsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
