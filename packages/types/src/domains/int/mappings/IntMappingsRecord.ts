export interface IntMappingsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsRecordValidator {
  public static validate(data: Partial<IntMappingsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
