export interface IntMappingsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsEventValidator {
  public static validate(data: Partial<IntMappingsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
