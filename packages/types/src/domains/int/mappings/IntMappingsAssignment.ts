export interface IntMappingsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsAssignmentValidator {
  public static validate(data: Partial<IntMappingsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
