export interface IntMappingsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsReportValidator {
  public static validate(data: Partial<IntMappingsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
