export interface IntMappingsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsMetricValidator {
  public static validate(data: Partial<IntMappingsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
