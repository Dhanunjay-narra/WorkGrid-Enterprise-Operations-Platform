export interface IntMappingsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsSnapshotValidator {
  public static validate(data: Partial<IntMappingsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
