export interface IntMappingsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsPolicyValidator {
  public static validate(data: Partial<IntMappingsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
