export interface IntMappingsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsStateValidator {
  public static validate(data: Partial<IntMappingsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
