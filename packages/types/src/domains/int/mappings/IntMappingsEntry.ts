export interface IntMappingsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsEntryValidator {
  public static validate(data: Partial<IntMappingsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
