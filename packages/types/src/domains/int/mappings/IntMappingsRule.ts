export interface IntMappingsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsRuleValidator {
  public static validate(data: Partial<IntMappingsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
