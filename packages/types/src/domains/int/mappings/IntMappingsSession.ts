export interface IntMappingsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsSessionValidator {
  public static validate(data: Partial<IntMappingsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
