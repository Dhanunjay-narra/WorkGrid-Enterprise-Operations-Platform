export interface IntMappingsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsNodeValidator {
  public static validate(data: Partial<IntMappingsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
