export interface IntMappingsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntMappingsItemValidator {
  public static validate(data: Partial<IntMappingsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
