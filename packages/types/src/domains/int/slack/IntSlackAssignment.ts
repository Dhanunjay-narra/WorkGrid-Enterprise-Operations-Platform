export interface IntSlackAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackAssignmentValidator {
  public static validate(data: Partial<IntSlackAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
