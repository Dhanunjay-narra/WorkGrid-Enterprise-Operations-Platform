export interface IntSlackAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackAuditLogValidator {
  public static validate(data: Partial<IntSlackAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
