export interface IntSlackSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackSessionValidator {
  public static validate(data: Partial<IntSlackSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
