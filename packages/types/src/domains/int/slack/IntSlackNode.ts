export interface IntSlackNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackNodeValidator {
  public static validate(data: Partial<IntSlackNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
