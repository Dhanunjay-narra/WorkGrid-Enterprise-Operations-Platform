export interface IntSlackConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackConfigValidator {
  public static validate(data: Partial<IntSlackConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
