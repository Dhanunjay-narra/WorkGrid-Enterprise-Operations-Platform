export interface IntSlackScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackScheduleValidator {
  public static validate(data: Partial<IntSlackScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
