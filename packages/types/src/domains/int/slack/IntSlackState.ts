export interface IntSlackStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackStateValidator {
  public static validate(data: Partial<IntSlackStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
