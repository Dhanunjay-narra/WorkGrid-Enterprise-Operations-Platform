export interface IntSlackRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackRuleValidator {
  public static validate(data: Partial<IntSlackRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
