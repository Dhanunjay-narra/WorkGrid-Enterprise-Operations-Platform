export interface IntSlackThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackThresholdValidator {
  public static validate(data: Partial<IntSlackThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
