export interface IntSlackEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackEventValidator {
  public static validate(data: Partial<IntSlackEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
