export interface IntSlackRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackRecordValidator {
  public static validate(data: Partial<IntSlackRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
