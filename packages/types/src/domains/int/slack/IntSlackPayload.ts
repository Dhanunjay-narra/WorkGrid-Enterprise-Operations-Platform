export interface IntSlackPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackPayloadValidator {
  public static validate(data: Partial<IntSlackPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
