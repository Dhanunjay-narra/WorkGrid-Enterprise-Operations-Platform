export interface IntSlackSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackSummaryValidator {
  public static validate(data: Partial<IntSlackSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
