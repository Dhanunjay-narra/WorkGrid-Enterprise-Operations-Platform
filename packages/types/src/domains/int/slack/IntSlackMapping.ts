export interface IntSlackMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackMappingValidator {
  public static validate(data: Partial<IntSlackMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
