export interface IntSlackQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackQueueValidator {
  public static validate(data: Partial<IntSlackQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
