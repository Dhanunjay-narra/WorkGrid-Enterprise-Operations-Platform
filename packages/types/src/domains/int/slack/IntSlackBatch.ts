export interface IntSlackBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackBatchValidator {
  public static validate(data: Partial<IntSlackBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
