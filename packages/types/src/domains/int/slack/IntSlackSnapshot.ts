export interface IntSlackSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackSnapshotValidator {
  public static validate(data: Partial<IntSlackSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
