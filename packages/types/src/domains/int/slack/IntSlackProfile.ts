export interface IntSlackProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackProfileValidator {
  public static validate(data: Partial<IntSlackProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
