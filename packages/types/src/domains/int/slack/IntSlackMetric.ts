export interface IntSlackMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackMetricValidator {
  public static validate(data: Partial<IntSlackMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
