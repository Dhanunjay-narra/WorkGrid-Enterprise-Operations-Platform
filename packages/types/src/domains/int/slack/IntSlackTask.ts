export interface IntSlackTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackTaskValidator {
  public static validate(data: Partial<IntSlackTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
