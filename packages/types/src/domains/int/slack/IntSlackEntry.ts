export interface IntSlackEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackEntryValidator {
  public static validate(data: Partial<IntSlackEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
