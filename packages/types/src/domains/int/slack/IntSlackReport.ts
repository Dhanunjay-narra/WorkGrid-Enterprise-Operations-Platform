export interface IntSlackReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackReportValidator {
  public static validate(data: Partial<IntSlackReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
