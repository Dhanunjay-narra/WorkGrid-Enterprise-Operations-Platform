export interface IntSlackTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackTransactionValidator {
  public static validate(data: Partial<IntSlackTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
