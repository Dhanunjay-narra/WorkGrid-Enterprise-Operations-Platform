export interface IntSlackItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackItemValidator {
  public static validate(data: Partial<IntSlackItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
