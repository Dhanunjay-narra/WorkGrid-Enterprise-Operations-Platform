export interface IntSlackPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IntSlackPolicyValidator {
  public static validate(data: Partial<IntSlackPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
