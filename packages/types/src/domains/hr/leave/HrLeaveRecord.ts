export interface HrLeaveRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveRecordValidator {
  public static validate(data: Partial<HrLeaveRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
