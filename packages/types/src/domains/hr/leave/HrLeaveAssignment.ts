export interface HrLeaveAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveAssignmentValidator {
  public static validate(data: Partial<HrLeaveAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
