export interface HrLeaveMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveMappingValidator {
  public static validate(data: Partial<HrLeaveMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
