export interface HrLeaveMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveMetricValidator {
  public static validate(data: Partial<HrLeaveMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
