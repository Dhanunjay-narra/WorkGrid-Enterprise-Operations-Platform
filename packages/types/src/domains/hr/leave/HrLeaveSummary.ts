export interface HrLeaveSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveSummaryValidator {
  public static validate(data: Partial<HrLeaveSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
