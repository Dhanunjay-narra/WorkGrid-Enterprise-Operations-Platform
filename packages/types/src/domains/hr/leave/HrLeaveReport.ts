export interface HrLeaveReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveReportValidator {
  public static validate(data: Partial<HrLeaveReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
