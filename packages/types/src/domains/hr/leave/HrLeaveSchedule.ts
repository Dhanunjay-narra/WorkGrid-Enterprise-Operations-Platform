export interface HrLeaveScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveScheduleValidator {
  public static validate(data: Partial<HrLeaveScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
