export interface HrLeaveProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveProfileValidator {
  public static validate(data: Partial<HrLeaveProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
