export interface HrLeaveConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveConfigValidator {
  public static validate(data: Partial<HrLeaveConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
