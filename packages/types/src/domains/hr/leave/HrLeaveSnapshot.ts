export interface HrLeaveSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveSnapshotValidator {
  public static validate(data: Partial<HrLeaveSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
