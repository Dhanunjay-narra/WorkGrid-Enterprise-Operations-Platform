export interface HrLeaveBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveBatchValidator {
  public static validate(data: Partial<HrLeaveBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
