export interface HrLeaveEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveEntryValidator {
  public static validate(data: Partial<HrLeaveEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
