export interface HrLeaveAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveAuditLogValidator {
  public static validate(data: Partial<HrLeaveAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
