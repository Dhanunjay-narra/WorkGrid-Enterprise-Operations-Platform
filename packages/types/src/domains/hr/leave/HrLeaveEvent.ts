export interface HrLeaveEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveEventValidator {
  public static validate(data: Partial<HrLeaveEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
