export interface HrLeaveStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveStateValidator {
  public static validate(data: Partial<HrLeaveStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
