export interface HrLeaveTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveTransactionValidator {
  public static validate(data: Partial<HrLeaveTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
