export interface HrLeaveSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveSessionValidator {
  public static validate(data: Partial<HrLeaveSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
