export interface HrLeaveQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveQueueValidator {
  public static validate(data: Partial<HrLeaveQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
