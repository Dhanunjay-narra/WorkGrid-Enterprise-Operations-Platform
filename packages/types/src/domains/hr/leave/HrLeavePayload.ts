export interface HrLeavePayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeavePayloadValidator {
  public static validate(data: Partial<HrLeavePayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
