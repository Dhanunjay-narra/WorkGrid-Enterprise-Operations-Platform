export interface HrLeaveThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrLeaveThresholdValidator {
  public static validate(data: Partial<HrLeaveThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
