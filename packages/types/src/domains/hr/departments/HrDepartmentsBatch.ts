export interface HrDepartmentsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsBatchValidator {
  public static validate(data: Partial<HrDepartmentsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
