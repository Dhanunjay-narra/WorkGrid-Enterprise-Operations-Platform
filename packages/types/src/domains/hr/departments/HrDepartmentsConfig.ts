export interface HrDepartmentsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsConfigValidator {
  public static validate(data: Partial<HrDepartmentsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
