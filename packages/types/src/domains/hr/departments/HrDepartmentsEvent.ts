export interface HrDepartmentsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsEventValidator {
  public static validate(data: Partial<HrDepartmentsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
