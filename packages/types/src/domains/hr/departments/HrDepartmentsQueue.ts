export interface HrDepartmentsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsQueueValidator {
  public static validate(data: Partial<HrDepartmentsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
