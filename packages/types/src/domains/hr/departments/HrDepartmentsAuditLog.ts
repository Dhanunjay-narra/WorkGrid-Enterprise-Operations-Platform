export interface HrDepartmentsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsAuditLogValidator {
  public static validate(data: Partial<HrDepartmentsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
