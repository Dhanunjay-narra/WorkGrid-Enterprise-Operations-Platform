export interface HrDepartmentsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsThresholdValidator {
  public static validate(data: Partial<HrDepartmentsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
