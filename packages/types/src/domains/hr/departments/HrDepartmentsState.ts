export interface HrDepartmentsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsStateValidator {
  public static validate(data: Partial<HrDepartmentsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
