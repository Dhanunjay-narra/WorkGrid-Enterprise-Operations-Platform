export interface HrDepartmentsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsReportValidator {
  public static validate(data: Partial<HrDepartmentsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
