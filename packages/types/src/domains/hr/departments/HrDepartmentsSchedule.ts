export interface HrDepartmentsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsScheduleValidator {
  public static validate(data: Partial<HrDepartmentsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
