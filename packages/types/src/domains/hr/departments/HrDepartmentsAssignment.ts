export interface HrDepartmentsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsAssignmentValidator {
  public static validate(data: Partial<HrDepartmentsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
