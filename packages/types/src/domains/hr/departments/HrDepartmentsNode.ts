export interface HrDepartmentsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsNodeValidator {
  public static validate(data: Partial<HrDepartmentsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
