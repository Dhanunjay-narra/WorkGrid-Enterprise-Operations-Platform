export interface HrDepartmentsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsEntryValidator {
  public static validate(data: Partial<HrDepartmentsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
