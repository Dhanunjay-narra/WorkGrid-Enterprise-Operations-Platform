export interface HrDepartmentsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsProfileValidator {
  public static validate(data: Partial<HrDepartmentsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
