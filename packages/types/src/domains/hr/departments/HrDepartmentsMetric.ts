export interface HrDepartmentsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsMetricValidator {
  public static validate(data: Partial<HrDepartmentsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
