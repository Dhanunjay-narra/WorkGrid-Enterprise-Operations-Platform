export interface HrDepartmentsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsTransactionValidator {
  public static validate(data: Partial<HrDepartmentsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
