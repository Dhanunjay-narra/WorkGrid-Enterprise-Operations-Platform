export interface HrDepartmentsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsSnapshotValidator {
  public static validate(data: Partial<HrDepartmentsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
