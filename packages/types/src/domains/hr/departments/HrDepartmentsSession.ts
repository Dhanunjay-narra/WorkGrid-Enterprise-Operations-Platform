export interface HrDepartmentsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsSessionValidator {
  public static validate(data: Partial<HrDepartmentsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
