export interface HrDepartmentsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsTaskValidator {
  public static validate(data: Partial<HrDepartmentsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
