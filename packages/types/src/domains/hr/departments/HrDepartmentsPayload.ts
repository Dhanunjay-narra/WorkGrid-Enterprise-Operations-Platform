export interface HrDepartmentsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsPayloadValidator {
  public static validate(data: Partial<HrDepartmentsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
