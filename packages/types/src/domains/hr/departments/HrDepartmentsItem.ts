export interface HrDepartmentsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsItemValidator {
  public static validate(data: Partial<HrDepartmentsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
