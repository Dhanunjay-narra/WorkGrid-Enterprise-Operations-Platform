export interface HrDepartmentsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsMappingValidator {
  public static validate(data: Partial<HrDepartmentsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
