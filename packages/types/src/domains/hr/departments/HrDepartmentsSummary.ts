export interface HrDepartmentsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsSummaryValidator {
  public static validate(data: Partial<HrDepartmentsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
