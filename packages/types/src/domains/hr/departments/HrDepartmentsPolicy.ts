export interface HrDepartmentsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsPolicyValidator {
  public static validate(data: Partial<HrDepartmentsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
