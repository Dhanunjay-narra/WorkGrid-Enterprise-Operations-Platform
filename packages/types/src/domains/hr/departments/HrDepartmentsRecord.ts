export interface HrDepartmentsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrDepartmentsRecordValidator {
  public static validate(data: Partial<HrDepartmentsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
