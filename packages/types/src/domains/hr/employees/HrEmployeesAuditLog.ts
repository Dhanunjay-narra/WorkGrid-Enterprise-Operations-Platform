export interface HrEmployeesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesAuditLogValidator {
  public static validate(data: Partial<HrEmployeesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
