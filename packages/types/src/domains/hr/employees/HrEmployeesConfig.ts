export interface HrEmployeesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesConfigValidator {
  public static validate(data: Partial<HrEmployeesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
