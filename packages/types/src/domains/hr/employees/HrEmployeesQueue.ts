export interface HrEmployeesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesQueueValidator {
  public static validate(data: Partial<HrEmployeesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
