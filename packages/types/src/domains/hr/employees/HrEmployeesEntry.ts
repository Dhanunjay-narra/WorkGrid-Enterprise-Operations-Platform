export interface HrEmployeesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesEntryValidator {
  public static validate(data: Partial<HrEmployeesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
