export interface HrEmployeesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesScheduleValidator {
  public static validate(data: Partial<HrEmployeesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
