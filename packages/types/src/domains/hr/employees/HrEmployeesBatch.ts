export interface HrEmployeesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesBatchValidator {
  public static validate(data: Partial<HrEmployeesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
