export interface HrEmployeesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesSnapshotValidator {
  public static validate(data: Partial<HrEmployeesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
