export interface HrEmployeesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesEventValidator {
  public static validate(data: Partial<HrEmployeesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
