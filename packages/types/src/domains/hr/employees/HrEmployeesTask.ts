export interface HrEmployeesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesTaskValidator {
  public static validate(data: Partial<HrEmployeesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
