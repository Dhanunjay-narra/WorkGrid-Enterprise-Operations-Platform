export interface HrEmployeesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesMappingValidator {
  public static validate(data: Partial<HrEmployeesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
