export interface HrEmployeesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesMetricValidator {
  public static validate(data: Partial<HrEmployeesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
