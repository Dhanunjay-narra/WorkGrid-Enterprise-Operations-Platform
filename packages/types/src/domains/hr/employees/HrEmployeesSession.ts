export interface HrEmployeesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesSessionValidator {
  public static validate(data: Partial<HrEmployeesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
