export interface HrEmployeesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesItemValidator {
  public static validate(data: Partial<HrEmployeesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
