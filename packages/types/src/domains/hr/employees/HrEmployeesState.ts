export interface HrEmployeesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesStateValidator {
  public static validate(data: Partial<HrEmployeesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
