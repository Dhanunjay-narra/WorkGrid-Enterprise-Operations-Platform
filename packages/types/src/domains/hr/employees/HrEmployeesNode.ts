export interface HrEmployeesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesNodeValidator {
  public static validate(data: Partial<HrEmployeesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
