export interface HrEmployeesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesAssignmentValidator {
  public static validate(data: Partial<HrEmployeesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
