export interface HrEmployeesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesPayloadValidator {
  public static validate(data: Partial<HrEmployeesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
