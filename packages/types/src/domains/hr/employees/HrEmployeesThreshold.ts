export interface HrEmployeesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesThresholdValidator {
  public static validate(data: Partial<HrEmployeesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
