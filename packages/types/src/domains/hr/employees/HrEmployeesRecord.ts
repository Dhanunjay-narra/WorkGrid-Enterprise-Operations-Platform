export interface HrEmployeesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesRecordValidator {
  public static validate(data: Partial<HrEmployeesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
