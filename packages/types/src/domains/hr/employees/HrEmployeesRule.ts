export interface HrEmployeesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesRuleValidator {
  public static validate(data: Partial<HrEmployeesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
