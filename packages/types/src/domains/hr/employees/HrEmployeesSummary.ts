export interface HrEmployeesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesSummaryValidator {
  public static validate(data: Partial<HrEmployeesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
