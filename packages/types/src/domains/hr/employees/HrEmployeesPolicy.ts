export interface HrEmployeesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesPolicyValidator {
  public static validate(data: Partial<HrEmployeesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
