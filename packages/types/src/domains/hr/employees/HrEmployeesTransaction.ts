export interface HrEmployeesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesTransactionValidator {
  public static validate(data: Partial<HrEmployeesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
