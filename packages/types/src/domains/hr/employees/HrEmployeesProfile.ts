export interface HrEmployeesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesProfileValidator {
  public static validate(data: Partial<HrEmployeesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
