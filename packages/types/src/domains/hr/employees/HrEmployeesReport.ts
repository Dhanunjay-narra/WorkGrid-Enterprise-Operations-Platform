export interface HrEmployeesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrEmployeesReportValidator {
  public static validate(data: Partial<HrEmployeesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
