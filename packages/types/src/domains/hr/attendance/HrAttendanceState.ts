export interface HrAttendanceStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceStateValidator {
  public static validate(data: Partial<HrAttendanceStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
