export interface HrAttendanceMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceMappingValidator {
  public static validate(data: Partial<HrAttendanceMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
