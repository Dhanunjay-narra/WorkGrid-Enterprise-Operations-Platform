export interface HrAttendanceRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceRecordValidator {
  public static validate(data: Partial<HrAttendanceRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
