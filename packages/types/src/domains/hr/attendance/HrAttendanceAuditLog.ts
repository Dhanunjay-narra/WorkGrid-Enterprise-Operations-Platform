export interface HrAttendanceAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceAuditLogValidator {
  public static validate(data: Partial<HrAttendanceAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
