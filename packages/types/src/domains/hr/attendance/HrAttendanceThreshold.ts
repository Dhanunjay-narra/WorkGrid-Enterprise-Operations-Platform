export interface HrAttendanceThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceThresholdValidator {
  public static validate(data: Partial<HrAttendanceThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
