export interface HrAttendanceSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceSnapshotValidator {
  public static validate(data: Partial<HrAttendanceSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
