export interface HrAttendanceReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceReportValidator {
  public static validate(data: Partial<HrAttendanceReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
