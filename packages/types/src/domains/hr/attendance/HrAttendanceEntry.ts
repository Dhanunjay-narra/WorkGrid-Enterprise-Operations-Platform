export interface HrAttendanceEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceEntryValidator {
  public static validate(data: Partial<HrAttendanceEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
