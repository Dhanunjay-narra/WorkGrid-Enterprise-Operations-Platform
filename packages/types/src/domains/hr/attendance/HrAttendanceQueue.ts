export interface HrAttendanceQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceQueueValidator {
  public static validate(data: Partial<HrAttendanceQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
