export interface HrAttendancePayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendancePayloadValidator {
  public static validate(data: Partial<HrAttendancePayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
