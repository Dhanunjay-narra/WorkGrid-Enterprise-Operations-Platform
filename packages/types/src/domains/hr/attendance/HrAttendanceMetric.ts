export interface HrAttendanceMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceMetricValidator {
  public static validate(data: Partial<HrAttendanceMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
