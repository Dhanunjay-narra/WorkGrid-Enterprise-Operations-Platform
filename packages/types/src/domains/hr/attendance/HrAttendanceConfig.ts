export interface HrAttendanceConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceConfigValidator {
  public static validate(data: Partial<HrAttendanceConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
