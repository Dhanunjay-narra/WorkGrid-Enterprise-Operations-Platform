export interface HrAttendanceTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceTaskValidator {
  public static validate(data: Partial<HrAttendanceTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
