export interface HrAttendanceItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceItemValidator {
  public static validate(data: Partial<HrAttendanceItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
