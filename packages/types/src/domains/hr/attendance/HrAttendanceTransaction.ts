export interface HrAttendanceTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceTransactionValidator {
  public static validate(data: Partial<HrAttendanceTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
