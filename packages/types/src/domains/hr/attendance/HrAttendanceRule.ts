export interface HrAttendanceRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceRuleValidator {
  public static validate(data: Partial<HrAttendanceRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
