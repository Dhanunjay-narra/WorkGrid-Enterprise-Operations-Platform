export interface HrAttendanceAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceAssignmentValidator {
  public static validate(data: Partial<HrAttendanceAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
