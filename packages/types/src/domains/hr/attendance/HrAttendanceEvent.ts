export interface HrAttendanceEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceEventValidator {
  public static validate(data: Partial<HrAttendanceEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
