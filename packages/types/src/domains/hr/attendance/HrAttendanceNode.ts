export interface HrAttendanceNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceNodeValidator {
  public static validate(data: Partial<HrAttendanceNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
