export interface HrAttendanceProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceProfileValidator {
  public static validate(data: Partial<HrAttendanceProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
