export interface HrAttendanceBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceBatchValidator {
  public static validate(data: Partial<HrAttendanceBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
