export interface HrAttendanceSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceSessionValidator {
  public static validate(data: Partial<HrAttendanceSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
