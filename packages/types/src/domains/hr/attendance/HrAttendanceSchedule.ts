export interface HrAttendanceScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceScheduleValidator {
  public static validate(data: Partial<HrAttendanceScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
