export interface HrAttendancePolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendancePolicyValidator {
  public static validate(data: Partial<HrAttendancePolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
