export interface HrAttendanceSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrAttendanceSummaryValidator {
  public static validate(data: Partial<HrAttendanceSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
