export interface HrRecruitmentProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentProfileValidator {
  public static validate(data: Partial<HrRecruitmentProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
