export interface HrRecruitmentQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentQueueValidator {
  public static validate(data: Partial<HrRecruitmentQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
