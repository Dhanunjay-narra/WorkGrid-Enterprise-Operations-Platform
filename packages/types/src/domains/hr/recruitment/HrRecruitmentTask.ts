export interface HrRecruitmentTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentTaskValidator {
  public static validate(data: Partial<HrRecruitmentTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
