export interface HrRecruitmentPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentPayloadValidator {
  public static validate(data: Partial<HrRecruitmentPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
