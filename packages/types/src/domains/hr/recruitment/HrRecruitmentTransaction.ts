export interface HrRecruitmentTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentTransactionValidator {
  public static validate(data: Partial<HrRecruitmentTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
