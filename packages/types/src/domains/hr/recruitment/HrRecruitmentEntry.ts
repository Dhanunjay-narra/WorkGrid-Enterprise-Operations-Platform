export interface HrRecruitmentEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentEntryValidator {
  public static validate(data: Partial<HrRecruitmentEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
