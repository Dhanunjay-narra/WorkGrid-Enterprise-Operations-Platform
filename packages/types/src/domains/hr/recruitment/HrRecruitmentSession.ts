export interface HrRecruitmentSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentSessionValidator {
  public static validate(data: Partial<HrRecruitmentSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
