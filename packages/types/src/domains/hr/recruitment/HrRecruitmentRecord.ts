export interface HrRecruitmentRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentRecordValidator {
  public static validate(data: Partial<HrRecruitmentRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
