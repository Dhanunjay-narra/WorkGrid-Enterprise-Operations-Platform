export interface HrRecruitmentRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentRuleValidator {
  public static validate(data: Partial<HrRecruitmentRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
