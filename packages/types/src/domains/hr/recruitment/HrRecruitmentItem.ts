export interface HrRecruitmentItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentItemValidator {
  public static validate(data: Partial<HrRecruitmentItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
