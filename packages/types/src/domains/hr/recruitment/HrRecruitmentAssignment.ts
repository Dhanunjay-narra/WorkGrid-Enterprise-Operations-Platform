export interface HrRecruitmentAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentAssignmentValidator {
  public static validate(data: Partial<HrRecruitmentAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
