export interface HrRecruitmentPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentPolicyValidator {
  public static validate(data: Partial<HrRecruitmentPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
