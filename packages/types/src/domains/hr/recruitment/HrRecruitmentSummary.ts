export interface HrRecruitmentSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentSummaryValidator {
  public static validate(data: Partial<HrRecruitmentSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
