export interface HrRecruitmentThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentThresholdValidator {
  public static validate(data: Partial<HrRecruitmentThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
