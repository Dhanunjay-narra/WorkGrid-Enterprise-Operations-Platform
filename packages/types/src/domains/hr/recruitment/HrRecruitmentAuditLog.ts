export interface HrRecruitmentAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentAuditLogValidator {
  public static validate(data: Partial<HrRecruitmentAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
