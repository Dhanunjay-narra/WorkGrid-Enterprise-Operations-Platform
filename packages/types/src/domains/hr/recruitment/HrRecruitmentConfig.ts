export interface HrRecruitmentConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentConfigValidator {
  public static validate(data: Partial<HrRecruitmentConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
