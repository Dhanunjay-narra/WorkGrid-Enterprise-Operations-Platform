export interface HrRecruitmentBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentBatchValidator {
  public static validate(data: Partial<HrRecruitmentBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
