export interface HrRecruitmentEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentEventValidator {
  public static validate(data: Partial<HrRecruitmentEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
