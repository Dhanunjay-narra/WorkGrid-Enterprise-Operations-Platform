export interface HrRecruitmentMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentMappingValidator {
  public static validate(data: Partial<HrRecruitmentMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
