export interface HrRecruitmentStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentStateValidator {
  public static validate(data: Partial<HrRecruitmentStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
