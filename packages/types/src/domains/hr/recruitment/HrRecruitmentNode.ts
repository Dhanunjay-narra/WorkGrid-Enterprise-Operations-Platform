export interface HrRecruitmentNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentNodeValidator {
  public static validate(data: Partial<HrRecruitmentNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
