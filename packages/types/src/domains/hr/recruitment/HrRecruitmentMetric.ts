export interface HrRecruitmentMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentMetricValidator {
  public static validate(data: Partial<HrRecruitmentMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
