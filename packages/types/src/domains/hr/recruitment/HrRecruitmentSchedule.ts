export interface HrRecruitmentScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrRecruitmentScheduleValidator {
  public static validate(data: Partial<HrRecruitmentScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
