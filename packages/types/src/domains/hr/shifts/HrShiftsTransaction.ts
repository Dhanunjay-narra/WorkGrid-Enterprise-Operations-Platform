export interface HrShiftsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsTransactionValidator {
  public static validate(data: Partial<HrShiftsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
