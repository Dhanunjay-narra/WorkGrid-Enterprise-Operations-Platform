export interface HrShiftsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsMappingValidator {
  public static validate(data: Partial<HrShiftsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
