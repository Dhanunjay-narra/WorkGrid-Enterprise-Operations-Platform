export interface HrShiftsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsConfigValidator {
  public static validate(data: Partial<HrShiftsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
