export interface HrShiftsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsScheduleValidator {
  public static validate(data: Partial<HrShiftsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
