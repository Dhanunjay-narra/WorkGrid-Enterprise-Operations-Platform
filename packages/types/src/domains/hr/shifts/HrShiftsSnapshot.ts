export interface HrShiftsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsSnapshotValidator {
  public static validate(data: Partial<HrShiftsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
