export interface HrShiftsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsPolicyValidator {
  public static validate(data: Partial<HrShiftsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
