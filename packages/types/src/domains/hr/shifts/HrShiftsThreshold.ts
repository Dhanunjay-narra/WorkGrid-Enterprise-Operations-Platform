export interface HrShiftsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsThresholdValidator {
  public static validate(data: Partial<HrShiftsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
