export interface HrShiftsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsProfileValidator {
  public static validate(data: Partial<HrShiftsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
