export interface HrShiftsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsQueueValidator {
  public static validate(data: Partial<HrShiftsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
