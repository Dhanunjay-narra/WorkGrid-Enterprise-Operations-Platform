export interface HrShiftsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsRuleValidator {
  public static validate(data: Partial<HrShiftsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
