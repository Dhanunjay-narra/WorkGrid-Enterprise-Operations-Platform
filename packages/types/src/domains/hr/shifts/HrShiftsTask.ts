export interface HrShiftsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsTaskValidator {
  public static validate(data: Partial<HrShiftsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
