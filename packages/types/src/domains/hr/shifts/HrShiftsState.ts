export interface HrShiftsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsStateValidator {
  public static validate(data: Partial<HrShiftsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
