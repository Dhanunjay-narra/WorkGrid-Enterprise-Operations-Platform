export interface HrShiftsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsRecordValidator {
  public static validate(data: Partial<HrShiftsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
