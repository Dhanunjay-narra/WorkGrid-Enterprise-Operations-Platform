export interface HrShiftsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsSessionValidator {
  public static validate(data: Partial<HrShiftsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
