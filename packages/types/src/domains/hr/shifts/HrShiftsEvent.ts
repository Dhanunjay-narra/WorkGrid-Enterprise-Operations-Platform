export interface HrShiftsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsEventValidator {
  public static validate(data: Partial<HrShiftsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
