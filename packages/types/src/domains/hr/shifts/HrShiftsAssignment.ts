export interface HrShiftsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsAssignmentValidator {
  public static validate(data: Partial<HrShiftsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
