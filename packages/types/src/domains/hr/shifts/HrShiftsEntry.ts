export interface HrShiftsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsEntryValidator {
  public static validate(data: Partial<HrShiftsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
