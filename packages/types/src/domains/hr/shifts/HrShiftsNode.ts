export interface HrShiftsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsNodeValidator {
  public static validate(data: Partial<HrShiftsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
