export interface HrShiftsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsReportValidator {
  public static validate(data: Partial<HrShiftsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
