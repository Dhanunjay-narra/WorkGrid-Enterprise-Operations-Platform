export interface HrShiftsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsItemValidator {
  public static validate(data: Partial<HrShiftsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
