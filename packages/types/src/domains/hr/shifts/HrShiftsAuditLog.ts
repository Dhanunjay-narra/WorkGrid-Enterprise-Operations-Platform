export interface HrShiftsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsAuditLogValidator {
  public static validate(data: Partial<HrShiftsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
