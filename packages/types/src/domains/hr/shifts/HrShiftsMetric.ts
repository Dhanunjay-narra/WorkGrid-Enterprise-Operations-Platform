export interface HrShiftsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsMetricValidator {
  public static validate(data: Partial<HrShiftsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
