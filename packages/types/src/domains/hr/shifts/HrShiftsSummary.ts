export interface HrShiftsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsSummaryValidator {
  public static validate(data: Partial<HrShiftsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
