export interface HrShiftsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsPayloadValidator {
  public static validate(data: Partial<HrShiftsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
