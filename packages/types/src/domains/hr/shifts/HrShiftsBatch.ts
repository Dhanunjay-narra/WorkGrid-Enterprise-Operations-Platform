export interface HrShiftsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrShiftsBatchValidator {
  public static validate(data: Partial<HrShiftsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
