export interface HrPerformanceThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceThresholdValidator {
  public static validate(data: Partial<HrPerformanceThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
