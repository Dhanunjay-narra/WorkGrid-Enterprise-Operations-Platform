export interface HrPerformanceReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceReportValidator {
  public static validate(data: Partial<HrPerformanceReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
