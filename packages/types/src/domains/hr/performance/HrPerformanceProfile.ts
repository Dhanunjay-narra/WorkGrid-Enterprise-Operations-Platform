export interface HrPerformanceProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceProfileValidator {
  public static validate(data: Partial<HrPerformanceProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
