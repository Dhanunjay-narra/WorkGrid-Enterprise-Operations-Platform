export interface HrPerformanceBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceBatchValidator {
  public static validate(data: Partial<HrPerformanceBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
