export interface HrPerformanceSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceSnapshotValidator {
  public static validate(data: Partial<HrPerformanceSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
