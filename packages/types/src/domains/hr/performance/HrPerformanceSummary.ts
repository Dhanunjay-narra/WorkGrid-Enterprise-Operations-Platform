export interface HrPerformanceSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceSummaryValidator {
  public static validate(data: Partial<HrPerformanceSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
