export interface HrPerformanceQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceQueueValidator {
  public static validate(data: Partial<HrPerformanceQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
