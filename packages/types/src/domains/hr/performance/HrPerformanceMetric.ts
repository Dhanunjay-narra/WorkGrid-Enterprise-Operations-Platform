export interface HrPerformanceMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceMetricValidator {
  public static validate(data: Partial<HrPerformanceMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
