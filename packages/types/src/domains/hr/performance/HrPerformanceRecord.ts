export interface HrPerformanceRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceRecordValidator {
  public static validate(data: Partial<HrPerformanceRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
