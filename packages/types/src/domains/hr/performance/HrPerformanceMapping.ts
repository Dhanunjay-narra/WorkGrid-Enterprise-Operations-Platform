export interface HrPerformanceMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceMappingValidator {
  public static validate(data: Partial<HrPerformanceMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
