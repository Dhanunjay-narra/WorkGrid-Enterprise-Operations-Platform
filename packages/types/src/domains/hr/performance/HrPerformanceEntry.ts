export interface HrPerformanceEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceEntryValidator {
  public static validate(data: Partial<HrPerformanceEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
