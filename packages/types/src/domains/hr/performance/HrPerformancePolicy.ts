export interface HrPerformancePolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformancePolicyValidator {
  public static validate(data: Partial<HrPerformancePolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
