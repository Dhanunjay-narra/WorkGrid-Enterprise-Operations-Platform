export interface HrPerformanceConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceConfigValidator {
  public static validate(data: Partial<HrPerformanceConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
