export interface HrPerformancePayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformancePayloadValidator {
  public static validate(data: Partial<HrPerformancePayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
