export interface HrPerformanceNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceNodeValidator {
  public static validate(data: Partial<HrPerformanceNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
