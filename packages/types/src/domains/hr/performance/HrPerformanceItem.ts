export interface HrPerformanceItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceItemValidator {
  public static validate(data: Partial<HrPerformanceItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
