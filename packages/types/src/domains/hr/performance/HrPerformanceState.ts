export interface HrPerformanceStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceStateValidator {
  public static validate(data: Partial<HrPerformanceStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
