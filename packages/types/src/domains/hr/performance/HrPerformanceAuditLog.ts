export interface HrPerformanceAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceAuditLogValidator {
  public static validate(data: Partial<HrPerformanceAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
