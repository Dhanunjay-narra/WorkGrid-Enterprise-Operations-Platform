export interface HrPerformanceTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceTaskValidator {
  public static validate(data: Partial<HrPerformanceTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
