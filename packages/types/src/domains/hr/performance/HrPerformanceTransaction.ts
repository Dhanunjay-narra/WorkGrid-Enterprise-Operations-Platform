export interface HrPerformanceTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceTransactionValidator {
  public static validate(data: Partial<HrPerformanceTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
