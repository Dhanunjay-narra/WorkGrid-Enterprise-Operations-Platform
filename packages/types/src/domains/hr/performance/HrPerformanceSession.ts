export interface HrPerformanceSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceSessionValidator {
  public static validate(data: Partial<HrPerformanceSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
