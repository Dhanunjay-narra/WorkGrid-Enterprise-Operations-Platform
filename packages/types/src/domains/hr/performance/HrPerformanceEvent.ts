export interface HrPerformanceEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceEventValidator {
  public static validate(data: Partial<HrPerformanceEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
