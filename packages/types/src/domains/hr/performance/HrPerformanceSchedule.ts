export interface HrPerformanceScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceScheduleValidator {
  public static validate(data: Partial<HrPerformanceScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
