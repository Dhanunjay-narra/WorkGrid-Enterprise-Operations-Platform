export interface HrPerformanceAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPerformanceAssignmentValidator {
  public static validate(data: Partial<HrPerformanceAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
