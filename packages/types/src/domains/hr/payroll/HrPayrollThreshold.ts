export interface HrPayrollThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollThresholdValidator {
  public static validate(data: Partial<HrPayrollThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
