export interface HrPayrollAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollAssignmentValidator {
  public static validate(data: Partial<HrPayrollAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
