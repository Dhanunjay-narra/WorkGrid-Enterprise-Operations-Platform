export interface HrPayrollBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollBatchValidator {
  public static validate(data: Partial<HrPayrollBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
