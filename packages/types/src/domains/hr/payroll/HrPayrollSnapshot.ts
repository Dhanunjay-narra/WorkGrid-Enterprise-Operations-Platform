export interface HrPayrollSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollSnapshotValidator {
  public static validate(data: Partial<HrPayrollSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
