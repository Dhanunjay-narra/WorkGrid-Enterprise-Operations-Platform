export interface HrPayrollScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollScheduleValidator {
  public static validate(data: Partial<HrPayrollScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
