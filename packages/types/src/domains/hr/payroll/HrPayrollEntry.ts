export interface HrPayrollEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollEntryValidator {
  public static validate(data: Partial<HrPayrollEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
