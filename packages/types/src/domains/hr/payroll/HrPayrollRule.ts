export interface HrPayrollRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollRuleValidator {
  public static validate(data: Partial<HrPayrollRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
