export interface HrPayrollTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollTaskValidator {
  public static validate(data: Partial<HrPayrollTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
