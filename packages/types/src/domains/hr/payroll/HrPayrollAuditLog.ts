export interface HrPayrollAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollAuditLogValidator {
  public static validate(data: Partial<HrPayrollAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
