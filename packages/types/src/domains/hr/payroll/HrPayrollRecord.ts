export interface HrPayrollRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollRecordValidator {
  public static validate(data: Partial<HrPayrollRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
