export interface HrPayrollPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollPayloadValidator {
  public static validate(data: Partial<HrPayrollPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
