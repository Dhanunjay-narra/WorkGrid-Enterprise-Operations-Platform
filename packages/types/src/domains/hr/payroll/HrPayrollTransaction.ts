export interface HrPayrollTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollTransactionValidator {
  public static validate(data: Partial<HrPayrollTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
