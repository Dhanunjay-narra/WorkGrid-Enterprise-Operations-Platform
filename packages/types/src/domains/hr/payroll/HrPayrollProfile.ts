export interface HrPayrollProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollProfileValidator {
  public static validate(data: Partial<HrPayrollProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
