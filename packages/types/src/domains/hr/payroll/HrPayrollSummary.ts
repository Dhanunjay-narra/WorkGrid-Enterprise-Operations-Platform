export interface HrPayrollSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollSummaryValidator {
  public static validate(data: Partial<HrPayrollSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
