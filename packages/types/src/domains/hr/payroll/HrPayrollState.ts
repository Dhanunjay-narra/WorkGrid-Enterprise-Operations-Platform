export interface HrPayrollStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollStateValidator {
  public static validate(data: Partial<HrPayrollStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
