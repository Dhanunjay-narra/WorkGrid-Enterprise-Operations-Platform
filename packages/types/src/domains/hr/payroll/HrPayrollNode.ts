export interface HrPayrollNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollNodeValidator {
  public static validate(data: Partial<HrPayrollNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
