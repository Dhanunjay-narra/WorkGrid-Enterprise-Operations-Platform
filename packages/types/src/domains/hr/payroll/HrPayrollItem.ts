export interface HrPayrollItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollItemValidator {
  public static validate(data: Partial<HrPayrollItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
