export interface HrPayrollConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollConfigValidator {
  public static validate(data: Partial<HrPayrollConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
