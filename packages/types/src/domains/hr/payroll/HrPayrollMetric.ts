export interface HrPayrollMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollMetricValidator {
  public static validate(data: Partial<HrPayrollMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
