export interface HrPayrollMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollMappingValidator {
  public static validate(data: Partial<HrPayrollMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
