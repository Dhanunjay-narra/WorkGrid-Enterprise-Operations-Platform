export interface HrPayrollSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollSessionValidator {
  public static validate(data: Partial<HrPayrollSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
