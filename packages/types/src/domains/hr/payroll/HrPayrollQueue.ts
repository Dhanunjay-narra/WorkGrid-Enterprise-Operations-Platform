export interface HrPayrollQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollQueueValidator {
  public static validate(data: Partial<HrPayrollQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
