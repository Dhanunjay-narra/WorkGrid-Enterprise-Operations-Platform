export interface HrPayrollPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollPolicyValidator {
  public static validate(data: Partial<HrPayrollPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
