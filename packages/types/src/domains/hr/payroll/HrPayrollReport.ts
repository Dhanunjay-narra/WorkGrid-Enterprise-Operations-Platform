export interface HrPayrollReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class HrPayrollReportValidator {
  public static validate(data: Partial<HrPayrollReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
