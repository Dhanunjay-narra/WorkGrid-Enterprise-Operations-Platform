export interface AuditMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AuditMappingValidator {
  public static validate(data: Partial<AuditMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
