export interface AuditProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AuditProfileValidator {
  public static validate(data: Partial<AuditProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
