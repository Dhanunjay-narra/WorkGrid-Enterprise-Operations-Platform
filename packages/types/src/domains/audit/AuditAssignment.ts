export interface AuditAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AuditAssignmentValidator {
  public static validate(data: Partial<AuditAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
