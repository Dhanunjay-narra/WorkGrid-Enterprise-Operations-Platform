export interface AuditSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AuditSnapshotValidator {
  public static validate(data: Partial<AuditSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
