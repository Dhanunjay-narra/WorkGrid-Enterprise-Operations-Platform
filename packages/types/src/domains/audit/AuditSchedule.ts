export interface AuditScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AuditScheduleValidator {
  public static validate(data: Partial<AuditScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
