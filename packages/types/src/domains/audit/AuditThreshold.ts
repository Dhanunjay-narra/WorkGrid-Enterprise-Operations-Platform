export interface AuditThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AuditThresholdValidator {
  public static validate(data: Partial<AuditThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
