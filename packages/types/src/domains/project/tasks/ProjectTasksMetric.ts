export interface ProjectTasksMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksMetricValidator {
  public static validate(data: Partial<ProjectTasksMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
