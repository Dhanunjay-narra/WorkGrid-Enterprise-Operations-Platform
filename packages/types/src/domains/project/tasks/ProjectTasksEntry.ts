export interface ProjectTasksEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksEntryValidator {
  public static validate(data: Partial<ProjectTasksEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
