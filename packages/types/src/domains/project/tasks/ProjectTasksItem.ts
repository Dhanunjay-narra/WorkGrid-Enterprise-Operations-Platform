export interface ProjectTasksItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksItemValidator {
  public static validate(data: Partial<ProjectTasksItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
