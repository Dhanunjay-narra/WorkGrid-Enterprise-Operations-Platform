export interface ProjectTasksScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksScheduleValidator {
  public static validate(data: Partial<ProjectTasksScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
