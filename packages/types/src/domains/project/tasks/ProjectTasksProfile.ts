export interface ProjectTasksProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksProfileValidator {
  public static validate(data: Partial<ProjectTasksProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
