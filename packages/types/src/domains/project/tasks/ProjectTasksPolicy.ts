export interface ProjectTasksPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksPolicyValidator {
  public static validate(data: Partial<ProjectTasksPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
