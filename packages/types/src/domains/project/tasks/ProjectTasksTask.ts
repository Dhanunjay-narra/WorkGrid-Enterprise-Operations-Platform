export interface ProjectTasksTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksTaskValidator {
  public static validate(data: Partial<ProjectTasksTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
