export interface ProjectTasksConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksConfigValidator {
  public static validate(data: Partial<ProjectTasksConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
