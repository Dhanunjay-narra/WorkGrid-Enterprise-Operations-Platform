export interface ProjectTasksRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksRuleValidator {
  public static validate(data: Partial<ProjectTasksRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
