export interface ProjectTasksAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksAssignmentValidator {
  public static validate(data: Partial<ProjectTasksAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
