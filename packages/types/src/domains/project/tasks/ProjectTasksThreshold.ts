export interface ProjectTasksThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksThresholdValidator {
  public static validate(data: Partial<ProjectTasksThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
