export interface ProjectTasksQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksQueueValidator {
  public static validate(data: Partial<ProjectTasksQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
