export interface ProjectTasksNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksNodeValidator {
  public static validate(data: Partial<ProjectTasksNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
