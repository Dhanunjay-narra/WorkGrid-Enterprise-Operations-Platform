export interface ProjectTasksRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksRecordValidator {
  public static validate(data: Partial<ProjectTasksRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
