export interface ProjectTasksSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksSessionValidator {
  public static validate(data: Partial<ProjectTasksSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
