export interface ProjectTasksSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksSummaryValidator {
  public static validate(data: Partial<ProjectTasksSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
