export interface ProjectTasksBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksBatchValidator {
  public static validate(data: Partial<ProjectTasksBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
