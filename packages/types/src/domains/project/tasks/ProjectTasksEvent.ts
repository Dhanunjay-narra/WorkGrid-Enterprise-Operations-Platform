export interface ProjectTasksEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksEventValidator {
  public static validate(data: Partial<ProjectTasksEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
