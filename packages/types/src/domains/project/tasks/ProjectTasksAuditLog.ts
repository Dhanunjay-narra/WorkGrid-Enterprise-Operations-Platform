export interface ProjectTasksAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksAuditLogValidator {
  public static validate(data: Partial<ProjectTasksAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
