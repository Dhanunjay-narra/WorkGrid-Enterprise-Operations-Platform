export interface ProjectTasksReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksReportValidator {
  public static validate(data: Partial<ProjectTasksReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
