export interface ProjectTasksTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksTransactionValidator {
  public static validate(data: Partial<ProjectTasksTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
