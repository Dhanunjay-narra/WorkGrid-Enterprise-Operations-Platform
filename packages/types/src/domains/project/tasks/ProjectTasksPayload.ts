export interface ProjectTasksPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksPayloadValidator {
  public static validate(data: Partial<ProjectTasksPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
