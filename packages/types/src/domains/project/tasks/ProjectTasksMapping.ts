export interface ProjectTasksMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksMappingValidator {
  public static validate(data: Partial<ProjectTasksMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
