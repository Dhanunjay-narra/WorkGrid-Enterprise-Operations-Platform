export interface ProjectTasksStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksStateValidator {
  public static validate(data: Partial<ProjectTasksStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
