export interface ProjectTasksSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectTasksSnapshotValidator {
  public static validate(data: Partial<ProjectTasksSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
