export interface ProjectCapacityNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityNodeValidator {
  public static validate(data: Partial<ProjectCapacityNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
