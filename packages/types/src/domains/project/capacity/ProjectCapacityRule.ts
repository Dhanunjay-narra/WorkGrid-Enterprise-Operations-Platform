export interface ProjectCapacityRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityRuleValidator {
  public static validate(data: Partial<ProjectCapacityRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
