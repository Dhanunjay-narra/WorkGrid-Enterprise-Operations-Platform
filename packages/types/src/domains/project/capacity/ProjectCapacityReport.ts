export interface ProjectCapacityReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityReportValidator {
  public static validate(data: Partial<ProjectCapacityReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
