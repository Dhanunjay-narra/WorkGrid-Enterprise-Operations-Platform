export interface ProjectCapacityEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityEventValidator {
  public static validate(data: Partial<ProjectCapacityEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
