export interface ProjectCapacityThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityThresholdValidator {
  public static validate(data: Partial<ProjectCapacityThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
