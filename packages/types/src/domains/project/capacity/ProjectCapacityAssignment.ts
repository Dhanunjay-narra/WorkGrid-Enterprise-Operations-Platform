export interface ProjectCapacityAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityAssignmentValidator {
  public static validate(data: Partial<ProjectCapacityAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
