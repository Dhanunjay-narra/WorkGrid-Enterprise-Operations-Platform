export interface ProjectCapacityAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityAuditLogValidator {
  public static validate(data: Partial<ProjectCapacityAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
