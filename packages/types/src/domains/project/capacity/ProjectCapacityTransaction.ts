export interface ProjectCapacityTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityTransactionValidator {
  public static validate(data: Partial<ProjectCapacityTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
