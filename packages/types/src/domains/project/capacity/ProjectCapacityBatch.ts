export interface ProjectCapacityBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityBatchValidator {
  public static validate(data: Partial<ProjectCapacityBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
