export interface ProjectCapacityMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityMappingValidator {
  public static validate(data: Partial<ProjectCapacityMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
