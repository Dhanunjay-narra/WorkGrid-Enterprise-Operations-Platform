export interface ProjectCapacityScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityScheduleValidator {
  public static validate(data: Partial<ProjectCapacityScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
