export interface ProjectCapacityItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityItemValidator {
  public static validate(data: Partial<ProjectCapacityItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
