export interface ProjectCapacitySessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacitySessionValidator {
  public static validate(data: Partial<ProjectCapacitySessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
