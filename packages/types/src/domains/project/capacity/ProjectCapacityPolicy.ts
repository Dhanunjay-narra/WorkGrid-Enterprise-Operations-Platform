export interface ProjectCapacityPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityPolicyValidator {
  public static validate(data: Partial<ProjectCapacityPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
