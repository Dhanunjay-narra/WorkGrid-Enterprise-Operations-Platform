export interface ProjectCapacityProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityProfileValidator {
  public static validate(data: Partial<ProjectCapacityProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
