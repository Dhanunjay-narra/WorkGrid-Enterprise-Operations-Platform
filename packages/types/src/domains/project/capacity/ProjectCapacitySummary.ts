export interface ProjectCapacitySummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacitySummaryValidator {
  public static validate(data: Partial<ProjectCapacitySummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
