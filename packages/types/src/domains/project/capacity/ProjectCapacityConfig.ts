export interface ProjectCapacityConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityConfigValidator {
  public static validate(data: Partial<ProjectCapacityConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
