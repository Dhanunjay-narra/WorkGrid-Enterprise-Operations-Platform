export interface ProjectCapacityRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityRecordValidator {
  public static validate(data: Partial<ProjectCapacityRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
