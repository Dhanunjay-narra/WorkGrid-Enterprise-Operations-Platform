export interface ProjectCapacityStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityStateValidator {
  public static validate(data: Partial<ProjectCapacityStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
