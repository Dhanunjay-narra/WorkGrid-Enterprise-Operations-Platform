export interface ProjectCapacityEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityEntryValidator {
  public static validate(data: Partial<ProjectCapacityEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
