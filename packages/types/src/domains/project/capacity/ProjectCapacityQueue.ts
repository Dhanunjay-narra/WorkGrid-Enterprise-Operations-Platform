export interface ProjectCapacityQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityQueueValidator {
  public static validate(data: Partial<ProjectCapacityQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
