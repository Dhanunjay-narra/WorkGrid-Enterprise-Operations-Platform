export interface ProjectCapacityMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityMetricValidator {
  public static validate(data: Partial<ProjectCapacityMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
