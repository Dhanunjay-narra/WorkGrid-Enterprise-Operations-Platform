export interface ProjectCapacityPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityPayloadValidator {
  public static validate(data: Partial<ProjectCapacityPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
