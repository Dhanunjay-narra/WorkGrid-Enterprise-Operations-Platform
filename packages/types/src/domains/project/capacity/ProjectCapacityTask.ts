export interface ProjectCapacityTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacityTaskValidator {
  public static validate(data: Partial<ProjectCapacityTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
