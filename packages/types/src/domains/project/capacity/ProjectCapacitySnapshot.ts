export interface ProjectCapacitySnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectCapacitySnapshotValidator {
  public static validate(data: Partial<ProjectCapacitySnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
