export interface ProjectSprintsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsSummaryValidator {
  public static validate(data: Partial<ProjectSprintsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
