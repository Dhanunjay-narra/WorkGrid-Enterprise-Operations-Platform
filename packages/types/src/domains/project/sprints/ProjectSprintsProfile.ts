export interface ProjectSprintsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsProfileValidator {
  public static validate(data: Partial<ProjectSprintsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
