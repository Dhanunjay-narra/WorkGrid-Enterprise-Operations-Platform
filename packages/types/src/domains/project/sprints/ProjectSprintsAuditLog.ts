export interface ProjectSprintsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsAuditLogValidator {
  public static validate(data: Partial<ProjectSprintsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
