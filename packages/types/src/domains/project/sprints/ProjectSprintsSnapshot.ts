export interface ProjectSprintsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsSnapshotValidator {
  public static validate(data: Partial<ProjectSprintsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
