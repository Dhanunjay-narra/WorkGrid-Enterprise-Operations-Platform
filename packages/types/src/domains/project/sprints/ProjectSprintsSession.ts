export interface ProjectSprintsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsSessionValidator {
  public static validate(data: Partial<ProjectSprintsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
