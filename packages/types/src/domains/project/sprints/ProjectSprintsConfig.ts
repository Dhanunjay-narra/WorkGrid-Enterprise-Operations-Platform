export interface ProjectSprintsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsConfigValidator {
  public static validate(data: Partial<ProjectSprintsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
