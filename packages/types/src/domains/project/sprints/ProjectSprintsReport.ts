export interface ProjectSprintsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsReportValidator {
  public static validate(data: Partial<ProjectSprintsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
