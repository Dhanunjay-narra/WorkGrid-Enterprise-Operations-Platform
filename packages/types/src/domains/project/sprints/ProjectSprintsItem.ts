export interface ProjectSprintsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsItemValidator {
  public static validate(data: Partial<ProjectSprintsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
