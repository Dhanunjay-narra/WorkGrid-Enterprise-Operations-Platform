export interface ProjectSprintsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsRecordValidator {
  public static validate(data: Partial<ProjectSprintsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
