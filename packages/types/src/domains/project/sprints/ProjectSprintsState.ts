export interface ProjectSprintsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsStateValidator {
  public static validate(data: Partial<ProjectSprintsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
