export interface ProjectSprintsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsTransactionValidator {
  public static validate(data: Partial<ProjectSprintsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
