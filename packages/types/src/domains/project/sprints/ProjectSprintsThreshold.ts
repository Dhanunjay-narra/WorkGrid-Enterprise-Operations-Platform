export interface ProjectSprintsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsThresholdValidator {
  public static validate(data: Partial<ProjectSprintsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
