export interface ProjectSprintsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsRuleValidator {
  public static validate(data: Partial<ProjectSprintsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
