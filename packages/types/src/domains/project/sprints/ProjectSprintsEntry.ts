export interface ProjectSprintsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsEntryValidator {
  public static validate(data: Partial<ProjectSprintsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
