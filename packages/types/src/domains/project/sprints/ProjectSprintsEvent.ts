export interface ProjectSprintsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsEventValidator {
  public static validate(data: Partial<ProjectSprintsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
