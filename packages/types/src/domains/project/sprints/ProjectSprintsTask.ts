export interface ProjectSprintsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsTaskValidator {
  public static validate(data: Partial<ProjectSprintsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
