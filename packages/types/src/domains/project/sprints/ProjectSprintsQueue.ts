export interface ProjectSprintsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsQueueValidator {
  public static validate(data: Partial<ProjectSprintsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
