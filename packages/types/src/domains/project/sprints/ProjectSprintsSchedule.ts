export interface ProjectSprintsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsScheduleValidator {
  public static validate(data: Partial<ProjectSprintsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
