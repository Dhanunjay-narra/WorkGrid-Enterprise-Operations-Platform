export interface ProjectSprintsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsMetricValidator {
  public static validate(data: Partial<ProjectSprintsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
