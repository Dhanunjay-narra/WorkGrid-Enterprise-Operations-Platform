export interface ProjectSprintsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsNodeValidator {
  public static validate(data: Partial<ProjectSprintsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
