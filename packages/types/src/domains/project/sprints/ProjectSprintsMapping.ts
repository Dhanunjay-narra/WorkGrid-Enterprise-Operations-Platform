export interface ProjectSprintsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsMappingValidator {
  public static validate(data: Partial<ProjectSprintsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
