export interface ProjectSprintsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsPayloadValidator {
  public static validate(data: Partial<ProjectSprintsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
