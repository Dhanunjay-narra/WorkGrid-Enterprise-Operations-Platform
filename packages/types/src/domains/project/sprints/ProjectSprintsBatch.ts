export interface ProjectSprintsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsBatchValidator {
  public static validate(data: Partial<ProjectSprintsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
