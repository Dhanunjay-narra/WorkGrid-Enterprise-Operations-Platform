export interface ProjectSprintsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsAssignmentValidator {
  public static validate(data: Partial<ProjectSprintsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
