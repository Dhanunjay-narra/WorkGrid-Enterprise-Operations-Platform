export interface ProjectSprintsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectSprintsPolicyValidator {
  public static validate(data: Partial<ProjectSprintsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
