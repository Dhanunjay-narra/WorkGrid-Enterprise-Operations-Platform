export interface ProjectRisksReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksReportValidator {
  public static validate(data: Partial<ProjectRisksReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
