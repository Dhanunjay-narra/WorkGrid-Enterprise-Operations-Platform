export interface ProjectRisksPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksPayloadValidator {
  public static validate(data: Partial<ProjectRisksPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
