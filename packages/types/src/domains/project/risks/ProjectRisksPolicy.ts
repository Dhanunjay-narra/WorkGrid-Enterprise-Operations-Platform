export interface ProjectRisksPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksPolicyValidator {
  public static validate(data: Partial<ProjectRisksPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
