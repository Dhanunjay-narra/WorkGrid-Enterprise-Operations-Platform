export interface ProjectRisksSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksSummaryValidator {
  public static validate(data: Partial<ProjectRisksSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
