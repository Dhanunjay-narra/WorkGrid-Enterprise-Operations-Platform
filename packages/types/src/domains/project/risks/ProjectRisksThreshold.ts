export interface ProjectRisksThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksThresholdValidator {
  public static validate(data: Partial<ProjectRisksThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
