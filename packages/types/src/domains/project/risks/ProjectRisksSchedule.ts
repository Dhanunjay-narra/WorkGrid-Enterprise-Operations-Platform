export interface ProjectRisksScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksScheduleValidator {
  public static validate(data: Partial<ProjectRisksScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
