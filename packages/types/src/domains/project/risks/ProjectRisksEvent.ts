export interface ProjectRisksEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksEventValidator {
  public static validate(data: Partial<ProjectRisksEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
