export interface ProjectRisksProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksProfileValidator {
  public static validate(data: Partial<ProjectRisksProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
