export interface ProjectRisksStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksStateValidator {
  public static validate(data: Partial<ProjectRisksStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
