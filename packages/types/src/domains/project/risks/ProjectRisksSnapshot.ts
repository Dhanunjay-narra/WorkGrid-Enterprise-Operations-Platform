export interface ProjectRisksSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksSnapshotValidator {
  public static validate(data: Partial<ProjectRisksSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
