export interface ProjectRisksQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksQueueValidator {
  public static validate(data: Partial<ProjectRisksQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
