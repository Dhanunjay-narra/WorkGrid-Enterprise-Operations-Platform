export interface ProjectRisksTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksTaskValidator {
  public static validate(data: Partial<ProjectRisksTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
