export interface ProjectRisksEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksEntryValidator {
  public static validate(data: Partial<ProjectRisksEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
