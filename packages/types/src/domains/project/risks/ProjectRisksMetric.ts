export interface ProjectRisksMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksMetricValidator {
  public static validate(data: Partial<ProjectRisksMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
