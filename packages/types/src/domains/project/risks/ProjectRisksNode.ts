export interface ProjectRisksNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksNodeValidator {
  public static validate(data: Partial<ProjectRisksNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
