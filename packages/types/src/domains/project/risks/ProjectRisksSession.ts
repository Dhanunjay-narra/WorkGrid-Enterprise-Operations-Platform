export interface ProjectRisksSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksSessionValidator {
  public static validate(data: Partial<ProjectRisksSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
