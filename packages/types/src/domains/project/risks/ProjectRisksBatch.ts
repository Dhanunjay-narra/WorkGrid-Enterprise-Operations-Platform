export interface ProjectRisksBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksBatchValidator {
  public static validate(data: Partial<ProjectRisksBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
