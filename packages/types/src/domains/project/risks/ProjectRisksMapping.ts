export interface ProjectRisksMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksMappingValidator {
  public static validate(data: Partial<ProjectRisksMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
