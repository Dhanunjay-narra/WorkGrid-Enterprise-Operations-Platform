export interface ProjectRisksRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksRuleValidator {
  public static validate(data: Partial<ProjectRisksRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
