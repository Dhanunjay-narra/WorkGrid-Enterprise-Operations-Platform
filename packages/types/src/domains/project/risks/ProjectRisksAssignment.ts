export interface ProjectRisksAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksAssignmentValidator {
  public static validate(data: Partial<ProjectRisksAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
