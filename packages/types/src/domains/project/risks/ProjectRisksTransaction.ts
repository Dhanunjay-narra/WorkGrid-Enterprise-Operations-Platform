export interface ProjectRisksTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksTransactionValidator {
  public static validate(data: Partial<ProjectRisksTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
