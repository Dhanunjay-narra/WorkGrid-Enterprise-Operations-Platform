export interface ProjectRisksAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksAuditLogValidator {
  public static validate(data: Partial<ProjectRisksAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
