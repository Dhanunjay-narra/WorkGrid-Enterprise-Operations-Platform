export interface ProjectRisksConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksConfigValidator {
  public static validate(data: Partial<ProjectRisksConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
