export interface ProjectRisksRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksRecordValidator {
  public static validate(data: Partial<ProjectRisksRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
