export interface ProjectRisksItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectRisksItemValidator {
  public static validate(data: Partial<ProjectRisksItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
