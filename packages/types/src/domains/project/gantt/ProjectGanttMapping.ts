export interface ProjectGanttMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttMappingValidator {
  public static validate(data: Partial<ProjectGanttMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
