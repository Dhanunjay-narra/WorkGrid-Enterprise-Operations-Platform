export interface ProjectGanttNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttNodeValidator {
  public static validate(data: Partial<ProjectGanttNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
