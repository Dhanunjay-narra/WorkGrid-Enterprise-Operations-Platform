export interface ProjectGanttAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttAssignmentValidator {
  public static validate(data: Partial<ProjectGanttAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
