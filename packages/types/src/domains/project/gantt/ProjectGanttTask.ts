export interface ProjectGanttTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttTaskValidator {
  public static validate(data: Partial<ProjectGanttTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
