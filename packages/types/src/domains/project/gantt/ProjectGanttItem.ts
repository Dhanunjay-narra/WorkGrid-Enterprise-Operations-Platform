export interface ProjectGanttItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttItemValidator {
  public static validate(data: Partial<ProjectGanttItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
