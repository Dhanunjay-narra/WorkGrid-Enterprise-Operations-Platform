export interface ProjectGanttBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttBatchValidator {
  public static validate(data: Partial<ProjectGanttBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
