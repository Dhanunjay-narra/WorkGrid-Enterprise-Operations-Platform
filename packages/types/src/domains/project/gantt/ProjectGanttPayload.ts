export interface ProjectGanttPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttPayloadValidator {
  public static validate(data: Partial<ProjectGanttPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
