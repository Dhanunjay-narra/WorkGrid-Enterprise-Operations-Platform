export interface ProjectGanttSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttSnapshotValidator {
  public static validate(data: Partial<ProjectGanttSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
