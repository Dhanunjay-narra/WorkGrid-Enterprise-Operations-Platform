export interface ProjectGanttStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttStateValidator {
  public static validate(data: Partial<ProjectGanttStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
