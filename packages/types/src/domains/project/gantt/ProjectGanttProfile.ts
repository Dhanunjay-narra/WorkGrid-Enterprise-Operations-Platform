export interface ProjectGanttProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttProfileValidator {
  public static validate(data: Partial<ProjectGanttProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
