export interface ProjectGanttReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttReportValidator {
  public static validate(data: Partial<ProjectGanttReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
