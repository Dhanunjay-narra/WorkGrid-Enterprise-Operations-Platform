export interface ProjectGanttEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttEventValidator {
  public static validate(data: Partial<ProjectGanttEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
