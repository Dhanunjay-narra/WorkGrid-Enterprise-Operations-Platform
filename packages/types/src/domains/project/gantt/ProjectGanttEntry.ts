export interface ProjectGanttEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttEntryValidator {
  public static validate(data: Partial<ProjectGanttEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
