export interface ProjectGanttThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttThresholdValidator {
  public static validate(data: Partial<ProjectGanttThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
