export interface ProjectGanttAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttAuditLogValidator {
  public static validate(data: Partial<ProjectGanttAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
