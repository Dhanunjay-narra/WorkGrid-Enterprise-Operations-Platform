export interface ProjectGanttScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttScheduleValidator {
  public static validate(data: Partial<ProjectGanttScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
