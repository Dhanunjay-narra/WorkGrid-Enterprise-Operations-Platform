export interface ProjectGanttConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttConfigValidator {
  public static validate(data: Partial<ProjectGanttConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
