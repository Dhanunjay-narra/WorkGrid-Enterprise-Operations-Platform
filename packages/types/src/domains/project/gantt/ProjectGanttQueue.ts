export interface ProjectGanttQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttQueueValidator {
  public static validate(data: Partial<ProjectGanttQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
