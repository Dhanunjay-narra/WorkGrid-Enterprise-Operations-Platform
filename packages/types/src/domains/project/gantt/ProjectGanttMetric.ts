export interface ProjectGanttMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttMetricValidator {
  public static validate(data: Partial<ProjectGanttMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
