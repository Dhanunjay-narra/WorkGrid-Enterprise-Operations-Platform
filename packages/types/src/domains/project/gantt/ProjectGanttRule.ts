export interface ProjectGanttRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttRuleValidator {
  public static validate(data: Partial<ProjectGanttRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
