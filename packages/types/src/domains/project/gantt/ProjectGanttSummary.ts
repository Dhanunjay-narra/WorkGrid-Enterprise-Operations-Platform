export interface ProjectGanttSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttSummaryValidator {
  public static validate(data: Partial<ProjectGanttSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
