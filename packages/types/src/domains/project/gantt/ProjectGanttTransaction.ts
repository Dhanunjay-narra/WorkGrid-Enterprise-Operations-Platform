export interface ProjectGanttTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttTransactionValidator {
  public static validate(data: Partial<ProjectGanttTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
