export interface ProjectGanttSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttSessionValidator {
  public static validate(data: Partial<ProjectGanttSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
