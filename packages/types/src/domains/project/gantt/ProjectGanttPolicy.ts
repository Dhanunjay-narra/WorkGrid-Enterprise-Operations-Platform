export interface ProjectGanttPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectGanttPolicyValidator {
  public static validate(data: Partial<ProjectGanttPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
