export interface ProjectKanbanTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanTransactionValidator {
  public static validate(data: Partial<ProjectKanbanTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
