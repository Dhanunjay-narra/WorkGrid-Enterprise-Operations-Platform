export interface ProjectKanbanMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanMetricValidator {
  public static validate(data: Partial<ProjectKanbanMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
