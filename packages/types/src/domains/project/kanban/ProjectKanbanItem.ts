export interface ProjectKanbanItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanItemValidator {
  public static validate(data: Partial<ProjectKanbanItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
