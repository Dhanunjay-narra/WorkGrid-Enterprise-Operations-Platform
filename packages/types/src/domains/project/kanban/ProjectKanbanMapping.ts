export interface ProjectKanbanMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanMappingValidator {
  public static validate(data: Partial<ProjectKanbanMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
