export interface ProjectKanbanBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanBatchValidator {
  public static validate(data: Partial<ProjectKanbanBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
