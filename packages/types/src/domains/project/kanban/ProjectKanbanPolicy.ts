export interface ProjectKanbanPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanPolicyValidator {
  public static validate(data: Partial<ProjectKanbanPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
