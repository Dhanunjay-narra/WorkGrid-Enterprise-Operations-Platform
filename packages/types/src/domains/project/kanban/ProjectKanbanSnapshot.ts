export interface ProjectKanbanSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanSnapshotValidator {
  public static validate(data: Partial<ProjectKanbanSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
