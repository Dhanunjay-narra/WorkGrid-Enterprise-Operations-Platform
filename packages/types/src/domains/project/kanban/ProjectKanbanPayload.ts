export interface ProjectKanbanPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanPayloadValidator {
  public static validate(data: Partial<ProjectKanbanPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
