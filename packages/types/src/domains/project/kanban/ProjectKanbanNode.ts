export interface ProjectKanbanNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanNodeValidator {
  public static validate(data: Partial<ProjectKanbanNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
