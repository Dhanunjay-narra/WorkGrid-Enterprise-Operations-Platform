export interface ProjectKanbanTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanTaskValidator {
  public static validate(data: Partial<ProjectKanbanTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
