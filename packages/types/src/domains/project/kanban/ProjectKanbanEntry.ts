export interface ProjectKanbanEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanEntryValidator {
  public static validate(data: Partial<ProjectKanbanEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
