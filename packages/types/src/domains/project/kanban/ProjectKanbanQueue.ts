export interface ProjectKanbanQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanQueueValidator {
  public static validate(data: Partial<ProjectKanbanQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
