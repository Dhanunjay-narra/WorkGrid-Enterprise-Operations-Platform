export interface ProjectKanbanReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanReportValidator {
  public static validate(data: Partial<ProjectKanbanReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
