export interface ProjectKanbanSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanSummaryValidator {
  public static validate(data: Partial<ProjectKanbanSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
