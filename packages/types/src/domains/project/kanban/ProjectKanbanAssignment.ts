export interface ProjectKanbanAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanAssignmentValidator {
  public static validate(data: Partial<ProjectKanbanAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
