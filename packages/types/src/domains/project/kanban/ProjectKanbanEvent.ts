export interface ProjectKanbanEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanEventValidator {
  public static validate(data: Partial<ProjectKanbanEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
