export interface ProjectKanbanAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanAuditLogValidator {
  public static validate(data: Partial<ProjectKanbanAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
