export interface ProjectKanbanRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanRecordValidator {
  public static validate(data: Partial<ProjectKanbanRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
