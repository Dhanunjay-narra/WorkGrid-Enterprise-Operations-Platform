export interface ProjectKanbanProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanProfileValidator {
  public static validate(data: Partial<ProjectKanbanProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
