export interface ProjectKanbanScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanScheduleValidator {
  public static validate(data: Partial<ProjectKanbanScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
