export interface ProjectKanbanThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanThresholdValidator {
  public static validate(data: Partial<ProjectKanbanThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
