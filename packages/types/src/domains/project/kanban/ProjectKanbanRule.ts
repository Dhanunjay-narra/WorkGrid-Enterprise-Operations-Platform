export interface ProjectKanbanRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanRuleValidator {
  public static validate(data: Partial<ProjectKanbanRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
