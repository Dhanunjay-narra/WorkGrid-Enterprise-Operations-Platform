export interface ProjectKanbanStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanStateValidator {
  public static validate(data: Partial<ProjectKanbanStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
