export interface ProjectKanbanConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanConfigValidator {
  public static validate(data: Partial<ProjectKanbanConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
