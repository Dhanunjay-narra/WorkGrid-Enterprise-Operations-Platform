export interface ProjectKanbanSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectKanbanSessionValidator {
  public static validate(data: Partial<ProjectKanbanSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
