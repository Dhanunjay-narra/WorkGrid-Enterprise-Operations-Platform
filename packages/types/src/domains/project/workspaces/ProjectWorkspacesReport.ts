export interface ProjectWorkspacesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesReportValidator {
  public static validate(data: Partial<ProjectWorkspacesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
