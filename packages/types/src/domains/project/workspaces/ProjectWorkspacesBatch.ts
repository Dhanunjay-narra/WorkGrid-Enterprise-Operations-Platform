export interface ProjectWorkspacesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesBatchValidator {
  public static validate(data: Partial<ProjectWorkspacesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
