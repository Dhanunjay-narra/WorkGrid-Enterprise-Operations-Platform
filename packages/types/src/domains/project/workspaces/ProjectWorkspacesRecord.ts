export interface ProjectWorkspacesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesRecordValidator {
  public static validate(data: Partial<ProjectWorkspacesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
