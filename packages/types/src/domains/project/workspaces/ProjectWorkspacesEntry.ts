export interface ProjectWorkspacesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesEntryValidator {
  public static validate(data: Partial<ProjectWorkspacesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
