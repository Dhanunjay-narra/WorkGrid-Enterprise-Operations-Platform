export interface ProjectWorkspacesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesScheduleValidator {
  public static validate(data: Partial<ProjectWorkspacesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
