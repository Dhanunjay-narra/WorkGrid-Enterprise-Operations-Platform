export interface ProjectWorkspacesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesQueueValidator {
  public static validate(data: Partial<ProjectWorkspacesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
