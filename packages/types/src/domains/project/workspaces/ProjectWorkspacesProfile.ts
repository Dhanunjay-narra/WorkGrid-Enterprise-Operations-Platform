export interface ProjectWorkspacesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesProfileValidator {
  public static validate(data: Partial<ProjectWorkspacesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
