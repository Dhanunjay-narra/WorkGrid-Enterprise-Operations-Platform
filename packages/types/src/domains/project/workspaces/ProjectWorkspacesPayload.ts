export interface ProjectWorkspacesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesPayloadValidator {
  public static validate(data: Partial<ProjectWorkspacesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
