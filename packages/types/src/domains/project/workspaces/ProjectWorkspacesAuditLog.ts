export interface ProjectWorkspacesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesAuditLogValidator {
  public static validate(data: Partial<ProjectWorkspacesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
