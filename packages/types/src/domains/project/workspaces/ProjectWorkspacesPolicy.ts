export interface ProjectWorkspacesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesPolicyValidator {
  public static validate(data: Partial<ProjectWorkspacesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
