export interface ProjectWorkspacesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesMetricValidator {
  public static validate(data: Partial<ProjectWorkspacesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
