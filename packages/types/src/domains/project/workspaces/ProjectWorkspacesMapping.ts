export interface ProjectWorkspacesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesMappingValidator {
  public static validate(data: Partial<ProjectWorkspacesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
