export interface ProjectWorkspacesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesNodeValidator {
  public static validate(data: Partial<ProjectWorkspacesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
