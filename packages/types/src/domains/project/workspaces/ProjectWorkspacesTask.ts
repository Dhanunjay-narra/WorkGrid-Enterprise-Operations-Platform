export interface ProjectWorkspacesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesTaskValidator {
  public static validate(data: Partial<ProjectWorkspacesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
