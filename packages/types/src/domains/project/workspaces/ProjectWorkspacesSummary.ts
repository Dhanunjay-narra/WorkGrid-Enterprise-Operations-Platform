export interface ProjectWorkspacesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesSummaryValidator {
  public static validate(data: Partial<ProjectWorkspacesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
