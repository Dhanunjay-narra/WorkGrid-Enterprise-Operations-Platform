export interface ProjectWorkspacesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesAssignmentValidator {
  public static validate(data: Partial<ProjectWorkspacesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
