export interface ProjectWorkspacesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesStateValidator {
  public static validate(data: Partial<ProjectWorkspacesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
