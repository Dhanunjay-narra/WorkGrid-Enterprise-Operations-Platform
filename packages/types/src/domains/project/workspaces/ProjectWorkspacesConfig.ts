export interface ProjectWorkspacesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesConfigValidator {
  public static validate(data: Partial<ProjectWorkspacesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
