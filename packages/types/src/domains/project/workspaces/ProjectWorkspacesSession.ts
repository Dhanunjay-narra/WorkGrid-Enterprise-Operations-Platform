export interface ProjectWorkspacesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesSessionValidator {
  public static validate(data: Partial<ProjectWorkspacesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
