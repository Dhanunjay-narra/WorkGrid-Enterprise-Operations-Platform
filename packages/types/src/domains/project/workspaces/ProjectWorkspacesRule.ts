export interface ProjectWorkspacesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesRuleValidator {
  public static validate(data: Partial<ProjectWorkspacesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
