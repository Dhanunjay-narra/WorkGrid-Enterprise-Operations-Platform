export interface ProjectWorkspacesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesThresholdValidator {
  public static validate(data: Partial<ProjectWorkspacesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
