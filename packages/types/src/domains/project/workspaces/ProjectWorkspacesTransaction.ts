export interface ProjectWorkspacesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesTransactionValidator {
  public static validate(data: Partial<ProjectWorkspacesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
