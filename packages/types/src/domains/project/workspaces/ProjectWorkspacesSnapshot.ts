export interface ProjectWorkspacesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesSnapshotValidator {
  public static validate(data: Partial<ProjectWorkspacesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
