export interface ProjectWorkspacesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectWorkspacesEventValidator {
  public static validate(data: Partial<ProjectWorkspacesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
