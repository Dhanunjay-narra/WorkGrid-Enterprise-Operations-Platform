export interface ProjectEpicsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsAuditLogValidator {
  public static validate(data: Partial<ProjectEpicsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
