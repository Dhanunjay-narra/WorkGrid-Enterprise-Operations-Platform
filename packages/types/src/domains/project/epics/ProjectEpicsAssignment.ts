export interface ProjectEpicsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsAssignmentValidator {
  public static validate(data: Partial<ProjectEpicsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
