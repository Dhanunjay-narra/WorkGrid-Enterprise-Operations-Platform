export interface ProjectEpicsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsScheduleValidator {
  public static validate(data: Partial<ProjectEpicsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
