export interface ProjectEpicsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsRecordValidator {
  public static validate(data: Partial<ProjectEpicsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
