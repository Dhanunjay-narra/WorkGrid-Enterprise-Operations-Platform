export interface ProjectEpicsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsThresholdValidator {
  public static validate(data: Partial<ProjectEpicsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
