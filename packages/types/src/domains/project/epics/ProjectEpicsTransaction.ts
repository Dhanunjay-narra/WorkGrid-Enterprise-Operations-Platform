export interface ProjectEpicsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsTransactionValidator {
  public static validate(data: Partial<ProjectEpicsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
