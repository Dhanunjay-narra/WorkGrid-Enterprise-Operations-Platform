export interface ProjectEpicsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsEntryValidator {
  public static validate(data: Partial<ProjectEpicsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
