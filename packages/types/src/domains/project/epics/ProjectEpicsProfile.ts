export interface ProjectEpicsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsProfileValidator {
  public static validate(data: Partial<ProjectEpicsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
