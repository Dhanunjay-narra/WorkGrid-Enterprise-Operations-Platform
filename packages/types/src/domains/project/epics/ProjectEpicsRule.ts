export interface ProjectEpicsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsRuleValidator {
  public static validate(data: Partial<ProjectEpicsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
