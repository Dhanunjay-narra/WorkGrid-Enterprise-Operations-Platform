export interface ProjectEpicsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsMappingValidator {
  public static validate(data: Partial<ProjectEpicsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
