export interface ProjectEpicsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsQueueValidator {
  public static validate(data: Partial<ProjectEpicsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
