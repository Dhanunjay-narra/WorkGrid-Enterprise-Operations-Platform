export interface ProjectEpicsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsReportValidator {
  public static validate(data: Partial<ProjectEpicsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
