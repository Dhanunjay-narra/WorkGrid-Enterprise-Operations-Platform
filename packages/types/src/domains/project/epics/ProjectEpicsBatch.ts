export interface ProjectEpicsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsBatchValidator {
  public static validate(data: Partial<ProjectEpicsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
