export interface ProjectEpicsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsSessionValidator {
  public static validate(data: Partial<ProjectEpicsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
