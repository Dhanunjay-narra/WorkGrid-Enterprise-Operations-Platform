export interface ProjectEpicsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsStateValidator {
  public static validate(data: Partial<ProjectEpicsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
