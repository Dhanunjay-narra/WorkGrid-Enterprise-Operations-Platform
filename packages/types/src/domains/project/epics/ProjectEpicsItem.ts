export interface ProjectEpicsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsItemValidator {
  public static validate(data: Partial<ProjectEpicsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
