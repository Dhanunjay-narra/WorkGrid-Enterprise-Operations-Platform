export interface ProjectEpicsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsPolicyValidator {
  public static validate(data: Partial<ProjectEpicsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
