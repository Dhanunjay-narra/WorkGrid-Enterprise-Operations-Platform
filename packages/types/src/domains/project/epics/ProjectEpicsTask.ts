export interface ProjectEpicsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsTaskValidator {
  public static validate(data: Partial<ProjectEpicsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
