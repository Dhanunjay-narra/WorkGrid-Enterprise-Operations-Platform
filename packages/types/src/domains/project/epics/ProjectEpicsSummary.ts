export interface ProjectEpicsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsSummaryValidator {
  public static validate(data: Partial<ProjectEpicsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
