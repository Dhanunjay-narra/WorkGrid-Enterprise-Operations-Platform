export interface ProjectEpicsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsConfigValidator {
  public static validate(data: Partial<ProjectEpicsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
