export interface ProjectEpicsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsEventValidator {
  public static validate(data: Partial<ProjectEpicsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
