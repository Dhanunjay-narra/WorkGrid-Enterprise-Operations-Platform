export interface ProjectEpicsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsSnapshotValidator {
  public static validate(data: Partial<ProjectEpicsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
