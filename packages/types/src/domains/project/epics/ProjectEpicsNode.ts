export interface ProjectEpicsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsNodeValidator {
  public static validate(data: Partial<ProjectEpicsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
