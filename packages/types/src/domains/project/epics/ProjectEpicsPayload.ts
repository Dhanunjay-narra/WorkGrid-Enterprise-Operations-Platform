export interface ProjectEpicsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsPayloadValidator {
  public static validate(data: Partial<ProjectEpicsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
