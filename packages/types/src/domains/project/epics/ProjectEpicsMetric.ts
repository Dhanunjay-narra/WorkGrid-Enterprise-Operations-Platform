export interface ProjectEpicsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ProjectEpicsMetricValidator {
  public static validate(data: Partial<ProjectEpicsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
