export interface WorkflowNodesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesSummaryValidator {
  public static validate(data: Partial<WorkflowNodesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
