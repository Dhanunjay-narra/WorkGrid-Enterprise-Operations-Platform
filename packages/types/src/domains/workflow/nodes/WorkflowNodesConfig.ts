export interface WorkflowNodesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesConfigValidator {
  public static validate(data: Partial<WorkflowNodesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
