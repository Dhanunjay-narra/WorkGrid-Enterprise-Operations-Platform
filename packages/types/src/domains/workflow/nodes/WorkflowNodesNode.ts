export interface WorkflowNodesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesNodeValidator {
  public static validate(data: Partial<WorkflowNodesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
