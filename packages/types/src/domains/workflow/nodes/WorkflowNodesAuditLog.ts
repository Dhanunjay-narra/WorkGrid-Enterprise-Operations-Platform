export interface WorkflowNodesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesAuditLogValidator {
  public static validate(data: Partial<WorkflowNodesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
