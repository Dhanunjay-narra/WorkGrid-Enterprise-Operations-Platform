export interface WorkflowNodesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesMappingValidator {
  public static validate(data: Partial<WorkflowNodesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
