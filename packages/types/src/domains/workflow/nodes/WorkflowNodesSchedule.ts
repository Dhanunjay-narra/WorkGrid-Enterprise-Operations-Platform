export interface WorkflowNodesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesScheduleValidator {
  public static validate(data: Partial<WorkflowNodesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
