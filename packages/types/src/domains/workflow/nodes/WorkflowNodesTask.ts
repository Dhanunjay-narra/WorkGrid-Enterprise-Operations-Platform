export interface WorkflowNodesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesTaskValidator {
  public static validate(data: Partial<WorkflowNodesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
