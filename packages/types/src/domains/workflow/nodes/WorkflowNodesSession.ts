export interface WorkflowNodesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesSessionValidator {
  public static validate(data: Partial<WorkflowNodesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
