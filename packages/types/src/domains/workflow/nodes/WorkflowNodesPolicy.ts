export interface WorkflowNodesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesPolicyValidator {
  public static validate(data: Partial<WorkflowNodesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
