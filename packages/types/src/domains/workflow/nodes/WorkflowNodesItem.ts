export interface WorkflowNodesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesItemValidator {
  public static validate(data: Partial<WorkflowNodesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
