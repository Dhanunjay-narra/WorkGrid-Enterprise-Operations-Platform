export interface WorkflowNodesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesEntryValidator {
  public static validate(data: Partial<WorkflowNodesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
