export interface WorkflowNodesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesTransactionValidator {
  public static validate(data: Partial<WorkflowNodesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
