export interface WorkflowNodesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesQueueValidator {
  public static validate(data: Partial<WorkflowNodesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
