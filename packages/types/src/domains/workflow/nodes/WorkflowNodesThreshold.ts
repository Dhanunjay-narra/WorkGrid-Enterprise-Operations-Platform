export interface WorkflowNodesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesThresholdValidator {
  public static validate(data: Partial<WorkflowNodesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
