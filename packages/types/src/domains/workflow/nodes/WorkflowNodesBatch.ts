export interface WorkflowNodesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesBatchValidator {
  public static validate(data: Partial<WorkflowNodesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
