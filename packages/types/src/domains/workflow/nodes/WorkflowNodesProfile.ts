export interface WorkflowNodesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesProfileValidator {
  public static validate(data: Partial<WorkflowNodesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
