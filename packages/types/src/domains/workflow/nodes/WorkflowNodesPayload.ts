export interface WorkflowNodesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesPayloadValidator {
  public static validate(data: Partial<WorkflowNodesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
