export interface WorkflowNodesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesMetricValidator {
  public static validate(data: Partial<WorkflowNodesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
