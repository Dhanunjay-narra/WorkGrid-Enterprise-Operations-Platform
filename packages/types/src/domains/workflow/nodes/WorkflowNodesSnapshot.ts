export interface WorkflowNodesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesSnapshotValidator {
  public static validate(data: Partial<WorkflowNodesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
