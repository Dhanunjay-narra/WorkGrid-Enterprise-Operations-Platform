export interface WorkflowNodesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesEventValidator {
  public static validate(data: Partial<WorkflowNodesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
