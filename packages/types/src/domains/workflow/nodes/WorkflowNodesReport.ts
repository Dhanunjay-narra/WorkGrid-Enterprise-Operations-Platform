export interface WorkflowNodesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesReportValidator {
  public static validate(data: Partial<WorkflowNodesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
