export interface WorkflowNodesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesRecordValidator {
  public static validate(data: Partial<WorkflowNodesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
