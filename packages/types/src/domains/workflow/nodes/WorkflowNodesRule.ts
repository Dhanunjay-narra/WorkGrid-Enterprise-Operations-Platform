export interface WorkflowNodesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesRuleValidator {
  public static validate(data: Partial<WorkflowNodesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
