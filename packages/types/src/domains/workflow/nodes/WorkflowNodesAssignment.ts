export interface WorkflowNodesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesAssignmentValidator {
  public static validate(data: Partial<WorkflowNodesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
