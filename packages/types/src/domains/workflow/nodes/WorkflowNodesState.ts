export interface WorkflowNodesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowNodesStateValidator {
  public static validate(data: Partial<WorkflowNodesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
