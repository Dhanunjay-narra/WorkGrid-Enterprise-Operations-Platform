export interface WorkflowVariablesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesEventValidator {
  public static validate(data: Partial<WorkflowVariablesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
