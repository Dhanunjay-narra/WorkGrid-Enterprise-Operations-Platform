export interface WorkflowVariablesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesMappingValidator {
  public static validate(data: Partial<WorkflowVariablesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
