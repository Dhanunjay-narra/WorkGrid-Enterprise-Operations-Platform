export interface WorkflowVariablesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesItemValidator {
  public static validate(data: Partial<WorkflowVariablesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
