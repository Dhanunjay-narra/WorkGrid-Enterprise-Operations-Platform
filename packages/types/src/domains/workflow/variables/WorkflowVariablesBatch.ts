export interface WorkflowVariablesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesBatchValidator {
  public static validate(data: Partial<WorkflowVariablesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
