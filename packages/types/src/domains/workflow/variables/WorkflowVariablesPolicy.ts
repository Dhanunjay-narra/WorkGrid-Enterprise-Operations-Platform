export interface WorkflowVariablesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesPolicyValidator {
  public static validate(data: Partial<WorkflowVariablesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
