export interface WorkflowVariablesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesSessionValidator {
  public static validate(data: Partial<WorkflowVariablesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
