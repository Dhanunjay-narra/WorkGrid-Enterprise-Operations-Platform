export interface WorkflowVariablesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesConfigValidator {
  public static validate(data: Partial<WorkflowVariablesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
