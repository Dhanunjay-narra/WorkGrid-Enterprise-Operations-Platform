export interface WorkflowVariablesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesMetricValidator {
  public static validate(data: Partial<WorkflowVariablesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
