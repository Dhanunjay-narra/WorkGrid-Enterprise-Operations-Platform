export interface WorkflowVariablesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesAuditLogValidator {
  public static validate(data: Partial<WorkflowVariablesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
