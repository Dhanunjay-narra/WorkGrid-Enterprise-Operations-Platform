export interface WorkflowVariablesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesPayloadValidator {
  public static validate(data: Partial<WorkflowVariablesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
