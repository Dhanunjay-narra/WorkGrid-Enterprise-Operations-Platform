export interface WorkflowVariablesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesTransactionValidator {
  public static validate(data: Partial<WorkflowVariablesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
