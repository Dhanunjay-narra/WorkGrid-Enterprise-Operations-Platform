export interface WorkflowVariablesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesSummaryValidator {
  public static validate(data: Partial<WorkflowVariablesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
