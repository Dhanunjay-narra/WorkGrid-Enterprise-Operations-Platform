export interface WorkflowVariablesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesRuleValidator {
  public static validate(data: Partial<WorkflowVariablesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
