export interface WorkflowVariablesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesReportValidator {
  public static validate(data: Partial<WorkflowVariablesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
