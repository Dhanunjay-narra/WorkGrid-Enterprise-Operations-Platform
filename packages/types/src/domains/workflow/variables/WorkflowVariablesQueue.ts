export interface WorkflowVariablesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesQueueValidator {
  public static validate(data: Partial<WorkflowVariablesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
