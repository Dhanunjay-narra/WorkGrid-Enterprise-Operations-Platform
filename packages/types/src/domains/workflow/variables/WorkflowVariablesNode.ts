export interface WorkflowVariablesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesNodeValidator {
  public static validate(data: Partial<WorkflowVariablesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
