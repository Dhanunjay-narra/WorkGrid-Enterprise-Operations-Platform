export interface WorkflowVariablesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesSnapshotValidator {
  public static validate(data: Partial<WorkflowVariablesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
