export interface WorkflowVariablesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesRecordValidator {
  public static validate(data: Partial<WorkflowVariablesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
