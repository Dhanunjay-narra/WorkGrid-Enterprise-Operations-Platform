export interface WorkflowVariablesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesThresholdValidator {
  public static validate(data: Partial<WorkflowVariablesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
