export interface WorkflowVariablesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesEntryValidator {
  public static validate(data: Partial<WorkflowVariablesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
