export interface WorkflowVariablesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesAssignmentValidator {
  public static validate(data: Partial<WorkflowVariablesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
