export interface WorkflowVariablesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesScheduleValidator {
  public static validate(data: Partial<WorkflowVariablesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
