export interface WorkflowVariablesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesTaskValidator {
  public static validate(data: Partial<WorkflowVariablesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
