export interface WorkflowVariablesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesProfileValidator {
  public static validate(data: Partial<WorkflowVariablesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
