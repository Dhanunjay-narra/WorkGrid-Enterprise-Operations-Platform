export interface WorkflowVariablesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowVariablesStateValidator {
  public static validate(data: Partial<WorkflowVariablesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
