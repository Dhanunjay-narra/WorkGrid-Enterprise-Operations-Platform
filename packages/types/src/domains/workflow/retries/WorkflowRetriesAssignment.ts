export interface WorkflowRetriesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesAssignmentValidator {
  public static validate(data: Partial<WorkflowRetriesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
