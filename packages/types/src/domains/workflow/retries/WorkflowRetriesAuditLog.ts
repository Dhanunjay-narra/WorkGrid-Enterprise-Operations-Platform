export interface WorkflowRetriesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesAuditLogValidator {
  public static validate(data: Partial<WorkflowRetriesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
