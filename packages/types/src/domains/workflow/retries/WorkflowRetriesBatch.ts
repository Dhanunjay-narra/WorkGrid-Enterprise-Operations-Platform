export interface WorkflowRetriesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesBatchValidator {
  public static validate(data: Partial<WorkflowRetriesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
