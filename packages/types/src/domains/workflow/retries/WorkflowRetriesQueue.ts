export interface WorkflowRetriesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesQueueValidator {
  public static validate(data: Partial<WorkflowRetriesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
