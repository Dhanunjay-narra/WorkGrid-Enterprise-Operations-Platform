export interface WorkflowRetriesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesSessionValidator {
  public static validate(data: Partial<WorkflowRetriesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
