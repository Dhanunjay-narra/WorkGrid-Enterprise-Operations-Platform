export interface WorkflowRetriesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesStateValidator {
  public static validate(data: Partial<WorkflowRetriesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
