export interface WorkflowRetriesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesPayloadValidator {
  public static validate(data: Partial<WorkflowRetriesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
