export interface WorkflowRetriesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesMappingValidator {
  public static validate(data: Partial<WorkflowRetriesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
