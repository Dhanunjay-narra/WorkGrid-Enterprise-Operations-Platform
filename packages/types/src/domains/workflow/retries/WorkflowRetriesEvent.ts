export interface WorkflowRetriesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesEventValidator {
  public static validate(data: Partial<WorkflowRetriesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
