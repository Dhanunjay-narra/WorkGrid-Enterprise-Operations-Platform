export interface WorkflowRetriesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesTransactionValidator {
  public static validate(data: Partial<WorkflowRetriesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
