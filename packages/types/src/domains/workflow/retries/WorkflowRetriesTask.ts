export interface WorkflowRetriesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesTaskValidator {
  public static validate(data: Partial<WorkflowRetriesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
