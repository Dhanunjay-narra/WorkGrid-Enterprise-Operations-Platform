export interface WorkflowRetriesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesRecordValidator {
  public static validate(data: Partial<WorkflowRetriesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
