export interface WorkflowRetriesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesSummaryValidator {
  public static validate(data: Partial<WorkflowRetriesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
