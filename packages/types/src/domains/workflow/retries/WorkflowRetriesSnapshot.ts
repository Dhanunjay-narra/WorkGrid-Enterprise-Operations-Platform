export interface WorkflowRetriesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesSnapshotValidator {
  public static validate(data: Partial<WorkflowRetriesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
