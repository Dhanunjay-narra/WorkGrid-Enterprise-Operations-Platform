export interface WorkflowRetriesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesNodeValidator {
  public static validate(data: Partial<WorkflowRetriesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
