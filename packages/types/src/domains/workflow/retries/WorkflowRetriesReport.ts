export interface WorkflowRetriesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesReportValidator {
  public static validate(data: Partial<WorkflowRetriesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
