export interface WorkflowRetriesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesItemValidator {
  public static validate(data: Partial<WorkflowRetriesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
