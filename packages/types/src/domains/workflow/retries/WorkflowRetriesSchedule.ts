export interface WorkflowRetriesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesScheduleValidator {
  public static validate(data: Partial<WorkflowRetriesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
