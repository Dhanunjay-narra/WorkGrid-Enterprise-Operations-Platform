export interface WorkflowRetriesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesRuleValidator {
  public static validate(data: Partial<WorkflowRetriesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
