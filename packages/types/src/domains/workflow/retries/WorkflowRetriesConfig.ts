export interface WorkflowRetriesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesConfigValidator {
  public static validate(data: Partial<WorkflowRetriesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
