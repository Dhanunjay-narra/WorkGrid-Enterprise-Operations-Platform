export interface WorkflowRetriesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesProfileValidator {
  public static validate(data: Partial<WorkflowRetriesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
