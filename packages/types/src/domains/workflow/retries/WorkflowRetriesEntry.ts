export interface WorkflowRetriesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesEntryValidator {
  public static validate(data: Partial<WorkflowRetriesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
