export interface WorkflowRetriesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesMetricValidator {
  public static validate(data: Partial<WorkflowRetriesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
