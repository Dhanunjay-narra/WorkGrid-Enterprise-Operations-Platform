export interface WorkflowRetriesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowRetriesThresholdValidator {
  public static validate(data: Partial<WorkflowRetriesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
