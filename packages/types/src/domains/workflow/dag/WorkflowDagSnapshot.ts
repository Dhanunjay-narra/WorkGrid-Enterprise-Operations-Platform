export interface WorkflowDagSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagSnapshotValidator {
  public static validate(data: Partial<WorkflowDagSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
