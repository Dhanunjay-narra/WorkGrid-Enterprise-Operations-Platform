export interface WorkflowDagThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagThresholdValidator {
  public static validate(data: Partial<WorkflowDagThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
