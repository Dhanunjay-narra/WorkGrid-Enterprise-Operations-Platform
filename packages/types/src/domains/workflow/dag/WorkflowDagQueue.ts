export interface WorkflowDagQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagQueueValidator {
  public static validate(data: Partial<WorkflowDagQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
