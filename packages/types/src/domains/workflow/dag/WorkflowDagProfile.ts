export interface WorkflowDagProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagProfileValidator {
  public static validate(data: Partial<WorkflowDagProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
