export interface WorkflowDagAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagAssignmentValidator {
  public static validate(data: Partial<WorkflowDagAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
