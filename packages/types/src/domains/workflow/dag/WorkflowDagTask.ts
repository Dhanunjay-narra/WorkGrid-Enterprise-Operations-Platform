export interface WorkflowDagTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagTaskValidator {
  public static validate(data: Partial<WorkflowDagTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
