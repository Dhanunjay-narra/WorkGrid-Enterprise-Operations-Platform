export interface WorkflowDagScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagScheduleValidator {
  public static validate(data: Partial<WorkflowDagScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
