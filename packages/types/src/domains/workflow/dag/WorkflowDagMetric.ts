export interface WorkflowDagMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagMetricValidator {
  public static validate(data: Partial<WorkflowDagMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
