export interface WorkflowDagItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagItemValidator {
  public static validate(data: Partial<WorkflowDagItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
