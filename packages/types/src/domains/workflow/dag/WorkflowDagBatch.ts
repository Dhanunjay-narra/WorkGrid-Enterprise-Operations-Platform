export interface WorkflowDagBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagBatchValidator {
  public static validate(data: Partial<WorkflowDagBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
