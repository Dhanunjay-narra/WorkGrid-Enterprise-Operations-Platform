export interface WorkflowDagReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagReportValidator {
  public static validate(data: Partial<WorkflowDagReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
