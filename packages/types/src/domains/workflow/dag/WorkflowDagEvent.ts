export interface WorkflowDagEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagEventValidator {
  public static validate(data: Partial<WorkflowDagEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
