export interface WorkflowDagRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagRecordValidator {
  public static validate(data: Partial<WorkflowDagRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
