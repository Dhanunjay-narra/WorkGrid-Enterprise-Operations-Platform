export interface WorkflowDagConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagConfigValidator {
  public static validate(data: Partial<WorkflowDagConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
