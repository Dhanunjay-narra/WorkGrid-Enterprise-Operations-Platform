export interface WorkflowDagEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagEntryValidator {
  public static validate(data: Partial<WorkflowDagEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
