export interface WorkflowDagSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagSessionValidator {
  public static validate(data: Partial<WorkflowDagSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
