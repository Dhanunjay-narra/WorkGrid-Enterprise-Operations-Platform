export interface WorkflowDagSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagSummaryValidator {
  public static validate(data: Partial<WorkflowDagSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
