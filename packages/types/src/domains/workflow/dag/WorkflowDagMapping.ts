export interface WorkflowDagMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagMappingValidator {
  public static validate(data: Partial<WorkflowDagMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
