export interface WorkflowDagAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagAuditLogValidator {
  public static validate(data: Partial<WorkflowDagAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
