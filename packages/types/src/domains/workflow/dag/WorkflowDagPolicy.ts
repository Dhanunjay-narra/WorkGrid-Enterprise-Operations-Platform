export interface WorkflowDagPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagPolicyValidator {
  public static validate(data: Partial<WorkflowDagPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
