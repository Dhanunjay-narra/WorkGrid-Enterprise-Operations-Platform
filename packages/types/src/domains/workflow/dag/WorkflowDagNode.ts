export interface WorkflowDagNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagNodeValidator {
  public static validate(data: Partial<WorkflowDagNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
