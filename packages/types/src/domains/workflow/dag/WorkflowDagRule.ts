export interface WorkflowDagRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagRuleValidator {
  public static validate(data: Partial<WorkflowDagRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
