export interface WorkflowDagTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagTransactionValidator {
  public static validate(data: Partial<WorkflowDagTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
