export interface WorkflowDagStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagStateValidator {
  public static validate(data: Partial<WorkflowDagStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
