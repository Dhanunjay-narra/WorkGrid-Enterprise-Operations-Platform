export interface WorkflowDagPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowDagPayloadValidator {
  public static validate(data: Partial<WorkflowDagPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
