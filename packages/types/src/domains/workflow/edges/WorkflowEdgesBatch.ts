export interface WorkflowEdgesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesBatchValidator {
  public static validate(data: Partial<WorkflowEdgesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
