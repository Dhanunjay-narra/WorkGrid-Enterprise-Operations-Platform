export interface WorkflowEdgesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesEntryValidator {
  public static validate(data: Partial<WorkflowEdgesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
