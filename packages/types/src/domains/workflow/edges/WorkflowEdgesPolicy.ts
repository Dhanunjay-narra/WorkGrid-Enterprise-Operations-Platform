export interface WorkflowEdgesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesPolicyValidator {
  public static validate(data: Partial<WorkflowEdgesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
