export interface WorkflowEdgesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesAssignmentValidator {
  public static validate(data: Partial<WorkflowEdgesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
