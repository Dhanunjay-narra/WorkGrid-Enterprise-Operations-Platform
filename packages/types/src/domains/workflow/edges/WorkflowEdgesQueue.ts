export interface WorkflowEdgesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesQueueValidator {
  public static validate(data: Partial<WorkflowEdgesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
