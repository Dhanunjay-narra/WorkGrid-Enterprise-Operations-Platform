export interface WorkflowEdgesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesTransactionValidator {
  public static validate(data: Partial<WorkflowEdgesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
