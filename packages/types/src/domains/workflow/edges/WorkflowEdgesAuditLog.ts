export interface WorkflowEdgesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesAuditLogValidator {
  public static validate(data: Partial<WorkflowEdgesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
