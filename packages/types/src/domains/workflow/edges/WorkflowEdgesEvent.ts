export interface WorkflowEdgesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesEventValidator {
  public static validate(data: Partial<WorkflowEdgesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
