export interface WorkflowEdgesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesSnapshotValidator {
  public static validate(data: Partial<WorkflowEdgesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
