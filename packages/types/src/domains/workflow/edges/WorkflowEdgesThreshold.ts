export interface WorkflowEdgesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesThresholdValidator {
  public static validate(data: Partial<WorkflowEdgesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
