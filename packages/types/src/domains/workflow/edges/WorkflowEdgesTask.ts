export interface WorkflowEdgesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesTaskValidator {
  public static validate(data: Partial<WorkflowEdgesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
