export interface WorkflowEdgesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesNodeValidator {
  public static validate(data: Partial<WorkflowEdgesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
