export interface WorkflowEdgesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesSummaryValidator {
  public static validate(data: Partial<WorkflowEdgesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
