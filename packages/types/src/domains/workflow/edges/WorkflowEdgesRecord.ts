export interface WorkflowEdgesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesRecordValidator {
  public static validate(data: Partial<WorkflowEdgesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
