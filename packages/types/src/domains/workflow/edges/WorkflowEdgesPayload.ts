export interface WorkflowEdgesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesPayloadValidator {
  public static validate(data: Partial<WorkflowEdgesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
