export interface WorkflowEdgesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesRuleValidator {
  public static validate(data: Partial<WorkflowEdgesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
