export interface WorkflowEdgesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesMappingValidator {
  public static validate(data: Partial<WorkflowEdgesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
