export interface WorkflowEdgesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesSessionValidator {
  public static validate(data: Partial<WorkflowEdgesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
