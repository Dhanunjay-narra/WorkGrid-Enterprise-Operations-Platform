export interface WorkflowEdgesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesMetricValidator {
  public static validate(data: Partial<WorkflowEdgesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
