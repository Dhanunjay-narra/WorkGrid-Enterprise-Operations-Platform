export interface WorkflowEdgesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesItemValidator {
  public static validate(data: Partial<WorkflowEdgesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
