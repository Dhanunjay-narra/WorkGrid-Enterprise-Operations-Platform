export interface WorkflowEdgesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesReportValidator {
  public static validate(data: Partial<WorkflowEdgesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
