export interface WorkflowEdgesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesScheduleValidator {
  public static validate(data: Partial<WorkflowEdgesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
