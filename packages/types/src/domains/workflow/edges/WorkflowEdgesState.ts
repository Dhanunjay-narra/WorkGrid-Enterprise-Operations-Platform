export interface WorkflowEdgesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesStateValidator {
  public static validate(data: Partial<WorkflowEdgesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
