export interface WorkflowEdgesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesConfigValidator {
  public static validate(data: Partial<WorkflowEdgesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
