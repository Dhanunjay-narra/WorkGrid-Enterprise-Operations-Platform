export interface WorkflowEdgesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowEdgesProfileValidator {
  public static validate(data: Partial<WorkflowEdgesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
