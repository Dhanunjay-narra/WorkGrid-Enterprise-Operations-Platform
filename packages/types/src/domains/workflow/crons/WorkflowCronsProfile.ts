export interface WorkflowCronsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsProfileValidator {
  public static validate(data: Partial<WorkflowCronsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
