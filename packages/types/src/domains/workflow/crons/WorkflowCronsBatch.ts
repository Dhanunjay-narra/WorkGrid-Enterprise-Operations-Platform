export interface WorkflowCronsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsBatchValidator {
  public static validate(data: Partial<WorkflowCronsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
