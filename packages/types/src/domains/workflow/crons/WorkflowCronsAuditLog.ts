export interface WorkflowCronsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsAuditLogValidator {
  public static validate(data: Partial<WorkflowCronsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
