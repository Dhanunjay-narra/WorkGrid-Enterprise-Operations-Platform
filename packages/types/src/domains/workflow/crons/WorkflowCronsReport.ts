export interface WorkflowCronsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsReportValidator {
  public static validate(data: Partial<WorkflowCronsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
