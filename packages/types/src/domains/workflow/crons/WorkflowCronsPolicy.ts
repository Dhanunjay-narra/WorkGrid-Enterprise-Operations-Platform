export interface WorkflowCronsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsPolicyValidator {
  public static validate(data: Partial<WorkflowCronsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
