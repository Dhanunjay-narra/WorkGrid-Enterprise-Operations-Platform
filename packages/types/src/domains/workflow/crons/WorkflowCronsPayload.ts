export interface WorkflowCronsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsPayloadValidator {
  public static validate(data: Partial<WorkflowCronsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
