export interface WorkflowCronsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsEntryValidator {
  public static validate(data: Partial<WorkflowCronsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
