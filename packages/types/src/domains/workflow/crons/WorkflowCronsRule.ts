export interface WorkflowCronsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsRuleValidator {
  public static validate(data: Partial<WorkflowCronsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
