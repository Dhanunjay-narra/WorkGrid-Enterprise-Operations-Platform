export interface WorkflowCronsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsItemValidator {
  public static validate(data: Partial<WorkflowCronsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
