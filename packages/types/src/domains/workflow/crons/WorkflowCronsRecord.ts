export interface WorkflowCronsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsRecordValidator {
  public static validate(data: Partial<WorkflowCronsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
