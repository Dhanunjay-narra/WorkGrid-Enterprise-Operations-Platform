export interface WorkflowCronsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsThresholdValidator {
  public static validate(data: Partial<WorkflowCronsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
