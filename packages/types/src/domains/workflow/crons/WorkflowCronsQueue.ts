export interface WorkflowCronsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsQueueValidator {
  public static validate(data: Partial<WorkflowCronsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
