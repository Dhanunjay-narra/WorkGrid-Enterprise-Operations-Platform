export interface WorkflowCronsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsTaskValidator {
  public static validate(data: Partial<WorkflowCronsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
