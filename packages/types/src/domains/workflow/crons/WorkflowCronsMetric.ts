export interface WorkflowCronsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsMetricValidator {
  public static validate(data: Partial<WorkflowCronsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
