export interface WorkflowCronsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsSessionValidator {
  public static validate(data: Partial<WorkflowCronsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
