export interface WorkflowCronsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsConfigValidator {
  public static validate(data: Partial<WorkflowCronsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
