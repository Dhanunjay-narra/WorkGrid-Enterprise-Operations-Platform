export interface WorkflowCronsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsStateValidator {
  public static validate(data: Partial<WorkflowCronsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
