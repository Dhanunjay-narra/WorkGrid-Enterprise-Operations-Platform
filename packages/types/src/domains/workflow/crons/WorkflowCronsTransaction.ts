export interface WorkflowCronsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsTransactionValidator {
  public static validate(data: Partial<WorkflowCronsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
