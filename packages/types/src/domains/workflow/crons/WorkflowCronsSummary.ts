export interface WorkflowCronsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsSummaryValidator {
  public static validate(data: Partial<WorkflowCronsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
