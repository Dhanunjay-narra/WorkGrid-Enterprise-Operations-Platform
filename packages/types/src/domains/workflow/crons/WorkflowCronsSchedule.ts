export interface WorkflowCronsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsScheduleValidator {
  public static validate(data: Partial<WorkflowCronsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
