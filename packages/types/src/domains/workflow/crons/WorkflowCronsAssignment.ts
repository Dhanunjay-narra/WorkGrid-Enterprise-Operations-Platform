export interface WorkflowCronsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsAssignmentValidator {
  public static validate(data: Partial<WorkflowCronsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
