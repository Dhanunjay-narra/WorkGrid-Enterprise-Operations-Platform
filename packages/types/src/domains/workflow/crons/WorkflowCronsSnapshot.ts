export interface WorkflowCronsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsSnapshotValidator {
  public static validate(data: Partial<WorkflowCronsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
