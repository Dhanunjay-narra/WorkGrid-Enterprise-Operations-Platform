export interface WorkflowCronsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsEventValidator {
  public static validate(data: Partial<WorkflowCronsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
