export interface WorkflowCronsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsMappingValidator {
  public static validate(data: Partial<WorkflowCronsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
