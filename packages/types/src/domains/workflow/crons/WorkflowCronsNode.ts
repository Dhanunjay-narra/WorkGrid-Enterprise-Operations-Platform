export interface WorkflowCronsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowCronsNodeValidator {
  public static validate(data: Partial<WorkflowCronsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
