export interface WorkflowExecutionsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsRuleValidator {
  public static validate(data: Partial<WorkflowExecutionsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
