export interface WorkflowExecutionsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsConfigValidator {
  public static validate(data: Partial<WorkflowExecutionsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
