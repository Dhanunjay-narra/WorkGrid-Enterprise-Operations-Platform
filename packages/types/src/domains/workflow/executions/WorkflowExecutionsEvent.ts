export interface WorkflowExecutionsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsEventValidator {
  public static validate(data: Partial<WorkflowExecutionsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
