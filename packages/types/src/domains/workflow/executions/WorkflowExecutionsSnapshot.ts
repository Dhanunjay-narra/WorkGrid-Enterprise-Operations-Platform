export interface WorkflowExecutionsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsSnapshotValidator {
  public static validate(data: Partial<WorkflowExecutionsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
