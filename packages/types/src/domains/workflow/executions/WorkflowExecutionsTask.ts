export interface WorkflowExecutionsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsTaskValidator {
  public static validate(data: Partial<WorkflowExecutionsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
