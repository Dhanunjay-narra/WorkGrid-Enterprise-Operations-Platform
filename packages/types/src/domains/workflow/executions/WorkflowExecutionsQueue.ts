export interface WorkflowExecutionsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsQueueValidator {
  public static validate(data: Partial<WorkflowExecutionsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
