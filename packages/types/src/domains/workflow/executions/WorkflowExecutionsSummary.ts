export interface WorkflowExecutionsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsSummaryValidator {
  public static validate(data: Partial<WorkflowExecutionsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
