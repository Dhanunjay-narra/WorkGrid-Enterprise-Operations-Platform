export interface WorkflowExecutionsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsRecordValidator {
  public static validate(data: Partial<WorkflowExecutionsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
