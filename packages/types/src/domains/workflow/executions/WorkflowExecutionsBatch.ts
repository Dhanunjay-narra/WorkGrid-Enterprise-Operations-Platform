export interface WorkflowExecutionsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsBatchValidator {
  public static validate(data: Partial<WorkflowExecutionsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
