export interface WorkflowExecutionsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsMappingValidator {
  public static validate(data: Partial<WorkflowExecutionsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
