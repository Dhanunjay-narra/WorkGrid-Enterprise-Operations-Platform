export interface WorkflowExecutionsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsSessionValidator {
  public static validate(data: Partial<WorkflowExecutionsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
