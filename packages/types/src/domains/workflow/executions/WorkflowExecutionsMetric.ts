export interface WorkflowExecutionsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsMetricValidator {
  public static validate(data: Partial<WorkflowExecutionsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
