export interface WorkflowExecutionsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsTransactionValidator {
  public static validate(data: Partial<WorkflowExecutionsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
