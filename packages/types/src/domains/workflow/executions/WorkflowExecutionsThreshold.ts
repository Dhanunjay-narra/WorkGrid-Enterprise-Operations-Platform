export interface WorkflowExecutionsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsThresholdValidator {
  public static validate(data: Partial<WorkflowExecutionsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
