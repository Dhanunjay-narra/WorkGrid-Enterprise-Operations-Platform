export interface WorkflowExecutionsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsReportValidator {
  public static validate(data: Partial<WorkflowExecutionsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
