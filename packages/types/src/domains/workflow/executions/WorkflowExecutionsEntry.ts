export interface WorkflowExecutionsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsEntryValidator {
  public static validate(data: Partial<WorkflowExecutionsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
