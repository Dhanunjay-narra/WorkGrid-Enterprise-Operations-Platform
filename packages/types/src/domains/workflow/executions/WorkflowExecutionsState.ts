export interface WorkflowExecutionsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsStateValidator {
  public static validate(data: Partial<WorkflowExecutionsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
