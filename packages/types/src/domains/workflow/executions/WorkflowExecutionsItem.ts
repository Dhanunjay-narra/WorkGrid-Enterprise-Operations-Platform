export interface WorkflowExecutionsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsItemValidator {
  public static validate(data: Partial<WorkflowExecutionsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
