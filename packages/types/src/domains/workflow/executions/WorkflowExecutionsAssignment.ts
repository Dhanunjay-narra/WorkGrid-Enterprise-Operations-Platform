export interface WorkflowExecutionsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsAssignmentValidator {
  public static validate(data: Partial<WorkflowExecutionsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
