export interface WorkflowExecutionsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsProfileValidator {
  public static validate(data: Partial<WorkflowExecutionsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
