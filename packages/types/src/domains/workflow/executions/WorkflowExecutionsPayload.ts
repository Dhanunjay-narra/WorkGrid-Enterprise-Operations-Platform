export interface WorkflowExecutionsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsPayloadValidator {
  public static validate(data: Partial<WorkflowExecutionsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
