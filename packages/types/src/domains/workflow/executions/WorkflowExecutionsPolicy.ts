export interface WorkflowExecutionsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsPolicyValidator {
  public static validate(data: Partial<WorkflowExecutionsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
