export interface WorkflowExecutionsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsAuditLogValidator {
  public static validate(data: Partial<WorkflowExecutionsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
