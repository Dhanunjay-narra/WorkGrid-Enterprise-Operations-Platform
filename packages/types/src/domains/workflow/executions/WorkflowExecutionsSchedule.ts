export interface WorkflowExecutionsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowExecutionsScheduleValidator {
  public static validate(data: Partial<WorkflowExecutionsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
