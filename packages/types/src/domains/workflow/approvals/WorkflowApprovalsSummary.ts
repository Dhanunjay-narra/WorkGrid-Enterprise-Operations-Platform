export interface WorkflowApprovalsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsSummaryValidator {
  public static validate(data: Partial<WorkflowApprovalsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
