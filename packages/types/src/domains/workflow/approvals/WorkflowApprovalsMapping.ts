export interface WorkflowApprovalsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsMappingValidator {
  public static validate(data: Partial<WorkflowApprovalsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
