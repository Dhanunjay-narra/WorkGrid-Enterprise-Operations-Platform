export interface WorkflowApprovalsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsSnapshotValidator {
  public static validate(data: Partial<WorkflowApprovalsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
