export interface WorkflowApprovalsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsTransactionValidator {
  public static validate(data: Partial<WorkflowApprovalsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
