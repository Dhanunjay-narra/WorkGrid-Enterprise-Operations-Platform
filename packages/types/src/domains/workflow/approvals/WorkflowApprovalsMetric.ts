export interface WorkflowApprovalsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsMetricValidator {
  public static validate(data: Partial<WorkflowApprovalsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
