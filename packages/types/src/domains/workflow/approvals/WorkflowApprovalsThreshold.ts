export interface WorkflowApprovalsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsThresholdValidator {
  public static validate(data: Partial<WorkflowApprovalsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
