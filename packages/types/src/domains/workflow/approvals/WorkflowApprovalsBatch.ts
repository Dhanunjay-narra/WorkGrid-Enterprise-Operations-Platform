export interface WorkflowApprovalsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsBatchValidator {
  public static validate(data: Partial<WorkflowApprovalsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
