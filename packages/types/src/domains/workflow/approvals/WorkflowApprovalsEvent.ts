export interface WorkflowApprovalsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsEventValidator {
  public static validate(data: Partial<WorkflowApprovalsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
