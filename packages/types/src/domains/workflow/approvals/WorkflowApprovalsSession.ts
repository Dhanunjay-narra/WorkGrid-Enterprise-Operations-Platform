export interface WorkflowApprovalsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsSessionValidator {
  public static validate(data: Partial<WorkflowApprovalsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
