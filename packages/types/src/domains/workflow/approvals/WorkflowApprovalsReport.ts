export interface WorkflowApprovalsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsReportValidator {
  public static validate(data: Partial<WorkflowApprovalsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
