export interface WorkflowApprovalsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsAssignmentValidator {
  public static validate(data: Partial<WorkflowApprovalsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
