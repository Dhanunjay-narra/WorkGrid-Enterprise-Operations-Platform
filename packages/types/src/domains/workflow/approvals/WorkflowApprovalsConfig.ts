export interface WorkflowApprovalsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsConfigValidator {
  public static validate(data: Partial<WorkflowApprovalsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
