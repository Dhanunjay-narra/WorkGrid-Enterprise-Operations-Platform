export interface WorkflowApprovalsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsEntryValidator {
  public static validate(data: Partial<WorkflowApprovalsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
