export interface WorkflowApprovalsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsStateValidator {
  public static validate(data: Partial<WorkflowApprovalsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
