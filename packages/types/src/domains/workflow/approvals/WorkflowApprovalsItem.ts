export interface WorkflowApprovalsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsItemValidator {
  public static validate(data: Partial<WorkflowApprovalsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
