export interface WorkflowApprovalsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsAuditLogValidator {
  public static validate(data: Partial<WorkflowApprovalsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
