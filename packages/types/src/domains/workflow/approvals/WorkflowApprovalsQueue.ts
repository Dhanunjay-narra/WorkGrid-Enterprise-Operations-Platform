export interface WorkflowApprovalsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsQueueValidator {
  public static validate(data: Partial<WorkflowApprovalsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
