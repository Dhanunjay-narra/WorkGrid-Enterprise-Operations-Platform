export interface WorkflowApprovalsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsPolicyValidator {
  public static validate(data: Partial<WorkflowApprovalsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
