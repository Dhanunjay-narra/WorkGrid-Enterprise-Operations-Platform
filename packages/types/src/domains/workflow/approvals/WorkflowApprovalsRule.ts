export interface WorkflowApprovalsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsRuleValidator {
  public static validate(data: Partial<WorkflowApprovalsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
