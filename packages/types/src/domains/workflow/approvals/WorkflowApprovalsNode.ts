export interface WorkflowApprovalsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsNodeValidator {
  public static validate(data: Partial<WorkflowApprovalsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
