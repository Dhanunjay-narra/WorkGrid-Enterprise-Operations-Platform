export interface WorkflowApprovalsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsProfileValidator {
  public static validate(data: Partial<WorkflowApprovalsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
