export interface WorkflowApprovalsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsScheduleValidator {
  public static validate(data: Partial<WorkflowApprovalsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
