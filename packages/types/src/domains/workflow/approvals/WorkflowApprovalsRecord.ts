export interface WorkflowApprovalsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsRecordValidator {
  public static validate(data: Partial<WorkflowApprovalsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
