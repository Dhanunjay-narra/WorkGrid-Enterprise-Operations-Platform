export interface WorkflowApprovalsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class WorkflowApprovalsTaskValidator {
  public static validate(data: Partial<WorkflowApprovalsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
