export interface ObsProfilingAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingAuditLogValidator {
  public static validate(data: Partial<ObsProfilingAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
