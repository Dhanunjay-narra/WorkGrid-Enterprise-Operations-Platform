export interface ObsProfilingEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingEventValidator {
  public static validate(data: Partial<ObsProfilingEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
