export interface ObsProfilingNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingNodeValidator {
  public static validate(data: Partial<ObsProfilingNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
