export interface ObsProfilingThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingThresholdValidator {
  public static validate(data: Partial<ObsProfilingThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
