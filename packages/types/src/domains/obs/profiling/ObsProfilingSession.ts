export interface ObsProfilingSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingSessionValidator {
  public static validate(data: Partial<ObsProfilingSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
