export interface ObsProfilingConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingConfigValidator {
  public static validate(data: Partial<ObsProfilingConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
