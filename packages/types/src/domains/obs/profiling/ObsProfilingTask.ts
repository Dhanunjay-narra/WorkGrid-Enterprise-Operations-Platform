export interface ObsProfilingTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingTaskValidator {
  public static validate(data: Partial<ObsProfilingTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
