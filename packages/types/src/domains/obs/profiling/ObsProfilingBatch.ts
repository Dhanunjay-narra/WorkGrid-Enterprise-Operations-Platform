export interface ObsProfilingBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingBatchValidator {
  public static validate(data: Partial<ObsProfilingBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
