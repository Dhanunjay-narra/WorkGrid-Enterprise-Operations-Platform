export interface ObsProfilingPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingPayloadValidator {
  public static validate(data: Partial<ObsProfilingPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
