export interface ObsProfilingProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingProfileValidator {
  public static validate(data: Partial<ObsProfilingProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
