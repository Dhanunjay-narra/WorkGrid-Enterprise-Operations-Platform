export interface ObsProfilingTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingTransactionValidator {
  public static validate(data: Partial<ObsProfilingTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
