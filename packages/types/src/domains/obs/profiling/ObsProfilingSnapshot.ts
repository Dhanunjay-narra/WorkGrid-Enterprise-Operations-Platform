export interface ObsProfilingSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingSnapshotValidator {
  public static validate(data: Partial<ObsProfilingSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
