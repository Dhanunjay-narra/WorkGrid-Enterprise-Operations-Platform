export interface ObsProfilingStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingStateValidator {
  public static validate(data: Partial<ObsProfilingStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
