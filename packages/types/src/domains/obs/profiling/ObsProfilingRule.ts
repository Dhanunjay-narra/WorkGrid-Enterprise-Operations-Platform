export interface ObsProfilingRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingRuleValidator {
  public static validate(data: Partial<ObsProfilingRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
