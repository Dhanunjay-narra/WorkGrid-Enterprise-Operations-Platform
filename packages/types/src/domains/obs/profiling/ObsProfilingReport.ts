export interface ObsProfilingReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingReportValidator {
  public static validate(data: Partial<ObsProfilingReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
