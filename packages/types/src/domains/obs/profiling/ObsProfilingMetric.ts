export interface ObsProfilingMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingMetricValidator {
  public static validate(data: Partial<ObsProfilingMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
