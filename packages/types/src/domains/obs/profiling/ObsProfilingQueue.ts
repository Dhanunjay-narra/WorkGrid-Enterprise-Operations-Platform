export interface ObsProfilingQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingQueueValidator {
  public static validate(data: Partial<ObsProfilingQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
