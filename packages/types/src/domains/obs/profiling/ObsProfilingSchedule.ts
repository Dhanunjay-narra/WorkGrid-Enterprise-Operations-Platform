export interface ObsProfilingScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingScheduleValidator {
  public static validate(data: Partial<ObsProfilingScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
