export interface ObsProfilingEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingEntryValidator {
  public static validate(data: Partial<ObsProfilingEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
