export interface ObsProfilingAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingAssignmentValidator {
  public static validate(data: Partial<ObsProfilingAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
