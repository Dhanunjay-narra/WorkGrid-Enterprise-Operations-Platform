export interface ObsProfilingRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingRecordValidator {
  public static validate(data: Partial<ObsProfilingRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
