export interface ObsProfilingItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingItemValidator {
  public static validate(data: Partial<ObsProfilingItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
