export interface ObsProfilingMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingMappingValidator {
  public static validate(data: Partial<ObsProfilingMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
