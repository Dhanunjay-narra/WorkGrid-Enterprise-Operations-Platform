export interface ObsProfilingSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingSummaryValidator {
  public static validate(data: Partial<ObsProfilingSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
