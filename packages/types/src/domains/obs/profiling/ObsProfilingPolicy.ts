export interface ObsProfilingPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProfilingPolicyValidator {
  public static validate(data: Partial<ObsProfilingPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
