export interface ObsTracingTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingTaskValidator {
  public static validate(data: Partial<ObsTracingTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
