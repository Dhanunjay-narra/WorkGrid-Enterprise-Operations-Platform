export interface ObsTracingTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingTransactionValidator {
  public static validate(data: Partial<ObsTracingTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
