export interface ObsTracingPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingPayloadValidator {
  public static validate(data: Partial<ObsTracingPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
