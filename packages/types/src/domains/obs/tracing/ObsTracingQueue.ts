export interface ObsTracingQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingQueueValidator {
  public static validate(data: Partial<ObsTracingQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
