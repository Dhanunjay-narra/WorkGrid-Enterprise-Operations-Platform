export interface ObsTracingConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingConfigValidator {
  public static validate(data: Partial<ObsTracingConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
