export interface ObsTracingProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingProfileValidator {
  public static validate(data: Partial<ObsTracingProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
