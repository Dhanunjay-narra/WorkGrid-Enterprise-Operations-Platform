export interface ObsTracingScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingScheduleValidator {
  public static validate(data: Partial<ObsTracingScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
