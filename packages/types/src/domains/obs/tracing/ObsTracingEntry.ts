export interface ObsTracingEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingEntryValidator {
  public static validate(data: Partial<ObsTracingEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
