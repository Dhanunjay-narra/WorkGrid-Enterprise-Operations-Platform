export interface ObsTracingBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingBatchValidator {
  public static validate(data: Partial<ObsTracingBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
