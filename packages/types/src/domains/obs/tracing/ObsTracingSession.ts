export interface ObsTracingSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingSessionValidator {
  public static validate(data: Partial<ObsTracingSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
