export interface ObsTracingSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingSummaryValidator {
  public static validate(data: Partial<ObsTracingSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
