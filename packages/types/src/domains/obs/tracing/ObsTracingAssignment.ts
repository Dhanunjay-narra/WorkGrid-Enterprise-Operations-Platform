export interface ObsTracingAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingAssignmentValidator {
  public static validate(data: Partial<ObsTracingAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
