export interface ObsTracingMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingMetricValidator {
  public static validate(data: Partial<ObsTracingMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
