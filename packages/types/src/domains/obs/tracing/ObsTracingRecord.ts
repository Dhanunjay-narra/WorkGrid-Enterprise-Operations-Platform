export interface ObsTracingRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingRecordValidator {
  public static validate(data: Partial<ObsTracingRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
