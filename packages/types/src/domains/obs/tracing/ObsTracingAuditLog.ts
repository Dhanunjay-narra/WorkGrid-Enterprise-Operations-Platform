export interface ObsTracingAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingAuditLogValidator {
  public static validate(data: Partial<ObsTracingAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
