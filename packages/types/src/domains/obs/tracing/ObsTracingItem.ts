export interface ObsTracingItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingItemValidator {
  public static validate(data: Partial<ObsTracingItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
