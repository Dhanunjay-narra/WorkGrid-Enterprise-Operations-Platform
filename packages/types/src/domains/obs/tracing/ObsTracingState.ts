export interface ObsTracingStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingStateValidator {
  public static validate(data: Partial<ObsTracingStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
