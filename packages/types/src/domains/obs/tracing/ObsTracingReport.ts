export interface ObsTracingReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingReportValidator {
  public static validate(data: Partial<ObsTracingReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
