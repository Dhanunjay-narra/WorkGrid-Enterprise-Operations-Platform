export interface ObsTracingSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingSnapshotValidator {
  public static validate(data: Partial<ObsTracingSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
