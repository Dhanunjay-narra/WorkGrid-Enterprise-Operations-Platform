export interface ObsTracingThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingThresholdValidator {
  public static validate(data: Partial<ObsTracingThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
