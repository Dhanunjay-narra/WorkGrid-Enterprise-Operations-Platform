export interface ObsTracingNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingNodeValidator {
  public static validate(data: Partial<ObsTracingNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
