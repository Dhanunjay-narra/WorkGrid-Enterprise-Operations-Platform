export interface ObsTracingPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingPolicyValidator {
  public static validate(data: Partial<ObsTracingPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
