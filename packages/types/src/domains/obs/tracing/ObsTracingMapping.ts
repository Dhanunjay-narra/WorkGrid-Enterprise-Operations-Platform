export interface ObsTracingMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingMappingValidator {
  public static validate(data: Partial<ObsTracingMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
