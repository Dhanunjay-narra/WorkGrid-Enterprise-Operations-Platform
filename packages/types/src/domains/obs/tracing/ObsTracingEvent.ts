export interface ObsTracingEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsTracingEventValidator {
  public static validate(data: Partial<ObsTracingEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
