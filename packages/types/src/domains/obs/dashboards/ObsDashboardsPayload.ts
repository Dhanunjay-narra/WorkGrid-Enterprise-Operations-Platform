export interface ObsDashboardsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsPayloadValidator {
  public static validate(data: Partial<ObsDashboardsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
