export interface ObsDashboardsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsMetricValidator {
  public static validate(data: Partial<ObsDashboardsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
