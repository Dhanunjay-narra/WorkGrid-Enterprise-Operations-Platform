export interface ObsDashboardsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsTransactionValidator {
  public static validate(data: Partial<ObsDashboardsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
