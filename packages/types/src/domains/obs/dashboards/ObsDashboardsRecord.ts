export interface ObsDashboardsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsRecordValidator {
  public static validate(data: Partial<ObsDashboardsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
