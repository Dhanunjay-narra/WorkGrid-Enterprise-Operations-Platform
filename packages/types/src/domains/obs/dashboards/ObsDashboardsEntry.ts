export interface ObsDashboardsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsEntryValidator {
  public static validate(data: Partial<ObsDashboardsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
