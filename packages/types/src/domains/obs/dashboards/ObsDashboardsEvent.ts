export interface ObsDashboardsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsEventValidator {
  public static validate(data: Partial<ObsDashboardsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
