export interface ObsDashboardsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsNodeValidator {
  public static validate(data: Partial<ObsDashboardsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
