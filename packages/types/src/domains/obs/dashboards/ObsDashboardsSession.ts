export interface ObsDashboardsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsSessionValidator {
  public static validate(data: Partial<ObsDashboardsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
