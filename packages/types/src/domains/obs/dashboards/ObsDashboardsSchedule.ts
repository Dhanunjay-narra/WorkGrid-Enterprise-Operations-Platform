export interface ObsDashboardsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsScheduleValidator {
  public static validate(data: Partial<ObsDashboardsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
