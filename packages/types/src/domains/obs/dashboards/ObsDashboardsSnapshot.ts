export interface ObsDashboardsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsSnapshotValidator {
  public static validate(data: Partial<ObsDashboardsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
