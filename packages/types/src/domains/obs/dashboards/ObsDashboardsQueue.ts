export interface ObsDashboardsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsQueueValidator {
  public static validate(data: Partial<ObsDashboardsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
