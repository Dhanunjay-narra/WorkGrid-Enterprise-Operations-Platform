export interface ObsDashboardsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsProfileValidator {
  public static validate(data: Partial<ObsDashboardsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
