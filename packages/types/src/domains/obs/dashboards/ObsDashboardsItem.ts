export interface ObsDashboardsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsItemValidator {
  public static validate(data: Partial<ObsDashboardsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
