export interface ObsDashboardsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsBatchValidator {
  public static validate(data: Partial<ObsDashboardsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
