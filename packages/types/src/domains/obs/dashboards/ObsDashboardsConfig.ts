export interface ObsDashboardsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsConfigValidator {
  public static validate(data: Partial<ObsDashboardsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
