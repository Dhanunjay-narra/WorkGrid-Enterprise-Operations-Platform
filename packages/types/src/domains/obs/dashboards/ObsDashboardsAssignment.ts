export interface ObsDashboardsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsAssignmentValidator {
  public static validate(data: Partial<ObsDashboardsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
