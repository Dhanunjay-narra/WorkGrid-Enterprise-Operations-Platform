export interface ObsDashboardsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsStateValidator {
  public static validate(data: Partial<ObsDashboardsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
