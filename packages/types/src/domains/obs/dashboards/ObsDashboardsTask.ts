export interface ObsDashboardsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsTaskValidator {
  public static validate(data: Partial<ObsDashboardsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
