export interface ObsDashboardsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsSummaryValidator {
  public static validate(data: Partial<ObsDashboardsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
