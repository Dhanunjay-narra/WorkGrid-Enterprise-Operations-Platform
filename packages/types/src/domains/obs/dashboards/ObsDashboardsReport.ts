export interface ObsDashboardsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsReportValidator {
  public static validate(data: Partial<ObsDashboardsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
