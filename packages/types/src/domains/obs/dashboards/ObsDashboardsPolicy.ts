export interface ObsDashboardsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsPolicyValidator {
  public static validate(data: Partial<ObsDashboardsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
