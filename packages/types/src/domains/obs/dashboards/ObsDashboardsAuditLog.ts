export interface ObsDashboardsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsAuditLogValidator {
  public static validate(data: Partial<ObsDashboardsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
