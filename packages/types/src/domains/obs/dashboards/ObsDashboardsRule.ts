export interface ObsDashboardsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsRuleValidator {
  public static validate(data: Partial<ObsDashboardsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
