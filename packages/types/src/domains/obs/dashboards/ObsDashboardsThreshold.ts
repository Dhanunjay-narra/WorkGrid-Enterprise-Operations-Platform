export interface ObsDashboardsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsThresholdValidator {
  public static validate(data: Partial<ObsDashboardsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
