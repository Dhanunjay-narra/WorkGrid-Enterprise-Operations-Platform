export interface ObsDashboardsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsDashboardsMappingValidator {
  public static validate(data: Partial<ObsDashboardsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
