export interface ObsSpansSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansSessionValidator {
  public static validate(data: Partial<ObsSpansSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
