export interface ObsSpansReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansReportValidator {
  public static validate(data: Partial<ObsSpansReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
