export interface ObsSpansAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansAuditLogValidator {
  public static validate(data: Partial<ObsSpansAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
