export interface ObsSpansTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansTransactionValidator {
  public static validate(data: Partial<ObsSpansTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
