export interface ObsSpansMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansMetricValidator {
  public static validate(data: Partial<ObsSpansMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
