export interface ObsSpansStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansStateValidator {
  public static validate(data: Partial<ObsSpansStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
