export interface ObsSpansItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansItemValidator {
  public static validate(data: Partial<ObsSpansItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
