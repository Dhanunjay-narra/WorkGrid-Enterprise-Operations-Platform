export interface ObsSpansScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansScheduleValidator {
  public static validate(data: Partial<ObsSpansScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
