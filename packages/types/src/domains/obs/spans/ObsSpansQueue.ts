export interface ObsSpansQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansQueueValidator {
  public static validate(data: Partial<ObsSpansQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
