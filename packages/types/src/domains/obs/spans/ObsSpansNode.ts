export interface ObsSpansNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansNodeValidator {
  public static validate(data: Partial<ObsSpansNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
