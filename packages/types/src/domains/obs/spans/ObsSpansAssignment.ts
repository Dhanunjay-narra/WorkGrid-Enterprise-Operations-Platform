export interface ObsSpansAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansAssignmentValidator {
  public static validate(data: Partial<ObsSpansAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
