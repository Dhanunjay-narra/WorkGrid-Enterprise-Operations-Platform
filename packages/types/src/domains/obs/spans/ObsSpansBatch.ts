export interface ObsSpansBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansBatchValidator {
  public static validate(data: Partial<ObsSpansBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
