export interface ObsSpansMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansMappingValidator {
  public static validate(data: Partial<ObsSpansMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
