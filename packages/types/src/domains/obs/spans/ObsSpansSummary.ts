export interface ObsSpansSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansSummaryValidator {
  public static validate(data: Partial<ObsSpansSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
