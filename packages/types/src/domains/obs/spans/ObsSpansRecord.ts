export interface ObsSpansRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansRecordValidator {
  public static validate(data: Partial<ObsSpansRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
