export interface ObsSpansTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansTaskValidator {
  public static validate(data: Partial<ObsSpansTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
