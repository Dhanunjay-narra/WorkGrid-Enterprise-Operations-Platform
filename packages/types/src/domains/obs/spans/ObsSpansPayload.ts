export interface ObsSpansPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansPayloadValidator {
  public static validate(data: Partial<ObsSpansPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
