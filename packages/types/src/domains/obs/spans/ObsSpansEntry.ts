export interface ObsSpansEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansEntryValidator {
  public static validate(data: Partial<ObsSpansEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
