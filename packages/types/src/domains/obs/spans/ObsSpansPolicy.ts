export interface ObsSpansPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansPolicyValidator {
  public static validate(data: Partial<ObsSpansPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
