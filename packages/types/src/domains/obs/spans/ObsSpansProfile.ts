export interface ObsSpansProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansProfileValidator {
  public static validate(data: Partial<ObsSpansProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
