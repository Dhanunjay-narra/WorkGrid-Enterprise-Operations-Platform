export interface ObsSpansRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansRuleValidator {
  public static validate(data: Partial<ObsSpansRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
