export interface ObsSpansThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansThresholdValidator {
  public static validate(data: Partial<ObsSpansThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
