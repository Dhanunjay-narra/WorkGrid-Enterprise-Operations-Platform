export interface ObsSpansSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansSnapshotValidator {
  public static validate(data: Partial<ObsSpansSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
