export interface ObsSpansConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansConfigValidator {
  public static validate(data: Partial<ObsSpansConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
