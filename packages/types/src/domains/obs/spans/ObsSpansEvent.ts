export interface ObsSpansEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsSpansEventValidator {
  public static validate(data: Partial<ObsSpansEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
