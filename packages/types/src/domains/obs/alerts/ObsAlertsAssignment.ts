export interface ObsAlertsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsAssignmentValidator {
  public static validate(data: Partial<ObsAlertsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
