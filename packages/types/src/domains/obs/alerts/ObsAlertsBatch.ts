export interface ObsAlertsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsBatchValidator {
  public static validate(data: Partial<ObsAlertsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
