export interface ObsAlertsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsRecordValidator {
  public static validate(data: Partial<ObsAlertsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
