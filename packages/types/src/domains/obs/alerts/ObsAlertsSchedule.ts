export interface ObsAlertsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsScheduleValidator {
  public static validate(data: Partial<ObsAlertsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
