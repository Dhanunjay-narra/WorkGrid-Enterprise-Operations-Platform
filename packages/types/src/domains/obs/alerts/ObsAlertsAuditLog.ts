export interface ObsAlertsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsAuditLogValidator {
  public static validate(data: Partial<ObsAlertsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
