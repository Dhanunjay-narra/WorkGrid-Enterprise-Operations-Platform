export interface ObsAlertsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsConfigValidator {
  public static validate(data: Partial<ObsAlertsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
