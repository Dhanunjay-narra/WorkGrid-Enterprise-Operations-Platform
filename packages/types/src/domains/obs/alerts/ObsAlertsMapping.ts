export interface ObsAlertsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsMappingValidator {
  public static validate(data: Partial<ObsAlertsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
