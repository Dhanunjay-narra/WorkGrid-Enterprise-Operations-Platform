export interface ObsAlertsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsPolicyValidator {
  public static validate(data: Partial<ObsAlertsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
