export interface ObsAlertsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsReportValidator {
  public static validate(data: Partial<ObsAlertsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
