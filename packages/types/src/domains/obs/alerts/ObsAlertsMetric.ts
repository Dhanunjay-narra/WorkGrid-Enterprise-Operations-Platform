export interface ObsAlertsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsMetricValidator {
  public static validate(data: Partial<ObsAlertsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
