export interface ObsAlertsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsTaskValidator {
  public static validate(data: Partial<ObsAlertsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
