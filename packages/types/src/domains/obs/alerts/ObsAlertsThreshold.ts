export interface ObsAlertsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsThresholdValidator {
  public static validate(data: Partial<ObsAlertsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
