export interface ObsAlertsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsStateValidator {
  public static validate(data: Partial<ObsAlertsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
