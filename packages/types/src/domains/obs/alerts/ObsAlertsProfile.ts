export interface ObsAlertsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsProfileValidator {
  public static validate(data: Partial<ObsAlertsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
