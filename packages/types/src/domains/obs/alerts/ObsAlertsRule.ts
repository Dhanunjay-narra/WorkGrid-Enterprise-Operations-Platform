export interface ObsAlertsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsRuleValidator {
  public static validate(data: Partial<ObsAlertsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
