export interface ObsAlertsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsTransactionValidator {
  public static validate(data: Partial<ObsAlertsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
