export interface ObsAlertsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsPayloadValidator {
  public static validate(data: Partial<ObsAlertsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
