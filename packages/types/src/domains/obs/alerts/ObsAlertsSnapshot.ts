export interface ObsAlertsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsSnapshotValidator {
  public static validate(data: Partial<ObsAlertsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
