export interface ObsAlertsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsItemValidator {
  public static validate(data: Partial<ObsAlertsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
