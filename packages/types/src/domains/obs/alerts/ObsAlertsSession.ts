export interface ObsAlertsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsSessionValidator {
  public static validate(data: Partial<ObsAlertsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
