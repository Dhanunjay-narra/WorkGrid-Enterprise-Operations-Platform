export interface ObsAlertsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsEntryValidator {
  public static validate(data: Partial<ObsAlertsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
