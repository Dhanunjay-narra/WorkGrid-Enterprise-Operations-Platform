export interface ObsAlertsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsNodeValidator {
  public static validate(data: Partial<ObsAlertsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
