export interface ObsAlertsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsEventValidator {
  public static validate(data: Partial<ObsAlertsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
