export interface ObsAlertsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsSummaryValidator {
  public static validate(data: Partial<ObsAlertsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
