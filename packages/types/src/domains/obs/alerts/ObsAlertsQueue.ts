export interface ObsAlertsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsAlertsQueueValidator {
  public static validate(data: Partial<ObsAlertsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
