export interface ObsProbesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesMetricValidator {
  public static validate(data: Partial<ObsProbesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
