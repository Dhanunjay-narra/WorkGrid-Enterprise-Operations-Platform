export interface ObsProbesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesMappingValidator {
  public static validate(data: Partial<ObsProbesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
