export interface ObsProbesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesAssignmentValidator {
  public static validate(data: Partial<ObsProbesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
