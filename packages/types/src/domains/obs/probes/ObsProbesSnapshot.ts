export interface ObsProbesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesSnapshotValidator {
  public static validate(data: Partial<ObsProbesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
