export interface ObsProbesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesEventValidator {
  public static validate(data: Partial<ObsProbesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
