export interface ObsProbesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesStateValidator {
  public static validate(data: Partial<ObsProbesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
