export interface ObsProbesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesItemValidator {
  public static validate(data: Partial<ObsProbesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
