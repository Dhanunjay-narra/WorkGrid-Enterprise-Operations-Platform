export interface ObsProbesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesTransactionValidator {
  public static validate(data: Partial<ObsProbesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
