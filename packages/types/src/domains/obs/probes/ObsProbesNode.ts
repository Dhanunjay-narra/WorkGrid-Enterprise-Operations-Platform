export interface ObsProbesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesNodeValidator {
  public static validate(data: Partial<ObsProbesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
