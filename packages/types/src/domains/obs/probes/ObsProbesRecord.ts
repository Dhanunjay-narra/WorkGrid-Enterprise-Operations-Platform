export interface ObsProbesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesRecordValidator {
  public static validate(data: Partial<ObsProbesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
