export interface ObsProbesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesProfileValidator {
  public static validate(data: Partial<ObsProbesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
