export interface ObsProbesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesAuditLogValidator {
  public static validate(data: Partial<ObsProbesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
