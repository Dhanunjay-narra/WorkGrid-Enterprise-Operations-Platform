export interface ObsProbesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesEntryValidator {
  public static validate(data: Partial<ObsProbesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
