export interface ObsProbesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesQueueValidator {
  public static validate(data: Partial<ObsProbesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
