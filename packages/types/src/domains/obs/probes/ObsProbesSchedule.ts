export interface ObsProbesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesScheduleValidator {
  public static validate(data: Partial<ObsProbesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
