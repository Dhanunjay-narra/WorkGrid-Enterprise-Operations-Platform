export interface ObsProbesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesReportValidator {
  public static validate(data: Partial<ObsProbesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
