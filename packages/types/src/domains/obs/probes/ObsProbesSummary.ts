export interface ObsProbesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesSummaryValidator {
  public static validate(data: Partial<ObsProbesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
