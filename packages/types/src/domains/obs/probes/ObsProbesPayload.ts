export interface ObsProbesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesPayloadValidator {
  public static validate(data: Partial<ObsProbesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
