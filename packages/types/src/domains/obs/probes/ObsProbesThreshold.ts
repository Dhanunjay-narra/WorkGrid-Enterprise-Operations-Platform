export interface ObsProbesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesThresholdValidator {
  public static validate(data: Partial<ObsProbesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
