export interface ObsProbesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesRuleValidator {
  public static validate(data: Partial<ObsProbesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
