export interface ObsProbesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesConfigValidator {
  public static validate(data: Partial<ObsProbesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
