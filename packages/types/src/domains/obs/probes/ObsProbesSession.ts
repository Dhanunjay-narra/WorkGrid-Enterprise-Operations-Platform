export interface ObsProbesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesSessionValidator {
  public static validate(data: Partial<ObsProbesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
