export interface ObsProbesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesTaskValidator {
  public static validate(data: Partial<ObsProbesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
