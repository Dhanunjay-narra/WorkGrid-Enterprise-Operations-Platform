export interface ObsProbesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesBatchValidator {
  public static validate(data: Partial<ObsProbesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
