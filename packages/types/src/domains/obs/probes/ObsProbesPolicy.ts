export interface ObsProbesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsProbesPolicyValidator {
  public static validate(data: Partial<ObsProbesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
