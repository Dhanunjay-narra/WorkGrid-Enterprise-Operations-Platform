export interface ObsLoggingConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingConfigValidator {
  public static validate(data: Partial<ObsLoggingConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
