export interface ObsLoggingSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingSnapshotValidator {
  public static validate(data: Partial<ObsLoggingSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
