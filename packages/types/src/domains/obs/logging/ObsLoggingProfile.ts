export interface ObsLoggingProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingProfileValidator {
  public static validate(data: Partial<ObsLoggingProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
