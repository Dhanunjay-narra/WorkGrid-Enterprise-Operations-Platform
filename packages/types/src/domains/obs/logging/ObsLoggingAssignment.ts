export interface ObsLoggingAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingAssignmentValidator {
  public static validate(data: Partial<ObsLoggingAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
