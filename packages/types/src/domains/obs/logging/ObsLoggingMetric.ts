export interface ObsLoggingMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingMetricValidator {
  public static validate(data: Partial<ObsLoggingMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
