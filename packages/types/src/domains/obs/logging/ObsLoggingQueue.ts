export interface ObsLoggingQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingQueueValidator {
  public static validate(data: Partial<ObsLoggingQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
