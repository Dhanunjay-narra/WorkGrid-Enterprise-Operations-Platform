export interface ObsLoggingScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingScheduleValidator {
  public static validate(data: Partial<ObsLoggingScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
