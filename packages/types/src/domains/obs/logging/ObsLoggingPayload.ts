export interface ObsLoggingPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingPayloadValidator {
  public static validate(data: Partial<ObsLoggingPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
