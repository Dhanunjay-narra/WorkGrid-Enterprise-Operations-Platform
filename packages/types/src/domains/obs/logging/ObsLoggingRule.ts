export interface ObsLoggingRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingRuleValidator {
  public static validate(data: Partial<ObsLoggingRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
