export interface ObsLoggingPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingPolicyValidator {
  public static validate(data: Partial<ObsLoggingPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
