export interface ObsLoggingBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingBatchValidator {
  public static validate(data: Partial<ObsLoggingBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
