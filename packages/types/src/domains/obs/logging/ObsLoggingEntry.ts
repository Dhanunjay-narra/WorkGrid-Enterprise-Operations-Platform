export interface ObsLoggingEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingEntryValidator {
  public static validate(data: Partial<ObsLoggingEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
