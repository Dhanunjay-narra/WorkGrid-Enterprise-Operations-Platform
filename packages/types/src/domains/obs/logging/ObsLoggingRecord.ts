export interface ObsLoggingRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingRecordValidator {
  public static validate(data: Partial<ObsLoggingRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
