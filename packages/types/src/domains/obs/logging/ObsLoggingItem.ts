export interface ObsLoggingItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingItemValidator {
  public static validate(data: Partial<ObsLoggingItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
