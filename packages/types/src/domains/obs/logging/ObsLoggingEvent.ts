export interface ObsLoggingEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingEventValidator {
  public static validate(data: Partial<ObsLoggingEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
