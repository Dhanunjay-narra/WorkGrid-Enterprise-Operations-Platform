export interface ObsLoggingThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingThresholdValidator {
  public static validate(data: Partial<ObsLoggingThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
