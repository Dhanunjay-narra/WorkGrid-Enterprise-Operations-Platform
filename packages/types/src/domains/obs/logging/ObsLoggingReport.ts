export interface ObsLoggingReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingReportValidator {
  public static validate(data: Partial<ObsLoggingReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
