export interface ObsLoggingMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingMappingValidator {
  public static validate(data: Partial<ObsLoggingMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
