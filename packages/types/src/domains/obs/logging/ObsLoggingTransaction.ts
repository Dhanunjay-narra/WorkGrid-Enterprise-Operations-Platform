export interface ObsLoggingTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingTransactionValidator {
  public static validate(data: Partial<ObsLoggingTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
