export interface ObsLoggingSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingSummaryValidator {
  public static validate(data: Partial<ObsLoggingSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
