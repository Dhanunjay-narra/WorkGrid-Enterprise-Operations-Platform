export interface ObsLoggingAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingAuditLogValidator {
  public static validate(data: Partial<ObsLoggingAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
