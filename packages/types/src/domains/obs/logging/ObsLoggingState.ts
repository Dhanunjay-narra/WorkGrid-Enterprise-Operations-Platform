export interface ObsLoggingStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingStateValidator {
  public static validate(data: Partial<ObsLoggingStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
