export interface ObsLoggingNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingNodeValidator {
  public static validate(data: Partial<ObsLoggingNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
