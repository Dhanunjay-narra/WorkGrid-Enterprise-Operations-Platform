export interface ObsLoggingTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingTaskValidator {
  public static validate(data: Partial<ObsLoggingTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
