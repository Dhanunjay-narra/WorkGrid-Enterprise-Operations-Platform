export interface ObsLoggingSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsLoggingSessionValidator {
  public static validate(data: Partial<ObsLoggingSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
