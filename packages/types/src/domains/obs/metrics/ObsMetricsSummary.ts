export interface ObsMetricsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsSummaryValidator {
  public static validate(data: Partial<ObsMetricsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
