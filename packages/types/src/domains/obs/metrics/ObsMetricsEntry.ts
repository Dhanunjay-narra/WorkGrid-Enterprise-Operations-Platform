export interface ObsMetricsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsEntryValidator {
  public static validate(data: Partial<ObsMetricsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
