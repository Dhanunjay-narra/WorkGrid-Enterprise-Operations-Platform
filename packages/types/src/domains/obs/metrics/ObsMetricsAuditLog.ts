export interface ObsMetricsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsAuditLogValidator {
  public static validate(data: Partial<ObsMetricsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
