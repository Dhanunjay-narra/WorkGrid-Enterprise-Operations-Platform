export interface ObsMetricsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsProfileValidator {
  public static validate(data: Partial<ObsMetricsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
