export interface ObsMetricsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsReportValidator {
  public static validate(data: Partial<ObsMetricsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
