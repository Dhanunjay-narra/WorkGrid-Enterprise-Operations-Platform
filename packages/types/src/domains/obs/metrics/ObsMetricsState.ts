export interface ObsMetricsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsStateValidator {
  public static validate(data: Partial<ObsMetricsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
