export interface ObsMetricsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsMappingValidator {
  public static validate(data: Partial<ObsMetricsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
