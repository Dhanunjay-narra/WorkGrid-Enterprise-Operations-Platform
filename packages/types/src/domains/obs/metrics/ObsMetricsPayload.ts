export interface ObsMetricsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsPayloadValidator {
  public static validate(data: Partial<ObsMetricsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
