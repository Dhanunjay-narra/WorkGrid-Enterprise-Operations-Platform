export interface ObsMetricsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsEventValidator {
  public static validate(data: Partial<ObsMetricsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
