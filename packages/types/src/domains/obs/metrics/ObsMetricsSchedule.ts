export interface ObsMetricsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsScheduleValidator {
  public static validate(data: Partial<ObsMetricsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
