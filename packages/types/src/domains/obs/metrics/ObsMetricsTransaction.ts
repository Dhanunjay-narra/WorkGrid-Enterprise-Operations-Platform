export interface ObsMetricsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsTransactionValidator {
  public static validate(data: Partial<ObsMetricsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
