export interface ObsMetricsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsRecordValidator {
  public static validate(data: Partial<ObsMetricsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
