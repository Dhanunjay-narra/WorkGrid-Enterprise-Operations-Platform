export interface ObsMetricsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsSnapshotValidator {
  public static validate(data: Partial<ObsMetricsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
