export interface ObsMetricsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsSessionValidator {
  public static validate(data: Partial<ObsMetricsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
