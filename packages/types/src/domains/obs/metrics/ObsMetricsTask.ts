export interface ObsMetricsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsTaskValidator {
  public static validate(data: Partial<ObsMetricsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
