export interface ObsMetricsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsConfigValidator {
  public static validate(data: Partial<ObsMetricsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
