export interface ObsMetricsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsItemValidator {
  public static validate(data: Partial<ObsMetricsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
