export interface ObsMetricsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsNodeValidator {
  public static validate(data: Partial<ObsMetricsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
