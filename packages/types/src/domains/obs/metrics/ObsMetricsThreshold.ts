export interface ObsMetricsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsThresholdValidator {
  public static validate(data: Partial<ObsMetricsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
