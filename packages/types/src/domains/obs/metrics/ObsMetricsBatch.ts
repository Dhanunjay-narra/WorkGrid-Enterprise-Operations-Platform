export interface ObsMetricsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsBatchValidator {
  public static validate(data: Partial<ObsMetricsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
