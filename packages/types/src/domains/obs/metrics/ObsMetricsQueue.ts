export interface ObsMetricsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsQueueValidator {
  public static validate(data: Partial<ObsMetricsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
