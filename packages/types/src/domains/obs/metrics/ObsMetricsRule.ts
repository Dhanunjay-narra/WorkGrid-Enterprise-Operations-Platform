export interface ObsMetricsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsRuleValidator {
  public static validate(data: Partial<ObsMetricsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
