export interface ObsMetricsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsMetricValidator {
  public static validate(data: Partial<ObsMetricsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
