export interface ObsMetricsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsAssignmentValidator {
  public static validate(data: Partial<ObsMetricsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
