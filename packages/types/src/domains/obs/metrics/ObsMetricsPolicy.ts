export interface ObsMetricsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ObsMetricsPolicyValidator {
  public static validate(data: Partial<ObsMetricsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
