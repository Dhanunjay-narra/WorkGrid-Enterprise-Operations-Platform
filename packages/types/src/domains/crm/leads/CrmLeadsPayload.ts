export interface CrmLeadsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsPayloadValidator {
  public static validate(data: Partial<CrmLeadsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
