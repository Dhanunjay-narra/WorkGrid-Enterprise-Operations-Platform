export interface CrmLeadsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsAssignmentValidator {
  public static validate(data: Partial<CrmLeadsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
