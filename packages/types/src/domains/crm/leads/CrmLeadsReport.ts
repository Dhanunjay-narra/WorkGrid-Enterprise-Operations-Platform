export interface CrmLeadsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsReportValidator {
  public static validate(data: Partial<CrmLeadsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
