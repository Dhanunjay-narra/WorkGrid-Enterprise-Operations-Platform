export interface CrmLeadsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsScheduleValidator {
  public static validate(data: Partial<CrmLeadsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
