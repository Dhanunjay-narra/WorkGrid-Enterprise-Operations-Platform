export interface CrmLeadsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsSummaryValidator {
  public static validate(data: Partial<CrmLeadsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
