export interface CrmLeadsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsProfileValidator {
  public static validate(data: Partial<CrmLeadsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
