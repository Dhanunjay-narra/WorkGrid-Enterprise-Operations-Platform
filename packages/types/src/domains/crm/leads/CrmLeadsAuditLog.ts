export interface CrmLeadsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsAuditLogValidator {
  public static validate(data: Partial<CrmLeadsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
