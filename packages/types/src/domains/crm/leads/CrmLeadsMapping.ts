export interface CrmLeadsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsMappingValidator {
  public static validate(data: Partial<CrmLeadsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
