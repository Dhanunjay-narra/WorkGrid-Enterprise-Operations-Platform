export interface CrmLeadsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsSessionValidator {
  public static validate(data: Partial<CrmLeadsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
