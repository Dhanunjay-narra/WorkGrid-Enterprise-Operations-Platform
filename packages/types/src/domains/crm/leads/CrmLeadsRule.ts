export interface CrmLeadsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsRuleValidator {
  public static validate(data: Partial<CrmLeadsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
