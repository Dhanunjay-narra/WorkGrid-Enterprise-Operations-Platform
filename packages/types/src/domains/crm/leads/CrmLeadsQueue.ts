export interface CrmLeadsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsQueueValidator {
  public static validate(data: Partial<CrmLeadsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
