export interface CrmLeadsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsRecordValidator {
  public static validate(data: Partial<CrmLeadsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
