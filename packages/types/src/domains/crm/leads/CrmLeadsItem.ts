export interface CrmLeadsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsItemValidator {
  public static validate(data: Partial<CrmLeadsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
