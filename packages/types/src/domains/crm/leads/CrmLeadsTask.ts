export interface CrmLeadsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsTaskValidator {
  public static validate(data: Partial<CrmLeadsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
