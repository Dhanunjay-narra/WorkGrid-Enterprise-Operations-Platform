export interface CrmLeadsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsMetricValidator {
  public static validate(data: Partial<CrmLeadsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
