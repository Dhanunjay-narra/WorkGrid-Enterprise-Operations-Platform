export interface CrmLeadsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsNodeValidator {
  public static validate(data: Partial<CrmLeadsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
