export interface CrmLeadsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsThresholdValidator {
  public static validate(data: Partial<CrmLeadsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
