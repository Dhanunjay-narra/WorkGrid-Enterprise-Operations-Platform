export interface CrmLeadsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsStateValidator {
  public static validate(data: Partial<CrmLeadsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
