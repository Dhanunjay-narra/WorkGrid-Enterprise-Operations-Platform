export interface CrmLeadsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsConfigValidator {
  public static validate(data: Partial<CrmLeadsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
