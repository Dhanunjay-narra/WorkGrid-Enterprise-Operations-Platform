export interface CrmLeadsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsSnapshotValidator {
  public static validate(data: Partial<CrmLeadsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
