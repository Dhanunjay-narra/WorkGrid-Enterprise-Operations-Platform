export interface CrmLeadsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsEventValidator {
  public static validate(data: Partial<CrmLeadsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
