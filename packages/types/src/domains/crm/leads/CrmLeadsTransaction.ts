export interface CrmLeadsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsTransactionValidator {
  public static validate(data: Partial<CrmLeadsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
