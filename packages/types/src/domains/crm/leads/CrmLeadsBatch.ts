export interface CrmLeadsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsBatchValidator {
  public static validate(data: Partial<CrmLeadsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
