export interface CrmLeadsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsEntryValidator {
  public static validate(data: Partial<CrmLeadsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
