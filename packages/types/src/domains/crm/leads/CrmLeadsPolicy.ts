export interface CrmLeadsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmLeadsPolicyValidator {
  public static validate(data: Partial<CrmLeadsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
