export interface CrmForecastingPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingPayloadValidator {
  public static validate(data: Partial<CrmForecastingPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
