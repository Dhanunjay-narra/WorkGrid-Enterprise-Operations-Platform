export interface CrmForecastingStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingStateValidator {
  public static validate(data: Partial<CrmForecastingStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
