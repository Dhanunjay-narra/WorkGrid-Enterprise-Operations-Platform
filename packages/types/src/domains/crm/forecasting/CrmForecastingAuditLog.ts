export interface CrmForecastingAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingAuditLogValidator {
  public static validate(data: Partial<CrmForecastingAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
