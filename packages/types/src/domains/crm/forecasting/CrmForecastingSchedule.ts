export interface CrmForecastingScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingScheduleValidator {
  public static validate(data: Partial<CrmForecastingScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
