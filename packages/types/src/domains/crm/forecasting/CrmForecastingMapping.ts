export interface CrmForecastingMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingMappingValidator {
  public static validate(data: Partial<CrmForecastingMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
