export interface CrmForecastingQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingQueueValidator {
  public static validate(data: Partial<CrmForecastingQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
