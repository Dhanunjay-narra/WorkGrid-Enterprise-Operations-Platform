export interface CrmForecastingPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingPolicyValidator {
  public static validate(data: Partial<CrmForecastingPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
