export interface CrmForecastingThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingThresholdValidator {
  public static validate(data: Partial<CrmForecastingThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
