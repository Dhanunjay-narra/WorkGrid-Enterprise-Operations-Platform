export interface CrmForecastingNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingNodeValidator {
  public static validate(data: Partial<CrmForecastingNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
