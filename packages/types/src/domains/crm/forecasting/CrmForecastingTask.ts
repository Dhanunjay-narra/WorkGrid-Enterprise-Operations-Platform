export interface CrmForecastingTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingTaskValidator {
  public static validate(data: Partial<CrmForecastingTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
