export interface CrmForecastingSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingSnapshotValidator {
  public static validate(data: Partial<CrmForecastingSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
