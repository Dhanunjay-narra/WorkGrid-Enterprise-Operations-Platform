export interface CrmForecastingBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingBatchValidator {
  public static validate(data: Partial<CrmForecastingBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
