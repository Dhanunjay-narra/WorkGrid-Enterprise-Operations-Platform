export interface CrmForecastingReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingReportValidator {
  public static validate(data: Partial<CrmForecastingReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
