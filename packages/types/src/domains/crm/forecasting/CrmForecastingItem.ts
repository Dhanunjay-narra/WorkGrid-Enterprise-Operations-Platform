export interface CrmForecastingItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingItemValidator {
  public static validate(data: Partial<CrmForecastingItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
