export interface CrmForecastingSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingSessionValidator {
  public static validate(data: Partial<CrmForecastingSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
