export interface CrmForecastingAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingAssignmentValidator {
  public static validate(data: Partial<CrmForecastingAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
