export interface CrmForecastingSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingSummaryValidator {
  public static validate(data: Partial<CrmForecastingSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
