export interface CrmForecastingRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingRecordValidator {
  public static validate(data: Partial<CrmForecastingRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
