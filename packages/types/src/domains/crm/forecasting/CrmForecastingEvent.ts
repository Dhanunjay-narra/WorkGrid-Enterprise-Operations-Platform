export interface CrmForecastingEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingEventValidator {
  public static validate(data: Partial<CrmForecastingEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
