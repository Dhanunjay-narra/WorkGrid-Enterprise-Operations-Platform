export interface CrmForecastingEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingEntryValidator {
  public static validate(data: Partial<CrmForecastingEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
