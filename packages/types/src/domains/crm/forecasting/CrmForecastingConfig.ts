export interface CrmForecastingConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingConfigValidator {
  public static validate(data: Partial<CrmForecastingConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
