export interface CrmForecastingRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingRuleValidator {
  public static validate(data: Partial<CrmForecastingRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
