export interface CrmForecastingMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingMetricValidator {
  public static validate(data: Partial<CrmForecastingMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
