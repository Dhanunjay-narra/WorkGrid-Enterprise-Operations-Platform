export interface CrmForecastingProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmForecastingProfileValidator {
  public static validate(data: Partial<CrmForecastingProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
