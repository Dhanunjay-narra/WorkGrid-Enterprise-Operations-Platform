export interface CrmAccountsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsReportValidator {
  public static validate(data: Partial<CrmAccountsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
