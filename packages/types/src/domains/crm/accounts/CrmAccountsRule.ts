export interface CrmAccountsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsRuleValidator {
  public static validate(data: Partial<CrmAccountsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
