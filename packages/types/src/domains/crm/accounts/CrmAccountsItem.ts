export interface CrmAccountsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsItemValidator {
  public static validate(data: Partial<CrmAccountsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
