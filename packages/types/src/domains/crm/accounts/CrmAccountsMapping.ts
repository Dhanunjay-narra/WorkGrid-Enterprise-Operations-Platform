export interface CrmAccountsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsMappingValidator {
  public static validate(data: Partial<CrmAccountsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
