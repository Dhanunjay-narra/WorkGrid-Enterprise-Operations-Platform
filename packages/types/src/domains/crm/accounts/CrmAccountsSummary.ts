export interface CrmAccountsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsSummaryValidator {
  public static validate(data: Partial<CrmAccountsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
