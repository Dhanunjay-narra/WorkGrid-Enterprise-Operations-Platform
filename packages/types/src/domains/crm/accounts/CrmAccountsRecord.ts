export interface CrmAccountsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsRecordValidator {
  public static validate(data: Partial<CrmAccountsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
