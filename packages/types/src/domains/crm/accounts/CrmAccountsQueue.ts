export interface CrmAccountsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsQueueValidator {
  public static validate(data: Partial<CrmAccountsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
