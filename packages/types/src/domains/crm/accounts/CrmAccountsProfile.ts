export interface CrmAccountsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsProfileValidator {
  public static validate(data: Partial<CrmAccountsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
