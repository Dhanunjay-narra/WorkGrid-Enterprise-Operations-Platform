export interface CrmAccountsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsTaskValidator {
  public static validate(data: Partial<CrmAccountsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
