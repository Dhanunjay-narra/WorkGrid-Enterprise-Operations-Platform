export interface CrmAccountsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsEventValidator {
  public static validate(data: Partial<CrmAccountsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
