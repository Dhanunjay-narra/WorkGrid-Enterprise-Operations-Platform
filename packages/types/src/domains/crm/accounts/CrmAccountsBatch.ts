export interface CrmAccountsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsBatchValidator {
  public static validate(data: Partial<CrmAccountsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
