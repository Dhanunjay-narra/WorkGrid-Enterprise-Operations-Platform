export interface CrmAccountsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsMetricValidator {
  public static validate(data: Partial<CrmAccountsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
