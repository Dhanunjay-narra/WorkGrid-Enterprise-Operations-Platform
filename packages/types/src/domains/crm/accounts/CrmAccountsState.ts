export interface CrmAccountsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsStateValidator {
  public static validate(data: Partial<CrmAccountsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
