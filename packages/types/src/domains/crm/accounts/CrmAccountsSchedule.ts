export interface CrmAccountsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsScheduleValidator {
  public static validate(data: Partial<CrmAccountsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
