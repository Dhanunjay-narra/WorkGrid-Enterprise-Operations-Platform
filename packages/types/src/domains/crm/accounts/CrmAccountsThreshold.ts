export interface CrmAccountsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsThresholdValidator {
  public static validate(data: Partial<CrmAccountsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
