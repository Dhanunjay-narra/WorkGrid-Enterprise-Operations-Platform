export interface CrmAccountsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsEntryValidator {
  public static validate(data: Partial<CrmAccountsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
