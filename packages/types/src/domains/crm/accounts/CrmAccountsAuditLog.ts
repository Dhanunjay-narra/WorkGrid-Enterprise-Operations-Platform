export interface CrmAccountsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsAuditLogValidator {
  public static validate(data: Partial<CrmAccountsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
