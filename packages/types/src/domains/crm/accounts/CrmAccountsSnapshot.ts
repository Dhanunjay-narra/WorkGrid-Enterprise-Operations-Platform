export interface CrmAccountsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsSnapshotValidator {
  public static validate(data: Partial<CrmAccountsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
