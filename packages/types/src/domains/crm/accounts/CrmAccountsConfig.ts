export interface CrmAccountsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsConfigValidator {
  public static validate(data: Partial<CrmAccountsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
