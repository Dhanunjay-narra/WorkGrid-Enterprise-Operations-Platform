export interface CrmAccountsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsNodeValidator {
  public static validate(data: Partial<CrmAccountsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
