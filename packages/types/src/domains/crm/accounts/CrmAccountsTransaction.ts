export interface CrmAccountsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsTransactionValidator {
  public static validate(data: Partial<CrmAccountsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
