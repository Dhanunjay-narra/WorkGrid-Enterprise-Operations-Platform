export interface CrmAccountsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsPolicyValidator {
  public static validate(data: Partial<CrmAccountsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
