export interface CrmAccountsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsSessionValidator {
  public static validate(data: Partial<CrmAccountsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
