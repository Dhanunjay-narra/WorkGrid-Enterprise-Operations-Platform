export interface CrmAccountsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsPayloadValidator {
  public static validate(data: Partial<CrmAccountsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
