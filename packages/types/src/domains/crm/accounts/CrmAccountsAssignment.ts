export interface CrmAccountsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmAccountsAssignmentValidator {
  public static validate(data: Partial<CrmAccountsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
