export interface CrmPipelineThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineThresholdValidator {
  public static validate(data: Partial<CrmPipelineThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
