export interface CrmPipelineMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineMappingValidator {
  public static validate(data: Partial<CrmPipelineMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
