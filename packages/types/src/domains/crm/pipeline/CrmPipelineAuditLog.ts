export interface CrmPipelineAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineAuditLogValidator {
  public static validate(data: Partial<CrmPipelineAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
