export interface CrmPipelinePayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelinePayloadValidator {
  public static validate(data: Partial<CrmPipelinePayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
