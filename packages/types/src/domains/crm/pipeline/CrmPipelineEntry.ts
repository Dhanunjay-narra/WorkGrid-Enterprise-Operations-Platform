export interface CrmPipelineEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineEntryValidator {
  public static validate(data: Partial<CrmPipelineEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
