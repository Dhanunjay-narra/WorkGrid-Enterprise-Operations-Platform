export interface CrmPipelineScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineScheduleValidator {
  public static validate(data: Partial<CrmPipelineScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
