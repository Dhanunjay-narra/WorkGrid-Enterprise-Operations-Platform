export interface CrmPipelineItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineItemValidator {
  public static validate(data: Partial<CrmPipelineItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
