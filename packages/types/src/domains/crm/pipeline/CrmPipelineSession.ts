export interface CrmPipelineSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineSessionValidator {
  public static validate(data: Partial<CrmPipelineSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
