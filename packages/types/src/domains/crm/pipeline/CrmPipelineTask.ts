export interface CrmPipelineTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineTaskValidator {
  public static validate(data: Partial<CrmPipelineTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
