export interface CrmPipelineAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineAssignmentValidator {
  public static validate(data: Partial<CrmPipelineAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
