export interface CrmPipelinePolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelinePolicyValidator {
  public static validate(data: Partial<CrmPipelinePolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
