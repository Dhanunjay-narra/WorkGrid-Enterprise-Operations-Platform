export interface CrmPipelineRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineRuleValidator {
  public static validate(data: Partial<CrmPipelineRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
