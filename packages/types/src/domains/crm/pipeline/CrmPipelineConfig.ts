export interface CrmPipelineConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineConfigValidator {
  public static validate(data: Partial<CrmPipelineConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
