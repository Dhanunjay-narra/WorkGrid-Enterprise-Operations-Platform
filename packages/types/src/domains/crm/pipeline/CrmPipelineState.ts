export interface CrmPipelineStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineStateValidator {
  public static validate(data: Partial<CrmPipelineStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
