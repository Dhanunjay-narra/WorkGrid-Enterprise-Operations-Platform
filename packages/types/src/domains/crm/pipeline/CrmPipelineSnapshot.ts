export interface CrmPipelineSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineSnapshotValidator {
  public static validate(data: Partial<CrmPipelineSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
