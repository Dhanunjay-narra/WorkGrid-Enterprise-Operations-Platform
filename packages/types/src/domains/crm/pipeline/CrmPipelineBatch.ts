export interface CrmPipelineBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineBatchValidator {
  public static validate(data: Partial<CrmPipelineBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
