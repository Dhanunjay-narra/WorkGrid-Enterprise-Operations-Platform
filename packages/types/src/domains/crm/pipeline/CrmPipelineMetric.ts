export interface CrmPipelineMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineMetricValidator {
  public static validate(data: Partial<CrmPipelineMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
