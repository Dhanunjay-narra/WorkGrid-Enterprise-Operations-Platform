export interface CrmPipelineSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineSummaryValidator {
  public static validate(data: Partial<CrmPipelineSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
