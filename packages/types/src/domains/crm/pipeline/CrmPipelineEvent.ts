export interface CrmPipelineEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineEventValidator {
  public static validate(data: Partial<CrmPipelineEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
