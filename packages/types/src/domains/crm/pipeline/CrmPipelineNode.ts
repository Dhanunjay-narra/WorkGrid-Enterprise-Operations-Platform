export interface CrmPipelineNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineNodeValidator {
  public static validate(data: Partial<CrmPipelineNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
