export interface CrmPipelineQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineQueueValidator {
  public static validate(data: Partial<CrmPipelineQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
