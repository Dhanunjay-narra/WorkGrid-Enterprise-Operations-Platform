export interface CrmPipelineRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineRecordValidator {
  public static validate(data: Partial<CrmPipelineRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
