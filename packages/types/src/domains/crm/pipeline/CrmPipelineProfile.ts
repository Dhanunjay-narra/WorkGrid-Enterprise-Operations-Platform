export interface CrmPipelineProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineProfileValidator {
  public static validate(data: Partial<CrmPipelineProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
