export interface CrmPipelineTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineTransactionValidator {
  public static validate(data: Partial<CrmPipelineTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
