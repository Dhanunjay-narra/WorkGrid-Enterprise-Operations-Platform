export interface CrmPipelineReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmPipelineReportValidator {
  public static validate(data: Partial<CrmPipelineReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
