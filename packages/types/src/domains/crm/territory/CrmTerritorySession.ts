export interface CrmTerritorySessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritorySessionValidator {
  public static validate(data: Partial<CrmTerritorySessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
