export interface CrmTerritoryRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryRuleValidator {
  public static validate(data: Partial<CrmTerritoryRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
