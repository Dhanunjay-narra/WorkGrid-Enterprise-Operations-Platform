export interface CrmTerritoryProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryProfileValidator {
  public static validate(data: Partial<CrmTerritoryProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
