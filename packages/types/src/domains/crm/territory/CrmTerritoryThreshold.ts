export interface CrmTerritoryThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryThresholdValidator {
  public static validate(data: Partial<CrmTerritoryThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
