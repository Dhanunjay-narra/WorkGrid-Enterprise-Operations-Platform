export interface CrmTerritoryMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryMetricValidator {
  public static validate(data: Partial<CrmTerritoryMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
