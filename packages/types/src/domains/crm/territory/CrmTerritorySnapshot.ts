export interface CrmTerritorySnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritorySnapshotValidator {
  public static validate(data: Partial<CrmTerritorySnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
