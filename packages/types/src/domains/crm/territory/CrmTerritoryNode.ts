export interface CrmTerritoryNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryNodeValidator {
  public static validate(data: Partial<CrmTerritoryNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
