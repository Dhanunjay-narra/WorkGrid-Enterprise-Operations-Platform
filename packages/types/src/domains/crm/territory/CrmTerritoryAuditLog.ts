export interface CrmTerritoryAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryAuditLogValidator {
  public static validate(data: Partial<CrmTerritoryAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
