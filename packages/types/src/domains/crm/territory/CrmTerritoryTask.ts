export interface CrmTerritoryTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryTaskValidator {
  public static validate(data: Partial<CrmTerritoryTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
