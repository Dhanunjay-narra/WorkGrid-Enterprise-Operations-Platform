export interface CrmTerritoryEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryEventValidator {
  public static validate(data: Partial<CrmTerritoryEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
