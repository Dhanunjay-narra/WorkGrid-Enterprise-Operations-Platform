export interface CrmTerritoryBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryBatchValidator {
  public static validate(data: Partial<CrmTerritoryBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
