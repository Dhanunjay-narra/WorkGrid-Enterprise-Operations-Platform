export interface CrmTerritoryRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryRecordValidator {
  public static validate(data: Partial<CrmTerritoryRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
