export interface CrmTerritoryReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryReportValidator {
  public static validate(data: Partial<CrmTerritoryReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
