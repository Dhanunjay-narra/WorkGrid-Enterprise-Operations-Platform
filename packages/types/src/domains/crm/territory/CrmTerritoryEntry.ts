export interface CrmTerritoryEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryEntryValidator {
  public static validate(data: Partial<CrmTerritoryEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
