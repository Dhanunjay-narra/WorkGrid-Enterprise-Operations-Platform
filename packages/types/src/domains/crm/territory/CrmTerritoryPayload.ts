export interface CrmTerritoryPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryPayloadValidator {
  public static validate(data: Partial<CrmTerritoryPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
