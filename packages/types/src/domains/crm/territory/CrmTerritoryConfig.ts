export interface CrmTerritoryConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryConfigValidator {
  public static validate(data: Partial<CrmTerritoryConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
