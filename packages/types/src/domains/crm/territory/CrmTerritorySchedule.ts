export interface CrmTerritoryScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryScheduleValidator {
  public static validate(data: Partial<CrmTerritoryScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
