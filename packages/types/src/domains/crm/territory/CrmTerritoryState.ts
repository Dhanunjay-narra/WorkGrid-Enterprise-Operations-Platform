export interface CrmTerritoryStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryStateValidator {
  public static validate(data: Partial<CrmTerritoryStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
