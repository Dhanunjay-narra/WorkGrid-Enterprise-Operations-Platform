export interface CrmTerritoryMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryMappingValidator {
  public static validate(data: Partial<CrmTerritoryMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
