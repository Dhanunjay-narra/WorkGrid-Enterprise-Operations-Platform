export interface CrmTerritoryPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryPolicyValidator {
  public static validate(data: Partial<CrmTerritoryPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
