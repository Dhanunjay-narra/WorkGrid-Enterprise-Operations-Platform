export interface CrmTerritoryAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryAssignmentValidator {
  public static validate(data: Partial<CrmTerritoryAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
