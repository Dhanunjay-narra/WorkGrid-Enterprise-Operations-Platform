export interface CrmTerritoryQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryQueueValidator {
  public static validate(data: Partial<CrmTerritoryQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
