export interface CrmTerritorySummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritorySummaryValidator {
  public static validate(data: Partial<CrmTerritorySummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
