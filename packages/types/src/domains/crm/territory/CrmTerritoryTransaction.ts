export interface CrmTerritoryTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryTransactionValidator {
  public static validate(data: Partial<CrmTerritoryTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
