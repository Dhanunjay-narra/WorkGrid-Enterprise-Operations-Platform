export interface CrmTerritoryItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmTerritoryItemValidator {
  public static validate(data: Partial<CrmTerritoryItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
