export interface CrmDealsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsConfigValidator {
  public static validate(data: Partial<CrmDealsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
