export interface CrmDealsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsNodeValidator {
  public static validate(data: Partial<CrmDealsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
