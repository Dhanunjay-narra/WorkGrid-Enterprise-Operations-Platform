export interface CrmDealsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsSummaryValidator {
  public static validate(data: Partial<CrmDealsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
