export interface CrmDealsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsPayloadValidator {
  public static validate(data: Partial<CrmDealsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
