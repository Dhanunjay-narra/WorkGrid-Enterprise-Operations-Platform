export interface CrmDealsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsSnapshotValidator {
  public static validate(data: Partial<CrmDealsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
