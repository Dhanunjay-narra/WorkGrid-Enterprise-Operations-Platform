export interface CrmDealsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsRuleValidator {
  public static validate(data: Partial<CrmDealsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
