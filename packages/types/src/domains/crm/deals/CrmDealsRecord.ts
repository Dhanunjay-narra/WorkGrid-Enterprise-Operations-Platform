export interface CrmDealsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsRecordValidator {
  public static validate(data: Partial<CrmDealsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
