export interface CrmDealsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsAssignmentValidator {
  public static validate(data: Partial<CrmDealsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
