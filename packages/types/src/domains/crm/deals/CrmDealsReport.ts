export interface CrmDealsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsReportValidator {
  public static validate(data: Partial<CrmDealsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
