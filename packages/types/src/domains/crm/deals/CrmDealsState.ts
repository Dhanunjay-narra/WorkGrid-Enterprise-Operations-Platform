export interface CrmDealsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsStateValidator {
  public static validate(data: Partial<CrmDealsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
