export interface CrmDealsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsEntryValidator {
  public static validate(data: Partial<CrmDealsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
