export interface CrmDealsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsScheduleValidator {
  public static validate(data: Partial<CrmDealsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
