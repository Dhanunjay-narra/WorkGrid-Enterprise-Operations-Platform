export interface CrmDealsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsItemValidator {
  public static validate(data: Partial<CrmDealsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
