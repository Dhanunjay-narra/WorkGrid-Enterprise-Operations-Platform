export interface CrmDealsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsQueueValidator {
  public static validate(data: Partial<CrmDealsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
