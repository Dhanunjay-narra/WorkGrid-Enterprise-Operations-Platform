export interface CrmDealsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsBatchValidator {
  public static validate(data: Partial<CrmDealsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
