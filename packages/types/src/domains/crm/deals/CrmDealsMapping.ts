export interface CrmDealsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsMappingValidator {
  public static validate(data: Partial<CrmDealsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
