export interface CrmDealsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsPolicyValidator {
  public static validate(data: Partial<CrmDealsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
