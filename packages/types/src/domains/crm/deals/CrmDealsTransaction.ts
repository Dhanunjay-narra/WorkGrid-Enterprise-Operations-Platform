export interface CrmDealsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsTransactionValidator {
  public static validate(data: Partial<CrmDealsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
