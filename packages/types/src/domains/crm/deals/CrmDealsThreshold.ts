export interface CrmDealsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsThresholdValidator {
  public static validate(data: Partial<CrmDealsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
