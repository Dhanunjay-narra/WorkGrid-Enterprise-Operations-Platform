export interface CrmDealsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsTaskValidator {
  public static validate(data: Partial<CrmDealsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
