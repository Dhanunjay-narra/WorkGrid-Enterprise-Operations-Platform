export interface CrmDealsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsSessionValidator {
  public static validate(data: Partial<CrmDealsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
