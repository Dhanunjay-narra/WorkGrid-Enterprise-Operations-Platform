export interface CrmDealsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsMetricValidator {
  public static validate(data: Partial<CrmDealsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
