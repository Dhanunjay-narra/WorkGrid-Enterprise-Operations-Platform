export interface CrmDealsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsEventValidator {
  public static validate(data: Partial<CrmDealsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
