export interface CrmDealsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsProfileValidator {
  public static validate(data: Partial<CrmDealsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
