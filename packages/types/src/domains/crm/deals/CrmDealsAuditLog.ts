export interface CrmDealsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmDealsAuditLogValidator {
  public static validate(data: Partial<CrmDealsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
