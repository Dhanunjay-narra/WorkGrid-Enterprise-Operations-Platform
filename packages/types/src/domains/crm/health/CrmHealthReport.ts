export interface CrmHealthReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthReportValidator {
  public static validate(data: Partial<CrmHealthReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
