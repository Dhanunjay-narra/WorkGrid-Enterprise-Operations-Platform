export interface CrmHealthSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthSessionValidator {
  public static validate(data: Partial<CrmHealthSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
