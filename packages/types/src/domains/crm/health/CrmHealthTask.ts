export interface CrmHealthTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthTaskValidator {
  public static validate(data: Partial<CrmHealthTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
