export interface CrmHealthAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthAuditLogValidator {
  public static validate(data: Partial<CrmHealthAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
