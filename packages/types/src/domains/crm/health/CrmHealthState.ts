export interface CrmHealthStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthStateValidator {
  public static validate(data: Partial<CrmHealthStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
