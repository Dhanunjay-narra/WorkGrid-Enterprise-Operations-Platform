export interface CrmHealthPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthPayloadValidator {
  public static validate(data: Partial<CrmHealthPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
