export interface CrmHealthNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthNodeValidator {
  public static validate(data: Partial<CrmHealthNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
