export interface CrmHealthTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthTransactionValidator {
  public static validate(data: Partial<CrmHealthTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
