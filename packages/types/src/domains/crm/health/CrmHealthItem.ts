export interface CrmHealthItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthItemValidator {
  public static validate(data: Partial<CrmHealthItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
