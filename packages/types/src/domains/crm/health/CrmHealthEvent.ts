export interface CrmHealthEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthEventValidator {
  public static validate(data: Partial<CrmHealthEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
