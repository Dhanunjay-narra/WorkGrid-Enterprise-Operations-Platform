export interface CrmHealthBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthBatchValidator {
  public static validate(data: Partial<CrmHealthBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
