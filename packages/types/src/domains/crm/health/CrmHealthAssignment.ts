export interface CrmHealthAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthAssignmentValidator {
  public static validate(data: Partial<CrmHealthAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
