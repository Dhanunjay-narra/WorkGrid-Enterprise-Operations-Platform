export interface CrmHealthThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthThresholdValidator {
  public static validate(data: Partial<CrmHealthThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
