export interface CrmHealthSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthSnapshotValidator {
  public static validate(data: Partial<CrmHealthSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
