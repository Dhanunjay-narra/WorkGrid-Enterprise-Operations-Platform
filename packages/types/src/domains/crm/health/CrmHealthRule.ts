export interface CrmHealthRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthRuleValidator {
  public static validate(data: Partial<CrmHealthRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
