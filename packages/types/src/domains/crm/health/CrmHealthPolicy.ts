export interface CrmHealthPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthPolicyValidator {
  public static validate(data: Partial<CrmHealthPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
