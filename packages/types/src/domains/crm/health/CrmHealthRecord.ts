export interface CrmHealthRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthRecordValidator {
  public static validate(data: Partial<CrmHealthRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
