export interface CrmHealthScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthScheduleValidator {
  public static validate(data: Partial<CrmHealthScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
