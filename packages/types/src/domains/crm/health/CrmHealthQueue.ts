export interface CrmHealthQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthQueueValidator {
  public static validate(data: Partial<CrmHealthQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
