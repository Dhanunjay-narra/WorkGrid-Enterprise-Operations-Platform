export interface CrmHealthSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthSummaryValidator {
  public static validate(data: Partial<CrmHealthSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
