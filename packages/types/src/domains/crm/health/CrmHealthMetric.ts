export interface CrmHealthMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthMetricValidator {
  public static validate(data: Partial<CrmHealthMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
