export interface CrmHealthEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthEntryValidator {
  public static validate(data: Partial<CrmHealthEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
