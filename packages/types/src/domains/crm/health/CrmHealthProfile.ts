export interface CrmHealthProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthProfileValidator {
  public static validate(data: Partial<CrmHealthProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
