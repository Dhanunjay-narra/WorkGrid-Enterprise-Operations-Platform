export interface CrmHealthMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthMappingValidator {
  public static validate(data: Partial<CrmHealthMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
