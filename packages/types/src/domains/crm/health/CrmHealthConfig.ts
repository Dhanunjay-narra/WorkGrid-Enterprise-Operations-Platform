export interface CrmHealthConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmHealthConfigValidator {
  public static validate(data: Partial<CrmHealthConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
