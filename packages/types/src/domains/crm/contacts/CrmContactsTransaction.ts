export interface CrmContactsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsTransactionValidator {
  public static validate(data: Partial<CrmContactsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
