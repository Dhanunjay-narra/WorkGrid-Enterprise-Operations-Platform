export interface CrmContactsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsRuleValidator {
  public static validate(data: Partial<CrmContactsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
