export interface CrmContactsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsBatchValidator {
  public static validate(data: Partial<CrmContactsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
