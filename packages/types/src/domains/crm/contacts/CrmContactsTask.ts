export interface CrmContactsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsTaskValidator {
  public static validate(data: Partial<CrmContactsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
