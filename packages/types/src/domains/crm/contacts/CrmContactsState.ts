export interface CrmContactsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsStateValidator {
  public static validate(data: Partial<CrmContactsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
