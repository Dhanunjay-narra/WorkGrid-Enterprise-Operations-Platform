export interface CrmContactsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsMappingValidator {
  public static validate(data: Partial<CrmContactsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
