export interface CrmContactsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsAssignmentValidator {
  public static validate(data: Partial<CrmContactsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
