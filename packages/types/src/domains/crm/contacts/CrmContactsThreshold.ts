export interface CrmContactsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsThresholdValidator {
  public static validate(data: Partial<CrmContactsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
