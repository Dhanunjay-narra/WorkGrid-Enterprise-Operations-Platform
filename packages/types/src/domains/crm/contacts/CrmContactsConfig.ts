export interface CrmContactsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsConfigValidator {
  public static validate(data: Partial<CrmContactsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
