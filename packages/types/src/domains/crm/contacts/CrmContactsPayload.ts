export interface CrmContactsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsPayloadValidator {
  public static validate(data: Partial<CrmContactsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
