export interface CrmContactsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsProfileValidator {
  public static validate(data: Partial<CrmContactsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
