export interface CrmContactsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsRecordValidator {
  public static validate(data: Partial<CrmContactsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
