export interface CrmContactsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsItemValidator {
  public static validate(data: Partial<CrmContactsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
