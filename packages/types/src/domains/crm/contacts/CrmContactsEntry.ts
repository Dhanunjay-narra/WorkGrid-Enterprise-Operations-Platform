export interface CrmContactsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsEntryValidator {
  public static validate(data: Partial<CrmContactsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
