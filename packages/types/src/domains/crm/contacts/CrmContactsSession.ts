export interface CrmContactsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsSessionValidator {
  public static validate(data: Partial<CrmContactsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
