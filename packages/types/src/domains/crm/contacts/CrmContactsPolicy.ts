export interface CrmContactsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsPolicyValidator {
  public static validate(data: Partial<CrmContactsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
