export interface CrmContactsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsReportValidator {
  public static validate(data: Partial<CrmContactsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
