export interface CrmContactsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsScheduleValidator {
  public static validate(data: Partial<CrmContactsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
