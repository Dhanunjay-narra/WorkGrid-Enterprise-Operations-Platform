export interface CrmContactsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsNodeValidator {
  public static validate(data: Partial<CrmContactsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
