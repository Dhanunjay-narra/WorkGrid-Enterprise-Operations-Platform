export interface CrmContactsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsEventValidator {
  public static validate(data: Partial<CrmContactsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
