export interface CrmContactsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsMetricValidator {
  public static validate(data: Partial<CrmContactsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
