export interface CrmContactsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsAuditLogValidator {
  public static validate(data: Partial<CrmContactsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
