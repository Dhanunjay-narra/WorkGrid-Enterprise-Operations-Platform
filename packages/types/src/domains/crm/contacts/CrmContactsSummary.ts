export interface CrmContactsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsSummaryValidator {
  public static validate(data: Partial<CrmContactsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
