export interface CrmContactsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsSnapshotValidator {
  public static validate(data: Partial<CrmContactsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
