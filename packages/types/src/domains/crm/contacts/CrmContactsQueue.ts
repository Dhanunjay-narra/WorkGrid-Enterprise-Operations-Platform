export interface CrmContactsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CrmContactsQueueValidator {
  public static validate(data: Partial<CrmContactsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
