export interface IotTelemetryProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryProfileValidator {
  public static validate(data: Partial<IotTelemetryProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
