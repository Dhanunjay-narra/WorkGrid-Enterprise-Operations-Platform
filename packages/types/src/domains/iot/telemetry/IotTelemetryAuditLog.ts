export interface IotTelemetryAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryAuditLogValidator {
  public static validate(data: Partial<IotTelemetryAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
