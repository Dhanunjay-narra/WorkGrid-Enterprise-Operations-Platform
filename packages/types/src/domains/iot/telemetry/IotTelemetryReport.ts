export interface IotTelemetryReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryReportValidator {
  public static validate(data: Partial<IotTelemetryReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
