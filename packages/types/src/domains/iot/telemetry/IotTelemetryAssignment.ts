export interface IotTelemetryAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryAssignmentValidator {
  public static validate(data: Partial<IotTelemetryAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
