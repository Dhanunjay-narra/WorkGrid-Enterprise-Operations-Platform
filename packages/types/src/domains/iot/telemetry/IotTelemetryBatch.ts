export interface IotTelemetryBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryBatchValidator {
  public static validate(data: Partial<IotTelemetryBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
