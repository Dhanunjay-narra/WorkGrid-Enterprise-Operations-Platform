export interface IotTelemetryTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryTaskValidator {
  public static validate(data: Partial<IotTelemetryTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
