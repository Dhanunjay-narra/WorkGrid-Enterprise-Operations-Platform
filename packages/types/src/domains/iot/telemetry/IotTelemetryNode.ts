export interface IotTelemetryNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryNodeValidator {
  public static validate(data: Partial<IotTelemetryNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
