export interface IotTelemetryPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryPolicyValidator {
  public static validate(data: Partial<IotTelemetryPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
