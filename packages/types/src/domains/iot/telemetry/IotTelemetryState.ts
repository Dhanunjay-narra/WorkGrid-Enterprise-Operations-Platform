export interface IotTelemetryStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryStateValidator {
  public static validate(data: Partial<IotTelemetryStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
