export interface IotTelemetryRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryRecordValidator {
  public static validate(data: Partial<IotTelemetryRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
