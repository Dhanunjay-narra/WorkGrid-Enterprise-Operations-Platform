export interface IotTelemetryItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryItemValidator {
  public static validate(data: Partial<IotTelemetryItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
