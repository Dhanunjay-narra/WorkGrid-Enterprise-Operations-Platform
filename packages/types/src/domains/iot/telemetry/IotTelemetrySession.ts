export interface IotTelemetrySessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetrySessionValidator {
  public static validate(data: Partial<IotTelemetrySessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
