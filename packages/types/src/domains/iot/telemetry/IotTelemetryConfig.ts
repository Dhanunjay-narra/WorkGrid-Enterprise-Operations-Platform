export interface IotTelemetryConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryConfigValidator {
  public static validate(data: Partial<IotTelemetryConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
