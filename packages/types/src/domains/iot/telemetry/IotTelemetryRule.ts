export interface IotTelemetryRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryRuleValidator {
  public static validate(data: Partial<IotTelemetryRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
