export interface IotTelemetryEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryEntryValidator {
  public static validate(data: Partial<IotTelemetryEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
