export interface IotTelemetryPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryPayloadValidator {
  public static validate(data: Partial<IotTelemetryPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
