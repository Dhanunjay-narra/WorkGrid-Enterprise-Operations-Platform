export interface IotTelemetrySnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetrySnapshotValidator {
  public static validate(data: Partial<IotTelemetrySnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
