export interface IotTelemetryTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryTransactionValidator {
  public static validate(data: Partial<IotTelemetryTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
