export interface IotTelemetryScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryScheduleValidator {
  public static validate(data: Partial<IotTelemetryScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
