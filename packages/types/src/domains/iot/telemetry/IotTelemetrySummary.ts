export interface IotTelemetrySummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetrySummaryValidator {
  public static validate(data: Partial<IotTelemetrySummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
