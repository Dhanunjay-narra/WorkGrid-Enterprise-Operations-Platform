export interface IotTelemetryMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryMappingValidator {
  public static validate(data: Partial<IotTelemetryMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
