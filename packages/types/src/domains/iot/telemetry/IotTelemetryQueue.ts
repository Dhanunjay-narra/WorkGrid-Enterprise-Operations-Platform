export interface IotTelemetryQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryQueueValidator {
  public static validate(data: Partial<IotTelemetryQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
