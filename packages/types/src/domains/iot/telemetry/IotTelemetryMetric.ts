export interface IotTelemetryMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryMetricValidator {
  public static validate(data: Partial<IotTelemetryMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
