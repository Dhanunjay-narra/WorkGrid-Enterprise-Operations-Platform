export interface IotTelemetryEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotTelemetryEventValidator {
  public static validate(data: Partial<IotTelemetryEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
