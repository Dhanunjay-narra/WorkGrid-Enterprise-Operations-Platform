export interface IotFirmwareTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareTransactionValidator {
  public static validate(data: Partial<IotFirmwareTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
