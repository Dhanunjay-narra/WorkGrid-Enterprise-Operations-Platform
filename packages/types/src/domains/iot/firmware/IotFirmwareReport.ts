export interface IotFirmwareReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareReportValidator {
  public static validate(data: Partial<IotFirmwareReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
