export interface IotFirmwareItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareItemValidator {
  public static validate(data: Partial<IotFirmwareItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
