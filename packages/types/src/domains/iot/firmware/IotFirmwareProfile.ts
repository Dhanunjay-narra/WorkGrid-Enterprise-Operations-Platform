export interface IotFirmwareProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareProfileValidator {
  public static validate(data: Partial<IotFirmwareProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
