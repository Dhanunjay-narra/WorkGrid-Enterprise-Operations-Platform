export interface IotFirmwareSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareSummaryValidator {
  public static validate(data: Partial<IotFirmwareSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
