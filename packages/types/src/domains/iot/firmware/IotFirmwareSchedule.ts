export interface IotFirmwareScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareScheduleValidator {
  public static validate(data: Partial<IotFirmwareScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
