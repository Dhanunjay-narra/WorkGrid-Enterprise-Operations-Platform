export interface IotFirmwareAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareAssignmentValidator {
  public static validate(data: Partial<IotFirmwareAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
