export interface IotFirmwareSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareSnapshotValidator {
  public static validate(data: Partial<IotFirmwareSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
