export interface IotFirmwareMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareMetricValidator {
  public static validate(data: Partial<IotFirmwareMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
