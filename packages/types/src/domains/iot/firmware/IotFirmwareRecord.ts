export interface IotFirmwareRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareRecordValidator {
  public static validate(data: Partial<IotFirmwareRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
