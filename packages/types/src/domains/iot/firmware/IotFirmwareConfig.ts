export interface IotFirmwareConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareConfigValidator {
  public static validate(data: Partial<IotFirmwareConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
