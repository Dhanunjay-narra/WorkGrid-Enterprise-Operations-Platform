export interface IotFirmwareThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareThresholdValidator {
  public static validate(data: Partial<IotFirmwareThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
