export interface IotFirmwareBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareBatchValidator {
  public static validate(data: Partial<IotFirmwareBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
