export interface IotFirmwareQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareQueueValidator {
  public static validate(data: Partial<IotFirmwareQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
