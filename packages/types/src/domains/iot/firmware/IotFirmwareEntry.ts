export interface IotFirmwareEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareEntryValidator {
  public static validate(data: Partial<IotFirmwareEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
