export interface IotFirmwareMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareMappingValidator {
  public static validate(data: Partial<IotFirmwareMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
