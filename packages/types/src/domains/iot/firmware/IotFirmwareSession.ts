export interface IotFirmwareSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareSessionValidator {
  public static validate(data: Partial<IotFirmwareSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
