export interface IotFirmwareStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareStateValidator {
  public static validate(data: Partial<IotFirmwareStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
