export interface IotFirmwareAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareAuditLogValidator {
  public static validate(data: Partial<IotFirmwareAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
