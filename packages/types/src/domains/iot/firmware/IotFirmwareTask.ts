export interface IotFirmwareTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareTaskValidator {
  public static validate(data: Partial<IotFirmwareTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
