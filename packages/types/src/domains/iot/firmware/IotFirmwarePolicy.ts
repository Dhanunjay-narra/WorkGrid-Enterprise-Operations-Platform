export interface IotFirmwarePolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwarePolicyValidator {
  public static validate(data: Partial<IotFirmwarePolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
