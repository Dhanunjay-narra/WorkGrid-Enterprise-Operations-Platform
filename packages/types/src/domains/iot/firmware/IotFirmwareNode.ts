export interface IotFirmwareNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareNodeValidator {
  public static validate(data: Partial<IotFirmwareNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
