export interface IotFirmwarePayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwarePayloadValidator {
  public static validate(data: Partial<IotFirmwarePayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
