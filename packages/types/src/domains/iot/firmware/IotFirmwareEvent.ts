export interface IotFirmwareEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareEventValidator {
  public static validate(data: Partial<IotFirmwareEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
