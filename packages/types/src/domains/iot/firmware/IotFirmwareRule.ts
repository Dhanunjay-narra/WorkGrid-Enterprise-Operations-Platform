export interface IotFirmwareRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFirmwareRuleValidator {
  public static validate(data: Partial<IotFirmwareRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
