export interface IotAnomaliesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesAuditLogValidator {
  public static validate(data: Partial<IotAnomaliesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
