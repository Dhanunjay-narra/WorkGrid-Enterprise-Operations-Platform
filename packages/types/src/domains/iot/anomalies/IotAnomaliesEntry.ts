export interface IotAnomaliesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesEntryValidator {
  public static validate(data: Partial<IotAnomaliesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
