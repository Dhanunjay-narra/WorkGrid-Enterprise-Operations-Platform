export interface IotAnomaliesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesSnapshotValidator {
  public static validate(data: Partial<IotAnomaliesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
