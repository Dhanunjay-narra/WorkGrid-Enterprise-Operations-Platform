export interface IotAnomaliesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesSummaryValidator {
  public static validate(data: Partial<IotAnomaliesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
