export interface IotAnomaliesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesNodeValidator {
  public static validate(data: Partial<IotAnomaliesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
