export interface IotAnomaliesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesTaskValidator {
  public static validate(data: Partial<IotAnomaliesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
