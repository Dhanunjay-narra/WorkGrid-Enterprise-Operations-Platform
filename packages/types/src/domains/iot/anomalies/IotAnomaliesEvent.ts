export interface IotAnomaliesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesEventValidator {
  public static validate(data: Partial<IotAnomaliesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
