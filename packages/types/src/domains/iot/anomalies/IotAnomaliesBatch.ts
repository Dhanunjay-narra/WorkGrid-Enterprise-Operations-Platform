export interface IotAnomaliesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesBatchValidator {
  public static validate(data: Partial<IotAnomaliesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
