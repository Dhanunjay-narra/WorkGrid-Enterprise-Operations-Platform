export interface IotAnomaliesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesRecordValidator {
  public static validate(data: Partial<IotAnomaliesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
