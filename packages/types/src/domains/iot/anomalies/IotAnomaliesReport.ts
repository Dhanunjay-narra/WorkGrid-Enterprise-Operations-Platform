export interface IotAnomaliesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesReportValidator {
  public static validate(data: Partial<IotAnomaliesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
