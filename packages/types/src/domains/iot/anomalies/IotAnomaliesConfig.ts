export interface IotAnomaliesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesConfigValidator {
  public static validate(data: Partial<IotAnomaliesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
