export interface IotAnomaliesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesRuleValidator {
  public static validate(data: Partial<IotAnomaliesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
