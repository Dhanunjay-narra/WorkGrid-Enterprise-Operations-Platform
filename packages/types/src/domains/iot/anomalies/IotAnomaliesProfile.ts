export interface IotAnomaliesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesProfileValidator {
  public static validate(data: Partial<IotAnomaliesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
