export interface IotAnomaliesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesItemValidator {
  public static validate(data: Partial<IotAnomaliesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
