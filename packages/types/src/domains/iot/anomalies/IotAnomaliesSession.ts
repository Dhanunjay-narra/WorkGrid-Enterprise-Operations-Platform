export interface IotAnomaliesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesSessionValidator {
  public static validate(data: Partial<IotAnomaliesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
