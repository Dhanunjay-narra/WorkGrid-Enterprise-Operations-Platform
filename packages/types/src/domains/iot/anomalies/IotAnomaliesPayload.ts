export interface IotAnomaliesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesPayloadValidator {
  public static validate(data: Partial<IotAnomaliesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
