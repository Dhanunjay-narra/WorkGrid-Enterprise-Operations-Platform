export interface IotAnomaliesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesMetricValidator {
  public static validate(data: Partial<IotAnomaliesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
