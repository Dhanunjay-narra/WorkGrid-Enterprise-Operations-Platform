export interface IotAnomaliesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesStateValidator {
  public static validate(data: Partial<IotAnomaliesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
