export interface IotAnomaliesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesTransactionValidator {
  public static validate(data: Partial<IotAnomaliesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
