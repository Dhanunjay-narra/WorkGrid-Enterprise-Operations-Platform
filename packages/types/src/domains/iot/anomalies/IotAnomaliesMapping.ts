export interface IotAnomaliesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesMappingValidator {
  public static validate(data: Partial<IotAnomaliesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
