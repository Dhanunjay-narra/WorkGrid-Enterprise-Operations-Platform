export interface IotAnomaliesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesScheduleValidator {
  public static validate(data: Partial<IotAnomaliesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
