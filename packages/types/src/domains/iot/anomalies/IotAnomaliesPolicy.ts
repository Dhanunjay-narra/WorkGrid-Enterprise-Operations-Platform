export interface IotAnomaliesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesPolicyValidator {
  public static validate(data: Partial<IotAnomaliesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
