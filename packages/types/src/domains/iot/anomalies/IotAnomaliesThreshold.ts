export interface IotAnomaliesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesThresholdValidator {
  public static validate(data: Partial<IotAnomaliesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
