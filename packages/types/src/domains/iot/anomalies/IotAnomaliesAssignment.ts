export interface IotAnomaliesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotAnomaliesAssignmentValidator {
  public static validate(data: Partial<IotAnomaliesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
