export interface IotThresholdsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsSummaryValidator {
  public static validate(data: Partial<IotThresholdsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
