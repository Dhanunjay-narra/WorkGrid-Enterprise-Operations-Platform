export interface IotThresholdsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsBatchValidator {
  public static validate(data: Partial<IotThresholdsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
