export interface IotThresholdsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsMetricValidator {
  public static validate(data: Partial<IotThresholdsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
