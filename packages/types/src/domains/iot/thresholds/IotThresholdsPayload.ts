export interface IotThresholdsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsPayloadValidator {
  public static validate(data: Partial<IotThresholdsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
