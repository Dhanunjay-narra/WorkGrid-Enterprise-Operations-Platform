export interface IotThresholdsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsNodeValidator {
  public static validate(data: Partial<IotThresholdsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
