export interface IotThresholdsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsEventValidator {
  public static validate(data: Partial<IotThresholdsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
