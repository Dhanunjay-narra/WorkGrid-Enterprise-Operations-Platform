export interface IotThresholdsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsSessionValidator {
  public static validate(data: Partial<IotThresholdsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
