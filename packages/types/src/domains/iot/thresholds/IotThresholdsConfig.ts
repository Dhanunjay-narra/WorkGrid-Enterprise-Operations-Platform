export interface IotThresholdsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsConfigValidator {
  public static validate(data: Partial<IotThresholdsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
