export interface IotThresholdsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsRuleValidator {
  public static validate(data: Partial<IotThresholdsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
