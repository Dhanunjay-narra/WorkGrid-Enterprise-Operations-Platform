export interface IotThresholdsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsThresholdValidator {
  public static validate(data: Partial<IotThresholdsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
