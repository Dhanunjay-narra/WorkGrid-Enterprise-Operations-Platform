export interface IotThresholdsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsAuditLogValidator {
  public static validate(data: Partial<IotThresholdsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
