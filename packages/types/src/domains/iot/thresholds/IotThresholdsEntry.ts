export interface IotThresholdsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsEntryValidator {
  public static validate(data: Partial<IotThresholdsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
