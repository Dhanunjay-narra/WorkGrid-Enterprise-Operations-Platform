export interface IotThresholdsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsPolicyValidator {
  public static validate(data: Partial<IotThresholdsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
