export interface IotThresholdsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsRecordValidator {
  public static validate(data: Partial<IotThresholdsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
