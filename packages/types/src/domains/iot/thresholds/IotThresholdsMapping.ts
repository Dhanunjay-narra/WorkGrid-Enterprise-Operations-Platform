export interface IotThresholdsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsMappingValidator {
  public static validate(data: Partial<IotThresholdsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
