export interface IotThresholdsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsStateValidator {
  public static validate(data: Partial<IotThresholdsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
