export interface IotThresholdsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsQueueValidator {
  public static validate(data: Partial<IotThresholdsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
