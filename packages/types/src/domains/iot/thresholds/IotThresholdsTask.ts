export interface IotThresholdsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsTaskValidator {
  public static validate(data: Partial<IotThresholdsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
