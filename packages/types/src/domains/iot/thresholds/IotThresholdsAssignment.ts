export interface IotThresholdsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsAssignmentValidator {
  public static validate(data: Partial<IotThresholdsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
