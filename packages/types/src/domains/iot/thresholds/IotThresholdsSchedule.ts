export interface IotThresholdsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsScheduleValidator {
  public static validate(data: Partial<IotThresholdsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
