export interface IotThresholdsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsProfileValidator {
  public static validate(data: Partial<IotThresholdsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
