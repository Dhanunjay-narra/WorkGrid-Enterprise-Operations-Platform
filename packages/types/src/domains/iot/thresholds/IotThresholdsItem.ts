export interface IotThresholdsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsItemValidator {
  public static validate(data: Partial<IotThresholdsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
