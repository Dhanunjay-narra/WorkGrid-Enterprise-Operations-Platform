export interface IotThresholdsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsReportValidator {
  public static validate(data: Partial<IotThresholdsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
