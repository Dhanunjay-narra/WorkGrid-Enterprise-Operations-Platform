export interface IotThresholdsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotThresholdsTransactionValidator {
  public static validate(data: Partial<IotThresholdsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
