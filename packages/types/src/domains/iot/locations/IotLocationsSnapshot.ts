export interface IotLocationsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsSnapshotValidator {
  public static validate(data: Partial<IotLocationsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
