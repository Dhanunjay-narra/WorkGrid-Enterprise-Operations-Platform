export interface IotLocationsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsMetricValidator {
  public static validate(data: Partial<IotLocationsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
