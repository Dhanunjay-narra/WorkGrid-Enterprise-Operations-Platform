export interface IotLocationsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsSessionValidator {
  public static validate(data: Partial<IotLocationsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
