export interface IotLocationsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsPayloadValidator {
  public static validate(data: Partial<IotLocationsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
