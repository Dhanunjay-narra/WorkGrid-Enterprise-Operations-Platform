export interface IotLocationsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsEntryValidator {
  public static validate(data: Partial<IotLocationsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
