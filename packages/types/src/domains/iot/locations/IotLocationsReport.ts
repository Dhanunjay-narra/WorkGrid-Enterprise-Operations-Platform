export interface IotLocationsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsReportValidator {
  public static validate(data: Partial<IotLocationsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
