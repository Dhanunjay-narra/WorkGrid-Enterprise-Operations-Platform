export interface IotLocationsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsPolicyValidator {
  public static validate(data: Partial<IotLocationsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
