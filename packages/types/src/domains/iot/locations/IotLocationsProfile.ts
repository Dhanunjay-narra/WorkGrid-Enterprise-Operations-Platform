export interface IotLocationsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsProfileValidator {
  public static validate(data: Partial<IotLocationsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
