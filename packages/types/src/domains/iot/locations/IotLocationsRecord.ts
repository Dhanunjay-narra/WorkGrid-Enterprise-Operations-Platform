export interface IotLocationsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsRecordValidator {
  public static validate(data: Partial<IotLocationsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
