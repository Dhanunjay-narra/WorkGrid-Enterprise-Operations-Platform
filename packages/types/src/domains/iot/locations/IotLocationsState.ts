export interface IotLocationsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsStateValidator {
  public static validate(data: Partial<IotLocationsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
