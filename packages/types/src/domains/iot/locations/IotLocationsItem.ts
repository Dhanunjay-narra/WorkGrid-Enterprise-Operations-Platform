export interface IotLocationsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsItemValidator {
  public static validate(data: Partial<IotLocationsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
