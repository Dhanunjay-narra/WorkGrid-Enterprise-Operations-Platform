export interface IotLocationsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsConfigValidator {
  public static validate(data: Partial<IotLocationsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
