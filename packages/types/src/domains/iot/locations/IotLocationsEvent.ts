export interface IotLocationsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsEventValidator {
  public static validate(data: Partial<IotLocationsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
