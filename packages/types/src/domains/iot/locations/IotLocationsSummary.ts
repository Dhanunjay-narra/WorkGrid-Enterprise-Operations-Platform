export interface IotLocationsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsSummaryValidator {
  public static validate(data: Partial<IotLocationsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
