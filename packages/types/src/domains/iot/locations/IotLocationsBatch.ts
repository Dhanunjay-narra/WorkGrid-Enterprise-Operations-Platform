export interface IotLocationsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsBatchValidator {
  public static validate(data: Partial<IotLocationsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
