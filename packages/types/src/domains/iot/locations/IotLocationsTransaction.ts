export interface IotLocationsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsTransactionValidator {
  public static validate(data: Partial<IotLocationsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
