export interface IotLocationsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsQueueValidator {
  public static validate(data: Partial<IotLocationsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
