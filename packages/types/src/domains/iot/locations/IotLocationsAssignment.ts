export interface IotLocationsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsAssignmentValidator {
  public static validate(data: Partial<IotLocationsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
