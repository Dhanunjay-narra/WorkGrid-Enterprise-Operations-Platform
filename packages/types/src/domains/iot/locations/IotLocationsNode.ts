export interface IotLocationsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsNodeValidator {
  public static validate(data: Partial<IotLocationsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
