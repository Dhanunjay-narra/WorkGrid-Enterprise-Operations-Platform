export interface IotLocationsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsScheduleValidator {
  public static validate(data: Partial<IotLocationsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
