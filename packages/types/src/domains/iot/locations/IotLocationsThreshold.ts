export interface IotLocationsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsThresholdValidator {
  public static validate(data: Partial<IotLocationsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
