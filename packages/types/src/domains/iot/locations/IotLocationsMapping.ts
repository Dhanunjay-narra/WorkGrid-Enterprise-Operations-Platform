export interface IotLocationsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsMappingValidator {
  public static validate(data: Partial<IotLocationsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
