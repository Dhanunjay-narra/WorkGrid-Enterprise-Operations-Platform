export interface IotLocationsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsTaskValidator {
  public static validate(data: Partial<IotLocationsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
