export interface IotLocationsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsAuditLogValidator {
  public static validate(data: Partial<IotLocationsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
