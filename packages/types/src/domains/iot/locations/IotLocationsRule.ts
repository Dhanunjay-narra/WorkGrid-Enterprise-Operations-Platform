export interface IotLocationsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotLocationsRuleValidator {
  public static validate(data: Partial<IotLocationsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
