export interface IotCommandsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsConfigValidator {
  public static validate(data: Partial<IotCommandsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
