export interface IotCommandsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsQueueValidator {
  public static validate(data: Partial<IotCommandsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
