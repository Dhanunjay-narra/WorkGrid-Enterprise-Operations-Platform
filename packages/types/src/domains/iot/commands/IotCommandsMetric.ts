export interface IotCommandsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsMetricValidator {
  public static validate(data: Partial<IotCommandsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
