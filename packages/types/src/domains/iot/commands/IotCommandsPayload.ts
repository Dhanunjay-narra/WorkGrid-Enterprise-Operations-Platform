export interface IotCommandsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsPayloadValidator {
  public static validate(data: Partial<IotCommandsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
