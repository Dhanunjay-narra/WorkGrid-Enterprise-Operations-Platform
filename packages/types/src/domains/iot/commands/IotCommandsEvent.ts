export interface IotCommandsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsEventValidator {
  public static validate(data: Partial<IotCommandsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
