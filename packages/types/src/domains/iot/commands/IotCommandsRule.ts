export interface IotCommandsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsRuleValidator {
  public static validate(data: Partial<IotCommandsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
