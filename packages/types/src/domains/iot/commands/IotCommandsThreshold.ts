export interface IotCommandsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsThresholdValidator {
  public static validate(data: Partial<IotCommandsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
