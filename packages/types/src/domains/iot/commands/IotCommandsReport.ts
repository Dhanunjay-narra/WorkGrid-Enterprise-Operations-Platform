export interface IotCommandsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsReportValidator {
  public static validate(data: Partial<IotCommandsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
