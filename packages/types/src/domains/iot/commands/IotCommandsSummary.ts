export interface IotCommandsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsSummaryValidator {
  public static validate(data: Partial<IotCommandsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
