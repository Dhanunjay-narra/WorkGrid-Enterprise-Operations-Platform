export interface IotCommandsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsSnapshotValidator {
  public static validate(data: Partial<IotCommandsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
