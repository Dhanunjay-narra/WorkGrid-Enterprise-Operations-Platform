export interface IotCommandsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsAuditLogValidator {
  public static validate(data: Partial<IotCommandsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
