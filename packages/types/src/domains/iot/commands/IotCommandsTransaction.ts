export interface IotCommandsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsTransactionValidator {
  public static validate(data: Partial<IotCommandsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
