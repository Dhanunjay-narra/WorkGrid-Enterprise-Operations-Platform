export interface IotCommandsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsItemValidator {
  public static validate(data: Partial<IotCommandsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
