export interface IotCommandsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsRecordValidator {
  public static validate(data: Partial<IotCommandsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
