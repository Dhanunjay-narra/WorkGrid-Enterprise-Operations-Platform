export interface IotCommandsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsTaskValidator {
  public static validate(data: Partial<IotCommandsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
