export interface IotCommandsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsProfileValidator {
  public static validate(data: Partial<IotCommandsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
