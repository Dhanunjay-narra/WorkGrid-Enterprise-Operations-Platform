export interface IotCommandsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsEntryValidator {
  public static validate(data: Partial<IotCommandsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
