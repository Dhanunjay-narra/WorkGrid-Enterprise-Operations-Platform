export interface IotCommandsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsAssignmentValidator {
  public static validate(data: Partial<IotCommandsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
