export interface IotCommandsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsBatchValidator {
  public static validate(data: Partial<IotCommandsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
