export interface IotCommandsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsScheduleValidator {
  public static validate(data: Partial<IotCommandsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
