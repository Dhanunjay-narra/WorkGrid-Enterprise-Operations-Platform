export interface IotCommandsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsStateValidator {
  public static validate(data: Partial<IotCommandsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
