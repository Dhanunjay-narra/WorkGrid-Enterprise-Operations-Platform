export interface IotCommandsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsSessionValidator {
  public static validate(data: Partial<IotCommandsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
