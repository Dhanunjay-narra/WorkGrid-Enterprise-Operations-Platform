export interface IotCommandsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotCommandsPolicyValidator {
  public static validate(data: Partial<IotCommandsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
