export interface IotFleetMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetMetricValidator {
  public static validate(data: Partial<IotFleetMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
