export interface IotFleetSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetSessionValidator {
  public static validate(data: Partial<IotFleetSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
