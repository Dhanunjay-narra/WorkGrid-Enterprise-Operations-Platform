export interface IotFleetNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetNodeValidator {
  public static validate(data: Partial<IotFleetNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
