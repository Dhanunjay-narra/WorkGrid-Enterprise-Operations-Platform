export interface IotFleetPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetPayloadValidator {
  public static validate(data: Partial<IotFleetPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
