export interface IotFleetRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetRuleValidator {
  public static validate(data: Partial<IotFleetRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
