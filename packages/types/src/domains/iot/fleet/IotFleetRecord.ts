export interface IotFleetRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetRecordValidator {
  public static validate(data: Partial<IotFleetRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
