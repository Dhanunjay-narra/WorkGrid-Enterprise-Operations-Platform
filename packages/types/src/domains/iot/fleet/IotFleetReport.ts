export interface IotFleetReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetReportValidator {
  public static validate(data: Partial<IotFleetReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
