export interface IotFleetEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetEntryValidator {
  public static validate(data: Partial<IotFleetEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
