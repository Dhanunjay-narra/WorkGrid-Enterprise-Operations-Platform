export interface IotFleetProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetProfileValidator {
  public static validate(data: Partial<IotFleetProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
