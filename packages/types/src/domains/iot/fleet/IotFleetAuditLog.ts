export interface IotFleetAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetAuditLogValidator {
  public static validate(data: Partial<IotFleetAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
