export interface IotFleetBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetBatchValidator {
  public static validate(data: Partial<IotFleetBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
