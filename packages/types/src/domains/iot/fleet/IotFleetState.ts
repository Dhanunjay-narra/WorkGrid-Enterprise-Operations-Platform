export interface IotFleetStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetStateValidator {
  public static validate(data: Partial<IotFleetStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
