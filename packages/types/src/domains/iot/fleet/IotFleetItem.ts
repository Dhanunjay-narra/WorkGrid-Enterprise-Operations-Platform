export interface IotFleetItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetItemValidator {
  public static validate(data: Partial<IotFleetItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
