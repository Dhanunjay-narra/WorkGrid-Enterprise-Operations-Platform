export interface IotFleetTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetTaskValidator {
  public static validate(data: Partial<IotFleetTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
