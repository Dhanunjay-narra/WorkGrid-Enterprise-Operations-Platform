export interface IotFleetSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetSnapshotValidator {
  public static validate(data: Partial<IotFleetSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
