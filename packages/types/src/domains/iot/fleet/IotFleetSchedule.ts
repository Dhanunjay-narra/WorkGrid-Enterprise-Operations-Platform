export interface IotFleetScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetScheduleValidator {
  public static validate(data: Partial<IotFleetScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
