export interface IotFleetPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetPolicyValidator {
  public static validate(data: Partial<IotFleetPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
