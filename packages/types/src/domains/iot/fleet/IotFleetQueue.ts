export interface IotFleetQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetQueueValidator {
  public static validate(data: Partial<IotFleetQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
