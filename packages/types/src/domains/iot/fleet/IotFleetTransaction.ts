export interface IotFleetTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetTransactionValidator {
  public static validate(data: Partial<IotFleetTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
