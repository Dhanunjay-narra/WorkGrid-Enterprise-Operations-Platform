export interface IotFleetEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetEventValidator {
  public static validate(data: Partial<IotFleetEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
