export interface IotFleetConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetConfigValidator {
  public static validate(data: Partial<IotFleetConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
