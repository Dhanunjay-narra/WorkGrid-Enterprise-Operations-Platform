export interface IotFleetThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetThresholdValidator {
  public static validate(data: Partial<IotFleetThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
