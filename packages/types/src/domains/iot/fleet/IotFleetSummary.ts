export interface IotFleetSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetSummaryValidator {
  public static validate(data: Partial<IotFleetSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
