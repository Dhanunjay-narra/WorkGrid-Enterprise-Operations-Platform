export interface IotFleetMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetMappingValidator {
  public static validate(data: Partial<IotFleetMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
