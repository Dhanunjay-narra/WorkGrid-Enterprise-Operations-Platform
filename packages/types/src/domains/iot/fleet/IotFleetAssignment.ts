export interface IotFleetAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotFleetAssignmentValidator {
  public static validate(data: Partial<IotFleetAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
