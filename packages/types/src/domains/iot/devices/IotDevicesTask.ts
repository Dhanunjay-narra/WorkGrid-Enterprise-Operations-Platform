export interface IotDevicesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesTaskValidator {
  public static validate(data: Partial<IotDevicesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
