export interface IotDevicesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesSnapshotValidator {
  public static validate(data: Partial<IotDevicesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
