export interface IotDevicesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesMetricValidator {
  public static validate(data: Partial<IotDevicesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
