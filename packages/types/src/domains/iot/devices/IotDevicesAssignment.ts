export interface IotDevicesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesAssignmentValidator {
  public static validate(data: Partial<IotDevicesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
