export interface IotDevicesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesStateValidator {
  public static validate(data: Partial<IotDevicesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
