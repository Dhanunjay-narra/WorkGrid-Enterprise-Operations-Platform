export interface IotDevicesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesBatchValidator {
  public static validate(data: Partial<IotDevicesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
