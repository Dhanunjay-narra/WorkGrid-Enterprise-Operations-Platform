export interface IotDevicesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesPolicyValidator {
  public static validate(data: Partial<IotDevicesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
