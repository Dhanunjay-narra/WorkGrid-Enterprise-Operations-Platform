export interface IotDevicesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesEventValidator {
  public static validate(data: Partial<IotDevicesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
