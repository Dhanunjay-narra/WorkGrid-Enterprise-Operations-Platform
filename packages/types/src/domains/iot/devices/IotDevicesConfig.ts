export interface IotDevicesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesConfigValidator {
  public static validate(data: Partial<IotDevicesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
