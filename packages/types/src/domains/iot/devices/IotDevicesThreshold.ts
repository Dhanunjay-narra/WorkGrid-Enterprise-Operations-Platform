export interface IotDevicesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesThresholdValidator {
  public static validate(data: Partial<IotDevicesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
