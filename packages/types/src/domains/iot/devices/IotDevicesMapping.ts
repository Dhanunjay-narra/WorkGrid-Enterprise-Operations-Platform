export interface IotDevicesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesMappingValidator {
  public static validate(data: Partial<IotDevicesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
