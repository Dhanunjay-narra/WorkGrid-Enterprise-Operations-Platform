export interface IotDevicesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesSessionValidator {
  public static validate(data: Partial<IotDevicesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
