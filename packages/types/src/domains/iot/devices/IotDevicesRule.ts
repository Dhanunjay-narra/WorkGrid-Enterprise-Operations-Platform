export interface IotDevicesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesRuleValidator {
  public static validate(data: Partial<IotDevicesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
