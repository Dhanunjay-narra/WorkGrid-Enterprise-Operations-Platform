export interface IotDevicesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesReportValidator {
  public static validate(data: Partial<IotDevicesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
