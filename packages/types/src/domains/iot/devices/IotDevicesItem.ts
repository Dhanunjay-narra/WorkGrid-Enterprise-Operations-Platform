export interface IotDevicesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesItemValidator {
  public static validate(data: Partial<IotDevicesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
