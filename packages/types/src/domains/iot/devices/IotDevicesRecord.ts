export interface IotDevicesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesRecordValidator {
  public static validate(data: Partial<IotDevicesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
