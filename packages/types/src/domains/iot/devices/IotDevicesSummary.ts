export interface IotDevicesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesSummaryValidator {
  public static validate(data: Partial<IotDevicesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
