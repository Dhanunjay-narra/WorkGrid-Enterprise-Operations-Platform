export interface IotDevicesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesTransactionValidator {
  public static validate(data: Partial<IotDevicesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
