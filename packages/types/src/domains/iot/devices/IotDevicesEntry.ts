export interface IotDevicesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesEntryValidator {
  public static validate(data: Partial<IotDevicesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
