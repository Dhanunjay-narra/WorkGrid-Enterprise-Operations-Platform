export interface IotDevicesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesNodeValidator {
  public static validate(data: Partial<IotDevicesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
