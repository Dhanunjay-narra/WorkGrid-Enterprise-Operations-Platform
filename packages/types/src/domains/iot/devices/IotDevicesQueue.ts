export interface IotDevicesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesQueueValidator {
  public static validate(data: Partial<IotDevicesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
