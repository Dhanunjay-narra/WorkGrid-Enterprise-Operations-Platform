export interface IotDevicesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesPayloadValidator {
  public static validate(data: Partial<IotDevicesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
