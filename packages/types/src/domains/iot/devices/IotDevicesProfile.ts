export interface IotDevicesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesProfileValidator {
  public static validate(data: Partial<IotDevicesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
