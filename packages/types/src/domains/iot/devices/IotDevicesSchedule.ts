export interface IotDevicesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesScheduleValidator {
  public static validate(data: Partial<IotDevicesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
