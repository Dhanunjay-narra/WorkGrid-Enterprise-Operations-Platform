export interface IotDevicesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class IotDevicesAuditLogValidator {
  public static validate(data: Partial<IotDevicesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
