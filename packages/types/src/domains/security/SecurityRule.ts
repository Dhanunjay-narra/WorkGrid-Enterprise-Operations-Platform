export interface SecurityRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityRuleValidator {
  public static validate(data: Partial<SecurityRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
