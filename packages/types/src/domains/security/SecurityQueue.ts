export interface SecurityQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityQueueValidator {
  public static validate(data: Partial<SecurityQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
