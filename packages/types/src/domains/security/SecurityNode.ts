export interface SecurityNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityNodeValidator {
  public static validate(data: Partial<SecurityNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
