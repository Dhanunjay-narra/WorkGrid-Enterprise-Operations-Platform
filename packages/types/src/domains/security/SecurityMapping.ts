export interface SecurityMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityMappingValidator {
  public static validate(data: Partial<SecurityMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
