export interface SecurityMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityMetricValidator {
  public static validate(data: Partial<SecurityMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
