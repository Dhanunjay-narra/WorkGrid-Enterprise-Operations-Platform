export interface SecurityThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityThresholdValidator {
  public static validate(data: Partial<SecurityThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
