export interface SecurityScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityScheduleValidator {
  public static validate(data: Partial<SecurityScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
