export interface SecurityRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityRecordValidator {
  public static validate(data: Partial<SecurityRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
