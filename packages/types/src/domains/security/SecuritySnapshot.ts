export interface SecuritySnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecuritySnapshotValidator {
  public static validate(data: Partial<SecuritySnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
