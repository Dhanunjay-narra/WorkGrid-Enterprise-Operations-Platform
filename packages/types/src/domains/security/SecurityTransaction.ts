export interface SecurityTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityTransactionValidator {
  public static validate(data: Partial<SecurityTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
