export interface SecurityPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityPayloadValidator {
  public static validate(data: Partial<SecurityPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
