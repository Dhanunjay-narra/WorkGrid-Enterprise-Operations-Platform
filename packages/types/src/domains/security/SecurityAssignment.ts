export interface SecurityAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityAssignmentValidator {
  public static validate(data: Partial<SecurityAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
