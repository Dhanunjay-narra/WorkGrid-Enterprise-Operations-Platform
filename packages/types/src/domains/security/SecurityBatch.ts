export interface SecurityBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityBatchValidator {
  public static validate(data: Partial<SecurityBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
