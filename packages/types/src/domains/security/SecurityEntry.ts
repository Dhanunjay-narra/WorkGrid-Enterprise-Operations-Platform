export interface SecurityEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityEntryValidator {
  public static validate(data: Partial<SecurityEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
