export interface SecurityItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityItemValidator {
  public static validate(data: Partial<SecurityItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
