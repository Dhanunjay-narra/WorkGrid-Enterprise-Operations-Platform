export interface SecurityTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityTaskValidator {
  public static validate(data: Partial<SecurityTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
