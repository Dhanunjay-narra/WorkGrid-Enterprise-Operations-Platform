export interface SecurityProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityProfileValidator {
  public static validate(data: Partial<SecurityProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
