export interface SecurityAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class SecurityAuditLogValidator {
  public static validate(data: Partial<SecurityAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
