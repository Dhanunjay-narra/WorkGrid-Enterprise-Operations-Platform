export interface RbacAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class RbacAuditLogValidator {
  public static validate(data: Partial<RbacAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
