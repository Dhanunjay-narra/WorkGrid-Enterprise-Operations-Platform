export interface RbacThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class RbacThresholdValidator {
  public static validate(data: Partial<RbacThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
