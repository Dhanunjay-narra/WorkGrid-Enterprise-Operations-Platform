export interface RbacTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class RbacTransactionValidator {
  public static validate(data: Partial<RbacTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
