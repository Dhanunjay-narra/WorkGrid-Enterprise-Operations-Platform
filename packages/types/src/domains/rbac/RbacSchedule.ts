export interface RbacScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class RbacScheduleValidator {
  public static validate(data: Partial<RbacScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
