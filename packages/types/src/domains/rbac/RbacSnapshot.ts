export interface RbacSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class RbacSnapshotValidator {
  public static validate(data: Partial<RbacSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
