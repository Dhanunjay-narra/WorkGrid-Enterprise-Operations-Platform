export interface CommThreadsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsAssignmentValidator {
  public static validate(data: Partial<CommThreadsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
