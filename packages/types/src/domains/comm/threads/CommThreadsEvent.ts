export interface CommThreadsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsEventValidator {
  public static validate(data: Partial<CommThreadsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
