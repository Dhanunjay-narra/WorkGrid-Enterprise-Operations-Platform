export interface CommThreadsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsAuditLogValidator {
  public static validate(data: Partial<CommThreadsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
