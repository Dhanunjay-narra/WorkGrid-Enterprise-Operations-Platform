export interface CommThreadsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsRuleValidator {
  public static validate(data: Partial<CommThreadsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
