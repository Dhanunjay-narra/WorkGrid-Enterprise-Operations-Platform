export interface CommThreadsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsQueueValidator {
  public static validate(data: Partial<CommThreadsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
