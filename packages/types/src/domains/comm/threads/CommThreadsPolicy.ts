export interface CommThreadsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsPolicyValidator {
  public static validate(data: Partial<CommThreadsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
