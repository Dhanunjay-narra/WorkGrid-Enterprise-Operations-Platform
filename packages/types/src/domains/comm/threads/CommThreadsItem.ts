export interface CommThreadsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsItemValidator {
  public static validate(data: Partial<CommThreadsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
