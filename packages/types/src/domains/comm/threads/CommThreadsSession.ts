export interface CommThreadsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsSessionValidator {
  public static validate(data: Partial<CommThreadsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
