export interface CommThreadsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsSummaryValidator {
  public static validate(data: Partial<CommThreadsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
