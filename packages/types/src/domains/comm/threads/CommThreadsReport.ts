export interface CommThreadsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsReportValidator {
  public static validate(data: Partial<CommThreadsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
