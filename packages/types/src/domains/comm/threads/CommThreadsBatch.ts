export interface CommThreadsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsBatchValidator {
  public static validate(data: Partial<CommThreadsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
