export interface CommThreadsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsMappingValidator {
  public static validate(data: Partial<CommThreadsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
