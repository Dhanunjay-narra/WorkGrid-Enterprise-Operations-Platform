export interface CommThreadsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsScheduleValidator {
  public static validate(data: Partial<CommThreadsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
