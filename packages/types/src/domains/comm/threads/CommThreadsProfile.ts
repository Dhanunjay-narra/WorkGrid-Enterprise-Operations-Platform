export interface CommThreadsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsProfileValidator {
  public static validate(data: Partial<CommThreadsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
