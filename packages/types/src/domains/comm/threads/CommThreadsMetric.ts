export interface CommThreadsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsMetricValidator {
  public static validate(data: Partial<CommThreadsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
