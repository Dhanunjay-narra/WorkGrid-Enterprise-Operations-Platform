export interface CommThreadsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsConfigValidator {
  public static validate(data: Partial<CommThreadsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
