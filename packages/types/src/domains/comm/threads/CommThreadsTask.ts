export interface CommThreadsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsTaskValidator {
  public static validate(data: Partial<CommThreadsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
