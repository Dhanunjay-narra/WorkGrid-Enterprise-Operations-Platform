export interface CommThreadsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsTransactionValidator {
  public static validate(data: Partial<CommThreadsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
