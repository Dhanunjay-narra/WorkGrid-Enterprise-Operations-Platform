export interface CommThreadsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsPayloadValidator {
  public static validate(data: Partial<CommThreadsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
