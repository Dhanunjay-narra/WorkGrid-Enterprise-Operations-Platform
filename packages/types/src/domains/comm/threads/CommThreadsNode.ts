export interface CommThreadsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsNodeValidator {
  public static validate(data: Partial<CommThreadsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
