export interface CommThreadsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsThresholdValidator {
  public static validate(data: Partial<CommThreadsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
