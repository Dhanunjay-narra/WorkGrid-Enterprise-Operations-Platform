export interface CommThreadsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsSnapshotValidator {
  public static validate(data: Partial<CommThreadsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
