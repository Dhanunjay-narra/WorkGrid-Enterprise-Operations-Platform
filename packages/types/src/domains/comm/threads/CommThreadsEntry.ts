export interface CommThreadsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsEntryValidator {
  public static validate(data: Partial<CommThreadsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
