export interface CommThreadsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsStateValidator {
  public static validate(data: Partial<CommThreadsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
