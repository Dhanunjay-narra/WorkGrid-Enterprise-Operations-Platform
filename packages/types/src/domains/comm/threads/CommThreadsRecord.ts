export interface CommThreadsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommThreadsRecordValidator {
  public static validate(data: Partial<CommThreadsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
