export interface CommPresenceReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceReportValidator {
  public static validate(data: Partial<CommPresenceReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
