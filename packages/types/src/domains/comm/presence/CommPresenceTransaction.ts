export interface CommPresenceTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceTransactionValidator {
  public static validate(data: Partial<CommPresenceTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
