export interface CommPresenceStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceStateValidator {
  public static validate(data: Partial<CommPresenceStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
