export interface CommPresenceBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceBatchValidator {
  public static validate(data: Partial<CommPresenceBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
