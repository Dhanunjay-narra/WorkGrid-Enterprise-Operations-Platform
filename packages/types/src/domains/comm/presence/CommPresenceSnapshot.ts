export interface CommPresenceSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceSnapshotValidator {
  public static validate(data: Partial<CommPresenceSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
