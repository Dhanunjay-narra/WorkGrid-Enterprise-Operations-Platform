export interface CommPresenceEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceEventValidator {
  public static validate(data: Partial<CommPresenceEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
