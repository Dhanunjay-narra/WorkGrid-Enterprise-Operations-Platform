export interface CommPresenceMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceMetricValidator {
  public static validate(data: Partial<CommPresenceMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
