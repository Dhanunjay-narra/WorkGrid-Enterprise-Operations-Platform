export interface CommPresenceTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceTaskValidator {
  public static validate(data: Partial<CommPresenceTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
