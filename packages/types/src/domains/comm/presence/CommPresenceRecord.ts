export interface CommPresenceRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceRecordValidator {
  public static validate(data: Partial<CommPresenceRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
