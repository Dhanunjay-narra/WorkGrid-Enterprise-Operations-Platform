export interface CommPresenceThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceThresholdValidator {
  public static validate(data: Partial<CommPresenceThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
