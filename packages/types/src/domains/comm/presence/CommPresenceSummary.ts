export interface CommPresenceSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceSummaryValidator {
  public static validate(data: Partial<CommPresenceSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
