export interface CommPresenceAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceAssignmentValidator {
  public static validate(data: Partial<CommPresenceAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
