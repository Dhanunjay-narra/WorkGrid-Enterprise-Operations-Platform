export interface CommPresenceNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceNodeValidator {
  public static validate(data: Partial<CommPresenceNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
