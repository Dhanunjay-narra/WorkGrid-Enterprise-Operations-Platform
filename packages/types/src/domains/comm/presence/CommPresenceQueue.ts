export interface CommPresenceQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceQueueValidator {
  public static validate(data: Partial<CommPresenceQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
