export interface CommPresenceRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceRuleValidator {
  public static validate(data: Partial<CommPresenceRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
