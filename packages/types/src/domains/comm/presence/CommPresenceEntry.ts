export interface CommPresenceEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceEntryValidator {
  public static validate(data: Partial<CommPresenceEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
