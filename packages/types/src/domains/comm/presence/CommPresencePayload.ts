export interface CommPresencePayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresencePayloadValidator {
  public static validate(data: Partial<CommPresencePayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
