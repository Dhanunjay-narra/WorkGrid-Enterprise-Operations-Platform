export interface CommPresenceScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceScheduleValidator {
  public static validate(data: Partial<CommPresenceScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
