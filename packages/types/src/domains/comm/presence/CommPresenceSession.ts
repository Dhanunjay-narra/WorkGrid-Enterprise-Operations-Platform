export interface CommPresenceSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceSessionValidator {
  public static validate(data: Partial<CommPresenceSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
