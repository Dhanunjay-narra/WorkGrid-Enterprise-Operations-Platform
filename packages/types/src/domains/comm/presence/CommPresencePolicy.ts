export interface CommPresencePolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresencePolicyValidator {
  public static validate(data: Partial<CommPresencePolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
