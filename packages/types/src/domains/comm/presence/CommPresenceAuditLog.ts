export interface CommPresenceAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceAuditLogValidator {
  public static validate(data: Partial<CommPresenceAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
