export interface CommPresenceItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceItemValidator {
  public static validate(data: Partial<CommPresenceItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
