export interface CommPresenceMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceMappingValidator {
  public static validate(data: Partial<CommPresenceMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
