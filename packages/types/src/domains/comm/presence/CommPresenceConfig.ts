export interface CommPresenceConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceConfigValidator {
  public static validate(data: Partial<CommPresenceConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
