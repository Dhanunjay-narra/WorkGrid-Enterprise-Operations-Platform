export interface CommPresenceProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommPresenceProfileValidator {
  public static validate(data: Partial<CommPresenceProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
