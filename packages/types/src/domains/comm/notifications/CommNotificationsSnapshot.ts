export interface CommNotificationsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsSnapshotValidator {
  public static validate(data: Partial<CommNotificationsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
