export interface CommNotificationsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsTransactionValidator {
  public static validate(data: Partial<CommNotificationsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
