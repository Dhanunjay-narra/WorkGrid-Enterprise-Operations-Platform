export interface CommNotificationsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsAssignmentValidator {
  public static validate(data: Partial<CommNotificationsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
