export interface CommNotificationsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsEntryValidator {
  public static validate(data: Partial<CommNotificationsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
