export interface CommNotificationsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsNodeValidator {
  public static validate(data: Partial<CommNotificationsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
