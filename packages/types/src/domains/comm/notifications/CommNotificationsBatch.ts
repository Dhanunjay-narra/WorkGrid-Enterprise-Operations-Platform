export interface CommNotificationsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsBatchValidator {
  public static validate(data: Partial<CommNotificationsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
