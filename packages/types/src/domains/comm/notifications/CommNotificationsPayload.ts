export interface CommNotificationsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsPayloadValidator {
  public static validate(data: Partial<CommNotificationsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
