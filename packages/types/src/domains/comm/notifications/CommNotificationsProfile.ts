export interface CommNotificationsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsProfileValidator {
  public static validate(data: Partial<CommNotificationsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
