export interface CommNotificationsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsSessionValidator {
  public static validate(data: Partial<CommNotificationsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
