export interface CommNotificationsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsSummaryValidator {
  public static validate(data: Partial<CommNotificationsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
