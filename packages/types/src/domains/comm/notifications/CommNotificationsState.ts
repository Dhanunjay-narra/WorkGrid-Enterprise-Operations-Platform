export interface CommNotificationsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsStateValidator {
  public static validate(data: Partial<CommNotificationsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
