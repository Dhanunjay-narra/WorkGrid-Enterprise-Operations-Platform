export interface CommNotificationsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsQueueValidator {
  public static validate(data: Partial<CommNotificationsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
