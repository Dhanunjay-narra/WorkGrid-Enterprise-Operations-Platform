export interface CommNotificationsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsMappingValidator {
  public static validate(data: Partial<CommNotificationsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
