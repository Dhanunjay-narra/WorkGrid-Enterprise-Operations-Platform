export interface CommNotificationsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsRecordValidator {
  public static validate(data: Partial<CommNotificationsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
