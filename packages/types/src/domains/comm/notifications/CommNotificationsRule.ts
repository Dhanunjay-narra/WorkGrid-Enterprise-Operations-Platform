export interface CommNotificationsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsRuleValidator {
  public static validate(data: Partial<CommNotificationsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
