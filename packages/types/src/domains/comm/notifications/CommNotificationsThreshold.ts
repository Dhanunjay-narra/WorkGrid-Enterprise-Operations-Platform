export interface CommNotificationsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsThresholdValidator {
  public static validate(data: Partial<CommNotificationsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
