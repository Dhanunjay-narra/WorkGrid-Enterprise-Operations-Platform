export interface CommNotificationsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsConfigValidator {
  public static validate(data: Partial<CommNotificationsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
