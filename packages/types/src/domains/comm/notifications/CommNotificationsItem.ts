export interface CommNotificationsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsItemValidator {
  public static validate(data: Partial<CommNotificationsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
