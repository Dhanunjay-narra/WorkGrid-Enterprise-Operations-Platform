export interface CommNotificationsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsReportValidator {
  public static validate(data: Partial<CommNotificationsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
