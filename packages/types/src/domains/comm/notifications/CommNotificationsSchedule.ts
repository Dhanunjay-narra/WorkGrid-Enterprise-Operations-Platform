export interface CommNotificationsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsScheduleValidator {
  public static validate(data: Partial<CommNotificationsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
