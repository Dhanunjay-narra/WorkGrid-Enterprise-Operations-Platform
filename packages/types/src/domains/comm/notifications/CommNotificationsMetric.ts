export interface CommNotificationsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsMetricValidator {
  public static validate(data: Partial<CommNotificationsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
