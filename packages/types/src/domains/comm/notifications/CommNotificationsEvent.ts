export interface CommNotificationsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsEventValidator {
  public static validate(data: Partial<CommNotificationsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
