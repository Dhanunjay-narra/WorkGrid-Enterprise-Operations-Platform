export interface CommNotificationsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsPolicyValidator {
  public static validate(data: Partial<CommNotificationsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
