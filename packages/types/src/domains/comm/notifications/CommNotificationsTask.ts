export interface CommNotificationsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsTaskValidator {
  public static validate(data: Partial<CommNotificationsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
