export interface CommNotificationsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommNotificationsAuditLogValidator {
  public static validate(data: Partial<CommNotificationsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
