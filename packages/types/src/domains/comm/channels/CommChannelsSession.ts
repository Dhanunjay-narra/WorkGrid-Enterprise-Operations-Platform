export interface CommChannelsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsSessionValidator {
  public static validate(data: Partial<CommChannelsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
