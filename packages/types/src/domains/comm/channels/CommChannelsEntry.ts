export interface CommChannelsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsEntryValidator {
  public static validate(data: Partial<CommChannelsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
