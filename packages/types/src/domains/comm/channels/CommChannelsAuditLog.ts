export interface CommChannelsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsAuditLogValidator {
  public static validate(data: Partial<CommChannelsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
