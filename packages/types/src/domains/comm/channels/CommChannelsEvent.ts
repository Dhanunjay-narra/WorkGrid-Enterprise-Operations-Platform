export interface CommChannelsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsEventValidator {
  public static validate(data: Partial<CommChannelsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
