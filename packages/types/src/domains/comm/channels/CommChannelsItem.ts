export interface CommChannelsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsItemValidator {
  public static validate(data: Partial<CommChannelsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
