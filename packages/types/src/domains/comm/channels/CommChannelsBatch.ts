export interface CommChannelsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsBatchValidator {
  public static validate(data: Partial<CommChannelsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
