export interface CommChannelsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsQueueValidator {
  public static validate(data: Partial<CommChannelsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
