export interface CommChannelsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsReportValidator {
  public static validate(data: Partial<CommChannelsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
