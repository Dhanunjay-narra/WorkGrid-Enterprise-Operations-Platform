export interface CommChannelsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsStateValidator {
  public static validate(data: Partial<CommChannelsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
