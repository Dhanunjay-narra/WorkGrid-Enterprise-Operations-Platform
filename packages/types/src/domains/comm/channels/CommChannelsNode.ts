export interface CommChannelsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsNodeValidator {
  public static validate(data: Partial<CommChannelsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
