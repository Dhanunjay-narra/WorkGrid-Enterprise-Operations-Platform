export interface CommChannelsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsTaskValidator {
  public static validate(data: Partial<CommChannelsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
