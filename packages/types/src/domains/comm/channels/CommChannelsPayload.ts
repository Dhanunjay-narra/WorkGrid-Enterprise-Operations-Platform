export interface CommChannelsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsPayloadValidator {
  public static validate(data: Partial<CommChannelsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
