export interface CommChannelsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsConfigValidator {
  public static validate(data: Partial<CommChannelsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
