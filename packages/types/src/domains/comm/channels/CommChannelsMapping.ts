export interface CommChannelsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsMappingValidator {
  public static validate(data: Partial<CommChannelsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
