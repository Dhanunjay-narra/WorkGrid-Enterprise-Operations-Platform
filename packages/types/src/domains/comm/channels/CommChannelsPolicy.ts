export interface CommChannelsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsPolicyValidator {
  public static validate(data: Partial<CommChannelsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
