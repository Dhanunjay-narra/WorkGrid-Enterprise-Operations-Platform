export interface CommChannelsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsMetricValidator {
  public static validate(data: Partial<CommChannelsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
