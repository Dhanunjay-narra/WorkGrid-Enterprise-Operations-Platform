export interface CommChannelsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsThresholdValidator {
  public static validate(data: Partial<CommChannelsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
