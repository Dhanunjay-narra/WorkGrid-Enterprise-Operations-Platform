export interface CommChannelsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsAssignmentValidator {
  public static validate(data: Partial<CommChannelsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
