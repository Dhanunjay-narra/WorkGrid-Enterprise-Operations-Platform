export interface CommChannelsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsRuleValidator {
  public static validate(data: Partial<CommChannelsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
