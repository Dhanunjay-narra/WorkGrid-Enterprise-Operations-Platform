export interface CommChannelsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsSnapshotValidator {
  public static validate(data: Partial<CommChannelsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
