export interface CommChannelsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsRecordValidator {
  public static validate(data: Partial<CommChannelsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
