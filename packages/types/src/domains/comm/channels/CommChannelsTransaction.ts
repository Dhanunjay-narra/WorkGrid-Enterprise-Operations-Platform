export interface CommChannelsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsTransactionValidator {
  public static validate(data: Partial<CommChannelsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
