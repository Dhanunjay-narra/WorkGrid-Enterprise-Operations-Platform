export interface CommChannelsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsProfileValidator {
  public static validate(data: Partial<CommChannelsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
