export interface CommChannelsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommChannelsSummaryValidator {
  public static validate(data: Partial<CommChannelsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
