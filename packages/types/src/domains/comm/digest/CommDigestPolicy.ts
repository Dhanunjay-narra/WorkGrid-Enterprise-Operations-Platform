export interface CommDigestPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestPolicyValidator {
  public static validate(data: Partial<CommDigestPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
