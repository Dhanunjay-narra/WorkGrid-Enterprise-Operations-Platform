export interface CommDigestStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestStateValidator {
  public static validate(data: Partial<CommDigestStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
