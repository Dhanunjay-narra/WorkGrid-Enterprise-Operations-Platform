export interface CommDigestConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestConfigValidator {
  public static validate(data: Partial<CommDigestConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
