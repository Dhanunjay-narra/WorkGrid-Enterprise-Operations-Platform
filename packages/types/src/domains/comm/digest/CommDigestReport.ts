export interface CommDigestReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestReportValidator {
  public static validate(data: Partial<CommDigestReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
