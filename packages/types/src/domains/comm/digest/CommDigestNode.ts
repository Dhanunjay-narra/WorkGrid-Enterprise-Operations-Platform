export interface CommDigestNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestNodeValidator {
  public static validate(data: Partial<CommDigestNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
