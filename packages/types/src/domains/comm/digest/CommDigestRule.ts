export interface CommDigestRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestRuleValidator {
  public static validate(data: Partial<CommDigestRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
