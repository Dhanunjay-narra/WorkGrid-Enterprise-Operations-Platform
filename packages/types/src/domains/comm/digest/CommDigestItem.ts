export interface CommDigestItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestItemValidator {
  public static validate(data: Partial<CommDigestItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
