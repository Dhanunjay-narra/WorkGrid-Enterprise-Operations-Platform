export interface CommDigestAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestAuditLogValidator {
  public static validate(data: Partial<CommDigestAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
