export interface CommDigestEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestEntryValidator {
  public static validate(data: Partial<CommDigestEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
