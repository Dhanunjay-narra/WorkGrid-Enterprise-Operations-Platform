export interface CommDigestSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestSnapshotValidator {
  public static validate(data: Partial<CommDigestSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
