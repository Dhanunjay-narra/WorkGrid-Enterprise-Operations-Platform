export interface CommDigestAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestAssignmentValidator {
  public static validate(data: Partial<CommDigestAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
