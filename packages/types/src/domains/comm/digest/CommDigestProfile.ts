export interface CommDigestProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestProfileValidator {
  public static validate(data: Partial<CommDigestProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
