export interface CommDigestScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestScheduleValidator {
  public static validate(data: Partial<CommDigestScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
