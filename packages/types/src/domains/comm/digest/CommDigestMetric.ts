export interface CommDigestMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestMetricValidator {
  public static validate(data: Partial<CommDigestMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
