export interface CommDigestEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestEventValidator {
  public static validate(data: Partial<CommDigestEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
