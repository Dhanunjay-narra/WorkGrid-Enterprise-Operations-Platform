export interface CommDigestPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestPayloadValidator {
  public static validate(data: Partial<CommDigestPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
