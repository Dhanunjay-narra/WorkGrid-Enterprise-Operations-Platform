export interface CommDigestBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestBatchValidator {
  public static validate(data: Partial<CommDigestBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
