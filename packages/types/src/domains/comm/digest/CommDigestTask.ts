export interface CommDigestTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestTaskValidator {
  public static validate(data: Partial<CommDigestTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
