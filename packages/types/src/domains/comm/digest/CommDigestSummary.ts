export interface CommDigestSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestSummaryValidator {
  public static validate(data: Partial<CommDigestSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
