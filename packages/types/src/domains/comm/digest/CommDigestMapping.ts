export interface CommDigestMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestMappingValidator {
  public static validate(data: Partial<CommDigestMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
