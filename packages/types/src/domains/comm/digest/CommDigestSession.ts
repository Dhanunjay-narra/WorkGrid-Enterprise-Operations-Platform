export interface CommDigestSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestSessionValidator {
  public static validate(data: Partial<CommDigestSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
