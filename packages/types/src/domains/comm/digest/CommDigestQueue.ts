export interface CommDigestQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestQueueValidator {
  public static validate(data: Partial<CommDigestQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
