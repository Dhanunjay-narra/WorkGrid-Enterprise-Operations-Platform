export interface CommDigestRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestRecordValidator {
  public static validate(data: Partial<CommDigestRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
