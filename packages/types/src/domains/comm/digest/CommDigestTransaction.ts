export interface CommDigestTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommDigestTransactionValidator {
  public static validate(data: Partial<CommDigestTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
