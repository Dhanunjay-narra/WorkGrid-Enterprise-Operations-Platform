export interface CommMessagesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesProfileValidator {
  public static validate(data: Partial<CommMessagesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
