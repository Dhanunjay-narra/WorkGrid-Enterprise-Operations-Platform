export interface CommMessagesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesReportValidator {
  public static validate(data: Partial<CommMessagesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
