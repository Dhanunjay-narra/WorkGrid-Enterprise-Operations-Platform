export interface CommMessagesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesScheduleValidator {
  public static validate(data: Partial<CommMessagesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
