export interface CommMessagesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesStateValidator {
  public static validate(data: Partial<CommMessagesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
