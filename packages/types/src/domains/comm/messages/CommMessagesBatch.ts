export interface CommMessagesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesBatchValidator {
  public static validate(data: Partial<CommMessagesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
