export interface CommMessagesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesSnapshotValidator {
  public static validate(data: Partial<CommMessagesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
