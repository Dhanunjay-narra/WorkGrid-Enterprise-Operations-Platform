export interface CommMessagesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesSessionValidator {
  public static validate(data: Partial<CommMessagesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
