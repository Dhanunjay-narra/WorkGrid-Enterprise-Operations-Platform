export interface CommMessagesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesPolicyValidator {
  public static validate(data: Partial<CommMessagesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
