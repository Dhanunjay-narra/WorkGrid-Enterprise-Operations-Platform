export interface CommMessagesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesNodeValidator {
  public static validate(data: Partial<CommMessagesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
