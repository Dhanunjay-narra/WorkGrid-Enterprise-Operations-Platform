export interface CommMessagesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesRecordValidator {
  public static validate(data: Partial<CommMessagesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
