export interface CommMessagesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesMappingValidator {
  public static validate(data: Partial<CommMessagesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
