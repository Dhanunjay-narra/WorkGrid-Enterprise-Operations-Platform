export interface CommMessagesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesEventValidator {
  public static validate(data: Partial<CommMessagesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
