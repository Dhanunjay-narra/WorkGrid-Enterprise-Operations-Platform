export interface CommMessagesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesQueueValidator {
  public static validate(data: Partial<CommMessagesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
