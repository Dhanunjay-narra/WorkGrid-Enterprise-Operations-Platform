export interface CommMessagesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesAuditLogValidator {
  public static validate(data: Partial<CommMessagesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
