export interface CommMessagesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesAssignmentValidator {
  public static validate(data: Partial<CommMessagesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
