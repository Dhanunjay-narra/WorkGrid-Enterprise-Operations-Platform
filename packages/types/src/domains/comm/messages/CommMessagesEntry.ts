export interface CommMessagesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesEntryValidator {
  public static validate(data: Partial<CommMessagesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
