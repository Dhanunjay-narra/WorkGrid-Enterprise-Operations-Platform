export interface CommMessagesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesConfigValidator {
  public static validate(data: Partial<CommMessagesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
