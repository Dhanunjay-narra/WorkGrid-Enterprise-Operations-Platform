export interface CommMessagesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesTaskValidator {
  public static validate(data: Partial<CommMessagesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
