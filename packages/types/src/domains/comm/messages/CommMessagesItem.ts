export interface CommMessagesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesItemValidator {
  public static validate(data: Partial<CommMessagesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
