export interface CommMessagesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesRuleValidator {
  public static validate(data: Partial<CommMessagesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
