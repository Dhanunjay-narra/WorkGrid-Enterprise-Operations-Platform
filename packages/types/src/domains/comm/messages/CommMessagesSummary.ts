export interface CommMessagesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesSummaryValidator {
  public static validate(data: Partial<CommMessagesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
