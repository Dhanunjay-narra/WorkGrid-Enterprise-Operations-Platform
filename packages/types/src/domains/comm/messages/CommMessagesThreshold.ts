export interface CommMessagesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesThresholdValidator {
  public static validate(data: Partial<CommMessagesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
