export interface CommMessagesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesTransactionValidator {
  public static validate(data: Partial<CommMessagesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
