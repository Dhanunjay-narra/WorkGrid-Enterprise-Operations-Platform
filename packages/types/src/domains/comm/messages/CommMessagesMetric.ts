export interface CommMessagesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesMetricValidator {
  public static validate(data: Partial<CommMessagesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
