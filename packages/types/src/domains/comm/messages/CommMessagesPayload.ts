export interface CommMessagesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommMessagesPayloadValidator {
  public static validate(data: Partial<CommMessagesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
