export interface CommCallsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsConfigValidator {
  public static validate(data: Partial<CommCallsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
