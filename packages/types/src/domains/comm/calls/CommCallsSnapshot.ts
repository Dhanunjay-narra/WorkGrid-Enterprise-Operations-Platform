export interface CommCallsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsSnapshotValidator {
  public static validate(data: Partial<CommCallsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
