export interface CommCallsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsSessionValidator {
  public static validate(data: Partial<CommCallsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
