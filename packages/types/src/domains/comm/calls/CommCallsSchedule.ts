export interface CommCallsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsScheduleValidator {
  public static validate(data: Partial<CommCallsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
