export interface CommCallsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsEntryValidator {
  public static validate(data: Partial<CommCallsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
