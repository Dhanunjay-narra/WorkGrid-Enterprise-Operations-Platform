export interface CommCallsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsProfileValidator {
  public static validate(data: Partial<CommCallsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
