export interface CommCallsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsMetricValidator {
  public static validate(data: Partial<CommCallsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
