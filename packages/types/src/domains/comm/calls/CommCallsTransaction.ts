export interface CommCallsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsTransactionValidator {
  public static validate(data: Partial<CommCallsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
