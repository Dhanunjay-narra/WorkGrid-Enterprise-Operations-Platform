export interface CommCallsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsAuditLogValidator {
  public static validate(data: Partial<CommCallsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
