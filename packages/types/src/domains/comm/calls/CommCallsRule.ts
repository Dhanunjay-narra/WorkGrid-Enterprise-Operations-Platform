export interface CommCallsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsRuleValidator {
  public static validate(data: Partial<CommCallsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
