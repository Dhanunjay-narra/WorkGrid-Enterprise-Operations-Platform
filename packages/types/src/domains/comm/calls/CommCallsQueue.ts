export interface CommCallsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsQueueValidator {
  public static validate(data: Partial<CommCallsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
