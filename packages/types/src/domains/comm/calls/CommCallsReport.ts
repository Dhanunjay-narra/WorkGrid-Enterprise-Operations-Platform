export interface CommCallsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsReportValidator {
  public static validate(data: Partial<CommCallsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
