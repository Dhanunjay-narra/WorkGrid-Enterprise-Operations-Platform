export interface CommCallsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsPolicyValidator {
  public static validate(data: Partial<CommCallsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
