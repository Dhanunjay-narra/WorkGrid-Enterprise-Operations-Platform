export interface CommCallsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsItemValidator {
  public static validate(data: Partial<CommCallsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
