export interface CommCallsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsSummaryValidator {
  public static validate(data: Partial<CommCallsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
