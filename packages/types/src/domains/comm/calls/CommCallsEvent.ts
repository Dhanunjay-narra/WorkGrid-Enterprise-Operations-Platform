export interface CommCallsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsEventValidator {
  public static validate(data: Partial<CommCallsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
