export interface CommCallsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsTaskValidator {
  public static validate(data: Partial<CommCallsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
