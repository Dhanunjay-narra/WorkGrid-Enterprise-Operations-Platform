export interface CommCallsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsNodeValidator {
  public static validate(data: Partial<CommCallsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
