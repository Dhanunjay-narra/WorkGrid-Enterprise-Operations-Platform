export interface CommCallsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsThresholdValidator {
  public static validate(data: Partial<CommCallsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
