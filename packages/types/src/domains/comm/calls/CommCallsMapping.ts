export interface CommCallsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsMappingValidator {
  public static validate(data: Partial<CommCallsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
