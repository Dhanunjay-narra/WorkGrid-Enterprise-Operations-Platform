export interface CommCallsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsPayloadValidator {
  public static validate(data: Partial<CommCallsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
