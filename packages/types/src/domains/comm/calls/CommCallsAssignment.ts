export interface CommCallsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsAssignmentValidator {
  public static validate(data: Partial<CommCallsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
