export interface CommCallsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsStateValidator {
  public static validate(data: Partial<CommCallsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
