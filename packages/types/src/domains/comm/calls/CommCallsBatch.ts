export interface CommCallsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsBatchValidator {
  public static validate(data: Partial<CommCallsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
