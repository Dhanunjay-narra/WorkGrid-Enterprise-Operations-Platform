export interface CommCallsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommCallsRecordValidator {
  public static validate(data: Partial<CommCallsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
