export interface CommWebhooksSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksSnapshotValidator {
  public static validate(data: Partial<CommWebhooksSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
