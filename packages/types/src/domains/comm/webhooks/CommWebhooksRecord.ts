export interface CommWebhooksRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksRecordValidator {
  public static validate(data: Partial<CommWebhooksRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
