export interface CommWebhooksConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksConfigValidator {
  public static validate(data: Partial<CommWebhooksConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
