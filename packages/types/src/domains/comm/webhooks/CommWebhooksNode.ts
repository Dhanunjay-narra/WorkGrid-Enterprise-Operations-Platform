export interface CommWebhooksNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksNodeValidator {
  public static validate(data: Partial<CommWebhooksNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
