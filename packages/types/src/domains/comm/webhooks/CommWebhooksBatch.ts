export interface CommWebhooksBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksBatchValidator {
  public static validate(data: Partial<CommWebhooksBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
