export interface CommWebhooksItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksItemValidator {
  public static validate(data: Partial<CommWebhooksItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
