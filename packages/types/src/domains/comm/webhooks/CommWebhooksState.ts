export interface CommWebhooksStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksStateValidator {
  public static validate(data: Partial<CommWebhooksStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
