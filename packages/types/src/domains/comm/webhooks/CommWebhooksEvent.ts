export interface CommWebhooksEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksEventValidator {
  public static validate(data: Partial<CommWebhooksEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
