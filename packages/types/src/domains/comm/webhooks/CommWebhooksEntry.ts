export interface CommWebhooksEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksEntryValidator {
  public static validate(data: Partial<CommWebhooksEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
