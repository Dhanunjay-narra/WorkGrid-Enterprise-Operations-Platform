export interface CommWebhooksPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksPayloadValidator {
  public static validate(data: Partial<CommWebhooksPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
