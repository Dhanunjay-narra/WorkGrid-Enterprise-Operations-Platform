export interface CommWebhooksTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksTransactionValidator {
  public static validate(data: Partial<CommWebhooksTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
