export interface CommWebhooksAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksAuditLogValidator {
  public static validate(data: Partial<CommWebhooksAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
