export interface CommWebhooksAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksAssignmentValidator {
  public static validate(data: Partial<CommWebhooksAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
