export interface CommWebhooksMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksMappingValidator {
  public static validate(data: Partial<CommWebhooksMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
