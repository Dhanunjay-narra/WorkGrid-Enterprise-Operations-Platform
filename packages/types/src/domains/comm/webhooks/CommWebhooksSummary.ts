export interface CommWebhooksSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksSummaryValidator {
  public static validate(data: Partial<CommWebhooksSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
