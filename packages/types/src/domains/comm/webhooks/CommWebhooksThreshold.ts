export interface CommWebhooksThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksThresholdValidator {
  public static validate(data: Partial<CommWebhooksThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
