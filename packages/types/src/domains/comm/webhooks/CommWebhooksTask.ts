export interface CommWebhooksTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksTaskValidator {
  public static validate(data: Partial<CommWebhooksTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
