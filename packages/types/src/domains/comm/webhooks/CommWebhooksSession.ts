export interface CommWebhooksSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksSessionValidator {
  public static validate(data: Partial<CommWebhooksSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
