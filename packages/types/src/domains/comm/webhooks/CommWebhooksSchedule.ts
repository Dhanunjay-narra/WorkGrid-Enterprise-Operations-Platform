export interface CommWebhooksScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksScheduleValidator {
  public static validate(data: Partial<CommWebhooksScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
