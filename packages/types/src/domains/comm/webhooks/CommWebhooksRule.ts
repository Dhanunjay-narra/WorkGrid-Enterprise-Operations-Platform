export interface CommWebhooksRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksRuleValidator {
  public static validate(data: Partial<CommWebhooksRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
