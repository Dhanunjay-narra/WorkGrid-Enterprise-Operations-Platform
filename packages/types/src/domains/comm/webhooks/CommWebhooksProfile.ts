export interface CommWebhooksProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksProfileValidator {
  public static validate(data: Partial<CommWebhooksProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
