export interface CommWebhooksMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksMetricValidator {
  public static validate(data: Partial<CommWebhooksMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
