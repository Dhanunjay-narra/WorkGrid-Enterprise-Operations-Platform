export interface CommWebhooksQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksQueueValidator {
  public static validate(data: Partial<CommWebhooksQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
