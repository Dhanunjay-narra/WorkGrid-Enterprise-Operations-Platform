export interface CommWebhooksReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksReportValidator {
  public static validate(data: Partial<CommWebhooksReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
