export interface CommWebhooksPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CommWebhooksPolicyValidator {
  public static validate(data: Partial<CommWebhooksPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
