export interface AbacScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AbacScheduleValidator {
  public static validate(data: Partial<AbacScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
