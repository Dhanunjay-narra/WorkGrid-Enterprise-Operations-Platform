export interface AbacAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AbacAssignmentValidator {
  public static validate(data: Partial<AbacAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
