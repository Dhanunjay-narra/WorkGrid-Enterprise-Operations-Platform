export interface AbacTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AbacTransactionValidator {
  public static validate(data: Partial<AbacTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
