export interface AbacThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AbacThresholdValidator {
  public static validate(data: Partial<AbacThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
