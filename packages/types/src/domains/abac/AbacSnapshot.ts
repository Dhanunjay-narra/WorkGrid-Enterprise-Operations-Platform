export interface AbacSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AbacSnapshotValidator {
  public static validate(data: Partial<AbacSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
