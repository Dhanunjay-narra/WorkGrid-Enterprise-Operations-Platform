export interface AbacAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AbacAuditLogValidator {
  public static validate(data: Partial<AbacAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
