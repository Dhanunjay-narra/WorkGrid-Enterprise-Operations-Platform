export interface InventoryTransfersReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersReportValidator {
  public static validate(data: Partial<InventoryTransfersReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
