export interface InventoryTransfersTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersTransactionValidator {
  public static validate(data: Partial<InventoryTransfersTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
