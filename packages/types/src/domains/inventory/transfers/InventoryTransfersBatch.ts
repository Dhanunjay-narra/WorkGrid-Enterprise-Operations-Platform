export interface InventoryTransfersBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersBatchValidator {
  public static validate(data: Partial<InventoryTransfersBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
