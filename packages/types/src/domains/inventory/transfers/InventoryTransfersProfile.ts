export interface InventoryTransfersProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersProfileValidator {
  public static validate(data: Partial<InventoryTransfersProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
