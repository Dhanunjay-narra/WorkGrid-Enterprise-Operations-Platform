export interface InventoryTransfersAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersAuditLogValidator {
  public static validate(data: Partial<InventoryTransfersAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
