export interface InventoryTransfersItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersItemValidator {
  public static validate(data: Partial<InventoryTransfersItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
