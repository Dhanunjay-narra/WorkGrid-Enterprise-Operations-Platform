export interface InventoryTransfersRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersRuleValidator {
  public static validate(data: Partial<InventoryTransfersRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
