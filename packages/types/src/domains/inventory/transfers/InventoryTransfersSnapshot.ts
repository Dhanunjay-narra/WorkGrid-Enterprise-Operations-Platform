export interface InventoryTransfersSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersSnapshotValidator {
  public static validate(data: Partial<InventoryTransfersSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
