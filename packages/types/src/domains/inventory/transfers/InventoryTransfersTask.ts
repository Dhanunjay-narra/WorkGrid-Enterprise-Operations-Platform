export interface InventoryTransfersTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersTaskValidator {
  public static validate(data: Partial<InventoryTransfersTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
