export interface InventoryTransfersStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersStateValidator {
  public static validate(data: Partial<InventoryTransfersStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
