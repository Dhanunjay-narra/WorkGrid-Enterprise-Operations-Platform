export interface InventoryTransfersPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersPolicyValidator {
  public static validate(data: Partial<InventoryTransfersPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
