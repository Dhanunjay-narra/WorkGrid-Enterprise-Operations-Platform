export interface InventoryTransfersQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersQueueValidator {
  public static validate(data: Partial<InventoryTransfersQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
