export interface InventoryTransfersConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersConfigValidator {
  public static validate(data: Partial<InventoryTransfersConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
