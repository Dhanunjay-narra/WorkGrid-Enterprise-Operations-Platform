export interface InventoryTransfersSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersSummaryValidator {
  public static validate(data: Partial<InventoryTransfersSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
