export interface InventoryTransfersNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersNodeValidator {
  public static validate(data: Partial<InventoryTransfersNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
