export interface InventoryTransfersScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersScheduleValidator {
  public static validate(data: Partial<InventoryTransfersScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
