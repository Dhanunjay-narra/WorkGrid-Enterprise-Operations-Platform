export interface InventoryTransfersThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersThresholdValidator {
  public static validate(data: Partial<InventoryTransfersThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
