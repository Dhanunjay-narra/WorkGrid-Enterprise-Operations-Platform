export interface InventoryTransfersSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersSessionValidator {
  public static validate(data: Partial<InventoryTransfersSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
