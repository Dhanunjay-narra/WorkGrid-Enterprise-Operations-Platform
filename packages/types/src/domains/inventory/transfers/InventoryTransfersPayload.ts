export interface InventoryTransfersPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersPayloadValidator {
  public static validate(data: Partial<InventoryTransfersPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
