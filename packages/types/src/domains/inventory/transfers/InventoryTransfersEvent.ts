export interface InventoryTransfersEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersEventValidator {
  public static validate(data: Partial<InventoryTransfersEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
