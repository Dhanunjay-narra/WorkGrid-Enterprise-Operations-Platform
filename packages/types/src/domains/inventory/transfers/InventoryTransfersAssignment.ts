export interface InventoryTransfersAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersAssignmentValidator {
  public static validate(data: Partial<InventoryTransfersAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
