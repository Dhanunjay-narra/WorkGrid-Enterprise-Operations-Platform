export interface InventoryTransfersEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersEntryValidator {
  public static validate(data: Partial<InventoryTransfersEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
