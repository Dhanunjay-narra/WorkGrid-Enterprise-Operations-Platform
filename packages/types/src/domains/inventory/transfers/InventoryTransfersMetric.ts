export interface InventoryTransfersMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersMetricValidator {
  public static validate(data: Partial<InventoryTransfersMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
