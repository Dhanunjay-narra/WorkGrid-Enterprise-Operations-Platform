export interface InventoryTransfersMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersMappingValidator {
  public static validate(data: Partial<InventoryTransfersMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
