export interface InventoryTransfersRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryTransfersRecordValidator {
  public static validate(data: Partial<InventoryTransfersRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
