export interface InventorySuppliersSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersSnapshotValidator {
  public static validate(data: Partial<InventorySuppliersSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
