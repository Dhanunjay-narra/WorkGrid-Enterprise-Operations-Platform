export interface InventorySuppliersMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersMetricValidator {
  public static validate(data: Partial<InventorySuppliersMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
