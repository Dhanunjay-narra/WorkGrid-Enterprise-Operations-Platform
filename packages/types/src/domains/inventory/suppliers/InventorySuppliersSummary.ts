export interface InventorySuppliersSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersSummaryValidator {
  public static validate(data: Partial<InventorySuppliersSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
