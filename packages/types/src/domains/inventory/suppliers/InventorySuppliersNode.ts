export interface InventorySuppliersNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersNodeValidator {
  public static validate(data: Partial<InventorySuppliersNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
