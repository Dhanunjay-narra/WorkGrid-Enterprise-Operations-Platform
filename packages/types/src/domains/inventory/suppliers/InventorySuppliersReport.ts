export interface InventorySuppliersReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersReportValidator {
  public static validate(data: Partial<InventorySuppliersReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
