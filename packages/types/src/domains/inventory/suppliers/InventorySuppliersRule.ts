export interface InventorySuppliersRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersRuleValidator {
  public static validate(data: Partial<InventorySuppliersRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
