export interface InventorySuppliersSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersSessionValidator {
  public static validate(data: Partial<InventorySuppliersSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
