export interface InventorySuppliersAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersAssignmentValidator {
  public static validate(data: Partial<InventorySuppliersAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
