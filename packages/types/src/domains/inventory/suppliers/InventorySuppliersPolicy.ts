export interface InventorySuppliersPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersPolicyValidator {
  public static validate(data: Partial<InventorySuppliersPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
