export interface InventorySuppliersScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersScheduleValidator {
  public static validate(data: Partial<InventorySuppliersScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
