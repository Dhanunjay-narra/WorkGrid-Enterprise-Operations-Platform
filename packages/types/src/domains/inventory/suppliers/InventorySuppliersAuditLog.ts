export interface InventorySuppliersAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersAuditLogValidator {
  public static validate(data: Partial<InventorySuppliersAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
