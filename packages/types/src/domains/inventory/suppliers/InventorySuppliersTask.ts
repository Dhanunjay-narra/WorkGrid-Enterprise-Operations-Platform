export interface InventorySuppliersTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersTaskValidator {
  public static validate(data: Partial<InventorySuppliersTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
