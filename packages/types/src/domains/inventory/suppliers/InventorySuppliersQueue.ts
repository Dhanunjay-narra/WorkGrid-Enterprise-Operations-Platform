export interface InventorySuppliersQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersQueueValidator {
  public static validate(data: Partial<InventorySuppliersQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
