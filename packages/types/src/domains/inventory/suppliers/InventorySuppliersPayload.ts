export interface InventorySuppliersPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersPayloadValidator {
  public static validate(data: Partial<InventorySuppliersPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
