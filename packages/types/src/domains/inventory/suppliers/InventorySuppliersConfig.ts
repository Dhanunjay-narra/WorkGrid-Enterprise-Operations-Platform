export interface InventorySuppliersConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersConfigValidator {
  public static validate(data: Partial<InventorySuppliersConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
