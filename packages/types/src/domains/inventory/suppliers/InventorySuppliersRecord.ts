export interface InventorySuppliersRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersRecordValidator {
  public static validate(data: Partial<InventorySuppliersRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
