export interface InventorySuppliersBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersBatchValidator {
  public static validate(data: Partial<InventorySuppliersBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
