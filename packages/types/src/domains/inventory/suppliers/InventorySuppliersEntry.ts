export interface InventorySuppliersEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersEntryValidator {
  public static validate(data: Partial<InventorySuppliersEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
