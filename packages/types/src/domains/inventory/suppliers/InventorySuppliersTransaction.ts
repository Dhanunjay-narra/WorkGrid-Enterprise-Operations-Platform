export interface InventorySuppliersTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersTransactionValidator {
  public static validate(data: Partial<InventorySuppliersTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
