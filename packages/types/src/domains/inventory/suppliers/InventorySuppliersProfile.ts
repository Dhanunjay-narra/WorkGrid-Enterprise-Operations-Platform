export interface InventorySuppliersProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersProfileValidator {
  public static validate(data: Partial<InventorySuppliersProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
