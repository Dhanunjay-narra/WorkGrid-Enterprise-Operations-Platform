export interface InventorySuppliersStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersStateValidator {
  public static validate(data: Partial<InventorySuppliersStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
