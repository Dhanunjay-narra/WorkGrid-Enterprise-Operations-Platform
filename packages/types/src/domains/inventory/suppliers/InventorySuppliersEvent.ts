export interface InventorySuppliersEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersEventValidator {
  public static validate(data: Partial<InventorySuppliersEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
