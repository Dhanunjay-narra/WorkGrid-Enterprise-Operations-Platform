export interface InventorySuppliersItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersItemValidator {
  public static validate(data: Partial<InventorySuppliersItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
