export interface InventorySuppliersThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySuppliersThresholdValidator {
  public static validate(data: Partial<InventorySuppliersThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
