export interface InventoryReorderMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderMetricValidator {
  public static validate(data: Partial<InventoryReorderMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
