export interface InventoryReorderItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderItemValidator {
  public static validate(data: Partial<InventoryReorderItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
