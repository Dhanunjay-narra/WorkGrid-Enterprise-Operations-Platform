export interface InventoryReorderSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderSummaryValidator {
  public static validate(data: Partial<InventoryReorderSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
