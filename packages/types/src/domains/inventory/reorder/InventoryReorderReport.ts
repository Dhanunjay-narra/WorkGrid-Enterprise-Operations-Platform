export interface InventoryReorderReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderReportValidator {
  public static validate(data: Partial<InventoryReorderReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
