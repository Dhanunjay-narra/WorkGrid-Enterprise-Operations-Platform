export interface InventoryReorderPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderPolicyValidator {
  public static validate(data: Partial<InventoryReorderPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
