export interface InventoryReorderPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderPayloadValidator {
  public static validate(data: Partial<InventoryReorderPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
