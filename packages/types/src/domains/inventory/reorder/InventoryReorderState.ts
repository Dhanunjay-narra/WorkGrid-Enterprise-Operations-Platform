export interface InventoryReorderStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderStateValidator {
  public static validate(data: Partial<InventoryReorderStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
