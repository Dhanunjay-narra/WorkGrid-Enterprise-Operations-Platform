export interface InventoryReorderAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderAssignmentValidator {
  public static validate(data: Partial<InventoryReorderAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
