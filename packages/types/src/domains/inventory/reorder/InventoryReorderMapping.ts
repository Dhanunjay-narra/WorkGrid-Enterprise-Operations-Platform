export interface InventoryReorderMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderMappingValidator {
  public static validate(data: Partial<InventoryReorderMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
