export interface InventoryReorderTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderTaskValidator {
  public static validate(data: Partial<InventoryReorderTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
