export interface InventoryReorderRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderRecordValidator {
  public static validate(data: Partial<InventoryReorderRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
