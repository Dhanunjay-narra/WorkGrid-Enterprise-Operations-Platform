export interface InventoryReorderEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderEntryValidator {
  public static validate(data: Partial<InventoryReorderEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
