export interface InventoryReorderThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderThresholdValidator {
  public static validate(data: Partial<InventoryReorderThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
