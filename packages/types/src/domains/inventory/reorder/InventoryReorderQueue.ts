export interface InventoryReorderQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderQueueValidator {
  public static validate(data: Partial<InventoryReorderQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
