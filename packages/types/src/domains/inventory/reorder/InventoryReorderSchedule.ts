export interface InventoryReorderScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderScheduleValidator {
  public static validate(data: Partial<InventoryReorderScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
