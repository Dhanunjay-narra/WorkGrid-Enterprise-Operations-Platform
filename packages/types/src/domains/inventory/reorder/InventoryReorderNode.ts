export interface InventoryReorderNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderNodeValidator {
  public static validate(data: Partial<InventoryReorderNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
