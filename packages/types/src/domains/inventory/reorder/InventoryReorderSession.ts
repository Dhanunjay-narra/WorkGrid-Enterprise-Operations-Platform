export interface InventoryReorderSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderSessionValidator {
  public static validate(data: Partial<InventoryReorderSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
