export interface InventoryReorderConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderConfigValidator {
  public static validate(data: Partial<InventoryReorderConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
