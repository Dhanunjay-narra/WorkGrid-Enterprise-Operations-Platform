export interface InventoryReorderBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderBatchValidator {
  public static validate(data: Partial<InventoryReorderBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
