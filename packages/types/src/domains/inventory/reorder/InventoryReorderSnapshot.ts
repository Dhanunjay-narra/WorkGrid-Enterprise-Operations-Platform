export interface InventoryReorderSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderSnapshotValidator {
  public static validate(data: Partial<InventoryReorderSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
