export interface InventoryReorderProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderProfileValidator {
  public static validate(data: Partial<InventoryReorderProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
