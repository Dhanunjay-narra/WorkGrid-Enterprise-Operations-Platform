export interface InventoryReorderEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderEventValidator {
  public static validate(data: Partial<InventoryReorderEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
