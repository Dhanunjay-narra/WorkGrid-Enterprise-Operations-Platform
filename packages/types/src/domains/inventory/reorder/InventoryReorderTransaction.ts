export interface InventoryReorderTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderTransactionValidator {
  public static validate(data: Partial<InventoryReorderTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
