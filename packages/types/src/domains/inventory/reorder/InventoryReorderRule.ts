export interface InventoryReorderRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryReorderRuleValidator {
  public static validate(data: Partial<InventoryReorderRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
