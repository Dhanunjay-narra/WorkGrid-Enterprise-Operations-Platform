export interface InventoryBatchesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesSnapshotValidator {
  public static validate(data: Partial<InventoryBatchesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
