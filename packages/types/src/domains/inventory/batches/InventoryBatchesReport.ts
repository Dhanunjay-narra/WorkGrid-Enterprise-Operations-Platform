export interface InventoryBatchesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesReportValidator {
  public static validate(data: Partial<InventoryBatchesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
