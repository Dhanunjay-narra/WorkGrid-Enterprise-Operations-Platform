export interface InventoryBatchesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesThresholdValidator {
  public static validate(data: Partial<InventoryBatchesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
