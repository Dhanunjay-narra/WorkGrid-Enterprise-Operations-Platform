export interface InventoryBatchesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesSummaryValidator {
  public static validate(data: Partial<InventoryBatchesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
