export interface InventoryBatchesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesConfigValidator {
  public static validate(data: Partial<InventoryBatchesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
