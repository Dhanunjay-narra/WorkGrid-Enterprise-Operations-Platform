export interface InventoryBatchesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesSessionValidator {
  public static validate(data: Partial<InventoryBatchesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
