export interface InventoryBatchesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesProfileValidator {
  public static validate(data: Partial<InventoryBatchesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
