export interface InventoryBatchesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesItemValidator {
  public static validate(data: Partial<InventoryBatchesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
