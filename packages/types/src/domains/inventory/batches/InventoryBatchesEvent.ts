export interface InventoryBatchesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesEventValidator {
  public static validate(data: Partial<InventoryBatchesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
