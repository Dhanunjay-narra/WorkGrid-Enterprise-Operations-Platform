export interface InventoryBatchesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesTaskValidator {
  public static validate(data: Partial<InventoryBatchesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
