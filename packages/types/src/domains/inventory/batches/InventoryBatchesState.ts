export interface InventoryBatchesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesStateValidator {
  public static validate(data: Partial<InventoryBatchesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
