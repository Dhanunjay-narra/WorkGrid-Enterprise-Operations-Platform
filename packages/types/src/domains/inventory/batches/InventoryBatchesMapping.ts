export interface InventoryBatchesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesMappingValidator {
  public static validate(data: Partial<InventoryBatchesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
