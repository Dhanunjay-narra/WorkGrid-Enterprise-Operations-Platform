export interface InventoryBatchesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesNodeValidator {
  public static validate(data: Partial<InventoryBatchesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
