export interface InventoryBatchesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesAssignmentValidator {
  public static validate(data: Partial<InventoryBatchesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
