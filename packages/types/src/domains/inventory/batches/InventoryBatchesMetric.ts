export interface InventoryBatchesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesMetricValidator {
  public static validate(data: Partial<InventoryBatchesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
