export interface InventoryBatchesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesScheduleValidator {
  public static validate(data: Partial<InventoryBatchesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
