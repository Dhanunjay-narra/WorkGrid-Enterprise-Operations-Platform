export interface InventoryBatchesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesRecordValidator {
  public static validate(data: Partial<InventoryBatchesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
