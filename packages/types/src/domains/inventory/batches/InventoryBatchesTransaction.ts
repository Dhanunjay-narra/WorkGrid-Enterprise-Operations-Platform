export interface InventoryBatchesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesTransactionValidator {
  public static validate(data: Partial<InventoryBatchesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
