export interface InventoryBatchesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesQueueValidator {
  public static validate(data: Partial<InventoryBatchesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
