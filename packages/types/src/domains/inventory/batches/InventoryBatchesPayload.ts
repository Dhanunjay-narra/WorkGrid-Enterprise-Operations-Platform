export interface InventoryBatchesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesPayloadValidator {
  public static validate(data: Partial<InventoryBatchesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
