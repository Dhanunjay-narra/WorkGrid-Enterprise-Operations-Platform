export interface InventoryBatchesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesRuleValidator {
  public static validate(data: Partial<InventoryBatchesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
