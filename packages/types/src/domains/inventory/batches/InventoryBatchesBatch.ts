export interface InventoryBatchesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesBatchValidator {
  public static validate(data: Partial<InventoryBatchesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
