export interface InventoryBatchesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesAuditLogValidator {
  public static validate(data: Partial<InventoryBatchesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
