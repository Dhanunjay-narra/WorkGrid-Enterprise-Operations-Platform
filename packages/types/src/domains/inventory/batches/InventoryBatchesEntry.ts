export interface InventoryBatchesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesEntryValidator {
  public static validate(data: Partial<InventoryBatchesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
