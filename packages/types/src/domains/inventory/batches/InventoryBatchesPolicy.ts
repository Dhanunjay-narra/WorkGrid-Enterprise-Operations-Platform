export interface InventoryBatchesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryBatchesPolicyValidator {
  public static validate(data: Partial<InventoryBatchesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
