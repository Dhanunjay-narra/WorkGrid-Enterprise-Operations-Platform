export interface InventoryWarehouseItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseItemValidator {
  public static validate(data: Partial<InventoryWarehouseItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
