export interface InventoryWarehouseConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseConfigValidator {
  public static validate(data: Partial<InventoryWarehouseConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
