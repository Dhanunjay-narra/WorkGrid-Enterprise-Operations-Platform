export interface InventoryWarehousePolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehousePolicyValidator {
  public static validate(data: Partial<InventoryWarehousePolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
