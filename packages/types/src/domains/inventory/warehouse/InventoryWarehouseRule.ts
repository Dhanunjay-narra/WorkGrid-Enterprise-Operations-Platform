export interface InventoryWarehouseRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseRuleValidator {
  public static validate(data: Partial<InventoryWarehouseRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
