export interface InventoryWarehouseTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseTransactionValidator {
  public static validate(data: Partial<InventoryWarehouseTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
