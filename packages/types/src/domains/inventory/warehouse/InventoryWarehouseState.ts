export interface InventoryWarehouseStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseStateValidator {
  public static validate(data: Partial<InventoryWarehouseStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
