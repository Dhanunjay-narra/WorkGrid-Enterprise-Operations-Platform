export interface InventoryWarehouseAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseAssignmentValidator {
  public static validate(data: Partial<InventoryWarehouseAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
