export interface InventoryWarehouseMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseMetricValidator {
  public static validate(data: Partial<InventoryWarehouseMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
