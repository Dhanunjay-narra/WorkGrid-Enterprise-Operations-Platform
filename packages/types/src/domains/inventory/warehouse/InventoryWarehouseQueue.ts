export interface InventoryWarehouseQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseQueueValidator {
  public static validate(data: Partial<InventoryWarehouseQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
