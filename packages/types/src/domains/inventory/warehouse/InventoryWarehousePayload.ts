export interface InventoryWarehousePayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehousePayloadValidator {
  public static validate(data: Partial<InventoryWarehousePayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
