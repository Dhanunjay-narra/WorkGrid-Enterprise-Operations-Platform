export interface InventoryWarehouseScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseScheduleValidator {
  public static validate(data: Partial<InventoryWarehouseScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
