export interface InventoryWarehouseAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseAuditLogValidator {
  public static validate(data: Partial<InventoryWarehouseAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
