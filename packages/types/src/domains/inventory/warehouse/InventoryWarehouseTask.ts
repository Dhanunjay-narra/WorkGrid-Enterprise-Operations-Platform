export interface InventoryWarehouseTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseTaskValidator {
  public static validate(data: Partial<InventoryWarehouseTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
