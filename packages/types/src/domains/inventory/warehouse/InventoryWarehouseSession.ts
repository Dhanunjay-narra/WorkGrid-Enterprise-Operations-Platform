export interface InventoryWarehouseSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseSessionValidator {
  public static validate(data: Partial<InventoryWarehouseSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
