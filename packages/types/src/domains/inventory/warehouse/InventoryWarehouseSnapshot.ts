export interface InventoryWarehouseSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseSnapshotValidator {
  public static validate(data: Partial<InventoryWarehouseSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
