export interface InventoryWarehouseEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseEntryValidator {
  public static validate(data: Partial<InventoryWarehouseEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
