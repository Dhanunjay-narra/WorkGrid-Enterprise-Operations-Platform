export interface InventoryWarehouseNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseNodeValidator {
  public static validate(data: Partial<InventoryWarehouseNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
