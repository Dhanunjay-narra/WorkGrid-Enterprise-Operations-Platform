export interface InventoryWarehouseMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseMappingValidator {
  public static validate(data: Partial<InventoryWarehouseMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
