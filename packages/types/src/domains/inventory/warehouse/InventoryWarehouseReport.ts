export interface InventoryWarehouseReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseReportValidator {
  public static validate(data: Partial<InventoryWarehouseReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
