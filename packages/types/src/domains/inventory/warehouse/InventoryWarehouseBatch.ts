export interface InventoryWarehouseBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseBatchValidator {
  public static validate(data: Partial<InventoryWarehouseBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
