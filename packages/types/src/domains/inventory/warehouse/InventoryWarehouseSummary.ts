export interface InventoryWarehouseSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseSummaryValidator {
  public static validate(data: Partial<InventoryWarehouseSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
