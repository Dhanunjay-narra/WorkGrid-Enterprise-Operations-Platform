export interface InventoryWarehouseRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseRecordValidator {
  public static validate(data: Partial<InventoryWarehouseRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
