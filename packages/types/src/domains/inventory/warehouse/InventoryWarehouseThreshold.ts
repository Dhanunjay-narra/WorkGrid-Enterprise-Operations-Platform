export interface InventoryWarehouseThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseThresholdValidator {
  public static validate(data: Partial<InventoryWarehouseThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
