export interface InventoryWarehouseProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryWarehouseProfileValidator {
  public static validate(data: Partial<InventoryWarehouseProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
