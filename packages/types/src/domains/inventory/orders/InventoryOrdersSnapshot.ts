export interface InventoryOrdersSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersSnapshotValidator {
  public static validate(data: Partial<InventoryOrdersSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
