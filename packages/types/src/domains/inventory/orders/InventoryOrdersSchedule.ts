export interface InventoryOrdersScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersScheduleValidator {
  public static validate(data: Partial<InventoryOrdersScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
