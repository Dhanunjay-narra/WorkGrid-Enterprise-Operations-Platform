export interface InventoryOrdersQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersQueueValidator {
  public static validate(data: Partial<InventoryOrdersQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
