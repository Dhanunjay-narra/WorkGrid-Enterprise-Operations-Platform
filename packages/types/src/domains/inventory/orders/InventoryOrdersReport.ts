export interface InventoryOrdersReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersReportValidator {
  public static validate(data: Partial<InventoryOrdersReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
