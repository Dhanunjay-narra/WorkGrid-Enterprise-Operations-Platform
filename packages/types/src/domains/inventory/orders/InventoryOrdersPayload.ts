export interface InventoryOrdersPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersPayloadValidator {
  public static validate(data: Partial<InventoryOrdersPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
