export interface InventoryOrdersAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersAssignmentValidator {
  public static validate(data: Partial<InventoryOrdersAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
