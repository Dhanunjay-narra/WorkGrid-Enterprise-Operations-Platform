export interface InventoryOrdersNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersNodeValidator {
  public static validate(data: Partial<InventoryOrdersNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
