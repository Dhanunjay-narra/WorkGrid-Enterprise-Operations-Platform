export interface InventoryOrdersEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersEventValidator {
  public static validate(data: Partial<InventoryOrdersEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
