export interface InventoryOrdersProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersProfileValidator {
  public static validate(data: Partial<InventoryOrdersProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
