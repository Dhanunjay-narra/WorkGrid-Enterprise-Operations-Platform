export interface InventoryOrdersSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersSessionValidator {
  public static validate(data: Partial<InventoryOrdersSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
