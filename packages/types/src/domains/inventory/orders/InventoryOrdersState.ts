export interface InventoryOrdersStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersStateValidator {
  public static validate(data: Partial<InventoryOrdersStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
