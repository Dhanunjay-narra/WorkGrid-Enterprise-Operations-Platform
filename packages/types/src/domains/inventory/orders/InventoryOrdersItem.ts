export interface InventoryOrdersItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersItemValidator {
  public static validate(data: Partial<InventoryOrdersItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
