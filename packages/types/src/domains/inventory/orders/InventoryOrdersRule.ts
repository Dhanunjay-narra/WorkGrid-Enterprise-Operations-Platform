export interface InventoryOrdersRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersRuleValidator {
  public static validate(data: Partial<InventoryOrdersRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
