export interface InventoryOrdersRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersRecordValidator {
  public static validate(data: Partial<InventoryOrdersRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
