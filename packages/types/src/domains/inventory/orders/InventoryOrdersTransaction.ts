export interface InventoryOrdersTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersTransactionValidator {
  public static validate(data: Partial<InventoryOrdersTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
