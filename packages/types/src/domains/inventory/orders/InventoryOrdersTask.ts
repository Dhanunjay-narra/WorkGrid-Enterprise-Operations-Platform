export interface InventoryOrdersTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersTaskValidator {
  public static validate(data: Partial<InventoryOrdersTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
