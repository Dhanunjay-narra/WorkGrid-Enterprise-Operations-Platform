export interface InventoryOrdersMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersMetricValidator {
  public static validate(data: Partial<InventoryOrdersMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
