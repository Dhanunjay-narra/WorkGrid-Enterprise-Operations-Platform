export interface InventoryOrdersSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersSummaryValidator {
  public static validate(data: Partial<InventoryOrdersSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
