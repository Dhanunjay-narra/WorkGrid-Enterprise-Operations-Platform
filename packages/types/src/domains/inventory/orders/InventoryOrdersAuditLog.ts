export interface InventoryOrdersAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersAuditLogValidator {
  public static validate(data: Partial<InventoryOrdersAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
