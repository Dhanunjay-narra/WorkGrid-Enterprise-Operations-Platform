export interface InventoryOrdersEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersEntryValidator {
  public static validate(data: Partial<InventoryOrdersEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
