export interface InventoryOrdersPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersPolicyValidator {
  public static validate(data: Partial<InventoryOrdersPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
