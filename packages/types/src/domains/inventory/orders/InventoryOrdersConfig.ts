export interface InventoryOrdersConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersConfigValidator {
  public static validate(data: Partial<InventoryOrdersConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
