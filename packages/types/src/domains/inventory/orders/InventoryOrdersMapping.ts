export interface InventoryOrdersMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersMappingValidator {
  public static validate(data: Partial<InventoryOrdersMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
