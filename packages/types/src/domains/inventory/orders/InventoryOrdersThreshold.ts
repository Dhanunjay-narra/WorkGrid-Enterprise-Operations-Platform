export interface InventoryOrdersThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersThresholdValidator {
  public static validate(data: Partial<InventoryOrdersThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
