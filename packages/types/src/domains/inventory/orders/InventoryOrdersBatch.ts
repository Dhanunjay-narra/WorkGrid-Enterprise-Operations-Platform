export interface InventoryOrdersBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryOrdersBatchValidator {
  public static validate(data: Partial<InventoryOrdersBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
