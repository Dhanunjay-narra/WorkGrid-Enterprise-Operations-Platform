export interface InventorySkuRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuRuleValidator {
  public static validate(data: Partial<InventorySkuRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
