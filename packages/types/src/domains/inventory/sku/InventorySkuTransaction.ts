export interface InventorySkuTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuTransactionValidator {
  public static validate(data: Partial<InventorySkuTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
