export interface InventorySkuScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuScheduleValidator {
  public static validate(data: Partial<InventorySkuScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
