export interface InventorySkuStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuStateValidator {
  public static validate(data: Partial<InventorySkuStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
