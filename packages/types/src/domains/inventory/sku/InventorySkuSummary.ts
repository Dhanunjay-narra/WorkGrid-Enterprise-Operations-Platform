export interface InventorySkuSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuSummaryValidator {
  public static validate(data: Partial<InventorySkuSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
