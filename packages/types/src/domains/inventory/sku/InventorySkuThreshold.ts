export interface InventorySkuThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuThresholdValidator {
  public static validate(data: Partial<InventorySkuThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
