export interface InventorySkuReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuReportValidator {
  public static validate(data: Partial<InventorySkuReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
