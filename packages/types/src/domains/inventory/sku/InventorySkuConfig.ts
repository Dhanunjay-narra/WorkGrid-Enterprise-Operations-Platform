export interface InventorySkuConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuConfigValidator {
  public static validate(data: Partial<InventorySkuConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
