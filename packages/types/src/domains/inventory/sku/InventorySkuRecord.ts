export interface InventorySkuRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuRecordValidator {
  public static validate(data: Partial<InventorySkuRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
