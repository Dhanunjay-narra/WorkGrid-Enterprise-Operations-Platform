export interface InventorySkuEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuEntryValidator {
  public static validate(data: Partial<InventorySkuEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
