export interface InventorySkuBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuBatchValidator {
  public static validate(data: Partial<InventorySkuBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
