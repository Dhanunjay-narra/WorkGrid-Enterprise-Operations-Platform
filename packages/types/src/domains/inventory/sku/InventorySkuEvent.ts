export interface InventorySkuEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuEventValidator {
  public static validate(data: Partial<InventorySkuEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
