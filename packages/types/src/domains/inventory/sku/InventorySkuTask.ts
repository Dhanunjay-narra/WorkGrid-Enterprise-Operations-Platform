export interface InventorySkuTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuTaskValidator {
  public static validate(data: Partial<InventorySkuTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
