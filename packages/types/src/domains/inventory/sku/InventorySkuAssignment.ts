export interface InventorySkuAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuAssignmentValidator {
  public static validate(data: Partial<InventorySkuAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
