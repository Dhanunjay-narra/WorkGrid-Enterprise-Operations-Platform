export interface InventorySkuProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuProfileValidator {
  public static validate(data: Partial<InventorySkuProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
