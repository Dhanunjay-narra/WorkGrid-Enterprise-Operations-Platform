export interface InventorySkuMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuMetricValidator {
  public static validate(data: Partial<InventorySkuMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
