export interface InventorySkuMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuMappingValidator {
  public static validate(data: Partial<InventorySkuMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
