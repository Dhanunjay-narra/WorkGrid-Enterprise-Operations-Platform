export interface InventorySkuSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuSessionValidator {
  public static validate(data: Partial<InventorySkuSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
