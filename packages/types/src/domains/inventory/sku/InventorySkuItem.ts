export interface InventorySkuItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuItemValidator {
  public static validate(data: Partial<InventorySkuItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
