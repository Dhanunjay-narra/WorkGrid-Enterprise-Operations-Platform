export interface InventorySkuQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuQueueValidator {
  public static validate(data: Partial<InventorySkuQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
