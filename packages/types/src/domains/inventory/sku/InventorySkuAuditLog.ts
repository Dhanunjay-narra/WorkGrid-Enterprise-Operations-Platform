export interface InventorySkuAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuAuditLogValidator {
  public static validate(data: Partial<InventorySkuAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
