export interface InventorySkuSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuSnapshotValidator {
  public static validate(data: Partial<InventorySkuSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
