export interface InventorySkuPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuPayloadValidator {
  public static validate(data: Partial<InventorySkuPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
