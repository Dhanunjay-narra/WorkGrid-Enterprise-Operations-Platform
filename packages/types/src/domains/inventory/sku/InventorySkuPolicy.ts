export interface InventorySkuPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuPolicyValidator {
  public static validate(data: Partial<InventorySkuPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
