export interface InventorySkuNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventorySkuNodeValidator {
  public static validate(data: Partial<InventorySkuNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
