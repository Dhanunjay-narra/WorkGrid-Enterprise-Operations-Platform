export interface InventoryStockSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockSessionValidator {
  public static validate(data: Partial<InventoryStockSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
