export interface InventoryStockReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockReportValidator {
  public static validate(data: Partial<InventoryStockReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
