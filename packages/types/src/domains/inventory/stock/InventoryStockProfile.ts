export interface InventoryStockProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockProfileValidator {
  public static validate(data: Partial<InventoryStockProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
