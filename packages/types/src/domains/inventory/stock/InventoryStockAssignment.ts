export interface InventoryStockAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockAssignmentValidator {
  public static validate(data: Partial<InventoryStockAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
