export interface InventoryStockNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockNodeValidator {
  public static validate(data: Partial<InventoryStockNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
