export interface InventoryStockPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockPolicyValidator {
  public static validate(data: Partial<InventoryStockPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
