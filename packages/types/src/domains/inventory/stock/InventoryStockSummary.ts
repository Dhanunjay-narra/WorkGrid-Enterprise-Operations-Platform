export interface InventoryStockSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockSummaryValidator {
  public static validate(data: Partial<InventoryStockSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
