export interface InventoryStockPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockPayloadValidator {
  public static validate(data: Partial<InventoryStockPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
