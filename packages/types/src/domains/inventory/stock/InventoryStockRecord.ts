export interface InventoryStockRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockRecordValidator {
  public static validate(data: Partial<InventoryStockRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
