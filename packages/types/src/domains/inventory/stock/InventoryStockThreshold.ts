export interface InventoryStockThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockThresholdValidator {
  public static validate(data: Partial<InventoryStockThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
