export interface InventoryStockMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockMetricValidator {
  public static validate(data: Partial<InventoryStockMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
