export interface InventoryStockConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockConfigValidator {
  public static validate(data: Partial<InventoryStockConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
