export interface InventoryStockStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockStateValidator {
  public static validate(data: Partial<InventoryStockStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
