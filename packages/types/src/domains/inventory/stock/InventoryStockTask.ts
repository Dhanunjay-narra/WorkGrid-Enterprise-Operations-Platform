export interface InventoryStockTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockTaskValidator {
  public static validate(data: Partial<InventoryStockTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
