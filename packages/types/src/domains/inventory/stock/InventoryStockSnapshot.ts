export interface InventoryStockSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockSnapshotValidator {
  public static validate(data: Partial<InventoryStockSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
