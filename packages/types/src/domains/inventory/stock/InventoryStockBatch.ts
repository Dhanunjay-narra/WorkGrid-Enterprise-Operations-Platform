export interface InventoryStockBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockBatchValidator {
  public static validate(data: Partial<InventoryStockBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
