export interface InventoryStockEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockEntryValidator {
  public static validate(data: Partial<InventoryStockEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
