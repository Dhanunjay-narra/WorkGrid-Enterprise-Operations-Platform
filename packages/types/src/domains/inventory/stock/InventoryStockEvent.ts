export interface InventoryStockEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockEventValidator {
  public static validate(data: Partial<InventoryStockEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
