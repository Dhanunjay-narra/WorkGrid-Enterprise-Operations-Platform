export interface InventoryStockItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockItemValidator {
  public static validate(data: Partial<InventoryStockItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
