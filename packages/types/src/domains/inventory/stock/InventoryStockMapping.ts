export interface InventoryStockMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockMappingValidator {
  public static validate(data: Partial<InventoryStockMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
