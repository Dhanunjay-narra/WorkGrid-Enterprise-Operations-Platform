export interface InventoryStockRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockRuleValidator {
  public static validate(data: Partial<InventoryStockRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
