export interface InventoryStockAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockAuditLogValidator {
  public static validate(data: Partial<InventoryStockAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
