export interface InventoryStockScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockScheduleValidator {
  public static validate(data: Partial<InventoryStockScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
