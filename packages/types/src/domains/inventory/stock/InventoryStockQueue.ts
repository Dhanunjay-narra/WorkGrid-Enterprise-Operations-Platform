export interface InventoryStockQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class InventoryStockQueueValidator {
  public static validate(data: Partial<InventoryStockQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
