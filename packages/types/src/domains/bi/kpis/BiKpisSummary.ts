export interface BiKpisSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisSummaryValidator {
  public static validate(data: Partial<BiKpisSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
