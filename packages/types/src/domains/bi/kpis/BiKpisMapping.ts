export interface BiKpisMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisMappingValidator {
  public static validate(data: Partial<BiKpisMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
