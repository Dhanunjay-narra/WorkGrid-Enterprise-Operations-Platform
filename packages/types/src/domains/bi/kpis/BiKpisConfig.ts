export interface BiKpisConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisConfigValidator {
  public static validate(data: Partial<BiKpisConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
