export interface BiKpisPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisPayloadValidator {
  public static validate(data: Partial<BiKpisPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
