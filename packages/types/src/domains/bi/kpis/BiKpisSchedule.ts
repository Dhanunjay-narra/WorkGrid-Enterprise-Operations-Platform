export interface BiKpisScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisScheduleValidator {
  public static validate(data: Partial<BiKpisScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
