export interface BiKpisAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisAssignmentValidator {
  public static validate(data: Partial<BiKpisAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
