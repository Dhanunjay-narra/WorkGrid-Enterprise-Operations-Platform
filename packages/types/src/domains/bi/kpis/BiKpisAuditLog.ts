export interface BiKpisAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisAuditLogValidator {
  public static validate(data: Partial<BiKpisAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
