export interface BiKpisReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisReportValidator {
  public static validate(data: Partial<BiKpisReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
