export interface BiKpisThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisThresholdValidator {
  public static validate(data: Partial<BiKpisThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
