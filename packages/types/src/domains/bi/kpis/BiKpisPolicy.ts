export interface BiKpisPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisPolicyValidator {
  public static validate(data: Partial<BiKpisPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
