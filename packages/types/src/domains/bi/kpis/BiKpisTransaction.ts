export interface BiKpisTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisTransactionValidator {
  public static validate(data: Partial<BiKpisTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
