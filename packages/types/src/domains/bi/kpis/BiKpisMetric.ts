export interface BiKpisMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisMetricValidator {
  public static validate(data: Partial<BiKpisMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
