export interface BiKpisProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisProfileValidator {
  public static validate(data: Partial<BiKpisProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
