export interface BiKpisSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisSessionValidator {
  public static validate(data: Partial<BiKpisSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
