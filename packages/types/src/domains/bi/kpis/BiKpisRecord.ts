export interface BiKpisRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiKpisRecordValidator {
  public static validate(data: Partial<BiKpisRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
