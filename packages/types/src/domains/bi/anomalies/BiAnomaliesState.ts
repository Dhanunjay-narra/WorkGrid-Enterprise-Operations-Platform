export interface BiAnomaliesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesStateValidator {
  public static validate(data: Partial<BiAnomaliesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
