export interface BiAnomaliesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesPolicyValidator {
  public static validate(data: Partial<BiAnomaliesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
