export interface BiAnomaliesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesBatchValidator {
  public static validate(data: Partial<BiAnomaliesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
