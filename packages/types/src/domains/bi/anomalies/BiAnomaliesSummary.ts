export interface BiAnomaliesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesSummaryValidator {
  public static validate(data: Partial<BiAnomaliesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
