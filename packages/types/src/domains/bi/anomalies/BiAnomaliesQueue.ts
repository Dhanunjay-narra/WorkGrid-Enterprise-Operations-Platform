export interface BiAnomaliesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesQueueValidator {
  public static validate(data: Partial<BiAnomaliesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
