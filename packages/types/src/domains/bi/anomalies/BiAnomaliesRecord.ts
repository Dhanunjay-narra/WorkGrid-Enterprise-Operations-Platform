export interface BiAnomaliesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesRecordValidator {
  public static validate(data: Partial<BiAnomaliesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
