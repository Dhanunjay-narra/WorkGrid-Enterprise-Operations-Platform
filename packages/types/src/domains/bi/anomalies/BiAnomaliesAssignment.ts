export interface BiAnomaliesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesAssignmentValidator {
  public static validate(data: Partial<BiAnomaliesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
