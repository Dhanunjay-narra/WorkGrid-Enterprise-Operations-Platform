export interface BiAnomaliesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesConfigValidator {
  public static validate(data: Partial<BiAnomaliesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
