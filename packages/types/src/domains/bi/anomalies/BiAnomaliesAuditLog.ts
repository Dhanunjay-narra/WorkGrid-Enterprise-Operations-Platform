export interface BiAnomaliesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesAuditLogValidator {
  public static validate(data: Partial<BiAnomaliesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
