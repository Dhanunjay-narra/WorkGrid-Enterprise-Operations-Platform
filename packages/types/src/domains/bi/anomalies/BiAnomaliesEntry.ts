export interface BiAnomaliesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesEntryValidator {
  public static validate(data: Partial<BiAnomaliesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
