export interface BiAnomaliesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesItemValidator {
  public static validate(data: Partial<BiAnomaliesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
