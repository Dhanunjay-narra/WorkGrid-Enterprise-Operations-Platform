export interface BiAnomaliesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesMappingValidator {
  public static validate(data: Partial<BiAnomaliesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
