export interface BiAnomaliesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesSnapshotValidator {
  public static validate(data: Partial<BiAnomaliesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
