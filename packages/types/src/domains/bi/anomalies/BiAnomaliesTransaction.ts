export interface BiAnomaliesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesTransactionValidator {
  public static validate(data: Partial<BiAnomaliesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
