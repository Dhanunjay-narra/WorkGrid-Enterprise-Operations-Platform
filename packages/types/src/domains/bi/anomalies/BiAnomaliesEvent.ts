export interface BiAnomaliesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesEventValidator {
  public static validate(data: Partial<BiAnomaliesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
