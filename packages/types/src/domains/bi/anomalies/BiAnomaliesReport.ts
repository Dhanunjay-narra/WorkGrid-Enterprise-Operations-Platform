export interface BiAnomaliesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesReportValidator {
  public static validate(data: Partial<BiAnomaliesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
