export interface BiAnomaliesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesScheduleValidator {
  public static validate(data: Partial<BiAnomaliesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
