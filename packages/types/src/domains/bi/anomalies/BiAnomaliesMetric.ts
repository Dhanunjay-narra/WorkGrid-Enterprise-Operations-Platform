export interface BiAnomaliesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesMetricValidator {
  public static validate(data: Partial<BiAnomaliesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
