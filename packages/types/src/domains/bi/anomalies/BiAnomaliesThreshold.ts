export interface BiAnomaliesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesThresholdValidator {
  public static validate(data: Partial<BiAnomaliesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
