export interface BiAnomaliesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesSessionValidator {
  public static validate(data: Partial<BiAnomaliesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
