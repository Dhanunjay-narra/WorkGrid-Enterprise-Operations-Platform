export interface BiAnomaliesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesRuleValidator {
  public static validate(data: Partial<BiAnomaliesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
