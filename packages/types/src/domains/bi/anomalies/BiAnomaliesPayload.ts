export interface BiAnomaliesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesPayloadValidator {
  public static validate(data: Partial<BiAnomaliesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
