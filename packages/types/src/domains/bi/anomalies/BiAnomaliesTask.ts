export interface BiAnomaliesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesTaskValidator {
  public static validate(data: Partial<BiAnomaliesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
