export interface BiAnomaliesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesProfileValidator {
  public static validate(data: Partial<BiAnomaliesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
