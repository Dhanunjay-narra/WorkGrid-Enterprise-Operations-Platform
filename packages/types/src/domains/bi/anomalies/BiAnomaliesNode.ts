export interface BiAnomaliesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiAnomaliesNodeValidator {
  public static validate(data: Partial<BiAnomaliesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
