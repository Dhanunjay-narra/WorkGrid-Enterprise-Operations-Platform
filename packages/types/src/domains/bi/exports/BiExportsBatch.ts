export interface BiExportsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsBatchValidator {
  public static validate(data: Partial<BiExportsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
