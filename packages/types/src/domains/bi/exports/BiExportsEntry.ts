export interface BiExportsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsEntryValidator {
  public static validate(data: Partial<BiExportsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
