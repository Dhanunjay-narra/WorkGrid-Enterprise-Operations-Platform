export interface BiExportsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsPolicyValidator {
  public static validate(data: Partial<BiExportsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
