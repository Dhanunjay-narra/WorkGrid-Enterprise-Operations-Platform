export interface BiExportsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsAuditLogValidator {
  public static validate(data: Partial<BiExportsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
