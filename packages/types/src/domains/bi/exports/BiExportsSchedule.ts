export interface BiExportsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsScheduleValidator {
  public static validate(data: Partial<BiExportsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
