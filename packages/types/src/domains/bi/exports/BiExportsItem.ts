export interface BiExportsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsItemValidator {
  public static validate(data: Partial<BiExportsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
