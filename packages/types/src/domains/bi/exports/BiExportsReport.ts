export interface BiExportsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsReportValidator {
  public static validate(data: Partial<BiExportsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
