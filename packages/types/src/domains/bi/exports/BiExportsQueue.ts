export interface BiExportsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsQueueValidator {
  public static validate(data: Partial<BiExportsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
