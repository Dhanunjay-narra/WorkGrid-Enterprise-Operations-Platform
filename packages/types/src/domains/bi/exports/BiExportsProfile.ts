export interface BiExportsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsProfileValidator {
  public static validate(data: Partial<BiExportsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
