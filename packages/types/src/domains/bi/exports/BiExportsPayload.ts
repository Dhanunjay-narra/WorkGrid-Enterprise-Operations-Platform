export interface BiExportsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsPayloadValidator {
  public static validate(data: Partial<BiExportsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
