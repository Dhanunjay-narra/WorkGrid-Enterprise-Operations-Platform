export interface BiExportsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsStateValidator {
  public static validate(data: Partial<BiExportsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
