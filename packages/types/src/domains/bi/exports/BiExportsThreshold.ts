export interface BiExportsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsThresholdValidator {
  public static validate(data: Partial<BiExportsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
