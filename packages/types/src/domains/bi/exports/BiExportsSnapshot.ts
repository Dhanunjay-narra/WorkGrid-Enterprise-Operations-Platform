export interface BiExportsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsSnapshotValidator {
  public static validate(data: Partial<BiExportsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
