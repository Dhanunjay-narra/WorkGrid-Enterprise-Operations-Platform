export interface BiExportsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsTransactionValidator {
  public static validate(data: Partial<BiExportsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
