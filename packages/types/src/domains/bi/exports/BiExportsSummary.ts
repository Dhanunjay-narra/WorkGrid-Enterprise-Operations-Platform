export interface BiExportsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsSummaryValidator {
  public static validate(data: Partial<BiExportsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
