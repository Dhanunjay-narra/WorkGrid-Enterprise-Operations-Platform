export interface BiExportsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsAssignmentValidator {
  public static validate(data: Partial<BiExportsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
