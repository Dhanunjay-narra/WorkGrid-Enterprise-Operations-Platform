export interface BiExportsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsEventValidator {
  public static validate(data: Partial<BiExportsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
