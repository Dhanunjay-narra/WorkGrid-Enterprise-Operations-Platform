export interface BiExportsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsNodeValidator {
  public static validate(data: Partial<BiExportsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
