export interface BiExportsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsMappingValidator {
  public static validate(data: Partial<BiExportsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
