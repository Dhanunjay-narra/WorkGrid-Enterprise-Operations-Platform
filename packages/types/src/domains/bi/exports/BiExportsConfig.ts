export interface BiExportsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsConfigValidator {
  public static validate(data: Partial<BiExportsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
