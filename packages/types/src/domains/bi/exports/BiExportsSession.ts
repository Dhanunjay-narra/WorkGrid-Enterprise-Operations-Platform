export interface BiExportsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsSessionValidator {
  public static validate(data: Partial<BiExportsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
