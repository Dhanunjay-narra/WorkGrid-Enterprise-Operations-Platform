export interface BiExportsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsTaskValidator {
  public static validate(data: Partial<BiExportsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
