export interface BiExportsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsRuleValidator {
  public static validate(data: Partial<BiExportsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
