export interface BiExportsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsMetricValidator {
  public static validate(data: Partial<BiExportsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
