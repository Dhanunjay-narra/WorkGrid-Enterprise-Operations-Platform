export interface BiExportsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiExportsRecordValidator {
  public static validate(data: Partial<BiExportsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
