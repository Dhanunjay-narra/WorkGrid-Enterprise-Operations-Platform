export interface BiQueriesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesStateValidator {
  public static validate(data: Partial<BiQueriesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
