export interface BiQueriesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesThresholdValidator {
  public static validate(data: Partial<BiQueriesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
