export interface BiQueriesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesItemValidator {
  public static validate(data: Partial<BiQueriesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
