export interface BiQueriesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesQueueValidator {
  public static validate(data: Partial<BiQueriesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
