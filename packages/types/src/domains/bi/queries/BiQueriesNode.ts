export interface BiQueriesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesNodeValidator {
  public static validate(data: Partial<BiQueriesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
