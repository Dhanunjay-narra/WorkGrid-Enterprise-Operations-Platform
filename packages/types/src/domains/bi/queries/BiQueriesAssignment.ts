export interface BiQueriesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesAssignmentValidator {
  public static validate(data: Partial<BiQueriesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
