export interface BiQueriesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesMetricValidator {
  public static validate(data: Partial<BiQueriesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
