export interface BiQueriesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesBatchValidator {
  public static validate(data: Partial<BiQueriesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
