export interface BiQueriesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesReportValidator {
  public static validate(data: Partial<BiQueriesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
