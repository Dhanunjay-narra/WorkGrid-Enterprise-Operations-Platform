export interface BiQueriesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesSessionValidator {
  public static validate(data: Partial<BiQueriesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
