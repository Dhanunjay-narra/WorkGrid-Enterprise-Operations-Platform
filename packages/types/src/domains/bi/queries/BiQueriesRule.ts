export interface BiQueriesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesRuleValidator {
  public static validate(data: Partial<BiQueriesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
