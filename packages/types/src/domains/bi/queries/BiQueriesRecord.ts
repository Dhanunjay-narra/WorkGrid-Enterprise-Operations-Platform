export interface BiQueriesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesRecordValidator {
  public static validate(data: Partial<BiQueriesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
