export interface BiQueriesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesEventValidator {
  public static validate(data: Partial<BiQueriesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
