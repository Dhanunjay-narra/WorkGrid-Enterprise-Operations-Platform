export interface BiQueriesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesPolicyValidator {
  public static validate(data: Partial<BiQueriesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
