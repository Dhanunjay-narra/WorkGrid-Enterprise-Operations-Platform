export interface BiQueriesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesConfigValidator {
  public static validate(data: Partial<BiQueriesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
