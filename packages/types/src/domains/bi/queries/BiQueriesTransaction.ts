export interface BiQueriesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesTransactionValidator {
  public static validate(data: Partial<BiQueriesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
