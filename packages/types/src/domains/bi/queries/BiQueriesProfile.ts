export interface BiQueriesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesProfileValidator {
  public static validate(data: Partial<BiQueriesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
