export interface BiQueriesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesEntryValidator {
  public static validate(data: Partial<BiQueriesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
