export interface BiQueriesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesSnapshotValidator {
  public static validate(data: Partial<BiQueriesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
