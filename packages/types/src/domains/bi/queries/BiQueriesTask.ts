export interface BiQueriesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesTaskValidator {
  public static validate(data: Partial<BiQueriesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
