export interface BiQueriesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesMappingValidator {
  public static validate(data: Partial<BiQueriesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
