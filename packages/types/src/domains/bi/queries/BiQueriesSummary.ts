export interface BiQueriesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesSummaryValidator {
  public static validate(data: Partial<BiQueriesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
