export interface BiQueriesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesAuditLogValidator {
  public static validate(data: Partial<BiQueriesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
