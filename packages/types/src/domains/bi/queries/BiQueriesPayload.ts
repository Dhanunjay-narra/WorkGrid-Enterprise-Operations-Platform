export interface BiQueriesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesPayloadValidator {
  public static validate(data: Partial<BiQueriesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
