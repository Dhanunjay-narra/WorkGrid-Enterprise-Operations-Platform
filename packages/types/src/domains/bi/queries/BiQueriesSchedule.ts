export interface BiQueriesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiQueriesScheduleValidator {
  public static validate(data: Partial<BiQueriesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
