export interface BiCohortsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsRecordValidator {
  public static validate(data: Partial<BiCohortsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
