export interface BiCohortsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsTaskValidator {
  public static validate(data: Partial<BiCohortsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
