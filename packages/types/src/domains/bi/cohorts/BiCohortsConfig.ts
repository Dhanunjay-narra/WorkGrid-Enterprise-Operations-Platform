export interface BiCohortsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsConfigValidator {
  public static validate(data: Partial<BiCohortsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
