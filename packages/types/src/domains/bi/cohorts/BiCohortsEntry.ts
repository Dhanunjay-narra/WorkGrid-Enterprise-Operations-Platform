export interface BiCohortsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsEntryValidator {
  public static validate(data: Partial<BiCohortsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
