export interface BiCohortsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsSnapshotValidator {
  public static validate(data: Partial<BiCohortsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
