export interface BiCohortsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsSessionValidator {
  public static validate(data: Partial<BiCohortsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
