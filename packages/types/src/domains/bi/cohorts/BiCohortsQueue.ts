export interface BiCohortsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsQueueValidator {
  public static validate(data: Partial<BiCohortsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
