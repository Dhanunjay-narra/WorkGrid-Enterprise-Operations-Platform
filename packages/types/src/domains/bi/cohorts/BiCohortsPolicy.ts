export interface BiCohortsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsPolicyValidator {
  public static validate(data: Partial<BiCohortsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
