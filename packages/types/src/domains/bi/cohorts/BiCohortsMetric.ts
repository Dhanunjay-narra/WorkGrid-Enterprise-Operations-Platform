export interface BiCohortsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsMetricValidator {
  public static validate(data: Partial<BiCohortsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
