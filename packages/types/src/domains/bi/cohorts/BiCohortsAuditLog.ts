export interface BiCohortsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsAuditLogValidator {
  public static validate(data: Partial<BiCohortsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
