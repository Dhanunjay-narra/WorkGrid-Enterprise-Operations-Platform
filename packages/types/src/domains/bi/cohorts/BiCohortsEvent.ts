export interface BiCohortsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsEventValidator {
  public static validate(data: Partial<BiCohortsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
