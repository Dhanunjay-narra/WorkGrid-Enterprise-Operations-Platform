export interface BiCohortsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsSummaryValidator {
  public static validate(data: Partial<BiCohortsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
