export interface BiCohortsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsBatchValidator {
  public static validate(data: Partial<BiCohortsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
