export interface BiCohortsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsItemValidator {
  public static validate(data: Partial<BiCohortsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
