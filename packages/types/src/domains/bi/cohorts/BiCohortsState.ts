export interface BiCohortsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsStateValidator {
  public static validate(data: Partial<BiCohortsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
