export interface BiCohortsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsMappingValidator {
  public static validate(data: Partial<BiCohortsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
