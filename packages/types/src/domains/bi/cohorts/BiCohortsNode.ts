export interface BiCohortsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsNodeValidator {
  public static validate(data: Partial<BiCohortsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
