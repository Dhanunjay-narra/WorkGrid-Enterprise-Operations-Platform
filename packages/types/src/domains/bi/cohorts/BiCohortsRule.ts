export interface BiCohortsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsRuleValidator {
  public static validate(data: Partial<BiCohortsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
