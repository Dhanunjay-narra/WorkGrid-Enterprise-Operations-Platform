export interface BiCohortsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsAssignmentValidator {
  public static validate(data: Partial<BiCohortsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
