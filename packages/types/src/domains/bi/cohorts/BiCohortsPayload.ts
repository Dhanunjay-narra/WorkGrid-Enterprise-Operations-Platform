export interface BiCohortsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsPayloadValidator {
  public static validate(data: Partial<BiCohortsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
