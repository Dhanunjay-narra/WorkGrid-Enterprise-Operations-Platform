export interface BiCohortsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsScheduleValidator {
  public static validate(data: Partial<BiCohortsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
