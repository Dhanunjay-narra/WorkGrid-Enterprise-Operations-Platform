export interface BiCohortsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsThresholdValidator {
  public static validate(data: Partial<BiCohortsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
