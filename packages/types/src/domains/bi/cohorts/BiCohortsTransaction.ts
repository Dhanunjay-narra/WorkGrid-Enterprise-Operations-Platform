export interface BiCohortsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsTransactionValidator {
  public static validate(data: Partial<BiCohortsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
