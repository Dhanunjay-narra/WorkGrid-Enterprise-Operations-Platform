export interface BiCohortsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsProfileValidator {
  public static validate(data: Partial<BiCohortsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
