export interface BiCohortsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiCohortsReportValidator {
  public static validate(data: Partial<BiCohortsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
