export interface BiDashboardsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsRuleValidator {
  public static validate(data: Partial<BiDashboardsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
