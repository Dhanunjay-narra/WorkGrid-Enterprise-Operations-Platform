export interface BiDashboardsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsReportValidator {
  public static validate(data: Partial<BiDashboardsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
