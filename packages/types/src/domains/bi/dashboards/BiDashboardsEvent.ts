export interface BiDashboardsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsEventValidator {
  public static validate(data: Partial<BiDashboardsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
