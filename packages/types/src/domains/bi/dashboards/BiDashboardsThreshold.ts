export interface BiDashboardsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsThresholdValidator {
  public static validate(data: Partial<BiDashboardsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
