export interface BiDashboardsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsNodeValidator {
  public static validate(data: Partial<BiDashboardsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
