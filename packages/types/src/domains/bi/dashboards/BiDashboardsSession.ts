export interface BiDashboardsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsSessionValidator {
  public static validate(data: Partial<BiDashboardsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
