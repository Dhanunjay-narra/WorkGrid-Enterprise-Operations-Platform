export interface BiDashboardsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsTransactionValidator {
  public static validate(data: Partial<BiDashboardsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
