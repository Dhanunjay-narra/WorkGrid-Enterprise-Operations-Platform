export interface BiDashboardsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsQueueValidator {
  public static validate(data: Partial<BiDashboardsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
