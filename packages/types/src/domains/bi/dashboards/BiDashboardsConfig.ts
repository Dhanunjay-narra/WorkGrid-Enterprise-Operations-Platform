export interface BiDashboardsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsConfigValidator {
  public static validate(data: Partial<BiDashboardsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
