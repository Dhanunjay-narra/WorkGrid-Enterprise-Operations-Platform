export interface BiDashboardsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsRecordValidator {
  public static validate(data: Partial<BiDashboardsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
