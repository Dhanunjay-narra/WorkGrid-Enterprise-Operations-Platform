export interface BiDashboardsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsMappingValidator {
  public static validate(data: Partial<BiDashboardsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
