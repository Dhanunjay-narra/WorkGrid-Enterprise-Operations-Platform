export interface BiDashboardsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsAssignmentValidator {
  public static validate(data: Partial<BiDashboardsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
