export interface BiDashboardsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsAuditLogValidator {
  public static validate(data: Partial<BiDashboardsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
