export interface BiDashboardsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsItemValidator {
  public static validate(data: Partial<BiDashboardsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
