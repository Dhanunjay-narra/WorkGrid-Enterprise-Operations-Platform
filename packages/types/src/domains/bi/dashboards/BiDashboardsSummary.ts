export interface BiDashboardsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsSummaryValidator {
  public static validate(data: Partial<BiDashboardsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
