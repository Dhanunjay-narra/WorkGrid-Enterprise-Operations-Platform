export interface BiDashboardsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsEntryValidator {
  public static validate(data: Partial<BiDashboardsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
