export interface BiDashboardsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsScheduleValidator {
  public static validate(data: Partial<BiDashboardsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
