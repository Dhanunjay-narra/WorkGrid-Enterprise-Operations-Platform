export interface BiDashboardsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsStateValidator {
  public static validate(data: Partial<BiDashboardsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
