export interface BiDashboardsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsPolicyValidator {
  public static validate(data: Partial<BiDashboardsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
