export interface BiDashboardsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsPayloadValidator {
  public static validate(data: Partial<BiDashboardsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
