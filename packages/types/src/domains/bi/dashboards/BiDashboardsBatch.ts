export interface BiDashboardsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsBatchValidator {
  public static validate(data: Partial<BiDashboardsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
