export interface BiDashboardsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsTaskValidator {
  public static validate(data: Partial<BiDashboardsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
