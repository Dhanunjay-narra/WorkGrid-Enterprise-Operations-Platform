export interface BiDashboardsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsProfileValidator {
  public static validate(data: Partial<BiDashboardsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
