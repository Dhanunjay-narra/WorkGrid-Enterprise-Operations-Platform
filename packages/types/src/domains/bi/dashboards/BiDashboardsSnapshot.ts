export interface BiDashboardsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsSnapshotValidator {
  public static validate(data: Partial<BiDashboardsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
