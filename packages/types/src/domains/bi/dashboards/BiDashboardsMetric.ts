export interface BiDashboardsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiDashboardsMetricValidator {
  public static validate(data: Partial<BiDashboardsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
