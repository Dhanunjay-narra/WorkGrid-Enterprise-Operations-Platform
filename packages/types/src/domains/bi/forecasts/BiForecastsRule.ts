export interface BiForecastsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsRuleValidator {
  public static validate(data: Partial<BiForecastsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
