export interface BiForecastsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsQueueValidator {
  public static validate(data: Partial<BiForecastsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
