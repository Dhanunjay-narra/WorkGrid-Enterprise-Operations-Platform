export interface BiForecastsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsBatchValidator {
  public static validate(data: Partial<BiForecastsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
