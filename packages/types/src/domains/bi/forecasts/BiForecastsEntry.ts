export interface BiForecastsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsEntryValidator {
  public static validate(data: Partial<BiForecastsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
