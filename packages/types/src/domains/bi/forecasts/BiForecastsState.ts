export interface BiForecastsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsStateValidator {
  public static validate(data: Partial<BiForecastsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
