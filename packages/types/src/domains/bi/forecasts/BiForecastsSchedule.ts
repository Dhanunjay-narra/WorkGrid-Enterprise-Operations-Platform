export interface BiForecastsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsScheduleValidator {
  public static validate(data: Partial<BiForecastsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
