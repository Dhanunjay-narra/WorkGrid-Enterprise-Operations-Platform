export interface BiForecastsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsPolicyValidator {
  public static validate(data: Partial<BiForecastsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
