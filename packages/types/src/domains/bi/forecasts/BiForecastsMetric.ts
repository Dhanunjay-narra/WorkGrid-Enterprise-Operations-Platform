export interface BiForecastsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsMetricValidator {
  public static validate(data: Partial<BiForecastsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
