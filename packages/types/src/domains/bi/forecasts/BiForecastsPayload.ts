export interface BiForecastsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsPayloadValidator {
  public static validate(data: Partial<BiForecastsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
