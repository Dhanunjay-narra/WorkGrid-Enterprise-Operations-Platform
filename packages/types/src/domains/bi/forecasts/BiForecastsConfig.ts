export interface BiForecastsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsConfigValidator {
  public static validate(data: Partial<BiForecastsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
