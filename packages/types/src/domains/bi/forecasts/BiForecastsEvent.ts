export interface BiForecastsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsEventValidator {
  public static validate(data: Partial<BiForecastsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
