export interface BiForecastsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsSessionValidator {
  public static validate(data: Partial<BiForecastsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
