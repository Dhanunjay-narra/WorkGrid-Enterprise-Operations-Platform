export interface BiForecastsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsAssignmentValidator {
  public static validate(data: Partial<BiForecastsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
