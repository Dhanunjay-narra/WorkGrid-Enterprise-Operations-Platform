export interface BiForecastsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsAuditLogValidator {
  public static validate(data: Partial<BiForecastsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
