export interface BiForecastsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsTaskValidator {
  public static validate(data: Partial<BiForecastsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
