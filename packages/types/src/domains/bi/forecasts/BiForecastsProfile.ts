export interface BiForecastsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsProfileValidator {
  public static validate(data: Partial<BiForecastsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
