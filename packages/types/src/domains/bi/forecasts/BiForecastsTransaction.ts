export interface BiForecastsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsTransactionValidator {
  public static validate(data: Partial<BiForecastsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
