export interface BiForecastsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsRecordValidator {
  public static validate(data: Partial<BiForecastsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
