export interface BiForecastsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsThresholdValidator {
  public static validate(data: Partial<BiForecastsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
