export interface BiForecastsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsNodeValidator {
  public static validate(data: Partial<BiForecastsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
