export interface BiForecastsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsReportValidator {
  public static validate(data: Partial<BiForecastsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
