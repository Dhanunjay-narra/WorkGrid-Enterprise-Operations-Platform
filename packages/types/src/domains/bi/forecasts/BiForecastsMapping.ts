export interface BiForecastsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsMappingValidator {
  public static validate(data: Partial<BiForecastsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
