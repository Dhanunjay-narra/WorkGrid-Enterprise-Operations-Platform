export interface BiForecastsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsItemValidator {
  public static validate(data: Partial<BiForecastsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
