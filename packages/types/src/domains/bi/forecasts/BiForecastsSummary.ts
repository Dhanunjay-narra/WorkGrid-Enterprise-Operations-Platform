export interface BiForecastsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsSummaryValidator {
  public static validate(data: Partial<BiForecastsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
