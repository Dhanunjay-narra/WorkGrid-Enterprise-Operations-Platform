export interface BiForecastsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiForecastsSnapshotValidator {
  public static validate(data: Partial<BiForecastsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
