export interface BiWidgetsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsAuditLogValidator {
  public static validate(data: Partial<BiWidgetsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
