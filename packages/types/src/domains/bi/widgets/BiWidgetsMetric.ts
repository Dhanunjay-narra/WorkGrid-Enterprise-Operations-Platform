export interface BiWidgetsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsMetricValidator {
  public static validate(data: Partial<BiWidgetsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
