export interface BiWidgetsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsConfigValidator {
  public static validate(data: Partial<BiWidgetsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
