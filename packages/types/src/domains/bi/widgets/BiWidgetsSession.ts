export interface BiWidgetsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsSessionValidator {
  public static validate(data: Partial<BiWidgetsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
