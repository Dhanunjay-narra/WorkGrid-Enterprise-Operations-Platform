export interface BiWidgetsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsSnapshotValidator {
  public static validate(data: Partial<BiWidgetsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
