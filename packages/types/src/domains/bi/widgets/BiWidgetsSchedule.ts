export interface BiWidgetsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsScheduleValidator {
  public static validate(data: Partial<BiWidgetsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
