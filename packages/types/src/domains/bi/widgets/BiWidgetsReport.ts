export interface BiWidgetsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsReportValidator {
  public static validate(data: Partial<BiWidgetsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
