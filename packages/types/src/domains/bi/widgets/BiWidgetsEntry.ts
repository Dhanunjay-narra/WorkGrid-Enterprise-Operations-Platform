export interface BiWidgetsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsEntryValidator {
  public static validate(data: Partial<BiWidgetsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
