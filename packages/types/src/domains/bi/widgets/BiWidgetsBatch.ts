export interface BiWidgetsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsBatchValidator {
  public static validate(data: Partial<BiWidgetsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
