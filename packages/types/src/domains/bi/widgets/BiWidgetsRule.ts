export interface BiWidgetsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsRuleValidator {
  public static validate(data: Partial<BiWidgetsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
