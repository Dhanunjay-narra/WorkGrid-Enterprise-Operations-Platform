export interface BiWidgetsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsSummaryValidator {
  public static validate(data: Partial<BiWidgetsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
