export interface BiWidgetsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsItemValidator {
  public static validate(data: Partial<BiWidgetsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
