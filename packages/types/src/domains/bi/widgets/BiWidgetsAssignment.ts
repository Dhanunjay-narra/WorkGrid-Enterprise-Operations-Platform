export interface BiWidgetsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsAssignmentValidator {
  public static validate(data: Partial<BiWidgetsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
