export interface BiWidgetsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsRecordValidator {
  public static validate(data: Partial<BiWidgetsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
