export interface BiWidgetsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsStateValidator {
  public static validate(data: Partial<BiWidgetsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
