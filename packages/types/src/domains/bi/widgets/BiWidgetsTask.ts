export interface BiWidgetsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsTaskValidator {
  public static validate(data: Partial<BiWidgetsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
