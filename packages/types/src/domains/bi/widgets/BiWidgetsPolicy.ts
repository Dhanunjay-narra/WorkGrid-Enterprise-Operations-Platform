export interface BiWidgetsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsPolicyValidator {
  public static validate(data: Partial<BiWidgetsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
