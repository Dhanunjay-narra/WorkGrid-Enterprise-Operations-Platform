export interface BiWidgetsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsMappingValidator {
  public static validate(data: Partial<BiWidgetsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
