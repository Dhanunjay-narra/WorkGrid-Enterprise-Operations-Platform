export interface BiWidgetsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsProfileValidator {
  public static validate(data: Partial<BiWidgetsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
