export interface BiWidgetsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsQueueValidator {
  public static validate(data: Partial<BiWidgetsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
