export interface BiWidgetsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsPayloadValidator {
  public static validate(data: Partial<BiWidgetsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
