export interface BiWidgetsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsNodeValidator {
  public static validate(data: Partial<BiWidgetsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
