export interface BiWidgetsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsTransactionValidator {
  public static validate(data: Partial<BiWidgetsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
