export interface BiWidgetsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsThresholdValidator {
  public static validate(data: Partial<BiWidgetsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
