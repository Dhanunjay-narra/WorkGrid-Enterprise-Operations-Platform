export interface BiWidgetsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class BiWidgetsEventValidator {
  public static validate(data: Partial<BiWidgetsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
