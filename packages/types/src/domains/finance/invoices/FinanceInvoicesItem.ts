export interface FinanceInvoicesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesItemValidator {
  public static validate(data: Partial<FinanceInvoicesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
