export interface FinanceInvoicesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesScheduleValidator {
  public static validate(data: Partial<FinanceInvoicesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
