export interface FinanceInvoicesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesTransactionValidator {
  public static validate(data: Partial<FinanceInvoicesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
