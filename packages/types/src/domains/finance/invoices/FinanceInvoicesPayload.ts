export interface FinanceInvoicesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesPayloadValidator {
  public static validate(data: Partial<FinanceInvoicesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
