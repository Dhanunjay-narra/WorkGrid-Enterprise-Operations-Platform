export interface FinanceInvoicesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesStateValidator {
  public static validate(data: Partial<FinanceInvoicesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
