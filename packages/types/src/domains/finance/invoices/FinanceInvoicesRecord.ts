export interface FinanceInvoicesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesRecordValidator {
  public static validate(data: Partial<FinanceInvoicesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
