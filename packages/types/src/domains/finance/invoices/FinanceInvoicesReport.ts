export interface FinanceInvoicesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesReportValidator {
  public static validate(data: Partial<FinanceInvoicesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
