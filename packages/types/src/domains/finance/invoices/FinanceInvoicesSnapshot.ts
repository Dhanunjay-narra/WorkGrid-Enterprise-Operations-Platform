export interface FinanceInvoicesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesSnapshotValidator {
  public static validate(data: Partial<FinanceInvoicesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
