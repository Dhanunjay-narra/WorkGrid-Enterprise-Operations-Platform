export interface FinanceInvoicesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesConfigValidator {
  public static validate(data: Partial<FinanceInvoicesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
