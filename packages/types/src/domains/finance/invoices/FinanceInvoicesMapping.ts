export interface FinanceInvoicesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesMappingValidator {
  public static validate(data: Partial<FinanceInvoicesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
