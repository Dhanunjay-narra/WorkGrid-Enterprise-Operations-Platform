export interface FinanceInvoicesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesEventValidator {
  public static validate(data: Partial<FinanceInvoicesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
