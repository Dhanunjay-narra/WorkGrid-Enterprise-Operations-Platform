export interface FinanceInvoicesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesBatchValidator {
  public static validate(data: Partial<FinanceInvoicesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
