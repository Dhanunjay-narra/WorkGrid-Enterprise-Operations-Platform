export interface FinanceInvoicesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesNodeValidator {
  public static validate(data: Partial<FinanceInvoicesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
