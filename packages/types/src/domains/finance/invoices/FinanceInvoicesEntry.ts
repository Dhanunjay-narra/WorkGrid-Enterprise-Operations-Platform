export interface FinanceInvoicesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesEntryValidator {
  public static validate(data: Partial<FinanceInvoicesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
