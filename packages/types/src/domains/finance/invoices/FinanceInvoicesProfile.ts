export interface FinanceInvoicesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesProfileValidator {
  public static validate(data: Partial<FinanceInvoicesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
