export interface FinanceInvoicesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesAuditLogValidator {
  public static validate(data: Partial<FinanceInvoicesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
