export interface FinanceInvoicesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesTaskValidator {
  public static validate(data: Partial<FinanceInvoicesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
