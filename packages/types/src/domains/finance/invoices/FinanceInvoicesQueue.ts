export interface FinanceInvoicesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesQueueValidator {
  public static validate(data: Partial<FinanceInvoicesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
