export interface FinanceInvoicesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesThresholdValidator {
  public static validate(data: Partial<FinanceInvoicesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
