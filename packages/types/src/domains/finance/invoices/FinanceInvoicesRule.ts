export interface FinanceInvoicesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesRuleValidator {
  public static validate(data: Partial<FinanceInvoicesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
