export interface FinanceInvoicesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesPolicyValidator {
  public static validate(data: Partial<FinanceInvoicesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
