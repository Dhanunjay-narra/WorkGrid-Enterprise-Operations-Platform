export interface FinanceInvoicesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesAssignmentValidator {
  public static validate(data: Partial<FinanceInvoicesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
