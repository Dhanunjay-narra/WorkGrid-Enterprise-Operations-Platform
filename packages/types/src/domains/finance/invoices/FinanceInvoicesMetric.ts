export interface FinanceInvoicesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesMetricValidator {
  public static validate(data: Partial<FinanceInvoicesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
