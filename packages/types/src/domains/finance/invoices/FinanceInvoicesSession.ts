export interface FinanceInvoicesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesSessionValidator {
  public static validate(data: Partial<FinanceInvoicesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
