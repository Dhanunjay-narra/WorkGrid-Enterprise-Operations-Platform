export interface FinanceInvoicesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceInvoicesSummaryValidator {
  public static validate(data: Partial<FinanceInvoicesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
