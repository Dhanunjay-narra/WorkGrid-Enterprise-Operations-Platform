export interface FinanceTreasuryEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryEventValidator {
  public static validate(data: Partial<FinanceTreasuryEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
