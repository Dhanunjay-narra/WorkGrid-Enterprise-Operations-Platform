export interface FinanceTreasuryTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryTransactionValidator {
  public static validate(data: Partial<FinanceTreasuryTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
