export interface FinanceTreasurySnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasurySnapshotValidator {
  public static validate(data: Partial<FinanceTreasurySnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
