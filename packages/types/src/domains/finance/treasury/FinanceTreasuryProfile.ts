export interface FinanceTreasuryProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryProfileValidator {
  public static validate(data: Partial<FinanceTreasuryProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
