export interface FinanceTreasuryThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryThresholdValidator {
  public static validate(data: Partial<FinanceTreasuryThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
