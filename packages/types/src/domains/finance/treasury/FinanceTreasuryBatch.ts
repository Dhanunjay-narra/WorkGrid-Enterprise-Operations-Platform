export interface FinanceTreasuryBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryBatchValidator {
  public static validate(data: Partial<FinanceTreasuryBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
