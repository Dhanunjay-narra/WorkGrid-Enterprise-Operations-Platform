export interface FinanceTreasuryReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryReportValidator {
  public static validate(data: Partial<FinanceTreasuryReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
