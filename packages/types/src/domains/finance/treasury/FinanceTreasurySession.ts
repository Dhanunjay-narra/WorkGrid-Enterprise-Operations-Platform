export interface FinanceTreasurySessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasurySessionValidator {
  public static validate(data: Partial<FinanceTreasurySessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
