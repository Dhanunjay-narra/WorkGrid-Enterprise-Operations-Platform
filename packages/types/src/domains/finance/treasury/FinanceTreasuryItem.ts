export interface FinanceTreasuryItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryItemValidator {
  public static validate(data: Partial<FinanceTreasuryItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
