export interface FinanceTreasuryTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryTaskValidator {
  public static validate(data: Partial<FinanceTreasuryTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
