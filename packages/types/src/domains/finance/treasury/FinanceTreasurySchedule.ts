export interface FinanceTreasuryScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryScheduleValidator {
  public static validate(data: Partial<FinanceTreasuryScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
