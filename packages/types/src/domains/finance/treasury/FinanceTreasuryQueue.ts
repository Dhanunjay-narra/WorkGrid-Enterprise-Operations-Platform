export interface FinanceTreasuryQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryQueueValidator {
  public static validate(data: Partial<FinanceTreasuryQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
