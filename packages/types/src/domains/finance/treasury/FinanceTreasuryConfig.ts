export interface FinanceTreasuryConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryConfigValidator {
  public static validate(data: Partial<FinanceTreasuryConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
