export interface FinanceTreasuryEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryEntryValidator {
  public static validate(data: Partial<FinanceTreasuryEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
