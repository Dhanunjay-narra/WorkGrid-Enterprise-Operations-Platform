export interface FinanceTreasuryPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryPayloadValidator {
  public static validate(data: Partial<FinanceTreasuryPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
