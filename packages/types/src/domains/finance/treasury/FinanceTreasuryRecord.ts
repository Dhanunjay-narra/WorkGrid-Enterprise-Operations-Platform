export interface FinanceTreasuryRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryRecordValidator {
  public static validate(data: Partial<FinanceTreasuryRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
