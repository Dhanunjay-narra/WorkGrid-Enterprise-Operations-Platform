export interface FinanceTreasuryNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryNodeValidator {
  public static validate(data: Partial<FinanceTreasuryNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
