export interface FinanceTreasurySummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasurySummaryValidator {
  public static validate(data: Partial<FinanceTreasurySummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
