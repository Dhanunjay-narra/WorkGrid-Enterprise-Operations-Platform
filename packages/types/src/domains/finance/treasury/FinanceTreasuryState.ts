export interface FinanceTreasuryStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryStateValidator {
  public static validate(data: Partial<FinanceTreasuryStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
