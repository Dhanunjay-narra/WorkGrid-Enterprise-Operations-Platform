export interface FinanceTreasuryMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryMetricValidator {
  public static validate(data: Partial<FinanceTreasuryMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
