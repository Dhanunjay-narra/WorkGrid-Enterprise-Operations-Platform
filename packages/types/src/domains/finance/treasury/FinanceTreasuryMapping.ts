export interface FinanceTreasuryMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryMappingValidator {
  public static validate(data: Partial<FinanceTreasuryMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
