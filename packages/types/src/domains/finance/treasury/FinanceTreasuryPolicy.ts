export interface FinanceTreasuryPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryPolicyValidator {
  public static validate(data: Partial<FinanceTreasuryPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
