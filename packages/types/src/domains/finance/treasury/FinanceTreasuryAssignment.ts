export interface FinanceTreasuryAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTreasuryAssignmentValidator {
  public static validate(data: Partial<FinanceTreasuryAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
