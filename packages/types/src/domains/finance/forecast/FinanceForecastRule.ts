export interface FinanceForecastRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastRuleValidator {
  public static validate(data: Partial<FinanceForecastRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
