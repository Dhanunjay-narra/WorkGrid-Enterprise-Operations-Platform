export interface FinanceForecastPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastPolicyValidator {
  public static validate(data: Partial<FinanceForecastPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
