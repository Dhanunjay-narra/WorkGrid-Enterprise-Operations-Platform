export interface FinanceForecastScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastScheduleValidator {
  public static validate(data: Partial<FinanceForecastScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
