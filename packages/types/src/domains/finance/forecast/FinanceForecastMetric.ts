export interface FinanceForecastMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastMetricValidator {
  public static validate(data: Partial<FinanceForecastMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
