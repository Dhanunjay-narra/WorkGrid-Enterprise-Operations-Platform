export interface FinanceForecastSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastSessionValidator {
  public static validate(data: Partial<FinanceForecastSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
