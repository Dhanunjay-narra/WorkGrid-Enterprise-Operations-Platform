export interface FinanceForecastBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastBatchValidator {
  public static validate(data: Partial<FinanceForecastBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
