export interface FinanceForecastTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastTaskValidator {
  public static validate(data: Partial<FinanceForecastTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
