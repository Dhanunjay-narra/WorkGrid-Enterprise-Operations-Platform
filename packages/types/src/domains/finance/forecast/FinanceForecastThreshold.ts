export interface FinanceForecastThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastThresholdValidator {
  public static validate(data: Partial<FinanceForecastThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
