export interface FinanceForecastTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastTransactionValidator {
  public static validate(data: Partial<FinanceForecastTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
