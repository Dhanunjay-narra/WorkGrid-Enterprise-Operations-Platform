export interface FinanceForecastNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastNodeValidator {
  public static validate(data: Partial<FinanceForecastNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
