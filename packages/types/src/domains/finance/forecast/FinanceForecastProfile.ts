export interface FinanceForecastProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastProfileValidator {
  public static validate(data: Partial<FinanceForecastProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
