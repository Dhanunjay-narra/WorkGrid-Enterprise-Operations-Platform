export interface FinanceForecastQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastQueueValidator {
  public static validate(data: Partial<FinanceForecastQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
