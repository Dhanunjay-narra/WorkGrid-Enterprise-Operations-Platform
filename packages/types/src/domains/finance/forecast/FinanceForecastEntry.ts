export interface FinanceForecastEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastEntryValidator {
  public static validate(data: Partial<FinanceForecastEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
