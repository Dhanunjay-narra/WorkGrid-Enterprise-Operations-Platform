export interface FinanceForecastReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastReportValidator {
  public static validate(data: Partial<FinanceForecastReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
