export interface FinanceForecastEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastEventValidator {
  public static validate(data: Partial<FinanceForecastEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
