export interface FinanceForecastSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastSnapshotValidator {
  public static validate(data: Partial<FinanceForecastSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
