export interface FinanceForecastConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastConfigValidator {
  public static validate(data: Partial<FinanceForecastConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
