export interface FinanceForecastRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastRecordValidator {
  public static validate(data: Partial<FinanceForecastRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
