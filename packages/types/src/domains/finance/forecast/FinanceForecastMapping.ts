export interface FinanceForecastMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastMappingValidator {
  public static validate(data: Partial<FinanceForecastMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
