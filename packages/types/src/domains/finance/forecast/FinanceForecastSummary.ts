export interface FinanceForecastSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastSummaryValidator {
  public static validate(data: Partial<FinanceForecastSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
