export interface FinanceForecastStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastStateValidator {
  public static validate(data: Partial<FinanceForecastStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
