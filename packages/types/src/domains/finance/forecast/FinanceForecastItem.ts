export interface FinanceForecastItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastItemValidator {
  public static validate(data: Partial<FinanceForecastItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
