export interface FinanceForecastPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastPayloadValidator {
  public static validate(data: Partial<FinanceForecastPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
