export interface FinanceForecastAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastAuditLogValidator {
  public static validate(data: Partial<FinanceForecastAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
