export interface FinanceForecastAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceForecastAssignmentValidator {
  public static validate(data: Partial<FinanceForecastAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
