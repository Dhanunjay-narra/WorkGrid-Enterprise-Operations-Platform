export interface FinanceTaxesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesTransactionValidator {
  public static validate(data: Partial<FinanceTaxesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
