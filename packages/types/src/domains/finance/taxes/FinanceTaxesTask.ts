export interface FinanceTaxesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesTaskValidator {
  public static validate(data: Partial<FinanceTaxesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
