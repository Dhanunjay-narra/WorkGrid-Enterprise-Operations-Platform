export interface FinanceTaxesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesItemValidator {
  public static validate(data: Partial<FinanceTaxesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
