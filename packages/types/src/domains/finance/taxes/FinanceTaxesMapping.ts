export interface FinanceTaxesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesMappingValidator {
  public static validate(data: Partial<FinanceTaxesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
