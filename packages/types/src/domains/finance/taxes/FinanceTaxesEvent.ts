export interface FinanceTaxesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesEventValidator {
  public static validate(data: Partial<FinanceTaxesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
