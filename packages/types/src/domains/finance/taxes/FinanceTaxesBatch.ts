export interface FinanceTaxesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesBatchValidator {
  public static validate(data: Partial<FinanceTaxesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
