export interface FinanceTaxesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesPayloadValidator {
  public static validate(data: Partial<FinanceTaxesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
