export interface FinanceTaxesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesConfigValidator {
  public static validate(data: Partial<FinanceTaxesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
