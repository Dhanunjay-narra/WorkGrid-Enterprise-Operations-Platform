export interface FinanceTaxesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesPolicyValidator {
  public static validate(data: Partial<FinanceTaxesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
