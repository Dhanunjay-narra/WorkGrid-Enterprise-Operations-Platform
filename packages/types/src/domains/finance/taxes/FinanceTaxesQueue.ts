export interface FinanceTaxesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesQueueValidator {
  public static validate(data: Partial<FinanceTaxesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
