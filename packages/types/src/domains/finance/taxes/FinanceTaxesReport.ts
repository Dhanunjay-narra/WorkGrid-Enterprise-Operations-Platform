export interface FinanceTaxesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesReportValidator {
  public static validate(data: Partial<FinanceTaxesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
