export interface FinanceTaxesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesEntryValidator {
  public static validate(data: Partial<FinanceTaxesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
