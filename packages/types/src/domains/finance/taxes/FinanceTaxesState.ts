export interface FinanceTaxesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesStateValidator {
  public static validate(data: Partial<FinanceTaxesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
