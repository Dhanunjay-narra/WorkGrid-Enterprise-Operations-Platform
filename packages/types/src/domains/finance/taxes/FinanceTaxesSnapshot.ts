export interface FinanceTaxesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesSnapshotValidator {
  public static validate(data: Partial<FinanceTaxesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
