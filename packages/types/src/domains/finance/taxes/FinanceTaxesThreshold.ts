export interface FinanceTaxesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesThresholdValidator {
  public static validate(data: Partial<FinanceTaxesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
