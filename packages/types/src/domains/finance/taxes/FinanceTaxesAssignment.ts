export interface FinanceTaxesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesAssignmentValidator {
  public static validate(data: Partial<FinanceTaxesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
