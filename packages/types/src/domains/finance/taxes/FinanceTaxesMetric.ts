export interface FinanceTaxesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesMetricValidator {
  public static validate(data: Partial<FinanceTaxesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
