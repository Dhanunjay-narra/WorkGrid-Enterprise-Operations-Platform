export interface FinanceTaxesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesRuleValidator {
  public static validate(data: Partial<FinanceTaxesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
