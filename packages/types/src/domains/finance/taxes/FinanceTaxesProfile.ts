export interface FinanceTaxesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesProfileValidator {
  public static validate(data: Partial<FinanceTaxesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
