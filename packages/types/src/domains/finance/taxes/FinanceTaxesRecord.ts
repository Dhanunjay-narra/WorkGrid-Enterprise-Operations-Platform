export interface FinanceTaxesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesRecordValidator {
  public static validate(data: Partial<FinanceTaxesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
