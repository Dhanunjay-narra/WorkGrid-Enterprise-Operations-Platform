export interface FinanceTaxesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesScheduleValidator {
  public static validate(data: Partial<FinanceTaxesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
