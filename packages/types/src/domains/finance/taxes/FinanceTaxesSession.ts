export interface FinanceTaxesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesSessionValidator {
  public static validate(data: Partial<FinanceTaxesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
