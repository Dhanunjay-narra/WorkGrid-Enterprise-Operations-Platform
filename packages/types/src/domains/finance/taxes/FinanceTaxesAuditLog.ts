export interface FinanceTaxesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceTaxesAuditLogValidator {
  public static validate(data: Partial<FinanceTaxesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
