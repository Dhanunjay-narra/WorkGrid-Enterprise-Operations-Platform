export interface FinanceBankingSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingSummaryValidator {
  public static validate(data: Partial<FinanceBankingSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
