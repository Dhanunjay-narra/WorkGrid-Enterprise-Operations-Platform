export interface FinanceBankingAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingAuditLogValidator {
  public static validate(data: Partial<FinanceBankingAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
