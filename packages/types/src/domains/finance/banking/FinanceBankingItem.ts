export interface FinanceBankingItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingItemValidator {
  public static validate(data: Partial<FinanceBankingItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
