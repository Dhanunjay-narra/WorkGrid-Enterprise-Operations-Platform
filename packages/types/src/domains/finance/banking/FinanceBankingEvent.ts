export interface FinanceBankingEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingEventValidator {
  public static validate(data: Partial<FinanceBankingEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
