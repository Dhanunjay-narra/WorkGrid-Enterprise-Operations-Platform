export interface FinanceBankingRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingRecordValidator {
  public static validate(data: Partial<FinanceBankingRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
