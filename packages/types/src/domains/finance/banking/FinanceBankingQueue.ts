export interface FinanceBankingQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingQueueValidator {
  public static validate(data: Partial<FinanceBankingQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
