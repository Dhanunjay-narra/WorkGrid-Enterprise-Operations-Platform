export interface FinanceBankingRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingRuleValidator {
  public static validate(data: Partial<FinanceBankingRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
