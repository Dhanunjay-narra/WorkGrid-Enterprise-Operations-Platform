export interface FinanceBankingMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingMappingValidator {
  public static validate(data: Partial<FinanceBankingMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
