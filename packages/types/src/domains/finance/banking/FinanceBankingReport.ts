export interface FinanceBankingReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingReportValidator {
  public static validate(data: Partial<FinanceBankingReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
