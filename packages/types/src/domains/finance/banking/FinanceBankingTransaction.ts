export interface FinanceBankingTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingTransactionValidator {
  public static validate(data: Partial<FinanceBankingTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
