export interface FinanceBankingNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingNodeValidator {
  public static validate(data: Partial<FinanceBankingNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
