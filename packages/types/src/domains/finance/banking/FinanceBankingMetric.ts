export interface FinanceBankingMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingMetricValidator {
  public static validate(data: Partial<FinanceBankingMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
