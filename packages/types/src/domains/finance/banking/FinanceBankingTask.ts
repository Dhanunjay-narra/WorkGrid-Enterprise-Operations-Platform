export interface FinanceBankingTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingTaskValidator {
  public static validate(data: Partial<FinanceBankingTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
