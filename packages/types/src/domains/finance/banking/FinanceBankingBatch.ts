export interface FinanceBankingBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingBatchValidator {
  public static validate(data: Partial<FinanceBankingBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
