export interface FinanceBankingProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingProfileValidator {
  public static validate(data: Partial<FinanceBankingProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
