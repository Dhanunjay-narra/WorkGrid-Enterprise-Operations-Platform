export interface FinanceBankingSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingSessionValidator {
  public static validate(data: Partial<FinanceBankingSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
