export interface FinanceBankingScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingScheduleValidator {
  public static validate(data: Partial<FinanceBankingScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
