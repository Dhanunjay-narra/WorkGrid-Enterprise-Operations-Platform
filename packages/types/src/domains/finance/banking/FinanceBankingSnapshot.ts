export interface FinanceBankingSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingSnapshotValidator {
  public static validate(data: Partial<FinanceBankingSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
