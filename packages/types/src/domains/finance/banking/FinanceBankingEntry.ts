export interface FinanceBankingEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingEntryValidator {
  public static validate(data: Partial<FinanceBankingEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
