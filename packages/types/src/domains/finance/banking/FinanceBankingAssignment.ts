export interface FinanceBankingAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingAssignmentValidator {
  public static validate(data: Partial<FinanceBankingAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
