export interface FinanceBankingThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingThresholdValidator {
  public static validate(data: Partial<FinanceBankingThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
