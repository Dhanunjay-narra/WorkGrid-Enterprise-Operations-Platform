export interface FinanceBankingConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingConfigValidator {
  public static validate(data: Partial<FinanceBankingConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
