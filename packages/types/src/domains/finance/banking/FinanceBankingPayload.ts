export interface FinanceBankingPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingPayloadValidator {
  public static validate(data: Partial<FinanceBankingPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
