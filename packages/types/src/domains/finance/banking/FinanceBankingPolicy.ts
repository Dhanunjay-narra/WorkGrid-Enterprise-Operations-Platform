export interface FinanceBankingPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingPolicyValidator {
  public static validate(data: Partial<FinanceBankingPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
