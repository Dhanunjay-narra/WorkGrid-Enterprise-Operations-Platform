export interface FinanceBankingStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBankingStateValidator {
  public static validate(data: Partial<FinanceBankingStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
