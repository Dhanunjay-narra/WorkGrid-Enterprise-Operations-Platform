export interface FinanceLedgerRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerRecordValidator {
  public static validate(data: Partial<FinanceLedgerRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
