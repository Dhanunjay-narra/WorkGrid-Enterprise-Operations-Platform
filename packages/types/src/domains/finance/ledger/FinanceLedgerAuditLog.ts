export interface FinanceLedgerAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerAuditLogValidator {
  public static validate(data: Partial<FinanceLedgerAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
