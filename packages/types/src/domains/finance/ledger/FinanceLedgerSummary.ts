export interface FinanceLedgerSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerSummaryValidator {
  public static validate(data: Partial<FinanceLedgerSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
