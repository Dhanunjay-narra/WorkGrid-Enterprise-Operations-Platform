export interface FinanceLedgerRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerRuleValidator {
  public static validate(data: Partial<FinanceLedgerRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
