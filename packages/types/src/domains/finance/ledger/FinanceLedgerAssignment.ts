export interface FinanceLedgerAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerAssignmentValidator {
  public static validate(data: Partial<FinanceLedgerAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
