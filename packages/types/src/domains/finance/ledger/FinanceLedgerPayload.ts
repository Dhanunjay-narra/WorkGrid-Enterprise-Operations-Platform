export interface FinanceLedgerPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerPayloadValidator {
  public static validate(data: Partial<FinanceLedgerPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
