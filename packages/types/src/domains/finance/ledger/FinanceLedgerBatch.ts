export interface FinanceLedgerBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerBatchValidator {
  public static validate(data: Partial<FinanceLedgerBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
