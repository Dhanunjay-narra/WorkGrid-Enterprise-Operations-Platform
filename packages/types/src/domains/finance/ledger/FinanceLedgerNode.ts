export interface FinanceLedgerNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerNodeValidator {
  public static validate(data: Partial<FinanceLedgerNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
