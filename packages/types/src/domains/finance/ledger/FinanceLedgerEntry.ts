export interface FinanceLedgerEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerEntryValidator {
  public static validate(data: Partial<FinanceLedgerEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
