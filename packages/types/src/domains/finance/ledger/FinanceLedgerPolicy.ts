export interface FinanceLedgerPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerPolicyValidator {
  public static validate(data: Partial<FinanceLedgerPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
