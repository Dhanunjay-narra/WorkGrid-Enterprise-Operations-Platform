export interface FinanceLedgerMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerMappingValidator {
  public static validate(data: Partial<FinanceLedgerMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
