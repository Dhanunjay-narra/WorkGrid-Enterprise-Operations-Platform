export interface FinanceLedgerTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerTransactionValidator {
  public static validate(data: Partial<FinanceLedgerTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
