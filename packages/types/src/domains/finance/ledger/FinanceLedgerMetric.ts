export interface FinanceLedgerMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerMetricValidator {
  public static validate(data: Partial<FinanceLedgerMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
