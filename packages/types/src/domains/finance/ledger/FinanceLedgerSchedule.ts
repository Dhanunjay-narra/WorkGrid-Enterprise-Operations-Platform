export interface FinanceLedgerScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerScheduleValidator {
  public static validate(data: Partial<FinanceLedgerScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
