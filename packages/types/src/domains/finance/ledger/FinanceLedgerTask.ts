export interface FinanceLedgerTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerTaskValidator {
  public static validate(data: Partial<FinanceLedgerTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
