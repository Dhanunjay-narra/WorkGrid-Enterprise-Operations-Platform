export interface FinanceLedgerStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerStateValidator {
  public static validate(data: Partial<FinanceLedgerStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
