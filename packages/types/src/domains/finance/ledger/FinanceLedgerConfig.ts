export interface FinanceLedgerConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerConfigValidator {
  public static validate(data: Partial<FinanceLedgerConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
