export interface FinanceLedgerThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerThresholdValidator {
  public static validate(data: Partial<FinanceLedgerThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
