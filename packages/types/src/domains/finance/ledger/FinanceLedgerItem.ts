export interface FinanceLedgerItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerItemValidator {
  public static validate(data: Partial<FinanceLedgerItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
