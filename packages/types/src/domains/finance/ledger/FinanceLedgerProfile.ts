export interface FinanceLedgerProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerProfileValidator {
  public static validate(data: Partial<FinanceLedgerProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
