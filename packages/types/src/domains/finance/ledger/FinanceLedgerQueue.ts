export interface FinanceLedgerQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerQueueValidator {
  public static validate(data: Partial<FinanceLedgerQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
