export interface FinanceLedgerSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerSessionValidator {
  public static validate(data: Partial<FinanceLedgerSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
