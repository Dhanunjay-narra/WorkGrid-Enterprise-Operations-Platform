export interface FinanceLedgerSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerSnapshotValidator {
  public static validate(data: Partial<FinanceLedgerSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
