export interface FinanceLedgerReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceLedgerReportValidator {
  public static validate(data: Partial<FinanceLedgerReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
