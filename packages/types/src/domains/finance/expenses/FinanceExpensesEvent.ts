export interface FinanceExpensesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesEventValidator {
  public static validate(data: Partial<FinanceExpensesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
