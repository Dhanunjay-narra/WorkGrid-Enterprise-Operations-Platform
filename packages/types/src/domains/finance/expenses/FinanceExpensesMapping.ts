export interface FinanceExpensesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesMappingValidator {
  public static validate(data: Partial<FinanceExpensesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
