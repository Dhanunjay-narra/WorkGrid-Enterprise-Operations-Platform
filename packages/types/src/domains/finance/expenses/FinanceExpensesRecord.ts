export interface FinanceExpensesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesRecordValidator {
  public static validate(data: Partial<FinanceExpensesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
