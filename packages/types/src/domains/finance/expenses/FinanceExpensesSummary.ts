export interface FinanceExpensesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesSummaryValidator {
  public static validate(data: Partial<FinanceExpensesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
