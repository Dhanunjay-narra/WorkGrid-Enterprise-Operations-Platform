export interface FinanceExpensesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesSnapshotValidator {
  public static validate(data: Partial<FinanceExpensesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
