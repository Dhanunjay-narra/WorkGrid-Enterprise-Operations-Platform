export interface FinanceExpensesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesTransactionValidator {
  public static validate(data: Partial<FinanceExpensesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
