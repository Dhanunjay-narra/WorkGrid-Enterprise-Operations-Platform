export interface FinanceExpensesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesReportValidator {
  public static validate(data: Partial<FinanceExpensesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
