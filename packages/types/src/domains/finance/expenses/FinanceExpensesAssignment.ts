export interface FinanceExpensesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesAssignmentValidator {
  public static validate(data: Partial<FinanceExpensesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
