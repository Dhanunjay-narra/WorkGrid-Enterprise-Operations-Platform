export interface FinanceExpensesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesQueueValidator {
  public static validate(data: Partial<FinanceExpensesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
