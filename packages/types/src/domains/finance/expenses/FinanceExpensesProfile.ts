export interface FinanceExpensesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesProfileValidator {
  public static validate(data: Partial<FinanceExpensesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
