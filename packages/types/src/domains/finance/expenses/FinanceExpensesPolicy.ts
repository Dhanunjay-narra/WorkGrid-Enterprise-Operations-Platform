export interface FinanceExpensesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesPolicyValidator {
  public static validate(data: Partial<FinanceExpensesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
