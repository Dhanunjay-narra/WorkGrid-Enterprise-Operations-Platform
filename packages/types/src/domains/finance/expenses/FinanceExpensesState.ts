export interface FinanceExpensesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesStateValidator {
  public static validate(data: Partial<FinanceExpensesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
