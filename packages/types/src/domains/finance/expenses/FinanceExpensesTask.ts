export interface FinanceExpensesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesTaskValidator {
  public static validate(data: Partial<FinanceExpensesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
