export interface FinanceExpensesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesBatchValidator {
  public static validate(data: Partial<FinanceExpensesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
