export interface FinanceExpensesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesItemValidator {
  public static validate(data: Partial<FinanceExpensesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
