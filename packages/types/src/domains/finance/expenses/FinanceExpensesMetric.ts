export interface FinanceExpensesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesMetricValidator {
  public static validate(data: Partial<FinanceExpensesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
