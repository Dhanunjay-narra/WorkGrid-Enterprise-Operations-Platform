export interface FinanceExpensesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesPayloadValidator {
  public static validate(data: Partial<FinanceExpensesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
