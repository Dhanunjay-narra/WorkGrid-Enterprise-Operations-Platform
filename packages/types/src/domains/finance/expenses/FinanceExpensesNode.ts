export interface FinanceExpensesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesNodeValidator {
  public static validate(data: Partial<FinanceExpensesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
