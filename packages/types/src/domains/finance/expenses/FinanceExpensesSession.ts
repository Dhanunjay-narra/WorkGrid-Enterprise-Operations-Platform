export interface FinanceExpensesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesSessionValidator {
  public static validate(data: Partial<FinanceExpensesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
