export interface FinanceExpensesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesThresholdValidator {
  public static validate(data: Partial<FinanceExpensesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
