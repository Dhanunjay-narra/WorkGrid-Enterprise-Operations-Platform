export interface FinanceExpensesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesAuditLogValidator {
  public static validate(data: Partial<FinanceExpensesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
