export interface FinanceExpensesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesEntryValidator {
  public static validate(data: Partial<FinanceExpensesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
