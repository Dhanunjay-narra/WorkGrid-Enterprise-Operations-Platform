export interface FinanceExpensesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesConfigValidator {
  public static validate(data: Partial<FinanceExpensesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
