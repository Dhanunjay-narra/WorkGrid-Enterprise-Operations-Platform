export interface FinanceExpensesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesScheduleValidator {
  public static validate(data: Partial<FinanceExpensesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
