export interface FinanceExpensesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceExpensesRuleValidator {
  public static validate(data: Partial<FinanceExpensesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
