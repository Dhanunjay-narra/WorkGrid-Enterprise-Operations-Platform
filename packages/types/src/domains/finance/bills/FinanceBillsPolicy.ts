export interface FinanceBillsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsPolicyValidator {
  public static validate(data: Partial<FinanceBillsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
