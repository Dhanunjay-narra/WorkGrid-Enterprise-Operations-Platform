export interface FinanceBillsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsMetricValidator {
  public static validate(data: Partial<FinanceBillsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
