export interface FinanceBillsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsItemValidator {
  public static validate(data: Partial<FinanceBillsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
