export interface FinanceBillsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsPayloadValidator {
  public static validate(data: Partial<FinanceBillsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
