export interface FinanceBillsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsNodeValidator {
  public static validate(data: Partial<FinanceBillsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
