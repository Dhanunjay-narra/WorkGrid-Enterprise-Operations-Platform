export interface FinanceBillsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsProfileValidator {
  public static validate(data: Partial<FinanceBillsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
