export interface FinanceBillsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsAssignmentValidator {
  public static validate(data: Partial<FinanceBillsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
