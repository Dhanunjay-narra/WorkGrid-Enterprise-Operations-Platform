export interface FinanceBillsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsBatchValidator {
  public static validate(data: Partial<FinanceBillsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
