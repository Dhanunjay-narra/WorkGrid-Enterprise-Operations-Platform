export interface FinanceBillsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsRuleValidator {
  public static validate(data: Partial<FinanceBillsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
