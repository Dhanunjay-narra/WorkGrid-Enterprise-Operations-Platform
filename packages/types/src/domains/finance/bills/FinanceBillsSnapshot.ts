export interface FinanceBillsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsSnapshotValidator {
  public static validate(data: Partial<FinanceBillsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
