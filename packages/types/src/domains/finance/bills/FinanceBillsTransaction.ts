export interface FinanceBillsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsTransactionValidator {
  public static validate(data: Partial<FinanceBillsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
