export interface FinanceBillsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsScheduleValidator {
  public static validate(data: Partial<FinanceBillsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
