export interface FinanceBillsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsConfigValidator {
  public static validate(data: Partial<FinanceBillsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
