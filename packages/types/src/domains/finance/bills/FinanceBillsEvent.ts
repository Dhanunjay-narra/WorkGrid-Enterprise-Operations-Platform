export interface FinanceBillsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsEventValidator {
  public static validate(data: Partial<FinanceBillsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
