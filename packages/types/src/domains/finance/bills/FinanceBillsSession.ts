export interface FinanceBillsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsSessionValidator {
  public static validate(data: Partial<FinanceBillsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
