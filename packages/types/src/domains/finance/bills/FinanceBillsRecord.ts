export interface FinanceBillsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsRecordValidator {
  public static validate(data: Partial<FinanceBillsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
