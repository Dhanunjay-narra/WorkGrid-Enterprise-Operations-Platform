export interface FinanceBillsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsMappingValidator {
  public static validate(data: Partial<FinanceBillsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
