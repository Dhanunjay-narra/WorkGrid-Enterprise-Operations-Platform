export interface FinanceBillsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsReportValidator {
  public static validate(data: Partial<FinanceBillsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
