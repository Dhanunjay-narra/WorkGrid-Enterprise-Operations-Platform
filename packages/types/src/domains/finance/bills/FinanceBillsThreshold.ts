export interface FinanceBillsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsThresholdValidator {
  public static validate(data: Partial<FinanceBillsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
