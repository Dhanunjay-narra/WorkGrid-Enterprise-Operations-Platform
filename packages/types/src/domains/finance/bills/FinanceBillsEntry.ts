export interface FinanceBillsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsEntryValidator {
  public static validate(data: Partial<FinanceBillsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
