export interface FinanceBillsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsAuditLogValidator {
  public static validate(data: Partial<FinanceBillsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
