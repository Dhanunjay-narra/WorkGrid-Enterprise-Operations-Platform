export interface FinanceBillsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsSummaryValidator {
  public static validate(data: Partial<FinanceBillsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
