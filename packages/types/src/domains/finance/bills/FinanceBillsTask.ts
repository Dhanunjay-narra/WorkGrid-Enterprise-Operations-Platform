export interface FinanceBillsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsTaskValidator {
  public static validate(data: Partial<FinanceBillsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
