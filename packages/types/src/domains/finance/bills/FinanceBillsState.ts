export interface FinanceBillsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsStateValidator {
  public static validate(data: Partial<FinanceBillsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
