export interface FinanceBillsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class FinanceBillsQueueValidator {
  public static validate(data: Partial<FinanceBillsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
