export interface AiEmbeddingsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsMappingValidator {
  public static validate(data: Partial<AiEmbeddingsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
