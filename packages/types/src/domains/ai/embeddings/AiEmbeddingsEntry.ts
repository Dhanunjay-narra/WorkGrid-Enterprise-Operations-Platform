export interface AiEmbeddingsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsEntryValidator {
  public static validate(data: Partial<AiEmbeddingsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
