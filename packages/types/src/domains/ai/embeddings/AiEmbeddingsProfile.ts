export interface AiEmbeddingsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsProfileValidator {
  public static validate(data: Partial<AiEmbeddingsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
