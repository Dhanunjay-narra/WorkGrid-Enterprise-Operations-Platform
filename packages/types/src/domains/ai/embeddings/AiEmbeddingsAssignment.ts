export interface AiEmbeddingsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsAssignmentValidator {
  public static validate(data: Partial<AiEmbeddingsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
