export interface AiEmbeddingsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsSessionValidator {
  public static validate(data: Partial<AiEmbeddingsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
