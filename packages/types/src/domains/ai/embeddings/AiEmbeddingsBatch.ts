export interface AiEmbeddingsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsBatchValidator {
  public static validate(data: Partial<AiEmbeddingsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
