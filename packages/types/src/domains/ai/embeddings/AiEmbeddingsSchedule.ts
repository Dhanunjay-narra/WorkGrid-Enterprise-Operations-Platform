export interface AiEmbeddingsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsScheduleValidator {
  public static validate(data: Partial<AiEmbeddingsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
