export interface AiEmbeddingsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsPayloadValidator {
  public static validate(data: Partial<AiEmbeddingsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
