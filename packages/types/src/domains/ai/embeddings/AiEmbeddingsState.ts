export interface AiEmbeddingsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsStateValidator {
  public static validate(data: Partial<AiEmbeddingsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
