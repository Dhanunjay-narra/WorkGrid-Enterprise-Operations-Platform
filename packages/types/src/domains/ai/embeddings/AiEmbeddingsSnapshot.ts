export interface AiEmbeddingsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsSnapshotValidator {
  public static validate(data: Partial<AiEmbeddingsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
