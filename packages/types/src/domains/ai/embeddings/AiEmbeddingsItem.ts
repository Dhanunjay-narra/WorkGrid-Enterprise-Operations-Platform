export interface AiEmbeddingsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsItemValidator {
  public static validate(data: Partial<AiEmbeddingsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
