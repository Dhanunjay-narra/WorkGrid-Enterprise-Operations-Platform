export interface AiEmbeddingsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsEventValidator {
  public static validate(data: Partial<AiEmbeddingsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
