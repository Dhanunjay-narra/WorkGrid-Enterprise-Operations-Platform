export interface AiEmbeddingsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsTransactionValidator {
  public static validate(data: Partial<AiEmbeddingsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
