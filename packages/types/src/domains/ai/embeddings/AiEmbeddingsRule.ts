export interface AiEmbeddingsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsRuleValidator {
  public static validate(data: Partial<AiEmbeddingsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
