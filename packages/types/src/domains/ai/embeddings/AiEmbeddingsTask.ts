export interface AiEmbeddingsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsTaskValidator {
  public static validate(data: Partial<AiEmbeddingsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
