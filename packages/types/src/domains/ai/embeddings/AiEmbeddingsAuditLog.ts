export interface AiEmbeddingsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsAuditLogValidator {
  public static validate(data: Partial<AiEmbeddingsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
