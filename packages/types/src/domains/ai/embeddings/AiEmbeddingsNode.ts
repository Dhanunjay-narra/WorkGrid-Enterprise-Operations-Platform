export interface AiEmbeddingsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsNodeValidator {
  public static validate(data: Partial<AiEmbeddingsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
