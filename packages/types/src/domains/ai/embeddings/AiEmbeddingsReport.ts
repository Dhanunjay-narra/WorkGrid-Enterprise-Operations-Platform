export interface AiEmbeddingsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsReportValidator {
  public static validate(data: Partial<AiEmbeddingsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
