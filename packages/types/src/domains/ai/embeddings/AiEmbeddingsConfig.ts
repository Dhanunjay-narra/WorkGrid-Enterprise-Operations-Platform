export interface AiEmbeddingsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsConfigValidator {
  public static validate(data: Partial<AiEmbeddingsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
