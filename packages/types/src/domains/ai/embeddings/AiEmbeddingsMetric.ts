export interface AiEmbeddingsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsMetricValidator {
  public static validate(data: Partial<AiEmbeddingsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
