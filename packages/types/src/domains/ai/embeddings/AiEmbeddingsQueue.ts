export interface AiEmbeddingsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsQueueValidator {
  public static validate(data: Partial<AiEmbeddingsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
