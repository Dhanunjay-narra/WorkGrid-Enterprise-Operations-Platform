export interface AiEmbeddingsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsThresholdValidator {
  public static validate(data: Partial<AiEmbeddingsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
