export interface AiEmbeddingsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsPolicyValidator {
  public static validate(data: Partial<AiEmbeddingsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
