export interface AiEmbeddingsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEmbeddingsSummaryValidator {
  public static validate(data: Partial<AiEmbeddingsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
