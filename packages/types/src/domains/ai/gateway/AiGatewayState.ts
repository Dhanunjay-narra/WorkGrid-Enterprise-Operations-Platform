export interface AiGatewayStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayStateValidator {
  public static validate(data: Partial<AiGatewayStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
