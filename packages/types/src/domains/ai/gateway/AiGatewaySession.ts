export interface AiGatewaySessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewaySessionValidator {
  public static validate(data: Partial<AiGatewaySessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
