export interface AiGatewayTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayTaskValidator {
  public static validate(data: Partial<AiGatewayTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
