export interface AiGatewayAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayAuditLogValidator {
  public static validate(data: Partial<AiGatewayAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
