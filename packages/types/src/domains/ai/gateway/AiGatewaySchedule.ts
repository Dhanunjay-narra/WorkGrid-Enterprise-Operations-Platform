export interface AiGatewayScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayScheduleValidator {
  public static validate(data: Partial<AiGatewayScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
