export interface AiGatewayTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayTransactionValidator {
  public static validate(data: Partial<AiGatewayTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
