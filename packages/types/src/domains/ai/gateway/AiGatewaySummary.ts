export interface AiGatewaySummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewaySummaryValidator {
  public static validate(data: Partial<AiGatewaySummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
