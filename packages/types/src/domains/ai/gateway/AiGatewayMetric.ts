export interface AiGatewayMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayMetricValidator {
  public static validate(data: Partial<AiGatewayMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
