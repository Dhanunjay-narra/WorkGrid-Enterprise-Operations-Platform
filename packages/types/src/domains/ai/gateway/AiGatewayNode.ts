export interface AiGatewayNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayNodeValidator {
  public static validate(data: Partial<AiGatewayNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
