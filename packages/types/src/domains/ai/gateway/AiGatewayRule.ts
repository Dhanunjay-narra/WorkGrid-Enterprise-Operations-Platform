export interface AiGatewayRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayRuleValidator {
  public static validate(data: Partial<AiGatewayRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
