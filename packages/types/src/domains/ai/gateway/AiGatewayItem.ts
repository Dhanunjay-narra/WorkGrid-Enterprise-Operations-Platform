export interface AiGatewayItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayItemValidator {
  public static validate(data: Partial<AiGatewayItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
