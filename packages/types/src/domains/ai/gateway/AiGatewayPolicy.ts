export interface AiGatewayPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayPolicyValidator {
  public static validate(data: Partial<AiGatewayPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
