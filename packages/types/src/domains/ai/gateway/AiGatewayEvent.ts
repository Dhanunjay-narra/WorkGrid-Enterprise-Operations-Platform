export interface AiGatewayEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayEventValidator {
  public static validate(data: Partial<AiGatewayEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
