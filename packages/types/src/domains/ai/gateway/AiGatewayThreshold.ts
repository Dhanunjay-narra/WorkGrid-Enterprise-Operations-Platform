export interface AiGatewayThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayThresholdValidator {
  public static validate(data: Partial<AiGatewayThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
