export interface AiGatewayConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayConfigValidator {
  public static validate(data: Partial<AiGatewayConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
