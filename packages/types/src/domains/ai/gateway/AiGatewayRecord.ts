export interface AiGatewayRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayRecordValidator {
  public static validate(data: Partial<AiGatewayRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
