export interface AiGatewayReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayReportValidator {
  public static validate(data: Partial<AiGatewayReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
