export interface AiGatewayBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayBatchValidator {
  public static validate(data: Partial<AiGatewayBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
