export interface AiGatewayEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayEntryValidator {
  public static validate(data: Partial<AiGatewayEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
