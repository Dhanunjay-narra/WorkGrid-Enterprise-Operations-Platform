export interface AiGatewayMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayMappingValidator {
  public static validate(data: Partial<AiGatewayMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
