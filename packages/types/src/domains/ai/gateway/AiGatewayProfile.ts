export interface AiGatewayProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayProfileValidator {
  public static validate(data: Partial<AiGatewayProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
