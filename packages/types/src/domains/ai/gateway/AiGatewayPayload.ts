export interface AiGatewayPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayPayloadValidator {
  public static validate(data: Partial<AiGatewayPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
