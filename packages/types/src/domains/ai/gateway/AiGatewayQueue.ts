export interface AiGatewayQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayQueueValidator {
  public static validate(data: Partial<AiGatewayQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
