export interface AiGatewaySnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewaySnapshotValidator {
  public static validate(data: Partial<AiGatewaySnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
