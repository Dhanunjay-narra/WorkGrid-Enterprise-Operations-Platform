export interface AiGatewayAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiGatewayAssignmentValidator {
  public static validate(data: Partial<AiGatewayAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
