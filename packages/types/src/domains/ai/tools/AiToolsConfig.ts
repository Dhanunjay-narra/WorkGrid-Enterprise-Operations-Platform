export interface AiToolsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsConfigValidator {
  public static validate(data: Partial<AiToolsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
