export interface AiToolsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsBatchValidator {
  public static validate(data: Partial<AiToolsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
