export interface AiToolsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsSessionValidator {
  public static validate(data: Partial<AiToolsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
