export interface AiToolsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsMappingValidator {
  public static validate(data: Partial<AiToolsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
