export interface AiToolsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsSummaryValidator {
  public static validate(data: Partial<AiToolsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
