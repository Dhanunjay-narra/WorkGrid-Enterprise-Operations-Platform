export interface AiToolsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsStateValidator {
  public static validate(data: Partial<AiToolsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
