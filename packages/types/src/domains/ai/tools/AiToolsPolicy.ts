export interface AiToolsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsPolicyValidator {
  public static validate(data: Partial<AiToolsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
