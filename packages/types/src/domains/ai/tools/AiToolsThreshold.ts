export interface AiToolsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsThresholdValidator {
  public static validate(data: Partial<AiToolsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
