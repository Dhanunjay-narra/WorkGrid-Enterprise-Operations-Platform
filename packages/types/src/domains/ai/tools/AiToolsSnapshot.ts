export interface AiToolsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsSnapshotValidator {
  public static validate(data: Partial<AiToolsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
