export interface AiToolsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsProfileValidator {
  public static validate(data: Partial<AiToolsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
