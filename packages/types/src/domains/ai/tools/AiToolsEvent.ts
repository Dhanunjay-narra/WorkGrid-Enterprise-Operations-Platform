export interface AiToolsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsEventValidator {
  public static validate(data: Partial<AiToolsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
