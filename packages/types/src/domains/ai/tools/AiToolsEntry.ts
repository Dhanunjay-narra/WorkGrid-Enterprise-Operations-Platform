export interface AiToolsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsEntryValidator {
  public static validate(data: Partial<AiToolsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
