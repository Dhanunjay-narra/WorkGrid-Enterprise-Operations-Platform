export interface AiToolsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsAuditLogValidator {
  public static validate(data: Partial<AiToolsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
