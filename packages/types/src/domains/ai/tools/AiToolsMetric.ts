export interface AiToolsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsMetricValidator {
  public static validate(data: Partial<AiToolsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
