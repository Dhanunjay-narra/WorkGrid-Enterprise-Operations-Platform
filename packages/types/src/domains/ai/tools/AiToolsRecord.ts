export interface AiToolsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsRecordValidator {
  public static validate(data: Partial<AiToolsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
