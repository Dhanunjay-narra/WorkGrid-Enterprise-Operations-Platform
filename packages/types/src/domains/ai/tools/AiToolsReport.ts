export interface AiToolsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsReportValidator {
  public static validate(data: Partial<AiToolsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
