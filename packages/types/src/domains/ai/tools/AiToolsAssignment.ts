export interface AiToolsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsAssignmentValidator {
  public static validate(data: Partial<AiToolsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
