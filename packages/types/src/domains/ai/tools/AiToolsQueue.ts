export interface AiToolsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsQueueValidator {
  public static validate(data: Partial<AiToolsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
