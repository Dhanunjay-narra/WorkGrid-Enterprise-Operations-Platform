export interface AiToolsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsTransactionValidator {
  public static validate(data: Partial<AiToolsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
