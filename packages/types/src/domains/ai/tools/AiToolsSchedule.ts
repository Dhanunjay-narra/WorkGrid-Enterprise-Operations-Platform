export interface AiToolsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsScheduleValidator {
  public static validate(data: Partial<AiToolsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
