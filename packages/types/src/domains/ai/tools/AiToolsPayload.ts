export interface AiToolsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiToolsPayloadValidator {
  public static validate(data: Partial<AiToolsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
