export interface AiEvaluationsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsPolicyValidator {
  public static validate(data: Partial<AiEvaluationsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
