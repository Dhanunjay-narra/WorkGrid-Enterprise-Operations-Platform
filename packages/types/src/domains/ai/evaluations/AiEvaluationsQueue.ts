export interface AiEvaluationsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsQueueValidator {
  public static validate(data: Partial<AiEvaluationsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
