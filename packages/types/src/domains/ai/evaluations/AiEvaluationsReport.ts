export interface AiEvaluationsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsReportValidator {
  public static validate(data: Partial<AiEvaluationsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
