export interface AiEvaluationsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsRuleValidator {
  public static validate(data: Partial<AiEvaluationsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
