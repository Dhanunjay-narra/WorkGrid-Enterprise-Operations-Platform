export interface AiEvaluationsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsPayloadValidator {
  public static validate(data: Partial<AiEvaluationsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
