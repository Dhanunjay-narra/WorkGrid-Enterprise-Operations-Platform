export interface AiEvaluationsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsTaskValidator {
  public static validate(data: Partial<AiEvaluationsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
