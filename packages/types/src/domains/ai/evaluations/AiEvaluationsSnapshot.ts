export interface AiEvaluationsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsSnapshotValidator {
  public static validate(data: Partial<AiEvaluationsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
