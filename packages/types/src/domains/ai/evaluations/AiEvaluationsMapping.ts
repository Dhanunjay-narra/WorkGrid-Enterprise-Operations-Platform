export interface AiEvaluationsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsMappingValidator {
  public static validate(data: Partial<AiEvaluationsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
