export interface AiEvaluationsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsBatchValidator {
  public static validate(data: Partial<AiEvaluationsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
