export interface AiEvaluationsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsSessionValidator {
  public static validate(data: Partial<AiEvaluationsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
