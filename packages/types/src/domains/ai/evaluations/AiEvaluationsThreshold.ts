export interface AiEvaluationsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsThresholdValidator {
  public static validate(data: Partial<AiEvaluationsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
