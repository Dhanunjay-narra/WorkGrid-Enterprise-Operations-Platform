export interface AiEvaluationsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsItemValidator {
  public static validate(data: Partial<AiEvaluationsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
