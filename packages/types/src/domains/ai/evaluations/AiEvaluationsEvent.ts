export interface AiEvaluationsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsEventValidator {
  public static validate(data: Partial<AiEvaluationsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
