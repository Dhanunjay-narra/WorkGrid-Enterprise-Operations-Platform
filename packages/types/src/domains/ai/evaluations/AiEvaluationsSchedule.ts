export interface AiEvaluationsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsScheduleValidator {
  public static validate(data: Partial<AiEvaluationsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
