export interface AiEvaluationsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsNodeValidator {
  public static validate(data: Partial<AiEvaluationsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
