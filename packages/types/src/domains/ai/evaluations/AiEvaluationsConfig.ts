export interface AiEvaluationsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsConfigValidator {
  public static validate(data: Partial<AiEvaluationsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
