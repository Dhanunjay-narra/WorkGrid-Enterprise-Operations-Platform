export interface AiEvaluationsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsProfileValidator {
  public static validate(data: Partial<AiEvaluationsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
