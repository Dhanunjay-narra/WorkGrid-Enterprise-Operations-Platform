export interface AiEvaluationsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsMetricValidator {
  public static validate(data: Partial<AiEvaluationsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
