export interface AiEvaluationsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsAssignmentValidator {
  public static validate(data: Partial<AiEvaluationsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
