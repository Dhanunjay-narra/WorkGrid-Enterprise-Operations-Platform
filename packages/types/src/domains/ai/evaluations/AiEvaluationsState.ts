export interface AiEvaluationsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsStateValidator {
  public static validate(data: Partial<AiEvaluationsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
