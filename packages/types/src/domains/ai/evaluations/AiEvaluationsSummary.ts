export interface AiEvaluationsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsSummaryValidator {
  public static validate(data: Partial<AiEvaluationsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
