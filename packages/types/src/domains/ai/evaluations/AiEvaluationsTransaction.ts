export interface AiEvaluationsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsTransactionValidator {
  public static validate(data: Partial<AiEvaluationsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
