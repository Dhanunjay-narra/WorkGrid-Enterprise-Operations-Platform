export interface AiEvaluationsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsAuditLogValidator {
  public static validate(data: Partial<AiEvaluationsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
