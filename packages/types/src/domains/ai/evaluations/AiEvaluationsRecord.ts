export interface AiEvaluationsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsRecordValidator {
  public static validate(data: Partial<AiEvaluationsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
