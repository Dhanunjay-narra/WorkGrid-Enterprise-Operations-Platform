export interface AiEvaluationsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiEvaluationsEntryValidator {
  public static validate(data: Partial<AiEvaluationsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
