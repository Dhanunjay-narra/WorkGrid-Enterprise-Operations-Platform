export interface AiRagPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiRagPayloadValidator {
  public static validate(data: Partial<AiRagPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
