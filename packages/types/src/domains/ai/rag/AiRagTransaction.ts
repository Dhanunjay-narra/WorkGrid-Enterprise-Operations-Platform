export interface AiRagTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiRagTransactionValidator {
  public static validate(data: Partial<AiRagTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
