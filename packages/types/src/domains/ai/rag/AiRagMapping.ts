export interface AiRagMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiRagMappingValidator {
  public static validate(data: Partial<AiRagMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
