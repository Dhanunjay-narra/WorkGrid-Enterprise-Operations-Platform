export interface AiRagAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiRagAuditLogValidator {
  public static validate(data: Partial<AiRagAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
