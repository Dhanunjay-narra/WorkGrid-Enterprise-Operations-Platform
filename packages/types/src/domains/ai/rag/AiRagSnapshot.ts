export interface AiRagSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiRagSnapshotValidator {
  public static validate(data: Partial<AiRagSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
