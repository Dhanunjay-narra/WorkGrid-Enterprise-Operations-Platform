export interface AiRagThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiRagThresholdValidator {
  public static validate(data: Partial<AiRagThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
