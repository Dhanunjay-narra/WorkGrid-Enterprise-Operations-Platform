export interface AiRagProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiRagProfileValidator {
  public static validate(data: Partial<AiRagProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
