export interface AiRagSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiRagSummaryValidator {
  public static validate(data: Partial<AiRagSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
