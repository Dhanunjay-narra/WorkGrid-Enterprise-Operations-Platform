export interface AiRagAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiRagAssignmentValidator {
  public static validate(data: Partial<AiRagAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
