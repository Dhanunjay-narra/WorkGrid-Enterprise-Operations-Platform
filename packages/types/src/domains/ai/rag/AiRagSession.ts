export interface AiRagSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiRagSessionValidator {
  public static validate(data: Partial<AiRagSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
