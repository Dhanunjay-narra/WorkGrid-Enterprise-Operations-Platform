export interface AiRagScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiRagScheduleValidator {
  public static validate(data: Partial<AiRagScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
