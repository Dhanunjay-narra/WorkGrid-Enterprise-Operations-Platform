export interface AiPromptsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsRuleValidator {
  public static validate(data: Partial<AiPromptsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
