export interface AiPromptsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsMetricValidator {
  public static validate(data: Partial<AiPromptsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
