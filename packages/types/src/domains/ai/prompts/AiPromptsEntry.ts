export interface AiPromptsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsEntryValidator {
  public static validate(data: Partial<AiPromptsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
