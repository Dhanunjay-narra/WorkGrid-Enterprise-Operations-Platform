export interface AiPromptsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsProfileValidator {
  public static validate(data: Partial<AiPromptsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
