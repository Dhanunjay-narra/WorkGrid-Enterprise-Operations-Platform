export interface AiPromptsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsReportValidator {
  public static validate(data: Partial<AiPromptsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
