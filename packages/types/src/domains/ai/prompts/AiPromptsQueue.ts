export interface AiPromptsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsQueueValidator {
  public static validate(data: Partial<AiPromptsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
