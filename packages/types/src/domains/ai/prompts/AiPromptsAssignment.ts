export interface AiPromptsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsAssignmentValidator {
  public static validate(data: Partial<AiPromptsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
