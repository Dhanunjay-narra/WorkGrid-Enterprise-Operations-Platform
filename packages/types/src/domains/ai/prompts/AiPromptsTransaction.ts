export interface AiPromptsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsTransactionValidator {
  public static validate(data: Partial<AiPromptsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
