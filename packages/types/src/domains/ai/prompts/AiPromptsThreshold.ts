export interface AiPromptsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsThresholdValidator {
  public static validate(data: Partial<AiPromptsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
