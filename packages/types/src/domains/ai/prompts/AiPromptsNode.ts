export interface AiPromptsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsNodeValidator {
  public static validate(data: Partial<AiPromptsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
