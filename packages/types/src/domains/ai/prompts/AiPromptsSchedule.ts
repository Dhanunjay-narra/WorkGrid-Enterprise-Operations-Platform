export interface AiPromptsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsScheduleValidator {
  public static validate(data: Partial<AiPromptsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
