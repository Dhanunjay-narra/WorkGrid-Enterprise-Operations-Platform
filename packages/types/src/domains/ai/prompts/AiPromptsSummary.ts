export interface AiPromptsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsSummaryValidator {
  public static validate(data: Partial<AiPromptsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
