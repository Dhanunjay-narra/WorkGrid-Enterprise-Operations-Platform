export interface AiPromptsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsSnapshotValidator {
  public static validate(data: Partial<AiPromptsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
