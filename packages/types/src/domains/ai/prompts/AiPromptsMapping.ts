export interface AiPromptsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsMappingValidator {
  public static validate(data: Partial<AiPromptsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
