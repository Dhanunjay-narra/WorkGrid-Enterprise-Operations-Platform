export interface AiPromptsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsTaskValidator {
  public static validate(data: Partial<AiPromptsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
