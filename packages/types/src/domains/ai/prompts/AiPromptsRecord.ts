export interface AiPromptsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsRecordValidator {
  public static validate(data: Partial<AiPromptsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
