export interface AiPromptsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsItemValidator {
  public static validate(data: Partial<AiPromptsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
