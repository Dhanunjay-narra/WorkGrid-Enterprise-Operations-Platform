export interface AiPromptsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsPayloadValidator {
  public static validate(data: Partial<AiPromptsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
