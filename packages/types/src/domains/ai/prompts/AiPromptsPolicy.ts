export interface AiPromptsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsPolicyValidator {
  public static validate(data: Partial<AiPromptsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
