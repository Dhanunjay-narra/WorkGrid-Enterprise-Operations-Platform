export interface AiPromptsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsEventValidator {
  public static validate(data: Partial<AiPromptsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
