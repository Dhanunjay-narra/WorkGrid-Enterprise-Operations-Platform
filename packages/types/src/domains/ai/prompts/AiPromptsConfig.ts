export interface AiPromptsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsConfigValidator {
  public static validate(data: Partial<AiPromptsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
