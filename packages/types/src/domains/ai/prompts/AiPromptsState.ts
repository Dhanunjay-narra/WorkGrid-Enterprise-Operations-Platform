export interface AiPromptsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsStateValidator {
  public static validate(data: Partial<AiPromptsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
