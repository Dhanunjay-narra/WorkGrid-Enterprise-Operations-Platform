export interface AiPromptsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsBatchValidator {
  public static validate(data: Partial<AiPromptsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
