export interface AiPromptsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsSessionValidator {
  public static validate(data: Partial<AiPromptsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
