export interface AiPromptsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiPromptsAuditLogValidator {
  public static validate(data: Partial<AiPromptsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
