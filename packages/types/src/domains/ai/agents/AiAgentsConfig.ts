export interface AiAgentsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsConfigValidator {
  public static validate(data: Partial<AiAgentsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
