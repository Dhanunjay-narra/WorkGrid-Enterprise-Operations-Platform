export interface AiAgentsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsTransactionValidator {
  public static validate(data: Partial<AiAgentsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
