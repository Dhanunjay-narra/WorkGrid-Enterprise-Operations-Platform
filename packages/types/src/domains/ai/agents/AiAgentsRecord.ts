export interface AiAgentsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsRecordValidator {
  public static validate(data: Partial<AiAgentsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
