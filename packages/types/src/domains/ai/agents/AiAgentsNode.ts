export interface AiAgentsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsNodeValidator {
  public static validate(data: Partial<AiAgentsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
