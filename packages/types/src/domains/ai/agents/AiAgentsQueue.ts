export interface AiAgentsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsQueueValidator {
  public static validate(data: Partial<AiAgentsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
