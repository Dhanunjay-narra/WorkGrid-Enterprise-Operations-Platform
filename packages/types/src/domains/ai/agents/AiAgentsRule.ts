export interface AiAgentsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsRuleValidator {
  public static validate(data: Partial<AiAgentsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
