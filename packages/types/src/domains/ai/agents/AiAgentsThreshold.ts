export interface AiAgentsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsThresholdValidator {
  public static validate(data: Partial<AiAgentsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
