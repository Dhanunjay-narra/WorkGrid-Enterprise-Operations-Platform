export interface AiAgentsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsReportValidator {
  public static validate(data: Partial<AiAgentsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
