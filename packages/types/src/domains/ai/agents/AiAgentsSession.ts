export interface AiAgentsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsSessionValidator {
  public static validate(data: Partial<AiAgentsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
