export interface AiAgentsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsSnapshotValidator {
  public static validate(data: Partial<AiAgentsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
