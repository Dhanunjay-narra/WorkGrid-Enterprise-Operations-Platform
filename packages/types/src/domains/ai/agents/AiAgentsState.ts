export interface AiAgentsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsStateValidator {
  public static validate(data: Partial<AiAgentsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
