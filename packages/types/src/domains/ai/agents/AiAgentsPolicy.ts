export interface AiAgentsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsPolicyValidator {
  public static validate(data: Partial<AiAgentsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
