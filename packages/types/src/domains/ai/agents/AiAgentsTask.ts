export interface AiAgentsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsTaskValidator {
  public static validate(data: Partial<AiAgentsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
