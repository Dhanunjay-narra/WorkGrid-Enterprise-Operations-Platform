export interface AiAgentsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsPayloadValidator {
  public static validate(data: Partial<AiAgentsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
