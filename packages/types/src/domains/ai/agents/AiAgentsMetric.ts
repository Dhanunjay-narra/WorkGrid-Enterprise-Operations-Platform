export interface AiAgentsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsMetricValidator {
  public static validate(data: Partial<AiAgentsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
