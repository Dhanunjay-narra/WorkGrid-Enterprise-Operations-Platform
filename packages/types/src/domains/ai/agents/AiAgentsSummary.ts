export interface AiAgentsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsSummaryValidator {
  public static validate(data: Partial<AiAgentsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
