export interface AiAgentsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsEventValidator {
  public static validate(data: Partial<AiAgentsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
