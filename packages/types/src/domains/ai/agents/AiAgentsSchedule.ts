export interface AiAgentsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsScheduleValidator {
  public static validate(data: Partial<AiAgentsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
