export interface AiAgentsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsAssignmentValidator {
  public static validate(data: Partial<AiAgentsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
