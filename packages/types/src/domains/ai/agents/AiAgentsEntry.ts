export interface AiAgentsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsEntryValidator {
  public static validate(data: Partial<AiAgentsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
