export interface AiAgentsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsAuditLogValidator {
  public static validate(data: Partial<AiAgentsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
