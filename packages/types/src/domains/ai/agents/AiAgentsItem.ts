export interface AiAgentsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsItemValidator {
  public static validate(data: Partial<AiAgentsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
