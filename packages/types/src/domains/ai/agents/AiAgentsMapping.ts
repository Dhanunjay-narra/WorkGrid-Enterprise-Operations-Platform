export interface AiAgentsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsMappingValidator {
  public static validate(data: Partial<AiAgentsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
