export interface AiAgentsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsBatchValidator {
  public static validate(data: Partial<AiAgentsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
