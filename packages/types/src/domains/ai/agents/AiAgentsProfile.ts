export interface AiAgentsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiAgentsProfileValidator {
  public static validate(data: Partial<AiAgentsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
