export interface AiMemoryEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryEntryValidator {
  public static validate(data: Partial<AiMemoryEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
