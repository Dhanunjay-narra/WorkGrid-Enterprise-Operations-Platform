export interface AiMemoryTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryTransactionValidator {
  public static validate(data: Partial<AiMemoryTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
