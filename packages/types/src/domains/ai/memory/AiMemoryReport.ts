export interface AiMemoryReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryReportValidator {
  public static validate(data: Partial<AiMemoryReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
