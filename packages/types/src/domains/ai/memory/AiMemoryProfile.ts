export interface AiMemoryProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryProfileValidator {
  public static validate(data: Partial<AiMemoryProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
