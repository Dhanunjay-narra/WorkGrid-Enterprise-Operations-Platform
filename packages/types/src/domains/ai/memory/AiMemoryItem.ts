export interface AiMemoryItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryItemValidator {
  public static validate(data: Partial<AiMemoryItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
