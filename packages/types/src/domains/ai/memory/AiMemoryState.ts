export interface AiMemoryStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryStateValidator {
  public static validate(data: Partial<AiMemoryStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
