export interface AiMemorySummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemorySummaryValidator {
  public static validate(data: Partial<AiMemorySummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
