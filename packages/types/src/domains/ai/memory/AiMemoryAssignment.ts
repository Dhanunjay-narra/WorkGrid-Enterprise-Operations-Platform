export interface AiMemoryAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryAssignmentValidator {
  public static validate(data: Partial<AiMemoryAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
