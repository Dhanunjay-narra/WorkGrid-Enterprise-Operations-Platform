export interface AiMemorySessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemorySessionValidator {
  public static validate(data: Partial<AiMemorySessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
