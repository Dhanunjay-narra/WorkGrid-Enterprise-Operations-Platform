export interface AiMemoryRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryRecordValidator {
  public static validate(data: Partial<AiMemoryRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
