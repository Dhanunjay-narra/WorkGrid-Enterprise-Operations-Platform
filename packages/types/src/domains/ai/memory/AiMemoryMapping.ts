export interface AiMemoryMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryMappingValidator {
  public static validate(data: Partial<AiMemoryMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
