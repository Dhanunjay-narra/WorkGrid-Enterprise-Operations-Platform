export interface AiMemoryRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryRuleValidator {
  public static validate(data: Partial<AiMemoryRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
