export interface AiMemorySnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemorySnapshotValidator {
  public static validate(data: Partial<AiMemorySnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
