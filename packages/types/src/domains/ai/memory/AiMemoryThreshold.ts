export interface AiMemoryThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryThresholdValidator {
  public static validate(data: Partial<AiMemoryThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
