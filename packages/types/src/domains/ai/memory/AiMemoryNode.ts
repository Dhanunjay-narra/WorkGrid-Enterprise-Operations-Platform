export interface AiMemoryNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryNodeValidator {
  public static validate(data: Partial<AiMemoryNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
