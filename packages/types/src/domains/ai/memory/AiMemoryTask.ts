export interface AiMemoryTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryTaskValidator {
  public static validate(data: Partial<AiMemoryTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
