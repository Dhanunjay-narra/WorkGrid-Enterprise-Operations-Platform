export interface AiMemoryQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryQueueValidator {
  public static validate(data: Partial<AiMemoryQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
