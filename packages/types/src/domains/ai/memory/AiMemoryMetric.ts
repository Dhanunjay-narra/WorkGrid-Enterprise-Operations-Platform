export interface AiMemoryMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryMetricValidator {
  public static validate(data: Partial<AiMemoryMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
