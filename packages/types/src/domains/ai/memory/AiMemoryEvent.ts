export interface AiMemoryEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryEventValidator {
  public static validate(data: Partial<AiMemoryEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
