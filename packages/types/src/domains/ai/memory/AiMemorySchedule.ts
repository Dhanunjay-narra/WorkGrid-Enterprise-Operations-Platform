export interface AiMemoryScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryScheduleValidator {
  public static validate(data: Partial<AiMemoryScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
