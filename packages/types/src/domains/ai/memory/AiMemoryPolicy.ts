export interface AiMemoryPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryPolicyValidator {
  public static validate(data: Partial<AiMemoryPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
