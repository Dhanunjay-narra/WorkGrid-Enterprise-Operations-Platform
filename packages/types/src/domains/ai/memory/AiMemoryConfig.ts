export interface AiMemoryConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryConfigValidator {
  public static validate(data: Partial<AiMemoryConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
