export interface AiMemoryPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryPayloadValidator {
  public static validate(data: Partial<AiMemoryPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
