export interface AiMemoryAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryAuditLogValidator {
  public static validate(data: Partial<AiMemoryAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
