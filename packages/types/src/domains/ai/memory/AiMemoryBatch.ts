export interface AiMemoryBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AiMemoryBatchValidator {
  public static validate(data: Partial<AiMemoryBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
