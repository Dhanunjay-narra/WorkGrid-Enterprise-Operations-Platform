export interface DmsSignaturesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesConfigValidator {
  public static validate(data: Partial<DmsSignaturesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
