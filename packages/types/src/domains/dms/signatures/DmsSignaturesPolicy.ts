export interface DmsSignaturesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesPolicyValidator {
  public static validate(data: Partial<DmsSignaturesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
