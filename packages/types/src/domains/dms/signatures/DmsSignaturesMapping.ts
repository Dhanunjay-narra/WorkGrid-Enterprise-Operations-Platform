export interface DmsSignaturesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesMappingValidator {
  public static validate(data: Partial<DmsSignaturesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
