export interface DmsSignaturesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesEntryValidator {
  public static validate(data: Partial<DmsSignaturesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
