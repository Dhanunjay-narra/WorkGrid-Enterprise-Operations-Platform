export interface DmsSignaturesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesScheduleValidator {
  public static validate(data: Partial<DmsSignaturesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
