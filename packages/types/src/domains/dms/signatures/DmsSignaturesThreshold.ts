export interface DmsSignaturesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesThresholdValidator {
  public static validate(data: Partial<DmsSignaturesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
