export interface DmsSignaturesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesPayloadValidator {
  public static validate(data: Partial<DmsSignaturesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
