export interface DmsSignaturesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesSnapshotValidator {
  public static validate(data: Partial<DmsSignaturesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
