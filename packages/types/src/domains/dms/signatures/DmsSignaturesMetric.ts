export interface DmsSignaturesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesMetricValidator {
  public static validate(data: Partial<DmsSignaturesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
