export interface DmsSignaturesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesRuleValidator {
  public static validate(data: Partial<DmsSignaturesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
