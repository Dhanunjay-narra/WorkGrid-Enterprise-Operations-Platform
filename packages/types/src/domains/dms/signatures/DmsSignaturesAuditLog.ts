export interface DmsSignaturesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesAuditLogValidator {
  public static validate(data: Partial<DmsSignaturesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
