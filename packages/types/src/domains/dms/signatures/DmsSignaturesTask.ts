export interface DmsSignaturesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesTaskValidator {
  public static validate(data: Partial<DmsSignaturesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
