export interface DmsSignaturesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesTransactionValidator {
  public static validate(data: Partial<DmsSignaturesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
