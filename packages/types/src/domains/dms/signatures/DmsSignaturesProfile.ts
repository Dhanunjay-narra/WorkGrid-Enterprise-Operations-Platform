export interface DmsSignaturesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesProfileValidator {
  public static validate(data: Partial<DmsSignaturesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
