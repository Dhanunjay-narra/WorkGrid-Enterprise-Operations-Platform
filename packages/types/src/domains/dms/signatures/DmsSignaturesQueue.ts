export interface DmsSignaturesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesQueueValidator {
  public static validate(data: Partial<DmsSignaturesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
