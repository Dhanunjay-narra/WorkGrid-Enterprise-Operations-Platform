export interface DmsSignaturesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesAssignmentValidator {
  public static validate(data: Partial<DmsSignaturesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
