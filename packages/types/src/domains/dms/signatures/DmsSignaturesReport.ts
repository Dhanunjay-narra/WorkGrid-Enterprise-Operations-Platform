export interface DmsSignaturesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesReportValidator {
  public static validate(data: Partial<DmsSignaturesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
