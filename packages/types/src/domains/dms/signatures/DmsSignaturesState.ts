export interface DmsSignaturesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesStateValidator {
  public static validate(data: Partial<DmsSignaturesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
