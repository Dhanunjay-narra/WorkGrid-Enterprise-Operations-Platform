export interface DmsSignaturesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesItemValidator {
  public static validate(data: Partial<DmsSignaturesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
