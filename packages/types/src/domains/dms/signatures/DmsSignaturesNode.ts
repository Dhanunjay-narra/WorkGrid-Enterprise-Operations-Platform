export interface DmsSignaturesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesNodeValidator {
  public static validate(data: Partial<DmsSignaturesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
