export interface DmsSignaturesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesEventValidator {
  public static validate(data: Partial<DmsSignaturesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
