export interface DmsSignaturesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesBatchValidator {
  public static validate(data: Partial<DmsSignaturesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
