export interface DmsSignaturesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesSessionValidator {
  public static validate(data: Partial<DmsSignaturesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
