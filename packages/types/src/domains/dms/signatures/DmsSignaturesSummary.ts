export interface DmsSignaturesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesSummaryValidator {
  public static validate(data: Partial<DmsSignaturesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
