export interface DmsSignaturesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsSignaturesRecordValidator {
  public static validate(data: Partial<DmsSignaturesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
