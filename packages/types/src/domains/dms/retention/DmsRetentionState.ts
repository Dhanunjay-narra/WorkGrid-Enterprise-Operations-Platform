export interface DmsRetentionStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionStateValidator {
  public static validate(data: Partial<DmsRetentionStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
