export interface DmsRetentionNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionNodeValidator {
  public static validate(data: Partial<DmsRetentionNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
