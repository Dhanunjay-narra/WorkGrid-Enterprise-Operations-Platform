export interface DmsRetentionEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionEventValidator {
  public static validate(data: Partial<DmsRetentionEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
