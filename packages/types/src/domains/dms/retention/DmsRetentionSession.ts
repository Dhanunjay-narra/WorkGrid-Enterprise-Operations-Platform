export interface DmsRetentionSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionSessionValidator {
  public static validate(data: Partial<DmsRetentionSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
