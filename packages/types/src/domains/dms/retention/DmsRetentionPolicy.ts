export interface DmsRetentionPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionPolicyValidator {
  public static validate(data: Partial<DmsRetentionPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
