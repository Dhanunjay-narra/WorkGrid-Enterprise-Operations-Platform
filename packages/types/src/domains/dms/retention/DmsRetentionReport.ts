export interface DmsRetentionReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionReportValidator {
  public static validate(data: Partial<DmsRetentionReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
