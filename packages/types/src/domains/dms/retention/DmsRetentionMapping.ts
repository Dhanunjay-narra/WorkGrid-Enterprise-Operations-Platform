export interface DmsRetentionMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionMappingValidator {
  public static validate(data: Partial<DmsRetentionMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
