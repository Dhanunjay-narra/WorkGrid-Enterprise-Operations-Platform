export interface DmsRetentionAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionAssignmentValidator {
  public static validate(data: Partial<DmsRetentionAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
