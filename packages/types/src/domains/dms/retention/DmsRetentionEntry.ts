export interface DmsRetentionEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionEntryValidator {
  public static validate(data: Partial<DmsRetentionEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
