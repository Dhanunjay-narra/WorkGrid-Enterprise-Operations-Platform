export interface DmsRetentionRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionRecordValidator {
  public static validate(data: Partial<DmsRetentionRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
