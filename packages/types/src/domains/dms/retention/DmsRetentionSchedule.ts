export interface DmsRetentionScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionScheduleValidator {
  public static validate(data: Partial<DmsRetentionScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
