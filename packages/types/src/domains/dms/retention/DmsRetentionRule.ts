export interface DmsRetentionRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionRuleValidator {
  public static validate(data: Partial<DmsRetentionRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
