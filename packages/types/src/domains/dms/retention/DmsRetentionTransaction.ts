export interface DmsRetentionTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionTransactionValidator {
  public static validate(data: Partial<DmsRetentionTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
