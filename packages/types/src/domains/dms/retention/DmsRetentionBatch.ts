export interface DmsRetentionBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionBatchValidator {
  public static validate(data: Partial<DmsRetentionBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
