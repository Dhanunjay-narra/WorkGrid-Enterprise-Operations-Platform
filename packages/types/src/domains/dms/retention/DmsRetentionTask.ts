export interface DmsRetentionTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionTaskValidator {
  public static validate(data: Partial<DmsRetentionTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
