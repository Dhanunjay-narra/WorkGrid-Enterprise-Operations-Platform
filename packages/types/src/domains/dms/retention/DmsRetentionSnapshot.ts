export interface DmsRetentionSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionSnapshotValidator {
  public static validate(data: Partial<DmsRetentionSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
