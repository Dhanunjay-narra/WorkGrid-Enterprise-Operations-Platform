export interface DmsRetentionPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionPayloadValidator {
  public static validate(data: Partial<DmsRetentionPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
