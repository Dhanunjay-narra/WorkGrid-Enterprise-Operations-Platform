export interface DmsRetentionItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionItemValidator {
  public static validate(data: Partial<DmsRetentionItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
