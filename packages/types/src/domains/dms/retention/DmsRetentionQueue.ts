export interface DmsRetentionQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionQueueValidator {
  public static validate(data: Partial<DmsRetentionQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
