export interface DmsRetentionAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionAuditLogValidator {
  public static validate(data: Partial<DmsRetentionAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
