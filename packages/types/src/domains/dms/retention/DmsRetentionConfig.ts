export interface DmsRetentionConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionConfigValidator {
  public static validate(data: Partial<DmsRetentionConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
