export interface DmsRetentionProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionProfileValidator {
  public static validate(data: Partial<DmsRetentionProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
