export interface DmsRetentionThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionThresholdValidator {
  public static validate(data: Partial<DmsRetentionThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
