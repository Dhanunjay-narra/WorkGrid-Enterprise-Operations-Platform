export interface DmsRetentionSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionSummaryValidator {
  public static validate(data: Partial<DmsRetentionSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
