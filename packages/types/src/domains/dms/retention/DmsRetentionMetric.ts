export interface DmsRetentionMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsRetentionMetricValidator {
  public static validate(data: Partial<DmsRetentionMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
