export interface DmsFoldersMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersMappingValidator {
  public static validate(data: Partial<DmsFoldersMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
