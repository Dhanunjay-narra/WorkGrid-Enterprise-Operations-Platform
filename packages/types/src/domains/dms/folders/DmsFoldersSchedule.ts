export interface DmsFoldersScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersScheduleValidator {
  public static validate(data: Partial<DmsFoldersScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
