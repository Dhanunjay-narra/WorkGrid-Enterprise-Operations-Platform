export interface DmsFoldersThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersThresholdValidator {
  public static validate(data: Partial<DmsFoldersThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
