export interface DmsFoldersReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersReportValidator {
  public static validate(data: Partial<DmsFoldersReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
