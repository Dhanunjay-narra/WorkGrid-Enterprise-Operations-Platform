export interface DmsFoldersPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersPayloadValidator {
  public static validate(data: Partial<DmsFoldersPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
