export interface DmsFoldersQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersQueueValidator {
  public static validate(data: Partial<DmsFoldersQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
