export interface DmsFoldersNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersNodeValidator {
  public static validate(data: Partial<DmsFoldersNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
