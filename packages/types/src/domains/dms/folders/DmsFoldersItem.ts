export interface DmsFoldersItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersItemValidator {
  public static validate(data: Partial<DmsFoldersItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
