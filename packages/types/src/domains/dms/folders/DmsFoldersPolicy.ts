export interface DmsFoldersPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersPolicyValidator {
  public static validate(data: Partial<DmsFoldersPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
