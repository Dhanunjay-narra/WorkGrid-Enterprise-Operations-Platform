export interface DmsFoldersSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersSummaryValidator {
  public static validate(data: Partial<DmsFoldersSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
