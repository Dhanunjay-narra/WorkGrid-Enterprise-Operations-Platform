export interface DmsFoldersSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersSessionValidator {
  public static validate(data: Partial<DmsFoldersSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
