export interface DmsFoldersTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersTransactionValidator {
  public static validate(data: Partial<DmsFoldersTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
