export interface DmsFoldersRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersRecordValidator {
  public static validate(data: Partial<DmsFoldersRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
