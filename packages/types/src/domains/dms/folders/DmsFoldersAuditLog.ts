export interface DmsFoldersAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersAuditLogValidator {
  public static validate(data: Partial<DmsFoldersAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
