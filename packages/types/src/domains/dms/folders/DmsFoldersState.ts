export interface DmsFoldersStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersStateValidator {
  public static validate(data: Partial<DmsFoldersStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
