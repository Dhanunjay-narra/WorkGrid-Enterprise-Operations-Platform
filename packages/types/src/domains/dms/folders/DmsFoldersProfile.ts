export interface DmsFoldersProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersProfileValidator {
  public static validate(data: Partial<DmsFoldersProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
