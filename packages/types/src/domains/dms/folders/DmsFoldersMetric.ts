export interface DmsFoldersMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersMetricValidator {
  public static validate(data: Partial<DmsFoldersMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
