export interface DmsFoldersConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersConfigValidator {
  public static validate(data: Partial<DmsFoldersConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
