export interface DmsFoldersEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersEventValidator {
  public static validate(data: Partial<DmsFoldersEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
