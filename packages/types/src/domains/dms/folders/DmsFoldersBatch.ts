export interface DmsFoldersBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersBatchValidator {
  public static validate(data: Partial<DmsFoldersBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
