export interface DmsFoldersRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersRuleValidator {
  public static validate(data: Partial<DmsFoldersRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
