export interface DmsFoldersSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersSnapshotValidator {
  public static validate(data: Partial<DmsFoldersSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
