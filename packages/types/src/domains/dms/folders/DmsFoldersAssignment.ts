export interface DmsFoldersAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersAssignmentValidator {
  public static validate(data: Partial<DmsFoldersAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
