export interface DmsFoldersTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFoldersTaskValidator {
  public static validate(data: Partial<DmsFoldersTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
