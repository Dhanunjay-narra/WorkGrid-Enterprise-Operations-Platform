export interface DmsFilesSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesSummaryValidator {
  public static validate(data: Partial<DmsFilesSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
