export interface DmsFilesPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesPayloadValidator {
  public static validate(data: Partial<DmsFilesPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
