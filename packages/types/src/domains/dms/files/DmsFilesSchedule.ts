export interface DmsFilesScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesScheduleValidator {
  public static validate(data: Partial<DmsFilesScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
