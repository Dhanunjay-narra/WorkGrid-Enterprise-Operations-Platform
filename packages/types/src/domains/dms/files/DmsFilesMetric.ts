export interface DmsFilesMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesMetricValidator {
  public static validate(data: Partial<DmsFilesMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
