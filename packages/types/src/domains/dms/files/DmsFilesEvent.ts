export interface DmsFilesEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesEventValidator {
  public static validate(data: Partial<DmsFilesEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
