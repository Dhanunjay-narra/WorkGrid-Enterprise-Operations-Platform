export interface DmsFilesRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesRecordValidator {
  public static validate(data: Partial<DmsFilesRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
