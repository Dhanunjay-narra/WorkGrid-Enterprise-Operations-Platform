export interface DmsFilesConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesConfigValidator {
  public static validate(data: Partial<DmsFilesConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
