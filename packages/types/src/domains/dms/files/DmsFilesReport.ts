export interface DmsFilesReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesReportValidator {
  public static validate(data: Partial<DmsFilesReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
