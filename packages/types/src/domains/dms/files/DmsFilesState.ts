export interface DmsFilesStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesStateValidator {
  public static validate(data: Partial<DmsFilesStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
