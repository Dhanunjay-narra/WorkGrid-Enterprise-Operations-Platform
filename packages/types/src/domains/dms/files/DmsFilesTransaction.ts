export interface DmsFilesTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesTransactionValidator {
  public static validate(data: Partial<DmsFilesTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
