export interface DmsFilesQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesQueueValidator {
  public static validate(data: Partial<DmsFilesQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
