export interface DmsFilesPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesPolicyValidator {
  public static validate(data: Partial<DmsFilesPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
