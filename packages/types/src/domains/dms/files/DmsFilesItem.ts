export interface DmsFilesItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesItemValidator {
  public static validate(data: Partial<DmsFilesItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
