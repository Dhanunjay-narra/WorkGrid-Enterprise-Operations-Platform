export interface DmsFilesNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesNodeValidator {
  public static validate(data: Partial<DmsFilesNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
