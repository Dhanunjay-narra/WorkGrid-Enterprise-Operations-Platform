export interface DmsFilesAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesAuditLogValidator {
  public static validate(data: Partial<DmsFilesAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
