export interface DmsFilesEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesEntryValidator {
  public static validate(data: Partial<DmsFilesEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
