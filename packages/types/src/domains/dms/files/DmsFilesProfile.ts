export interface DmsFilesProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesProfileValidator {
  public static validate(data: Partial<DmsFilesProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
