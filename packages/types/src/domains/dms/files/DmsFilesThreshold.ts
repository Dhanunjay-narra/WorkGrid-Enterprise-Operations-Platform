export interface DmsFilesThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesThresholdValidator {
  public static validate(data: Partial<DmsFilesThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
