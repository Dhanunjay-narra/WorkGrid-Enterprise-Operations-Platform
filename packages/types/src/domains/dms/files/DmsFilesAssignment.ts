export interface DmsFilesAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesAssignmentValidator {
  public static validate(data: Partial<DmsFilesAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
