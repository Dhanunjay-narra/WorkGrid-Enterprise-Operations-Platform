export interface DmsFilesTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesTaskValidator {
  public static validate(data: Partial<DmsFilesTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
