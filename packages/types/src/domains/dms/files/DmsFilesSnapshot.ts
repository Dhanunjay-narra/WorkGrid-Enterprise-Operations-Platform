export interface DmsFilesSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesSnapshotValidator {
  public static validate(data: Partial<DmsFilesSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
