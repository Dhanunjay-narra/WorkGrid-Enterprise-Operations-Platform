export interface DmsFilesBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesBatchValidator {
  public static validate(data: Partial<DmsFilesBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
