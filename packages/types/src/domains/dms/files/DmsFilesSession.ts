export interface DmsFilesSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesSessionValidator {
  public static validate(data: Partial<DmsFilesSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
