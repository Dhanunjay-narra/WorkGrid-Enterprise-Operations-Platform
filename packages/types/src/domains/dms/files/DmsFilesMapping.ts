export interface DmsFilesMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesMappingValidator {
  public static validate(data: Partial<DmsFilesMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
