export interface DmsFilesRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsFilesRuleValidator {
  public static validate(data: Partial<DmsFilesRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
