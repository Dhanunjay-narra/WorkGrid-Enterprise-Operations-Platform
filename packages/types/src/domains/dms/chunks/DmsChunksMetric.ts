export interface DmsChunksMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksMetricValidator {
  public static validate(data: Partial<DmsChunksMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
