export interface DmsChunksPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksPolicyValidator {
  public static validate(data: Partial<DmsChunksPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
