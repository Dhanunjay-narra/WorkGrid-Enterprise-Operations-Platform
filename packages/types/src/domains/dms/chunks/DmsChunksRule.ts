export interface DmsChunksRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksRuleValidator {
  public static validate(data: Partial<DmsChunksRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
