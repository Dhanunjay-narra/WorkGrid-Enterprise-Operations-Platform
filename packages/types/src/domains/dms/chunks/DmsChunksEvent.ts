export interface DmsChunksEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksEventValidator {
  public static validate(data: Partial<DmsChunksEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
