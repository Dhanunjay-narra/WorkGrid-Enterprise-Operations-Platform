export interface DmsChunksQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksQueueValidator {
  public static validate(data: Partial<DmsChunksQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
