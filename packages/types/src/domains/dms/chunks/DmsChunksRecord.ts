export interface DmsChunksRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksRecordValidator {
  public static validate(data: Partial<DmsChunksRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
