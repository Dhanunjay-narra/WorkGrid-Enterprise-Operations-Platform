export interface DmsChunksPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksPayloadValidator {
  public static validate(data: Partial<DmsChunksPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
