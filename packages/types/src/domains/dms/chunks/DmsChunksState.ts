export interface DmsChunksStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksStateValidator {
  public static validate(data: Partial<DmsChunksStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
