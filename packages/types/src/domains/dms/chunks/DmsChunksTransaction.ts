export interface DmsChunksTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksTransactionValidator {
  public static validate(data: Partial<DmsChunksTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
