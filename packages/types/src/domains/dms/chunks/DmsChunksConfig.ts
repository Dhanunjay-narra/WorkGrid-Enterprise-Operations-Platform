export interface DmsChunksConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksConfigValidator {
  public static validate(data: Partial<DmsChunksConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
