export interface DmsChunksTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksTaskValidator {
  public static validate(data: Partial<DmsChunksTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
