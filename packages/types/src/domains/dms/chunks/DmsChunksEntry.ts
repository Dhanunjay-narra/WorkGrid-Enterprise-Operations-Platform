export interface DmsChunksEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksEntryValidator {
  public static validate(data: Partial<DmsChunksEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
