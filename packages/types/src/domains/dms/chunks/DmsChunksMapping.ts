export interface DmsChunksMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksMappingValidator {
  public static validate(data: Partial<DmsChunksMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
