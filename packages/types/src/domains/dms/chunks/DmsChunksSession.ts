export interface DmsChunksSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksSessionValidator {
  public static validate(data: Partial<DmsChunksSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
