export interface DmsChunksNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksNodeValidator {
  public static validate(data: Partial<DmsChunksNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
