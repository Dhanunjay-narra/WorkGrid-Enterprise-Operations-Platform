export interface DmsChunksAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksAssignmentValidator {
  public static validate(data: Partial<DmsChunksAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
