export interface DmsChunksThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksThresholdValidator {
  public static validate(data: Partial<DmsChunksThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
