export interface DmsChunksItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksItemValidator {
  public static validate(data: Partial<DmsChunksItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
