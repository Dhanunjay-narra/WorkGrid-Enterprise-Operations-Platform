export interface DmsChunksSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksSnapshotValidator {
  public static validate(data: Partial<DmsChunksSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
