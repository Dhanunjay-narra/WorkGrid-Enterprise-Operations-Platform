export interface DmsChunksReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksReportValidator {
  public static validate(data: Partial<DmsChunksReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
