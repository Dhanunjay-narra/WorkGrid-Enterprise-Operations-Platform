export interface DmsChunksScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksScheduleValidator {
  public static validate(data: Partial<DmsChunksScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
