export interface DmsChunksAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksAuditLogValidator {
  public static validate(data: Partial<DmsChunksAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
