export interface DmsChunksSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksSummaryValidator {
  public static validate(data: Partial<DmsChunksSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
