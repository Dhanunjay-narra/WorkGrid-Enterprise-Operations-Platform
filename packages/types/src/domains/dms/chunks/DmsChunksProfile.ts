export interface DmsChunksProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksProfileValidator {
  public static validate(data: Partial<DmsChunksProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
