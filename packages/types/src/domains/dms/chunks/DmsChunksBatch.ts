export interface DmsChunksBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsChunksBatchValidator {
  public static validate(data: Partial<DmsChunksBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
