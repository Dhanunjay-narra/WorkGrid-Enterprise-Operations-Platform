export interface DmsOcrConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrConfigValidator {
  public static validate(data: Partial<DmsOcrConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
