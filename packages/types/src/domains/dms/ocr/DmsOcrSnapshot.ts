export interface DmsOcrSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrSnapshotValidator {
  public static validate(data: Partial<DmsOcrSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
