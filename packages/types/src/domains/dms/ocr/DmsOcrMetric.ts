export interface DmsOcrMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrMetricValidator {
  public static validate(data: Partial<DmsOcrMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
