export interface DmsOcrMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrMappingValidator {
  public static validate(data: Partial<DmsOcrMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
