export interface DmsOcrSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrSessionValidator {
  public static validate(data: Partial<DmsOcrSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
