export interface DmsOcrAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrAssignmentValidator {
  public static validate(data: Partial<DmsOcrAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
