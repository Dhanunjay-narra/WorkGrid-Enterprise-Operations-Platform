export interface DmsOcrThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrThresholdValidator {
  public static validate(data: Partial<DmsOcrThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
