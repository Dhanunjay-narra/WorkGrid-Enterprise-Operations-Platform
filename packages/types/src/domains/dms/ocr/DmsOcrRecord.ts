export interface DmsOcrRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrRecordValidator {
  public static validate(data: Partial<DmsOcrRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
