export interface DmsOcrReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrReportValidator {
  public static validate(data: Partial<DmsOcrReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
