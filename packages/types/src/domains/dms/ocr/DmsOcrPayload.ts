export interface DmsOcrPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrPayloadValidator {
  public static validate(data: Partial<DmsOcrPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
