export interface DmsOcrScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrScheduleValidator {
  public static validate(data: Partial<DmsOcrScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
