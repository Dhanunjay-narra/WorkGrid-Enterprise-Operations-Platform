export interface DmsOcrProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrProfileValidator {
  public static validate(data: Partial<DmsOcrProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
