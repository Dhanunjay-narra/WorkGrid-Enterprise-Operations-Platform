export interface DmsOcrTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrTransactionValidator {
  public static validate(data: Partial<DmsOcrTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
