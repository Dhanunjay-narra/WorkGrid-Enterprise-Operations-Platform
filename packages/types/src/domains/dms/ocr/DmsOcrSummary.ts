export interface DmsOcrSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrSummaryValidator {
  public static validate(data: Partial<DmsOcrSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
