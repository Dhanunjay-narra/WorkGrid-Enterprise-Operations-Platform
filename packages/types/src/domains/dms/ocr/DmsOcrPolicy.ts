export interface DmsOcrPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsOcrPolicyValidator {
  public static validate(data: Partial<DmsOcrPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
