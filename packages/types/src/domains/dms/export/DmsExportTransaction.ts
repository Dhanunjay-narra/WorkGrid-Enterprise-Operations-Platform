export interface DmsExportTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportTransactionValidator {
  public static validate(data: Partial<DmsExportTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
