export interface DmsExportEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportEntryValidator {
  public static validate(data: Partial<DmsExportEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
