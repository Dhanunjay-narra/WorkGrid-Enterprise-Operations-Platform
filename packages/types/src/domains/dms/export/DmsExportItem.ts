export interface DmsExportItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportItemValidator {
  public static validate(data: Partial<DmsExportItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
