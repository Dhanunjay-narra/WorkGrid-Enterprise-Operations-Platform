export interface DmsExportStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportStateValidator {
  public static validate(data: Partial<DmsExportStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
