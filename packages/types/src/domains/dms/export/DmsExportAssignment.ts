export interface DmsExportAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportAssignmentValidator {
  public static validate(data: Partial<DmsExportAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
