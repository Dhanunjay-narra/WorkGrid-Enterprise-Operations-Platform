export interface DmsExportAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportAuditLogValidator {
  public static validate(data: Partial<DmsExportAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
