export interface DmsExportRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportRuleValidator {
  public static validate(data: Partial<DmsExportRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
