export interface DmsExportMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportMappingValidator {
  public static validate(data: Partial<DmsExportMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
