export interface DmsExportSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportSessionValidator {
  public static validate(data: Partial<DmsExportSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
