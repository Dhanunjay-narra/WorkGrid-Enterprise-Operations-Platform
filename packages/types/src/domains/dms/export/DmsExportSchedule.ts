export interface DmsExportScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportScheduleValidator {
  public static validate(data: Partial<DmsExportScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
