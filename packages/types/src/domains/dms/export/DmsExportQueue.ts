export interface DmsExportQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportQueueValidator {
  public static validate(data: Partial<DmsExportQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
