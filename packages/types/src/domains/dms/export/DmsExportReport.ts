export interface DmsExportReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportReportValidator {
  public static validate(data: Partial<DmsExportReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
