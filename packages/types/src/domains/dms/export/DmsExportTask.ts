export interface DmsExportTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportTaskValidator {
  public static validate(data: Partial<DmsExportTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
