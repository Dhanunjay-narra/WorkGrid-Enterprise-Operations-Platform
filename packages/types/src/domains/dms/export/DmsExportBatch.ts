export interface DmsExportBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportBatchValidator {
  public static validate(data: Partial<DmsExportBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
