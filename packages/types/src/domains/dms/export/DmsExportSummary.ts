export interface DmsExportSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportSummaryValidator {
  public static validate(data: Partial<DmsExportSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
