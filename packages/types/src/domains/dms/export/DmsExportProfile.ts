export interface DmsExportProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportProfileValidator {
  public static validate(data: Partial<DmsExportProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
