export interface DmsExportPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportPayloadValidator {
  public static validate(data: Partial<DmsExportPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
