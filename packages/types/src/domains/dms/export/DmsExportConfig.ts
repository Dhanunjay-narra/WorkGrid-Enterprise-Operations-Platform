export interface DmsExportConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportConfigValidator {
  public static validate(data: Partial<DmsExportConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
