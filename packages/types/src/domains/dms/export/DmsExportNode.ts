export interface DmsExportNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportNodeValidator {
  public static validate(data: Partial<DmsExportNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
