export interface DmsExportThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportThresholdValidator {
  public static validate(data: Partial<DmsExportThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
