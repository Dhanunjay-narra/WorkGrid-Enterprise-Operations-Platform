export interface DmsExportMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportMetricValidator {
  public static validate(data: Partial<DmsExportMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
