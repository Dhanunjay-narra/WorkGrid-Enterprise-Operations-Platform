export interface DmsExportEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportEventValidator {
  public static validate(data: Partial<DmsExportEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
