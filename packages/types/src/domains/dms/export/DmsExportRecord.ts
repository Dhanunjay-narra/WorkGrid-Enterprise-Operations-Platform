export interface DmsExportRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportRecordValidator {
  public static validate(data: Partial<DmsExportRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
