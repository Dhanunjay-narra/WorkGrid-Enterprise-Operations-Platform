export interface DmsExportPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportPolicyValidator {
  public static validate(data: Partial<DmsExportPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
