export interface DmsExportSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsExportSnapshotValidator {
  public static validate(data: Partial<DmsExportSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
