export interface DmsVersionsPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsPayloadValidator {
  public static validate(data: Partial<DmsVersionsPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
