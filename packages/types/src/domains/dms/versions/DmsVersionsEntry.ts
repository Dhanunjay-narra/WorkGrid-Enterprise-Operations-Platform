export interface DmsVersionsEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsEntryValidator {
  public static validate(data: Partial<DmsVersionsEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
