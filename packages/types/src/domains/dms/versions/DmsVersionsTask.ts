export interface DmsVersionsTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsTaskValidator {
  public static validate(data: Partial<DmsVersionsTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
