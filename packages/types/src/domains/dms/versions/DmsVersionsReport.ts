export interface DmsVersionsReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsReportValidator {
  public static validate(data: Partial<DmsVersionsReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
