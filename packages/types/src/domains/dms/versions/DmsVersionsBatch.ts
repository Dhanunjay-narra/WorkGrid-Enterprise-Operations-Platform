export interface DmsVersionsBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsBatchValidator {
  public static validate(data: Partial<DmsVersionsBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
