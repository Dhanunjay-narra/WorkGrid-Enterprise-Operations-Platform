export interface DmsVersionsMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsMetricValidator {
  public static validate(data: Partial<DmsVersionsMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
