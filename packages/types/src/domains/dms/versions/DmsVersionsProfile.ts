export interface DmsVersionsProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsProfileValidator {
  public static validate(data: Partial<DmsVersionsProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
