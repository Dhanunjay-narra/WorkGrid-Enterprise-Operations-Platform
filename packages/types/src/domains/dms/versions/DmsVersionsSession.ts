export interface DmsVersionsSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsSessionValidator {
  public static validate(data: Partial<DmsVersionsSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
