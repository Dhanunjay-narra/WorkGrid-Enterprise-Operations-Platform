export interface DmsVersionsRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsRecordValidator {
  public static validate(data: Partial<DmsVersionsRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
