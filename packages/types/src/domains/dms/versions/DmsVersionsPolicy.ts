export interface DmsVersionsPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsPolicyValidator {
  public static validate(data: Partial<DmsVersionsPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
