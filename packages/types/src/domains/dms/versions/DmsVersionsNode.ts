export interface DmsVersionsNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsNodeValidator {
  public static validate(data: Partial<DmsVersionsNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
