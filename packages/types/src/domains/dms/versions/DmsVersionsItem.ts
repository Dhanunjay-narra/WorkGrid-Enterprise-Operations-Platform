export interface DmsVersionsItemModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsItemValidator {
  public static validate(data: Partial<DmsVersionsItemModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
