export interface DmsVersionsRuleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsRuleValidator {
  public static validate(data: Partial<DmsVersionsRuleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
