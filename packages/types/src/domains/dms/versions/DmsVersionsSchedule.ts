export interface DmsVersionsScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsScheduleValidator {
  public static validate(data: Partial<DmsVersionsScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
