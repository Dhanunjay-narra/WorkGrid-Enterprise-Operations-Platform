export interface DmsVersionsAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsAssignmentValidator {
  public static validate(data: Partial<DmsVersionsAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
