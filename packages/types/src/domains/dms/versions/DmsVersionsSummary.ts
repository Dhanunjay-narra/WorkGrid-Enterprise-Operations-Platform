export interface DmsVersionsSummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsSummaryValidator {
  public static validate(data: Partial<DmsVersionsSummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
