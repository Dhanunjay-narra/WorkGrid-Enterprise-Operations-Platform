export interface DmsVersionsConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsConfigValidator {
  public static validate(data: Partial<DmsVersionsConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
