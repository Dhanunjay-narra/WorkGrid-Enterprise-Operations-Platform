export interface DmsVersionsSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsSnapshotValidator {
  public static validate(data: Partial<DmsVersionsSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
