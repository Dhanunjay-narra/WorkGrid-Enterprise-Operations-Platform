export interface DmsVersionsMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsMappingValidator {
  public static validate(data: Partial<DmsVersionsMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
