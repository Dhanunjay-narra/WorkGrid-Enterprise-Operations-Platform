export interface DmsVersionsStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsStateValidator {
  public static validate(data: Partial<DmsVersionsStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
