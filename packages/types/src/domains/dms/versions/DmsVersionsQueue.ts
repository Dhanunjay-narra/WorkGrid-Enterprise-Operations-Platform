export interface DmsVersionsQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsQueueValidator {
  public static validate(data: Partial<DmsVersionsQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
