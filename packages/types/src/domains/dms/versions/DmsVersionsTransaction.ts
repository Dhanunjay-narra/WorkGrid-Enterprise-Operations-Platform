export interface DmsVersionsTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsTransactionValidator {
  public static validate(data: Partial<DmsVersionsTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
