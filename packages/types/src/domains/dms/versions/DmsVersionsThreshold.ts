export interface DmsVersionsThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsThresholdValidator {
  public static validate(data: Partial<DmsVersionsThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
