export interface DmsVersionsAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsAuditLogValidator {
  public static validate(data: Partial<DmsVersionsAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
