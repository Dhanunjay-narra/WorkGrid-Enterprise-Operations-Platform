export interface DmsVersionsEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class DmsVersionsEventValidator {
  public static validate(data: Partial<DmsVersionsEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
