export interface AuthScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AuthScheduleValidator {
  public static validate(data: Partial<AuthScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
