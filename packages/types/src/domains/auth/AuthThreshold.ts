export interface AuthThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AuthThresholdValidator {
  public static validate(data: Partial<AuthThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
