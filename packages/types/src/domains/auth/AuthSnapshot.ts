export interface AuthSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AuthSnapshotValidator {
  public static validate(data: Partial<AuthSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
