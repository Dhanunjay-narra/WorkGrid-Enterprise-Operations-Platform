export interface AuthAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AuthAssignmentValidator {
  public static validate(data: Partial<AuthAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
