export interface AuthTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class AuthTransactionValidator {
  public static validate(data: Partial<AuthTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
