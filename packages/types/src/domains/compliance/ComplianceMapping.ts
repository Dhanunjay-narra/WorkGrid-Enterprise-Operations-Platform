export interface ComplianceMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceMappingValidator {
  public static validate(data: Partial<ComplianceMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
