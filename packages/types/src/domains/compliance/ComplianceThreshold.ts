export interface ComplianceThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceThresholdValidator {
  public static validate(data: Partial<ComplianceThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
