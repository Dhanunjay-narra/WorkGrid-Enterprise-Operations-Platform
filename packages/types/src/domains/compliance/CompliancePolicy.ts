export interface CompliancePolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CompliancePolicyValidator {
  public static validate(data: Partial<CompliancePolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
