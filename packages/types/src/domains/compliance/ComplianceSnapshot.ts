export interface ComplianceSnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceSnapshotValidator {
  public static validate(data: Partial<ComplianceSnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
