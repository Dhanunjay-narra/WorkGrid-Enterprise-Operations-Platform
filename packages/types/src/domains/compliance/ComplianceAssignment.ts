export interface ComplianceAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceAssignmentValidator {
  public static validate(data: Partial<ComplianceAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
