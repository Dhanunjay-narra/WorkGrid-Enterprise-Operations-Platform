export interface ComplianceScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceScheduleValidator {
  public static validate(data: Partial<ComplianceScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
