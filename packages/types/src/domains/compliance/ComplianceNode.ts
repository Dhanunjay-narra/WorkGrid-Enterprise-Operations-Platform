export interface ComplianceNodeModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceNodeValidator {
  public static validate(data: Partial<ComplianceNodeModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
