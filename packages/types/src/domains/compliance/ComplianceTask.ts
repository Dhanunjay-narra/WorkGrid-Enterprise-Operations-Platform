export interface ComplianceTaskModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceTaskValidator {
  public static validate(data: Partial<ComplianceTaskModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
