export interface ComplianceAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceAuditLogValidator {
  public static validate(data: Partial<ComplianceAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
