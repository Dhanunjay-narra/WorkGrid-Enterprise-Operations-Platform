export interface ComplianceBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceBatchValidator {
  public static validate(data: Partial<ComplianceBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
