export interface ComplianceEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceEntryValidator {
  public static validate(data: Partial<ComplianceEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
