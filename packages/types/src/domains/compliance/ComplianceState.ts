export interface ComplianceStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceStateValidator {
  public static validate(data: Partial<ComplianceStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
