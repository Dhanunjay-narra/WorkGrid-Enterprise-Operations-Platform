export interface ComplianceQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceQueueValidator {
  public static validate(data: Partial<ComplianceQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
