export interface ComplianceEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceEventValidator {
  public static validate(data: Partial<ComplianceEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
