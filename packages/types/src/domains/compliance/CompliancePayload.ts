export interface CompliancePayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class CompliancePayloadValidator {
  public static validate(data: Partial<CompliancePayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
