export interface ComplianceTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceTransactionValidator {
  public static validate(data: Partial<ComplianceTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
