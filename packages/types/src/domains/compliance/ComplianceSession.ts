export interface ComplianceSessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class ComplianceSessionValidator {
  public static validate(data: Partial<ComplianceSessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
