export interface TenancyAssignmentModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyAssignmentValidator {
  public static validate(data: Partial<TenancyAssignmentModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
