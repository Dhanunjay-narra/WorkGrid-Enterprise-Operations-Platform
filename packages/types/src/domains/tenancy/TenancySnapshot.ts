export interface TenancySnapshotModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancySnapshotValidator {
  public static validate(data: Partial<TenancySnapshotModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
