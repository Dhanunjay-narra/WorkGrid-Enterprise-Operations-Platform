export interface TenancyMetricModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyMetricValidator {
  public static validate(data: Partial<TenancyMetricModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
