export interface TenancyQueueModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyQueueValidator {
  public static validate(data: Partial<TenancyQueueModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
