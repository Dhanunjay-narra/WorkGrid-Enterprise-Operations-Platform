export interface TenancyPayloadModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyPayloadValidator {
  public static validate(data: Partial<TenancyPayloadModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
