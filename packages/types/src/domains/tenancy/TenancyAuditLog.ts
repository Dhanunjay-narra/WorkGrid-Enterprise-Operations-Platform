export interface TenancyAuditLogModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyAuditLogValidator {
  public static validate(data: Partial<TenancyAuditLogModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
