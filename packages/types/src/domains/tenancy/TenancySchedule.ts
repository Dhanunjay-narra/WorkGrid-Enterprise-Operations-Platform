export interface TenancyScheduleModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyScheduleValidator {
  public static validate(data: Partial<TenancyScheduleModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
