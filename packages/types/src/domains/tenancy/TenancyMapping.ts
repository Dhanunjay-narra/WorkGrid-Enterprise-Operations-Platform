export interface TenancyMappingModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyMappingValidator {
  public static validate(data: Partial<TenancyMappingModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
