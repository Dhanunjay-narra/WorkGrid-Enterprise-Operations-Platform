export interface TenancyEventModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyEventValidator {
  public static validate(data: Partial<TenancyEventModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
