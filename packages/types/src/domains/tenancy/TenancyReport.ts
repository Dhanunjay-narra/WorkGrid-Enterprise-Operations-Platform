export interface TenancyReportModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyReportValidator {
  public static validate(data: Partial<TenancyReportModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
