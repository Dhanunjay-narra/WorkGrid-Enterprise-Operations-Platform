export interface TenancySessionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancySessionValidator {
  public static validate(data: Partial<TenancySessionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
