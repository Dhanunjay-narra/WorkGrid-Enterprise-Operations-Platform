export interface TenancyProfileModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyProfileValidator {
  public static validate(data: Partial<TenancyProfileModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
