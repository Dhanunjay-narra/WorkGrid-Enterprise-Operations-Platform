export interface TenancyTransactionModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyTransactionValidator {
  public static validate(data: Partial<TenancyTransactionModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
