export interface TenancyStateModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyStateValidator {
  public static validate(data: Partial<TenancyStateModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
