export interface TenancyThresholdModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyThresholdValidator {
  public static validate(data: Partial<TenancyThresholdModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
