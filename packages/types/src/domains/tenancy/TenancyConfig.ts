export interface TenancyConfigModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyConfigValidator {
  public static validate(data: Partial<TenancyConfigModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
