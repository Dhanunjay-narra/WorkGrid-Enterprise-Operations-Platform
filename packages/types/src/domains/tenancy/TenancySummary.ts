export interface TenancySummaryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancySummaryValidator {
  public static validate(data: Partial<TenancySummaryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
