export interface TenancyBatchModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyBatchValidator {
  public static validate(data: Partial<TenancyBatchModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
