export interface TenancyRecordModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyRecordValidator {
  public static validate(data: Partial<TenancyRecordModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
