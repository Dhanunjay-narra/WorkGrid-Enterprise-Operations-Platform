export interface TenancyPolicyModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyPolicyValidator {
  public static validate(data: Partial<TenancyPolicyModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
