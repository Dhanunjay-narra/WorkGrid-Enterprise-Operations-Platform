export interface TenancyEntryModel {
  id: string;
  tenantId: string;
  code: string;
  name: string;
...
export class TenancyEntryValidator {
  public static validate(data: Partial<TenancyEntryModel>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
