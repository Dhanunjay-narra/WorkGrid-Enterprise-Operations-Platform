...
export const InvStockMovementDataGrid: React.FC<{ tenantId: string }> = ({ tenantId }) => {
  const [selected, setSelected] = useState<string | null>(null);
  return (
    <Card title="InvStockMovement Data Grid">
      ...
      <p className="text-xs text-[#1E2022]/70">Showing live synchronized telemetry and operations for InvStockMovement.</p>
    </Card>
  );
};
