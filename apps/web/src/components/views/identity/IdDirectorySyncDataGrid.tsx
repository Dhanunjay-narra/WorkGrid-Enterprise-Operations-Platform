...
export const IdDirectorySyncDataGrid: React.FC<{ tenantId: string }> = ({ tenantId }) => {
  const [selected, setSelected] = useState<string | null>(null);
  return (
    <Card title="IdDirectorySync Data Grid">
      ...
      <p className="text-xs text-[#1E2022]/70">Showing live synchronized telemetry and operations for IdDirectorySync.</p>
    </Card>
  );
};
