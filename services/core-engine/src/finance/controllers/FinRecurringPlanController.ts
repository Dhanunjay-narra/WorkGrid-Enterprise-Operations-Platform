import { FinRecurringPlanService } from "../services/FinRecurringPlanService";

export class FinRecurringPlanController {
  private service = new FinRecurringPlanService();
