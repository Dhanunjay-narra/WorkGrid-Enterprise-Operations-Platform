import { FinGeneralLedgerService } from "../services/FinGeneralLedgerService";

export class FinGeneralLedgerController {
  private service = new FinGeneralLedgerService();
