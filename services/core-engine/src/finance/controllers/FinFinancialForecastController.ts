import { FinFinancialForecastService } from "../services/FinFinancialForecastService";

export class FinFinancialForecastController {
  private service = new FinFinancialForecastService();
