import { FinExpenseReceiptService } from "../services/FinExpenseReceiptService";

export class FinExpenseReceiptController {
  private service = new FinExpenseReceiptService();
