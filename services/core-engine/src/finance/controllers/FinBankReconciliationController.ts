import { FinBankReconciliationService } from "../services/FinBankReconciliationService";

export class FinBankReconciliationController {
  private service = new FinBankReconciliationService();
