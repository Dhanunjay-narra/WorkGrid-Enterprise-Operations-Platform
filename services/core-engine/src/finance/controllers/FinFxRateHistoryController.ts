import { FinFxRateHistoryService } from "../services/FinFxRateHistoryService";

export class FinFxRateHistoryController {
  private service = new FinFxRateHistoryService();
