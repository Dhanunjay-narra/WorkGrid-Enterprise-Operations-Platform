import { FinPaymentTransactionService } from "../services/FinPaymentTransactionService";

export class FinPaymentTransactionController {
  private service = new FinPaymentTransactionService();
