import { FinLedgerAccountService } from "../services/FinLedgerAccountService";

export class FinLedgerAccountController {
  private service = new FinLedgerAccountService();
