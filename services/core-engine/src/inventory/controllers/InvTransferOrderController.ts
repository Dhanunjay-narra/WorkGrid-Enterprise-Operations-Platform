import { InvTransferOrderService } from "../services/InvTransferOrderService";

export class InvTransferOrderController {
  private service = new InvTransferOrderService();
