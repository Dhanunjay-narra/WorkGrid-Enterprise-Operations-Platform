import { InvPurchaseOrderService } from "../services/InvPurchaseOrderService";

export class InvPurchaseOrderController {
  private service = new InvPurchaseOrderService();
