import { InvPurchaseOrderItemService } from "../services/InvPurchaseOrderItemService";

export class InvPurchaseOrderItemController {
  private service = new InvPurchaseOrderItemService();
