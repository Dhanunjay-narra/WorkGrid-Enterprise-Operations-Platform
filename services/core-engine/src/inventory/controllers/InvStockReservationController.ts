import { InvStockReservationService } from "../services/InvStockReservationService";

export class InvStockReservationController {
  private service = new InvStockReservationService();
