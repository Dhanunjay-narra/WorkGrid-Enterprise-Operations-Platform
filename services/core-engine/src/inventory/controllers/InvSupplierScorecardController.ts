import { InvSupplierScorecardService } from "../services/InvSupplierScorecardService";

export class InvSupplierScorecardController {
  private service = new InvSupplierScorecardService();
