import { InvWarehouseZoneService } from "../services/InvWarehouseZoneService";

export class InvWarehouseZoneController {
  private service = new InvWarehouseZoneService();
