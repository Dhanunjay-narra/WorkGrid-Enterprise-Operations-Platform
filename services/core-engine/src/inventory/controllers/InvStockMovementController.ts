import { InvStockMovementService } from "../services/InvStockMovementService";

export class InvStockMovementController {
  private service = new InvStockMovementService();
