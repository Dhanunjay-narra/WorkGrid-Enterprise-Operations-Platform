import { IdPasskeyCredentialService } from "../services/IdPasskeyCredentialService";

export class IdPasskeyCredentialController {
  private service = new IdPasskeyCredentialService();
