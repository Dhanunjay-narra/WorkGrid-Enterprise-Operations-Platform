import { IdGroupMembershipService } from "../services/IdGroupMembershipService";

export class IdGroupMembershipController {
  private service = new IdGroupMembershipService();
