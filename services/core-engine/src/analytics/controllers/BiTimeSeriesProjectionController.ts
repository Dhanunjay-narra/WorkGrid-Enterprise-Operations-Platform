import { BiTimeSeriesProjectionService } from "../services/BiTimeSeriesProjectionService";

export class BiTimeSeriesProjectionController {
  private service = new BiTimeSeriesProjectionService();
