import { BiAnomalyThresholdService } from "../services/BiAnomalyThresholdService";

export class BiAnomalyThresholdController {
  private service = new BiAnomalyThresholdService();
