import { BiExecutiveSummaryService } from "../services/BiExecutiveSummaryService";

export class BiExecutiveSummaryController {
  private service = new BiExecutiveSummaryService();
