import { BiAggregatedDailyMetricService } from "../services/BiAggregatedDailyMetricService";

export class BiAggregatedDailyMetricController {
  private service = new BiAggregatedDailyMetricService();
