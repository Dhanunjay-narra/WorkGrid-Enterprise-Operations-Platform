import { BiDrilldownFilterService } from "../services/BiDrilldownFilterService";

export class BiDrilldownFilterController {
  private service = new BiDrilldownFilterService();
