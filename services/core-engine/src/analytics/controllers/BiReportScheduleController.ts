import { BiReportScheduleService } from "../services/BiReportScheduleService";

export class BiReportScheduleController {
  private service = new BiReportScheduleService();
