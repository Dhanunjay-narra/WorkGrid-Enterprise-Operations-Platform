import { EvtIdempotencyRecordService } from "../services/EvtIdempotencyRecordService";

export class EvtIdempotencyRecordController {
  private service = new EvtIdempotencyRecordService();
