import { EvtEventPartitionService } from "../services/EvtEventPartitionService";

export class EvtEventPartitionController {
  private service = new EvtEventPartitionService();
