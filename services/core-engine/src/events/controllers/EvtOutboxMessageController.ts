import { EvtOutboxMessageService } from "../services/EvtOutboxMessageService";

export class EvtOutboxMessageController {
  private service = new EvtOutboxMessageService();
