import { EvtEventSubscriptionService } from "../services/EvtEventSubscriptionService";

export class EvtEventSubscriptionController {
  private service = new EvtEventSubscriptionService();
