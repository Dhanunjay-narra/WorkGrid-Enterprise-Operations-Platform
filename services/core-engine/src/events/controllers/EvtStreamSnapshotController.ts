import { EvtStreamSnapshotService } from "../services/EvtStreamSnapshotService";

export class EvtStreamSnapshotController {
  private service = new EvtStreamSnapshotService();
