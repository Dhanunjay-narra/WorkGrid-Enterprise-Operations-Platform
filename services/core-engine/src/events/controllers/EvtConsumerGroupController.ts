import { EvtConsumerGroupService } from "../services/EvtConsumerGroupService";

export class EvtConsumerGroupController {
  private service = new EvtConsumerGroupService();
