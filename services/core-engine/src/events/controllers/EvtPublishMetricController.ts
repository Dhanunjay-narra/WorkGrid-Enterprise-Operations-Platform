import { EvtPublishMetricService } from "../services/EvtPublishMetricService";

export class EvtPublishMetricController {
  private service = new EvtPublishMetricService();
