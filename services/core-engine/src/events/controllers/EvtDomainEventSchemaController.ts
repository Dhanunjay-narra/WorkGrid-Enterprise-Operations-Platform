import { EvtDomainEventSchemaService } from "../services/EvtDomainEventSchemaService";

export class EvtDomainEventSchemaController {
  private service = new EvtDomainEventSchemaService();
