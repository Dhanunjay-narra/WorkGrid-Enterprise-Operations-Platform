import { EvtDeadLetterEventService } from "../services/EvtDeadLetterEventService";

export class EvtDeadLetterEventController {
  private service = new EvtDeadLetterEventService();
