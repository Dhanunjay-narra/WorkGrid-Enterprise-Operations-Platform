import { DocDocumentSignatureService } from "../services/DocDocumentSignatureService";

export class DocDocumentSignatureController {
  private service = new DocDocumentSignatureService();
