import { DocFileExportJobService } from "../services/DocFileExportJobService";

export class DocFileExportJobController {
  private service = new DocFileExportJobService();
