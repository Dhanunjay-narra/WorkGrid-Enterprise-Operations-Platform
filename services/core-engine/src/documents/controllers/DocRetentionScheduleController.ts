import { DocRetentionScheduleService } from "../services/DocRetentionScheduleService";

export class DocRetentionScheduleController {
  private service = new DocRetentionScheduleService();
