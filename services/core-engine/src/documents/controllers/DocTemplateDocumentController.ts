import { DocTemplateDocumentService } from "../services/DocTemplateDocumentService";

export class DocTemplateDocumentController {
  private service = new DocTemplateDocumentService();
