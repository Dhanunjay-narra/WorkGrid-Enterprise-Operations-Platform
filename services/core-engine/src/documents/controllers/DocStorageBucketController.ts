import { DocStorageBucketService } from "../services/DocStorageBucketService";

export class DocStorageBucketController {
  private service = new DocStorageBucketService();
