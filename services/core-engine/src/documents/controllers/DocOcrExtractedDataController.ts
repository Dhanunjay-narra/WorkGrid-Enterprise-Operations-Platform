import { DocOcrExtractedDataService } from "../services/DocOcrExtractedDataService";

export class DocOcrExtractedDataController {
  private service = new DocOcrExtractedDataService();
