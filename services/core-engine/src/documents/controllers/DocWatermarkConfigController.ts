import { DocWatermarkConfigService } from "../services/DocWatermarkConfigService";

export class DocWatermarkConfigController {
  private service = new DocWatermarkConfigService();
