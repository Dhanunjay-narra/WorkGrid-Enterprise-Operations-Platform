import { DocDocumentVersionService } from "../services/DocDocumentVersionService";

export class DocDocumentVersionController {
  private service = new DocDocumentVersionService();
