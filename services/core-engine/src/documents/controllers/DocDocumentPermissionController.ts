import { DocDocumentPermissionService } from "../services/DocDocumentPermissionService";

export class DocDocumentPermissionController {
  private service = new DocDocumentPermissionService();
