import { WfWorkflowExecutionService } from "../services/WfWorkflowExecutionService";

export class WfWorkflowExecutionController {
  private service = new WfWorkflowExecutionService();
