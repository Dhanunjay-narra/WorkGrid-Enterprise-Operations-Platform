import { WfApprovalDecisionService } from "../services/WfApprovalDecisionService";

export class WfApprovalDecisionController {
  private service = new WfApprovalDecisionService();
