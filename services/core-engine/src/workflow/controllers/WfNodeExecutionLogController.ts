import { WfNodeExecutionLogService } from "../services/WfNodeExecutionLogService";

export class WfNodeExecutionLogController {
  private service = new WfNodeExecutionLogService();
