import { WfWorkflowDefinitionService } from "../services/WfWorkflowDefinitionService";

export class WfWorkflowDefinitionController {
  private service = new WfWorkflowDefinitionService();
