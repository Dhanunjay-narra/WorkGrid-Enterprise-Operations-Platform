import { WfExecutionStepMetricService } from "../services/WfExecutionStepMetricService";

export class WfExecutionStepMetricController {
  private service = new WfExecutionStepMetricService();
