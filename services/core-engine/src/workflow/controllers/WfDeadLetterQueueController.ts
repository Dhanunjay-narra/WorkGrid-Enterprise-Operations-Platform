import { WfDeadLetterQueueService } from "../services/WfDeadLetterQueueService";

export class WfDeadLetterQueueController {
  private service = new WfDeadLetterQueueService();
