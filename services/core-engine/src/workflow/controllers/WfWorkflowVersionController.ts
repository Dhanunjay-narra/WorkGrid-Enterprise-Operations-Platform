import { WfWorkflowVersionService } from "../services/WfWorkflowVersionService";

export class WfWorkflowVersionController {
  private service = new WfWorkflowVersionService();
