import { CrmSalesContractService } from "../services/CrmSalesContractService";

export class CrmSalesContractController {
  private service = new CrmSalesContractService();
