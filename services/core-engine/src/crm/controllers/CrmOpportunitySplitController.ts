import { CrmOpportunitySplitService } from "../services/CrmOpportunitySplitService";

export class CrmOpportunitySplitController {
  private service = new CrmOpportunitySplitService();
