import { CrmCustomerHealthService } from "../services/CrmCustomerHealthService";

export class CrmCustomerHealthController {
  private service = new CrmCustomerHealthService();
