import { CrmCompetitorIntelService } from "../services/CrmCompetitorIntelService";

export class CrmCompetitorIntelController {
  private service = new CrmCompetitorIntelService();
