import { CrmEmailSequenceService } from "../services/CrmEmailSequenceService";

export class CrmEmailSequenceController {
  private service = new CrmEmailSequenceService();
