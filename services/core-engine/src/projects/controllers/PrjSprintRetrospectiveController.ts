import { PrjSprintRetrospectiveService } from "../services/PrjSprintRetrospectiveService";

export class PrjSprintRetrospectiveController {
  private service = new PrjSprintRetrospectiveService();
