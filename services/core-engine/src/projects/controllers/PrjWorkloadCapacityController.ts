import { PrjWorkloadCapacityService } from "../services/PrjWorkloadCapacityService";

export class PrjWorkloadCapacityController {
  private service = new PrjWorkloadCapacityService();
