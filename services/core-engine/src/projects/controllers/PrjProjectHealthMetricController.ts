import { PrjProjectHealthMetricService } from "../services/PrjProjectHealthMetricService";

export class PrjProjectHealthMetricController {
  private service = new PrjProjectHealthMetricService();
