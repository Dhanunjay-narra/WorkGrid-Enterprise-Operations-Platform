import { PrjGanttDependencyService } from "../services/PrjGanttDependencyService";

export class PrjGanttDependencyController {
  private service = new PrjGanttDependencyService();
