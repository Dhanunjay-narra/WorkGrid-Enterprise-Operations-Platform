import { SecRateLimitCounterService } from "../services/SecRateLimitCounterService";

export class SecRateLimitCounterController {
  private service = new SecRateLimitCounterService();
