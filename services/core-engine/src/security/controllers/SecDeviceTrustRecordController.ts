import { SecDeviceTrustRecordService } from "../services/SecDeviceTrustRecordService";

export class SecDeviceTrustRecordController {
  private service = new SecDeviceTrustRecordService();
