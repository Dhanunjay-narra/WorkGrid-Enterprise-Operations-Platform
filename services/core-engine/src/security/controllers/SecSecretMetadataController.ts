import { SecSecretMetadataService } from "../services/SecSecretMetadataService";

export class SecSecretMetadataController {
  private service = new SecSecretMetadataService();
