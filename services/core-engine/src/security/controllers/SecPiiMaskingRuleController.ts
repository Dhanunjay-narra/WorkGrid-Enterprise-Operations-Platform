import { SecPiiMaskingRuleService } from "../services/SecPiiMaskingRuleService";

export class SecPiiMaskingRuleController {
  private service = new SecPiiMaskingRuleService();
