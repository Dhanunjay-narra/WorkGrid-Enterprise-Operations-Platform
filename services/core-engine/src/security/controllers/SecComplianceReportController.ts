import { SecComplianceReportService } from "../services/SecComplianceReportService";

export class SecComplianceReportController {
  private service = new SecComplianceReportService();
