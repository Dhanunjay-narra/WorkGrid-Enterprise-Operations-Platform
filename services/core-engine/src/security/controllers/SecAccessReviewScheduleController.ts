import { SecAccessReviewScheduleService } from "../services/SecAccessReviewScheduleService";

export class SecAccessReviewScheduleController {
  private service = new SecAccessReviewScheduleService();
