import { SecBlockedIpRecordService } from "../services/SecBlockedIpRecordService";

export class SecBlockedIpRecordController {
  private service = new SecBlockedIpRecordService();
