import { SecSecurityPolicyService } from "../services/SecSecurityPolicyService";

export class SecSecurityPolicyController {
  private service = new SecSecurityPolicyService();
