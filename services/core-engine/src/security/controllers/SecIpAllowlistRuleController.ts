import { SecIpAllowlistRuleService } from "../services/SecIpAllowlistRuleService";

export class SecIpAllowlistRuleController {
  private service = new SecIpAllowlistRuleService();
