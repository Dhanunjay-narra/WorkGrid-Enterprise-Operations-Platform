import { IntHealthCheckPingService } from "../services/IntHealthCheckPingService";

export class IntHealthCheckPingController {
  private service = new IntHealthCheckPingService();
