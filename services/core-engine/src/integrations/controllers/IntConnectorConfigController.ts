import { IntConnectorConfigService } from "../services/IntConnectorConfigService";

export class IntConnectorConfigController {
  private service = new IntConnectorConfigService();
