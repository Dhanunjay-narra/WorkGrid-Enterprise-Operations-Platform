import { IntOAuthConnectionService } from "../services/IntOAuthConnectionService";

export class IntOAuthConnectionController {
  private service = new IntOAuthConnectionService();
