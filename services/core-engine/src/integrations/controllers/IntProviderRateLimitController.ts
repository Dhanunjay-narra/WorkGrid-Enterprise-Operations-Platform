import { IntProviderRateLimitService } from "../services/IntProviderRateLimitService";

export class IntProviderRateLimitController {
  private service = new IntProviderRateLimitService();
