import { IntSyncQueueItemService } from "../services/IntSyncQueueItemService";

export class IntSyncQueueItemController {
  private service = new IntSyncQueueItemService();
