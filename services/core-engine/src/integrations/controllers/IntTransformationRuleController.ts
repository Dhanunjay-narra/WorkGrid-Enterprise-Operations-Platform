import { IntTransformationRuleService } from "../services/IntTransformationRuleService";

export class IntTransformationRuleController {
  private service = new IntTransformationRuleService();
