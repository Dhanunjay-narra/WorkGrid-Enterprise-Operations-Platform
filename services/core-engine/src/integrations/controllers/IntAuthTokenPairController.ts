import { IntAuthTokenPairService } from "../services/IntAuthTokenPairService";

export class IntAuthTokenPairController {
  private service = new IntAuthTokenPairService();
