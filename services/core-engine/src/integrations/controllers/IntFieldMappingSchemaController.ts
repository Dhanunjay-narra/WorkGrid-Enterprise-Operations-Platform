import { IntFieldMappingSchemaService } from "../services/IntFieldMappingSchemaService";

export class IntFieldMappingSchemaController {
  private service = new IntFieldMappingSchemaService();
