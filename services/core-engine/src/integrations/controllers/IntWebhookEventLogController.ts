import { IntWebhookEventLogService } from "../services/IntWebhookEventLogService";

export class IntWebhookEventLogController {
  private service = new IntWebhookEventLogService();
