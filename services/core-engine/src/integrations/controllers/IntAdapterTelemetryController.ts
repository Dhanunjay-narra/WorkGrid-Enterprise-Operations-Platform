import { IntAdapterTelemetryService } from "../services/IntAdapterTelemetryService";

export class IntAdapterTelemetryController {
  private service = new IntAdapterTelemetryService();
