import { IntWebhookSubscriptionService } from "../services/IntWebhookSubscriptionService";

export class IntWebhookSubscriptionController {
  private service = new IntWebhookSubscriptionService();
