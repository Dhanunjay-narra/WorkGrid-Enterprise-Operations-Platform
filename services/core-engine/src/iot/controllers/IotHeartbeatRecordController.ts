import { IotHeartbeatRecordService } from "../services/IotHeartbeatRecordService";

export class IotHeartbeatRecordController {
  private service = new IotHeartbeatRecordService();
