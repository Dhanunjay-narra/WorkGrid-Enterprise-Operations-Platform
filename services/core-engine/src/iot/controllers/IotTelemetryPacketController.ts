import { IotTelemetryPacketService } from "../services/IotTelemetryPacketService";

export class IotTelemetryPacketController {
  private service = new IotTelemetryPacketService();
