import { IotFirmwareVersionService } from "../services/IotFirmwareVersionService";

export class IotFirmwareVersionController {
  private service = new IotFirmwareVersionService();
