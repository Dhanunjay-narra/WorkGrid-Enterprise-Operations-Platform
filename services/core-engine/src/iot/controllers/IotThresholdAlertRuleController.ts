import { IotThresholdAlertRuleService } from "../services/IotThresholdAlertRuleService";

export class IotThresholdAlertRuleController {
  private service = new IotThresholdAlertRuleService();
