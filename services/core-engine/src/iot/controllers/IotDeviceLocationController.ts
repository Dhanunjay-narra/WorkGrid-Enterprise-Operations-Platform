import { IotDeviceLocationService } from "../services/IotDeviceLocationService";

export class IotDeviceLocationController {
  private service = new IotDeviceLocationService();
