import { IotSensorCalibrationService } from "../services/IotSensorCalibrationService";

export class IotSensorCalibrationController {
  private service = new IotSensorCalibrationService();
