import { IotCommandExecutionLogService } from "../services/IotCommandExecutionLogService";

export class IotCommandExecutionLogController {
  private service = new IotCommandExecutionLogService();
