import { IotDeviceCommandService } from "../services/IotDeviceCommandService";

export class IotDeviceCommandController {
  private service = new IotDeviceCommandService();
