import { HrSalaryComponentService } from "../services/HrSalaryComponentService";

export class HrSalaryComponentController {
  private service = new HrSalaryComponentService();
