import { HrInterviewStageService } from "../services/HrInterviewStageService";

export class HrInterviewStageController {
  private service = new HrInterviewStageService();
