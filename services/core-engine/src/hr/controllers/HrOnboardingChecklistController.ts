import { HrOnboardingChecklistService } from "../services/HrOnboardingChecklistService";

export class HrOnboardingChecklistController {
  private service = new HrOnboardingChecklistService();
