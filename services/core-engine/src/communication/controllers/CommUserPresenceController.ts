import { CommUserPresenceService } from "../services/CommUserPresenceService";

export class CommUserPresenceController {
  private service = new CommUserPresenceService();
