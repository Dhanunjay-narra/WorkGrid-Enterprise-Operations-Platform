import { CommWebhookDispatchLogService } from "../services/CommWebhookDispatchLogService";

export class CommWebhookDispatchLogController {
  private service = new CommWebhookDispatchLogService();
