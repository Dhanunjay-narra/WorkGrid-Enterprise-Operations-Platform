import { CommNotificationPreferenceService } from "../services/CommNotificationPreferenceService";

export class CommNotificationPreferenceController {
  private service = new CommNotificationPreferenceService();
