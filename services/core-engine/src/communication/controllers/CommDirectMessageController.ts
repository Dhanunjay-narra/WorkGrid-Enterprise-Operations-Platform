import { CommDirectMessageService } from "../services/CommDirectMessageService";

export class CommDirectMessageController {
  private service = new CommDirectMessageService();
