import { CommAttachmentFileService } from "../services/CommAttachmentFileService";

export class CommAttachmentFileController {
  private service = new CommAttachmentFileService();
