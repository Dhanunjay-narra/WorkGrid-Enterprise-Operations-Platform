import { CommMentionRecordService } from "../services/CommMentionRecordService";

export class CommMentionRecordController {
  private service = new CommMentionRecordService();
