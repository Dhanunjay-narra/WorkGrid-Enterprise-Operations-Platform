import { CommMessageReactionService } from "../services/CommMessageReactionService";

export class CommMessageReactionController {
  private service = new CommMessageReactionService();
