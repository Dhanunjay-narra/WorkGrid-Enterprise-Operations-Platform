import { CommBroadcastAnnouncementService } from "../services/CommBroadcastAnnouncementService";

export class CommBroadcastAnnouncementController {
  private service = new CommBroadcastAnnouncementService();
