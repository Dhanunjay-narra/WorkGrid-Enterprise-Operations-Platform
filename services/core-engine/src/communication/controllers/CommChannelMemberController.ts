import { CommChannelMemberService } from "../services/CommChannelMemberService";

export class CommChannelMemberController {
  private service = new CommChannelMemberService();
