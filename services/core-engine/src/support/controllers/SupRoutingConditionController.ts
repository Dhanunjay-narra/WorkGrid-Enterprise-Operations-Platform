import { SupRoutingConditionService } from "../services/SupRoutingConditionService";

export class SupRoutingConditionController {
  private service = new SupRoutingConditionService();
