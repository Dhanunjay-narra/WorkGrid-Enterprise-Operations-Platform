import { SupSatisfactionReportService } from "../services/SupSatisfactionReportService";

export class SupSatisfactionReportController {
  private service = new SupSatisfactionReportService();
