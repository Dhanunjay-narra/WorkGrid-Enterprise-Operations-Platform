import { SupEscalationRuleService } from "../services/SupEscalationRuleService";

export class SupEscalationRuleController {
  private service = new SupEscalationRuleService();
