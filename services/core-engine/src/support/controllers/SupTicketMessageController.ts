import { SupTicketMessageService } from "../services/SupTicketMessageService";

export class SupTicketMessageController {
  private service = new SupTicketMessageService();
