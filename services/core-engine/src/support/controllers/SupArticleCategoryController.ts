import { SupArticleCategoryService } from "../services/SupArticleCategoryService";

export class SupArticleCategoryController {
  private service = new SupArticleCategoryService();
