import { SupKnowledgeArticleService } from "../services/SupKnowledgeArticleService";

export class SupKnowledgeArticleController {
  private service = new SupKnowledgeArticleService();
