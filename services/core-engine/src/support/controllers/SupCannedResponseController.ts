import { SupCannedResponseService } from "../services/SupCannedResponseService";

export class SupCannedResponseController {
  private service = new SupCannedResponseService();
