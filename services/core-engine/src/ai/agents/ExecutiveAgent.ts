...
export class ExecutiveAgent {
  public readonly agentName = 'ExecutiveAgent';
  public readonly description = 'Synthesizes cross-domain metrics and generates high-level enterprise executive briefings.';
