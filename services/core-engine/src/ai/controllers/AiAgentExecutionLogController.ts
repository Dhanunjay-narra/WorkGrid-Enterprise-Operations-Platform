import { AiAgentExecutionLogService } from "../services/AiAgentExecutionLogService";

export class AiAgentExecutionLogController {
  private service = new AiAgentExecutionLogService();
