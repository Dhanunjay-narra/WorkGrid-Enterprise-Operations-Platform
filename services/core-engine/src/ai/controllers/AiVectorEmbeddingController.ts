import { AiVectorEmbeddingService } from "../services/AiVectorEmbeddingService";

export class AiVectorEmbeddingController {
  private service = new AiVectorEmbeddingService();
