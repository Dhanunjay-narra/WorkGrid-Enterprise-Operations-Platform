import { AiAgentMemoryEntryService } from "../services/AiAgentMemoryEntryService";

export class AiAgentMemoryEntryController {
  private service = new AiAgentMemoryEntryService();
