import { AiToolDefinitionService } from "../services/AiToolDefinitionService";

export class AiToolDefinitionController {
  private service = new AiToolDefinitionService();
