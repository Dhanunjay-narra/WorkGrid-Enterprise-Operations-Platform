import { AiModelFallbackLogService } from "../services/AiModelFallbackLogService";

export class AiModelFallbackLogController {
  private service = new AiModelFallbackLogService();
