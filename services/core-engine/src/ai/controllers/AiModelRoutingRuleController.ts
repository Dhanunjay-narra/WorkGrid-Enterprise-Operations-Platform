import { AiModelRoutingRuleService } from "../services/AiModelRoutingRuleService";

export class AiModelRoutingRuleController {
  private service = new AiModelRoutingRuleService();
