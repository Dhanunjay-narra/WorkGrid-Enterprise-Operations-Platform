import { AiToolCallRecordService } from "../services/AiToolCallRecordService";

export class AiToolCallRecordController {
  private service = new AiToolCallRecordService();
