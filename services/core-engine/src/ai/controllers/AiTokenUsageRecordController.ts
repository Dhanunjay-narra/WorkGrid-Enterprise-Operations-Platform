import { AiTokenUsageRecordService } from "../services/AiTokenUsageRecordService";

export class AiTokenUsageRecordController {
  private service = new AiTokenUsageRecordService();
