import { AiConfidenceScorecardService } from "../services/AiConfidenceScorecardService";

export class AiConfidenceScorecardController {
  private service = new AiConfidenceScorecardService();
