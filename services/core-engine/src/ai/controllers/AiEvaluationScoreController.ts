import { AiEvaluationScoreService } from "../services/AiEvaluationScoreService";

export class AiEvaluationScoreController {
  private service = new AiEvaluationScoreService();
