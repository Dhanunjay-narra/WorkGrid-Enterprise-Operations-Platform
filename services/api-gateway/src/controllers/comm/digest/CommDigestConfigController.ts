import { CommDigestConfigService } from "../../../../core-engine/src/comm/digest/services/CommDigestConfigService";

export class CommDigestConfigController {
  private service = new CommDigestConfigService();
