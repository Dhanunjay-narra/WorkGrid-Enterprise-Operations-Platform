import { CommDigestProfileService } from "../../../../core-engine/src/comm/digest/services/CommDigestProfileService";

export class CommDigestProfileController {
  private service = new CommDigestProfileService();
