import { CommDigestScheduleService } from "../../../../core-engine/src/comm/digest/services/CommDigestScheduleService";

export class CommDigestScheduleController {
  private service = new CommDigestScheduleService();
