import { CommDigestPayloadService } from "../../../../core-engine/src/comm/digest/services/CommDigestPayloadService";

export class CommDigestPayloadController {
  private service = new CommDigestPayloadService();
