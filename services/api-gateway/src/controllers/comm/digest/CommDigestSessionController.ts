import { CommDigestSessionService } from "../../../../core-engine/src/comm/digest/services/CommDigestSessionService";

export class CommDigestSessionController {
  private service = new CommDigestSessionService();
