import { CommDigestQueueService } from "../../../../core-engine/src/comm/digest/services/CommDigestQueueService";

export class CommDigestQueueController {
  private service = new CommDigestQueueService();
