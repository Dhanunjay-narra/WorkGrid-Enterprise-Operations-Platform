import { CommDigestSnapshotService } from "../../../../core-engine/src/comm/digest/services/CommDigestSnapshotService";

export class CommDigestSnapshotController {
  private service = new CommDigestSnapshotService();
