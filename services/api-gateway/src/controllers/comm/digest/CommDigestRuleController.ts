import { CommDigestRuleService } from "../../../../core-engine/src/comm/digest/services/CommDigestRuleService";

export class CommDigestRuleController {
  private service = new CommDigestRuleService();
