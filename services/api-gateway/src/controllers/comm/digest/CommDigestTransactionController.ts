import { CommDigestTransactionService } from "../../../../core-engine/src/comm/digest/services/CommDigestTransactionService";

export class CommDigestTransactionController {
  private service = new CommDigestTransactionService();
