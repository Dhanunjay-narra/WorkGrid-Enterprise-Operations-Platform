import { CommDigestPolicyService } from "../../../../core-engine/src/comm/digest/services/CommDigestPolicyService";

export class CommDigestPolicyController {
  private service = new CommDigestPolicyService();
