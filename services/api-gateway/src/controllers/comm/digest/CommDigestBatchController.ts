import { CommDigestBatchService } from "../../../../core-engine/src/comm/digest/services/CommDigestBatchService";

export class CommDigestBatchController {
  private service = new CommDigestBatchService();
