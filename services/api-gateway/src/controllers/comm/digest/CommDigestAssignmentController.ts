import { CommDigestAssignmentService } from "../../../../core-engine/src/comm/digest/services/CommDigestAssignmentService";

export class CommDigestAssignmentController {
  private service = new CommDigestAssignmentService();
