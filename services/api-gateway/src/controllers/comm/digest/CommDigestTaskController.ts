import { CommDigestTaskService } from "../../../../core-engine/src/comm/digest/services/CommDigestTaskService";

export class CommDigestTaskController {
  private service = new CommDigestTaskService();
