import { CommDigestMetricService } from "../../../../core-engine/src/comm/digest/services/CommDigestMetricService";

export class CommDigestMetricController {
  private service = new CommDigestMetricService();
