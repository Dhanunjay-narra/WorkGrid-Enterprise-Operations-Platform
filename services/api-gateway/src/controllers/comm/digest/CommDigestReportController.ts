import { CommDigestReportService } from "../../../../core-engine/src/comm/digest/services/CommDigestReportService";

export class CommDigestReportController {
  private service = new CommDigestReportService();
