import { CommDigestStateService } from "../../../../core-engine/src/comm/digest/services/CommDigestStateService";

export class CommDigestStateController {
  private service = new CommDigestStateService();
