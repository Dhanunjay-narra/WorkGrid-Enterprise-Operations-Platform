import { CommDigestEntryService } from "../../../../core-engine/src/comm/digest/services/CommDigestEntryService";

export class CommDigestEntryController {
  private service = new CommDigestEntryService();
