import { CommDigestMappingService } from "../../../../core-engine/src/comm/digest/services/CommDigestMappingService";

export class CommDigestMappingController {
  private service = new CommDigestMappingService();
