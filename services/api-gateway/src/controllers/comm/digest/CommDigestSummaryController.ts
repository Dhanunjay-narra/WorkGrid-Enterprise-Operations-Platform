import { CommDigestSummaryService } from "../../../../core-engine/src/comm/digest/services/CommDigestSummaryService";

export class CommDigestSummaryController {
  private service = new CommDigestSummaryService();
