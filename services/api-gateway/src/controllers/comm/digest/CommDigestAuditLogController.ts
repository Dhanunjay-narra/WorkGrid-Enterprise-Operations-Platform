import { CommDigestAuditLogService } from "../../../../core-engine/src/comm/digest/services/CommDigestAuditLogService";

export class CommDigestAuditLogController {
  private service = new CommDigestAuditLogService();
