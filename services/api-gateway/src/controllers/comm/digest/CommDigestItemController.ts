import { CommDigestItemService } from "../../../../core-engine/src/comm/digest/services/CommDigestItemService";

export class CommDigestItemController {
  private service = new CommDigestItemService();
