import { CommDigestNodeService } from "../../../../core-engine/src/comm/digest/services/CommDigestNodeService";

export class CommDigestNodeController {
  private service = new CommDigestNodeService();
