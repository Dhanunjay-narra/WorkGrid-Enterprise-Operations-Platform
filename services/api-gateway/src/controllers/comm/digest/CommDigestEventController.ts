import { CommDigestEventService } from "../../../../core-engine/src/comm/digest/services/CommDigestEventService";

export class CommDigestEventController {
  private service = new CommDigestEventService();
