import { CommDigestThresholdService } from "../../../../core-engine/src/comm/digest/services/CommDigestThresholdService";

export class CommDigestThresholdController {
  private service = new CommDigestThresholdService();
