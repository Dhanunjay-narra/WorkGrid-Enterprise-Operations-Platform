import { CommDigestRecordService } from "../../../../core-engine/src/comm/digest/services/CommDigestRecordService";

export class CommDigestRecordController {
  private service = new CommDigestRecordService();
