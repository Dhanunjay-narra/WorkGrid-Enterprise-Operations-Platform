import { CommWebhooksScheduleService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksScheduleService";

export class CommWebhooksScheduleController {
  private service = new CommWebhooksScheduleService();
