import { CommWebhooksAuditLogService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksAuditLogService";

export class CommWebhooksAuditLogController {
  private service = new CommWebhooksAuditLogService();
