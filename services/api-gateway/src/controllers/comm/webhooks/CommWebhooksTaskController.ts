import { CommWebhooksTaskService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksTaskService";

export class CommWebhooksTaskController {
  private service = new CommWebhooksTaskService();
