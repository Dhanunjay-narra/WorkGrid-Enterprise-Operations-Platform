import { CommWebhooksStateService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksStateService";

export class CommWebhooksStateController {
  private service = new CommWebhooksStateService();
