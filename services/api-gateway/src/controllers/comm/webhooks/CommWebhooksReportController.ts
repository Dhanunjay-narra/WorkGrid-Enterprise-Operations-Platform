import { CommWebhooksReportService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksReportService";

export class CommWebhooksReportController {
  private service = new CommWebhooksReportService();
