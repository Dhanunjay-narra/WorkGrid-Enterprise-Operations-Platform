import { CommWebhooksSnapshotService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksSnapshotService";

export class CommWebhooksSnapshotController {
  private service = new CommWebhooksSnapshotService();
