import { CommWebhooksMappingService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksMappingService";

export class CommWebhooksMappingController {
  private service = new CommWebhooksMappingService();
