import { CommWebhooksMetricService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksMetricService";

export class CommWebhooksMetricController {
  private service = new CommWebhooksMetricService();
