import { CommWebhooksProfileService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksProfileService";

export class CommWebhooksProfileController {
  private service = new CommWebhooksProfileService();
