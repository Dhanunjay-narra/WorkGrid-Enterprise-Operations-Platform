import { CommWebhooksRuleService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksRuleService";

export class CommWebhooksRuleController {
  private service = new CommWebhooksRuleService();
