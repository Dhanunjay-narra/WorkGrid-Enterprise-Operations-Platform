import { CommWebhooksPayloadService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksPayloadService";

export class CommWebhooksPayloadController {
  private service = new CommWebhooksPayloadService();
