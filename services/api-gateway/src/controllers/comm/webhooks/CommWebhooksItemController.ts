import { CommWebhooksItemService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksItemService";

export class CommWebhooksItemController {
  private service = new CommWebhooksItemService();
