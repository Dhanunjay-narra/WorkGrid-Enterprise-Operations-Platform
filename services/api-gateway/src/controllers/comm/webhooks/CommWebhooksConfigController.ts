import { CommWebhooksConfigService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksConfigService";

export class CommWebhooksConfigController {
  private service = new CommWebhooksConfigService();
