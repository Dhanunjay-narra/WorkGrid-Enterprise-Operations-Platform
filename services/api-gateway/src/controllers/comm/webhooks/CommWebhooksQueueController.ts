import { CommWebhooksQueueService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksQueueService";

export class CommWebhooksQueueController {
  private service = new CommWebhooksQueueService();
