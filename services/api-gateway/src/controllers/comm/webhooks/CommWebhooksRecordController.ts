import { CommWebhooksRecordService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksRecordService";

export class CommWebhooksRecordController {
  private service = new CommWebhooksRecordService();
