import { CommWebhooksSummaryService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksSummaryService";

export class CommWebhooksSummaryController {
  private service = new CommWebhooksSummaryService();
