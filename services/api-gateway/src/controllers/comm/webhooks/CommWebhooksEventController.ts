import { CommWebhooksEventService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksEventService";

export class CommWebhooksEventController {
  private service = new CommWebhooksEventService();
