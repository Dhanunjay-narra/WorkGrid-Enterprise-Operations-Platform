import { CommWebhooksEntryService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksEntryService";

export class CommWebhooksEntryController {
  private service = new CommWebhooksEntryService();
