import { CommWebhooksBatchService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksBatchService";

export class CommWebhooksBatchController {
  private service = new CommWebhooksBatchService();
