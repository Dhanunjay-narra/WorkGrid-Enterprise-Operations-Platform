import { CommWebhooksNodeService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksNodeService";

export class CommWebhooksNodeController {
  private service = new CommWebhooksNodeService();
