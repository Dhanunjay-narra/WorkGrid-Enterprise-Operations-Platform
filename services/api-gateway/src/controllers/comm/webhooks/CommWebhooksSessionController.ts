import { CommWebhooksSessionService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksSessionService";

export class CommWebhooksSessionController {
  private service = new CommWebhooksSessionService();
