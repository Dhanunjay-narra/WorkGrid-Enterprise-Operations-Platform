import { CommWebhooksPolicyService } from "../../../../core-engine/src/comm/webhooks/services/CommWebhooksPolicyService";

export class CommWebhooksPolicyController {
  private service = new CommWebhooksPolicyService();
