import { CommMessagesAuditLogService } from "../../../../core-engine/src/comm/messages/services/CommMessagesAuditLogService";

export class CommMessagesAuditLogController {
  private service = new CommMessagesAuditLogService();
