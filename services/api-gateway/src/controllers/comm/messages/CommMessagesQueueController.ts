import { CommMessagesQueueService } from "../../../../core-engine/src/comm/messages/services/CommMessagesQueueService";

export class CommMessagesQueueController {
  private service = new CommMessagesQueueService();
