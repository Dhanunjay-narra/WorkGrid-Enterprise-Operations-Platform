import { CommMessagesRecordService } from "../../../../core-engine/src/comm/messages/services/CommMessagesRecordService";

export class CommMessagesRecordController {
  private service = new CommMessagesRecordService();
