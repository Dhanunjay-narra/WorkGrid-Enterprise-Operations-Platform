import { CommMessagesNodeService } from "../../../../core-engine/src/comm/messages/services/CommMessagesNodeService";

export class CommMessagesNodeController {
  private service = new CommMessagesNodeService();
