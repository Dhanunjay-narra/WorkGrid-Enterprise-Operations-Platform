import { CommMessagesPayloadService } from "../../../../core-engine/src/comm/messages/services/CommMessagesPayloadService";

export class CommMessagesPayloadController {
  private service = new CommMessagesPayloadService();
