import { CommMessagesItemService } from "../../../../core-engine/src/comm/messages/services/CommMessagesItemService";

export class CommMessagesItemController {
  private service = new CommMessagesItemService();
