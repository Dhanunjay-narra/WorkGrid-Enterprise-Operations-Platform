import { CommMessagesMetricService } from "../../../../core-engine/src/comm/messages/services/CommMessagesMetricService";

export class CommMessagesMetricController {
  private service = new CommMessagesMetricService();
