import { CommMessagesSnapshotService } from "../../../../core-engine/src/comm/messages/services/CommMessagesSnapshotService";

export class CommMessagesSnapshotController {
  private service = new CommMessagesSnapshotService();
