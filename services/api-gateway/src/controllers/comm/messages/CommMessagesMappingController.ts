import { CommMessagesMappingService } from "../../../../core-engine/src/comm/messages/services/CommMessagesMappingService";

export class CommMessagesMappingController {
  private service = new CommMessagesMappingService();
