import { CommMessagesEventService } from "../../../../core-engine/src/comm/messages/services/CommMessagesEventService";

export class CommMessagesEventController {
  private service = new CommMessagesEventService();
