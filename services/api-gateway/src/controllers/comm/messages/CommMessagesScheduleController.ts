import { CommMessagesScheduleService } from "../../../../core-engine/src/comm/messages/services/CommMessagesScheduleService";

export class CommMessagesScheduleController {
  private service = new CommMessagesScheduleService();
