import { CommMessagesProfileService } from "../../../../core-engine/src/comm/messages/services/CommMessagesProfileService";

export class CommMessagesProfileController {
  private service = new CommMessagesProfileService();
