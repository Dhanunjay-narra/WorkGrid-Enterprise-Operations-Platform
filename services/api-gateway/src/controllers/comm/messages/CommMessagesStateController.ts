import { CommMessagesStateService } from "../../../../core-engine/src/comm/messages/services/CommMessagesStateService";

export class CommMessagesStateController {
  private service = new CommMessagesStateService();
