import { CommMessagesConfigService } from "../../../../core-engine/src/comm/messages/services/CommMessagesConfigService";

export class CommMessagesConfigController {
  private service = new CommMessagesConfigService();
