import { CommMessagesReportService } from "../../../../core-engine/src/comm/messages/services/CommMessagesReportService";

export class CommMessagesReportController {
  private service = new CommMessagesReportService();
