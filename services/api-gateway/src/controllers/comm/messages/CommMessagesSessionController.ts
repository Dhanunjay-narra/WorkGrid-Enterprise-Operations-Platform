import { CommMessagesSessionService } from "../../../../core-engine/src/comm/messages/services/CommMessagesSessionService";

export class CommMessagesSessionController {
  private service = new CommMessagesSessionService();
