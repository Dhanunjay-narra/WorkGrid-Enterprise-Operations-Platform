import { CommMessagesPolicyService } from "../../../../core-engine/src/comm/messages/services/CommMessagesPolicyService";

export class CommMessagesPolicyController {
  private service = new CommMessagesPolicyService();
