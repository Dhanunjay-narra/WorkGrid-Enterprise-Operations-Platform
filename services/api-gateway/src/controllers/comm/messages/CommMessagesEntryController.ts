import { CommMessagesEntryService } from "../../../../core-engine/src/comm/messages/services/CommMessagesEntryService";

export class CommMessagesEntryController {
  private service = new CommMessagesEntryService();
