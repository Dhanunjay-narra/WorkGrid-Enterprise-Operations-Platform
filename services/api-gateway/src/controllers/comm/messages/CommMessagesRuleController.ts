import { CommMessagesRuleService } from "../../../../core-engine/src/comm/messages/services/CommMessagesRuleService";

export class CommMessagesRuleController {
  private service = new CommMessagesRuleService();
