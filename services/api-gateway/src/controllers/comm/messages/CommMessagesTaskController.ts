import { CommMessagesTaskService } from "../../../../core-engine/src/comm/messages/services/CommMessagesTaskService";

export class CommMessagesTaskController {
  private service = new CommMessagesTaskService();
