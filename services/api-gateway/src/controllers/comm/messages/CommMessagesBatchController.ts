import { CommMessagesBatchService } from "../../../../core-engine/src/comm/messages/services/CommMessagesBatchService";

export class CommMessagesBatchController {
  private service = new CommMessagesBatchService();
