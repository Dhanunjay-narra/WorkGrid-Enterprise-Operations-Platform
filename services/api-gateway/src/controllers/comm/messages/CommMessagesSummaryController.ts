import { CommMessagesSummaryService } from "../../../../core-engine/src/comm/messages/services/CommMessagesSummaryService";

export class CommMessagesSummaryController {
  private service = new CommMessagesSummaryService();
