import { CommCallsNodeService } from "../../../../core-engine/src/comm/calls/services/CommCallsNodeService";

export class CommCallsNodeController {
  private service = new CommCallsNodeService();
