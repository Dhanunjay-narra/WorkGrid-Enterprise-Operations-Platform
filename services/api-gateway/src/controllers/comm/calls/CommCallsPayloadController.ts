import { CommCallsPayloadService } from "../../../../core-engine/src/comm/calls/services/CommCallsPayloadService";

export class CommCallsPayloadController {
  private service = new CommCallsPayloadService();
