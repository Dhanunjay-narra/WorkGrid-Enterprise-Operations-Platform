import { CommCallsScheduleService } from "../../../../core-engine/src/comm/calls/services/CommCallsScheduleService";

export class CommCallsScheduleController {
  private service = new CommCallsScheduleService();
