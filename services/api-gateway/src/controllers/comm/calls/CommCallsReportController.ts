import { CommCallsReportService } from "../../../../core-engine/src/comm/calls/services/CommCallsReportService";

export class CommCallsReportController {
  private service = new CommCallsReportService();
