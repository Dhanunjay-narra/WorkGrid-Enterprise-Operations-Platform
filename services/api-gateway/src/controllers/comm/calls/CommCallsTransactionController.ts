import { CommCallsTransactionService } from "../../../../core-engine/src/comm/calls/services/CommCallsTransactionService";

export class CommCallsTransactionController {
  private service = new CommCallsTransactionService();
