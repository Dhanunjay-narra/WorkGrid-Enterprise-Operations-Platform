import { CommCallsAssignmentService } from "../../../../core-engine/src/comm/calls/services/CommCallsAssignmentService";

export class CommCallsAssignmentController {
  private service = new CommCallsAssignmentService();
