import { CommCallsBatchService } from "../../../../core-engine/src/comm/calls/services/CommCallsBatchService";

export class CommCallsBatchController {
  private service = new CommCallsBatchService();
