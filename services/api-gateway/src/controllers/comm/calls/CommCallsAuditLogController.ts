import { CommCallsAuditLogService } from "../../../../core-engine/src/comm/calls/services/CommCallsAuditLogService";

export class CommCallsAuditLogController {
  private service = new CommCallsAuditLogService();
