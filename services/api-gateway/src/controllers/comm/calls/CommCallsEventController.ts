import { CommCallsEventService } from "../../../../core-engine/src/comm/calls/services/CommCallsEventService";

export class CommCallsEventController {
  private service = new CommCallsEventService();
