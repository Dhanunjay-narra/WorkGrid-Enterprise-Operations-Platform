import { CommCallsSummaryService } from "../../../../core-engine/src/comm/calls/services/CommCallsSummaryService";

export class CommCallsSummaryController {
  private service = new CommCallsSummaryService();
