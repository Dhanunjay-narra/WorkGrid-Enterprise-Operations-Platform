import { CommCallsMetricService } from "../../../../core-engine/src/comm/calls/services/CommCallsMetricService";

export class CommCallsMetricController {
  private service = new CommCallsMetricService();
