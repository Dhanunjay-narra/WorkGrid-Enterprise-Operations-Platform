import { CommCallsTaskService } from "../../../../core-engine/src/comm/calls/services/CommCallsTaskService";

export class CommCallsTaskController {
  private service = new CommCallsTaskService();
