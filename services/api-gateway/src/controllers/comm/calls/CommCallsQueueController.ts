import { CommCallsQueueService } from "../../../../core-engine/src/comm/calls/services/CommCallsQueueService";

export class CommCallsQueueController {
  private service = new CommCallsQueueService();
