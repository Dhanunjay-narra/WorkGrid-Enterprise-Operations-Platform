import { CommCallsSnapshotService } from "../../../../core-engine/src/comm/calls/services/CommCallsSnapshotService";

export class CommCallsSnapshotController {
  private service = new CommCallsSnapshotService();
