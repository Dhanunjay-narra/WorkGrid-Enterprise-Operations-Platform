import { CommCallsEntryService } from "../../../../core-engine/src/comm/calls/services/CommCallsEntryService";

export class CommCallsEntryController {
  private service = new CommCallsEntryService();
