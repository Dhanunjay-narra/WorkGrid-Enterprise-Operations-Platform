import { CommCallsProfileService } from "../../../../core-engine/src/comm/calls/services/CommCallsProfileService";

export class CommCallsProfileController {
  private service = new CommCallsProfileService();
