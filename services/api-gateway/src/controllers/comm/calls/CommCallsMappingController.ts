import { CommCallsMappingService } from "../../../../core-engine/src/comm/calls/services/CommCallsMappingService";

export class CommCallsMappingController {
  private service = new CommCallsMappingService();
