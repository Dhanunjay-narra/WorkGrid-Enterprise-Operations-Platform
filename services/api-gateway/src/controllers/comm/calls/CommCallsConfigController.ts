import { CommCallsConfigService } from "../../../../core-engine/src/comm/calls/services/CommCallsConfigService";

export class CommCallsConfigController {
  private service = new CommCallsConfigService();
