import { CommCallsPolicyService } from "../../../../core-engine/src/comm/calls/services/CommCallsPolicyService";

export class CommCallsPolicyController {
  private service = new CommCallsPolicyService();
