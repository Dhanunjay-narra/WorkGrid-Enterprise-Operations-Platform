import { CommCallsThresholdService } from "../../../../core-engine/src/comm/calls/services/CommCallsThresholdService";

export class CommCallsThresholdController {
  private service = new CommCallsThresholdService();
