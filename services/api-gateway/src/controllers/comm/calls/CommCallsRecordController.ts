import { CommCallsRecordService } from "../../../../core-engine/src/comm/calls/services/CommCallsRecordService";

export class CommCallsRecordController {
  private service = new CommCallsRecordService();
