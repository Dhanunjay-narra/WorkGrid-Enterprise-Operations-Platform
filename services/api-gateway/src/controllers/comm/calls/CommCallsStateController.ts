import { CommCallsStateService } from "../../../../core-engine/src/comm/calls/services/CommCallsStateService";

export class CommCallsStateController {
  private service = new CommCallsStateService();
