import { CommCallsItemService } from "../../../../core-engine/src/comm/calls/services/CommCallsItemService";

export class CommCallsItemController {
  private service = new CommCallsItemService();
