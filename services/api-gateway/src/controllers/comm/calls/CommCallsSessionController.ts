import { CommCallsSessionService } from "../../../../core-engine/src/comm/calls/services/CommCallsSessionService";

export class CommCallsSessionController {
  private service = new CommCallsSessionService();
