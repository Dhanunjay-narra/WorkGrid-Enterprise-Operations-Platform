import { CommCallsRuleService } from "../../../../core-engine/src/comm/calls/services/CommCallsRuleService";

export class CommCallsRuleController {
  private service = new CommCallsRuleService();
