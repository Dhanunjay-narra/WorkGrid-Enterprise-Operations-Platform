import { CommPresencePayloadService } from "../../../../core-engine/src/comm/presence/services/CommPresencePayloadService";

export class CommPresencePayloadController {
  private service = new CommPresencePayloadService();
