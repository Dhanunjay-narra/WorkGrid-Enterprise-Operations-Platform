import { CommPresenceQueueService } from "../../../../core-engine/src/comm/presence/services/CommPresenceQueueService";

export class CommPresenceQueueController {
  private service = new CommPresenceQueueService();
