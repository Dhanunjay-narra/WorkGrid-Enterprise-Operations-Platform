import { CommPresenceProfileService } from "../../../../core-engine/src/comm/presence/services/CommPresenceProfileService";

export class CommPresenceProfileController {
  private service = new CommPresenceProfileService();
