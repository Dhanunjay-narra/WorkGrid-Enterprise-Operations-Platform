import { CommPresenceAuditLogService } from "../../../../core-engine/src/comm/presence/services/CommPresenceAuditLogService";

export class CommPresenceAuditLogController {
  private service = new CommPresenceAuditLogService();
