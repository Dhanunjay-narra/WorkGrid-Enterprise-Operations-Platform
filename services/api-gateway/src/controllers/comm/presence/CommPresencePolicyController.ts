import { CommPresencePolicyService } from "../../../../core-engine/src/comm/presence/services/CommPresencePolicyService";

export class CommPresencePolicyController {
  private service = new CommPresencePolicyService();
