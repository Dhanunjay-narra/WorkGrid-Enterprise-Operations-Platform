import { CommPresenceMetricService } from "../../../../core-engine/src/comm/presence/services/CommPresenceMetricService";

export class CommPresenceMetricController {
  private service = new CommPresenceMetricService();
