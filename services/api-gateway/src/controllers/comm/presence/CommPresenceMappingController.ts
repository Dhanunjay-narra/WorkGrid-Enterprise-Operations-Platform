import { CommPresenceMappingService } from "../../../../core-engine/src/comm/presence/services/CommPresenceMappingService";

export class CommPresenceMappingController {
  private service = new CommPresenceMappingService();
