import { CommPresenceStateService } from "../../../../core-engine/src/comm/presence/services/CommPresenceStateService";

export class CommPresenceStateController {
  private service = new CommPresenceStateService();
