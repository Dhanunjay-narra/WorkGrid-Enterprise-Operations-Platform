import { CommPresenceEventService } from "../../../../core-engine/src/comm/presence/services/CommPresenceEventService";

export class CommPresenceEventController {
  private service = new CommPresenceEventService();
