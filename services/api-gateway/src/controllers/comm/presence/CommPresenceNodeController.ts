import { CommPresenceNodeService } from "../../../../core-engine/src/comm/presence/services/CommPresenceNodeService";

export class CommPresenceNodeController {
  private service = new CommPresenceNodeService();
