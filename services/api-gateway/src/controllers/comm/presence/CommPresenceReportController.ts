import { CommPresenceReportService } from "../../../../core-engine/src/comm/presence/services/CommPresenceReportService";

export class CommPresenceReportController {
  private service = new CommPresenceReportService();
