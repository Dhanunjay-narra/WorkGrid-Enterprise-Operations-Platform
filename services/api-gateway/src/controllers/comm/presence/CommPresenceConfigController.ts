import { CommPresenceConfigService } from "../../../../core-engine/src/comm/presence/services/CommPresenceConfigService";

export class CommPresenceConfigController {
  private service = new CommPresenceConfigService();
