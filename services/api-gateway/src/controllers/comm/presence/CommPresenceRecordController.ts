import { CommPresenceRecordService } from "../../../../core-engine/src/comm/presence/services/CommPresenceRecordService";

export class CommPresenceRecordController {
  private service = new CommPresenceRecordService();
