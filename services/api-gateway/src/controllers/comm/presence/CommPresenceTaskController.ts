import { CommPresenceTaskService } from "../../../../core-engine/src/comm/presence/services/CommPresenceTaskService";

export class CommPresenceTaskController {
  private service = new CommPresenceTaskService();
