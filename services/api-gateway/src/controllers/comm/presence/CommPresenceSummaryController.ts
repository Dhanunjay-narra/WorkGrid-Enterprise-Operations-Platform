import { CommPresenceSummaryService } from "../../../../core-engine/src/comm/presence/services/CommPresenceSummaryService";

export class CommPresenceSummaryController {
  private service = new CommPresenceSummaryService();
