import { CommPresenceBatchService } from "../../../../core-engine/src/comm/presence/services/CommPresenceBatchService";

export class CommPresenceBatchController {
  private service = new CommPresenceBatchService();
