import { CommPresenceScheduleService } from "../../../../core-engine/src/comm/presence/services/CommPresenceScheduleService";

export class CommPresenceScheduleController {
  private service = new CommPresenceScheduleService();
