import { CommPresenceEntryService } from "../../../../core-engine/src/comm/presence/services/CommPresenceEntryService";

export class CommPresenceEntryController {
  private service = new CommPresenceEntryService();
