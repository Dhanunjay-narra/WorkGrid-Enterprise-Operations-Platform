import { CommPresenceSessionService } from "../../../../core-engine/src/comm/presence/services/CommPresenceSessionService";

export class CommPresenceSessionController {
  private service = new CommPresenceSessionService();
