import { CommPresenceItemService } from "../../../../core-engine/src/comm/presence/services/CommPresenceItemService";

export class CommPresenceItemController {
  private service = new CommPresenceItemService();
