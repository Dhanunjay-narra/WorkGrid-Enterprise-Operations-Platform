import { CommPresenceSnapshotService } from "../../../../core-engine/src/comm/presence/services/CommPresenceSnapshotService";

export class CommPresenceSnapshotController {
  private service = new CommPresenceSnapshotService();
