import { CommPresenceRuleService } from "../../../../core-engine/src/comm/presence/services/CommPresenceRuleService";

export class CommPresenceRuleController {
  private service = new CommPresenceRuleService();
