import { CommChannelsMetricService } from "../../../../core-engine/src/comm/channels/services/CommChannelsMetricService";

export class CommChannelsMetricController {
  private service = new CommChannelsMetricService();
