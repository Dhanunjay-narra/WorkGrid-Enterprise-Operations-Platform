import { CommChannelsStateService } from "../../../../core-engine/src/comm/channels/services/CommChannelsStateService";

export class CommChannelsStateController {
  private service = new CommChannelsStateService();
