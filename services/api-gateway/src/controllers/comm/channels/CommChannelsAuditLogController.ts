import { CommChannelsAuditLogService } from "../../../../core-engine/src/comm/channels/services/CommChannelsAuditLogService";

export class CommChannelsAuditLogController {
  private service = new CommChannelsAuditLogService();
