import { CommChannelsNodeService } from "../../../../core-engine/src/comm/channels/services/CommChannelsNodeService";

export class CommChannelsNodeController {
  private service = new CommChannelsNodeService();
