import { CommChannelsMappingService } from "../../../../core-engine/src/comm/channels/services/CommChannelsMappingService";

export class CommChannelsMappingController {
  private service = new CommChannelsMappingService();
