import { CommChannelsPolicyService } from "../../../../core-engine/src/comm/channels/services/CommChannelsPolicyService";

export class CommChannelsPolicyController {
  private service = new CommChannelsPolicyService();
