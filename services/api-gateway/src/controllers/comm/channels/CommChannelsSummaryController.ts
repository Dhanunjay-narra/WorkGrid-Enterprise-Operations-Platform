import { CommChannelsSummaryService } from "../../../../core-engine/src/comm/channels/services/CommChannelsSummaryService";

export class CommChannelsSummaryController {
  private service = new CommChannelsSummaryService();
