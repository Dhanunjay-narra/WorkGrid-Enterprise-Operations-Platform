import { CommChannelsEventService } from "../../../../core-engine/src/comm/channels/services/CommChannelsEventService";

export class CommChannelsEventController {
  private service = new CommChannelsEventService();
