import { CommChannelsItemService } from "../../../../core-engine/src/comm/channels/services/CommChannelsItemService";

export class CommChannelsItemController {
  private service = new CommChannelsItemService();
