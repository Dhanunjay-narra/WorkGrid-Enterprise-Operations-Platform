import { CommChannelsConfigService } from "../../../../core-engine/src/comm/channels/services/CommChannelsConfigService";

export class CommChannelsConfigController {
  private service = new CommChannelsConfigService();
