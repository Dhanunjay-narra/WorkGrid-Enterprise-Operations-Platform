import { CommChannelsScheduleService } from "../../../../core-engine/src/comm/channels/services/CommChannelsScheduleService";

export class CommChannelsScheduleController {
  private service = new CommChannelsScheduleService();
