import { CommChannelsReportService } from "../../../../core-engine/src/comm/channels/services/CommChannelsReportService";

export class CommChannelsReportController {
  private service = new CommChannelsReportService();
