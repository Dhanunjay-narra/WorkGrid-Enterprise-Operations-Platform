import { CommChannelsSnapshotService } from "../../../../core-engine/src/comm/channels/services/CommChannelsSnapshotService";

export class CommChannelsSnapshotController {
  private service = new CommChannelsSnapshotService();
