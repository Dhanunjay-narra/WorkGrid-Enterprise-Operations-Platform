import { CommChannelsRecordService } from "../../../../core-engine/src/comm/channels/services/CommChannelsRecordService";

export class CommChannelsRecordController {
  private service = new CommChannelsRecordService();
