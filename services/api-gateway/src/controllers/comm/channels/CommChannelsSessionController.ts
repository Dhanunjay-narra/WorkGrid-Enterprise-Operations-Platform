import { CommChannelsSessionService } from "../../../../core-engine/src/comm/channels/services/CommChannelsSessionService";

export class CommChannelsSessionController {
  private service = new CommChannelsSessionService();
