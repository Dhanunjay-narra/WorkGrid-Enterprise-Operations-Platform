import { CommChannelsRuleService } from "../../../../core-engine/src/comm/channels/services/CommChannelsRuleService";

export class CommChannelsRuleController {
  private service = new CommChannelsRuleService();
