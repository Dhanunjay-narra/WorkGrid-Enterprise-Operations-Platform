import { CommChannelsProfileService } from "../../../../core-engine/src/comm/channels/services/CommChannelsProfileService";

export class CommChannelsProfileController {
  private service = new CommChannelsProfileService();
