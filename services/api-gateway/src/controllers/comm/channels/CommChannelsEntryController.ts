import { CommChannelsEntryService } from "../../../../core-engine/src/comm/channels/services/CommChannelsEntryService";

export class CommChannelsEntryController {
  private service = new CommChannelsEntryService();
