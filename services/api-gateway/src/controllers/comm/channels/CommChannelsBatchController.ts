import { CommChannelsBatchService } from "../../../../core-engine/src/comm/channels/services/CommChannelsBatchService";

export class CommChannelsBatchController {
  private service = new CommChannelsBatchService();
