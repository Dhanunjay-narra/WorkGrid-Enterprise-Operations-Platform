import { CommChannelsPayloadService } from "../../../../core-engine/src/comm/channels/services/CommChannelsPayloadService";

export class CommChannelsPayloadController {
  private service = new CommChannelsPayloadService();
