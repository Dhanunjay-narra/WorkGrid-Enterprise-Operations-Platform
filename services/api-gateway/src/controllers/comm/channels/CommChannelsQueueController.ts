import { CommChannelsQueueService } from "../../../../core-engine/src/comm/channels/services/CommChannelsQueueService";

export class CommChannelsQueueController {
  private service = new CommChannelsQueueService();
