import { CommChannelsTaskService } from "../../../../core-engine/src/comm/channels/services/CommChannelsTaskService";

export class CommChannelsTaskController {
  private service = new CommChannelsTaskService();
