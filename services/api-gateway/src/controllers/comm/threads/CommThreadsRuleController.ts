import { CommThreadsRuleService } from "../../../../core-engine/src/comm/threads/services/CommThreadsRuleService";

export class CommThreadsRuleController {
  private service = new CommThreadsRuleService();
