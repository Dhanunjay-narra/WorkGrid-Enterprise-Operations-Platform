import { CommThreadsEntryService } from "../../../../core-engine/src/comm/threads/services/CommThreadsEntryService";

export class CommThreadsEntryController {
  private service = new CommThreadsEntryService();
