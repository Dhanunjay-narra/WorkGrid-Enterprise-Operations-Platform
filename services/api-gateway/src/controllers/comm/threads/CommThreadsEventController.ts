import { CommThreadsEventService } from "../../../../core-engine/src/comm/threads/services/CommThreadsEventService";

export class CommThreadsEventController {
  private service = new CommThreadsEventService();
