import { CommThreadsTaskService } from "../../../../core-engine/src/comm/threads/services/CommThreadsTaskService";

export class CommThreadsTaskController {
  private service = new CommThreadsTaskService();
