import { CommThreadsNodeService } from "../../../../core-engine/src/comm/threads/services/CommThreadsNodeService";

export class CommThreadsNodeController {
  private service = new CommThreadsNodeService();
