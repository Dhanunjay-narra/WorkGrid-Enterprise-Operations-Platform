import { CommThreadsItemService } from "../../../../core-engine/src/comm/threads/services/CommThreadsItemService";

export class CommThreadsItemController {
  private service = new CommThreadsItemService();
