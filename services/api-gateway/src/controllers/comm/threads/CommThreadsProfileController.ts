import { CommThreadsProfileService } from "../../../../core-engine/src/comm/threads/services/CommThreadsProfileService";

export class CommThreadsProfileController {
  private service = new CommThreadsProfileService();
