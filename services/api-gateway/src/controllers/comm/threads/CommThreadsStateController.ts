import { CommThreadsStateService } from "../../../../core-engine/src/comm/threads/services/CommThreadsStateService";

export class CommThreadsStateController {
  private service = new CommThreadsStateService();
