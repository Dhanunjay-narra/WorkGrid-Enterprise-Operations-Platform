import { CommThreadsQueueService } from "../../../../core-engine/src/comm/threads/services/CommThreadsQueueService";

export class CommThreadsQueueController {
  private service = new CommThreadsQueueService();
