import { CommThreadsReportService } from "../../../../core-engine/src/comm/threads/services/CommThreadsReportService";

export class CommThreadsReportController {
  private service = new CommThreadsReportService();
