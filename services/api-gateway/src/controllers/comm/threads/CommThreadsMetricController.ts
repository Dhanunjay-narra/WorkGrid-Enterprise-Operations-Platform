import { CommThreadsMetricService } from "../../../../core-engine/src/comm/threads/services/CommThreadsMetricService";

export class CommThreadsMetricController {
  private service = new CommThreadsMetricService();
