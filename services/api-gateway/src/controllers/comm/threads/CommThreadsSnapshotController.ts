import { CommThreadsSnapshotService } from "../../../../core-engine/src/comm/threads/services/CommThreadsSnapshotService";

export class CommThreadsSnapshotController {
  private service = new CommThreadsSnapshotService();
