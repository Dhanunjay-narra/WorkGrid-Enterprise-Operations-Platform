import { CommThreadsMappingService } from "../../../../core-engine/src/comm/threads/services/CommThreadsMappingService";

export class CommThreadsMappingController {
  private service = new CommThreadsMappingService();
