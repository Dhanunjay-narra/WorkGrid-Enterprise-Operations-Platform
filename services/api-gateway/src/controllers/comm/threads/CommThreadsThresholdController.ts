import { CommThreadsThresholdService } from "../../../../core-engine/src/comm/threads/services/CommThreadsThresholdService";

export class CommThreadsThresholdController {
  private service = new CommThreadsThresholdService();
