import { CommThreadsRecordService } from "../../../../core-engine/src/comm/threads/services/CommThreadsRecordService";

export class CommThreadsRecordController {
  private service = new CommThreadsRecordService();
