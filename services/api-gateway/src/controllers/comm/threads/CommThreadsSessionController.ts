import { CommThreadsSessionService } from "../../../../core-engine/src/comm/threads/services/CommThreadsSessionService";

export class CommThreadsSessionController {
  private service = new CommThreadsSessionService();
