import { CommThreadsSummaryService } from "../../../../core-engine/src/comm/threads/services/CommThreadsSummaryService";

export class CommThreadsSummaryController {
  private service = new CommThreadsSummaryService();
