import { CommThreadsPayloadService } from "../../../../core-engine/src/comm/threads/services/CommThreadsPayloadService";

export class CommThreadsPayloadController {
  private service = new CommThreadsPayloadService();
