import { CommThreadsConfigService } from "../../../../core-engine/src/comm/threads/services/CommThreadsConfigService";

export class CommThreadsConfigController {
  private service = new CommThreadsConfigService();
