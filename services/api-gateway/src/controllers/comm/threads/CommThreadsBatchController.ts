import { CommThreadsBatchService } from "../../../../core-engine/src/comm/threads/services/CommThreadsBatchService";

export class CommThreadsBatchController {
  private service = new CommThreadsBatchService();
