import { CommThreadsAuditLogService } from "../../../../core-engine/src/comm/threads/services/CommThreadsAuditLogService";

export class CommThreadsAuditLogController {
  private service = new CommThreadsAuditLogService();
