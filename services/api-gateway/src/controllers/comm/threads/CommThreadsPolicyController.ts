import { CommThreadsPolicyService } from "../../../../core-engine/src/comm/threads/services/CommThreadsPolicyService";

export class CommThreadsPolicyController {
  private service = new CommThreadsPolicyService();
