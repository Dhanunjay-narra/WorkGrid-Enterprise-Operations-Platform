import { CommThreadsScheduleService } from "../../../../core-engine/src/comm/threads/services/CommThreadsScheduleService";

export class CommThreadsScheduleController {
  private service = new CommThreadsScheduleService();
