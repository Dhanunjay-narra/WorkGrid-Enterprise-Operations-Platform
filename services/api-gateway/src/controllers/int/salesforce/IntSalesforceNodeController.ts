import { IntSalesforceNodeService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceNodeService";

export class IntSalesforceNodeController {
  private service = new IntSalesforceNodeService();
