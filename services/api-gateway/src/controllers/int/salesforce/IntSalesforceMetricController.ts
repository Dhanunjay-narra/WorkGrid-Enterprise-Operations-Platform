import { IntSalesforceMetricService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceMetricService";

export class IntSalesforceMetricController {
  private service = new IntSalesforceMetricService();
