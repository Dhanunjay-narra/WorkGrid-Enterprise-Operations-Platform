import { IntSalesforceRecordService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceRecordService";

export class IntSalesforceRecordController {
  private service = new IntSalesforceRecordService();
