import { IntSalesforceReportService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceReportService";

export class IntSalesforceReportController {
  private service = new IntSalesforceReportService();
