import { IntSalesforceStateService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceStateService";

export class IntSalesforceStateController {
  private service = new IntSalesforceStateService();
