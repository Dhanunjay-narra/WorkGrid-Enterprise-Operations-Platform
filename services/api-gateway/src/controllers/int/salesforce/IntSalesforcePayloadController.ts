import { IntSalesforcePayloadService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforcePayloadService";

export class IntSalesforcePayloadController {
  private service = new IntSalesforcePayloadService();
