import { IntSalesforceMappingService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceMappingService";

export class IntSalesforceMappingController {
  private service = new IntSalesforceMappingService();
