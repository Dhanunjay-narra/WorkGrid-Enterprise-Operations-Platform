import { IntSalesforceTaskService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceTaskService";

export class IntSalesforceTaskController {
  private service = new IntSalesforceTaskService();
