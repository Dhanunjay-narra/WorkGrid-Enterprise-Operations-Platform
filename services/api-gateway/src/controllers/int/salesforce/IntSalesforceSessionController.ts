import { IntSalesforceSessionService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceSessionService";

export class IntSalesforceSessionController {
  private service = new IntSalesforceSessionService();
