import { IntSalesforceEventService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceEventService";

export class IntSalesforceEventController {
  private service = new IntSalesforceEventService();
