import { IntSalesforceItemService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceItemService";

export class IntSalesforceItemController {
  private service = new IntSalesforceItemService();
