import { IntSalesforceBatchService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceBatchService";

export class IntSalesforceBatchController {
  private service = new IntSalesforceBatchService();
