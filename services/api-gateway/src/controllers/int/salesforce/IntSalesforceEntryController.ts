import { IntSalesforceEntryService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceEntryService";

export class IntSalesforceEntryController {
  private service = new IntSalesforceEntryService();
