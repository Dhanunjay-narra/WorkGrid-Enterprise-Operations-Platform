import { IntSalesforceRuleService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceRuleService";

export class IntSalesforceRuleController {
  private service = new IntSalesforceRuleService();
