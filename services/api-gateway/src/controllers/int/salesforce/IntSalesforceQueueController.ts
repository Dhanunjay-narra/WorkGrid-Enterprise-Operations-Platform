import { IntSalesforceQueueService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceQueueService";

export class IntSalesforceQueueController {
  private service = new IntSalesforceQueueService();
