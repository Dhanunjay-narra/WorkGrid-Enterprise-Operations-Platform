import { IntSalesforcePolicyService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforcePolicyService";

export class IntSalesforcePolicyController {
  private service = new IntSalesforcePolicyService();
