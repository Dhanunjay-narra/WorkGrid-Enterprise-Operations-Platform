import { IntSalesforceProfileService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceProfileService";

export class IntSalesforceProfileController {
  private service = new IntSalesforceProfileService();
