import { IntSalesforceSummaryService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceSummaryService";

export class IntSalesforceSummaryController {
  private service = new IntSalesforceSummaryService();
