import { IntSalesforceConfigService } from "../../../../core-engine/src/int/salesforce/services/IntSalesforceConfigService";

export class IntSalesforceConfigController {
  private service = new IntSalesforceConfigService();
