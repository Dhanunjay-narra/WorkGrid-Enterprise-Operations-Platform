import { IntSyncNodeService } from "../../../../core-engine/src/int/sync/services/IntSyncNodeService";

export class IntSyncNodeController {
  private service = new IntSyncNodeService();
