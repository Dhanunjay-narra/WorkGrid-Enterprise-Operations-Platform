import { IntSyncProfileService } from "../../../../core-engine/src/int/sync/services/IntSyncProfileService";

export class IntSyncProfileController {
  private service = new IntSyncProfileService();
