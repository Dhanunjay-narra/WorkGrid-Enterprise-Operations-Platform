import { IntSyncMappingService } from "../../../../core-engine/src/int/sync/services/IntSyncMappingService";

export class IntSyncMappingController {
  private service = new IntSyncMappingService();
