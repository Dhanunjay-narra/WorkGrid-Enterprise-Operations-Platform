import { IntSyncBatchService } from "../../../../core-engine/src/int/sync/services/IntSyncBatchService";

export class IntSyncBatchController {
  private service = new IntSyncBatchService();
