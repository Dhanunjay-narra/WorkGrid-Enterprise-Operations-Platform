import { IntSyncConfigService } from "../../../../core-engine/src/int/sync/services/IntSyncConfigService";

export class IntSyncConfigController {
  private service = new IntSyncConfigService();
