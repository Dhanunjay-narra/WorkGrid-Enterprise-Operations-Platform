import { IntSyncItemService } from "../../../../core-engine/src/int/sync/services/IntSyncItemService";

export class IntSyncItemController {
  private service = new IntSyncItemService();
