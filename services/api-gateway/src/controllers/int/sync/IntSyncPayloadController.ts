import { IntSyncPayloadService } from "../../../../core-engine/src/int/sync/services/IntSyncPayloadService";

export class IntSyncPayloadController {
  private service = new IntSyncPayloadService();
