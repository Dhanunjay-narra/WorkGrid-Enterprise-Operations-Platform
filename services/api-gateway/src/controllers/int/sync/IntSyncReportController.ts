import { IntSyncReportService } from "../../../../core-engine/src/int/sync/services/IntSyncReportService";

export class IntSyncReportController {
  private service = new IntSyncReportService();
