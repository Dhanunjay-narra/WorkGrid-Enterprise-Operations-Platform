import { IntSyncScheduleService } from "../../../../core-engine/src/int/sync/services/IntSyncScheduleService";

export class IntSyncScheduleController {
  private service = new IntSyncScheduleService();
