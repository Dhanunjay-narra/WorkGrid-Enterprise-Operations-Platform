import { IntSyncAuditLogService } from "../../../../core-engine/src/int/sync/services/IntSyncAuditLogService";

export class IntSyncAuditLogController {
  private service = new IntSyncAuditLogService();
