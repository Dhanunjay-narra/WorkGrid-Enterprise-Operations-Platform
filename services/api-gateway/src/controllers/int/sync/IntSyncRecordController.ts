import { IntSyncRecordService } from "../../../../core-engine/src/int/sync/services/IntSyncRecordService";

export class IntSyncRecordController {
  private service = new IntSyncRecordService();
