import { IntSyncThresholdService } from "../../../../core-engine/src/int/sync/services/IntSyncThresholdService";

export class IntSyncThresholdController {
  private service = new IntSyncThresholdService();
