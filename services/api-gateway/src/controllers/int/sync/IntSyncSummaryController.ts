import { IntSyncSummaryService } from "../../../../core-engine/src/int/sync/services/IntSyncSummaryService";

export class IntSyncSummaryController {
  private service = new IntSyncSummaryService();
