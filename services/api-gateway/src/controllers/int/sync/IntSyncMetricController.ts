import { IntSyncMetricService } from "../../../../core-engine/src/int/sync/services/IntSyncMetricService";

export class IntSyncMetricController {
  private service = new IntSyncMetricService();
