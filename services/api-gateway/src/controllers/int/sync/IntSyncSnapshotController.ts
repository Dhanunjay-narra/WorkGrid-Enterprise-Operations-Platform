import { IntSyncSnapshotService } from "../../../../core-engine/src/int/sync/services/IntSyncSnapshotService";

export class IntSyncSnapshotController {
  private service = new IntSyncSnapshotService();
