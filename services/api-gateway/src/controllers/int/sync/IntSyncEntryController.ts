import { IntSyncEntryService } from "../../../../core-engine/src/int/sync/services/IntSyncEntryService";

export class IntSyncEntryController {
  private service = new IntSyncEntryService();
