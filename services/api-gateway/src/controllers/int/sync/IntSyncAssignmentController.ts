import { IntSyncAssignmentService } from "../../../../core-engine/src/int/sync/services/IntSyncAssignmentService";

export class IntSyncAssignmentController {
  private service = new IntSyncAssignmentService();
