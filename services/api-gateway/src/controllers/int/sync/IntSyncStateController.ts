import { IntSyncStateService } from "../../../../core-engine/src/int/sync/services/IntSyncStateService";

export class IntSyncStateController {
  private service = new IntSyncStateService();
