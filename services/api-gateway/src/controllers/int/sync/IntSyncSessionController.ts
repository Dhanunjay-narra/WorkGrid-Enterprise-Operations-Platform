import { IntSyncSessionService } from "../../../../core-engine/src/int/sync/services/IntSyncSessionService";

export class IntSyncSessionController {
  private service = new IntSyncSessionService();
