import { IntSyncRuleService } from "../../../../core-engine/src/int/sync/services/IntSyncRuleService";

export class IntSyncRuleController {
  private service = new IntSyncRuleService();
