import { IntSyncTransactionService } from "../../../../core-engine/src/int/sync/services/IntSyncTransactionService";

export class IntSyncTransactionController {
  private service = new IntSyncTransactionService();
