import { IntSyncTaskService } from "../../../../core-engine/src/int/sync/services/IntSyncTaskService";

export class IntSyncTaskController {
  private service = new IntSyncTaskService();
