import { IntSyncPolicyService } from "../../../../core-engine/src/int/sync/services/IntSyncPolicyService";

export class IntSyncPolicyController {
  private service = new IntSyncPolicyService();
