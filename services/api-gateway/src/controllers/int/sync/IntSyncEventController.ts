import { IntSyncEventService } from "../../../../core-engine/src/int/sync/services/IntSyncEventService";

export class IntSyncEventController {
  private service = new IntSyncEventService();
