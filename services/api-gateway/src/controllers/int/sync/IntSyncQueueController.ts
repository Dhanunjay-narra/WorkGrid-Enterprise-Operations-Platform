import { IntSyncQueueService } from "../../../../core-engine/src/int/sync/services/IntSyncQueueService";

export class IntSyncQueueController {
  private service = new IntSyncQueueService();
