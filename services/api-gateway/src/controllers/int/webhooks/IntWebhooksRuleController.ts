import { IntWebhooksRuleService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksRuleService";

export class IntWebhooksRuleController {
  private service = new IntWebhooksRuleService();
