import { IntWebhooksScheduleService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksScheduleService";

export class IntWebhooksScheduleController {
  private service = new IntWebhooksScheduleService();
