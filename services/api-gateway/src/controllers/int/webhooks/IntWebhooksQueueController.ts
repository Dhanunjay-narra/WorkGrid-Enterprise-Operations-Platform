import { IntWebhooksQueueService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksQueueService";

export class IntWebhooksQueueController {
  private service = new IntWebhooksQueueService();
