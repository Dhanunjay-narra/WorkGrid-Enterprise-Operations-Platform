import { IntWebhooksProfileService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksProfileService";

export class IntWebhooksProfileController {
  private service = new IntWebhooksProfileService();
