import { IntWebhooksSnapshotService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksSnapshotService";

export class IntWebhooksSnapshotController {
  private service = new IntWebhooksSnapshotService();
