import { IntWebhooksStateService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksStateService";

export class IntWebhooksStateController {
  private service = new IntWebhooksStateService();
