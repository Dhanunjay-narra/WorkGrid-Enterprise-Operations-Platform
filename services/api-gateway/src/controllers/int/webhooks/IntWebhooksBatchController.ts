import { IntWebhooksBatchService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksBatchService";

export class IntWebhooksBatchController {
  private service = new IntWebhooksBatchService();
