import { IntWebhooksThresholdService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksThresholdService";

export class IntWebhooksThresholdController {
  private service = new IntWebhooksThresholdService();
