import { IntWebhooksPayloadService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksPayloadService";

export class IntWebhooksPayloadController {
  private service = new IntWebhooksPayloadService();
