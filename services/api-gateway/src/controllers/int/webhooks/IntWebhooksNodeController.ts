import { IntWebhooksNodeService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksNodeService";

export class IntWebhooksNodeController {
  private service = new IntWebhooksNodeService();
