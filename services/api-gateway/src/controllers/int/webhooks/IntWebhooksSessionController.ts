import { IntWebhooksSessionService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksSessionService";

export class IntWebhooksSessionController {
  private service = new IntWebhooksSessionService();
