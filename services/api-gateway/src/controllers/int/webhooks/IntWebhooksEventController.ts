import { IntWebhooksEventService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksEventService";

export class IntWebhooksEventController {
  private service = new IntWebhooksEventService();
