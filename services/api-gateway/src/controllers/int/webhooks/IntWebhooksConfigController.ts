import { IntWebhooksConfigService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksConfigService";

export class IntWebhooksConfigController {
  private service = new IntWebhooksConfigService();
