import { IntWebhooksMetricService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksMetricService";

export class IntWebhooksMetricController {
  private service = new IntWebhooksMetricService();
