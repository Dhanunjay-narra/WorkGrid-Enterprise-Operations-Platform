import { IntWebhooksEntryService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksEntryService";

export class IntWebhooksEntryController {
  private service = new IntWebhooksEntryService();
