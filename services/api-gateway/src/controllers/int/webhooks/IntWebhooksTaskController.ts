import { IntWebhooksTaskService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksTaskService";

export class IntWebhooksTaskController {
  private service = new IntWebhooksTaskService();
