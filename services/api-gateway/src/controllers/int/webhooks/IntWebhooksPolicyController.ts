import { IntWebhooksPolicyService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksPolicyService";

export class IntWebhooksPolicyController {
  private service = new IntWebhooksPolicyService();
