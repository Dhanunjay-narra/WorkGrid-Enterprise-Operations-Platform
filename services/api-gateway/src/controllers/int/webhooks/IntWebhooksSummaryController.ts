import { IntWebhooksSummaryService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksSummaryService";

export class IntWebhooksSummaryController {
  private service = new IntWebhooksSummaryService();
