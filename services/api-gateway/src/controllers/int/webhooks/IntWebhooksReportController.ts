import { IntWebhooksReportService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksReportService";

export class IntWebhooksReportController {
  private service = new IntWebhooksReportService();
