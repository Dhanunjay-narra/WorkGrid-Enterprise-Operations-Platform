import { IntWebhooksRecordService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksRecordService";

export class IntWebhooksRecordController {
  private service = new IntWebhooksRecordService();
