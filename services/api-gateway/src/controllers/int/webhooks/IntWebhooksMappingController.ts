import { IntWebhooksMappingService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksMappingService";

export class IntWebhooksMappingController {
  private service = new IntWebhooksMappingService();
