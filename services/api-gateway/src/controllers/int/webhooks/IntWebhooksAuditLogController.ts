import { IntWebhooksAuditLogService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksAuditLogService";

export class IntWebhooksAuditLogController {
  private service = new IntWebhooksAuditLogService();
