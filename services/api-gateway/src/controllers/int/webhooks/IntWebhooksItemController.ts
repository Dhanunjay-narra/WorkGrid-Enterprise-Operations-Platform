import { IntWebhooksItemService } from "../../../../core-engine/src/int/webhooks/services/IntWebhooksItemService";

export class IntWebhooksItemController {
  private service = new IntWebhooksItemService();
