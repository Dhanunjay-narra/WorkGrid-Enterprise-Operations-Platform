import { IntMappingsProfileService } from "../../../../core-engine/src/int/mappings/services/IntMappingsProfileService";

export class IntMappingsProfileController {
  private service = new IntMappingsProfileService();
