import { IntMappingsThresholdService } from "../../../../core-engine/src/int/mappings/services/IntMappingsThresholdService";

export class IntMappingsThresholdController {
  private service = new IntMappingsThresholdService();
