import { IntMappingsEntryService } from "../../../../core-engine/src/int/mappings/services/IntMappingsEntryService";

export class IntMappingsEntryController {
  private service = new IntMappingsEntryService();
