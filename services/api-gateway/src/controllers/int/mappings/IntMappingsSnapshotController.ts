import { IntMappingsSnapshotService } from "../../../../core-engine/src/int/mappings/services/IntMappingsSnapshotService";

export class IntMappingsSnapshotController {
  private service = new IntMappingsSnapshotService();
