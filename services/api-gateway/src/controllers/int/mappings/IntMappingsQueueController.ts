import { IntMappingsQueueService } from "../../../../core-engine/src/int/mappings/services/IntMappingsQueueService";

export class IntMappingsQueueController {
  private service = new IntMappingsQueueService();
