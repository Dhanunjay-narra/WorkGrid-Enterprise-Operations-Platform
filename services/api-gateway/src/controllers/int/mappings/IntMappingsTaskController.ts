import { IntMappingsTaskService } from "../../../../core-engine/src/int/mappings/services/IntMappingsTaskService";

export class IntMappingsTaskController {
  private service = new IntMappingsTaskService();
