import { IntMappingsNodeService } from "../../../../core-engine/src/int/mappings/services/IntMappingsNodeService";

export class IntMappingsNodeController {
  private service = new IntMappingsNodeService();
