import { IntMappingsRuleService } from "../../../../core-engine/src/int/mappings/services/IntMappingsRuleService";

export class IntMappingsRuleController {
  private service = new IntMappingsRuleService();
