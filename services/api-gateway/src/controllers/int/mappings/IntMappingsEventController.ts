import { IntMappingsEventService } from "../../../../core-engine/src/int/mappings/services/IntMappingsEventService";

export class IntMappingsEventController {
  private service = new IntMappingsEventService();
