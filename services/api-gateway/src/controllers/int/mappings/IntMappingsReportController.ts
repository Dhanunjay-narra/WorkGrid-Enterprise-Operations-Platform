import { IntMappingsReportService } from "../../../../core-engine/src/int/mappings/services/IntMappingsReportService";

export class IntMappingsReportController {
  private service = new IntMappingsReportService();
