import { IntMappingsMappingService } from "../../../../core-engine/src/int/mappings/services/IntMappingsMappingService";

export class IntMappingsMappingController {
  private service = new IntMappingsMappingService();
