import { IntMappingsSummaryService } from "../../../../core-engine/src/int/mappings/services/IntMappingsSummaryService";

export class IntMappingsSummaryController {
  private service = new IntMappingsSummaryService();
