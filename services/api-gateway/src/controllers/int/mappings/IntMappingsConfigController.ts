import { IntMappingsConfigService } from "../../../../core-engine/src/int/mappings/services/IntMappingsConfigService";

export class IntMappingsConfigController {
  private service = new IntMappingsConfigService();
