import { IntMappingsStateService } from "../../../../core-engine/src/int/mappings/services/IntMappingsStateService";

export class IntMappingsStateController {
  private service = new IntMappingsStateService();
