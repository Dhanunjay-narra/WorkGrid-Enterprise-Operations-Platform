import { IntMappingsSessionService } from "../../../../core-engine/src/int/mappings/services/IntMappingsSessionService";

export class IntMappingsSessionController {
  private service = new IntMappingsSessionService();
