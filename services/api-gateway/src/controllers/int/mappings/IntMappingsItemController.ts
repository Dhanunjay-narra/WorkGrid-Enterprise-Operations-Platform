import { IntMappingsItemService } from "../../../../core-engine/src/int/mappings/services/IntMappingsItemService";

export class IntMappingsItemController {
  private service = new IntMappingsItemService();
