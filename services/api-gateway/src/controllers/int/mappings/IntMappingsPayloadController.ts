import { IntMappingsPayloadService } from "../../../../core-engine/src/int/mappings/services/IntMappingsPayloadService";

export class IntMappingsPayloadController {
  private service = new IntMappingsPayloadService();
