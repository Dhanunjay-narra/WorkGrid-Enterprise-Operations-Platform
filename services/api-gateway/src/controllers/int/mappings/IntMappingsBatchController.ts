import { IntMappingsBatchService } from "../../../../core-engine/src/int/mappings/services/IntMappingsBatchService";

export class IntMappingsBatchController {
  private service = new IntMappingsBatchService();
