import { IntMappingsAuditLogService } from "../../../../core-engine/src/int/mappings/services/IntMappingsAuditLogService";

export class IntMappingsAuditLogController {
  private service = new IntMappingsAuditLogService();
