import { IntMappingsMetricService } from "../../../../core-engine/src/int/mappings/services/IntMappingsMetricService";

export class IntMappingsMetricController {
  private service = new IntMappingsMetricService();
