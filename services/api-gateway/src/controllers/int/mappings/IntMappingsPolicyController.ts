import { IntMappingsPolicyService } from "../../../../core-engine/src/int/mappings/services/IntMappingsPolicyService";

export class IntMappingsPolicyController {
  private service = new IntMappingsPolicyService();
