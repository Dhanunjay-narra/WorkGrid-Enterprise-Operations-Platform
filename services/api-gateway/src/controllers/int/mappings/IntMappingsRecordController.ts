import { IntMappingsRecordService } from "../../../../core-engine/src/int/mappings/services/IntMappingsRecordService";

export class IntMappingsRecordController {
  private service = new IntMappingsRecordService();
