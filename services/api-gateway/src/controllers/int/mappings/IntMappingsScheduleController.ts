import { IntMappingsScheduleService } from "../../../../core-engine/src/int/mappings/services/IntMappingsScheduleService";

export class IntMappingsScheduleController {
  private service = new IntMappingsScheduleService();
