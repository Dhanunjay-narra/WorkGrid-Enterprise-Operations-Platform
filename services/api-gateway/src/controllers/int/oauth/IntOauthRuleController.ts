import { IntOauthRuleService } from "../../../../core-engine/src/int/oauth/services/IntOauthRuleService";

export class IntOauthRuleController {
  private service = new IntOauthRuleService();
