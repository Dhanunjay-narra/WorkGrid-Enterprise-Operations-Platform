import { IntOauthBatchService } from "../../../../core-engine/src/int/oauth/services/IntOauthBatchService";

export class IntOauthBatchController {
  private service = new IntOauthBatchService();
