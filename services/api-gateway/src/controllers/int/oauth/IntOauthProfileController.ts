import { IntOauthProfileService } from "../../../../core-engine/src/int/oauth/services/IntOauthProfileService";

export class IntOauthProfileController {
  private service = new IntOauthProfileService();
