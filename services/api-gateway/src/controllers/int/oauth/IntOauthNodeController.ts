import { IntOauthNodeService } from "../../../../core-engine/src/int/oauth/services/IntOauthNodeService";

export class IntOauthNodeController {
  private service = new IntOauthNodeService();
