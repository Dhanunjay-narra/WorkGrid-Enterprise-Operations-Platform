import { IntOauthPolicyService } from "../../../../core-engine/src/int/oauth/services/IntOauthPolicyService";

export class IntOauthPolicyController {
  private service = new IntOauthPolicyService();
