import { IntOauthQueueService } from "../../../../core-engine/src/int/oauth/services/IntOauthQueueService";

export class IntOauthQueueController {
  private service = new IntOauthQueueService();
