import { IntOauthSummaryService } from "../../../../core-engine/src/int/oauth/services/IntOauthSummaryService";

export class IntOauthSummaryController {
  private service = new IntOauthSummaryService();
