import { IntOauthReportService } from "../../../../core-engine/src/int/oauth/services/IntOauthReportService";

export class IntOauthReportController {
  private service = new IntOauthReportService();
