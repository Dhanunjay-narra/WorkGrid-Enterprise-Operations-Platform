import { IntOauthMappingService } from "../../../../core-engine/src/int/oauth/services/IntOauthMappingService";

export class IntOauthMappingController {
  private service = new IntOauthMappingService();
