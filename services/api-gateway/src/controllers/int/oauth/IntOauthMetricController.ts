import { IntOauthMetricService } from "../../../../core-engine/src/int/oauth/services/IntOauthMetricService";

export class IntOauthMetricController {
  private service = new IntOauthMetricService();
