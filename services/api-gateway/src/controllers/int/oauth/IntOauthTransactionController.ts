import { IntOauthTransactionService } from "../../../../core-engine/src/int/oauth/services/IntOauthTransactionService";

export class IntOauthTransactionController {
  private service = new IntOauthTransactionService();
