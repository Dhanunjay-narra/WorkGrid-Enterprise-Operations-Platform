import { IntOauthPayloadService } from "../../../../core-engine/src/int/oauth/services/IntOauthPayloadService";

export class IntOauthPayloadController {
  private service = new IntOauthPayloadService();
