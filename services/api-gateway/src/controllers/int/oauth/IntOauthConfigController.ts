import { IntOauthConfigService } from "../../../../core-engine/src/int/oauth/services/IntOauthConfigService";

export class IntOauthConfigController {
  private service = new IntOauthConfigService();
