import { IntOauthAuditLogService } from "../../../../core-engine/src/int/oauth/services/IntOauthAuditLogService";

export class IntOauthAuditLogController {
  private service = new IntOauthAuditLogService();
