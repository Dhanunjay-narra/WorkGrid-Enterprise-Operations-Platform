import { IntOauthEventService } from "../../../../core-engine/src/int/oauth/services/IntOauthEventService";

export class IntOauthEventController {
  private service = new IntOauthEventService();
