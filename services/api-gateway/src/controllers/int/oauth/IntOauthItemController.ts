import { IntOauthItemService } from "../../../../core-engine/src/int/oauth/services/IntOauthItemService";

export class IntOauthItemController {
  private service = new IntOauthItemService();
