import { IntOauthStateService } from "../../../../core-engine/src/int/oauth/services/IntOauthStateService";

export class IntOauthStateController {
  private service = new IntOauthStateService();
