import { IntOauthThresholdService } from "../../../../core-engine/src/int/oauth/services/IntOauthThresholdService";

export class IntOauthThresholdController {
  private service = new IntOauthThresholdService();
