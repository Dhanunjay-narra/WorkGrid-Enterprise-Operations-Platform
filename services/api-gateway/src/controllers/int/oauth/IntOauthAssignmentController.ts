import { IntOauthAssignmentService } from "../../../../core-engine/src/int/oauth/services/IntOauthAssignmentService";

export class IntOauthAssignmentController {
  private service = new IntOauthAssignmentService();
