import { IntOauthSessionService } from "../../../../core-engine/src/int/oauth/services/IntOauthSessionService";

export class IntOauthSessionController {
  private service = new IntOauthSessionService();
