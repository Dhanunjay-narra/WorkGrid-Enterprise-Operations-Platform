import { IntOauthScheduleService } from "../../../../core-engine/src/int/oauth/services/IntOauthScheduleService";

export class IntOauthScheduleController {
  private service = new IntOauthScheduleService();
