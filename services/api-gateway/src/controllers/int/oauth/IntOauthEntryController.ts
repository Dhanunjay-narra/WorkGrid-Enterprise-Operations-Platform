import { IntOauthEntryService } from "../../../../core-engine/src/int/oauth/services/IntOauthEntryService";

export class IntOauthEntryController {
  private service = new IntOauthEntryService();
