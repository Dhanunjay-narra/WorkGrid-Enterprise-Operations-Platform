import { IntOauthRecordService } from "../../../../core-engine/src/int/oauth/services/IntOauthRecordService";

export class IntOauthRecordController {
  private service = new IntOauthRecordService();
