import { IntOauthSnapshotService } from "../../../../core-engine/src/int/oauth/services/IntOauthSnapshotService";

export class IntOauthSnapshotController {
  private service = new IntOauthSnapshotService();
