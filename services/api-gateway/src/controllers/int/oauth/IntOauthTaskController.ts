import { IntOauthTaskService } from "../../../../core-engine/src/int/oauth/services/IntOauthTaskService";

export class IntOauthTaskController {
  private service = new IntOauthTaskService();
