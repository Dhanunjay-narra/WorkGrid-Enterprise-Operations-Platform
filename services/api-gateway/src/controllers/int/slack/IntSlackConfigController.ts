import { IntSlackConfigService } from "../../../../core-engine/src/int/slack/services/IntSlackConfigService";

export class IntSlackConfigController {
  private service = new IntSlackConfigService();
