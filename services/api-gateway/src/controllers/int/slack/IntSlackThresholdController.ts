import { IntSlackThresholdService } from "../../../../core-engine/src/int/slack/services/IntSlackThresholdService";

export class IntSlackThresholdController {
  private service = new IntSlackThresholdService();
