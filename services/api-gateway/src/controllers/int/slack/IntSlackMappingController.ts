import { IntSlackMappingService } from "../../../../core-engine/src/int/slack/services/IntSlackMappingService";

export class IntSlackMappingController {
  private service = new IntSlackMappingService();
