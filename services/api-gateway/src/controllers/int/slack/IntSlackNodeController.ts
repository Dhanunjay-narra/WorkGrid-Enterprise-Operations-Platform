import { IntSlackNodeService } from "../../../../core-engine/src/int/slack/services/IntSlackNodeService";

export class IntSlackNodeController {
  private service = new IntSlackNodeService();
