import { IntSlackStateService } from "../../../../core-engine/src/int/slack/services/IntSlackStateService";

export class IntSlackStateController {
  private service = new IntSlackStateService();
