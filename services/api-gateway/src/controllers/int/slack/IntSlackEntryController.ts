import { IntSlackEntryService } from "../../../../core-engine/src/int/slack/services/IntSlackEntryService";

export class IntSlackEntryController {
  private service = new IntSlackEntryService();
