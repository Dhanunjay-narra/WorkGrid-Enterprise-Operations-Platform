import { IntSlackQueueService } from "../../../../core-engine/src/int/slack/services/IntSlackQueueService";

export class IntSlackQueueController {
  private service = new IntSlackQueueService();
