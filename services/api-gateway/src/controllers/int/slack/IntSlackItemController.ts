import { IntSlackItemService } from "../../../../core-engine/src/int/slack/services/IntSlackItemService";

export class IntSlackItemController {
  private service = new IntSlackItemService();
