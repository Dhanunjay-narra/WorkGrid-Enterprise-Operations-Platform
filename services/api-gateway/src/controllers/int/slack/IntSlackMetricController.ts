import { IntSlackMetricService } from "../../../../core-engine/src/int/slack/services/IntSlackMetricService";

export class IntSlackMetricController {
  private service = new IntSlackMetricService();
