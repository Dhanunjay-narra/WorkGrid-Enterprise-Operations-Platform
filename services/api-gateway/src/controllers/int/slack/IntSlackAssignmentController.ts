import { IntSlackAssignmentService } from "../../../../core-engine/src/int/slack/services/IntSlackAssignmentService";

export class IntSlackAssignmentController {
  private service = new IntSlackAssignmentService();
