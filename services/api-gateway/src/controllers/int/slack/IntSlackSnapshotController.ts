import { IntSlackSnapshotService } from "../../../../core-engine/src/int/slack/services/IntSlackSnapshotService";

export class IntSlackSnapshotController {
  private service = new IntSlackSnapshotService();
