import { IntSlackSummaryService } from "../../../../core-engine/src/int/slack/services/IntSlackSummaryService";

export class IntSlackSummaryController {
  private service = new IntSlackSummaryService();
