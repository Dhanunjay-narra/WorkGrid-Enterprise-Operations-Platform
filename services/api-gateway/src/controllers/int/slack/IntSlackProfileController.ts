import { IntSlackProfileService } from "../../../../core-engine/src/int/slack/services/IntSlackProfileService";

export class IntSlackProfileController {
  private service = new IntSlackProfileService();
