import { IntSlackAuditLogService } from "../../../../core-engine/src/int/slack/services/IntSlackAuditLogService";

export class IntSlackAuditLogController {
  private service = new IntSlackAuditLogService();
