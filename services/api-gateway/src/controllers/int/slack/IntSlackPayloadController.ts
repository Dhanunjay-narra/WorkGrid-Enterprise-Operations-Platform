import { IntSlackPayloadService } from "../../../../core-engine/src/int/slack/services/IntSlackPayloadService";

export class IntSlackPayloadController {
  private service = new IntSlackPayloadService();
