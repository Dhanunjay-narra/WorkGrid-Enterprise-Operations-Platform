import { IntSlackRuleService } from "../../../../core-engine/src/int/slack/services/IntSlackRuleService";

export class IntSlackRuleController {
  private service = new IntSlackRuleService();
