import { IntSlackTaskService } from "../../../../core-engine/src/int/slack/services/IntSlackTaskService";

export class IntSlackTaskController {
  private service = new IntSlackTaskService();
