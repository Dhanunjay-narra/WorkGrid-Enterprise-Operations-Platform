import { IntSlackRecordService } from "../../../../core-engine/src/int/slack/services/IntSlackRecordService";

export class IntSlackRecordController {
  private service = new IntSlackRecordService();
