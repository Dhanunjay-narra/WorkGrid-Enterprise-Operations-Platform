import { IntSlackEventService } from "../../../../core-engine/src/int/slack/services/IntSlackEventService";

export class IntSlackEventController {
  private service = new IntSlackEventService();
