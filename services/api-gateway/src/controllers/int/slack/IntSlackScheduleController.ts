import { IntSlackScheduleService } from "../../../../core-engine/src/int/slack/services/IntSlackScheduleService";

export class IntSlackScheduleController {
  private service = new IntSlackScheduleService();
