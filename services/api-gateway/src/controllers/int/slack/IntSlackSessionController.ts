import { IntSlackSessionService } from "../../../../core-engine/src/int/slack/services/IntSlackSessionService";

export class IntSlackSessionController {
  private service = new IntSlackSessionService();
