import { IntSlackTransactionService } from "../../../../core-engine/src/int/slack/services/IntSlackTransactionService";

export class IntSlackTransactionController {
  private service = new IntSlackTransactionService();
