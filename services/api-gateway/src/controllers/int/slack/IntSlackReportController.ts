import { IntSlackReportService } from "../../../../core-engine/src/int/slack/services/IntSlackReportService";

export class IntSlackReportController {
  private service = new IntSlackReportService();
