import { IntSlackBatchService } from "../../../../core-engine/src/int/slack/services/IntSlackBatchService";

export class IntSlackBatchController {
  private service = new IntSlackBatchService();
