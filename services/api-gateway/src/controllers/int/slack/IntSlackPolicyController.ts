import { IntSlackPolicyService } from "../../../../core-engine/src/int/slack/services/IntSlackPolicyService";

export class IntSlackPolicyController {
  private service = new IntSlackPolicyService();
