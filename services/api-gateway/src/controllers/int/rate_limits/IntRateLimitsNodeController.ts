import { IntRateLimitsNodeService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsNodeService";

export class IntRateLimitsNodeController {
  private service = new IntRateLimitsNodeService();
