import { IntRateLimitsConfigService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsConfigService";

export class IntRateLimitsConfigController {
  private service = new IntRateLimitsConfigService();
