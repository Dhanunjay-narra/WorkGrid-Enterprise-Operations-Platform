import { IntRateLimitsMappingService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsMappingService";

export class IntRateLimitsMappingController {
  private service = new IntRateLimitsMappingService();
