import { IntRateLimitsQueueService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsQueueService";

export class IntRateLimitsQueueController {
  private service = new IntRateLimitsQueueService();
