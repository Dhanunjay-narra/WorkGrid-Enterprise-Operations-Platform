import { IntRateLimitsStateService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsStateService";

export class IntRateLimitsStateController {
  private service = new IntRateLimitsStateService();
