import { IntRateLimitsRuleService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsRuleService";

export class IntRateLimitsRuleController {
  private service = new IntRateLimitsRuleService();
