import { IntRateLimitsPayloadService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsPayloadService";

export class IntRateLimitsPayloadController {
  private service = new IntRateLimitsPayloadService();
