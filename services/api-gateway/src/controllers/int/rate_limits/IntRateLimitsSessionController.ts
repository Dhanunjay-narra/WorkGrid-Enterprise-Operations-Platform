import { IntRateLimitsSessionService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsSessionService";

export class IntRateLimitsSessionController {
  private service = new IntRateLimitsSessionService();
