import { IntRateLimitsReportService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsReportService";

export class IntRateLimitsReportController {
  private service = new IntRateLimitsReportService();
