import { IntRateLimitsRecordService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsRecordService";

export class IntRateLimitsRecordController {
  private service = new IntRateLimitsRecordService();
