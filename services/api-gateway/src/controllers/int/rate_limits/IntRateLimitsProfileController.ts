import { IntRateLimitsProfileService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsProfileService";

export class IntRateLimitsProfileController {
  private service = new IntRateLimitsProfileService();
