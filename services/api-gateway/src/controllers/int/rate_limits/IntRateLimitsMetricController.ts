import { IntRateLimitsMetricService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsMetricService";

export class IntRateLimitsMetricController {
  private service = new IntRateLimitsMetricService();
