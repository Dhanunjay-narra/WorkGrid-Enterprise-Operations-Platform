import { IntRateLimitsItemService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsItemService";

export class IntRateLimitsItemController {
  private service = new IntRateLimitsItemService();
