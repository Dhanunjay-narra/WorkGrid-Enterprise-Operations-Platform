import { IntRateLimitsPolicyService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsPolicyService";

export class IntRateLimitsPolicyController {
  private service = new IntRateLimitsPolicyService();
