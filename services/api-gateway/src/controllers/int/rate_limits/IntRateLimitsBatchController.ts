import { IntRateLimitsBatchService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsBatchService";

export class IntRateLimitsBatchController {
  private service = new IntRateLimitsBatchService();
