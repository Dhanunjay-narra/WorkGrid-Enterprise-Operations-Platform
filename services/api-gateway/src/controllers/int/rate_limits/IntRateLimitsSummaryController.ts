import { IntRateLimitsSummaryService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsSummaryService";

export class IntRateLimitsSummaryController {
  private service = new IntRateLimitsSummaryService();
