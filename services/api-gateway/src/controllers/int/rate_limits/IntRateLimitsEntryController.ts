import { IntRateLimitsEntryService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsEntryService";

export class IntRateLimitsEntryController {
  private service = new IntRateLimitsEntryService();
