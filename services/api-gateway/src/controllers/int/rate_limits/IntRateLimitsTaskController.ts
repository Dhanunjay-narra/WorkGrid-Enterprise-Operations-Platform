import { IntRateLimitsTaskService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsTaskService";

export class IntRateLimitsTaskController {
  private service = new IntRateLimitsTaskService();
