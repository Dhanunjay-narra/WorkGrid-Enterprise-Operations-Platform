import { IntRateLimitsEventService } from "../../../../core-engine/src/int/rate_limits/services/IntRateLimitsEventService";

export class IntRateLimitsEventController {
  private service = new IntRateLimitsEventService();
