import { IntStripeAuditLogService } from "../../../../core-engine/src/int/stripe/services/IntStripeAuditLogService";

export class IntStripeAuditLogController {
  private service = new IntStripeAuditLogService();
