import { IntStripeRuleService } from "../../../../core-engine/src/int/stripe/services/IntStripeRuleService";

export class IntStripeRuleController {
  private service = new IntStripeRuleService();
