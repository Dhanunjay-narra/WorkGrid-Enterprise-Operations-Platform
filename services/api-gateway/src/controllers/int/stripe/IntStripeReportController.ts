import { IntStripeReportService } from "../../../../core-engine/src/int/stripe/services/IntStripeReportService";

export class IntStripeReportController {
  private service = new IntStripeReportService();
