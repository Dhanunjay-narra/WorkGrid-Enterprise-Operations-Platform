import { IntStripeStateService } from "../../../../core-engine/src/int/stripe/services/IntStripeStateService";

export class IntStripeStateController {
  private service = new IntStripeStateService();
