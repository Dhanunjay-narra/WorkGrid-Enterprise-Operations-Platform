import { IntStripeSessionService } from "../../../../core-engine/src/int/stripe/services/IntStripeSessionService";

export class IntStripeSessionController {
  private service = new IntStripeSessionService();
