import { IntStripeAssignmentService } from "../../../../core-engine/src/int/stripe/services/IntStripeAssignmentService";

export class IntStripeAssignmentController {
  private service = new IntStripeAssignmentService();
