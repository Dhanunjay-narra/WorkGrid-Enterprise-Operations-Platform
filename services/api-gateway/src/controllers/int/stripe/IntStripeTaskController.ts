import { IntStripeTaskService } from "../../../../core-engine/src/int/stripe/services/IntStripeTaskService";

export class IntStripeTaskController {
  private service = new IntStripeTaskService();
