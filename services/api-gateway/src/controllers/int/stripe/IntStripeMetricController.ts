import { IntStripeMetricService } from "../../../../core-engine/src/int/stripe/services/IntStripeMetricService";

export class IntStripeMetricController {
  private service = new IntStripeMetricService();
