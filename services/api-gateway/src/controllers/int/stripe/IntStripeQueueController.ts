import { IntStripeQueueService } from "../../../../core-engine/src/int/stripe/services/IntStripeQueueService";

export class IntStripeQueueController {
  private service = new IntStripeQueueService();
