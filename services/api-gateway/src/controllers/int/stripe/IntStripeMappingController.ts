import { IntStripeMappingService } from "../../../../core-engine/src/int/stripe/services/IntStripeMappingService";

export class IntStripeMappingController {
  private service = new IntStripeMappingService();
