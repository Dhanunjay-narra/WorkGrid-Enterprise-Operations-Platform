import { IntStripeProfileService } from "../../../../core-engine/src/int/stripe/services/IntStripeProfileService";

export class IntStripeProfileController {
  private service = new IntStripeProfileService();
