import { IntStripeItemService } from "../../../../core-engine/src/int/stripe/services/IntStripeItemService";

export class IntStripeItemController {
  private service = new IntStripeItemService();
