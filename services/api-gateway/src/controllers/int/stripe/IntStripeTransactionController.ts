import { IntStripeTransactionService } from "../../../../core-engine/src/int/stripe/services/IntStripeTransactionService";

export class IntStripeTransactionController {
  private service = new IntStripeTransactionService();
