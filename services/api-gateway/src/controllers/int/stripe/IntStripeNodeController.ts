import { IntStripeNodeService } from "../../../../core-engine/src/int/stripe/services/IntStripeNodeService";

export class IntStripeNodeController {
  private service = new IntStripeNodeService();
