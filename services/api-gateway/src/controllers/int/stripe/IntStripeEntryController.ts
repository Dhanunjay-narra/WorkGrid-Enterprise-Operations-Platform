import { IntStripeEntryService } from "../../../../core-engine/src/int/stripe/services/IntStripeEntryService";

export class IntStripeEntryController {
  private service = new IntStripeEntryService();
