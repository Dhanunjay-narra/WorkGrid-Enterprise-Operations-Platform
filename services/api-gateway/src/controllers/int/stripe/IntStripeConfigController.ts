import { IntStripeConfigService } from "../../../../core-engine/src/int/stripe/services/IntStripeConfigService";

export class IntStripeConfigController {
  private service = new IntStripeConfigService();
