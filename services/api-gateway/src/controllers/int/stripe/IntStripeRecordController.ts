import { IntStripeRecordService } from "../../../../core-engine/src/int/stripe/services/IntStripeRecordService";

export class IntStripeRecordController {
  private service = new IntStripeRecordService();
