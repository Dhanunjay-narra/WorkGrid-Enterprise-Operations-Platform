import { IntStripePolicyService } from "../../../../core-engine/src/int/stripe/services/IntStripePolicyService";

export class IntStripePolicyController {
  private service = new IntStripePolicyService();
