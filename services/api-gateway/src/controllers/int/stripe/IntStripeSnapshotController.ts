import { IntStripeSnapshotService } from "../../../../core-engine/src/int/stripe/services/IntStripeSnapshotService";

export class IntStripeSnapshotController {
  private service = new IntStripeSnapshotService();
