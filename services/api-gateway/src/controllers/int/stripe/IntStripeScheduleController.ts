import { IntStripeScheduleService } from "../../../../core-engine/src/int/stripe/services/IntStripeScheduleService";

export class IntStripeScheduleController {
  private service = new IntStripeScheduleService();
