import { IntStripeSummaryService } from "../../../../core-engine/src/int/stripe/services/IntStripeSummaryService";

export class IntStripeSummaryController {
  private service = new IntStripeSummaryService();
