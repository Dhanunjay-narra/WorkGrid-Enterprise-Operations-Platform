import { IntStripePayloadService } from "../../../../core-engine/src/int/stripe/services/IntStripePayloadService";

export class IntStripePayloadController {
  private service = new IntStripePayloadService();
