import { IntStripeThresholdService } from "../../../../core-engine/src/int/stripe/services/IntStripeThresholdService";

export class IntStripeThresholdController {
  private service = new IntStripeThresholdService();
