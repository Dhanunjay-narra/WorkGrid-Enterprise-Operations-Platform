import { IntStripeBatchService } from "../../../../core-engine/src/int/stripe/services/IntStripeBatchService";

export class IntStripeBatchController {
  private service = new IntStripeBatchService();
