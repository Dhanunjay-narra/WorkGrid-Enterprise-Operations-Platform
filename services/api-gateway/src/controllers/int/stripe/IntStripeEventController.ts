import { IntStripeEventService } from "../../../../core-engine/src/int/stripe/services/IntStripeEventService";

export class IntStripeEventController {
  private service = new IntStripeEventService();
