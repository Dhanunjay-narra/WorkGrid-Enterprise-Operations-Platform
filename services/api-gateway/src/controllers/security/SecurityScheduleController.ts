import { SecurityScheduleService } from "../../../../core-engine/src/security/services/SecurityScheduleService";

export class SecurityScheduleController {
  private service = new SecurityScheduleService();
