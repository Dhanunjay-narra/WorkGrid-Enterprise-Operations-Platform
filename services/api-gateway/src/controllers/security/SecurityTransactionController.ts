import { SecurityTransactionService } from "../../../../core-engine/src/security/services/SecurityTransactionService";

export class SecurityTransactionController {
  private service = new SecurityTransactionService();
