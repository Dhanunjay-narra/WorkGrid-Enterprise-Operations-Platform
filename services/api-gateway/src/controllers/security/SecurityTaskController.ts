import { SecurityTaskService } from "../../../../core-engine/src/security/services/SecurityTaskService";

export class SecurityTaskController {
  private service = new SecurityTaskService();
