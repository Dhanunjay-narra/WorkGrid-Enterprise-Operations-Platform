import { SecurityThresholdService } from "../../../../core-engine/src/security/services/SecurityThresholdService";

export class SecurityThresholdController {
  private service = new SecurityThresholdService();
