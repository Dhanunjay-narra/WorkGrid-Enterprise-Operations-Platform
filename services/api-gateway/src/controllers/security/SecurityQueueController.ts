import { SecurityQueueService } from "../../../../core-engine/src/security/services/SecurityQueueService";

export class SecurityQueueController {
  private service = new SecurityQueueService();
