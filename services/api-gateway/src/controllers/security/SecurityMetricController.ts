import { SecurityMetricService } from "../../../../core-engine/src/security/services/SecurityMetricService";

export class SecurityMetricController {
  private service = new SecurityMetricService();
