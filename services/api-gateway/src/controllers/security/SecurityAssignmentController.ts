import { SecurityAssignmentService } from "../../../../core-engine/src/security/services/SecurityAssignmentService";

export class SecurityAssignmentController {
  private service = new SecurityAssignmentService();
