import { SecurityItemService } from "../../../../core-engine/src/security/services/SecurityItemService";

export class SecurityItemController {
  private service = new SecurityItemService();
