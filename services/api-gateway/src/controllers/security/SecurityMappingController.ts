import { SecurityMappingService } from "../../../../core-engine/src/security/services/SecurityMappingService";

export class SecurityMappingController {
  private service = new SecurityMappingService();
