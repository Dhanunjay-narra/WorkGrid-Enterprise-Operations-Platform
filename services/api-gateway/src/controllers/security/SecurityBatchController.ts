import { SecurityBatchService } from "../../../../core-engine/src/security/services/SecurityBatchService";

export class SecurityBatchController {
  private service = new SecurityBatchService();
