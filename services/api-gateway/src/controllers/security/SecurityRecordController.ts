import { SecurityRecordService } from "../../../../core-engine/src/security/services/SecurityRecordService";

export class SecurityRecordController {
  private service = new SecurityRecordService();
