import { SecurityPayloadService } from "../../../../core-engine/src/security/services/SecurityPayloadService";

export class SecurityPayloadController {
  private service = new SecurityPayloadService();
