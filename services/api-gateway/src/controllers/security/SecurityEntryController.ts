import { SecurityEntryService } from "../../../../core-engine/src/security/services/SecurityEntryService";

export class SecurityEntryController {
  private service = new SecurityEntryService();
