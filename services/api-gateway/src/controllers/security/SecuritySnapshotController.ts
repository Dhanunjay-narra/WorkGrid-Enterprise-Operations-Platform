import { SecuritySnapshotService } from "../../../../core-engine/src/security/services/SecuritySnapshotService";

export class SecuritySnapshotController {
  private service = new SecuritySnapshotService();
