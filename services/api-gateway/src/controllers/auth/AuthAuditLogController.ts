import { AuthAuditLogService } from "../../../../core-engine/src/auth/services/AuthAuditLogService";

export class AuthAuditLogController {
  private service = new AuthAuditLogService();
