import { AuthTransactionService } from "../../../../core-engine/src/auth/services/AuthTransactionService";

export class AuthTransactionController {
  private service = new AuthTransactionService();
