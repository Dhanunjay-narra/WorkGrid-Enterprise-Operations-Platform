import { AuthSnapshotService } from "../../../../core-engine/src/auth/services/AuthSnapshotService";

export class AuthSnapshotController {
  private service = new AuthSnapshotService();
