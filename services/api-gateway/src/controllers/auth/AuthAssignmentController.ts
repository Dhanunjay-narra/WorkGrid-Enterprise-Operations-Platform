import { AuthAssignmentService } from "../../../../core-engine/src/auth/services/AuthAssignmentService";

export class AuthAssignmentController {
  private service = new AuthAssignmentService();
