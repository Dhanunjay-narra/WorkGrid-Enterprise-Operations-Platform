import { AuthPayloadService } from "../../../../core-engine/src/auth/services/AuthPayloadService";

export class AuthPayloadController {
  private service = new AuthPayloadService();
