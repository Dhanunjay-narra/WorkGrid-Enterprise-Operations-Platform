import { AuthThresholdService } from "../../../../core-engine/src/auth/services/AuthThresholdService";

export class AuthThresholdController {
  private service = new AuthThresholdService();
