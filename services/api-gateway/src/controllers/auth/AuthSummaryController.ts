import { AuthSummaryService } from "../../../../core-engine/src/auth/services/AuthSummaryService";

export class AuthSummaryController {
  private service = new AuthSummaryService();
