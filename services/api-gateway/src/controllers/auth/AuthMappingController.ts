import { AuthMappingService } from "../../../../core-engine/src/auth/services/AuthMappingService";

export class AuthMappingController {
  private service = new AuthMappingService();
