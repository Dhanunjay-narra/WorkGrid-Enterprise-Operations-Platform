import { CrmTerritoryMetricService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryMetricService";

export class CrmTerritoryMetricController {
  private service = new CrmTerritoryMetricService();
