import { CrmTerritoryPayloadService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryPayloadService";

export class CrmTerritoryPayloadController {
  private service = new CrmTerritoryPayloadService();
