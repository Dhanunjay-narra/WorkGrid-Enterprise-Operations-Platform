import { CrmTerritoryNodeService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryNodeService";

export class CrmTerritoryNodeController {
  private service = new CrmTerritoryNodeService();
