import { CrmTerritorySummaryService } from "../../../../core-engine/src/crm/territory/services/CrmTerritorySummaryService";

export class CrmTerritorySummaryController {
  private service = new CrmTerritorySummaryService();
