import { CrmTerritoryConfigService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryConfigService";

export class CrmTerritoryConfigController {
  private service = new CrmTerritoryConfigService();
