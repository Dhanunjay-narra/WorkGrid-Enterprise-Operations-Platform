import { CrmTerritoryPolicyService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryPolicyService";

export class CrmTerritoryPolicyController {
  private service = new CrmTerritoryPolicyService();
