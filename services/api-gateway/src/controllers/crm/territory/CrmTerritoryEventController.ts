import { CrmTerritoryEventService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryEventService";

export class CrmTerritoryEventController {
  private service = new CrmTerritoryEventService();
