import { CrmTerritoryRuleService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryRuleService";

export class CrmTerritoryRuleController {
  private service = new CrmTerritoryRuleService();
