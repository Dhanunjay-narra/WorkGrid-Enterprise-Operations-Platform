import { CrmTerritoryItemService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryItemService";

export class CrmTerritoryItemController {
  private service = new CrmTerritoryItemService();
