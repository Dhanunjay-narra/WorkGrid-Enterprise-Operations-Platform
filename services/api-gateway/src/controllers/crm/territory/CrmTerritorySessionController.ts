import { CrmTerritorySessionService } from "../../../../core-engine/src/crm/territory/services/CrmTerritorySessionService";

export class CrmTerritorySessionController {
  private service = new CrmTerritorySessionService();
