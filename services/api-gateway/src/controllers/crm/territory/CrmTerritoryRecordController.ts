import { CrmTerritoryRecordService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryRecordService";

export class CrmTerritoryRecordController {
  private service = new CrmTerritoryRecordService();
