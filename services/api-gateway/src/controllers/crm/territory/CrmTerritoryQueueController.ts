import { CrmTerritoryQueueService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryQueueService";

export class CrmTerritoryQueueController {
  private service = new CrmTerritoryQueueService();
