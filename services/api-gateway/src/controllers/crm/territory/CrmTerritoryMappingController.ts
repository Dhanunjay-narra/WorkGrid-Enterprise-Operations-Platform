import { CrmTerritoryMappingService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryMappingService";

export class CrmTerritoryMappingController {
  private service = new CrmTerritoryMappingService();
