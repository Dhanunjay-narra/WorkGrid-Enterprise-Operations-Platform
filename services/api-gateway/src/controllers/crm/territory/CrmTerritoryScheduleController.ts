import { CrmTerritoryScheduleService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryScheduleService";

export class CrmTerritoryScheduleController {
  private service = new CrmTerritoryScheduleService();
