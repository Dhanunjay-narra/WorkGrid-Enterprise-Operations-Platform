import { CrmTerritoryProfileService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryProfileService";

export class CrmTerritoryProfileController {
  private service = new CrmTerritoryProfileService();
