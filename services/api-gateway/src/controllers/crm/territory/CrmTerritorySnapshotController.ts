import { CrmTerritorySnapshotService } from "../../../../core-engine/src/crm/territory/services/CrmTerritorySnapshotService";

export class CrmTerritorySnapshotController {
  private service = new CrmTerritorySnapshotService();
