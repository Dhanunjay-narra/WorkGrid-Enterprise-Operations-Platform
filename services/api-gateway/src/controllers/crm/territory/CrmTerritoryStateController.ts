import { CrmTerritoryStateService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryStateService";

export class CrmTerritoryStateController {
  private service = new CrmTerritoryStateService();
