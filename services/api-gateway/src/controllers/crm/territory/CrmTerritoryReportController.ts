import { CrmTerritoryReportService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryReportService";

export class CrmTerritoryReportController {
  private service = new CrmTerritoryReportService();
