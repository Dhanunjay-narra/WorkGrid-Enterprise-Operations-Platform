import { CrmTerritoryEntryService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryEntryService";

export class CrmTerritoryEntryController {
  private service = new CrmTerritoryEntryService();
