import { CrmTerritoryTaskService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryTaskService";

export class CrmTerritoryTaskController {
  private service = new CrmTerritoryTaskService();
