import { CrmTerritoryBatchService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryBatchService";

export class CrmTerritoryBatchController {
  private service = new CrmTerritoryBatchService();
