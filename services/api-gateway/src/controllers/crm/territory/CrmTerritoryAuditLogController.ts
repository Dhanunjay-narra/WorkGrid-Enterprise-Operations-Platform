import { CrmTerritoryAuditLogService } from "../../../../core-engine/src/crm/territory/services/CrmTerritoryAuditLogService";

export class CrmTerritoryAuditLogController {
  private service = new CrmTerritoryAuditLogService();
