import { CrmLeadsReportService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsReportService";

export class CrmLeadsReportController {
  private service = new CrmLeadsReportService();
