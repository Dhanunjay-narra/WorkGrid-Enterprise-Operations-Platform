import { CrmLeadsProfileService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsProfileService";

export class CrmLeadsProfileController {
  private service = new CrmLeadsProfileService();
