import { CrmLeadsMappingService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsMappingService";

export class CrmLeadsMappingController {
  private service = new CrmLeadsMappingService();
