import { CrmLeadsAssignmentService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsAssignmentService";

export class CrmLeadsAssignmentController {
  private service = new CrmLeadsAssignmentService();
