import { CrmLeadsSnapshotService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsSnapshotService";

export class CrmLeadsSnapshotController {
  private service = new CrmLeadsSnapshotService();
