import { CrmLeadsPayloadService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsPayloadService";

export class CrmLeadsPayloadController {
  private service = new CrmLeadsPayloadService();
