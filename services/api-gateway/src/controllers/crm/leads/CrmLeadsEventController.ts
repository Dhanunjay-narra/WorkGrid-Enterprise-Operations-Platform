import { CrmLeadsEventService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsEventService";

export class CrmLeadsEventController {
  private service = new CrmLeadsEventService();
