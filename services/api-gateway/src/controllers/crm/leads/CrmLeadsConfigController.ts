import { CrmLeadsConfigService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsConfigService";

export class CrmLeadsConfigController {
  private service = new CrmLeadsConfigService();
