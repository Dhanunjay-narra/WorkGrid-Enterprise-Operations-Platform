import { CrmLeadsSessionService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsSessionService";

export class CrmLeadsSessionController {
  private service = new CrmLeadsSessionService();
