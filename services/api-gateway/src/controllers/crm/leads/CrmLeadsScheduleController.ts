import { CrmLeadsScheduleService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsScheduleService";

export class CrmLeadsScheduleController {
  private service = new CrmLeadsScheduleService();
