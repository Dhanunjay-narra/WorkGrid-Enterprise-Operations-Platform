import { CrmLeadsEntryService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsEntryService";

export class CrmLeadsEntryController {
  private service = new CrmLeadsEntryService();
