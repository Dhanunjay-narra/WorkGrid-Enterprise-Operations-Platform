import { CrmLeadsMetricService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsMetricService";

export class CrmLeadsMetricController {
  private service = new CrmLeadsMetricService();
