import { CrmLeadsBatchService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsBatchService";

export class CrmLeadsBatchController {
  private service = new CrmLeadsBatchService();
