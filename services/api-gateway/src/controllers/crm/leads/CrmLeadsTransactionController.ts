import { CrmLeadsTransactionService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsTransactionService";

export class CrmLeadsTransactionController {
  private service = new CrmLeadsTransactionService();
