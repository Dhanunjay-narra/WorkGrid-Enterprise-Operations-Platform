import { CrmLeadsRuleService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsRuleService";

export class CrmLeadsRuleController {
  private service = new CrmLeadsRuleService();
