import { CrmLeadsQueueService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsQueueService";

export class CrmLeadsQueueController {
  private service = new CrmLeadsQueueService();
