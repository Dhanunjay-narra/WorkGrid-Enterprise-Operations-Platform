import { CrmLeadsSummaryService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsSummaryService";

export class CrmLeadsSummaryController {
  private service = new CrmLeadsSummaryService();
