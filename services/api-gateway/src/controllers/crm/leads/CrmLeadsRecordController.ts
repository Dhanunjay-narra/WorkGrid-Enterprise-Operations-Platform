import { CrmLeadsRecordService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsRecordService";

export class CrmLeadsRecordController {
  private service = new CrmLeadsRecordService();
