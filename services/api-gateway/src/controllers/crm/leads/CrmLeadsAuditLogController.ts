import { CrmLeadsAuditLogService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsAuditLogService";

export class CrmLeadsAuditLogController {
  private service = new CrmLeadsAuditLogService();
