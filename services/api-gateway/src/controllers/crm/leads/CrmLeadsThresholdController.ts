import { CrmLeadsThresholdService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsThresholdService";

export class CrmLeadsThresholdController {
  private service = new CrmLeadsThresholdService();
