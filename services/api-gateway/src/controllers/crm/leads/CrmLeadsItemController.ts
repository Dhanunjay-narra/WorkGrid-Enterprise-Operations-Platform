import { CrmLeadsItemService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsItemService";

export class CrmLeadsItemController {
  private service = new CrmLeadsItemService();
