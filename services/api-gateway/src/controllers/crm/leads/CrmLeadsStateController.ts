import { CrmLeadsStateService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsStateService";

export class CrmLeadsStateController {
  private service = new CrmLeadsStateService();
