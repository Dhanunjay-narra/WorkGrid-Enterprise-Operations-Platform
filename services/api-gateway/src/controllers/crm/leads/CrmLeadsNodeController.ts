import { CrmLeadsNodeService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsNodeService";

export class CrmLeadsNodeController {
  private service = new CrmLeadsNodeService();
