import { CrmLeadsPolicyService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsPolicyService";

export class CrmLeadsPolicyController {
  private service = new CrmLeadsPolicyService();
