import { CrmLeadsTaskService } from "../../../../core-engine/src/crm/leads/services/CrmLeadsTaskService";

export class CrmLeadsTaskController {
  private service = new CrmLeadsTaskService();
