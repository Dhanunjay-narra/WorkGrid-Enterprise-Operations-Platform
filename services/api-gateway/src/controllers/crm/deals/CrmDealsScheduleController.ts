import { CrmDealsScheduleService } from "../../../../core-engine/src/crm/deals/services/CrmDealsScheduleService";

export class CrmDealsScheduleController {
  private service = new CrmDealsScheduleService();
