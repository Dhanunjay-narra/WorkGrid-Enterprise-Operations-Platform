import { CrmDealsAuditLogService } from "../../../../core-engine/src/crm/deals/services/CrmDealsAuditLogService";

export class CrmDealsAuditLogController {
  private service = new CrmDealsAuditLogService();
