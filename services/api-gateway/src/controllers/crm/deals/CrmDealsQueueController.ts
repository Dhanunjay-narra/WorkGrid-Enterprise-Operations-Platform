import { CrmDealsQueueService } from "../../../../core-engine/src/crm/deals/services/CrmDealsQueueService";

export class CrmDealsQueueController {
  private service = new CrmDealsQueueService();
