import { CrmDealsSessionService } from "../../../../core-engine/src/crm/deals/services/CrmDealsSessionService";

export class CrmDealsSessionController {
  private service = new CrmDealsSessionService();
