import { CrmDealsEventService } from "../../../../core-engine/src/crm/deals/services/CrmDealsEventService";

export class CrmDealsEventController {
  private service = new CrmDealsEventService();
