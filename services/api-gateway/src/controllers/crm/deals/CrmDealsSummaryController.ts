import { CrmDealsSummaryService } from "../../../../core-engine/src/crm/deals/services/CrmDealsSummaryService";

export class CrmDealsSummaryController {
  private service = new CrmDealsSummaryService();
