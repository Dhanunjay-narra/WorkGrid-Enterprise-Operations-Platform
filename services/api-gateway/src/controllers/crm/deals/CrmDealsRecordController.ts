import { CrmDealsRecordService } from "../../../../core-engine/src/crm/deals/services/CrmDealsRecordService";

export class CrmDealsRecordController {
  private service = new CrmDealsRecordService();
