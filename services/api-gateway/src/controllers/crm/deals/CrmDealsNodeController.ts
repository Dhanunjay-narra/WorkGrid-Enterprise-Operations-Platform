import { CrmDealsNodeService } from "../../../../core-engine/src/crm/deals/services/CrmDealsNodeService";

export class CrmDealsNodeController {
  private service = new CrmDealsNodeService();
