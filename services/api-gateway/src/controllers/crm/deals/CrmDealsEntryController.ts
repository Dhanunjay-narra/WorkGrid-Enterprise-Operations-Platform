import { CrmDealsEntryService } from "../../../../core-engine/src/crm/deals/services/CrmDealsEntryService";

export class CrmDealsEntryController {
  private service = new CrmDealsEntryService();
