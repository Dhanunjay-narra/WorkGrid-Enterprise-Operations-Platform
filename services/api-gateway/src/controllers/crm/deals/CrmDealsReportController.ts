import { CrmDealsReportService } from "../../../../core-engine/src/crm/deals/services/CrmDealsReportService";

export class CrmDealsReportController {
  private service = new CrmDealsReportService();
