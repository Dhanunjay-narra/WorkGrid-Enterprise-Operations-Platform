import { CrmDealsRuleService } from "../../../../core-engine/src/crm/deals/services/CrmDealsRuleService";

export class CrmDealsRuleController {
  private service = new CrmDealsRuleService();
