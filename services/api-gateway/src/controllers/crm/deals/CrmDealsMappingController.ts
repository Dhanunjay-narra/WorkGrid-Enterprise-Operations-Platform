import { CrmDealsMappingService } from "../../../../core-engine/src/crm/deals/services/CrmDealsMappingService";

export class CrmDealsMappingController {
  private service = new CrmDealsMappingService();
