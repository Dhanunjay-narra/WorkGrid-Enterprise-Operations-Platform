import { CrmDealsTransactionService } from "../../../../core-engine/src/crm/deals/services/CrmDealsTransactionService";

export class CrmDealsTransactionController {
  private service = new CrmDealsTransactionService();
