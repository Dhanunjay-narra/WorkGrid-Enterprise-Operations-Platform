import { CrmDealsConfigService } from "../../../../core-engine/src/crm/deals/services/CrmDealsConfigService";

export class CrmDealsConfigController {
  private service = new CrmDealsConfigService();
