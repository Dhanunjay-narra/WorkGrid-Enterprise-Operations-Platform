import { CrmDealsBatchService } from "../../../../core-engine/src/crm/deals/services/CrmDealsBatchService";

export class CrmDealsBatchController {
  private service = new CrmDealsBatchService();
