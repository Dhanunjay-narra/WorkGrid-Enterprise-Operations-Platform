import { CrmDealsSnapshotService } from "../../../../core-engine/src/crm/deals/services/CrmDealsSnapshotService";

export class CrmDealsSnapshotController {
  private service = new CrmDealsSnapshotService();
