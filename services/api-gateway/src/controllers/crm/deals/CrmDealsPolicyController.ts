import { CrmDealsPolicyService } from "../../../../core-engine/src/crm/deals/services/CrmDealsPolicyService";

export class CrmDealsPolicyController {
  private service = new CrmDealsPolicyService();
