import { CrmDealsThresholdService } from "../../../../core-engine/src/crm/deals/services/CrmDealsThresholdService";

export class CrmDealsThresholdController {
  private service = new CrmDealsThresholdService();
