import { CrmDealsTaskService } from "../../../../core-engine/src/crm/deals/services/CrmDealsTaskService";

export class CrmDealsTaskController {
  private service = new CrmDealsTaskService();
