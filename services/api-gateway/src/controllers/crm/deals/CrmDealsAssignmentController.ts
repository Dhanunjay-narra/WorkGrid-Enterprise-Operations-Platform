import { CrmDealsAssignmentService } from "../../../../core-engine/src/crm/deals/services/CrmDealsAssignmentService";

export class CrmDealsAssignmentController {
  private service = new CrmDealsAssignmentService();
