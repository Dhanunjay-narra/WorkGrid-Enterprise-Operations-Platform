import { CrmDealsStateService } from "../../../../core-engine/src/crm/deals/services/CrmDealsStateService";

export class CrmDealsStateController {
  private service = new CrmDealsStateService();
