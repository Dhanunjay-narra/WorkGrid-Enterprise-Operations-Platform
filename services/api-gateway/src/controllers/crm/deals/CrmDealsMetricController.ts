import { CrmDealsMetricService } from "../../../../core-engine/src/crm/deals/services/CrmDealsMetricService";

export class CrmDealsMetricController {
  private service = new CrmDealsMetricService();
