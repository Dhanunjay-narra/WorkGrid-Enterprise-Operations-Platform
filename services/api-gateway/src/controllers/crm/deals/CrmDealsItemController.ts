import { CrmDealsItemService } from "../../../../core-engine/src/crm/deals/services/CrmDealsItemService";

export class CrmDealsItemController {
  private service = new CrmDealsItemService();
