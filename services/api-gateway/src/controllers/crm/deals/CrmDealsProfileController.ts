import { CrmDealsProfileService } from "../../../../core-engine/src/crm/deals/services/CrmDealsProfileService";

export class CrmDealsProfileController {
  private service = new CrmDealsProfileService();
