import { CrmDealsPayloadService } from "../../../../core-engine/src/crm/deals/services/CrmDealsPayloadService";

export class CrmDealsPayloadController {
  private service = new CrmDealsPayloadService();
