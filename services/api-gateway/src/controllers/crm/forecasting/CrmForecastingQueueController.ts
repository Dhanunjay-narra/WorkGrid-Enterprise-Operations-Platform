import { CrmForecastingQueueService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingQueueService";

export class CrmForecastingQueueController {
  private service = new CrmForecastingQueueService();
