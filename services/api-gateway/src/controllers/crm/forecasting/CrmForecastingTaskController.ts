import { CrmForecastingTaskService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingTaskService";

export class CrmForecastingTaskController {
  private service = new CrmForecastingTaskService();
