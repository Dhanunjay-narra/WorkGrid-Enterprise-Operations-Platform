import { CrmForecastingBatchService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingBatchService";

export class CrmForecastingBatchController {
  private service = new CrmForecastingBatchService();
