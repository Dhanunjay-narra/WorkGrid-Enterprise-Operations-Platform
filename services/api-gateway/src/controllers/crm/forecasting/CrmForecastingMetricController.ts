import { CrmForecastingMetricService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingMetricService";

export class CrmForecastingMetricController {
  private service = new CrmForecastingMetricService();
