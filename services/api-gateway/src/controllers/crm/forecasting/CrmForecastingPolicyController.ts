import { CrmForecastingPolicyService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingPolicyService";

export class CrmForecastingPolicyController {
  private service = new CrmForecastingPolicyService();
