import { CrmForecastingEntryService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingEntryService";

export class CrmForecastingEntryController {
  private service = new CrmForecastingEntryService();
