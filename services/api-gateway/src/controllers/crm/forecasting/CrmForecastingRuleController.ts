import { CrmForecastingRuleService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingRuleService";

export class CrmForecastingRuleController {
  private service = new CrmForecastingRuleService();
