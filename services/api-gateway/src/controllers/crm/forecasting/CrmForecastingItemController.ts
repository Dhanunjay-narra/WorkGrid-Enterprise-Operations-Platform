import { CrmForecastingItemService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingItemService";

export class CrmForecastingItemController {
  private service = new CrmForecastingItemService();
