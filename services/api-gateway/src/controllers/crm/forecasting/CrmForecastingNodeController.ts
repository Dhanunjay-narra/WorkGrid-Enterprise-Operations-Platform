import { CrmForecastingNodeService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingNodeService";

export class CrmForecastingNodeController {
  private service = new CrmForecastingNodeService();
