import { CrmForecastingRecordService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingRecordService";

export class CrmForecastingRecordController {
  private service = new CrmForecastingRecordService();
