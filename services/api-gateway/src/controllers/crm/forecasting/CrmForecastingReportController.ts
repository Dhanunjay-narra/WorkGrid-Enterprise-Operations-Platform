import { CrmForecastingReportService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingReportService";

export class CrmForecastingReportController {
  private service = new CrmForecastingReportService();
