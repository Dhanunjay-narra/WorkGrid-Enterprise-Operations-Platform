import { CrmForecastingStateService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingStateService";

export class CrmForecastingStateController {
  private service = new CrmForecastingStateService();
