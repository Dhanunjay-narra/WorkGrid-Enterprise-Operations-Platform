import { CrmForecastingConfigService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingConfigService";

export class CrmForecastingConfigController {
  private service = new CrmForecastingConfigService();
