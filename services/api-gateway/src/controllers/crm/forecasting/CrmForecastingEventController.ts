import { CrmForecastingEventService } from "../../../../core-engine/src/crm/forecasting/services/CrmForecastingEventService";

export class CrmForecastingEventController {
  private service = new CrmForecastingEventService();
