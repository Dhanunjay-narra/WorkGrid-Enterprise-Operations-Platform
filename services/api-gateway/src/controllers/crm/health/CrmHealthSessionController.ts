import { CrmHealthSessionService } from "../../../../core-engine/src/crm/health/services/CrmHealthSessionService";

export class CrmHealthSessionController {
  private service = new CrmHealthSessionService();
