import { CrmHealthSnapshotService } from "../../../../core-engine/src/crm/health/services/CrmHealthSnapshotService";

export class CrmHealthSnapshotController {
  private service = new CrmHealthSnapshotService();
