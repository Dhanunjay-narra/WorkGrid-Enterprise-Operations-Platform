import { CrmHealthPolicyService } from "../../../../core-engine/src/crm/health/services/CrmHealthPolicyService";

export class CrmHealthPolicyController {
  private service = new CrmHealthPolicyService();
