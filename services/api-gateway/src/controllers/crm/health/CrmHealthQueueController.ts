import { CrmHealthQueueService } from "../../../../core-engine/src/crm/health/services/CrmHealthQueueService";

export class CrmHealthQueueController {
  private service = new CrmHealthQueueService();
