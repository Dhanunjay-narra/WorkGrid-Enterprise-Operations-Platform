import { CrmHealthSummaryService } from "../../../../core-engine/src/crm/health/services/CrmHealthSummaryService";

export class CrmHealthSummaryController {
  private service = new CrmHealthSummaryService();
