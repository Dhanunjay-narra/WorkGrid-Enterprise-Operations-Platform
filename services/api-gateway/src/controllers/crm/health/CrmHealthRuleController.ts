import { CrmHealthRuleService } from "../../../../core-engine/src/crm/health/services/CrmHealthRuleService";

export class CrmHealthRuleController {
  private service = new CrmHealthRuleService();
