import { CrmHealthScheduleService } from "../../../../core-engine/src/crm/health/services/CrmHealthScheduleService";

export class CrmHealthScheduleController {
  private service = new CrmHealthScheduleService();
