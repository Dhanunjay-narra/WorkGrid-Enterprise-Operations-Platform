import { CrmHealthRecordService } from "../../../../core-engine/src/crm/health/services/CrmHealthRecordService";

export class CrmHealthRecordController {
  private service = new CrmHealthRecordService();
