import { CrmHealthTaskService } from "../../../../core-engine/src/crm/health/services/CrmHealthTaskService";

export class CrmHealthTaskController {
  private service = new CrmHealthTaskService();
