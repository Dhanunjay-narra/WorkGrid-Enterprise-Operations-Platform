import { CrmHealthPayloadService } from "../../../../core-engine/src/crm/health/services/CrmHealthPayloadService";

export class CrmHealthPayloadController {
  private service = new CrmHealthPayloadService();
