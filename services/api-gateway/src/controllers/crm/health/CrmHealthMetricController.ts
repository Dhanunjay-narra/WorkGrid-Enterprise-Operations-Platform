import { CrmHealthMetricService } from "../../../../core-engine/src/crm/health/services/CrmHealthMetricService";

export class CrmHealthMetricController {
  private service = new CrmHealthMetricService();
