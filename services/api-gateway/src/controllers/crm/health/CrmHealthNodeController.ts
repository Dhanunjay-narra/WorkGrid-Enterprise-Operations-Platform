import { CrmHealthNodeService } from "../../../../core-engine/src/crm/health/services/CrmHealthNodeService";

export class CrmHealthNodeController {
  private service = new CrmHealthNodeService();
