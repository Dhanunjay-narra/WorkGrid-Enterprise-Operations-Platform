import { CrmHealthProfileService } from "../../../../core-engine/src/crm/health/services/CrmHealthProfileService";

export class CrmHealthProfileController {
  private service = new CrmHealthProfileService();
