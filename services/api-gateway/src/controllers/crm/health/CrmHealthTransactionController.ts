import { CrmHealthTransactionService } from "../../../../core-engine/src/crm/health/services/CrmHealthTransactionService";

export class CrmHealthTransactionController {
  private service = new CrmHealthTransactionService();
