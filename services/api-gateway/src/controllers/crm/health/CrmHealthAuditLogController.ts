import { CrmHealthAuditLogService } from "../../../../core-engine/src/crm/health/services/CrmHealthAuditLogService";

export class CrmHealthAuditLogController {
  private service = new CrmHealthAuditLogService();
