import { CrmHealthEventService } from "../../../../core-engine/src/crm/health/services/CrmHealthEventService";

export class CrmHealthEventController {
  private service = new CrmHealthEventService();
