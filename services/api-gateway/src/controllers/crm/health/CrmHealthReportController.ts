import { CrmHealthReportService } from "../../../../core-engine/src/crm/health/services/CrmHealthReportService";

export class CrmHealthReportController {
  private service = new CrmHealthReportService();
