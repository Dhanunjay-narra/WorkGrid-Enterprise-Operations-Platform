import { CrmHealthBatchService } from "../../../../core-engine/src/crm/health/services/CrmHealthBatchService";

export class CrmHealthBatchController {
  private service = new CrmHealthBatchService();
