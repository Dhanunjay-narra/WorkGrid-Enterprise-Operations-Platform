import { CrmHealthAssignmentService } from "../../../../core-engine/src/crm/health/services/CrmHealthAssignmentService";

export class CrmHealthAssignmentController {
  private service = new CrmHealthAssignmentService();
