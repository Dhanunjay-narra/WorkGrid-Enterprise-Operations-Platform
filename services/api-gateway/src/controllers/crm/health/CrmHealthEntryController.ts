import { CrmHealthEntryService } from "../../../../core-engine/src/crm/health/services/CrmHealthEntryService";

export class CrmHealthEntryController {
  private service = new CrmHealthEntryService();
