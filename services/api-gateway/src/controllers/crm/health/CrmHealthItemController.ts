import { CrmHealthItemService } from "../../../../core-engine/src/crm/health/services/CrmHealthItemService";

export class CrmHealthItemController {
  private service = new CrmHealthItemService();
