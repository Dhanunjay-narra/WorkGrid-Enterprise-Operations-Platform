import { CrmHealthMappingService } from "../../../../core-engine/src/crm/health/services/CrmHealthMappingService";

export class CrmHealthMappingController {
  private service = new CrmHealthMappingService();
