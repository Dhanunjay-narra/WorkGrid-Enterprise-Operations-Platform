import { CrmHealthThresholdService } from "../../../../core-engine/src/crm/health/services/CrmHealthThresholdService";

export class CrmHealthThresholdController {
  private service = new CrmHealthThresholdService();
