import { CrmHealthStateService } from "../../../../core-engine/src/crm/health/services/CrmHealthStateService";

export class CrmHealthStateController {
  private service = new CrmHealthStateService();
