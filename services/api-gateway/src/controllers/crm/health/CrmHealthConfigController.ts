import { CrmHealthConfigService } from "../../../../core-engine/src/crm/health/services/CrmHealthConfigService";

export class CrmHealthConfigController {
  private service = new CrmHealthConfigService();
