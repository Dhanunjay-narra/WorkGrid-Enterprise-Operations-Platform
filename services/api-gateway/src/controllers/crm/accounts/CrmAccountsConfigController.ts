import { CrmAccountsConfigService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsConfigService";

export class CrmAccountsConfigController {
  private service = new CrmAccountsConfigService();
