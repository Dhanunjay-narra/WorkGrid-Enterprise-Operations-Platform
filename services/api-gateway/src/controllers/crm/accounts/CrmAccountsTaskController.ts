import { CrmAccountsTaskService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsTaskService";

export class CrmAccountsTaskController {
  private service = new CrmAccountsTaskService();
