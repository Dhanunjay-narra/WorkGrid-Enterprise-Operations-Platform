import { CrmAccountsMappingService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsMappingService";

export class CrmAccountsMappingController {
  private service = new CrmAccountsMappingService();
