import { CrmAccountsBatchService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsBatchService";

export class CrmAccountsBatchController {
  private service = new CrmAccountsBatchService();
