import { CrmAccountsMetricService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsMetricService";

export class CrmAccountsMetricController {
  private service = new CrmAccountsMetricService();
