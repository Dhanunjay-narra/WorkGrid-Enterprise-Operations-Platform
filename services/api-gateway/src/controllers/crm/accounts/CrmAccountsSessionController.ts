import { CrmAccountsSessionService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsSessionService";

export class CrmAccountsSessionController {
  private service = new CrmAccountsSessionService();
