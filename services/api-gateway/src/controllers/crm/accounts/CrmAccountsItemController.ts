import { CrmAccountsItemService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsItemService";

export class CrmAccountsItemController {
  private service = new CrmAccountsItemService();
