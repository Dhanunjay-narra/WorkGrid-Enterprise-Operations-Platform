import { CrmAccountsStateService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsStateService";

export class CrmAccountsStateController {
  private service = new CrmAccountsStateService();
