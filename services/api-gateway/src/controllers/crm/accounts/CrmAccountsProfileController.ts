import { CrmAccountsProfileService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsProfileService";

export class CrmAccountsProfileController {
  private service = new CrmAccountsProfileService();
