import { CrmAccountsAuditLogService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsAuditLogService";

export class CrmAccountsAuditLogController {
  private service = new CrmAccountsAuditLogService();
