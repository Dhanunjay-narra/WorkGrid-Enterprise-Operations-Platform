import { CrmAccountsSummaryService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsSummaryService";

export class CrmAccountsSummaryController {
  private service = new CrmAccountsSummaryService();
