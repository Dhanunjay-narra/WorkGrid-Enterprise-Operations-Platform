import { CrmAccountsRecordService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsRecordService";

export class CrmAccountsRecordController {
  private service = new CrmAccountsRecordService();
