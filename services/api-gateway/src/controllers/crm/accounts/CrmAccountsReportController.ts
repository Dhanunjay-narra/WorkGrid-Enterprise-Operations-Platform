import { CrmAccountsReportService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsReportService";

export class CrmAccountsReportController {
  private service = new CrmAccountsReportService();
