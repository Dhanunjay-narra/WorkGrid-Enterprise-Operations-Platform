import { CrmAccountsPayloadService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsPayloadService";

export class CrmAccountsPayloadController {
  private service = new CrmAccountsPayloadService();
