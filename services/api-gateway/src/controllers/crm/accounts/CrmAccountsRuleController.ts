import { CrmAccountsRuleService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsRuleService";

export class CrmAccountsRuleController {
  private service = new CrmAccountsRuleService();
