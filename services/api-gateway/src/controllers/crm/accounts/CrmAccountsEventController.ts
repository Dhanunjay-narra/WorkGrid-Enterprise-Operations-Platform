import { CrmAccountsEventService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsEventService";

export class CrmAccountsEventController {
  private service = new CrmAccountsEventService();
