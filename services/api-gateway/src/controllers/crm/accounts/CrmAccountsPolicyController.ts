import { CrmAccountsPolicyService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsPolicyService";

export class CrmAccountsPolicyController {
  private service = new CrmAccountsPolicyService();
