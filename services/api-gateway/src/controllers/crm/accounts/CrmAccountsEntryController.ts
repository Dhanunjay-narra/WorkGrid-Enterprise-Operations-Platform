import { CrmAccountsEntryService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsEntryService";

export class CrmAccountsEntryController {
  private service = new CrmAccountsEntryService();
