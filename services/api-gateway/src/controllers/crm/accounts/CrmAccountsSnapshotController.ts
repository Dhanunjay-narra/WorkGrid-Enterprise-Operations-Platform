import { CrmAccountsSnapshotService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsSnapshotService";

export class CrmAccountsSnapshotController {
  private service = new CrmAccountsSnapshotService();
