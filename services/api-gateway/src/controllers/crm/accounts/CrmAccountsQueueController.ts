import { CrmAccountsQueueService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsQueueService";

export class CrmAccountsQueueController {
  private service = new CrmAccountsQueueService();
