import { CrmAccountsNodeService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsNodeService";

export class CrmAccountsNodeController {
  private service = new CrmAccountsNodeService();
