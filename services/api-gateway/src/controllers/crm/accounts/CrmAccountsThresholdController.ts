import { CrmAccountsThresholdService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsThresholdService";

export class CrmAccountsThresholdController {
  private service = new CrmAccountsThresholdService();
