import { CrmAccountsScheduleService } from "../../../../core-engine/src/crm/accounts/services/CrmAccountsScheduleService";

export class CrmAccountsScheduleController {
  private service = new CrmAccountsScheduleService();
