import { CrmPipelineStateService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineStateService";

export class CrmPipelineStateController {
  private service = new CrmPipelineStateService();
