import { CrmPipelinePolicyService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelinePolicyService";

export class CrmPipelinePolicyController {
  private service = new CrmPipelinePolicyService();
