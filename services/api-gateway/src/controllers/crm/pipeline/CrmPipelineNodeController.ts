import { CrmPipelineNodeService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineNodeService";

export class CrmPipelineNodeController {
  private service = new CrmPipelineNodeService();
