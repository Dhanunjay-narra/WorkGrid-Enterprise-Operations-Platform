import { CrmPipelineSummaryService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineSummaryService";

export class CrmPipelineSummaryController {
  private service = new CrmPipelineSummaryService();
