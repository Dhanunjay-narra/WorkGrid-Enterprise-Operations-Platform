import { CrmPipelineEventService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineEventService";

export class CrmPipelineEventController {
  private service = new CrmPipelineEventService();
