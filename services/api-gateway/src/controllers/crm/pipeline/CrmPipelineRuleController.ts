import { CrmPipelineRuleService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineRuleService";

export class CrmPipelineRuleController {
  private service = new CrmPipelineRuleService();
