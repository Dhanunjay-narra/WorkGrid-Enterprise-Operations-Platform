import { CrmPipelineQueueService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineQueueService";

export class CrmPipelineQueueController {
  private service = new CrmPipelineQueueService();
