import { CrmPipelineMappingService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineMappingService";

export class CrmPipelineMappingController {
  private service = new CrmPipelineMappingService();
