import { CrmPipelinePayloadService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelinePayloadService";

export class CrmPipelinePayloadController {
  private service = new CrmPipelinePayloadService();
