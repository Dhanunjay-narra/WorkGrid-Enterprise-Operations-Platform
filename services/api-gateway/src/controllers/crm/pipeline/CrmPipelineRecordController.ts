import { CrmPipelineRecordService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineRecordService";

export class CrmPipelineRecordController {
  private service = new CrmPipelineRecordService();
