import { CrmPipelineSnapshotService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineSnapshotService";

export class CrmPipelineSnapshotController {
  private service = new CrmPipelineSnapshotService();
