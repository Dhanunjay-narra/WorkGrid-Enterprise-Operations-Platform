import { CrmPipelineConfigService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineConfigService";

export class CrmPipelineConfigController {
  private service = new CrmPipelineConfigService();
