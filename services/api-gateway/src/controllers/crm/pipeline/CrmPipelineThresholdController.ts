import { CrmPipelineThresholdService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineThresholdService";

export class CrmPipelineThresholdController {
  private service = new CrmPipelineThresholdService();
