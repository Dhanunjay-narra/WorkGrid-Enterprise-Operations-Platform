import { CrmPipelineBatchService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineBatchService";

export class CrmPipelineBatchController {
  private service = new CrmPipelineBatchService();
