import { CrmPipelineTaskService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineTaskService";

export class CrmPipelineTaskController {
  private service = new CrmPipelineTaskService();
