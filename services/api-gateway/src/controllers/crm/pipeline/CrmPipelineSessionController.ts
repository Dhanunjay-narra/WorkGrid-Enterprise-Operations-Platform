import { CrmPipelineSessionService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineSessionService";

export class CrmPipelineSessionController {
  private service = new CrmPipelineSessionService();
