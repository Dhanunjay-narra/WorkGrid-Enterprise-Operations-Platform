import { CrmPipelineReportService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineReportService";

export class CrmPipelineReportController {
  private service = new CrmPipelineReportService();
