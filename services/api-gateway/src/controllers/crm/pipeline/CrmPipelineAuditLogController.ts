import { CrmPipelineAuditLogService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineAuditLogService";

export class CrmPipelineAuditLogController {
  private service = new CrmPipelineAuditLogService();
