import { CrmPipelineProfileService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineProfileService";

export class CrmPipelineProfileController {
  private service = new CrmPipelineProfileService();
