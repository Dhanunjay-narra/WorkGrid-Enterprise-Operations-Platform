import { CrmPipelineItemService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineItemService";

export class CrmPipelineItemController {
  private service = new CrmPipelineItemService();
