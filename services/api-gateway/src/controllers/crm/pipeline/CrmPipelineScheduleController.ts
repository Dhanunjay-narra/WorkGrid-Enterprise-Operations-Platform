import { CrmPipelineScheduleService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineScheduleService";

export class CrmPipelineScheduleController {
  private service = new CrmPipelineScheduleService();
