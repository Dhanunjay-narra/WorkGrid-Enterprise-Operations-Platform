import { CrmPipelineMetricService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineMetricService";

export class CrmPipelineMetricController {
  private service = new CrmPipelineMetricService();
