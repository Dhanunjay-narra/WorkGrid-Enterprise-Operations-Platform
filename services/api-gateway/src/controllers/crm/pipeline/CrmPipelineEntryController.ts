import { CrmPipelineEntryService } from "../../../../core-engine/src/crm/pipeline/services/CrmPipelineEntryService";

export class CrmPipelineEntryController {
  private service = new CrmPipelineEntryService();
