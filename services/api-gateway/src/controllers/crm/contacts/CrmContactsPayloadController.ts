import { CrmContactsPayloadService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsPayloadService";

export class CrmContactsPayloadController {
  private service = new CrmContactsPayloadService();
