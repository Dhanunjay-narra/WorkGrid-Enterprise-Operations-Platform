import { CrmContactsTaskService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsTaskService";

export class CrmContactsTaskController {
  private service = new CrmContactsTaskService();
