import { CrmContactsMappingService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsMappingService";

export class CrmContactsMappingController {
  private service = new CrmContactsMappingService();
