import { CrmContactsRecordService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsRecordService";

export class CrmContactsRecordController {
  private service = new CrmContactsRecordService();
