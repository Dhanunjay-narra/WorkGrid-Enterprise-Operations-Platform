import { CrmContactsMetricService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsMetricService";

export class CrmContactsMetricController {
  private service = new CrmContactsMetricService();
