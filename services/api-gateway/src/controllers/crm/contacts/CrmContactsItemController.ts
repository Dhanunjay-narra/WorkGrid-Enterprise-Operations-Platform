import { CrmContactsItemService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsItemService";

export class CrmContactsItemController {
  private service = new CrmContactsItemService();
