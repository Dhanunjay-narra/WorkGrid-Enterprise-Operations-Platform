import { CrmContactsSessionService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsSessionService";

export class CrmContactsSessionController {
  private service = new CrmContactsSessionService();
