import { CrmContactsProfileService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsProfileService";

export class CrmContactsProfileController {
  private service = new CrmContactsProfileService();
