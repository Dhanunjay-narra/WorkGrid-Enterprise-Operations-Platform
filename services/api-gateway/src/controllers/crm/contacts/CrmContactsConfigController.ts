import { CrmContactsConfigService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsConfigService";

export class CrmContactsConfigController {
  private service = new CrmContactsConfigService();
