import { CrmContactsReportService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsReportService";

export class CrmContactsReportController {
  private service = new CrmContactsReportService();
