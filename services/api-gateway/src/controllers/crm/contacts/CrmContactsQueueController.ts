import { CrmContactsQueueService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsQueueService";

export class CrmContactsQueueController {
  private service = new CrmContactsQueueService();
