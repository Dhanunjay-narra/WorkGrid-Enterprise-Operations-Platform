import { CrmContactsScheduleService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsScheduleService";

export class CrmContactsScheduleController {
  private service = new CrmContactsScheduleService();
