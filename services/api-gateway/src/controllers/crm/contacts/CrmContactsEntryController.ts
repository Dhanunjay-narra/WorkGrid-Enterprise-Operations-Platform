import { CrmContactsEntryService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsEntryService";

export class CrmContactsEntryController {
  private service = new CrmContactsEntryService();
