import { CrmContactsPolicyService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsPolicyService";

export class CrmContactsPolicyController {
  private service = new CrmContactsPolicyService();
