import { CrmContactsRuleService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsRuleService";

export class CrmContactsRuleController {
  private service = new CrmContactsRuleService();
