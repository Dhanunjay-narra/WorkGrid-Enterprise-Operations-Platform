import { CrmContactsEventService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsEventService";

export class CrmContactsEventController {
  private service = new CrmContactsEventService();
