import { CrmContactsStateService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsStateService";

export class CrmContactsStateController {
  private service = new CrmContactsStateService();
