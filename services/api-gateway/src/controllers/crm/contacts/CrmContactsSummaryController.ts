import { CrmContactsSummaryService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsSummaryService";

export class CrmContactsSummaryController {
  private service = new CrmContactsSummaryService();
