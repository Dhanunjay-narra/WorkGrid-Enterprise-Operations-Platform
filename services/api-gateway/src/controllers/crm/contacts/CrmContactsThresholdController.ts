import { CrmContactsThresholdService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsThresholdService";

export class CrmContactsThresholdController {
  private service = new CrmContactsThresholdService();
