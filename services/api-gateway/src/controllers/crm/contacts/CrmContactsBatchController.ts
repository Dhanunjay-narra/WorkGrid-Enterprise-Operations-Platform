import { CrmContactsBatchService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsBatchService";

export class CrmContactsBatchController {
  private service = new CrmContactsBatchService();
