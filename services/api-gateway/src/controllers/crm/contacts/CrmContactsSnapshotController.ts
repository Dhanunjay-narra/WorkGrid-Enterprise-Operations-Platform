import { CrmContactsSnapshotService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsSnapshotService";

export class CrmContactsSnapshotController {
  private service = new CrmContactsSnapshotService();
