import { CrmContactsAuditLogService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsAuditLogService";

export class CrmContactsAuditLogController {
  private service = new CrmContactsAuditLogService();
