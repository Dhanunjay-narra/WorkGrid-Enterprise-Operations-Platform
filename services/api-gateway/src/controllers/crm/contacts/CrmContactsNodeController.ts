import { CrmContactsNodeService } from "../../../../core-engine/src/crm/contacts/services/CrmContactsNodeService";

export class CrmContactsNodeController {
  private service = new CrmContactsNodeService();
