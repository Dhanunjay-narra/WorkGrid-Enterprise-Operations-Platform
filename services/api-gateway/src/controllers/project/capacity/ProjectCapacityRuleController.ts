import { ProjectCapacityRuleService } from "../../../../core-engine/src/project/capacity/services/ProjectCapacityRuleService";

export class ProjectCapacityRuleController {
  private service = new ProjectCapacityRuleService();
