import { ProjectCapacityNodeService } from "../../../../core-engine/src/project/capacity/services/ProjectCapacityNodeService";

export class ProjectCapacityNodeController {
  private service = new ProjectCapacityNodeService();
