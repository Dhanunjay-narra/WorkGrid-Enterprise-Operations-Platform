import { ProjectCapacityItemService } from "../../../../core-engine/src/project/capacity/services/ProjectCapacityItemService";

export class ProjectCapacityItemController {
  private service = new ProjectCapacityItemService();
