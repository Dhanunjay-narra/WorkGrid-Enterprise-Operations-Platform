import { ProjectCapacityTaskService } from "../../../../core-engine/src/project/capacity/services/ProjectCapacityTaskService";

export class ProjectCapacityTaskController {
  private service = new ProjectCapacityTaskService();
