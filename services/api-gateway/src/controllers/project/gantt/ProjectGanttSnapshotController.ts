import { ProjectGanttSnapshotService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttSnapshotService";

export class ProjectGanttSnapshotController {
  private service = new ProjectGanttSnapshotService();
