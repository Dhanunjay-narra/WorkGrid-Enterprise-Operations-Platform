import { ProjectGanttEventService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttEventService";

export class ProjectGanttEventController {
  private service = new ProjectGanttEventService();
