import { ProjectGanttMappingService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttMappingService";

export class ProjectGanttMappingController {
  private service = new ProjectGanttMappingService();
