import { ProjectGanttItemService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttItemService";

export class ProjectGanttItemController {
  private service = new ProjectGanttItemService();
