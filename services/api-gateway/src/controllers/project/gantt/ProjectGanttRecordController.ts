import { ProjectGanttRecordService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttRecordService";

export class ProjectGanttRecordController {
  private service = new ProjectGanttRecordService();
