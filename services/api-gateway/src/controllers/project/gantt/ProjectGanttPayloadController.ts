import { ProjectGanttPayloadService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttPayloadService";

export class ProjectGanttPayloadController {
  private service = new ProjectGanttPayloadService();
