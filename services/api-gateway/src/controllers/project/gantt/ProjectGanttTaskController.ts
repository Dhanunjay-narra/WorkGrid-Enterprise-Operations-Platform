import { ProjectGanttTaskService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttTaskService";

export class ProjectGanttTaskController {
  private service = new ProjectGanttTaskService();
