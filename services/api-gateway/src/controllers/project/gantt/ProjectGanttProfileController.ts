import { ProjectGanttProfileService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttProfileService";

export class ProjectGanttProfileController {
  private service = new ProjectGanttProfileService();
