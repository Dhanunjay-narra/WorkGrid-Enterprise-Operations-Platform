import { ProjectGanttSessionService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttSessionService";

export class ProjectGanttSessionController {
  private service = new ProjectGanttSessionService();
