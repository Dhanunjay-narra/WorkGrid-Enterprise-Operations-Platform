import { ProjectGanttStateService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttStateService";

export class ProjectGanttStateController {
  private service = new ProjectGanttStateService();
