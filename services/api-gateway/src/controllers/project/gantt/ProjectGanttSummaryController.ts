import { ProjectGanttSummaryService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttSummaryService";

export class ProjectGanttSummaryController {
  private service = new ProjectGanttSummaryService();
