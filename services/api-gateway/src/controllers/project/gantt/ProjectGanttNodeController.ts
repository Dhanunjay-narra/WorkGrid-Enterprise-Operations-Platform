import { ProjectGanttNodeService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttNodeService";

export class ProjectGanttNodeController {
  private service = new ProjectGanttNodeService();
