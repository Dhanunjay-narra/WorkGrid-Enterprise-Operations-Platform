import { ProjectGanttConfigService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttConfigService";

export class ProjectGanttConfigController {
  private service = new ProjectGanttConfigService();
