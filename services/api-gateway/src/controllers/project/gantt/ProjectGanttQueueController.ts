import { ProjectGanttQueueService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttQueueService";

export class ProjectGanttQueueController {
  private service = new ProjectGanttQueueService();
