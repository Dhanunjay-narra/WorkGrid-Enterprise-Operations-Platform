import { ProjectGanttScheduleService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttScheduleService";

export class ProjectGanttScheduleController {
  private service = new ProjectGanttScheduleService();
