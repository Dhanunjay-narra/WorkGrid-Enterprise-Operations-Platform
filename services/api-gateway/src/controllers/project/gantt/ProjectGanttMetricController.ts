import { ProjectGanttMetricService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttMetricService";

export class ProjectGanttMetricController {
  private service = new ProjectGanttMetricService();
