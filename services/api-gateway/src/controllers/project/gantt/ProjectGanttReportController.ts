import { ProjectGanttReportService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttReportService";

export class ProjectGanttReportController {
  private service = new ProjectGanttReportService();
