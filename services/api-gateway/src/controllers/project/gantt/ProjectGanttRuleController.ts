import { ProjectGanttRuleService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttRuleService";

export class ProjectGanttRuleController {
  private service = new ProjectGanttRuleService();
