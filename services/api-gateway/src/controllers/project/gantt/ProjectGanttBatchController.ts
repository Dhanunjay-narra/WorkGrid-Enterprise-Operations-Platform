import { ProjectGanttBatchService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttBatchService";

export class ProjectGanttBatchController {
  private service = new ProjectGanttBatchService();
