import { ProjectGanttAuditLogService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttAuditLogService";

export class ProjectGanttAuditLogController {
  private service = new ProjectGanttAuditLogService();
