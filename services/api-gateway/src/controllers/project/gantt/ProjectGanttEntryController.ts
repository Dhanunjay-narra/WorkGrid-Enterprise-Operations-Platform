import { ProjectGanttEntryService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttEntryService";

export class ProjectGanttEntryController {
  private service = new ProjectGanttEntryService();
