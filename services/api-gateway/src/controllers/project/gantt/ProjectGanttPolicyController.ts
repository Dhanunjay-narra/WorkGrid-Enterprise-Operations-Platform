import { ProjectGanttPolicyService } from "../../../../core-engine/src/project/gantt/services/ProjectGanttPolicyService";

export class ProjectGanttPolicyController {
  private service = new ProjectGanttPolicyService();
