import { ProjectEpicsReportService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsReportService";

export class ProjectEpicsReportController {
  private service = new ProjectEpicsReportService();
