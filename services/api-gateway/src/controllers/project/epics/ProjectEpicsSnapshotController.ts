import { ProjectEpicsSnapshotService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsSnapshotService";

export class ProjectEpicsSnapshotController {
  private service = new ProjectEpicsSnapshotService();
