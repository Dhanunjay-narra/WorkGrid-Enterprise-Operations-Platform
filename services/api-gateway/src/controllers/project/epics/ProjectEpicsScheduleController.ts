import { ProjectEpicsScheduleService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsScheduleService";

export class ProjectEpicsScheduleController {
  private service = new ProjectEpicsScheduleService();
