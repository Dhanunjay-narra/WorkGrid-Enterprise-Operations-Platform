import { ProjectEpicsSummaryService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsSummaryService";

export class ProjectEpicsSummaryController {
  private service = new ProjectEpicsSummaryService();
