import { ProjectEpicsPayloadService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsPayloadService";

export class ProjectEpicsPayloadController {
  private service = new ProjectEpicsPayloadService();
