import { ProjectEpicsConfigService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsConfigService";

export class ProjectEpicsConfigController {
  private service = new ProjectEpicsConfigService();
