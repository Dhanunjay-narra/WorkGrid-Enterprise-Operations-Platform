import { ProjectEpicsMappingService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsMappingService";

export class ProjectEpicsMappingController {
  private service = new ProjectEpicsMappingService();
