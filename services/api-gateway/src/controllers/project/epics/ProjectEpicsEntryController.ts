import { ProjectEpicsEntryService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsEntryService";

export class ProjectEpicsEntryController {
  private service = new ProjectEpicsEntryService();
