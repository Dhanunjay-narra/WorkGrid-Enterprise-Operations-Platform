import { ProjectEpicsAuditLogService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsAuditLogService";

export class ProjectEpicsAuditLogController {
  private service = new ProjectEpicsAuditLogService();
