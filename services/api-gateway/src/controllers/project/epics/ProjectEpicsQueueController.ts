import { ProjectEpicsQueueService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsQueueService";

export class ProjectEpicsQueueController {
  private service = new ProjectEpicsQueueService();
