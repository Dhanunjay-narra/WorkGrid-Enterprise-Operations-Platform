import { ProjectEpicsStateService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsStateService";

export class ProjectEpicsStateController {
  private service = new ProjectEpicsStateService();
