import { ProjectEpicsMetricService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsMetricService";

export class ProjectEpicsMetricController {
  private service = new ProjectEpicsMetricService();
