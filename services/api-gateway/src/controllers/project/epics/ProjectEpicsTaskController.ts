import { ProjectEpicsTaskService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsTaskService";

export class ProjectEpicsTaskController {
  private service = new ProjectEpicsTaskService();
