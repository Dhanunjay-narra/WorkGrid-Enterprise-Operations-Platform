import { ProjectEpicsBatchService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsBatchService";

export class ProjectEpicsBatchController {
  private service = new ProjectEpicsBatchService();
