import { ProjectEpicsItemService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsItemService";

export class ProjectEpicsItemController {
  private service = new ProjectEpicsItemService();
