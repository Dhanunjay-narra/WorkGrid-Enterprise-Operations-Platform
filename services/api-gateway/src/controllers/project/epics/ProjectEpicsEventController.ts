import { ProjectEpicsEventService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsEventService";

export class ProjectEpicsEventController {
  private service = new ProjectEpicsEventService();
