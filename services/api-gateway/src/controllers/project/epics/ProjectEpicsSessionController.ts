import { ProjectEpicsSessionService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsSessionService";

export class ProjectEpicsSessionController {
  private service = new ProjectEpicsSessionService();
