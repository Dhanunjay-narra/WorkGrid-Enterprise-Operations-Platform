import { ProjectEpicsRecordService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsRecordService";

export class ProjectEpicsRecordController {
  private service = new ProjectEpicsRecordService();
