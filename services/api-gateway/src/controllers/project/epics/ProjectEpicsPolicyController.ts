import { ProjectEpicsPolicyService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsPolicyService";

export class ProjectEpicsPolicyController {
  private service = new ProjectEpicsPolicyService();
