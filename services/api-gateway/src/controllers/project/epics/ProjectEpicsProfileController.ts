import { ProjectEpicsProfileService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsProfileService";

export class ProjectEpicsProfileController {
  private service = new ProjectEpicsProfileService();
