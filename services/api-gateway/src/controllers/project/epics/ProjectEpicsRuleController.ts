import { ProjectEpicsRuleService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsRuleService";

export class ProjectEpicsRuleController {
  private service = new ProjectEpicsRuleService();
