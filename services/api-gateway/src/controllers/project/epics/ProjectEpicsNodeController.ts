import { ProjectEpicsNodeService } from "../../../../core-engine/src/project/epics/services/ProjectEpicsNodeService";

export class ProjectEpicsNodeController {
  private service = new ProjectEpicsNodeService();
