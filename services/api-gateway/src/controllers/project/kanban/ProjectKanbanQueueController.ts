import { ProjectKanbanQueueService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanQueueService";

export class ProjectKanbanQueueController {
  private service = new ProjectKanbanQueueService();
