import { ProjectKanbanRuleService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanRuleService";

export class ProjectKanbanRuleController {
  private service = new ProjectKanbanRuleService();
