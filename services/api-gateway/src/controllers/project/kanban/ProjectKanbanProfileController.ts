import { ProjectKanbanProfileService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanProfileService";

export class ProjectKanbanProfileController {
  private service = new ProjectKanbanProfileService();
