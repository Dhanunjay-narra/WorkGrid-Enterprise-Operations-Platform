import { ProjectKanbanSessionService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanSessionService";

export class ProjectKanbanSessionController {
  private service = new ProjectKanbanSessionService();
