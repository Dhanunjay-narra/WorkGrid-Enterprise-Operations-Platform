import { ProjectKanbanEventService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanEventService";

export class ProjectKanbanEventController {
  private service = new ProjectKanbanEventService();
