import { ProjectKanbanNodeService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanNodeService";

export class ProjectKanbanNodeController {
  private service = new ProjectKanbanNodeService();
