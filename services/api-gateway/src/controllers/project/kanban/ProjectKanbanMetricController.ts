import { ProjectKanbanMetricService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanMetricService";

export class ProjectKanbanMetricController {
  private service = new ProjectKanbanMetricService();
