import { ProjectKanbanPolicyService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanPolicyService";

export class ProjectKanbanPolicyController {
  private service = new ProjectKanbanPolicyService();
