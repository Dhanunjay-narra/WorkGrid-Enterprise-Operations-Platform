import { ProjectKanbanItemService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanItemService";

export class ProjectKanbanItemController {
  private service = new ProjectKanbanItemService();
