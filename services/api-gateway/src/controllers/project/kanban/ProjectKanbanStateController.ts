import { ProjectKanbanStateService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanStateService";

export class ProjectKanbanStateController {
  private service = new ProjectKanbanStateService();
