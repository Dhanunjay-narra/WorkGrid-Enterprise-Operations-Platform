import { ProjectKanbanTaskService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanTaskService";

export class ProjectKanbanTaskController {
  private service = new ProjectKanbanTaskService();
