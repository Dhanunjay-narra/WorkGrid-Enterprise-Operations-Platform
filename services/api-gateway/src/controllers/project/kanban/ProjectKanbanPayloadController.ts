import { ProjectKanbanPayloadService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanPayloadService";

export class ProjectKanbanPayloadController {
  private service = new ProjectKanbanPayloadService();
