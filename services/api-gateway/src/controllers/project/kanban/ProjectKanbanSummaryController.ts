import { ProjectKanbanSummaryService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanSummaryService";

export class ProjectKanbanSummaryController {
  private service = new ProjectKanbanSummaryService();
