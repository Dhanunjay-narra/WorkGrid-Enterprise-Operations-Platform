import { ProjectKanbanRecordService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanRecordService";

export class ProjectKanbanRecordController {
  private service = new ProjectKanbanRecordService();
