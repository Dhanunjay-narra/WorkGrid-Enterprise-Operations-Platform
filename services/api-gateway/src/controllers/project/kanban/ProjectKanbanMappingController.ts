import { ProjectKanbanMappingService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanMappingService";

export class ProjectKanbanMappingController {
  private service = new ProjectKanbanMappingService();
