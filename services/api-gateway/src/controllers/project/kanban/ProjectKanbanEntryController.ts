import { ProjectKanbanEntryService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanEntryService";

export class ProjectKanbanEntryController {
  private service = new ProjectKanbanEntryService();
