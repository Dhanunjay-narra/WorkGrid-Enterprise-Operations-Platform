import { ProjectKanbanBatchService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanBatchService";

export class ProjectKanbanBatchController {
  private service = new ProjectKanbanBatchService();
