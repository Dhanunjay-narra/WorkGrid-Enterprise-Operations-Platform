import { ProjectKanbanReportService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanReportService";

export class ProjectKanbanReportController {
  private service = new ProjectKanbanReportService();
