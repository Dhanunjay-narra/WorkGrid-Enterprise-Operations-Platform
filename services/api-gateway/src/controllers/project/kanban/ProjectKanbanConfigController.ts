import { ProjectKanbanConfigService } from "../../../../core-engine/src/project/kanban/services/ProjectKanbanConfigService";

export class ProjectKanbanConfigController {
  private service = new ProjectKanbanConfigService();
