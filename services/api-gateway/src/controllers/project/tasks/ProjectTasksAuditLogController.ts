import { ProjectTasksAuditLogService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksAuditLogService";

export class ProjectTasksAuditLogController {
  private service = new ProjectTasksAuditLogService();
