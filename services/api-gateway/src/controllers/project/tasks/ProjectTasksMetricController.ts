import { ProjectTasksMetricService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksMetricService";

export class ProjectTasksMetricController {
  private service = new ProjectTasksMetricService();
