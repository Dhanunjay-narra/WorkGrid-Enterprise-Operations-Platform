import { ProjectTasksEntryService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksEntryService";

export class ProjectTasksEntryController {
  private service = new ProjectTasksEntryService();
