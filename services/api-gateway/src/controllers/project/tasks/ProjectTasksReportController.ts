import { ProjectTasksReportService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksReportService";

export class ProjectTasksReportController {
  private service = new ProjectTasksReportService();
