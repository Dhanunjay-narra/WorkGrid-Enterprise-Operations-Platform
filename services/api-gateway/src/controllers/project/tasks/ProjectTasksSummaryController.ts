import { ProjectTasksSummaryService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksSummaryService";

export class ProjectTasksSummaryController {
  private service = new ProjectTasksSummaryService();
