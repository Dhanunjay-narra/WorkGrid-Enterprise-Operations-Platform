import { ProjectTasksEventService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksEventService";

export class ProjectTasksEventController {
  private service = new ProjectTasksEventService();
