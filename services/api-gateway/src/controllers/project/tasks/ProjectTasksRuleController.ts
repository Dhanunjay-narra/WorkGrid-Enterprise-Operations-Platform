import { ProjectTasksRuleService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksRuleService";

export class ProjectTasksRuleController {
  private service = new ProjectTasksRuleService();
