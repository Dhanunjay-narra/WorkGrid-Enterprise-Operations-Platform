import { ProjectTasksTaskService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksTaskService";

export class ProjectTasksTaskController {
  private service = new ProjectTasksTaskService();
