import { ProjectTasksScheduleService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksScheduleService";

export class ProjectTasksScheduleController {
  private service = new ProjectTasksScheduleService();
