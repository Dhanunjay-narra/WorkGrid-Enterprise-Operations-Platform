import { ProjectTasksRecordService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksRecordService";

export class ProjectTasksRecordController {
  private service = new ProjectTasksRecordService();
