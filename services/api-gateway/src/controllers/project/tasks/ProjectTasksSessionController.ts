import { ProjectTasksSessionService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksSessionService";

export class ProjectTasksSessionController {
  private service = new ProjectTasksSessionService();
