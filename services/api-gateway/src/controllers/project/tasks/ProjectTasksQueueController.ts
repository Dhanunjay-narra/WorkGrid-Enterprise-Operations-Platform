import { ProjectTasksQueueService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksQueueService";

export class ProjectTasksQueueController {
  private service = new ProjectTasksQueueService();
