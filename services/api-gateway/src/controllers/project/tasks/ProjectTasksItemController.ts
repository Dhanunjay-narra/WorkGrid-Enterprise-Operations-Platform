import { ProjectTasksItemService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksItemService";

export class ProjectTasksItemController {
  private service = new ProjectTasksItemService();
