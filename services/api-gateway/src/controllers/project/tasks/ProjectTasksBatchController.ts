import { ProjectTasksBatchService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksBatchService";

export class ProjectTasksBatchController {
  private service = new ProjectTasksBatchService();
