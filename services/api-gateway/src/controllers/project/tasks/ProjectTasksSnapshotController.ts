import { ProjectTasksSnapshotService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksSnapshotService";

export class ProjectTasksSnapshotController {
  private service = new ProjectTasksSnapshotService();
