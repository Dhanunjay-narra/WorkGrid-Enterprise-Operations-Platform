import { ProjectTasksMappingService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksMappingService";

export class ProjectTasksMappingController {
  private service = new ProjectTasksMappingService();
