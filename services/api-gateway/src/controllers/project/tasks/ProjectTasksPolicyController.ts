import { ProjectTasksPolicyService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksPolicyService";

export class ProjectTasksPolicyController {
  private service = new ProjectTasksPolicyService();
