import { ProjectTasksConfigService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksConfigService";

export class ProjectTasksConfigController {
  private service = new ProjectTasksConfigService();
