import { ProjectTasksPayloadService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksPayloadService";

export class ProjectTasksPayloadController {
  private service = new ProjectTasksPayloadService();
