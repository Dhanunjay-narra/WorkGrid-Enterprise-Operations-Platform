import { ProjectTasksNodeService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksNodeService";

export class ProjectTasksNodeController {
  private service = new ProjectTasksNodeService();
