import { ProjectTasksProfileService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksProfileService";

export class ProjectTasksProfileController {
  private service = new ProjectTasksProfileService();
