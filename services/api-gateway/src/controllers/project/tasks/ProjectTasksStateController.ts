import { ProjectTasksStateService } from "../../../../core-engine/src/project/tasks/services/ProjectTasksStateService";

export class ProjectTasksStateController {
  private service = new ProjectTasksStateService();
