import { ProjectRisksScheduleService } from "../../../../core-engine/src/project/risks/services/ProjectRisksScheduleService";

export class ProjectRisksScheduleController {
  private service = new ProjectRisksScheduleService();
