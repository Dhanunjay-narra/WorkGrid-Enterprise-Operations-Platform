import { ProjectRisksPayloadService } from "../../../../core-engine/src/project/risks/services/ProjectRisksPayloadService";

export class ProjectRisksPayloadController {
  private service = new ProjectRisksPayloadService();
