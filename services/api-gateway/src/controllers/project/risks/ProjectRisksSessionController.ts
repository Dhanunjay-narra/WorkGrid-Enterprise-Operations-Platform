import { ProjectRisksSessionService } from "../../../../core-engine/src/project/risks/services/ProjectRisksSessionService";

export class ProjectRisksSessionController {
  private service = new ProjectRisksSessionService();
