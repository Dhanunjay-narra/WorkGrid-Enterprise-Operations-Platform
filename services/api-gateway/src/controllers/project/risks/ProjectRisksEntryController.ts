import { ProjectRisksEntryService } from "../../../../core-engine/src/project/risks/services/ProjectRisksEntryService";

export class ProjectRisksEntryController {
  private service = new ProjectRisksEntryService();
