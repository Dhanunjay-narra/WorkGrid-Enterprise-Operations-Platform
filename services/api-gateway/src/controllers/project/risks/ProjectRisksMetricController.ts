import { ProjectRisksMetricService } from "../../../../core-engine/src/project/risks/services/ProjectRisksMetricService";

export class ProjectRisksMetricController {
  private service = new ProjectRisksMetricService();
