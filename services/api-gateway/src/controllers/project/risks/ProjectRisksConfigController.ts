import { ProjectRisksConfigService } from "../../../../core-engine/src/project/risks/services/ProjectRisksConfigService";

export class ProjectRisksConfigController {
  private service = new ProjectRisksConfigService();
