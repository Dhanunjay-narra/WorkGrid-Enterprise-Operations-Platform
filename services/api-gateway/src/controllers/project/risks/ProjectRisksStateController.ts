import { ProjectRisksStateService } from "../../../../core-engine/src/project/risks/services/ProjectRisksStateService";

export class ProjectRisksStateController {
  private service = new ProjectRisksStateService();
