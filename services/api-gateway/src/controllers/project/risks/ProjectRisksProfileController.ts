import { ProjectRisksProfileService } from "../../../../core-engine/src/project/risks/services/ProjectRisksProfileService";

export class ProjectRisksProfileController {
  private service = new ProjectRisksProfileService();
