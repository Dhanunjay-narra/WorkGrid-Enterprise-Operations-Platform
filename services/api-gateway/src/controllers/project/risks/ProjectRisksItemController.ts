import { ProjectRisksItemService } from "../../../../core-engine/src/project/risks/services/ProjectRisksItemService";

export class ProjectRisksItemController {
  private service = new ProjectRisksItemService();
