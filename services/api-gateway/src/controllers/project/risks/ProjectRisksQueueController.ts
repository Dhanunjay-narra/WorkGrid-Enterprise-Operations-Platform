import { ProjectRisksQueueService } from "../../../../core-engine/src/project/risks/services/ProjectRisksQueueService";

export class ProjectRisksQueueController {
  private service = new ProjectRisksQueueService();
