import { ProjectRisksBatchService } from "../../../../core-engine/src/project/risks/services/ProjectRisksBatchService";

export class ProjectRisksBatchController {
  private service = new ProjectRisksBatchService();
