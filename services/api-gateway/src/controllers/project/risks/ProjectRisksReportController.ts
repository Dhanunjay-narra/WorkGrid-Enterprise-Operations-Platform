import { ProjectRisksReportService } from "../../../../core-engine/src/project/risks/services/ProjectRisksReportService";

export class ProjectRisksReportController {
  private service = new ProjectRisksReportService();
