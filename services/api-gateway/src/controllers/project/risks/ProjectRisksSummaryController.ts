import { ProjectRisksSummaryService } from "../../../../core-engine/src/project/risks/services/ProjectRisksSummaryService";

export class ProjectRisksSummaryController {
  private service = new ProjectRisksSummaryService();
