import { ProjectRisksEventService } from "../../../../core-engine/src/project/risks/services/ProjectRisksEventService";

export class ProjectRisksEventController {
  private service = new ProjectRisksEventService();
