import { ProjectRisksNodeService } from "../../../../core-engine/src/project/risks/services/ProjectRisksNodeService";

export class ProjectRisksNodeController {
  private service = new ProjectRisksNodeService();
