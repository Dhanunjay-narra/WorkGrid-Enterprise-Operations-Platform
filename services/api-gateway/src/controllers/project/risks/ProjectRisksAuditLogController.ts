import { ProjectRisksAuditLogService } from "../../../../core-engine/src/project/risks/services/ProjectRisksAuditLogService";

export class ProjectRisksAuditLogController {
  private service = new ProjectRisksAuditLogService();
