import { ProjectRisksRuleService } from "../../../../core-engine/src/project/risks/services/ProjectRisksRuleService";

export class ProjectRisksRuleController {
  private service = new ProjectRisksRuleService();
