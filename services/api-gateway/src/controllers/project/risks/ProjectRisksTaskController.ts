import { ProjectRisksTaskService } from "../../../../core-engine/src/project/risks/services/ProjectRisksTaskService";

export class ProjectRisksTaskController {
  private service = new ProjectRisksTaskService();
