import { ProjectRisksRecordService } from "../../../../core-engine/src/project/risks/services/ProjectRisksRecordService";

export class ProjectRisksRecordController {
  private service = new ProjectRisksRecordService();
