import { ProjectRisksMappingService } from "../../../../core-engine/src/project/risks/services/ProjectRisksMappingService";

export class ProjectRisksMappingController {
  private service = new ProjectRisksMappingService();
