import { ProjectRisksPolicyService } from "../../../../core-engine/src/project/risks/services/ProjectRisksPolicyService";

export class ProjectRisksPolicyController {
  private service = new ProjectRisksPolicyService();
