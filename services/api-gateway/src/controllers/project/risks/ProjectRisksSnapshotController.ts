import { ProjectRisksSnapshotService } from "../../../../core-engine/src/project/risks/services/ProjectRisksSnapshotService";

export class ProjectRisksSnapshotController {
  private service = new ProjectRisksSnapshotService();
