import { ProjectSprintsRuleService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsRuleService";

export class ProjectSprintsRuleController {
  private service = new ProjectSprintsRuleService();
