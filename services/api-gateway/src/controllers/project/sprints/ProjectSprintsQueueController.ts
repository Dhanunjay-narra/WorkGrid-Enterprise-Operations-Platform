import { ProjectSprintsQueueService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsQueueService";

export class ProjectSprintsQueueController {
  private service = new ProjectSprintsQueueService();
