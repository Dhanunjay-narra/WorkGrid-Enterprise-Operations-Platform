import { ProjectSprintsPolicyService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsPolicyService";

export class ProjectSprintsPolicyController {
  private service = new ProjectSprintsPolicyService();
