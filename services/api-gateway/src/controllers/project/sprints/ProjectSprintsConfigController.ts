import { ProjectSprintsConfigService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsConfigService";

export class ProjectSprintsConfigController {
  private service = new ProjectSprintsConfigService();
