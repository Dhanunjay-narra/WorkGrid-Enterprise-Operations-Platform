import { ProjectSprintsTaskService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsTaskService";

export class ProjectSprintsTaskController {
  private service = new ProjectSprintsTaskService();
