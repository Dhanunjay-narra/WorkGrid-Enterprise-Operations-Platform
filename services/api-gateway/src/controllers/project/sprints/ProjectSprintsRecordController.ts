import { ProjectSprintsRecordService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsRecordService";

export class ProjectSprintsRecordController {
  private service = new ProjectSprintsRecordService();
