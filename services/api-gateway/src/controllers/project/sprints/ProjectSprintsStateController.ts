import { ProjectSprintsStateService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsStateService";

export class ProjectSprintsStateController {
  private service = new ProjectSprintsStateService();
