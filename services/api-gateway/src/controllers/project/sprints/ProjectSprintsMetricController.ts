import { ProjectSprintsMetricService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsMetricService";

export class ProjectSprintsMetricController {
  private service = new ProjectSprintsMetricService();
