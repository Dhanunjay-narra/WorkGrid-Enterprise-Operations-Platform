import { ProjectSprintsEntryService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsEntryService";

export class ProjectSprintsEntryController {
  private service = new ProjectSprintsEntryService();
