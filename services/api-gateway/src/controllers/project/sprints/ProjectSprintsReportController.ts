import { ProjectSprintsReportService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsReportService";

export class ProjectSprintsReportController {
  private service = new ProjectSprintsReportService();
