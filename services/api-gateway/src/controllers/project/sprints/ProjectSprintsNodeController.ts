import { ProjectSprintsNodeService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsNodeService";

export class ProjectSprintsNodeController {
  private service = new ProjectSprintsNodeService();
