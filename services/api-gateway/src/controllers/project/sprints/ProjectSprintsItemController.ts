import { ProjectSprintsItemService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsItemService";

export class ProjectSprintsItemController {
  private service = new ProjectSprintsItemService();
