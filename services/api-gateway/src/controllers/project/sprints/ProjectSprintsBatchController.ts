import { ProjectSprintsBatchService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsBatchService";

export class ProjectSprintsBatchController {
  private service = new ProjectSprintsBatchService();
