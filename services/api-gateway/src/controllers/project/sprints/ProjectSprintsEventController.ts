import { ProjectSprintsEventService } from "../../../../core-engine/src/project/sprints/services/ProjectSprintsEventService";

export class ProjectSprintsEventController {
  private service = new ProjectSprintsEventService();
