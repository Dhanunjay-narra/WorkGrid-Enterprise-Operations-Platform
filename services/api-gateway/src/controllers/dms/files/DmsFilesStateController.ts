import { DmsFilesStateService } from "../../../../core-engine/src/dms/files/services/DmsFilesStateService";

export class DmsFilesStateController {
  private service = new DmsFilesStateService();
