import { DmsFilesThresholdService } from "../../../../core-engine/src/dms/files/services/DmsFilesThresholdService";

export class DmsFilesThresholdController {
  private service = new DmsFilesThresholdService();
