import { DmsFilesSnapshotService } from "../../../../core-engine/src/dms/files/services/DmsFilesSnapshotService";

export class DmsFilesSnapshotController {
  private service = new DmsFilesSnapshotService();
