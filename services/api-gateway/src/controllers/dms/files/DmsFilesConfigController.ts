import { DmsFilesConfigService } from "../../../../core-engine/src/dms/files/services/DmsFilesConfigService";

export class DmsFilesConfigController {
  private service = new DmsFilesConfigService();
