import { DmsFilesPolicyService } from "../../../../core-engine/src/dms/files/services/DmsFilesPolicyService";

export class DmsFilesPolicyController {
  private service = new DmsFilesPolicyService();
