import { DmsFilesEventService } from "../../../../core-engine/src/dms/files/services/DmsFilesEventService";

export class DmsFilesEventController {
  private service = new DmsFilesEventService();
