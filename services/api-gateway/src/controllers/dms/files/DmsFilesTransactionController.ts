import { DmsFilesTransactionService } from "../../../../core-engine/src/dms/files/services/DmsFilesTransactionService";

export class DmsFilesTransactionController {
  private service = new DmsFilesTransactionService();
