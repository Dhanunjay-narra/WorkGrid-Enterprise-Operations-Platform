import { DmsFilesBatchService } from "../../../../core-engine/src/dms/files/services/DmsFilesBatchService";

export class DmsFilesBatchController {
  private service = new DmsFilesBatchService();
