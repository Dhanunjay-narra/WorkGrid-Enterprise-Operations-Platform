import { DmsFilesQueueService } from "../../../../core-engine/src/dms/files/services/DmsFilesQueueService";

export class DmsFilesQueueController {
  private service = new DmsFilesQueueService();
