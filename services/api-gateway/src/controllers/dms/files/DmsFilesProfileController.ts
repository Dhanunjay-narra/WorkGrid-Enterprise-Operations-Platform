import { DmsFilesProfileService } from "../../../../core-engine/src/dms/files/services/DmsFilesProfileService";

export class DmsFilesProfileController {
  private service = new DmsFilesProfileService();
