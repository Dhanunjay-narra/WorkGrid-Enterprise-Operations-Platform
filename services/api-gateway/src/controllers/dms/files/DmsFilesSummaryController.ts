import { DmsFilesSummaryService } from "../../../../core-engine/src/dms/files/services/DmsFilesSummaryService";

export class DmsFilesSummaryController {
  private service = new DmsFilesSummaryService();
