import { DmsFilesAuditLogService } from "../../../../core-engine/src/dms/files/services/DmsFilesAuditLogService";

export class DmsFilesAuditLogController {
  private service = new DmsFilesAuditLogService();
