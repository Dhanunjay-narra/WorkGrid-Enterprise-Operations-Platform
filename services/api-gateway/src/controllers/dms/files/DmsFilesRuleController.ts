import { DmsFilesRuleService } from "../../../../core-engine/src/dms/files/services/DmsFilesRuleService";

export class DmsFilesRuleController {
  private service = new DmsFilesRuleService();
