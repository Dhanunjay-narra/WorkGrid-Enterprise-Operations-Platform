import { DmsFilesItemService } from "../../../../core-engine/src/dms/files/services/DmsFilesItemService";

export class DmsFilesItemController {
  private service = new DmsFilesItemService();
