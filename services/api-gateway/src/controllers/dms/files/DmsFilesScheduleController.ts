import { DmsFilesScheduleService } from "../../../../core-engine/src/dms/files/services/DmsFilesScheduleService";

export class DmsFilesScheduleController {
  private service = new DmsFilesScheduleService();
