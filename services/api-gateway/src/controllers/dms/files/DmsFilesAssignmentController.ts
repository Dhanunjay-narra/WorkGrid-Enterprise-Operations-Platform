import { DmsFilesAssignmentService } from "../../../../core-engine/src/dms/files/services/DmsFilesAssignmentService";

export class DmsFilesAssignmentController {
  private service = new DmsFilesAssignmentService();
