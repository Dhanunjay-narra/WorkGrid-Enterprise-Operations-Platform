import { DmsFilesMetricService } from "../../../../core-engine/src/dms/files/services/DmsFilesMetricService";

export class DmsFilesMetricController {
  private service = new DmsFilesMetricService();
