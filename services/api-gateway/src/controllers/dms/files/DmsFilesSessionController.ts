import { DmsFilesSessionService } from "../../../../core-engine/src/dms/files/services/DmsFilesSessionService";

export class DmsFilesSessionController {
  private service = new DmsFilesSessionService();
