import { DmsFilesRecordService } from "../../../../core-engine/src/dms/files/services/DmsFilesRecordService";

export class DmsFilesRecordController {
  private service = new DmsFilesRecordService();
