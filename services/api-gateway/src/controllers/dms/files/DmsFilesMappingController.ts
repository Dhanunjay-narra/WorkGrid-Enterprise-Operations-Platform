import { DmsFilesMappingService } from "../../../../core-engine/src/dms/files/services/DmsFilesMappingService";

export class DmsFilesMappingController {
  private service = new DmsFilesMappingService();
