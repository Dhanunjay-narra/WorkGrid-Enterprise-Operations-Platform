import { DmsFilesEntryService } from "../../../../core-engine/src/dms/files/services/DmsFilesEntryService";

export class DmsFilesEntryController {
  private service = new DmsFilesEntryService();
