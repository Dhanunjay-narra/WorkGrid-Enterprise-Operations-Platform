import { DmsFilesTaskService } from "../../../../core-engine/src/dms/files/services/DmsFilesTaskService";

export class DmsFilesTaskController {
  private service = new DmsFilesTaskService();
