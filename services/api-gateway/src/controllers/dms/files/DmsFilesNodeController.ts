import { DmsFilesNodeService } from "../../../../core-engine/src/dms/files/services/DmsFilesNodeService";

export class DmsFilesNodeController {
  private service = new DmsFilesNodeService();
