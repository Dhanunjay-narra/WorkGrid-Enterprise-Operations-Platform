import { DmsFilesPayloadService } from "../../../../core-engine/src/dms/files/services/DmsFilesPayloadService";

export class DmsFilesPayloadController {
  private service = new DmsFilesPayloadService();
