import { DmsFilesReportService } from "../../../../core-engine/src/dms/files/services/DmsFilesReportService";

export class DmsFilesReportController {
  private service = new DmsFilesReportService();
