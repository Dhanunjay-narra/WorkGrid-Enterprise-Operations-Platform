import { DmsChunksTaskService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksTaskService";

export class DmsChunksTaskController {
  private service = new DmsChunksTaskService();
