import { DmsChunksRuleService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksRuleService";

export class DmsChunksRuleController {
  private service = new DmsChunksRuleService();
