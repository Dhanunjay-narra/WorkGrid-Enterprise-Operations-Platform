import { DmsChunksAssignmentService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksAssignmentService";

export class DmsChunksAssignmentController {
  private service = new DmsChunksAssignmentService();
