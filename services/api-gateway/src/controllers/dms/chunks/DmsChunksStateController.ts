import { DmsChunksStateService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksStateService";

export class DmsChunksStateController {
  private service = new DmsChunksStateService();
