import { DmsChunksEventService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksEventService";

export class DmsChunksEventController {
  private service = new DmsChunksEventService();
