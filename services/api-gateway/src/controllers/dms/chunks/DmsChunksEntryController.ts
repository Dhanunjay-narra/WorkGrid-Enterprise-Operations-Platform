import { DmsChunksEntryService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksEntryService";

export class DmsChunksEntryController {
  private service = new DmsChunksEntryService();
