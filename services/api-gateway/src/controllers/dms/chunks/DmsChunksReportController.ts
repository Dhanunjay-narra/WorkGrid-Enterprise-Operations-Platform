import { DmsChunksReportService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksReportService";

export class DmsChunksReportController {
  private service = new DmsChunksReportService();
