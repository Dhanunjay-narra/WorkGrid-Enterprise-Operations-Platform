import { DmsChunksMappingService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksMappingService";

export class DmsChunksMappingController {
  private service = new DmsChunksMappingService();
