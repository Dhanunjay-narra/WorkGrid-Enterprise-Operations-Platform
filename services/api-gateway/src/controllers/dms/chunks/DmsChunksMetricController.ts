import { DmsChunksMetricService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksMetricService";

export class DmsChunksMetricController {
  private service = new DmsChunksMetricService();
