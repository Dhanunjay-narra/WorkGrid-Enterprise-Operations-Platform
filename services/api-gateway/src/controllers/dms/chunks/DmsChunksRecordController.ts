import { DmsChunksRecordService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksRecordService";

export class DmsChunksRecordController {
  private service = new DmsChunksRecordService();
