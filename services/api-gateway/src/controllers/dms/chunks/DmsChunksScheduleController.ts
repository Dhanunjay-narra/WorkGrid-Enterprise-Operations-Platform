import { DmsChunksScheduleService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksScheduleService";

export class DmsChunksScheduleController {
  private service = new DmsChunksScheduleService();
