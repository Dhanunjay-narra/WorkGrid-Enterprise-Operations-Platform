import { DmsChunksConfigService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksConfigService";

export class DmsChunksConfigController {
  private service = new DmsChunksConfigService();
