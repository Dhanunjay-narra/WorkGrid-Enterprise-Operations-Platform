import { DmsChunksBatchService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksBatchService";

export class DmsChunksBatchController {
  private service = new DmsChunksBatchService();
