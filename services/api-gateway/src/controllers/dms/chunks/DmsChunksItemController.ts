import { DmsChunksItemService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksItemService";

export class DmsChunksItemController {
  private service = new DmsChunksItemService();
