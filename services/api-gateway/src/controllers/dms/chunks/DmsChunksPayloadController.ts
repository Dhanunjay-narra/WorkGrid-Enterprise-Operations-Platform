import { DmsChunksPayloadService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksPayloadService";

export class DmsChunksPayloadController {
  private service = new DmsChunksPayloadService();
