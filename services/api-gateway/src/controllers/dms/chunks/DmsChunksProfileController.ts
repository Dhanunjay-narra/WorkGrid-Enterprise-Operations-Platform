import { DmsChunksProfileService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksProfileService";

export class DmsChunksProfileController {
  private service = new DmsChunksProfileService();
