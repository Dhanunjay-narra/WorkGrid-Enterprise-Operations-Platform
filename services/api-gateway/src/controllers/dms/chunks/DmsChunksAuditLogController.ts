import { DmsChunksAuditLogService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksAuditLogService";

export class DmsChunksAuditLogController {
  private service = new DmsChunksAuditLogService();
