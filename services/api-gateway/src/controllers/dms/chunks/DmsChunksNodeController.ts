import { DmsChunksNodeService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksNodeService";

export class DmsChunksNodeController {
  private service = new DmsChunksNodeService();
