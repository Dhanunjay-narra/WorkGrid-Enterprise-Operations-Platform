import { DmsChunksSummaryService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksSummaryService";

export class DmsChunksSummaryController {
  private service = new DmsChunksSummaryService();
