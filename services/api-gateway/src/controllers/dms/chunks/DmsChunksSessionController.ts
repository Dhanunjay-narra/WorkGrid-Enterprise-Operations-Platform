import { DmsChunksSessionService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksSessionService";

export class DmsChunksSessionController {
  private service = new DmsChunksSessionService();
