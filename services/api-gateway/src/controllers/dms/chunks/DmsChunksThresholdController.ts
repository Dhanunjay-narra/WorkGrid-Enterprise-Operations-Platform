import { DmsChunksThresholdService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksThresholdService";

export class DmsChunksThresholdController {
  private service = new DmsChunksThresholdService();
