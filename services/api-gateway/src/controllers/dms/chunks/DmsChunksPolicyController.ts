import { DmsChunksPolicyService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksPolicyService";

export class DmsChunksPolicyController {
  private service = new DmsChunksPolicyService();
