import { DmsChunksTransactionService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksTransactionService";

export class DmsChunksTransactionController {
  private service = new DmsChunksTransactionService();
