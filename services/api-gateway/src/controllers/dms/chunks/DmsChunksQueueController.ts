import { DmsChunksQueueService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksQueueService";

export class DmsChunksQueueController {
  private service = new DmsChunksQueueService();
