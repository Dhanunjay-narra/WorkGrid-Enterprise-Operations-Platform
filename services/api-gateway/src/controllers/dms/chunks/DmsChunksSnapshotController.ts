import { DmsChunksSnapshotService } from "../../../../core-engine/src/dms/chunks/services/DmsChunksSnapshotService";

export class DmsChunksSnapshotController {
  private service = new DmsChunksSnapshotService();
