import { DmsFoldersItemService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersItemService";

export class DmsFoldersItemController {
  private service = new DmsFoldersItemService();
