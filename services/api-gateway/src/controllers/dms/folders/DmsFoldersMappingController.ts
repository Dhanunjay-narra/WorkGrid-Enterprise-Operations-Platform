import { DmsFoldersMappingService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersMappingService";

export class DmsFoldersMappingController {
  private service = new DmsFoldersMappingService();
