import { DmsFoldersRuleService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersRuleService";

export class DmsFoldersRuleController {
  private service = new DmsFoldersRuleService();
