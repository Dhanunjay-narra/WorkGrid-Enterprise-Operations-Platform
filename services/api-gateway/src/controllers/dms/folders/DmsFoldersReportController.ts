import { DmsFoldersReportService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersReportService";

export class DmsFoldersReportController {
  private service = new DmsFoldersReportService();
