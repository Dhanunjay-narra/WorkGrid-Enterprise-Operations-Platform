import { DmsFoldersMetricService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersMetricService";

export class DmsFoldersMetricController {
  private service = new DmsFoldersMetricService();
