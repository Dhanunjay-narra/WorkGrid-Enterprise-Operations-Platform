import { DmsFoldersEntryService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersEntryService";

export class DmsFoldersEntryController {
  private service = new DmsFoldersEntryService();
