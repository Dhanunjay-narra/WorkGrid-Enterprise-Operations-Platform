import { DmsFoldersSessionService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersSessionService";

export class DmsFoldersSessionController {
  private service = new DmsFoldersSessionService();
