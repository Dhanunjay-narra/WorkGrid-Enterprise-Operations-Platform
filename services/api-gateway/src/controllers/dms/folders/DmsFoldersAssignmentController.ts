import { DmsFoldersAssignmentService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersAssignmentService";

export class DmsFoldersAssignmentController {
  private service = new DmsFoldersAssignmentService();
