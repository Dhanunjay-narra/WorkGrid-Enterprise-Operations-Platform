import { DmsFoldersRecordService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersRecordService";

export class DmsFoldersRecordController {
  private service = new DmsFoldersRecordService();
