import { DmsFoldersThresholdService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersThresholdService";

export class DmsFoldersThresholdController {
  private service = new DmsFoldersThresholdService();
