import { DmsFoldersPolicyService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersPolicyService";

export class DmsFoldersPolicyController {
  private service = new DmsFoldersPolicyService();
