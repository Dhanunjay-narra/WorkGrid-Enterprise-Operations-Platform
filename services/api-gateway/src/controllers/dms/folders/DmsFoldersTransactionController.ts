import { DmsFoldersTransactionService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersTransactionService";

export class DmsFoldersTransactionController {
  private service = new DmsFoldersTransactionService();
