import { DmsFoldersQueueService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersQueueService";

export class DmsFoldersQueueController {
  private service = new DmsFoldersQueueService();
