import { DmsFoldersPayloadService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersPayloadService";

export class DmsFoldersPayloadController {
  private service = new DmsFoldersPayloadService();
