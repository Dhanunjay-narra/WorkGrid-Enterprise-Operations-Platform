import { DmsFoldersBatchService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersBatchService";

export class DmsFoldersBatchController {
  private service = new DmsFoldersBatchService();
