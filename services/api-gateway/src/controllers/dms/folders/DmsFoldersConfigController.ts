import { DmsFoldersConfigService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersConfigService";

export class DmsFoldersConfigController {
  private service = new DmsFoldersConfigService();
