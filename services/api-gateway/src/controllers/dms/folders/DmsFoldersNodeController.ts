import { DmsFoldersNodeService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersNodeService";

export class DmsFoldersNodeController {
  private service = new DmsFoldersNodeService();
