import { DmsFoldersEventService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersEventService";

export class DmsFoldersEventController {
  private service = new DmsFoldersEventService();
