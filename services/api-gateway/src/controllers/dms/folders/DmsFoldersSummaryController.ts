import { DmsFoldersSummaryService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersSummaryService";

export class DmsFoldersSummaryController {
  private service = new DmsFoldersSummaryService();
