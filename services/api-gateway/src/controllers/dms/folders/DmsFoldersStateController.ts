import { DmsFoldersStateService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersStateService";

export class DmsFoldersStateController {
  private service = new DmsFoldersStateService();
