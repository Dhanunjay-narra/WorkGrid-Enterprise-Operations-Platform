import { DmsFoldersTaskService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersTaskService";

export class DmsFoldersTaskController {
  private service = new DmsFoldersTaskService();
