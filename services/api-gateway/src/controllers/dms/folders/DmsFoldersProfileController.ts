import { DmsFoldersProfileService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersProfileService";

export class DmsFoldersProfileController {
  private service = new DmsFoldersProfileService();
