import { DmsFoldersScheduleService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersScheduleService";

export class DmsFoldersScheduleController {
  private service = new DmsFoldersScheduleService();
