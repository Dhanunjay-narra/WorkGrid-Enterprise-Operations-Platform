import { DmsFoldersSnapshotService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersSnapshotService";

export class DmsFoldersSnapshotController {
  private service = new DmsFoldersSnapshotService();
