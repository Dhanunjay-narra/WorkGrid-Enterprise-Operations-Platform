import { DmsFoldersAuditLogService } from "../../../../core-engine/src/dms/folders/services/DmsFoldersAuditLogService";

export class DmsFoldersAuditLogController {
  private service = new DmsFoldersAuditLogService();
