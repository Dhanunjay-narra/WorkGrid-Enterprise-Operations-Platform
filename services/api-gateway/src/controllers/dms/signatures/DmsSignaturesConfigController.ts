import { DmsSignaturesConfigService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesConfigService";

export class DmsSignaturesConfigController {
  private service = new DmsSignaturesConfigService();
