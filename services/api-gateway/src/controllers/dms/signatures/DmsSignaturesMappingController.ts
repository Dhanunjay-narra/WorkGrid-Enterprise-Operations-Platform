import { DmsSignaturesMappingService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesMappingService";

export class DmsSignaturesMappingController {
  private service = new DmsSignaturesMappingService();
