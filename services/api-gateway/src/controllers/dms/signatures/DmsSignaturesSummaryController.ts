import { DmsSignaturesSummaryService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesSummaryService";

export class DmsSignaturesSummaryController {
  private service = new DmsSignaturesSummaryService();
