import { DmsSignaturesEntryService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesEntryService";

export class DmsSignaturesEntryController {
  private service = new DmsSignaturesEntryService();
