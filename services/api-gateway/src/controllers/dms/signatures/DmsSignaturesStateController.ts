import { DmsSignaturesStateService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesStateService";

export class DmsSignaturesStateController {
  private service = new DmsSignaturesStateService();
