import { DmsSignaturesPolicyService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesPolicyService";

export class DmsSignaturesPolicyController {
  private service = new DmsSignaturesPolicyService();
