import { DmsSignaturesPayloadService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesPayloadService";

export class DmsSignaturesPayloadController {
  private service = new DmsSignaturesPayloadService();
