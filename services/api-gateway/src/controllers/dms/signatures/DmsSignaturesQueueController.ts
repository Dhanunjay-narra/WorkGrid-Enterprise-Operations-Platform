import { DmsSignaturesQueueService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesQueueService";

export class DmsSignaturesQueueController {
  private service = new DmsSignaturesQueueService();
