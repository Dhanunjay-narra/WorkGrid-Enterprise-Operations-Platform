import { DmsSignaturesSessionService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesSessionService";

export class DmsSignaturesSessionController {
  private service = new DmsSignaturesSessionService();
