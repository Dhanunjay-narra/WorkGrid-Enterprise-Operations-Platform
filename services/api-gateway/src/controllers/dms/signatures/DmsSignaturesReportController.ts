import { DmsSignaturesReportService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesReportService";

export class DmsSignaturesReportController {
  private service = new DmsSignaturesReportService();
