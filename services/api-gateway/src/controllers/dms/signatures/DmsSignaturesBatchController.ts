import { DmsSignaturesBatchService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesBatchService";

export class DmsSignaturesBatchController {
  private service = new DmsSignaturesBatchService();
