import { DmsSignaturesMetricService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesMetricService";

export class DmsSignaturesMetricController {
  private service = new DmsSignaturesMetricService();
