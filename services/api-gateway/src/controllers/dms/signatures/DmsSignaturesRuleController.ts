import { DmsSignaturesRuleService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesRuleService";

export class DmsSignaturesRuleController {
  private service = new DmsSignaturesRuleService();
