import { DmsSignaturesRecordService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesRecordService";

export class DmsSignaturesRecordController {
  private service = new DmsSignaturesRecordService();
