import { DmsSignaturesEventService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesEventService";

export class DmsSignaturesEventController {
  private service = new DmsSignaturesEventService();
