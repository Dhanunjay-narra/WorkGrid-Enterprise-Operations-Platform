import { DmsSignaturesItemService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesItemService";

export class DmsSignaturesItemController {
  private service = new DmsSignaturesItemService();
