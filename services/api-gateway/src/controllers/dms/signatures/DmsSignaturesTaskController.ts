import { DmsSignaturesTaskService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesTaskService";

export class DmsSignaturesTaskController {
  private service = new DmsSignaturesTaskService();
