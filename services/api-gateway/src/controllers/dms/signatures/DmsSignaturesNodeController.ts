import { DmsSignaturesNodeService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesNodeService";

export class DmsSignaturesNodeController {
  private service = new DmsSignaturesNodeService();
