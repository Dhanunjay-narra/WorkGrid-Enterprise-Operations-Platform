import { DmsSignaturesProfileService } from "../../../../core-engine/src/dms/signatures/services/DmsSignaturesProfileService";

export class DmsSignaturesProfileController {
  private service = new DmsSignaturesProfileService();
