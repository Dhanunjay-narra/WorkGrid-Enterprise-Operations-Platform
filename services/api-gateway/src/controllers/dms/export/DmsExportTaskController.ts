import { DmsExportTaskService } from "../../../../core-engine/src/dms/export/services/DmsExportTaskService";

export class DmsExportTaskController {
  private service = new DmsExportTaskService();
