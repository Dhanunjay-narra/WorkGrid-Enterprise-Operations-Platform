import { DmsExportAuditLogService } from "../../../../core-engine/src/dms/export/services/DmsExportAuditLogService";

export class DmsExportAuditLogController {
  private service = new DmsExportAuditLogService();
