import { DmsExportSessionService } from "../../../../core-engine/src/dms/export/services/DmsExportSessionService";

export class DmsExportSessionController {
  private service = new DmsExportSessionService();
