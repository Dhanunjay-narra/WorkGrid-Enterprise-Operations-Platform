import { DmsExportNodeService } from "../../../../core-engine/src/dms/export/services/DmsExportNodeService";

export class DmsExportNodeController {
  private service = new DmsExportNodeService();
