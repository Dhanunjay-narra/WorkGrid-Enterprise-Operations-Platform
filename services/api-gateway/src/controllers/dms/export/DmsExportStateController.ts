import { DmsExportStateService } from "../../../../core-engine/src/dms/export/services/DmsExportStateService";

export class DmsExportStateController {
  private service = new DmsExportStateService();
