import { DmsExportRuleService } from "../../../../core-engine/src/dms/export/services/DmsExportRuleService";

export class DmsExportRuleController {
  private service = new DmsExportRuleService();
