import { DmsExportItemService } from "../../../../core-engine/src/dms/export/services/DmsExportItemService";

export class DmsExportItemController {
  private service = new DmsExportItemService();
