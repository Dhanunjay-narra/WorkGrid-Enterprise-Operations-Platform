import { DmsExportConfigService } from "../../../../core-engine/src/dms/export/services/DmsExportConfigService";

export class DmsExportConfigController {
  private service = new DmsExportConfigService();
