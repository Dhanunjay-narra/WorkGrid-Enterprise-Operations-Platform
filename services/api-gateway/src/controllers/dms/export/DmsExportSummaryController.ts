import { DmsExportSummaryService } from "../../../../core-engine/src/dms/export/services/DmsExportSummaryService";

export class DmsExportSummaryController {
  private service = new DmsExportSummaryService();
