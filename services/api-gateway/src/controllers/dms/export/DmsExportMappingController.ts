import { DmsExportMappingService } from "../../../../core-engine/src/dms/export/services/DmsExportMappingService";

export class DmsExportMappingController {
  private service = new DmsExportMappingService();
