import { DmsExportProfileService } from "../../../../core-engine/src/dms/export/services/DmsExportProfileService";

export class DmsExportProfileController {
  private service = new DmsExportProfileService();
