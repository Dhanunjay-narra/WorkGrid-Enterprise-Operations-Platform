import { DmsExportScheduleService } from "../../../../core-engine/src/dms/export/services/DmsExportScheduleService";

export class DmsExportScheduleController {
  private service = new DmsExportScheduleService();
