import { DmsExportQueueService } from "../../../../core-engine/src/dms/export/services/DmsExportQueueService";

export class DmsExportQueueController {
  private service = new DmsExportQueueService();
