import { DmsExportAssignmentService } from "../../../../core-engine/src/dms/export/services/DmsExportAssignmentService";

export class DmsExportAssignmentController {
  private service = new DmsExportAssignmentService();
