import { DmsExportEntryService } from "../../../../core-engine/src/dms/export/services/DmsExportEntryService";

export class DmsExportEntryController {
  private service = new DmsExportEntryService();
