import { DmsExportTransactionService } from "../../../../core-engine/src/dms/export/services/DmsExportTransactionService";

export class DmsExportTransactionController {
  private service = new DmsExportTransactionService();
