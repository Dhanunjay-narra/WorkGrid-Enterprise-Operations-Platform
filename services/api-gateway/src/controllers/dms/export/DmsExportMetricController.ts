import { DmsExportMetricService } from "../../../../core-engine/src/dms/export/services/DmsExportMetricService";

export class DmsExportMetricController {
  private service = new DmsExportMetricService();
