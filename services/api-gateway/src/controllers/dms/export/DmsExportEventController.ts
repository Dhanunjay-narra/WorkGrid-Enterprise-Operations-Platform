import { DmsExportEventService } from "../../../../core-engine/src/dms/export/services/DmsExportEventService";

export class DmsExportEventController {
  private service = new DmsExportEventService();
