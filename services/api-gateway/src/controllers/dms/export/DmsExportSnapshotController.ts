import { DmsExportSnapshotService } from "../../../../core-engine/src/dms/export/services/DmsExportSnapshotService";

export class DmsExportSnapshotController {
  private service = new DmsExportSnapshotService();
