import { DmsExportThresholdService } from "../../../../core-engine/src/dms/export/services/DmsExportThresholdService";

export class DmsExportThresholdController {
  private service = new DmsExportThresholdService();
