import { DmsExportReportService } from "../../../../core-engine/src/dms/export/services/DmsExportReportService";

export class DmsExportReportController {
  private service = new DmsExportReportService();
