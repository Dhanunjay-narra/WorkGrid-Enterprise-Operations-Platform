import { DmsExportRecordService } from "../../../../core-engine/src/dms/export/services/DmsExportRecordService";

export class DmsExportRecordController {
  private service = new DmsExportRecordService();
