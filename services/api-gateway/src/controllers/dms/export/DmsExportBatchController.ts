import { DmsExportBatchService } from "../../../../core-engine/src/dms/export/services/DmsExportBatchService";

export class DmsExportBatchController {
  private service = new DmsExportBatchService();
