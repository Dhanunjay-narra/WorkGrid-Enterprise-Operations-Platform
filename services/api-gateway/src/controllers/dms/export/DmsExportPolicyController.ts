import { DmsExportPolicyService } from "../../../../core-engine/src/dms/export/services/DmsExportPolicyService";

export class DmsExportPolicyController {
  private service = new DmsExportPolicyService();
