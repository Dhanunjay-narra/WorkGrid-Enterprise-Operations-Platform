import { DmsExportPayloadService } from "../../../../core-engine/src/dms/export/services/DmsExportPayloadService";

export class DmsExportPayloadController {
  private service = new DmsExportPayloadService();
