import { DmsOcrConfigService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrConfigService";

export class DmsOcrConfigController {
  private service = new DmsOcrConfigService();
