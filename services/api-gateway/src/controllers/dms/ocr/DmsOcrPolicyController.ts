import { DmsOcrPolicyService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrPolicyService";

export class DmsOcrPolicyController {
  private service = new DmsOcrPolicyService();
