import { DmsOcrScheduleService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrScheduleService";

export class DmsOcrScheduleController {
  private service = new DmsOcrScheduleService();
