import { DmsOcrProfileService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrProfileService";

export class DmsOcrProfileController {
  private service = new DmsOcrProfileService();
