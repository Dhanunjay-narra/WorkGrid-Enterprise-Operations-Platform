import { DmsOcrTaskService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrTaskService";

export class DmsOcrTaskController {
  private service = new DmsOcrTaskService();
