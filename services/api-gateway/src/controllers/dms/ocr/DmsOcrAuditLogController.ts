import { DmsOcrAuditLogService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrAuditLogService";

export class DmsOcrAuditLogController {
  private service = new DmsOcrAuditLogService();
