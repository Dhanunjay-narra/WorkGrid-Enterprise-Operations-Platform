import { DmsOcrMappingService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrMappingService";

export class DmsOcrMappingController {
  private service = new DmsOcrMappingService();
