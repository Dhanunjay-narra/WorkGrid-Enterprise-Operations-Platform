import { DmsOcrEventService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrEventService";

export class DmsOcrEventController {
  private service = new DmsOcrEventService();
