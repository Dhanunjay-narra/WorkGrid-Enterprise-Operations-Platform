import { DmsOcrReportService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrReportService";

export class DmsOcrReportController {
  private service = new DmsOcrReportService();
