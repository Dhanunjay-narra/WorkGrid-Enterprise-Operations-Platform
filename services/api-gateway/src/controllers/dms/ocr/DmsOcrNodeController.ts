import { DmsOcrNodeService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrNodeService";

export class DmsOcrNodeController {
  private service = new DmsOcrNodeService();
