import { DmsOcrRuleService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrRuleService";

export class DmsOcrRuleController {
  private service = new DmsOcrRuleService();
