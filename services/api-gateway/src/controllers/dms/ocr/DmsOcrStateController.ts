import { DmsOcrStateService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrStateService";

export class DmsOcrStateController {
  private service = new DmsOcrStateService();
