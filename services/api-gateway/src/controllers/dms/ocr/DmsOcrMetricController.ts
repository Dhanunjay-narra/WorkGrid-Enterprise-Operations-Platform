import { DmsOcrMetricService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrMetricService";

export class DmsOcrMetricController {
  private service = new DmsOcrMetricService();
