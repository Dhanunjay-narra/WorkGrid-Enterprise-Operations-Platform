import { DmsOcrTransactionService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrTransactionService";

export class DmsOcrTransactionController {
  private service = new DmsOcrTransactionService();
