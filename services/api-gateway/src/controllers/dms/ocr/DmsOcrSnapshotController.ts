import { DmsOcrSnapshotService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrSnapshotService";

export class DmsOcrSnapshotController {
  private service = new DmsOcrSnapshotService();
