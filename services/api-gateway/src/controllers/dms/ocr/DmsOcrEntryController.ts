import { DmsOcrEntryService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrEntryService";

export class DmsOcrEntryController {
  private service = new DmsOcrEntryService();
