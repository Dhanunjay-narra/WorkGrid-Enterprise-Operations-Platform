import { DmsOcrAssignmentService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrAssignmentService";

export class DmsOcrAssignmentController {
  private service = new DmsOcrAssignmentService();
