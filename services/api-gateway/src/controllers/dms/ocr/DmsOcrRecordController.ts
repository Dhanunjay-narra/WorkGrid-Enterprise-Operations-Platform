import { DmsOcrRecordService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrRecordService";

export class DmsOcrRecordController {
  private service = new DmsOcrRecordService();
