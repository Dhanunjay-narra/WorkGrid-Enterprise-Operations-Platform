import { DmsOcrItemService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrItemService";

export class DmsOcrItemController {
  private service = new DmsOcrItemService();
