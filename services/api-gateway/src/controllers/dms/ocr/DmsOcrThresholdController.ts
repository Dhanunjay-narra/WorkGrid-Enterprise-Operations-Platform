import { DmsOcrThresholdService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrThresholdService";

export class DmsOcrThresholdController {
  private service = new DmsOcrThresholdService();
