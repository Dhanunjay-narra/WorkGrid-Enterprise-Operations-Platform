import { DmsOcrBatchService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrBatchService";

export class DmsOcrBatchController {
  private service = new DmsOcrBatchService();
