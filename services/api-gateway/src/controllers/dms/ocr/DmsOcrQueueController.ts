import { DmsOcrQueueService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrQueueService";

export class DmsOcrQueueController {
  private service = new DmsOcrQueueService();
