import { DmsOcrPayloadService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrPayloadService";

export class DmsOcrPayloadController {
  private service = new DmsOcrPayloadService();
