import { DmsOcrSessionService } from "../../../../core-engine/src/dms/ocr/services/DmsOcrSessionService";

export class DmsOcrSessionController {
  private service = new DmsOcrSessionService();
