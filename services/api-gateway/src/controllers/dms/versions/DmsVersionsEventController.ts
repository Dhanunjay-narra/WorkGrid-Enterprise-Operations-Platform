import { DmsVersionsEventService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsEventService";

export class DmsVersionsEventController {
  private service = new DmsVersionsEventService();
