import { DmsVersionsScheduleService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsScheduleService";

export class DmsVersionsScheduleController {
  private service = new DmsVersionsScheduleService();
