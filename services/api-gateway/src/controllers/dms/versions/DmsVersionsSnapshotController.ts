import { DmsVersionsSnapshotService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsSnapshotService";

export class DmsVersionsSnapshotController {
  private service = new DmsVersionsSnapshotService();
