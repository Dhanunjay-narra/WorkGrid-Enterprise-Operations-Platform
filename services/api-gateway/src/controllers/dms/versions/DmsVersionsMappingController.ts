import { DmsVersionsMappingService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsMappingService";

export class DmsVersionsMappingController {
  private service = new DmsVersionsMappingService();
