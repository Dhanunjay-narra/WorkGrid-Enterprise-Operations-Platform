import { DmsVersionsStateService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsStateService";

export class DmsVersionsStateController {
  private service = new DmsVersionsStateService();
