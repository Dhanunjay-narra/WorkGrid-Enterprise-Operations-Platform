import { DmsVersionsBatchService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsBatchService";

export class DmsVersionsBatchController {
  private service = new DmsVersionsBatchService();
