import { DmsVersionsPayloadService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsPayloadService";

export class DmsVersionsPayloadController {
  private service = new DmsVersionsPayloadService();
