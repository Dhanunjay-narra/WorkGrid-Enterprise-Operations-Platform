import { DmsVersionsAuditLogService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsAuditLogService";

export class DmsVersionsAuditLogController {
  private service = new DmsVersionsAuditLogService();
