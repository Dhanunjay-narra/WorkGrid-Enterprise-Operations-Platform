import { DmsVersionsConfigService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsConfigService";

export class DmsVersionsConfigController {
  private service = new DmsVersionsConfigService();
