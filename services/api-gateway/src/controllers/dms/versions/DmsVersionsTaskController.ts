import { DmsVersionsTaskService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsTaskService";

export class DmsVersionsTaskController {
  private service = new DmsVersionsTaskService();
