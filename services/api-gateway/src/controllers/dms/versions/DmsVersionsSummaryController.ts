import { DmsVersionsSummaryService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsSummaryService";

export class DmsVersionsSummaryController {
  private service = new DmsVersionsSummaryService();
