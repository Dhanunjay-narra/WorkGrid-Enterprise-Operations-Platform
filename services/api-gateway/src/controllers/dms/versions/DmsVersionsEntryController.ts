import { DmsVersionsEntryService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsEntryService";

export class DmsVersionsEntryController {
  private service = new DmsVersionsEntryService();
