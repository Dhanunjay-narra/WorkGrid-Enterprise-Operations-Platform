import { DmsVersionsRecordService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsRecordService";

export class DmsVersionsRecordController {
  private service = new DmsVersionsRecordService();
