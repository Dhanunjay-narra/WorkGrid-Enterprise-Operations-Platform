import { DmsVersionsThresholdService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsThresholdService";

export class DmsVersionsThresholdController {
  private service = new DmsVersionsThresholdService();
