import { DmsVersionsNodeService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsNodeService";

export class DmsVersionsNodeController {
  private service = new DmsVersionsNodeService();
