import { DmsVersionsMetricService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsMetricService";

export class DmsVersionsMetricController {
  private service = new DmsVersionsMetricService();
