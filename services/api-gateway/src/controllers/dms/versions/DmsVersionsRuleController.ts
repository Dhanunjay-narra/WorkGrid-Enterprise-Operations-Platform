import { DmsVersionsRuleService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsRuleService";

export class DmsVersionsRuleController {
  private service = new DmsVersionsRuleService();
