import { DmsVersionsPolicyService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsPolicyService";

export class DmsVersionsPolicyController {
  private service = new DmsVersionsPolicyService();
