import { DmsVersionsQueueService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsQueueService";

export class DmsVersionsQueueController {
  private service = new DmsVersionsQueueService();
