import { DmsVersionsItemService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsItemService";

export class DmsVersionsItemController {
  private service = new DmsVersionsItemService();
