import { DmsVersionsSessionService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsSessionService";

export class DmsVersionsSessionController {
  private service = new DmsVersionsSessionService();
