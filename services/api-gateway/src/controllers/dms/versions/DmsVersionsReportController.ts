import { DmsVersionsReportService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsReportService";

export class DmsVersionsReportController {
  private service = new DmsVersionsReportService();
