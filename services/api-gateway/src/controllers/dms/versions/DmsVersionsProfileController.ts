import { DmsVersionsProfileService } from "../../../../core-engine/src/dms/versions/services/DmsVersionsProfileService";

export class DmsVersionsProfileController {
  private service = new DmsVersionsProfileService();
