import { DmsRetentionScheduleService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionScheduleService";

export class DmsRetentionScheduleController {
  private service = new DmsRetentionScheduleService();
