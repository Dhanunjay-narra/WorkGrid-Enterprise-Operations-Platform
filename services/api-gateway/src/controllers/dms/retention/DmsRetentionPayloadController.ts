import { DmsRetentionPayloadService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionPayloadService";

export class DmsRetentionPayloadController {
  private service = new DmsRetentionPayloadService();
