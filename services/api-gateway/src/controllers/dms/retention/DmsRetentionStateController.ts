import { DmsRetentionStateService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionStateService";

export class DmsRetentionStateController {
  private service = new DmsRetentionStateService();
