import { DmsRetentionSnapshotService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionSnapshotService";

export class DmsRetentionSnapshotController {
  private service = new DmsRetentionSnapshotService();
