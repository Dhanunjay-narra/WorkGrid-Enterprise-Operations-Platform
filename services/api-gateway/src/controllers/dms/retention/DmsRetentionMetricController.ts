import { DmsRetentionMetricService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionMetricService";

export class DmsRetentionMetricController {
  private service = new DmsRetentionMetricService();
