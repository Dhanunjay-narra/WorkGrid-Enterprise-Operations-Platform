import { DmsRetentionConfigService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionConfigService";

export class DmsRetentionConfigController {
  private service = new DmsRetentionConfigService();
