import { DmsRetentionQueueService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionQueueService";

export class DmsRetentionQueueController {
  private service = new DmsRetentionQueueService();
