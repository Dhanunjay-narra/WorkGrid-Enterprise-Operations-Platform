import { DmsRetentionRuleService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionRuleService";

export class DmsRetentionRuleController {
  private service = new DmsRetentionRuleService();
