import { DmsRetentionAuditLogService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionAuditLogService";

export class DmsRetentionAuditLogController {
  private service = new DmsRetentionAuditLogService();
