import { DmsRetentionEntryService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionEntryService";

export class DmsRetentionEntryController {
  private service = new DmsRetentionEntryService();
