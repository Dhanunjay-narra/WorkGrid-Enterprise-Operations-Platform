import { DmsRetentionMappingService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionMappingService";

export class DmsRetentionMappingController {
  private service = new DmsRetentionMappingService();
