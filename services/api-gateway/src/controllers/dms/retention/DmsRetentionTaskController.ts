import { DmsRetentionTaskService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionTaskService";

export class DmsRetentionTaskController {
  private service = new DmsRetentionTaskService();
