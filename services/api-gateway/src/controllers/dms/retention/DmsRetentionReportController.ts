import { DmsRetentionReportService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionReportService";

export class DmsRetentionReportController {
  private service = new DmsRetentionReportService();
