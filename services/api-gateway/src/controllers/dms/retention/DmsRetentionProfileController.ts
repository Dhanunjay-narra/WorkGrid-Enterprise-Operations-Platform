import { DmsRetentionProfileService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionProfileService";

export class DmsRetentionProfileController {
  private service = new DmsRetentionProfileService();
