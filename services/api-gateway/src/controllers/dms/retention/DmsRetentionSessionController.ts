import { DmsRetentionSessionService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionSessionService";

export class DmsRetentionSessionController {
  private service = new DmsRetentionSessionService();
