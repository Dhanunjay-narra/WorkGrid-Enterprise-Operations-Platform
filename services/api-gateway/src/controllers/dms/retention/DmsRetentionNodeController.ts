import { DmsRetentionNodeService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionNodeService";

export class DmsRetentionNodeController {
  private service = new DmsRetentionNodeService();
