import { DmsRetentionItemService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionItemService";

export class DmsRetentionItemController {
  private service = new DmsRetentionItemService();
