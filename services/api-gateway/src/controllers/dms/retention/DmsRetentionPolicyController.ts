import { DmsRetentionPolicyService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionPolicyService";

export class DmsRetentionPolicyController {
  private service = new DmsRetentionPolicyService();
