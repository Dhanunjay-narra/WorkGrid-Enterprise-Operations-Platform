import { DmsRetentionSummaryService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionSummaryService";

export class DmsRetentionSummaryController {
  private service = new DmsRetentionSummaryService();
