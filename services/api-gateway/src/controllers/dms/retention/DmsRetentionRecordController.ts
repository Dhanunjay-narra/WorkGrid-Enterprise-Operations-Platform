import { DmsRetentionRecordService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionRecordService";

export class DmsRetentionRecordController {
  private service = new DmsRetentionRecordService();
