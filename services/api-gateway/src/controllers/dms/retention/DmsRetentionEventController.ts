import { DmsRetentionEventService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionEventService";

export class DmsRetentionEventController {
  private service = new DmsRetentionEventService();
