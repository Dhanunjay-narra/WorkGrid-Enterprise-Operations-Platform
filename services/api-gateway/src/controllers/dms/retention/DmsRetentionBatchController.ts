import { DmsRetentionBatchService } from "../../../../core-engine/src/dms/retention/services/DmsRetentionBatchService";

export class DmsRetentionBatchController {
  private service = new DmsRetentionBatchService();
