import { BiCohortsPolicyService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsPolicyService";

export class BiCohortsPolicyController {
  private service = new BiCohortsPolicyService();
