import { BiCohortsAssignmentService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsAssignmentService";

export class BiCohortsAssignmentController {
  private service = new BiCohortsAssignmentService();
