import { BiCohortsThresholdService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsThresholdService";

export class BiCohortsThresholdController {
  private service = new BiCohortsThresholdService();
