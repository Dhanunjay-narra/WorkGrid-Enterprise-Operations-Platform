import { BiCohortsMappingService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsMappingService";

export class BiCohortsMappingController {
  private service = new BiCohortsMappingService();
