import { BiCohortsEntryService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsEntryService";

export class BiCohortsEntryController {
  private service = new BiCohortsEntryService();
