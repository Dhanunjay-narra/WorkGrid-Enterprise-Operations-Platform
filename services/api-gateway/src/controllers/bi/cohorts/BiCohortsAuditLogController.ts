import { BiCohortsAuditLogService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsAuditLogService";

export class BiCohortsAuditLogController {
  private service = new BiCohortsAuditLogService();
