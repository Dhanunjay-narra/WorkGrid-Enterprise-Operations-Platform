import { BiCohortsStateService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsStateService";

export class BiCohortsStateController {
  private service = new BiCohortsStateService();
