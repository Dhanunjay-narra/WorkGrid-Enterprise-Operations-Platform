import { BiCohortsProfileService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsProfileService";

export class BiCohortsProfileController {
  private service = new BiCohortsProfileService();
