import { BiCohortsReportService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsReportService";

export class BiCohortsReportController {
  private service = new BiCohortsReportService();
