import { BiCohortsMetricService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsMetricService";

export class BiCohortsMetricController {
  private service = new BiCohortsMetricService();
