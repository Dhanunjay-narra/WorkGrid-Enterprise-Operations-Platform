import { BiCohortsBatchService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsBatchService";

export class BiCohortsBatchController {
  private service = new BiCohortsBatchService();
