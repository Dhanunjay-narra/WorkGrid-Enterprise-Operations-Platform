import { BiCohortsItemService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsItemService";

export class BiCohortsItemController {
  private service = new BiCohortsItemService();
