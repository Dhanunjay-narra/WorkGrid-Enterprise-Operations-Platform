import { BiCohortsSummaryService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsSummaryService";

export class BiCohortsSummaryController {
  private service = new BiCohortsSummaryService();
