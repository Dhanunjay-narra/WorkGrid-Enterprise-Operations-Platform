import { BiCohortsSnapshotService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsSnapshotService";

export class BiCohortsSnapshotController {
  private service = new BiCohortsSnapshotService();
