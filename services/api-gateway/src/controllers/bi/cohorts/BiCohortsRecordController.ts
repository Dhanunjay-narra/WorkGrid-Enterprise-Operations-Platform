import { BiCohortsRecordService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsRecordService";

export class BiCohortsRecordController {
  private service = new BiCohortsRecordService();
