import { BiCohortsPayloadService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsPayloadService";

export class BiCohortsPayloadController {
  private service = new BiCohortsPayloadService();
