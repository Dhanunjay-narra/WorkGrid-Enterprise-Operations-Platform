import { BiCohortsQueueService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsQueueService";

export class BiCohortsQueueController {
  private service = new BiCohortsQueueService();
