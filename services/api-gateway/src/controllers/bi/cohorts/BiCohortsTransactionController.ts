import { BiCohortsTransactionService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsTransactionService";

export class BiCohortsTransactionController {
  private service = new BiCohortsTransactionService();
