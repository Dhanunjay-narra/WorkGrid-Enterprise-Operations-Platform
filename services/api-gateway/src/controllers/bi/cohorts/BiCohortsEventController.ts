import { BiCohortsEventService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsEventService";

export class BiCohortsEventController {
  private service = new BiCohortsEventService();
