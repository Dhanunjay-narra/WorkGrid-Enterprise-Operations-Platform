import { BiCohortsScheduleService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsScheduleService";

export class BiCohortsScheduleController {
  private service = new BiCohortsScheduleService();
