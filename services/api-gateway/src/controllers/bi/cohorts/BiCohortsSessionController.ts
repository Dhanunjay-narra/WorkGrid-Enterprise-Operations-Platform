import { BiCohortsSessionService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsSessionService";

export class BiCohortsSessionController {
  private service = new BiCohortsSessionService();
