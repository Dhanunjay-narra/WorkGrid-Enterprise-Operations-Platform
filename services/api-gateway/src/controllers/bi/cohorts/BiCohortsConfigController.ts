import { BiCohortsConfigService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsConfigService";

export class BiCohortsConfigController {
  private service = new BiCohortsConfigService();
