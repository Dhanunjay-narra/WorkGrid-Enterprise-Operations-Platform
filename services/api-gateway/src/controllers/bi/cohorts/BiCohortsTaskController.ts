import { BiCohortsTaskService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsTaskService";

export class BiCohortsTaskController {
  private service = new BiCohortsTaskService();
