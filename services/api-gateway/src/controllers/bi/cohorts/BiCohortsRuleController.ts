import { BiCohortsRuleService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsRuleService";

export class BiCohortsRuleController {
  private service = new BiCohortsRuleService();
