import { BiCohortsNodeService } from "../../../../core-engine/src/bi/cohorts/services/BiCohortsNodeService";

export class BiCohortsNodeController {
  private service = new BiCohortsNodeService();
