import { BiForecastsProfileService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsProfileService";

export class BiForecastsProfileController {
  private service = new BiForecastsProfileService();
