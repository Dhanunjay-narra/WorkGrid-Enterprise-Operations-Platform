import { BiForecastsPayloadService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsPayloadService";

export class BiForecastsPayloadController {
  private service = new BiForecastsPayloadService();
