import { BiForecastsReportService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsReportService";

export class BiForecastsReportController {
  private service = new BiForecastsReportService();
