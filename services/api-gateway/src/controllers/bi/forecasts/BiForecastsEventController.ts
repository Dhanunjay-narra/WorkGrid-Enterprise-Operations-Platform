import { BiForecastsEventService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsEventService";

export class BiForecastsEventController {
  private service = new BiForecastsEventService();
