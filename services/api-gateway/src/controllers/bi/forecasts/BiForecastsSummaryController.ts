import { BiForecastsSummaryService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsSummaryService";

export class BiForecastsSummaryController {
  private service = new BiForecastsSummaryService();
