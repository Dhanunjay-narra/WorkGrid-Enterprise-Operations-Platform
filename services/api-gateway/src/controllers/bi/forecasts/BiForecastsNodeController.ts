import { BiForecastsNodeService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsNodeService";

export class BiForecastsNodeController {
  private service = new BiForecastsNodeService();
