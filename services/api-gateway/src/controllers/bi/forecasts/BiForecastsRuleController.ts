import { BiForecastsRuleService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsRuleService";

export class BiForecastsRuleController {
  private service = new BiForecastsRuleService();
