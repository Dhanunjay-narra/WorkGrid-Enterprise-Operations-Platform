import { BiForecastsScheduleService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsScheduleService";

export class BiForecastsScheduleController {
  private service = new BiForecastsScheduleService();
