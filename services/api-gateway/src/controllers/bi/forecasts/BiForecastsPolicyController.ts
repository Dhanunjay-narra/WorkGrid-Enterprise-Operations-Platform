import { BiForecastsPolicyService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsPolicyService";

export class BiForecastsPolicyController {
  private service = new BiForecastsPolicyService();
