import { BiForecastsStateService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsStateService";

export class BiForecastsStateController {
  private service = new BiForecastsStateService();
