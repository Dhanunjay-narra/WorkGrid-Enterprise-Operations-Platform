import { BiForecastsConfigService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsConfigService";

export class BiForecastsConfigController {
  private service = new BiForecastsConfigService();
