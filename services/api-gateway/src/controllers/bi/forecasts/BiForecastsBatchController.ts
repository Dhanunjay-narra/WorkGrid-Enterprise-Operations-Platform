import { BiForecastsBatchService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsBatchService";

export class BiForecastsBatchController {
  private service = new BiForecastsBatchService();
