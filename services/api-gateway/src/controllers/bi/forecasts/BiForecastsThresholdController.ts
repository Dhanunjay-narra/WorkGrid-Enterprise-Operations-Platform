import { BiForecastsThresholdService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsThresholdService";

export class BiForecastsThresholdController {
  private service = new BiForecastsThresholdService();
