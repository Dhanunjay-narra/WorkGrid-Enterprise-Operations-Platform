import { BiForecastsMetricService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsMetricService";

export class BiForecastsMetricController {
  private service = new BiForecastsMetricService();
