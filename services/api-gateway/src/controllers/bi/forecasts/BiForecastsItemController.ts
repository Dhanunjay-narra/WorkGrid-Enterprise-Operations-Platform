import { BiForecastsItemService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsItemService";

export class BiForecastsItemController {
  private service = new BiForecastsItemService();
