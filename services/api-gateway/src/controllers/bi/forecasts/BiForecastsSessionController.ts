import { BiForecastsSessionService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsSessionService";

export class BiForecastsSessionController {
  private service = new BiForecastsSessionService();
