import { BiForecastsSnapshotService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsSnapshotService";

export class BiForecastsSnapshotController {
  private service = new BiForecastsSnapshotService();
