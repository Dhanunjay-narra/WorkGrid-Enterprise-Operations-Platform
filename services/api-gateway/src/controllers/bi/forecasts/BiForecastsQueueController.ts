import { BiForecastsQueueService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsQueueService";

export class BiForecastsQueueController {
  private service = new BiForecastsQueueService();
