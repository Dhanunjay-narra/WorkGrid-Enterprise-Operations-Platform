import { BiForecastsAuditLogService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsAuditLogService";

export class BiForecastsAuditLogController {
  private service = new BiForecastsAuditLogService();
