import { BiForecastsEntryService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsEntryService";

export class BiForecastsEntryController {
  private service = new BiForecastsEntryService();
