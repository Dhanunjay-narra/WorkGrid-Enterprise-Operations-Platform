import { BiForecastsRecordService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsRecordService";

export class BiForecastsRecordController {
  private service = new BiForecastsRecordService();
