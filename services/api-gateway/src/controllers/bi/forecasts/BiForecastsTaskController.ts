import { BiForecastsTaskService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsTaskService";

export class BiForecastsTaskController {
  private service = new BiForecastsTaskService();
