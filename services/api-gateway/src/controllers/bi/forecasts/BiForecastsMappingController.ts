import { BiForecastsMappingService } from "../../../../core-engine/src/bi/forecasts/services/BiForecastsMappingService";

export class BiForecastsMappingController {
  private service = new BiForecastsMappingService();
