import { BiAnomaliesThresholdService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesThresholdService";

export class BiAnomaliesThresholdController {
  private service = new BiAnomaliesThresholdService();
