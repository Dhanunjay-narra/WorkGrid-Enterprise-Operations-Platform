import { BiAnomaliesReportService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesReportService";

export class BiAnomaliesReportController {
  private service = new BiAnomaliesReportService();
