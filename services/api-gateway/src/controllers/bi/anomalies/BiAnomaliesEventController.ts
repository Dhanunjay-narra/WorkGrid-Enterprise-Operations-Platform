import { BiAnomaliesEventService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesEventService";

export class BiAnomaliesEventController {
  private service = new BiAnomaliesEventService();
