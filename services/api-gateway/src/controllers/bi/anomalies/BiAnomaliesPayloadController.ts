import { BiAnomaliesPayloadService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesPayloadService";

export class BiAnomaliesPayloadController {
  private service = new BiAnomaliesPayloadService();
