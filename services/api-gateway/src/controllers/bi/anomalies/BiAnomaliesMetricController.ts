import { BiAnomaliesMetricService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesMetricService";

export class BiAnomaliesMetricController {
  private service = new BiAnomaliesMetricService();
