import { BiAnomaliesAuditLogService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesAuditLogService";

export class BiAnomaliesAuditLogController {
  private service = new BiAnomaliesAuditLogService();
