import { BiAnomaliesSnapshotService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesSnapshotService";

export class BiAnomaliesSnapshotController {
  private service = new BiAnomaliesSnapshotService();
