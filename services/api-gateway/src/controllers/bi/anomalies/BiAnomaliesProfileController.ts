import { BiAnomaliesProfileService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesProfileService";

export class BiAnomaliesProfileController {
  private service = new BiAnomaliesProfileService();
