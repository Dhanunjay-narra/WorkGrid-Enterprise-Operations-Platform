import { BiAnomaliesSummaryService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesSummaryService";

export class BiAnomaliesSummaryController {
  private service = new BiAnomaliesSummaryService();
