import { BiAnomaliesRuleService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesRuleService";

export class BiAnomaliesRuleController {
  private service = new BiAnomaliesRuleService();
