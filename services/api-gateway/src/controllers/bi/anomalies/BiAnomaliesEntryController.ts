import { BiAnomaliesEntryService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesEntryService";

export class BiAnomaliesEntryController {
  private service = new BiAnomaliesEntryService();
