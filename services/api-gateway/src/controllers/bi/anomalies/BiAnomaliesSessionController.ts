import { BiAnomaliesSessionService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesSessionService";

export class BiAnomaliesSessionController {
  private service = new BiAnomaliesSessionService();
