import { BiAnomaliesMappingService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesMappingService";

export class BiAnomaliesMappingController {
  private service = new BiAnomaliesMappingService();
