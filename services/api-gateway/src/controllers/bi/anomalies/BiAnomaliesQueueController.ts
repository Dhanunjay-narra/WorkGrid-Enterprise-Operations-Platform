import { BiAnomaliesQueueService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesQueueService";

export class BiAnomaliesQueueController {
  private service = new BiAnomaliesQueueService();
