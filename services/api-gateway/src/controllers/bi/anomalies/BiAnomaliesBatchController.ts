import { BiAnomaliesBatchService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesBatchService";

export class BiAnomaliesBatchController {
  private service = new BiAnomaliesBatchService();
