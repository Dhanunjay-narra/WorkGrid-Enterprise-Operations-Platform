import { BiAnomaliesNodeService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesNodeService";

export class BiAnomaliesNodeController {
  private service = new BiAnomaliesNodeService();
