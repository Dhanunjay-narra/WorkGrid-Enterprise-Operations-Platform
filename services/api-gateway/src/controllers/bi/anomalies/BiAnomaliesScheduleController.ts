import { BiAnomaliesScheduleService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesScheduleService";

export class BiAnomaliesScheduleController {
  private service = new BiAnomaliesScheduleService();
