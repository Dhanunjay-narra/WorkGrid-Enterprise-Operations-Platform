import { BiAnomaliesRecordService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesRecordService";

export class BiAnomaliesRecordController {
  private service = new BiAnomaliesRecordService();
