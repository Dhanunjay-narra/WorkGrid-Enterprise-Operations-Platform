import { BiAnomaliesItemService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesItemService";

export class BiAnomaliesItemController {
  private service = new BiAnomaliesItemService();
