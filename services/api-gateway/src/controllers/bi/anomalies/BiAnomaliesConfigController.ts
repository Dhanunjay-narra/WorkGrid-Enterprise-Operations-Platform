import { BiAnomaliesConfigService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesConfigService";

export class BiAnomaliesConfigController {
  private service = new BiAnomaliesConfigService();
