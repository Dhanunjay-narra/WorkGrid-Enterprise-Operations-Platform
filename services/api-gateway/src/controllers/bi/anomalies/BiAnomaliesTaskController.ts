import { BiAnomaliesTaskService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesTaskService";

export class BiAnomaliesTaskController {
  private service = new BiAnomaliesTaskService();
