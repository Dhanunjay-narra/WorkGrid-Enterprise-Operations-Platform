import { BiAnomaliesStateService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesStateService";

export class BiAnomaliesStateController {
  private service = new BiAnomaliesStateService();
