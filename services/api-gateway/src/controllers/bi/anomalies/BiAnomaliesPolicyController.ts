import { BiAnomaliesPolicyService } from "../../../../core-engine/src/bi/anomalies/services/BiAnomaliesPolicyService";

export class BiAnomaliesPolicyController {
  private service = new BiAnomaliesPolicyService();
