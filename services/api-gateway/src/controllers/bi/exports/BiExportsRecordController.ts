import { BiExportsRecordService } from "../../../../core-engine/src/bi/exports/services/BiExportsRecordService";

export class BiExportsRecordController {
  private service = new BiExportsRecordService();
