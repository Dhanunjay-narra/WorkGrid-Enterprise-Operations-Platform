import { BiExportsProfileService } from "../../../../core-engine/src/bi/exports/services/BiExportsProfileService";

export class BiExportsProfileController {
  private service = new BiExportsProfileService();
