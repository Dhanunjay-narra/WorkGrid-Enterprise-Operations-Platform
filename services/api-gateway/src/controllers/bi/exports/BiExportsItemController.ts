import { BiExportsItemService } from "../../../../core-engine/src/bi/exports/services/BiExportsItemService";

export class BiExportsItemController {
  private service = new BiExportsItemService();
