import { BiExportsThresholdService } from "../../../../core-engine/src/bi/exports/services/BiExportsThresholdService";

export class BiExportsThresholdController {
  private service = new BiExportsThresholdService();
