import { BiExportsEventService } from "../../../../core-engine/src/bi/exports/services/BiExportsEventService";

export class BiExportsEventController {
  private service = new BiExportsEventService();
