import { BiExportsQueueService } from "../../../../core-engine/src/bi/exports/services/BiExportsQueueService";

export class BiExportsQueueController {
  private service = new BiExportsQueueService();
