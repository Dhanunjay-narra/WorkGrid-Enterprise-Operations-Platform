import { BiExportsReportService } from "../../../../core-engine/src/bi/exports/services/BiExportsReportService";

export class BiExportsReportController {
  private service = new BiExportsReportService();
