import { BiExportsSnapshotService } from "../../../../core-engine/src/bi/exports/services/BiExportsSnapshotService";

export class BiExportsSnapshotController {
  private service = new BiExportsSnapshotService();
