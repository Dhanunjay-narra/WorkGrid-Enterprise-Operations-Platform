import { BiExportsMetricService } from "../../../../core-engine/src/bi/exports/services/BiExportsMetricService";

export class BiExportsMetricController {
  private service = new BiExportsMetricService();
