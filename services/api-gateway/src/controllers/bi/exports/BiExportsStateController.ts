import { BiExportsStateService } from "../../../../core-engine/src/bi/exports/services/BiExportsStateService";

export class BiExportsStateController {
  private service = new BiExportsStateService();
