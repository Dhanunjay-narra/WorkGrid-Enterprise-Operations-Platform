import { BiExportsBatchService } from "../../../../core-engine/src/bi/exports/services/BiExportsBatchService";

export class BiExportsBatchController {
  private service = new BiExportsBatchService();
