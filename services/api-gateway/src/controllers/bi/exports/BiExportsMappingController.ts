import { BiExportsMappingService } from "../../../../core-engine/src/bi/exports/services/BiExportsMappingService";

export class BiExportsMappingController {
  private service = new BiExportsMappingService();
