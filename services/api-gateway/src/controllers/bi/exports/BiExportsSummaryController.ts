import { BiExportsSummaryService } from "../../../../core-engine/src/bi/exports/services/BiExportsSummaryService";

export class BiExportsSummaryController {
  private service = new BiExportsSummaryService();
