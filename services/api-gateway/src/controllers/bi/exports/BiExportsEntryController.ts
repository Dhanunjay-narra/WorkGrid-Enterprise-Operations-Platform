import { BiExportsEntryService } from "../../../../core-engine/src/bi/exports/services/BiExportsEntryService";

export class BiExportsEntryController {
  private service = new BiExportsEntryService();
