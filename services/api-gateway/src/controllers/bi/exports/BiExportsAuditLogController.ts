import { BiExportsAuditLogService } from "../../../../core-engine/src/bi/exports/services/BiExportsAuditLogService";

export class BiExportsAuditLogController {
  private service = new BiExportsAuditLogService();
