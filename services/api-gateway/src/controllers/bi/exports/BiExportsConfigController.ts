import { BiExportsConfigService } from "../../../../core-engine/src/bi/exports/services/BiExportsConfigService";

export class BiExportsConfigController {
  private service = new BiExportsConfigService();
