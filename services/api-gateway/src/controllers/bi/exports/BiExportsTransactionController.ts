import { BiExportsTransactionService } from "../../../../core-engine/src/bi/exports/services/BiExportsTransactionService";

export class BiExportsTransactionController {
  private service = new BiExportsTransactionService();
