import { BiExportsScheduleService } from "../../../../core-engine/src/bi/exports/services/BiExportsScheduleService";

export class BiExportsScheduleController {
  private service = new BiExportsScheduleService();
