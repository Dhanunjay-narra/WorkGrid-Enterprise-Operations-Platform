import { BiExportsTaskService } from "../../../../core-engine/src/bi/exports/services/BiExportsTaskService";

export class BiExportsTaskController {
  private service = new BiExportsTaskService();
