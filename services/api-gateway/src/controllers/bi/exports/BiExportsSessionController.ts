import { BiExportsSessionService } from "../../../../core-engine/src/bi/exports/services/BiExportsSessionService";

export class BiExportsSessionController {
  private service = new BiExportsSessionService();
