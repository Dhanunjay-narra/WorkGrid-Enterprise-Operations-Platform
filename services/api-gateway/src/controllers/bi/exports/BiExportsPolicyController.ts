import { BiExportsPolicyService } from "../../../../core-engine/src/bi/exports/services/BiExportsPolicyService";

export class BiExportsPolicyController {
  private service = new BiExportsPolicyService();
