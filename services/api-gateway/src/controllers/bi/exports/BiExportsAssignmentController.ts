import { BiExportsAssignmentService } from "../../../../core-engine/src/bi/exports/services/BiExportsAssignmentService";

export class BiExportsAssignmentController {
  private service = new BiExportsAssignmentService();
