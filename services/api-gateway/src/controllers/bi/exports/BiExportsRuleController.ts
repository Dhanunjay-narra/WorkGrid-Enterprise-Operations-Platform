import { BiExportsRuleService } from "../../../../core-engine/src/bi/exports/services/BiExportsRuleService";

export class BiExportsRuleController {
  private service = new BiExportsRuleService();
