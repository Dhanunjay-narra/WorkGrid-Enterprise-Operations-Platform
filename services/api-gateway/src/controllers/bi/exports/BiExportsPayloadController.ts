import { BiExportsPayloadService } from "../../../../core-engine/src/bi/exports/services/BiExportsPayloadService";

export class BiExportsPayloadController {
  private service = new BiExportsPayloadService();
