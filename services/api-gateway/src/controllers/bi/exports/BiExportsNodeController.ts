import { BiExportsNodeService } from "../../../../core-engine/src/bi/exports/services/BiExportsNodeService";

export class BiExportsNodeController {
  private service = new BiExportsNodeService();
