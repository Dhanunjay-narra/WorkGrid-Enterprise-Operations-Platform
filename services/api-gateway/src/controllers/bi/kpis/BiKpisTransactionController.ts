import { BiKpisTransactionService } from "../../../../core-engine/src/bi/kpis/services/BiKpisTransactionService";

export class BiKpisTransactionController {
  private service = new BiKpisTransactionService();
