import { BiKpisQueueService } from "../../../../core-engine/src/bi/kpis/services/BiKpisQueueService";

export class BiKpisQueueController {
  private service = new BiKpisQueueService();
