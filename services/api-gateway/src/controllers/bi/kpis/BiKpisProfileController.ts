import { BiKpisProfileService } from "../../../../core-engine/src/bi/kpis/services/BiKpisProfileService";

export class BiKpisProfileController {
  private service = new BiKpisProfileService();
