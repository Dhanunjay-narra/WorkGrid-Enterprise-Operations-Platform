import { BiKpisEntryService } from "../../../../core-engine/src/bi/kpis/services/BiKpisEntryService";

export class BiKpisEntryController {
  private service = new BiKpisEntryService();
