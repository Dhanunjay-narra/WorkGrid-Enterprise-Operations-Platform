import { BiKpisMetricService } from "../../../../core-engine/src/bi/kpis/services/BiKpisMetricService";

export class BiKpisMetricController {
  private service = new BiKpisMetricService();
