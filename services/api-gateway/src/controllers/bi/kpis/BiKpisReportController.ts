import { BiKpisReportService } from "../../../../core-engine/src/bi/kpis/services/BiKpisReportService";

export class BiKpisReportController {
  private service = new BiKpisReportService();
