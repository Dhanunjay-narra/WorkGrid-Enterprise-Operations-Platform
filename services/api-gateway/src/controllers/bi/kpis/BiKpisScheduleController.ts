import { BiKpisScheduleService } from "../../../../core-engine/src/bi/kpis/services/BiKpisScheduleService";

export class BiKpisScheduleController {
  private service = new BiKpisScheduleService();
