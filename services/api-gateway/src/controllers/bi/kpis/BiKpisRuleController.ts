import { BiKpisRuleService } from "../../../../core-engine/src/bi/kpis/services/BiKpisRuleService";

export class BiKpisRuleController {
  private service = new BiKpisRuleService();
