import { BiKpisMappingService } from "../../../../core-engine/src/bi/kpis/services/BiKpisMappingService";

export class BiKpisMappingController {
  private service = new BiKpisMappingService();
