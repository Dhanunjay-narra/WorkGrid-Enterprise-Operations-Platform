import { BiKpisSummaryService } from "../../../../core-engine/src/bi/kpis/services/BiKpisSummaryService";

export class BiKpisSummaryController {
  private service = new BiKpisSummaryService();
