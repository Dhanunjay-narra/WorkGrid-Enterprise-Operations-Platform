import { BiKpisBatchService } from "../../../../core-engine/src/bi/kpis/services/BiKpisBatchService";

export class BiKpisBatchController {
  private service = new BiKpisBatchService();
