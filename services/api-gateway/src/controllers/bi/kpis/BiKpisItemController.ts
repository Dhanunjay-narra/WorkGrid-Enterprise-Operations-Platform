import { BiKpisItemService } from "../../../../core-engine/src/bi/kpis/services/BiKpisItemService";

export class BiKpisItemController {
  private service = new BiKpisItemService();
