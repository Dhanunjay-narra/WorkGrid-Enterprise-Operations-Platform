import { BiKpisAuditLogService } from "../../../../core-engine/src/bi/kpis/services/BiKpisAuditLogService";

export class BiKpisAuditLogController {
  private service = new BiKpisAuditLogService();
