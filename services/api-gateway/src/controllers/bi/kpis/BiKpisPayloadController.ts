import { BiKpisPayloadService } from "../../../../core-engine/src/bi/kpis/services/BiKpisPayloadService";

export class BiKpisPayloadController {
  private service = new BiKpisPayloadService();
