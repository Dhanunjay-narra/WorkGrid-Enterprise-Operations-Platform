import { BiKpisNodeService } from "../../../../core-engine/src/bi/kpis/services/BiKpisNodeService";

export class BiKpisNodeController {
  private service = new BiKpisNodeService();
