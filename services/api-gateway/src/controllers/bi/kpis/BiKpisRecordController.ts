import { BiKpisRecordService } from "../../../../core-engine/src/bi/kpis/services/BiKpisRecordService";

export class BiKpisRecordController {
  private service = new BiKpisRecordService();
