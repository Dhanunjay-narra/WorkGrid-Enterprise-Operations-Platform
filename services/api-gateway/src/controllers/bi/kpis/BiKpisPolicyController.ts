import { BiKpisPolicyService } from "../../../../core-engine/src/bi/kpis/services/BiKpisPolicyService";

export class BiKpisPolicyController {
  private service = new BiKpisPolicyService();
