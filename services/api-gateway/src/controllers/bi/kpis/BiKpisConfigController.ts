import { BiKpisConfigService } from "../../../../core-engine/src/bi/kpis/services/BiKpisConfigService";

export class BiKpisConfigController {
  private service = new BiKpisConfigService();
