import { BiKpisAssignmentService } from "../../../../core-engine/src/bi/kpis/services/BiKpisAssignmentService";

export class BiKpisAssignmentController {
  private service = new BiKpisAssignmentService();
