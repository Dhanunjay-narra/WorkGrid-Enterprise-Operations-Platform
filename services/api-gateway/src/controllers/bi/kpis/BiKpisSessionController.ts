import { BiKpisSessionService } from "../../../../core-engine/src/bi/kpis/services/BiKpisSessionService";

export class BiKpisSessionController {
  private service = new BiKpisSessionService();
