import { BiKpisSnapshotService } from "../../../../core-engine/src/bi/kpis/services/BiKpisSnapshotService";

export class BiKpisSnapshotController {
  private service = new BiKpisSnapshotService();
