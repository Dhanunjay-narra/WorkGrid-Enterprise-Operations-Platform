import { BiKpisThresholdService } from "../../../../core-engine/src/bi/kpis/services/BiKpisThresholdService";

export class BiKpisThresholdController {
  private service = new BiKpisThresholdService();
