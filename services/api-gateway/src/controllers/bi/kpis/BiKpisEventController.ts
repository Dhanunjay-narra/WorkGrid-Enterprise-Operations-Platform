import { BiKpisEventService } from "../../../../core-engine/src/bi/kpis/services/BiKpisEventService";

export class BiKpisEventController {
  private service = new BiKpisEventService();
