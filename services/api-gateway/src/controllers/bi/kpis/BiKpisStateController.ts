import { BiKpisStateService } from "../../../../core-engine/src/bi/kpis/services/BiKpisStateService";

export class BiKpisStateController {
  private service = new BiKpisStateService();
