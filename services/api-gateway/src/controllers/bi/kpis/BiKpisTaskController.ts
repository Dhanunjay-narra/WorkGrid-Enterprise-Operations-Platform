import { BiKpisTaskService } from "../../../../core-engine/src/bi/kpis/services/BiKpisTaskService";

export class BiKpisTaskController {
  private service = new BiKpisTaskService();
