import { BiDashboardsSessionService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsSessionService";

export class BiDashboardsSessionController {
  private service = new BiDashboardsSessionService();
