import { BiDashboardsStateService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsStateService";

export class BiDashboardsStateController {
  private service = new BiDashboardsStateService();
