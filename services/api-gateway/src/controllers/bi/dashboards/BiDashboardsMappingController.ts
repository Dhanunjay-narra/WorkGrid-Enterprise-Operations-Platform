import { BiDashboardsMappingService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsMappingService";

export class BiDashboardsMappingController {
  private service = new BiDashboardsMappingService();
