import { BiDashboardsReportService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsReportService";

export class BiDashboardsReportController {
  private service = new BiDashboardsReportService();
