import { BiDashboardsScheduleService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsScheduleService";

export class BiDashboardsScheduleController {
  private service = new BiDashboardsScheduleService();
