import { BiDashboardsEventService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsEventService";

export class BiDashboardsEventController {
  private service = new BiDashboardsEventService();
