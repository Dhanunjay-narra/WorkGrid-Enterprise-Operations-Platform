import { BiDashboardsSnapshotService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsSnapshotService";

export class BiDashboardsSnapshotController {
  private service = new BiDashboardsSnapshotService();
