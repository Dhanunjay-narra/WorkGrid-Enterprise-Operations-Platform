import { BiDashboardsNodeService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsNodeService";

export class BiDashboardsNodeController {
  private service = new BiDashboardsNodeService();
