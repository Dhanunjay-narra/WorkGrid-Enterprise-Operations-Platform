import { BiDashboardsConfigService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsConfigService";

export class BiDashboardsConfigController {
  private service = new BiDashboardsConfigService();
