import { BiDashboardsMetricService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsMetricService";

export class BiDashboardsMetricController {
  private service = new BiDashboardsMetricService();
