import { BiDashboardsItemService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsItemService";

export class BiDashboardsItemController {
  private service = new BiDashboardsItemService();
