import { BiDashboardsBatchService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsBatchService";

export class BiDashboardsBatchController {
  private service = new BiDashboardsBatchService();
