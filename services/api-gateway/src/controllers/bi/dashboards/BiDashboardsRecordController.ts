import { BiDashboardsRecordService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsRecordService";

export class BiDashboardsRecordController {
  private service = new BiDashboardsRecordService();
