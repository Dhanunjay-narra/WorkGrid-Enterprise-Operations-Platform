import { BiDashboardsTaskService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsTaskService";

export class BiDashboardsTaskController {
  private service = new BiDashboardsTaskService();
