import { BiDashboardsQueueService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsQueueService";

export class BiDashboardsQueueController {
  private service = new BiDashboardsQueueService();
