import { BiDashboardsProfileService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsProfileService";

export class BiDashboardsProfileController {
  private service = new BiDashboardsProfileService();
