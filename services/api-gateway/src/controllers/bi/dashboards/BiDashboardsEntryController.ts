import { BiDashboardsEntryService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsEntryService";

export class BiDashboardsEntryController {
  private service = new BiDashboardsEntryService();
