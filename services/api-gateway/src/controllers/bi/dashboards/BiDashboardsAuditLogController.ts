import { BiDashboardsAuditLogService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsAuditLogService";

export class BiDashboardsAuditLogController {
  private service = new BiDashboardsAuditLogService();
