import { BiDashboardsPayloadService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsPayloadService";

export class BiDashboardsPayloadController {
  private service = new BiDashboardsPayloadService();
