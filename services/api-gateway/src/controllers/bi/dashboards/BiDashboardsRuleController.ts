import { BiDashboardsRuleService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsRuleService";

export class BiDashboardsRuleController {
  private service = new BiDashboardsRuleService();
