import { BiDashboardsSummaryService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsSummaryService";

export class BiDashboardsSummaryController {
  private service = new BiDashboardsSummaryService();
