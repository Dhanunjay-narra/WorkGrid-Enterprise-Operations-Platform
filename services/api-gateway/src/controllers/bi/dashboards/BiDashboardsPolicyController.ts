import { BiDashboardsPolicyService } from "../../../../core-engine/src/bi/dashboards/services/BiDashboardsPolicyService";

export class BiDashboardsPolicyController {
  private service = new BiDashboardsPolicyService();
