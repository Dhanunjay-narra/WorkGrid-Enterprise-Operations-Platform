import { BiWidgetsAssignmentService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsAssignmentService";

export class BiWidgetsAssignmentController {
  private service = new BiWidgetsAssignmentService();
