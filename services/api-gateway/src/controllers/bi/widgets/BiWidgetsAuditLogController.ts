import { BiWidgetsAuditLogService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsAuditLogService";

export class BiWidgetsAuditLogController {
  private service = new BiWidgetsAuditLogService();
