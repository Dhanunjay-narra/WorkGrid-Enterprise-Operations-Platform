import { BiWidgetsPayloadService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsPayloadService";

export class BiWidgetsPayloadController {
  private service = new BiWidgetsPayloadService();
