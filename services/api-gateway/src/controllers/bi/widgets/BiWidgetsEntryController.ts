import { BiWidgetsEntryService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsEntryService";

export class BiWidgetsEntryController {
  private service = new BiWidgetsEntryService();
