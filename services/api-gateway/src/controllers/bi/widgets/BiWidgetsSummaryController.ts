import { BiWidgetsSummaryService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsSummaryService";

export class BiWidgetsSummaryController {
  private service = new BiWidgetsSummaryService();
