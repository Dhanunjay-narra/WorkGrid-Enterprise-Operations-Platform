import { BiWidgetsThresholdService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsThresholdService";

export class BiWidgetsThresholdController {
  private service = new BiWidgetsThresholdService();
