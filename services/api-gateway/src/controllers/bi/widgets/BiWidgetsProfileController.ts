import { BiWidgetsProfileService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsProfileService";

export class BiWidgetsProfileController {
  private service = new BiWidgetsProfileService();
