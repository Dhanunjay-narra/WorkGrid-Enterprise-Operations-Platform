import { BiWidgetsTaskService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsTaskService";

export class BiWidgetsTaskController {
  private service = new BiWidgetsTaskService();
