import { BiWidgetsConfigService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsConfigService";

export class BiWidgetsConfigController {
  private service = new BiWidgetsConfigService();
