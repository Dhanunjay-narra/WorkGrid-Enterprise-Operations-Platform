import { BiWidgetsStateService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsStateService";

export class BiWidgetsStateController {
  private service = new BiWidgetsStateService();
