import { BiWidgetsSessionService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsSessionService";

export class BiWidgetsSessionController {
  private service = new BiWidgetsSessionService();
