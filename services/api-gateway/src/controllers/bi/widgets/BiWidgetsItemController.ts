import { BiWidgetsItemService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsItemService";

export class BiWidgetsItemController {
  private service = new BiWidgetsItemService();
