import { BiWidgetsMappingService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsMappingService";

export class BiWidgetsMappingController {
  private service = new BiWidgetsMappingService();
