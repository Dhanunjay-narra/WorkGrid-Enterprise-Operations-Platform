import { BiWidgetsQueueService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsQueueService";

export class BiWidgetsQueueController {
  private service = new BiWidgetsQueueService();
