import { BiWidgetsTransactionService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsTransactionService";

export class BiWidgetsTransactionController {
  private service = new BiWidgetsTransactionService();
