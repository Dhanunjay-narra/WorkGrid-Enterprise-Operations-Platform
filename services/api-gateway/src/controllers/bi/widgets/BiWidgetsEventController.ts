import { BiWidgetsEventService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsEventService";

export class BiWidgetsEventController {
  private service = new BiWidgetsEventService();
