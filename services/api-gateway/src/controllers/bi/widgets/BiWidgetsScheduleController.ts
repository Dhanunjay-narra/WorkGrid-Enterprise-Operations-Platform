import { BiWidgetsScheduleService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsScheduleService";

export class BiWidgetsScheduleController {
  private service = new BiWidgetsScheduleService();
