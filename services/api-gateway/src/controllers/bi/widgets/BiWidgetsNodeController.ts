import { BiWidgetsNodeService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsNodeService";

export class BiWidgetsNodeController {
  private service = new BiWidgetsNodeService();
