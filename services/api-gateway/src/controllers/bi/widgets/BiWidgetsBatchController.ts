import { BiWidgetsBatchService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsBatchService";

export class BiWidgetsBatchController {
  private service = new BiWidgetsBatchService();
