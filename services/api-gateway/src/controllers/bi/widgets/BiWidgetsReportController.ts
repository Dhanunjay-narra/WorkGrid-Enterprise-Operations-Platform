import { BiWidgetsReportService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsReportService";

export class BiWidgetsReportController {
  private service = new BiWidgetsReportService();
