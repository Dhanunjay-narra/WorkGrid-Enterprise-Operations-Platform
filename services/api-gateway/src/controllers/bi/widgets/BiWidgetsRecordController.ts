import { BiWidgetsRecordService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsRecordService";

export class BiWidgetsRecordController {
  private service = new BiWidgetsRecordService();
