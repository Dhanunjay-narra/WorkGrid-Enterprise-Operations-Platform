import { BiWidgetsRuleService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsRuleService";

export class BiWidgetsRuleController {
  private service = new BiWidgetsRuleService();
