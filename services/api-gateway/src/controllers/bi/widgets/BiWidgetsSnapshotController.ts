import { BiWidgetsSnapshotService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsSnapshotService";

export class BiWidgetsSnapshotController {
  private service = new BiWidgetsSnapshotService();
