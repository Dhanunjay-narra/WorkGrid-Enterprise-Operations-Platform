import { BiWidgetsPolicyService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsPolicyService";

export class BiWidgetsPolicyController {
  private service = new BiWidgetsPolicyService();
