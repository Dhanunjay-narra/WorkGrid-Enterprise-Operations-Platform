import { BiWidgetsMetricService } from "../../../../core-engine/src/bi/widgets/services/BiWidgetsMetricService";

export class BiWidgetsMetricController {
  private service = new BiWidgetsMetricService();
