import { BiQueriesMetricService } from "../../../../core-engine/src/bi/queries/services/BiQueriesMetricService";

export class BiQueriesMetricController {
  private service = new BiQueriesMetricService();
