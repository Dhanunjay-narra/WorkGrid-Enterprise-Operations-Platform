import { BiQueriesBatchService } from "../../../../core-engine/src/bi/queries/services/BiQueriesBatchService";

export class BiQueriesBatchController {
  private service = new BiQueriesBatchService();
