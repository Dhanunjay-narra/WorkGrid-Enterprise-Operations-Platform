import { BiQueriesThresholdService } from "../../../../core-engine/src/bi/queries/services/BiQueriesThresholdService";

export class BiQueriesThresholdController {
  private service = new BiQueriesThresholdService();
