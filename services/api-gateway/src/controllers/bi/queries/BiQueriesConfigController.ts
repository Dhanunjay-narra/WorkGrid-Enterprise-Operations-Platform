import { BiQueriesConfigService } from "../../../../core-engine/src/bi/queries/services/BiQueriesConfigService";

export class BiQueriesConfigController {
  private service = new BiQueriesConfigService();
