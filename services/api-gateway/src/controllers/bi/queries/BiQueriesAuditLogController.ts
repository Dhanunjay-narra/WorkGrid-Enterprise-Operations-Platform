import { BiQueriesAuditLogService } from "../../../../core-engine/src/bi/queries/services/BiQueriesAuditLogService";

export class BiQueriesAuditLogController {
  private service = new BiQueriesAuditLogService();
