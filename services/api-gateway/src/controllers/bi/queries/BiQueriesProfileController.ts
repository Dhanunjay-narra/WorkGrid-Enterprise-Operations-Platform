import { BiQueriesProfileService } from "../../../../core-engine/src/bi/queries/services/BiQueriesProfileService";

export class BiQueriesProfileController {
  private service = new BiQueriesProfileService();
