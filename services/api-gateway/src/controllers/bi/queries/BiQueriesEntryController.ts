import { BiQueriesEntryService } from "../../../../core-engine/src/bi/queries/services/BiQueriesEntryService";

export class BiQueriesEntryController {
  private service = new BiQueriesEntryService();
