import { BiQueriesTransactionService } from "../../../../core-engine/src/bi/queries/services/BiQueriesTransactionService";

export class BiQueriesTransactionController {
  private service = new BiQueriesTransactionService();
