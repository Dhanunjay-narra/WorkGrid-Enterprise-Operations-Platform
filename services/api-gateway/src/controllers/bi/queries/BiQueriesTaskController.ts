import { BiQueriesTaskService } from "../../../../core-engine/src/bi/queries/services/BiQueriesTaskService";

export class BiQueriesTaskController {
  private service = new BiQueriesTaskService();
