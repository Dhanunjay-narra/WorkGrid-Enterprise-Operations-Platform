import { BiQueriesItemService } from "../../../../core-engine/src/bi/queries/services/BiQueriesItemService";

export class BiQueriesItemController {
  private service = new BiQueriesItemService();
