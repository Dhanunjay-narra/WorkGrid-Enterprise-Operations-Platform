import { BiQueriesStateService } from "../../../../core-engine/src/bi/queries/services/BiQueriesStateService";

export class BiQueriesStateController {
  private service = new BiQueriesStateService();
