import { BiQueriesPolicyService } from "../../../../core-engine/src/bi/queries/services/BiQueriesPolicyService";

export class BiQueriesPolicyController {
  private service = new BiQueriesPolicyService();
