import { BiQueriesReportService } from "../../../../core-engine/src/bi/queries/services/BiQueriesReportService";

export class BiQueriesReportController {
  private service = new BiQueriesReportService();
