import { BiQueriesMappingService } from "../../../../core-engine/src/bi/queries/services/BiQueriesMappingService";

export class BiQueriesMappingController {
  private service = new BiQueriesMappingService();
