import { BiQueriesSummaryService } from "../../../../core-engine/src/bi/queries/services/BiQueriesSummaryService";

export class BiQueriesSummaryController {
  private service = new BiQueriesSummaryService();
