import { BiQueriesRecordService } from "../../../../core-engine/src/bi/queries/services/BiQueriesRecordService";

export class BiQueriesRecordController {
  private service = new BiQueriesRecordService();
