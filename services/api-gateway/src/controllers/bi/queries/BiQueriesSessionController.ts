import { BiQueriesSessionService } from "../../../../core-engine/src/bi/queries/services/BiQueriesSessionService";

export class BiQueriesSessionController {
  private service = new BiQueriesSessionService();
