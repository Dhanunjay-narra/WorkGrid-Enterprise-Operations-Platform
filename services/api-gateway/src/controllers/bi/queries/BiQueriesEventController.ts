import { BiQueriesEventService } from "../../../../core-engine/src/bi/queries/services/BiQueriesEventService";

export class BiQueriesEventController {
  private service = new BiQueriesEventService();
