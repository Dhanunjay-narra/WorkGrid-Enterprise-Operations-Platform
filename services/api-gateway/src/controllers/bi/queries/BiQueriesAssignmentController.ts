import { BiQueriesAssignmentService } from "../../../../core-engine/src/bi/queries/services/BiQueriesAssignmentService";

export class BiQueriesAssignmentController {
  private service = new BiQueriesAssignmentService();
