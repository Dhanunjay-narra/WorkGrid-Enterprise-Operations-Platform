import { BiQueriesQueueService } from "../../../../core-engine/src/bi/queries/services/BiQueriesQueueService";

export class BiQueriesQueueController {
  private service = new BiQueriesQueueService();
