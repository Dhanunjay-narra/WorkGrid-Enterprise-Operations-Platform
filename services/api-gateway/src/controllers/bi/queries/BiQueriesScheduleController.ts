import { BiQueriesScheduleService } from "../../../../core-engine/src/bi/queries/services/BiQueriesScheduleService";

export class BiQueriesScheduleController {
  private service = new BiQueriesScheduleService();
