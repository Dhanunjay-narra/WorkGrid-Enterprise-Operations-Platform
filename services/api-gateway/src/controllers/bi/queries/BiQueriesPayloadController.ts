import { BiQueriesPayloadService } from "../../../../core-engine/src/bi/queries/services/BiQueriesPayloadService";

export class BiQueriesPayloadController {
  private service = new BiQueriesPayloadService();
