import { BiQueriesSnapshotService } from "../../../../core-engine/src/bi/queries/services/BiQueriesSnapshotService";

export class BiQueriesSnapshotController {
  private service = new BiQueriesSnapshotService();
