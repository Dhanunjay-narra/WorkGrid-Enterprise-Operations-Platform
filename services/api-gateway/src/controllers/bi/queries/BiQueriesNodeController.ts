import { BiQueriesNodeService } from "../../../../core-engine/src/bi/queries/services/BiQueriesNodeService";

export class BiQueriesNodeController {
  private service = new BiQueriesNodeService();
