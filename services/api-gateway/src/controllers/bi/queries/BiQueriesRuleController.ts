import { BiQueriesRuleService } from "../../../../core-engine/src/bi/queries/services/BiQueriesRuleService";

export class BiQueriesRuleController {
  private service = new BiQueriesRuleService();
