import { SupportCsatPolicyService } from "../../../../core-engine/src/support/csat/services/SupportCsatPolicyService";

export class SupportCsatPolicyController {
  private service = new SupportCsatPolicyService();
