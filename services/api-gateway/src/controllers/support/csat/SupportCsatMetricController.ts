import { SupportCsatMetricService } from "../../../../core-engine/src/support/csat/services/SupportCsatMetricService";

export class SupportCsatMetricController {
  private service = new SupportCsatMetricService();
