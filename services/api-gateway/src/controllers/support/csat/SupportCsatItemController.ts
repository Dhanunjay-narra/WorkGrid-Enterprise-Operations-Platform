import { SupportCsatItemService } from "../../../../core-engine/src/support/csat/services/SupportCsatItemService";

export class SupportCsatItemController {
  private service = new SupportCsatItemService();
