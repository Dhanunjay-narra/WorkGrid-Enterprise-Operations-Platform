import { SupportCsatSummaryService } from "../../../../core-engine/src/support/csat/services/SupportCsatSummaryService";

export class SupportCsatSummaryController {
  private service = new SupportCsatSummaryService();
