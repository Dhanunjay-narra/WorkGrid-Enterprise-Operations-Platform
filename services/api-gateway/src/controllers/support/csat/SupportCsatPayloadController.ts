import { SupportCsatPayloadService } from "../../../../core-engine/src/support/csat/services/SupportCsatPayloadService";

export class SupportCsatPayloadController {
  private service = new SupportCsatPayloadService();
