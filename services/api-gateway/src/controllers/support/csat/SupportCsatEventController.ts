import { SupportCsatEventService } from "../../../../core-engine/src/support/csat/services/SupportCsatEventService";

export class SupportCsatEventController {
  private service = new SupportCsatEventService();
