import { SupportCsatScheduleService } from "../../../../core-engine/src/support/csat/services/SupportCsatScheduleService";

export class SupportCsatScheduleController {
  private service = new SupportCsatScheduleService();
