import { SupportCsatStateService } from "../../../../core-engine/src/support/csat/services/SupportCsatStateService";

export class SupportCsatStateController {
  private service = new SupportCsatStateService();
