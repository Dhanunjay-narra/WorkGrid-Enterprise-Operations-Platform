import { SupportCsatSnapshotService } from "../../../../core-engine/src/support/csat/services/SupportCsatSnapshotService";

export class SupportCsatSnapshotController {
  private service = new SupportCsatSnapshotService();
