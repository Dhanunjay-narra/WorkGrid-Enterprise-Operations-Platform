import { SupportCsatQueueService } from "../../../../core-engine/src/support/csat/services/SupportCsatQueueService";

export class SupportCsatQueueController {
  private service = new SupportCsatQueueService();
