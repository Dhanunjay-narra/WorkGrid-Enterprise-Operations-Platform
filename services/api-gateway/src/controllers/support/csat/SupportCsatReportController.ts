import { SupportCsatReportService } from "../../../../core-engine/src/support/csat/services/SupportCsatReportService";

export class SupportCsatReportController {
  private service = new SupportCsatReportService();
