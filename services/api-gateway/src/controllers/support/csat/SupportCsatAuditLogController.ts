import { SupportCsatAuditLogService } from "../../../../core-engine/src/support/csat/services/SupportCsatAuditLogService";

export class SupportCsatAuditLogController {
  private service = new SupportCsatAuditLogService();
