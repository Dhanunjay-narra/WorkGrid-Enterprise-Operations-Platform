import { SupportCsatConfigService } from "../../../../core-engine/src/support/csat/services/SupportCsatConfigService";

export class SupportCsatConfigController {
  private service = new SupportCsatConfigService();
