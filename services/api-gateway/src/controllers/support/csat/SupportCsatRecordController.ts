import { SupportCsatRecordService } from "../../../../core-engine/src/support/csat/services/SupportCsatRecordService";

export class SupportCsatRecordController {
  private service = new SupportCsatRecordService();
