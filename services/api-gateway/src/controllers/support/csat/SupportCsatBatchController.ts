import { SupportCsatBatchService } from "../../../../core-engine/src/support/csat/services/SupportCsatBatchService";

export class SupportCsatBatchController {
  private service = new SupportCsatBatchService();
