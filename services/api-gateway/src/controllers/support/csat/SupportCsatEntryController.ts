import { SupportCsatEntryService } from "../../../../core-engine/src/support/csat/services/SupportCsatEntryService";

export class SupportCsatEntryController {
  private service = new SupportCsatEntryService();
