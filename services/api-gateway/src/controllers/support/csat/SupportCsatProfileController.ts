import { SupportCsatProfileService } from "../../../../core-engine/src/support/csat/services/SupportCsatProfileService";

export class SupportCsatProfileController {
  private service = new SupportCsatProfileService();
