import { SupportCsatThresholdService } from "../../../../core-engine/src/support/csat/services/SupportCsatThresholdService";

export class SupportCsatThresholdController {
  private service = new SupportCsatThresholdService();
