import { SupportCsatNodeService } from "../../../../core-engine/src/support/csat/services/SupportCsatNodeService";

export class SupportCsatNodeController {
  private service = new SupportCsatNodeService();
