import { SupportCsatTaskService } from "../../../../core-engine/src/support/csat/services/SupportCsatTaskService";

export class SupportCsatTaskController {
  private service = new SupportCsatTaskService();
