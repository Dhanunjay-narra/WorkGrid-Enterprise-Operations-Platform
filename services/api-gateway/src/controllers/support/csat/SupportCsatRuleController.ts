import { SupportCsatRuleService } from "../../../../core-engine/src/support/csat/services/SupportCsatRuleService";

export class SupportCsatRuleController {
  private service = new SupportCsatRuleService();
