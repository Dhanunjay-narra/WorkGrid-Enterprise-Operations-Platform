import { SupportCsatSessionService } from "../../../../core-engine/src/support/csat/services/SupportCsatSessionService";

export class SupportCsatSessionController {
  private service = new SupportCsatSessionService();
