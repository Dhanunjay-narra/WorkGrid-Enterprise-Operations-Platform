import { SupportCsatMappingService } from "../../../../core-engine/src/support/csat/services/SupportCsatMappingService";

export class SupportCsatMappingController {
  private service = new SupportCsatMappingService();
