import { SupportQueuesSummaryService } from "../../../../core-engine/src/support/queues/services/SupportQueuesSummaryService";

export class SupportQueuesSummaryController {
  private service = new SupportQueuesSummaryService();
