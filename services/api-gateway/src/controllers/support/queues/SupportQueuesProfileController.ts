import { SupportQueuesProfileService } from "../../../../core-engine/src/support/queues/services/SupportQueuesProfileService";

export class SupportQueuesProfileController {
  private service = new SupportQueuesProfileService();
