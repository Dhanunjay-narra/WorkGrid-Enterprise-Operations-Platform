import { SupportQueuesTaskService } from "../../../../core-engine/src/support/queues/services/SupportQueuesTaskService";

export class SupportQueuesTaskController {
  private service = new SupportQueuesTaskService();
