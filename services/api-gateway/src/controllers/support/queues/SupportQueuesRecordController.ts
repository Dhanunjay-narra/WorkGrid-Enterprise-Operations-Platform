import { SupportQueuesRecordService } from "../../../../core-engine/src/support/queues/services/SupportQueuesRecordService";

export class SupportQueuesRecordController {
  private service = new SupportQueuesRecordService();
