import { SupportQueuesConfigService } from "../../../../core-engine/src/support/queues/services/SupportQueuesConfigService";

export class SupportQueuesConfigController {
  private service = new SupportQueuesConfigService();
