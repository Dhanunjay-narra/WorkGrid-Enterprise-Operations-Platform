import { SupportQueuesQueueService } from "../../../../core-engine/src/support/queues/services/SupportQueuesQueueService";

export class SupportQueuesQueueController {
  private service = new SupportQueuesQueueService();
