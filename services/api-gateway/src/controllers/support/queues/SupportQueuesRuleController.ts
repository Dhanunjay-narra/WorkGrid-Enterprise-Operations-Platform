import { SupportQueuesRuleService } from "../../../../core-engine/src/support/queues/services/SupportQueuesRuleService";

export class SupportQueuesRuleController {
  private service = new SupportQueuesRuleService();
