import { SupportQueuesPolicyService } from "../../../../core-engine/src/support/queues/services/SupportQueuesPolicyService";

export class SupportQueuesPolicyController {
  private service = new SupportQueuesPolicyService();
