import { SupportQueuesReportService } from "../../../../core-engine/src/support/queues/services/SupportQueuesReportService";

export class SupportQueuesReportController {
  private service = new SupportQueuesReportService();
