import { SupportQueuesEntryService } from "../../../../core-engine/src/support/queues/services/SupportQueuesEntryService";

export class SupportQueuesEntryController {
  private service = new SupportQueuesEntryService();
