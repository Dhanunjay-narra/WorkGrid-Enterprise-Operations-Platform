import { SupportQueuesMappingService } from "../../../../core-engine/src/support/queues/services/SupportQueuesMappingService";

export class SupportQueuesMappingController {
  private service = new SupportQueuesMappingService();
