import { SupportQueuesMetricService } from "../../../../core-engine/src/support/queues/services/SupportQueuesMetricService";

export class SupportQueuesMetricController {
  private service = new SupportQueuesMetricService();
