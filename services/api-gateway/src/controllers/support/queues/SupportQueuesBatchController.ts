import { SupportQueuesBatchService } from "../../../../core-engine/src/support/queues/services/SupportQueuesBatchService";

export class SupportQueuesBatchController {
  private service = new SupportQueuesBatchService();
