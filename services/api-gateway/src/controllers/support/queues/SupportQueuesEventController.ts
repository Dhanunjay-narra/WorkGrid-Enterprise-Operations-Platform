import { SupportQueuesEventService } from "../../../../core-engine/src/support/queues/services/SupportQueuesEventService";

export class SupportQueuesEventController {
  private service = new SupportQueuesEventService();
