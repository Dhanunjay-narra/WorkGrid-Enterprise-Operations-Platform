import { SupportQueuesItemService } from "../../../../core-engine/src/support/queues/services/SupportQueuesItemService";

export class SupportQueuesItemController {
  private service = new SupportQueuesItemService();
