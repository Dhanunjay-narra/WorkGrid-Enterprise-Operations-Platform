import { SupportQueuesSessionService } from "../../../../core-engine/src/support/queues/services/SupportQueuesSessionService";

export class SupportQueuesSessionController {
  private service = new SupportQueuesSessionService();
