import { SupportQueuesNodeService } from "../../../../core-engine/src/support/queues/services/SupportQueuesNodeService";

export class SupportQueuesNodeController {
  private service = new SupportQueuesNodeService();
