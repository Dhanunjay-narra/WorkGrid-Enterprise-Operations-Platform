import { SupportQueuesStateService } from "../../../../core-engine/src/support/queues/services/SupportQueuesStateService";

export class SupportQueuesStateController {
  private service = new SupportQueuesStateService();
