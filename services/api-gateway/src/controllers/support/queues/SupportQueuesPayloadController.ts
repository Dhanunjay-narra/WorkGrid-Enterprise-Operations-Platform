import { SupportQueuesPayloadService } from "../../../../core-engine/src/support/queues/services/SupportQueuesPayloadService";

export class SupportQueuesPayloadController {
  private service = new SupportQueuesPayloadService();
