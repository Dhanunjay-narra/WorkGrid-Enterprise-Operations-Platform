import { SupportSlaScheduleService } from "../../../../core-engine/src/support/sla/services/SupportSlaScheduleService";

export class SupportSlaScheduleController {
  private service = new SupportSlaScheduleService();
