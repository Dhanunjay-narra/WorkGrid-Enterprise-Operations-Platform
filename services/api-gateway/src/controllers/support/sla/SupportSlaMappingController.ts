import { SupportSlaMappingService } from "../../../../core-engine/src/support/sla/services/SupportSlaMappingService";

export class SupportSlaMappingController {
  private service = new SupportSlaMappingService();
