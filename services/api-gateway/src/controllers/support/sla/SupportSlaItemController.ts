import { SupportSlaItemService } from "../../../../core-engine/src/support/sla/services/SupportSlaItemService";

export class SupportSlaItemController {
  private service = new SupportSlaItemService();
