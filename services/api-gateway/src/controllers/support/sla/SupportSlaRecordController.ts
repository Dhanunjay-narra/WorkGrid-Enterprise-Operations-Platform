import { SupportSlaRecordService } from "../../../../core-engine/src/support/sla/services/SupportSlaRecordService";

export class SupportSlaRecordController {
  private service = new SupportSlaRecordService();
