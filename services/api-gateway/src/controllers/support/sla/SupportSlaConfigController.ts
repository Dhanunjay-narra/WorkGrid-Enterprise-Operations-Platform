import { SupportSlaConfigService } from "../../../../core-engine/src/support/sla/services/SupportSlaConfigService";

export class SupportSlaConfigController {
  private service = new SupportSlaConfigService();
