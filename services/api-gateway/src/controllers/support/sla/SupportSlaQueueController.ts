import { SupportSlaQueueService } from "../../../../core-engine/src/support/sla/services/SupportSlaQueueService";

export class SupportSlaQueueController {
  private service = new SupportSlaQueueService();
