import { SupportSlaBatchService } from "../../../../core-engine/src/support/sla/services/SupportSlaBatchService";

export class SupportSlaBatchController {
  private service = new SupportSlaBatchService();
