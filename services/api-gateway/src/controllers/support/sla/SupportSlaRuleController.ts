import { SupportSlaRuleService } from "../../../../core-engine/src/support/sla/services/SupportSlaRuleService";

export class SupportSlaRuleController {
  private service = new SupportSlaRuleService();
