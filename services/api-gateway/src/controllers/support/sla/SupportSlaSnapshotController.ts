import { SupportSlaSnapshotService } from "../../../../core-engine/src/support/sla/services/SupportSlaSnapshotService";

export class SupportSlaSnapshotController {
  private service = new SupportSlaSnapshotService();
