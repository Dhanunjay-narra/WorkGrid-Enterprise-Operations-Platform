import { SupportSlaProfileService } from "../../../../core-engine/src/support/sla/services/SupportSlaProfileService";

export class SupportSlaProfileController {
  private service = new SupportSlaProfileService();
