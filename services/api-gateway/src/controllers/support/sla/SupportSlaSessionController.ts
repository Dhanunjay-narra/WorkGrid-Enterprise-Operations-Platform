import { SupportSlaSessionService } from "../../../../core-engine/src/support/sla/services/SupportSlaSessionService";

export class SupportSlaSessionController {
  private service = new SupportSlaSessionService();
