import { SupportSlaStateService } from "../../../../core-engine/src/support/sla/services/SupportSlaStateService";

export class SupportSlaStateController {
  private service = new SupportSlaStateService();
