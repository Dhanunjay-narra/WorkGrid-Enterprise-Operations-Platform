import { SupportSlaAuditLogService } from "../../../../core-engine/src/support/sla/services/SupportSlaAuditLogService";

export class SupportSlaAuditLogController {
  private service = new SupportSlaAuditLogService();
