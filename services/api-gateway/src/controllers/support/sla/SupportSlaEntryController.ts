import { SupportSlaEntryService } from "../../../../core-engine/src/support/sla/services/SupportSlaEntryService";

export class SupportSlaEntryController {
  private service = new SupportSlaEntryService();
