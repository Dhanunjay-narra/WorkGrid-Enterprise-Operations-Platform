import { SupportSlaMetricService } from "../../../../core-engine/src/support/sla/services/SupportSlaMetricService";

export class SupportSlaMetricController {
  private service = new SupportSlaMetricService();
