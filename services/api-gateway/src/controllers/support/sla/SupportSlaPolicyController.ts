import { SupportSlaPolicyService } from "../../../../core-engine/src/support/sla/services/SupportSlaPolicyService";

export class SupportSlaPolicyController {
  private service = new SupportSlaPolicyService();
