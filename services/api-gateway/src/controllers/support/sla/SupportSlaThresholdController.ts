import { SupportSlaThresholdService } from "../../../../core-engine/src/support/sla/services/SupportSlaThresholdService";

export class SupportSlaThresholdController {
  private service = new SupportSlaThresholdService();
