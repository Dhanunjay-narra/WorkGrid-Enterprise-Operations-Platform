import { SupportSlaNodeService } from "../../../../core-engine/src/support/sla/services/SupportSlaNodeService";

export class SupportSlaNodeController {
  private service = new SupportSlaNodeService();
