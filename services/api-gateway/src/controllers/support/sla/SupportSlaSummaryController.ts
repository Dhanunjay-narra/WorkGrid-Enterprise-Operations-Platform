import { SupportSlaSummaryService } from "../../../../core-engine/src/support/sla/services/SupportSlaSummaryService";

export class SupportSlaSummaryController {
  private service = new SupportSlaSummaryService();
