import { SupportSlaPayloadService } from "../../../../core-engine/src/support/sla/services/SupportSlaPayloadService";

export class SupportSlaPayloadController {
  private service = new SupportSlaPayloadService();
