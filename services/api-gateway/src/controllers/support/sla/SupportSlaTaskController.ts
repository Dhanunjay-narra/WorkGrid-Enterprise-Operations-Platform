import { SupportSlaTaskService } from "../../../../core-engine/src/support/sla/services/SupportSlaTaskService";

export class SupportSlaTaskController {
  private service = new SupportSlaTaskService();
