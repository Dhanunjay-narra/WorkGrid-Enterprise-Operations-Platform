import { SupportSlaEventService } from "../../../../core-engine/src/support/sla/services/SupportSlaEventService";

export class SupportSlaEventController {
  private service = new SupportSlaEventService();
