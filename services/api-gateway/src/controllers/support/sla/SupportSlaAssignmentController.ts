import { SupportSlaAssignmentService } from "../../../../core-engine/src/support/sla/services/SupportSlaAssignmentService";

export class SupportSlaAssignmentController {
  private service = new SupportSlaAssignmentService();
