import { SupportSlaReportService } from "../../../../core-engine/src/support/sla/services/SupportSlaReportService";

export class SupportSlaReportController {
  private service = new SupportSlaReportService();
