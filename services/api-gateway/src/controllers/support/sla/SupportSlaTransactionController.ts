import { SupportSlaTransactionService } from "../../../../core-engine/src/support/sla/services/SupportSlaTransactionService";

export class SupportSlaTransactionController {
  private service = new SupportSlaTransactionService();
