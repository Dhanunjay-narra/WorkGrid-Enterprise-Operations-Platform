import { SupportEscalationRuleService } from "../../../../core-engine/src/support/escalation/services/SupportEscalationRuleService";

export class SupportEscalationRuleController {
  private service = new SupportEscalationRuleService();
