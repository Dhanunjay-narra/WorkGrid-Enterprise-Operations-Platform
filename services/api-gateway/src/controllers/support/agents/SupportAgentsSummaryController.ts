import { SupportAgentsSummaryService } from "../../../../core-engine/src/support/agents/services/SupportAgentsSummaryService";

export class SupportAgentsSummaryController {
  private service = new SupportAgentsSummaryService();
