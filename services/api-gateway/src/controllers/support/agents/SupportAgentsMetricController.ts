import { SupportAgentsMetricService } from "../../../../core-engine/src/support/agents/services/SupportAgentsMetricService";

export class SupportAgentsMetricController {
  private service = new SupportAgentsMetricService();
