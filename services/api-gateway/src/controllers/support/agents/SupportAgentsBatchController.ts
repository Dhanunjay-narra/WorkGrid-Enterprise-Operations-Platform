import { SupportAgentsBatchService } from "../../../../core-engine/src/support/agents/services/SupportAgentsBatchService";

export class SupportAgentsBatchController {
  private service = new SupportAgentsBatchService();
