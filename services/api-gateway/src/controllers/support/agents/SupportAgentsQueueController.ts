import { SupportAgentsQueueService } from "../../../../core-engine/src/support/agents/services/SupportAgentsQueueService";

export class SupportAgentsQueueController {
  private service = new SupportAgentsQueueService();
