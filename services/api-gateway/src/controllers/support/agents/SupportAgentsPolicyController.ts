import { SupportAgentsPolicyService } from "../../../../core-engine/src/support/agents/services/SupportAgentsPolicyService";

export class SupportAgentsPolicyController {
  private service = new SupportAgentsPolicyService();
