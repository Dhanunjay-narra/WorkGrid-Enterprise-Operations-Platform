import { SupportAgentsMappingService } from "../../../../core-engine/src/support/agents/services/SupportAgentsMappingService";

export class SupportAgentsMappingController {
  private service = new SupportAgentsMappingService();
