import { SupportAgentsReportService } from "../../../../core-engine/src/support/agents/services/SupportAgentsReportService";

export class SupportAgentsReportController {
  private service = new SupportAgentsReportService();
