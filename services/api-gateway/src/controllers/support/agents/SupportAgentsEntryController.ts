import { SupportAgentsEntryService } from "../../../../core-engine/src/support/agents/services/SupportAgentsEntryService";

export class SupportAgentsEntryController {
  private service = new SupportAgentsEntryService();
