import { SupportAgentsRecordService } from "../../../../core-engine/src/support/agents/services/SupportAgentsRecordService";

export class SupportAgentsRecordController {
  private service = new SupportAgentsRecordService();
