import { SupportAgentsSessionService } from "../../../../core-engine/src/support/agents/services/SupportAgentsSessionService";

export class SupportAgentsSessionController {
  private service = new SupportAgentsSessionService();
