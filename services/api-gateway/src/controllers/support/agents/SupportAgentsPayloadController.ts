import { SupportAgentsPayloadService } from "../../../../core-engine/src/support/agents/services/SupportAgentsPayloadService";

export class SupportAgentsPayloadController {
  private service = new SupportAgentsPayloadService();
