import { SupportAgentsNodeService } from "../../../../core-engine/src/support/agents/services/SupportAgentsNodeService";

export class SupportAgentsNodeController {
  private service = new SupportAgentsNodeService();
