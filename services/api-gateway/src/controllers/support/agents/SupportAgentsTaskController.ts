import { SupportAgentsTaskService } from "../../../../core-engine/src/support/agents/services/SupportAgentsTaskService";

export class SupportAgentsTaskController {
  private service = new SupportAgentsTaskService();
