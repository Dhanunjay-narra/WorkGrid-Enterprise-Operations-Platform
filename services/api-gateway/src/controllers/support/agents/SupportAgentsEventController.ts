import { SupportAgentsEventService } from "../../../../core-engine/src/support/agents/services/SupportAgentsEventService";

export class SupportAgentsEventController {
  private service = new SupportAgentsEventService();
