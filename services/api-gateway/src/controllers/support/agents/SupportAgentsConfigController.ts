import { SupportAgentsConfigService } from "../../../../core-engine/src/support/agents/services/SupportAgentsConfigService";

export class SupportAgentsConfigController {
  private service = new SupportAgentsConfigService();
