import { SupportAgentsItemService } from "../../../../core-engine/src/support/agents/services/SupportAgentsItemService";

export class SupportAgentsItemController {
  private service = new SupportAgentsItemService();
