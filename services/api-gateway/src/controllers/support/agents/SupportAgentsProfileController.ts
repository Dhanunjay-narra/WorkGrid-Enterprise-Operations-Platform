import { SupportAgentsProfileService } from "../../../../core-engine/src/support/agents/services/SupportAgentsProfileService";

export class SupportAgentsProfileController {
  private service = new SupportAgentsProfileService();
