import { SupportAgentsRuleService } from "../../../../core-engine/src/support/agents/services/SupportAgentsRuleService";

export class SupportAgentsRuleController {
  private service = new SupportAgentsRuleService();
