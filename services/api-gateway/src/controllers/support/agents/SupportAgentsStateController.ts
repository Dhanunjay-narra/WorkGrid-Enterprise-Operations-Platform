import { SupportAgentsStateService } from "../../../../core-engine/src/support/agents/services/SupportAgentsStateService";

export class SupportAgentsStateController {
  private service = new SupportAgentsStateService();
