import { SupportTicketsEventService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsEventService";

export class SupportTicketsEventController {
  private service = new SupportTicketsEventService();
