import { SupportTicketsBatchService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsBatchService";

export class SupportTicketsBatchController {
  private service = new SupportTicketsBatchService();
