import { SupportTicketsReportService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsReportService";

export class SupportTicketsReportController {
  private service = new SupportTicketsReportService();
