import { SupportTicketsPolicyService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsPolicyService";

export class SupportTicketsPolicyController {
  private service = new SupportTicketsPolicyService();
