import { SupportTicketsMetricService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsMetricService";

export class SupportTicketsMetricController {
  private service = new SupportTicketsMetricService();
