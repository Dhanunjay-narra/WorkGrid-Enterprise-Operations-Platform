import { SupportTicketsItemService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsItemService";

export class SupportTicketsItemController {
  private service = new SupportTicketsItemService();
