import { SupportTicketsRuleService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsRuleService";

export class SupportTicketsRuleController {
  private service = new SupportTicketsRuleService();
