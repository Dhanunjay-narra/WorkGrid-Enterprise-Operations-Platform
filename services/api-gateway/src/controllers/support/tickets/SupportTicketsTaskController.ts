import { SupportTicketsTaskService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsTaskService";

export class SupportTicketsTaskController {
  private service = new SupportTicketsTaskService();
