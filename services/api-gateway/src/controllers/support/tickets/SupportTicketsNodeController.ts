import { SupportTicketsNodeService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsNodeService";

export class SupportTicketsNodeController {
  private service = new SupportTicketsNodeService();
