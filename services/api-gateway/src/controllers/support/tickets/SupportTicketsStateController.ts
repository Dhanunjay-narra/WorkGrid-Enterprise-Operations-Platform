import { SupportTicketsStateService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsStateService";

export class SupportTicketsStateController {
  private service = new SupportTicketsStateService();
