import { SupportTicketsEntryService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsEntryService";

export class SupportTicketsEntryController {
  private service = new SupportTicketsEntryService();
