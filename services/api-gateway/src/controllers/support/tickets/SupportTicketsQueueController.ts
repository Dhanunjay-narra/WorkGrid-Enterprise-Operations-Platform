import { SupportTicketsQueueService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsQueueService";

export class SupportTicketsQueueController {
  private service = new SupportTicketsQueueService();
