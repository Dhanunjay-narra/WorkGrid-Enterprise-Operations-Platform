import { SupportTicketsConfigService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsConfigService";

export class SupportTicketsConfigController {
  private service = new SupportTicketsConfigService();
