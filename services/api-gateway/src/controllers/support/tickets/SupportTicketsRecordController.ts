import { SupportTicketsRecordService } from "../../../../core-engine/src/support/tickets/services/SupportTicketsRecordService";

export class SupportTicketsRecordController {
  private service = new SupportTicketsRecordService();
