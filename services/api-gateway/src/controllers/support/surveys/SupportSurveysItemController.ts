import { SupportSurveysItemService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysItemService";

export class SupportSurveysItemController {
  private service = new SupportSurveysItemService();
