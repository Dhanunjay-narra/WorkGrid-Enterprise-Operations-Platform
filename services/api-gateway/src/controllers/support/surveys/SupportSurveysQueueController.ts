import { SupportSurveysQueueService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysQueueService";

export class SupportSurveysQueueController {
  private service = new SupportSurveysQueueService();
