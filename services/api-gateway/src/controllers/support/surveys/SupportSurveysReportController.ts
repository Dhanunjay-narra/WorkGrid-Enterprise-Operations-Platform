import { SupportSurveysReportService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysReportService";

export class SupportSurveysReportController {
  private service = new SupportSurveysReportService();
