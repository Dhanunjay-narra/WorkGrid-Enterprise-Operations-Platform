import { SupportSurveysStateService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysStateService";

export class SupportSurveysStateController {
  private service = new SupportSurveysStateService();
