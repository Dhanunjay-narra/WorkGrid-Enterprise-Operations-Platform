import { SupportSurveysEntryService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysEntryService";

export class SupportSurveysEntryController {
  private service = new SupportSurveysEntryService();
