import { SupportSurveysBatchService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysBatchService";

export class SupportSurveysBatchController {
  private service = new SupportSurveysBatchService();
