import { SupportSurveysEventService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysEventService";

export class SupportSurveysEventController {
  private service = new SupportSurveysEventService();
