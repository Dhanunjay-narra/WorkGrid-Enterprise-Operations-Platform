import { SupportSurveysRecordService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysRecordService";

export class SupportSurveysRecordController {
  private service = new SupportSurveysRecordService();
