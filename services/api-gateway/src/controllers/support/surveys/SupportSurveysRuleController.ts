import { SupportSurveysRuleService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysRuleService";

export class SupportSurveysRuleController {
  private service = new SupportSurveysRuleService();
