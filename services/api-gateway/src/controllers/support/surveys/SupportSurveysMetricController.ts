import { SupportSurveysMetricService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysMetricService";

export class SupportSurveysMetricController {
  private service = new SupportSurveysMetricService();
