import { SupportSurveysConfigService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysConfigService";

export class SupportSurveysConfigController {
  private service = new SupportSurveysConfigService();
