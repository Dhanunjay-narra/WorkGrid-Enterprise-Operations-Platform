import { SupportSurveysNodeService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysNodeService";

export class SupportSurveysNodeController {
  private service = new SupportSurveysNodeService();
