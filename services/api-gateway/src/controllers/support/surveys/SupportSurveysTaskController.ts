import { SupportSurveysTaskService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysTaskService";

export class SupportSurveysTaskController {
  private service = new SupportSurveysTaskService();
