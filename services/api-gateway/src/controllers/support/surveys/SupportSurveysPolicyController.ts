import { SupportSurveysPolicyService } from "../../../../core-engine/src/support/surveys/services/SupportSurveysPolicyService";

export class SupportSurveysPolicyController {
  private service = new SupportSurveysPolicyService();
