import { TenancyAuditLogService } from "../../../../core-engine/src/tenancy/services/TenancyAuditLogService";

export class TenancyAuditLogController {
  private service = new TenancyAuditLogService();
