import { TenancySessionService } from "../../../../core-engine/src/tenancy/services/TenancySessionService";

export class TenancySessionController {
  private service = new TenancySessionService();
