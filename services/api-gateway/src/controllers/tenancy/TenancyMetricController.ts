import { TenancyMetricService } from "../../../../core-engine/src/tenancy/services/TenancyMetricService";

export class TenancyMetricController {
  private service = new TenancyMetricService();
