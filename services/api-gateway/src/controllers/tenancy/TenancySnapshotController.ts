import { TenancySnapshotService } from "../../../../core-engine/src/tenancy/services/TenancySnapshotService";

export class TenancySnapshotController {
  private service = new TenancySnapshotService();
