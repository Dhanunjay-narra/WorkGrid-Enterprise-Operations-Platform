import { TenancyPolicyService } from "../../../../core-engine/src/tenancy/services/TenancyPolicyService";

export class TenancyPolicyController {
  private service = new TenancyPolicyService();
