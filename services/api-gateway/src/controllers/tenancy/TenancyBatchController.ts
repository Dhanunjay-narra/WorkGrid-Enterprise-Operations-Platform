import { TenancyBatchService } from "../../../../core-engine/src/tenancy/services/TenancyBatchService";

export class TenancyBatchController {
  private service = new TenancyBatchService();
