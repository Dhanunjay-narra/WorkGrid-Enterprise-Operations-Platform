import { TenancyItemService } from "../../../../core-engine/src/tenancy/services/TenancyItemService";

export class TenancyItemController {
  private service = new TenancyItemService();
