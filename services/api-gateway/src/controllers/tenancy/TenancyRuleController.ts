import { TenancyRuleService } from "../../../../core-engine/src/tenancy/services/TenancyRuleService";

export class TenancyRuleController {
  private service = new TenancyRuleService();
