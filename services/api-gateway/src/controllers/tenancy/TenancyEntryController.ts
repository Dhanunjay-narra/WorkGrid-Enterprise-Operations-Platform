import { TenancyEntryService } from "../../../../core-engine/src/tenancy/services/TenancyEntryService";

export class TenancyEntryController {
  private service = new TenancyEntryService();
