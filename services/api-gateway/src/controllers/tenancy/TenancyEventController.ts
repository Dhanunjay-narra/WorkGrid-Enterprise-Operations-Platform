import { TenancyEventService } from "../../../../core-engine/src/tenancy/services/TenancyEventService";

export class TenancyEventController {
  private service = new TenancyEventService();
