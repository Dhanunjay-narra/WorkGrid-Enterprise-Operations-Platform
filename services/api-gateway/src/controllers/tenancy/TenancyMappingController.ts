import { TenancyMappingService } from "../../../../core-engine/src/tenancy/services/TenancyMappingService";

export class TenancyMappingController {
  private service = new TenancyMappingService();
