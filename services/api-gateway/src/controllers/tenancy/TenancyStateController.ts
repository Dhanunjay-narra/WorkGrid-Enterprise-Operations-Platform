import { TenancyStateService } from "../../../../core-engine/src/tenancy/services/TenancyStateService";

export class TenancyStateController {
  private service = new TenancyStateService();
