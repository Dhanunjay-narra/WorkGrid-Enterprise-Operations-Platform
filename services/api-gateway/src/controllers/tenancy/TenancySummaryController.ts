import { TenancySummaryService } from "../../../../core-engine/src/tenancy/services/TenancySummaryService";

export class TenancySummaryController {
  private service = new TenancySummaryService();
