import { TenancyRecordService } from "../../../../core-engine/src/tenancy/services/TenancyRecordService";

export class TenancyRecordController {
  private service = new TenancyRecordService();
