import { TenancyAssignmentService } from "../../../../core-engine/src/tenancy/services/TenancyAssignmentService";

export class TenancyAssignmentController {
  private service = new TenancyAssignmentService();
