import { TenancyReportService } from "../../../../core-engine/src/tenancy/services/TenancyReportService";

export class TenancyReportController {
  private service = new TenancyReportService();
