import { TenancyQueueService } from "../../../../core-engine/src/tenancy/services/TenancyQueueService";

export class TenancyQueueController {
  private service = new TenancyQueueService();
