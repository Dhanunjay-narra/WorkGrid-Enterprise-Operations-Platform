import { TenancyProfileService } from "../../../../core-engine/src/tenancy/services/TenancyProfileService";

export class TenancyProfileController {
  private service = new TenancyProfileService();
