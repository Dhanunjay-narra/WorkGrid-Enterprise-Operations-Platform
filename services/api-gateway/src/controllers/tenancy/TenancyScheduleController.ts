import { TenancyScheduleService } from "../../../../core-engine/src/tenancy/services/TenancyScheduleService";

export class TenancyScheduleController {
  private service = new TenancyScheduleService();
