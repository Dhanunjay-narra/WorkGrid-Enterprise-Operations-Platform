import { TenancyPayloadService } from "../../../../core-engine/src/tenancy/services/TenancyPayloadService";

export class TenancyPayloadController {
  private service = new TenancyPayloadService();
