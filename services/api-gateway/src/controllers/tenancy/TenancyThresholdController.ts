import { TenancyThresholdService } from "../../../../core-engine/src/tenancy/services/TenancyThresholdService";

export class TenancyThresholdController {
  private service = new TenancyThresholdService();
