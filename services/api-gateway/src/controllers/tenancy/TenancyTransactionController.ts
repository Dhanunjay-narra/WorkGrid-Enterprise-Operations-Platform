import { TenancyTransactionService } from "../../../../core-engine/src/tenancy/services/TenancyTransactionService";

export class TenancyTransactionController {
  private service = new TenancyTransactionService();
