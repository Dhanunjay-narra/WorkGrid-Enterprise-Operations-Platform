import { TenancyTaskService } from "../../../../core-engine/src/tenancy/services/TenancyTaskService";

export class TenancyTaskController {
  private service = new TenancyTaskService();
