import { TenancyNodeService } from "../../../../core-engine/src/tenancy/services/TenancyNodeService";

export class TenancyNodeController {
  private service = new TenancyNodeService();
