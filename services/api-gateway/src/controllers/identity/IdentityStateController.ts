import { IdentityStateService } from "../../../../core-engine/src/identity/services/IdentityStateService";

export class IdentityStateController {
  private service = new IdentityStateService();
