import { IdentityTaskService } from "../../../../core-engine/src/identity/services/IdentityTaskService";

export class IdentityTaskController {
  private service = new IdentityTaskService();
