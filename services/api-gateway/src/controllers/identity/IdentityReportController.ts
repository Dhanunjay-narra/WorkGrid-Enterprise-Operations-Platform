import { IdentityReportService } from "../../../../core-engine/src/identity/services/IdentityReportService";

export class IdentityReportController {
  private service = new IdentityReportService();
