import { IdentityNodeService } from "../../../../core-engine/src/identity/services/IdentityNodeService";

export class IdentityNodeController {
  private service = new IdentityNodeService();
