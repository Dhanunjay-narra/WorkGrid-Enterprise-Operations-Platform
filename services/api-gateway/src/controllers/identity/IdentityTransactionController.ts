import { IdentityTransactionService } from "../../../../core-engine/src/identity/services/IdentityTransactionService";

export class IdentityTransactionController {
  private service = new IdentityTransactionService();
