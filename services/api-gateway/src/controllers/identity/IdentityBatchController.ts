import { IdentityBatchService } from "../../../../core-engine/src/identity/services/IdentityBatchService";

export class IdentityBatchController {
  private service = new IdentityBatchService();
