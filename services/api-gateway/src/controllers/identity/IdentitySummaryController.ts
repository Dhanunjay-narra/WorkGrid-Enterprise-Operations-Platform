import { IdentitySummaryService } from "../../../../core-engine/src/identity/services/IdentitySummaryService";

export class IdentitySummaryController {
  private service = new IdentitySummaryService();
