import { IdentityItemService } from "../../../../core-engine/src/identity/services/IdentityItemService";

export class IdentityItemController {
  private service = new IdentityItemService();
