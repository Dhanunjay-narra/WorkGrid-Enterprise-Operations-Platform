import { IdentityAuditLogService } from "../../../../core-engine/src/identity/services/IdentityAuditLogService";

export class IdentityAuditLogController {
  private service = new IdentityAuditLogService();
