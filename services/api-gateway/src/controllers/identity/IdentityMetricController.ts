import { IdentityMetricService } from "../../../../core-engine/src/identity/services/IdentityMetricService";

export class IdentityMetricController {
  private service = new IdentityMetricService();
