import { IdentityEntryService } from "../../../../core-engine/src/identity/services/IdentityEntryService";

export class IdentityEntryController {
  private service = new IdentityEntryService();
