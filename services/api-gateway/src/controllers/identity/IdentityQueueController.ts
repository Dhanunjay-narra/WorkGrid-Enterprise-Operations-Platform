import { IdentityQueueService } from "../../../../core-engine/src/identity/services/IdentityQueueService";

export class IdentityQueueController {
  private service = new IdentityQueueService();
