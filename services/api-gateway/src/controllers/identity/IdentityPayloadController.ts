import { IdentityPayloadService } from "../../../../core-engine/src/identity/services/IdentityPayloadService";

export class IdentityPayloadController {
  private service = new IdentityPayloadService();
