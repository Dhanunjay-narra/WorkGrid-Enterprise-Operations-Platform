import { IdentityThresholdService } from "../../../../core-engine/src/identity/services/IdentityThresholdService";

export class IdentityThresholdController {
  private service = new IdentityThresholdService();
