import { IdentityAssignmentService } from "../../../../core-engine/src/identity/services/IdentityAssignmentService";

export class IdentityAssignmentController {
  private service = new IdentityAssignmentService();
