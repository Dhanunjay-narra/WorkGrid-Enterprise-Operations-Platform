import { IdentityScheduleService } from "../../../../core-engine/src/identity/services/IdentityScheduleService";

export class IdentityScheduleController {
  private service = new IdentityScheduleService();
