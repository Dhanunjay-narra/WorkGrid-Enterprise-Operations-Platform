import { AbacScheduleService } from "../../../../core-engine/src/abac/services/AbacScheduleService";

export class AbacScheduleController {
  private service = new AbacScheduleService();
