import { AbacSessionService } from "../../../../core-engine/src/abac/services/AbacSessionService";

export class AbacSessionController {
  private service = new AbacSessionService();
