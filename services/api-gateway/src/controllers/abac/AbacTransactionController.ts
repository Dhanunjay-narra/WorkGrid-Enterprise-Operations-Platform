import { AbacTransactionService } from "../../../../core-engine/src/abac/services/AbacTransactionService";

export class AbacTransactionController {
  private service = new AbacTransactionService();
