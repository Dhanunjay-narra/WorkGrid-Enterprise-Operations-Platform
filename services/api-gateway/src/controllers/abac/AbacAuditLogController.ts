import { AbacAuditLogService } from "../../../../core-engine/src/abac/services/AbacAuditLogService";

export class AbacAuditLogController {
  private service = new AbacAuditLogService();
