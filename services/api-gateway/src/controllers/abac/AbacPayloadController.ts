import { AbacPayloadService } from "../../../../core-engine/src/abac/services/AbacPayloadService";

export class AbacPayloadController {
  private service = new AbacPayloadService();
