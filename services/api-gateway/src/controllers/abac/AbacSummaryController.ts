import { AbacSummaryService } from "../../../../core-engine/src/abac/services/AbacSummaryService";

export class AbacSummaryController {
  private service = new AbacSummaryService();
