import { AbacProfileService } from "../../../../core-engine/src/abac/services/AbacProfileService";

export class AbacProfileController {
  private service = new AbacProfileService();
