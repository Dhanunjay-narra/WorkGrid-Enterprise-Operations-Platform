import { AbacSnapshotService } from "../../../../core-engine/src/abac/services/AbacSnapshotService";

export class AbacSnapshotController {
  private service = new AbacSnapshotService();
