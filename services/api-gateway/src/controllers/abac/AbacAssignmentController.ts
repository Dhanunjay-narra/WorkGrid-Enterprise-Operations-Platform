import { AbacAssignmentService } from "../../../../core-engine/src/abac/services/AbacAssignmentService";

export class AbacAssignmentController {
  private service = new AbacAssignmentService();
