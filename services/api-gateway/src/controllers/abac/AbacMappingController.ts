import { AbacMappingService } from "../../../../core-engine/src/abac/services/AbacMappingService";

export class AbacMappingController {
  private service = new AbacMappingService();
