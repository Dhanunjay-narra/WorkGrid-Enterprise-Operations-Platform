import { AbacThresholdService } from "../../../../core-engine/src/abac/services/AbacThresholdService";

export class AbacThresholdController {
  private service = new AbacThresholdService();
