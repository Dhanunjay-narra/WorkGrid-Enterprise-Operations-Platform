import { IotTelemetryProfileService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryProfileService";

export class IotTelemetryProfileController {
  private service = new IotTelemetryProfileService();
