import { IotTelemetryStateService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryStateService";

export class IotTelemetryStateController {
  private service = new IotTelemetryStateService();
