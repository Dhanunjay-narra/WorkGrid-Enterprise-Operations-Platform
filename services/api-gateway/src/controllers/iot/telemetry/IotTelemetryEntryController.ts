import { IotTelemetryEntryService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryEntryService";

export class IotTelemetryEntryController {
  private service = new IotTelemetryEntryService();
