import { IotTelemetrySessionService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetrySessionService";

export class IotTelemetrySessionController {
  private service = new IotTelemetrySessionService();
