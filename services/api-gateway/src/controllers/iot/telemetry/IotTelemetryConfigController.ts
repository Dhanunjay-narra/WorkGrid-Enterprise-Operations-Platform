import { IotTelemetryConfigService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryConfigService";

export class IotTelemetryConfigController {
  private service = new IotTelemetryConfigService();
