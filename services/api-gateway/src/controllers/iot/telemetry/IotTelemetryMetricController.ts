import { IotTelemetryMetricService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryMetricService";

export class IotTelemetryMetricController {
  private service = new IotTelemetryMetricService();
