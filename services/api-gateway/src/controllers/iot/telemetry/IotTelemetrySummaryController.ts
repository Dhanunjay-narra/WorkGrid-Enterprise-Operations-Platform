import { IotTelemetrySummaryService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetrySummaryService";

export class IotTelemetrySummaryController {
  private service = new IotTelemetrySummaryService();
