import { IotTelemetryRecordService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryRecordService";

export class IotTelemetryRecordController {
  private service = new IotTelemetryRecordService();
