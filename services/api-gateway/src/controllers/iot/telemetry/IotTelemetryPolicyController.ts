import { IotTelemetryPolicyService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryPolicyService";

export class IotTelemetryPolicyController {
  private service = new IotTelemetryPolicyService();
