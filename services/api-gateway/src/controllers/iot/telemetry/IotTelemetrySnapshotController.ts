import { IotTelemetrySnapshotService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetrySnapshotService";

export class IotTelemetrySnapshotController {
  private service = new IotTelemetrySnapshotService();
