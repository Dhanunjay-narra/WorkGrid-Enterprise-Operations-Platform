import { IotTelemetryPayloadService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryPayloadService";

export class IotTelemetryPayloadController {
  private service = new IotTelemetryPayloadService();
