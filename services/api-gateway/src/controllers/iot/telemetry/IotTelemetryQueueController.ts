import { IotTelemetryQueueService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryQueueService";

export class IotTelemetryQueueController {
  private service = new IotTelemetryQueueService();
