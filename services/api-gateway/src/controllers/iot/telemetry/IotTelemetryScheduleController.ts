import { IotTelemetryScheduleService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryScheduleService";

export class IotTelemetryScheduleController {
  private service = new IotTelemetryScheduleService();
