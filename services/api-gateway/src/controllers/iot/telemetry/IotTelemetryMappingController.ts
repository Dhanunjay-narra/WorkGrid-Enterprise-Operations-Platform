import { IotTelemetryMappingService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryMappingService";

export class IotTelemetryMappingController {
  private service = new IotTelemetryMappingService();
