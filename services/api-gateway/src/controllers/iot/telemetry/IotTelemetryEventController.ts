import { IotTelemetryEventService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryEventService";

export class IotTelemetryEventController {
  private service = new IotTelemetryEventService();
