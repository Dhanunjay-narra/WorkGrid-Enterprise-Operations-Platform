import { IotTelemetryItemService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryItemService";

export class IotTelemetryItemController {
  private service = new IotTelemetryItemService();
