import { IotTelemetryAuditLogService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryAuditLogService";

export class IotTelemetryAuditLogController {
  private service = new IotTelemetryAuditLogService();
