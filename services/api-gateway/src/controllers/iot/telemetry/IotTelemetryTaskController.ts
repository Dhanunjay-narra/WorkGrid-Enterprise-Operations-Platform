import { IotTelemetryTaskService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryTaskService";

export class IotTelemetryTaskController {
  private service = new IotTelemetryTaskService();
