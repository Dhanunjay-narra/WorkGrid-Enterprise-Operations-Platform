import { IotTelemetryRuleService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryRuleService";

export class IotTelemetryRuleController {
  private service = new IotTelemetryRuleService();
