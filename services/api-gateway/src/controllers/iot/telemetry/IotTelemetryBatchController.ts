import { IotTelemetryBatchService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryBatchService";

export class IotTelemetryBatchController {
  private service = new IotTelemetryBatchService();
