import { IotTelemetryNodeService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryNodeService";

export class IotTelemetryNodeController {
  private service = new IotTelemetryNodeService();
