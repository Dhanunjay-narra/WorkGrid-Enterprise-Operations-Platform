import { IotTelemetryReportService } from "../../../../core-engine/src/iot/telemetry/services/IotTelemetryReportService";

export class IotTelemetryReportController {
  private service = new IotTelemetryReportService();
