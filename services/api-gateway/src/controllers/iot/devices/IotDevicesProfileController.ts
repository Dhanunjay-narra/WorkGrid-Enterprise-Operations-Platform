import { IotDevicesProfileService } from "../../../../core-engine/src/iot/devices/services/IotDevicesProfileService";

export class IotDevicesProfileController {
  private service = new IotDevicesProfileService();
