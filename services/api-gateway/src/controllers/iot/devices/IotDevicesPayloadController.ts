import { IotDevicesPayloadService } from "../../../../core-engine/src/iot/devices/services/IotDevicesPayloadService";

export class IotDevicesPayloadController {
  private service = new IotDevicesPayloadService();
