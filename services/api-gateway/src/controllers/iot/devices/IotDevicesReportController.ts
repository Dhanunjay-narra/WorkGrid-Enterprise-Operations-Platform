import { IotDevicesReportService } from "../../../../core-engine/src/iot/devices/services/IotDevicesReportService";

export class IotDevicesReportController {
  private service = new IotDevicesReportService();
