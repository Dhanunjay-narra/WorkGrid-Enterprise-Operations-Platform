import { IotDevicesEventService } from "../../../../core-engine/src/iot/devices/services/IotDevicesEventService";

export class IotDevicesEventController {
  private service = new IotDevicesEventService();
