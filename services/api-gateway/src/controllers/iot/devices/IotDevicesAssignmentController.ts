import { IotDevicesAssignmentService } from "../../../../core-engine/src/iot/devices/services/IotDevicesAssignmentService";

export class IotDevicesAssignmentController {
  private service = new IotDevicesAssignmentService();
