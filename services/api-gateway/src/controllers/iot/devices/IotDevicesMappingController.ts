import { IotDevicesMappingService } from "../../../../core-engine/src/iot/devices/services/IotDevicesMappingService";

export class IotDevicesMappingController {
  private service = new IotDevicesMappingService();
