import { IotDevicesThresholdService } from "../../../../core-engine/src/iot/devices/services/IotDevicesThresholdService";

export class IotDevicesThresholdController {
  private service = new IotDevicesThresholdService();
