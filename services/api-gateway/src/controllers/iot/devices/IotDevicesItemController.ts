import { IotDevicesItemService } from "../../../../core-engine/src/iot/devices/services/IotDevicesItemService";

export class IotDevicesItemController {
  private service = new IotDevicesItemService();
