import { IotDevicesPolicyService } from "../../../../core-engine/src/iot/devices/services/IotDevicesPolicyService";

export class IotDevicesPolicyController {
  private service = new IotDevicesPolicyService();
