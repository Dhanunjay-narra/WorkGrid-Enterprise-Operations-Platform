import { IotDevicesRecordService } from "../../../../core-engine/src/iot/devices/services/IotDevicesRecordService";

export class IotDevicesRecordController {
  private service = new IotDevicesRecordService();
