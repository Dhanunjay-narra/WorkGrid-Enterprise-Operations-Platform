import { IotDevicesMetricService } from "../../../../core-engine/src/iot/devices/services/IotDevicesMetricService";

export class IotDevicesMetricController {
  private service = new IotDevicesMetricService();
