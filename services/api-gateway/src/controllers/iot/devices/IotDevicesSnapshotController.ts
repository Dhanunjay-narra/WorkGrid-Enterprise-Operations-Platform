import { IotDevicesSnapshotService } from "../../../../core-engine/src/iot/devices/services/IotDevicesSnapshotService";

export class IotDevicesSnapshotController {
  private service = new IotDevicesSnapshotService();
