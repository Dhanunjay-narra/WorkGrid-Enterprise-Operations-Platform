import { IotDevicesNodeService } from "../../../../core-engine/src/iot/devices/services/IotDevicesNodeService";

export class IotDevicesNodeController {
  private service = new IotDevicesNodeService();
