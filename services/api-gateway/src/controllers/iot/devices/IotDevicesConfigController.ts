import { IotDevicesConfigService } from "../../../../core-engine/src/iot/devices/services/IotDevicesConfigService";

export class IotDevicesConfigController {
  private service = new IotDevicesConfigService();
