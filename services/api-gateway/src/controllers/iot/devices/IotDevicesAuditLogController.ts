import { IotDevicesAuditLogService } from "../../../../core-engine/src/iot/devices/services/IotDevicesAuditLogService";

export class IotDevicesAuditLogController {
  private service = new IotDevicesAuditLogService();
