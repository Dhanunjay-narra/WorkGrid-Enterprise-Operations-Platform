import { IotDevicesTaskService } from "../../../../core-engine/src/iot/devices/services/IotDevicesTaskService";

export class IotDevicesTaskController {
  private service = new IotDevicesTaskService();
