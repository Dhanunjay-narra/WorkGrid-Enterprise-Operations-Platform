import { IotDevicesSessionService } from "../../../../core-engine/src/iot/devices/services/IotDevicesSessionService";

export class IotDevicesSessionController {
  private service = new IotDevicesSessionService();
