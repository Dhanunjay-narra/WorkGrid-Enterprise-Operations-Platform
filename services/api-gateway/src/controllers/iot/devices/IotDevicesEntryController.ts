import { IotDevicesEntryService } from "../../../../core-engine/src/iot/devices/services/IotDevicesEntryService";

export class IotDevicesEntryController {
  private service = new IotDevicesEntryService();
