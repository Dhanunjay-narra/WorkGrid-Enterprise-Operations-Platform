import { IotDevicesSummaryService } from "../../../../core-engine/src/iot/devices/services/IotDevicesSummaryService";

export class IotDevicesSummaryController {
  private service = new IotDevicesSummaryService();
