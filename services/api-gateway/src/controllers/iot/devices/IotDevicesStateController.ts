import { IotDevicesStateService } from "../../../../core-engine/src/iot/devices/services/IotDevicesStateService";

export class IotDevicesStateController {
  private service = new IotDevicesStateService();
