import { IotDevicesTransactionService } from "../../../../core-engine/src/iot/devices/services/IotDevicesTransactionService";

export class IotDevicesTransactionController {
  private service = new IotDevicesTransactionService();
