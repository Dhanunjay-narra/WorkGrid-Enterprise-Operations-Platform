import { IotDevicesScheduleService } from "../../../../core-engine/src/iot/devices/services/IotDevicesScheduleService";

export class IotDevicesScheduleController {
  private service = new IotDevicesScheduleService();
