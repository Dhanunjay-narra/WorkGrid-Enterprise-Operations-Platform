import { IotDevicesRuleService } from "../../../../core-engine/src/iot/devices/services/IotDevicesRuleService";

export class IotDevicesRuleController {
  private service = new IotDevicesRuleService();
