import { IotDevicesBatchService } from "../../../../core-engine/src/iot/devices/services/IotDevicesBatchService";

export class IotDevicesBatchController {
  private service = new IotDevicesBatchService();
