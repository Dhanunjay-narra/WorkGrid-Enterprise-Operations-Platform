import { IotDevicesQueueService } from "../../../../core-engine/src/iot/devices/services/IotDevicesQueueService";

export class IotDevicesQueueController {
  private service = new IotDevicesQueueService();
