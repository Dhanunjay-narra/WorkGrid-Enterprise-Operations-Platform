import { IotFirmwareScheduleService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareScheduleService";

export class IotFirmwareScheduleController {
  private service = new IotFirmwareScheduleService();
