import { IotFirmwareRuleService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareRuleService";

export class IotFirmwareRuleController {
  private service = new IotFirmwareRuleService();
