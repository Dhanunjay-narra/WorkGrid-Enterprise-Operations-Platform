import { IotFirmwareReportService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareReportService";

export class IotFirmwareReportController {
  private service = new IotFirmwareReportService();
