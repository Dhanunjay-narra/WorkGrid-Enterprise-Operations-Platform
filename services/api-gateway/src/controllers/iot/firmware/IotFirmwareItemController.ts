import { IotFirmwareItemService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareItemService";

export class IotFirmwareItemController {
  private service = new IotFirmwareItemService();
