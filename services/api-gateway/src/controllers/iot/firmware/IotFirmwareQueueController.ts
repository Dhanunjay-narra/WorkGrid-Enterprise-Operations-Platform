import { IotFirmwareQueueService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareQueueService";

export class IotFirmwareQueueController {
  private service = new IotFirmwareQueueService();
