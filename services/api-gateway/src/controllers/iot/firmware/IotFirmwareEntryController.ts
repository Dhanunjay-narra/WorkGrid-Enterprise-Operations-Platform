import { IotFirmwareEntryService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareEntryService";

export class IotFirmwareEntryController {
  private service = new IotFirmwareEntryService();
