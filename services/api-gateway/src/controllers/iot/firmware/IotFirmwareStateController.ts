import { IotFirmwareStateService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareStateService";

export class IotFirmwareStateController {
  private service = new IotFirmwareStateService();
