import { IotFirmwareProfileService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareProfileService";

export class IotFirmwareProfileController {
  private service = new IotFirmwareProfileService();
