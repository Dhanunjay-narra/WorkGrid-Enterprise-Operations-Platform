import { IotFirmwareBatchService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareBatchService";

export class IotFirmwareBatchController {
  private service = new IotFirmwareBatchService();
