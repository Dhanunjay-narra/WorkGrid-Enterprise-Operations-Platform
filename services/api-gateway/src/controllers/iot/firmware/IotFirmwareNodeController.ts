import { IotFirmwareNodeService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareNodeService";

export class IotFirmwareNodeController {
  private service = new IotFirmwareNodeService();
