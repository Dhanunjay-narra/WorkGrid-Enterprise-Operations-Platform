import { IotFirmwareEventService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareEventService";

export class IotFirmwareEventController {
  private service = new IotFirmwareEventService();
