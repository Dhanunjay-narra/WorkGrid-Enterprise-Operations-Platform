import { IotFirmwareThresholdService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareThresholdService";

export class IotFirmwareThresholdController {
  private service = new IotFirmwareThresholdService();
