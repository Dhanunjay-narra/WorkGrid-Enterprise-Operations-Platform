import { IotFirmwareSnapshotService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareSnapshotService";

export class IotFirmwareSnapshotController {
  private service = new IotFirmwareSnapshotService();
