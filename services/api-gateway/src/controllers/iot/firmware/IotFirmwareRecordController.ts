import { IotFirmwareRecordService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareRecordService";

export class IotFirmwareRecordController {
  private service = new IotFirmwareRecordService();
