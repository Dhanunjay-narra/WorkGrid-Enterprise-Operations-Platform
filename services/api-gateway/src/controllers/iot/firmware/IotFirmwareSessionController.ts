import { IotFirmwareSessionService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareSessionService";

export class IotFirmwareSessionController {
  private service = new IotFirmwareSessionService();
