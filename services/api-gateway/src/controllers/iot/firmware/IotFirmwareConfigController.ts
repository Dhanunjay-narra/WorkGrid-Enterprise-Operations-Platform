import { IotFirmwareConfigService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareConfigService";

export class IotFirmwareConfigController {
  private service = new IotFirmwareConfigService();
