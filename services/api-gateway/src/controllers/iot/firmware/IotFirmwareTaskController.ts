import { IotFirmwareTaskService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareTaskService";

export class IotFirmwareTaskController {
  private service = new IotFirmwareTaskService();
