import { IotFirmwareAuditLogService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareAuditLogService";

export class IotFirmwareAuditLogController {
  private service = new IotFirmwareAuditLogService();
