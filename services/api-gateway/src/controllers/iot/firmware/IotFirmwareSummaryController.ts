import { IotFirmwareSummaryService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareSummaryService";

export class IotFirmwareSummaryController {
  private service = new IotFirmwareSummaryService();
