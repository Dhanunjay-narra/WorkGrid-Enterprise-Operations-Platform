import { IotFirmwarePolicyService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwarePolicyService";

export class IotFirmwarePolicyController {
  private service = new IotFirmwarePolicyService();
