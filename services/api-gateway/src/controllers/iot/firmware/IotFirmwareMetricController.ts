import { IotFirmwareMetricService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareMetricService";

export class IotFirmwareMetricController {
  private service = new IotFirmwareMetricService();
