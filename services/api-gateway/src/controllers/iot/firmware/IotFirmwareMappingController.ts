import { IotFirmwareMappingService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwareMappingService";

export class IotFirmwareMappingController {
  private service = new IotFirmwareMappingService();
