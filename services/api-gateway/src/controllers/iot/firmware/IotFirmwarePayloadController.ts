import { IotFirmwarePayloadService } from "../../../../core-engine/src/iot/firmware/services/IotFirmwarePayloadService";

export class IotFirmwarePayloadController {
  private service = new IotFirmwarePayloadService();
