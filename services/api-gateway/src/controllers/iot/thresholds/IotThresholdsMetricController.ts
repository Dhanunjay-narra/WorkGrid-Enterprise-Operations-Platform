import { IotThresholdsMetricService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsMetricService";

export class IotThresholdsMetricController {
  private service = new IotThresholdsMetricService();
