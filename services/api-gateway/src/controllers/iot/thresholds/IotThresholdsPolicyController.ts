import { IotThresholdsPolicyService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsPolicyService";

export class IotThresholdsPolicyController {
  private service = new IotThresholdsPolicyService();
