import { IotThresholdsRuleService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsRuleService";

export class IotThresholdsRuleController {
  private service = new IotThresholdsRuleService();
