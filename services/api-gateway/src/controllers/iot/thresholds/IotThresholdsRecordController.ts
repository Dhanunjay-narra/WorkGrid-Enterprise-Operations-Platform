import { IotThresholdsRecordService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsRecordService";

export class IotThresholdsRecordController {
  private service = new IotThresholdsRecordService();
