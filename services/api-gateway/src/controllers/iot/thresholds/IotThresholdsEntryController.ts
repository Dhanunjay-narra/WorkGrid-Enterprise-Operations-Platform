import { IotThresholdsEntryService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsEntryService";

export class IotThresholdsEntryController {
  private service = new IotThresholdsEntryService();
