import { IotThresholdsNodeService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsNodeService";

export class IotThresholdsNodeController {
  private service = new IotThresholdsNodeService();
