import { IotThresholdsQueueService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsQueueService";

export class IotThresholdsQueueController {
  private service = new IotThresholdsQueueService();
