import { IotThresholdsSummaryService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsSummaryService";

export class IotThresholdsSummaryController {
  private service = new IotThresholdsSummaryService();
