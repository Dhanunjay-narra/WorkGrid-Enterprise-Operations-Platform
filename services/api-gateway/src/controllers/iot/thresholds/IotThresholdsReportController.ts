import { IotThresholdsReportService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsReportService";

export class IotThresholdsReportController {
  private service = new IotThresholdsReportService();
