import { IotThresholdsItemService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsItemService";

export class IotThresholdsItemController {
  private service = new IotThresholdsItemService();
