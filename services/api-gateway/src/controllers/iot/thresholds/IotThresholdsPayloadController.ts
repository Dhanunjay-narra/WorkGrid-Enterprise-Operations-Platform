import { IotThresholdsPayloadService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsPayloadService";

export class IotThresholdsPayloadController {
  private service = new IotThresholdsPayloadService();
