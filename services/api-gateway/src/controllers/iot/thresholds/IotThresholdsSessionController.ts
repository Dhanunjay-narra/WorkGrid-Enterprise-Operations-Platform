import { IotThresholdsSessionService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsSessionService";

export class IotThresholdsSessionController {
  private service = new IotThresholdsSessionService();
