import { IotThresholdsMappingService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsMappingService";

export class IotThresholdsMappingController {
  private service = new IotThresholdsMappingService();
