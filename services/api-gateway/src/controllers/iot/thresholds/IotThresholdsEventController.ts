import { IotThresholdsEventService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsEventService";

export class IotThresholdsEventController {
  private service = new IotThresholdsEventService();
