import { IotThresholdsConfigService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsConfigService";

export class IotThresholdsConfigController {
  private service = new IotThresholdsConfigService();
