import { IotThresholdsProfileService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsProfileService";

export class IotThresholdsProfileController {
  private service = new IotThresholdsProfileService();
