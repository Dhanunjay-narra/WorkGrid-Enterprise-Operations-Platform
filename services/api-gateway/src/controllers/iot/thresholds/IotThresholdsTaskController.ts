import { IotThresholdsTaskService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsTaskService";

export class IotThresholdsTaskController {
  private service = new IotThresholdsTaskService();
