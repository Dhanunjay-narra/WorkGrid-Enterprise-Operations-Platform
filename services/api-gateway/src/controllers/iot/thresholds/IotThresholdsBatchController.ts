import { IotThresholdsBatchService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsBatchService";

export class IotThresholdsBatchController {
  private service = new IotThresholdsBatchService();
