import { IotThresholdsStateService } from "../../../../core-engine/src/iot/thresholds/services/IotThresholdsStateService";

export class IotThresholdsStateController {
  private service = new IotThresholdsStateService();
