import { IotLocationsReportService } from "../../../../core-engine/src/iot/locations/services/IotLocationsReportService";

export class IotLocationsReportController {
  private service = new IotLocationsReportService();
