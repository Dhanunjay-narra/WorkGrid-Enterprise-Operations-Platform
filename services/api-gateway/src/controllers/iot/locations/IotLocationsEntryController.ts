import { IotLocationsEntryService } from "../../../../core-engine/src/iot/locations/services/IotLocationsEntryService";

export class IotLocationsEntryController {
  private service = new IotLocationsEntryService();
