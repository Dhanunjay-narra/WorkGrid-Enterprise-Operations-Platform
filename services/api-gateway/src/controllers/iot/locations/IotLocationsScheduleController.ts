import { IotLocationsScheduleService } from "../../../../core-engine/src/iot/locations/services/IotLocationsScheduleService";

export class IotLocationsScheduleController {
  private service = new IotLocationsScheduleService();
