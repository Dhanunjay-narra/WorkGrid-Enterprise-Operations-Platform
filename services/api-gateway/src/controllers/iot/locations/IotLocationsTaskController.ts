import { IotLocationsTaskService } from "../../../../core-engine/src/iot/locations/services/IotLocationsTaskService";

export class IotLocationsTaskController {
  private service = new IotLocationsTaskService();
