import { IotLocationsProfileService } from "../../../../core-engine/src/iot/locations/services/IotLocationsProfileService";

export class IotLocationsProfileController {
  private service = new IotLocationsProfileService();
