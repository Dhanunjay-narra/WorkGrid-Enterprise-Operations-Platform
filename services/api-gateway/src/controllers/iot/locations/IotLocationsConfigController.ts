import { IotLocationsConfigService } from "../../../../core-engine/src/iot/locations/services/IotLocationsConfigService";

export class IotLocationsConfigController {
  private service = new IotLocationsConfigService();
