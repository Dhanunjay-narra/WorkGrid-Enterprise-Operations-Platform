import { IotLocationsMetricService } from "../../../../core-engine/src/iot/locations/services/IotLocationsMetricService";

export class IotLocationsMetricController {
  private service = new IotLocationsMetricService();
