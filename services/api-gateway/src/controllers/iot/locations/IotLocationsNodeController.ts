import { IotLocationsNodeService } from "../../../../core-engine/src/iot/locations/services/IotLocationsNodeService";

export class IotLocationsNodeController {
  private service = new IotLocationsNodeService();
