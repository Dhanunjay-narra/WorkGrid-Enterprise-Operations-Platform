import { IotLocationsItemService } from "../../../../core-engine/src/iot/locations/services/IotLocationsItemService";

export class IotLocationsItemController {
  private service = new IotLocationsItemService();
