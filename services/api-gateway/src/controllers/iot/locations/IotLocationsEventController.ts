import { IotLocationsEventService } from "../../../../core-engine/src/iot/locations/services/IotLocationsEventService";

export class IotLocationsEventController {
  private service = new IotLocationsEventService();
