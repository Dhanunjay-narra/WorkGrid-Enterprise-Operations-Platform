import { IotLocationsSnapshotService } from "../../../../core-engine/src/iot/locations/services/IotLocationsSnapshotService";

export class IotLocationsSnapshotController {
  private service = new IotLocationsSnapshotService();
