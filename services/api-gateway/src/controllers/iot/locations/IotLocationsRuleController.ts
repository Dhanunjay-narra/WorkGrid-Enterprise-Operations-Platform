import { IotLocationsRuleService } from "../../../../core-engine/src/iot/locations/services/IotLocationsRuleService";

export class IotLocationsRuleController {
  private service = new IotLocationsRuleService();
