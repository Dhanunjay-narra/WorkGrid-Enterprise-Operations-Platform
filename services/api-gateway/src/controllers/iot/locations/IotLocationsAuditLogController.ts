import { IotLocationsAuditLogService } from "../../../../core-engine/src/iot/locations/services/IotLocationsAuditLogService";

export class IotLocationsAuditLogController {
  private service = new IotLocationsAuditLogService();
