import { IotLocationsQueueService } from "../../../../core-engine/src/iot/locations/services/IotLocationsQueueService";

export class IotLocationsQueueController {
  private service = new IotLocationsQueueService();
