import { IotLocationsStateService } from "../../../../core-engine/src/iot/locations/services/IotLocationsStateService";

export class IotLocationsStateController {
  private service = new IotLocationsStateService();
