import { IotLocationsPayloadService } from "../../../../core-engine/src/iot/locations/services/IotLocationsPayloadService";

export class IotLocationsPayloadController {
  private service = new IotLocationsPayloadService();
