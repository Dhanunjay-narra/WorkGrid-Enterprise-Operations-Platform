import { IotLocationsSessionService } from "../../../../core-engine/src/iot/locations/services/IotLocationsSessionService";

export class IotLocationsSessionController {
  private service = new IotLocationsSessionService();
