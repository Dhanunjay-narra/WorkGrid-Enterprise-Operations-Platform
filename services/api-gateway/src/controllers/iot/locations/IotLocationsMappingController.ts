import { IotLocationsMappingService } from "../../../../core-engine/src/iot/locations/services/IotLocationsMappingService";

export class IotLocationsMappingController {
  private service = new IotLocationsMappingService();
