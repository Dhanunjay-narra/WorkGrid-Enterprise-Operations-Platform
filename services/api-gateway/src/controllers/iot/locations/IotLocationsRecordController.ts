import { IotLocationsRecordService } from "../../../../core-engine/src/iot/locations/services/IotLocationsRecordService";

export class IotLocationsRecordController {
  private service = new IotLocationsRecordService();
