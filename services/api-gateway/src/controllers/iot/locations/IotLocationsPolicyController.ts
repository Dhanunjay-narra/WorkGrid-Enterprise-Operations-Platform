import { IotLocationsPolicyService } from "../../../../core-engine/src/iot/locations/services/IotLocationsPolicyService";

export class IotLocationsPolicyController {
  private service = new IotLocationsPolicyService();
