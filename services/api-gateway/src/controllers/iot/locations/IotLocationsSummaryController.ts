import { IotLocationsSummaryService } from "../../../../core-engine/src/iot/locations/services/IotLocationsSummaryService";

export class IotLocationsSummaryController {
  private service = new IotLocationsSummaryService();
