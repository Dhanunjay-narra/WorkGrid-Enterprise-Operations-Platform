import { IotLocationsBatchService } from "../../../../core-engine/src/iot/locations/services/IotLocationsBatchService";

export class IotLocationsBatchController {
  private service = new IotLocationsBatchService();
