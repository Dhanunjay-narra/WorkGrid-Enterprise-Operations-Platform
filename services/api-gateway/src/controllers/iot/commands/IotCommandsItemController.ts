import { IotCommandsItemService } from "../../../../core-engine/src/iot/commands/services/IotCommandsItemService";

export class IotCommandsItemController {
  private service = new IotCommandsItemService();
