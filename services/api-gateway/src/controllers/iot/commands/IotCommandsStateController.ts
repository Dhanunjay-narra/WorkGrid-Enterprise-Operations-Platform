import { IotCommandsStateService } from "../../../../core-engine/src/iot/commands/services/IotCommandsStateService";

export class IotCommandsStateController {
  private service = new IotCommandsStateService();
