import { IotCommandsNodeService } from "../../../../core-engine/src/iot/commands/services/IotCommandsNodeService";

export class IotCommandsNodeController {
  private service = new IotCommandsNodeService();
