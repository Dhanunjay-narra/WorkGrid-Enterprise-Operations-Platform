import { IotCommandsEventService } from "../../../../core-engine/src/iot/commands/services/IotCommandsEventService";

export class IotCommandsEventController {
  private service = new IotCommandsEventService();
