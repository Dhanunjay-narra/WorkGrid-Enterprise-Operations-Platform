import { IotCommandsSnapshotService } from "../../../../core-engine/src/iot/commands/services/IotCommandsSnapshotService";

export class IotCommandsSnapshotController {
  private service = new IotCommandsSnapshotService();
