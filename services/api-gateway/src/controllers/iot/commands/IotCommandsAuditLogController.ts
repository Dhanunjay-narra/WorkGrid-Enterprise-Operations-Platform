import { IotCommandsAuditLogService } from "../../../../core-engine/src/iot/commands/services/IotCommandsAuditLogService";

export class IotCommandsAuditLogController {
  private service = new IotCommandsAuditLogService();
