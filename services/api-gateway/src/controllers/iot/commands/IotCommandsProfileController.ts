import { IotCommandsProfileService } from "../../../../core-engine/src/iot/commands/services/IotCommandsProfileService";

export class IotCommandsProfileController {
  private service = new IotCommandsProfileService();
