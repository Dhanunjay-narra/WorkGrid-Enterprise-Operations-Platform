import { IotCommandsSessionService } from "../../../../core-engine/src/iot/commands/services/IotCommandsSessionService";

export class IotCommandsSessionController {
  private service = new IotCommandsSessionService();
