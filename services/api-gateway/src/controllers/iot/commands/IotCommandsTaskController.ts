import { IotCommandsTaskService } from "../../../../core-engine/src/iot/commands/services/IotCommandsTaskService";

export class IotCommandsTaskController {
  private service = new IotCommandsTaskService();
