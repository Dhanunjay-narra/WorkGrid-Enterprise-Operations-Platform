import { IotCommandsMappingService } from "../../../../core-engine/src/iot/commands/services/IotCommandsMappingService";

export class IotCommandsMappingController {
  private service = new IotCommandsMappingService();
