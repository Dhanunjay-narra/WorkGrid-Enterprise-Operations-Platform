import { IotCommandsMetricService } from "../../../../core-engine/src/iot/commands/services/IotCommandsMetricService";

export class IotCommandsMetricController {
  private service = new IotCommandsMetricService();
