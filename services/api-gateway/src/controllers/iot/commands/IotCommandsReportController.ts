import { IotCommandsReportService } from "../../../../core-engine/src/iot/commands/services/IotCommandsReportService";

export class IotCommandsReportController {
  private service = new IotCommandsReportService();
