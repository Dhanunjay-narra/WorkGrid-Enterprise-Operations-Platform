import { IotCommandsConfigService } from "../../../../core-engine/src/iot/commands/services/IotCommandsConfigService";

export class IotCommandsConfigController {
  private service = new IotCommandsConfigService();
