import { IotCommandsPolicyService } from "../../../../core-engine/src/iot/commands/services/IotCommandsPolicyService";

export class IotCommandsPolicyController {
  private service = new IotCommandsPolicyService();
