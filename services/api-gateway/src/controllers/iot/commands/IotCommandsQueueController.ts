import { IotCommandsQueueService } from "../../../../core-engine/src/iot/commands/services/IotCommandsQueueService";

export class IotCommandsQueueController {
  private service = new IotCommandsQueueService();
