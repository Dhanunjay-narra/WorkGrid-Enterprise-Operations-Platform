import { IotCommandsSummaryService } from "../../../../core-engine/src/iot/commands/services/IotCommandsSummaryService";

export class IotCommandsSummaryController {
  private service = new IotCommandsSummaryService();
