import { IotCommandsPayloadService } from "../../../../core-engine/src/iot/commands/services/IotCommandsPayloadService";

export class IotCommandsPayloadController {
  private service = new IotCommandsPayloadService();
