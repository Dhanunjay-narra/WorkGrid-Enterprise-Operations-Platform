import { IotCommandsRecordService } from "../../../../core-engine/src/iot/commands/services/IotCommandsRecordService";

export class IotCommandsRecordController {
  private service = new IotCommandsRecordService();
