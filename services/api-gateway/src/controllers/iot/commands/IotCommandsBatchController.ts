import { IotCommandsBatchService } from "../../../../core-engine/src/iot/commands/services/IotCommandsBatchService";

export class IotCommandsBatchController {
  private service = new IotCommandsBatchService();
