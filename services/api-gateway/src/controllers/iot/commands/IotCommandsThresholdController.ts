import { IotCommandsThresholdService } from "../../../../core-engine/src/iot/commands/services/IotCommandsThresholdService";

export class IotCommandsThresholdController {
  private service = new IotCommandsThresholdService();
