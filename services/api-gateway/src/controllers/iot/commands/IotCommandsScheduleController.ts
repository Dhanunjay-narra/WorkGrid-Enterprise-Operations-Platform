import { IotCommandsScheduleService } from "../../../../core-engine/src/iot/commands/services/IotCommandsScheduleService";

export class IotCommandsScheduleController {
  private service = new IotCommandsScheduleService();
