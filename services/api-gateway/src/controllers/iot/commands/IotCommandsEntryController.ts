import { IotCommandsEntryService } from "../../../../core-engine/src/iot/commands/services/IotCommandsEntryService";

export class IotCommandsEntryController {
  private service = new IotCommandsEntryService();
