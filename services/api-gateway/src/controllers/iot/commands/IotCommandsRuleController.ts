import { IotCommandsRuleService } from "../../../../core-engine/src/iot/commands/services/IotCommandsRuleService";

export class IotCommandsRuleController {
  private service = new IotCommandsRuleService();
