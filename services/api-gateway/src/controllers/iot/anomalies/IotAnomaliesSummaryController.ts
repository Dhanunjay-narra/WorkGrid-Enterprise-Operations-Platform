import { IotAnomaliesSummaryService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesSummaryService";

export class IotAnomaliesSummaryController {
  private service = new IotAnomaliesSummaryService();
