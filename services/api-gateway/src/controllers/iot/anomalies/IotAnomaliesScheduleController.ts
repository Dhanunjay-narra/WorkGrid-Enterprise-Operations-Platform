import { IotAnomaliesScheduleService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesScheduleService";

export class IotAnomaliesScheduleController {
  private service = new IotAnomaliesScheduleService();
