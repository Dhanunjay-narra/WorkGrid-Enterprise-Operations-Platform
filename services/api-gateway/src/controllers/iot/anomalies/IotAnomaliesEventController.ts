import { IotAnomaliesEventService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesEventService";

export class IotAnomaliesEventController {
  private service = new IotAnomaliesEventService();
