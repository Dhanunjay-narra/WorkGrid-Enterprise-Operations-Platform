import { IotAnomaliesQueueService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesQueueService";

export class IotAnomaliesQueueController {
  private service = new IotAnomaliesQueueService();
