import { IotAnomaliesEntryService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesEntryService";

export class IotAnomaliesEntryController {
  private service = new IotAnomaliesEntryService();
