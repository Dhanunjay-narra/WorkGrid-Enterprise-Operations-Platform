import { IotAnomaliesRuleService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesRuleService";

export class IotAnomaliesRuleController {
  private service = new IotAnomaliesRuleService();
