import { IotAnomaliesSnapshotService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesSnapshotService";

export class IotAnomaliesSnapshotController {
  private service = new IotAnomaliesSnapshotService();
