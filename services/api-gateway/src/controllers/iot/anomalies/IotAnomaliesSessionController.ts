import { IotAnomaliesSessionService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesSessionService";

export class IotAnomaliesSessionController {
  private service = new IotAnomaliesSessionService();
