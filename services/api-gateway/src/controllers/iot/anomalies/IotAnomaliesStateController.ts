import { IotAnomaliesStateService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesStateService";

export class IotAnomaliesStateController {
  private service = new IotAnomaliesStateService();
