import { IotAnomaliesNodeService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesNodeService";

export class IotAnomaliesNodeController {
  private service = new IotAnomaliesNodeService();
