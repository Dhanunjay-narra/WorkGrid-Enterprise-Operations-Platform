import { IotAnomaliesAuditLogService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesAuditLogService";

export class IotAnomaliesAuditLogController {
  private service = new IotAnomaliesAuditLogService();
