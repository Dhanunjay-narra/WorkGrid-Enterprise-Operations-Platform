import { IotAnomaliesPayloadService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesPayloadService";

export class IotAnomaliesPayloadController {
  private service = new IotAnomaliesPayloadService();
