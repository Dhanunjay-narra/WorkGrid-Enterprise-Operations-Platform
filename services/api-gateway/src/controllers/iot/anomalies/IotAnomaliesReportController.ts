import { IotAnomaliesReportService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesReportService";

export class IotAnomaliesReportController {
  private service = new IotAnomaliesReportService();
