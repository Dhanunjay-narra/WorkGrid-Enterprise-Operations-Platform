import { IotAnomaliesMetricService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesMetricService";

export class IotAnomaliesMetricController {
  private service = new IotAnomaliesMetricService();
