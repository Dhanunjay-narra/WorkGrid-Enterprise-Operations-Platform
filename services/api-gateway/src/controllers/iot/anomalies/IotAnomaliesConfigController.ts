import { IotAnomaliesConfigService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesConfigService";

export class IotAnomaliesConfigController {
  private service = new IotAnomaliesConfigService();
