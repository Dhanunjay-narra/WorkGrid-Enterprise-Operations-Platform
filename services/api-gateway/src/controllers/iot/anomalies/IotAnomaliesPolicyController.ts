import { IotAnomaliesPolicyService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesPolicyService";

export class IotAnomaliesPolicyController {
  private service = new IotAnomaliesPolicyService();
