import { IotAnomaliesMappingService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesMappingService";

export class IotAnomaliesMappingController {
  private service = new IotAnomaliesMappingService();
