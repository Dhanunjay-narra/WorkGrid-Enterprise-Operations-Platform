import { IotAnomaliesProfileService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesProfileService";

export class IotAnomaliesProfileController {
  private service = new IotAnomaliesProfileService();
