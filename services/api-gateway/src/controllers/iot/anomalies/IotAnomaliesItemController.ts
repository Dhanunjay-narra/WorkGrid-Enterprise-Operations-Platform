import { IotAnomaliesItemService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesItemService";

export class IotAnomaliesItemController {
  private service = new IotAnomaliesItemService();
