import { IotAnomaliesTaskService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesTaskService";

export class IotAnomaliesTaskController {
  private service = new IotAnomaliesTaskService();
