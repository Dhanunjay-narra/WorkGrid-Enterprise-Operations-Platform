import { IotAnomaliesRecordService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesRecordService";

export class IotAnomaliesRecordController {
  private service = new IotAnomaliesRecordService();
