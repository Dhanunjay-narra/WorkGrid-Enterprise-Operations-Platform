import { IotAnomaliesBatchService } from "../../../../core-engine/src/iot/anomalies/services/IotAnomaliesBatchService";

export class IotAnomaliesBatchController {
  private service = new IotAnomaliesBatchService();
