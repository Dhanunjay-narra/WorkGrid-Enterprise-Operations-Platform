import { IotFleetMappingService } from "../../../../core-engine/src/iot/fleet/services/IotFleetMappingService";

export class IotFleetMappingController {
  private service = new IotFleetMappingService();
