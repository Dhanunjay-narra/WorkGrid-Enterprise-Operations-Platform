import { IotFleetScheduleService } from "../../../../core-engine/src/iot/fleet/services/IotFleetScheduleService";

export class IotFleetScheduleController {
  private service = new IotFleetScheduleService();
