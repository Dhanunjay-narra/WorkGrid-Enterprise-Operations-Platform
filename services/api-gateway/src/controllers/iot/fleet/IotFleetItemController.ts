import { IotFleetItemService } from "../../../../core-engine/src/iot/fleet/services/IotFleetItemService";

export class IotFleetItemController {
  private service = new IotFleetItemService();
