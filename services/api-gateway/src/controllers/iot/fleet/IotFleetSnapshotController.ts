import { IotFleetSnapshotService } from "../../../../core-engine/src/iot/fleet/services/IotFleetSnapshotService";

export class IotFleetSnapshotController {
  private service = new IotFleetSnapshotService();
