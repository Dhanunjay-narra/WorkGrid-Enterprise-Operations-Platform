import { IotFleetEventService } from "../../../../core-engine/src/iot/fleet/services/IotFleetEventService";

export class IotFleetEventController {
  private service = new IotFleetEventService();
