import { IotFleetThresholdService } from "../../../../core-engine/src/iot/fleet/services/IotFleetThresholdService";

export class IotFleetThresholdController {
  private service = new IotFleetThresholdService();
