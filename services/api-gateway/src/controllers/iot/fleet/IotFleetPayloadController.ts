import { IotFleetPayloadService } from "../../../../core-engine/src/iot/fleet/services/IotFleetPayloadService";

export class IotFleetPayloadController {
  private service = new IotFleetPayloadService();
