import { IotFleetTaskService } from "../../../../core-engine/src/iot/fleet/services/IotFleetTaskService";

export class IotFleetTaskController {
  private service = new IotFleetTaskService();
