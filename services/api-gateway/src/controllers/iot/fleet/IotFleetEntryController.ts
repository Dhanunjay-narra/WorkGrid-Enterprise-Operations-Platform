import { IotFleetEntryService } from "../../../../core-engine/src/iot/fleet/services/IotFleetEntryService";

export class IotFleetEntryController {
  private service = new IotFleetEntryService();
