import { IotFleetAssignmentService } from "../../../../core-engine/src/iot/fleet/services/IotFleetAssignmentService";

export class IotFleetAssignmentController {
  private service = new IotFleetAssignmentService();
