import { IotFleetProfileService } from "../../../../core-engine/src/iot/fleet/services/IotFleetProfileService";

export class IotFleetProfileController {
  private service = new IotFleetProfileService();
