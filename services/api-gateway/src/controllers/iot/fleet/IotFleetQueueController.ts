import { IotFleetQueueService } from "../../../../core-engine/src/iot/fleet/services/IotFleetQueueService";

export class IotFleetQueueController {
  private service = new IotFleetQueueService();
