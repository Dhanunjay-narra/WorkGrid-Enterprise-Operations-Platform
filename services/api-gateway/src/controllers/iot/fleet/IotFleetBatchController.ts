import { IotFleetBatchService } from "../../../../core-engine/src/iot/fleet/services/IotFleetBatchService";

export class IotFleetBatchController {
  private service = new IotFleetBatchService();
