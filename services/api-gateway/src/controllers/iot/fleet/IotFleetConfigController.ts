import { IotFleetConfigService } from "../../../../core-engine/src/iot/fleet/services/IotFleetConfigService";

export class IotFleetConfigController {
  private service = new IotFleetConfigService();
