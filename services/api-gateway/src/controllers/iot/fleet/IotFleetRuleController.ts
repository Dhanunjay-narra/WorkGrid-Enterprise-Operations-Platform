import { IotFleetRuleService } from "../../../../core-engine/src/iot/fleet/services/IotFleetRuleService";

export class IotFleetRuleController {
  private service = new IotFleetRuleService();
