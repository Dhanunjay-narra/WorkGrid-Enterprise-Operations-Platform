import { IotFleetNodeService } from "../../../../core-engine/src/iot/fleet/services/IotFleetNodeService";

export class IotFleetNodeController {
  private service = new IotFleetNodeService();
