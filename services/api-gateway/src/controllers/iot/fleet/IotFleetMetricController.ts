import { IotFleetMetricService } from "../../../../core-engine/src/iot/fleet/services/IotFleetMetricService";

export class IotFleetMetricController {
  private service = new IotFleetMetricService();
