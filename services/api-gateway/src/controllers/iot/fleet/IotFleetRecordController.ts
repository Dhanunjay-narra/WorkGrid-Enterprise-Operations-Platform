import { IotFleetRecordService } from "../../../../core-engine/src/iot/fleet/services/IotFleetRecordService";

export class IotFleetRecordController {
  private service = new IotFleetRecordService();
