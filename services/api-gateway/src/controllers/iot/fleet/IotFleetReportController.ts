import { IotFleetReportService } from "../../../../core-engine/src/iot/fleet/services/IotFleetReportService";

export class IotFleetReportController {
  private service = new IotFleetReportService();
