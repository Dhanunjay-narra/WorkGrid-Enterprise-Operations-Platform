import { IotFleetAuditLogService } from "../../../../core-engine/src/iot/fleet/services/IotFleetAuditLogService";

export class IotFleetAuditLogController {
  private service = new IotFleetAuditLogService();
