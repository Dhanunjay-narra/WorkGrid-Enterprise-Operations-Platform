import { IotFleetPolicyService } from "../../../../core-engine/src/iot/fleet/services/IotFleetPolicyService";

export class IotFleetPolicyController {
  private service = new IotFleetPolicyService();
