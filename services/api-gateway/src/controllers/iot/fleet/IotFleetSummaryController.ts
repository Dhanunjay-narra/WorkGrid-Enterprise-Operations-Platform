import { IotFleetSummaryService } from "../../../../core-engine/src/iot/fleet/services/IotFleetSummaryService";

export class IotFleetSummaryController {
  private service = new IotFleetSummaryService();
