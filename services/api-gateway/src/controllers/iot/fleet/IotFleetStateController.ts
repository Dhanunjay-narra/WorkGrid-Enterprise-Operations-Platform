import { IotFleetStateService } from "../../../../core-engine/src/iot/fleet/services/IotFleetStateService";

export class IotFleetStateController {
  private service = new IotFleetStateService();
