import { IotFleetTransactionService } from "../../../../core-engine/src/iot/fleet/services/IotFleetTransactionService";

export class IotFleetTransactionController {
  private service = new IotFleetTransactionService();
