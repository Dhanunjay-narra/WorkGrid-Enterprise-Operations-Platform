import { IotFleetSessionService } from "../../../../core-engine/src/iot/fleet/services/IotFleetSessionService";

export class IotFleetSessionController {
  private service = new IotFleetSessionService();
