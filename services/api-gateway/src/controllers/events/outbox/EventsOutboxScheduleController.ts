import { EventsOutboxScheduleService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxScheduleService";

export class EventsOutboxScheduleController {
  private service = new EventsOutboxScheduleService();
