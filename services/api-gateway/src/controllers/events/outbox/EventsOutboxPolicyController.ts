import { EventsOutboxPolicyService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxPolicyService";

export class EventsOutboxPolicyController {
  private service = new EventsOutboxPolicyService();
