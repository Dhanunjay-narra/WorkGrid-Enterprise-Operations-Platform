import { EventsOutboxEventService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxEventService";

export class EventsOutboxEventController {
  private service = new EventsOutboxEventService();
