import { EventsOutboxMetricService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxMetricService";

export class EventsOutboxMetricController {
  private service = new EventsOutboxMetricService();
