import { EventsOutboxEntryService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxEntryService";

export class EventsOutboxEntryController {
  private service = new EventsOutboxEntryService();
