import { EventsOutboxReportService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxReportService";

export class EventsOutboxReportController {
  private service = new EventsOutboxReportService();
