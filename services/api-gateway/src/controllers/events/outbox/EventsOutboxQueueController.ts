import { EventsOutboxQueueService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxQueueService";

export class EventsOutboxQueueController {
  private service = new EventsOutboxQueueService();
