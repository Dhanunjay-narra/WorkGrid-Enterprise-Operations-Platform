import { EventsOutboxAuditLogService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxAuditLogService";

export class EventsOutboxAuditLogController {
  private service = new EventsOutboxAuditLogService();
