import { EventsOutboxConfigService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxConfigService";

export class EventsOutboxConfigController {
  private service = new EventsOutboxConfigService();
