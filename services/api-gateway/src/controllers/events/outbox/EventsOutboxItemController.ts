import { EventsOutboxItemService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxItemService";

export class EventsOutboxItemController {
  private service = new EventsOutboxItemService();
