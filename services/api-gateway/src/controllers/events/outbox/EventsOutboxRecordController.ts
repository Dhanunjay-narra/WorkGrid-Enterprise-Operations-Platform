import { EventsOutboxRecordService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxRecordService";

export class EventsOutboxRecordController {
  private service = new EventsOutboxRecordService();
