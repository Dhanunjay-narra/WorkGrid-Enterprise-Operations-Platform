import { EventsOutboxPayloadService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxPayloadService";

export class EventsOutboxPayloadController {
  private service = new EventsOutboxPayloadService();
