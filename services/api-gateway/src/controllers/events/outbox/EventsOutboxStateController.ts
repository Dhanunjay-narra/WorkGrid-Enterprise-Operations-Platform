import { EventsOutboxStateService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxStateService";

export class EventsOutboxStateController {
  private service = new EventsOutboxStateService();
