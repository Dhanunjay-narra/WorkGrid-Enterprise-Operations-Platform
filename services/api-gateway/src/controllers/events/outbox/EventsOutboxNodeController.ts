import { EventsOutboxNodeService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxNodeService";

export class EventsOutboxNodeController {
  private service = new EventsOutboxNodeService();
