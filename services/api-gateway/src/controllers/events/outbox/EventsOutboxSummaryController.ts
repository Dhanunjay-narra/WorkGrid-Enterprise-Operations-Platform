import { EventsOutboxSummaryService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxSummaryService";

export class EventsOutboxSummaryController {
  private service = new EventsOutboxSummaryService();
