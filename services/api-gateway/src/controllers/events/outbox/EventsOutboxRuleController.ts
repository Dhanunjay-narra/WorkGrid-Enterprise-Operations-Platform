import { EventsOutboxRuleService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxRuleService";

export class EventsOutboxRuleController {
  private service = new EventsOutboxRuleService();
