import { EventsOutboxSnapshotService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxSnapshotService";

export class EventsOutboxSnapshotController {
  private service = new EventsOutboxSnapshotService();
