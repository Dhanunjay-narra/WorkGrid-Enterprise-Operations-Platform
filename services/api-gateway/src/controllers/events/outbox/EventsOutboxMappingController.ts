import { EventsOutboxMappingService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxMappingService";

export class EventsOutboxMappingController {
  private service = new EventsOutboxMappingService();
