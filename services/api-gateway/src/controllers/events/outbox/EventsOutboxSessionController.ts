import { EventsOutboxSessionService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxSessionService";

export class EventsOutboxSessionController {
  private service = new EventsOutboxSessionService();
