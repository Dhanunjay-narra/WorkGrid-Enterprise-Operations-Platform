import { EventsOutboxProfileService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxProfileService";

export class EventsOutboxProfileController {
  private service = new EventsOutboxProfileService();
