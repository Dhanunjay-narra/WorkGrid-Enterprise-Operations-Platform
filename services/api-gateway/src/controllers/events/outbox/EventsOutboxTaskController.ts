import { EventsOutboxTaskService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxTaskService";

export class EventsOutboxTaskController {
  private service = new EventsOutboxTaskService();
