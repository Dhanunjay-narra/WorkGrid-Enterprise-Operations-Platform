import { EventsOutboxBatchService } from "../../../../core-engine/src/events/outbox/services/EventsOutboxBatchService";

export class EventsOutboxBatchController {
  private service = new EventsOutboxBatchService();
