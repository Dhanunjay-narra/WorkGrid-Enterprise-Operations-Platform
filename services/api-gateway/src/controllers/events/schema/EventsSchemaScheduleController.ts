import { EventsSchemaScheduleService } from "../../../../core-engine/src/events/schema/services/EventsSchemaScheduleService";

export class EventsSchemaScheduleController {
  private service = new EventsSchemaScheduleService();
