import { EventsSchemaSummaryService } from "../../../../core-engine/src/events/schema/services/EventsSchemaSummaryService";

export class EventsSchemaSummaryController {
  private service = new EventsSchemaSummaryService();
