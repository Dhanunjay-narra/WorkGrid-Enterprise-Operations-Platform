import { EventsSchemaSessionService } from "../../../../core-engine/src/events/schema/services/EventsSchemaSessionService";

export class EventsSchemaSessionController {
  private service = new EventsSchemaSessionService();
