import { EventsSchemaAuditLogService } from "../../../../core-engine/src/events/schema/services/EventsSchemaAuditLogService";

export class EventsSchemaAuditLogController {
  private service = new EventsSchemaAuditLogService();
