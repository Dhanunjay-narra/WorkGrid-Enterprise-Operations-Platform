import { EventsSchemaItemService } from "../../../../core-engine/src/events/schema/services/EventsSchemaItemService";

export class EventsSchemaItemController {
  private service = new EventsSchemaItemService();
