import { EventsSchemaBatchService } from "../../../../core-engine/src/events/schema/services/EventsSchemaBatchService";

export class EventsSchemaBatchController {
  private service = new EventsSchemaBatchService();
