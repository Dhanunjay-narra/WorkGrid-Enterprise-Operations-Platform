import { EventsSchemaRecordService } from "../../../../core-engine/src/events/schema/services/EventsSchemaRecordService";

export class EventsSchemaRecordController {
  private service = new EventsSchemaRecordService();
