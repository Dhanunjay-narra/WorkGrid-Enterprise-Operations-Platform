import { EventsSchemaSnapshotService } from "../../../../core-engine/src/events/schema/services/EventsSchemaSnapshotService";

export class EventsSchemaSnapshotController {
  private service = new EventsSchemaSnapshotService();
