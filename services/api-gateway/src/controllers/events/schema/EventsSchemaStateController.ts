import { EventsSchemaStateService } from "../../../../core-engine/src/events/schema/services/EventsSchemaStateService";

export class EventsSchemaStateController {
  private service = new EventsSchemaStateService();
