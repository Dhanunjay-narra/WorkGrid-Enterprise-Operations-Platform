import { EventsSchemaEventService } from "../../../../core-engine/src/events/schema/services/EventsSchemaEventService";

export class EventsSchemaEventController {
  private service = new EventsSchemaEventService();
