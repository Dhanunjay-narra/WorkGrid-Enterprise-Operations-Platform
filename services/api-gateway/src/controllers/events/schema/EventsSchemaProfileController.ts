import { EventsSchemaProfileService } from "../../../../core-engine/src/events/schema/services/EventsSchemaProfileService";

export class EventsSchemaProfileController {
  private service = new EventsSchemaProfileService();
