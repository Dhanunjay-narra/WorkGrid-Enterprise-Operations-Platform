import { EventsSchemaReportService } from "../../../../core-engine/src/events/schema/services/EventsSchemaReportService";

export class EventsSchemaReportController {
  private service = new EventsSchemaReportService();
