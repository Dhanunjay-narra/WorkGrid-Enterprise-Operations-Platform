import { EventsSchemaQueueService } from "../../../../core-engine/src/events/schema/services/EventsSchemaQueueService";

export class EventsSchemaQueueController {
  private service = new EventsSchemaQueueService();
