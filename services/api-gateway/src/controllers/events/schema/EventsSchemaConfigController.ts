import { EventsSchemaConfigService } from "../../../../core-engine/src/events/schema/services/EventsSchemaConfigService";

export class EventsSchemaConfigController {
  private service = new EventsSchemaConfigService();
