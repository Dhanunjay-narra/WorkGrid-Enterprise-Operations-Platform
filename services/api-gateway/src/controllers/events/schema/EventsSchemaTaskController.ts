import { EventsSchemaTaskService } from "../../../../core-engine/src/events/schema/services/EventsSchemaTaskService";

export class EventsSchemaTaskController {
  private service = new EventsSchemaTaskService();
