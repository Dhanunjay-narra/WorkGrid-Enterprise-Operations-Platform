import { EventsSchemaPolicyService } from "../../../../core-engine/src/events/schema/services/EventsSchemaPolicyService";

export class EventsSchemaPolicyController {
  private service = new EventsSchemaPolicyService();
