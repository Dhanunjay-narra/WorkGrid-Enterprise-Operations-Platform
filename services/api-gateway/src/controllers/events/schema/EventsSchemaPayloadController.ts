import { EventsSchemaPayloadService } from "../../../../core-engine/src/events/schema/services/EventsSchemaPayloadService";

export class EventsSchemaPayloadController {
  private service = new EventsSchemaPayloadService();
