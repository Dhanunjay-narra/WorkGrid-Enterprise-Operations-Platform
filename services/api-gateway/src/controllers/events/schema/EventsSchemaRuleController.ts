import { EventsSchemaRuleService } from "../../../../core-engine/src/events/schema/services/EventsSchemaRuleService";

export class EventsSchemaRuleController {
  private service = new EventsSchemaRuleService();
