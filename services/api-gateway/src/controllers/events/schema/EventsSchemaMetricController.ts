import { EventsSchemaMetricService } from "../../../../core-engine/src/events/schema/services/EventsSchemaMetricService";

export class EventsSchemaMetricController {
  private service = new EventsSchemaMetricService();
