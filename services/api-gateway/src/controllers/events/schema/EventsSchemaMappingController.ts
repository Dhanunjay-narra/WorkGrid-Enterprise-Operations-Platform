import { EventsSchemaMappingService } from "../../../../core-engine/src/events/schema/services/EventsSchemaMappingService";

export class EventsSchemaMappingController {
  private service = new EventsSchemaMappingService();
