import { EventsSchemaEntryService } from "../../../../core-engine/src/events/schema/services/EventsSchemaEntryService";

export class EventsSchemaEntryController {
  private service = new EventsSchemaEntryService();
