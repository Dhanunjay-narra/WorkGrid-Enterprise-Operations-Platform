import { EventsSchemaNodeService } from "../../../../core-engine/src/events/schema/services/EventsSchemaNodeService";

export class EventsSchemaNodeController {
  private service = new EventsSchemaNodeService();
