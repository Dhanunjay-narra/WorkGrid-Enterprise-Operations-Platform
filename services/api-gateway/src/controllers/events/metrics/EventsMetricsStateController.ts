import { EventsMetricsStateService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsStateService";

export class EventsMetricsStateController {
  private service = new EventsMetricsStateService();
