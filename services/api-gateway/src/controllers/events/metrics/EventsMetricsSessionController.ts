import { EventsMetricsSessionService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsSessionService";

export class EventsMetricsSessionController {
  private service = new EventsMetricsSessionService();
