import { EventsMetricsRuleService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsRuleService";

export class EventsMetricsRuleController {
  private service = new EventsMetricsRuleService();
