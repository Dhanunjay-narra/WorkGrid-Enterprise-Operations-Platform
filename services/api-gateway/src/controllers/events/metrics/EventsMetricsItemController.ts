import { EventsMetricsItemService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsItemService";

export class EventsMetricsItemController {
  private service = new EventsMetricsItemService();
