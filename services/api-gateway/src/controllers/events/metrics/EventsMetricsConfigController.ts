import { EventsMetricsConfigService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsConfigService";

export class EventsMetricsConfigController {
  private service = new EventsMetricsConfigService();
