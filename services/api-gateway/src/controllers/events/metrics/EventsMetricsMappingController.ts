import { EventsMetricsMappingService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsMappingService";

export class EventsMetricsMappingController {
  private service = new EventsMetricsMappingService();
