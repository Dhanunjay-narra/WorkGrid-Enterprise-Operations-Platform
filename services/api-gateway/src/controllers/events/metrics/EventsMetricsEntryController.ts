import { EventsMetricsEntryService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsEntryService";

export class EventsMetricsEntryController {
  private service = new EventsMetricsEntryService();
