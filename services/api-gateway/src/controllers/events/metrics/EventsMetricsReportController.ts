import { EventsMetricsReportService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsReportService";

export class EventsMetricsReportController {
  private service = new EventsMetricsReportService();
