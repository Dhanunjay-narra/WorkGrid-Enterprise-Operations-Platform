import { EventsMetricsEventService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsEventService";

export class EventsMetricsEventController {
  private service = new EventsMetricsEventService();
