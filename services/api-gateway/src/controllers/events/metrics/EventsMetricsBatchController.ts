import { EventsMetricsBatchService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsBatchService";

export class EventsMetricsBatchController {
  private service = new EventsMetricsBatchService();
