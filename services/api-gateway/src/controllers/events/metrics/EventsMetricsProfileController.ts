import { EventsMetricsProfileService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsProfileService";

export class EventsMetricsProfileController {
  private service = new EventsMetricsProfileService();
