import { EventsMetricsMetricService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsMetricService";

export class EventsMetricsMetricController {
  private service = new EventsMetricsMetricService();
