import { EventsMetricsPayloadService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsPayloadService";

export class EventsMetricsPayloadController {
  private service = new EventsMetricsPayloadService();
