import { EventsMetricsNodeService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsNodeService";

export class EventsMetricsNodeController {
  private service = new EventsMetricsNodeService();
