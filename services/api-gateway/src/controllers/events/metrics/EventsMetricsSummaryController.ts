import { EventsMetricsSummaryService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsSummaryService";

export class EventsMetricsSummaryController {
  private service = new EventsMetricsSummaryService();
