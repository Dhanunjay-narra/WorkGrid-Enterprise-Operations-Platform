import { EventsMetricsPolicyService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsPolicyService";

export class EventsMetricsPolicyController {
  private service = new EventsMetricsPolicyService();
