import { EventsMetricsRecordService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsRecordService";

export class EventsMetricsRecordController {
  private service = new EventsMetricsRecordService();
