import { EventsMetricsQueueService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsQueueService";

export class EventsMetricsQueueController {
  private service = new EventsMetricsQueueService();
