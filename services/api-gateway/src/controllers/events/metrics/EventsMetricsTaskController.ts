import { EventsMetricsTaskService } from "../../../../core-engine/src/events/metrics/services/EventsMetricsTaskService";

export class EventsMetricsTaskController {
  private service = new EventsMetricsTaskService();
