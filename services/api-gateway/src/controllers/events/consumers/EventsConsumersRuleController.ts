import { EventsConsumersRuleService } from "../../../../core-engine/src/events/consumers/services/EventsConsumersRuleService";

export class EventsConsumersRuleController {
  private service = new EventsConsumersRuleService();
