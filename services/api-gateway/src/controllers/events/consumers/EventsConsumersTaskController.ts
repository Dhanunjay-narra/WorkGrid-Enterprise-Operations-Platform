import { EventsConsumersTaskService } from "../../../../core-engine/src/events/consumers/services/EventsConsumersTaskService";

export class EventsConsumersTaskController {
  private service = new EventsConsumersTaskService();
