import { EventsConsumersItemService } from "../../../../core-engine/src/events/consumers/services/EventsConsumersItemService";

export class EventsConsumersItemController {
  private service = new EventsConsumersItemService();
