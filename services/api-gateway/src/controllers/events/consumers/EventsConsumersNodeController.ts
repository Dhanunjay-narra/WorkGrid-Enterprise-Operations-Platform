import { EventsConsumersNodeService } from "../../../../core-engine/src/events/consumers/services/EventsConsumersNodeService";

export class EventsConsumersNodeController {
  private service = new EventsConsumersNodeService();
