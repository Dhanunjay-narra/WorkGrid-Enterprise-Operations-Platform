import { EventsReplaySnapshotService } from "../../../../core-engine/src/events/replay/services/EventsReplaySnapshotService";

export class EventsReplaySnapshotController {
  private service = new EventsReplaySnapshotService();
