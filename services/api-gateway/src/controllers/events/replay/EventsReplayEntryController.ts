import { EventsReplayEntryService } from "../../../../core-engine/src/events/replay/services/EventsReplayEntryService";

export class EventsReplayEntryController {
  private service = new EventsReplayEntryService();
