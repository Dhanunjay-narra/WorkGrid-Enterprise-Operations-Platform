import { EventsReplayNodeService } from "../../../../core-engine/src/events/replay/services/EventsReplayNodeService";

export class EventsReplayNodeController {
  private service = new EventsReplayNodeService();
