import { EventsReplayProfileService } from "../../../../core-engine/src/events/replay/services/EventsReplayProfileService";

export class EventsReplayProfileController {
  private service = new EventsReplayProfileService();
