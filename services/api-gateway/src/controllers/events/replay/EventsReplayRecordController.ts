import { EventsReplayRecordService } from "../../../../core-engine/src/events/replay/services/EventsReplayRecordService";

export class EventsReplayRecordController {
  private service = new EventsReplayRecordService();
