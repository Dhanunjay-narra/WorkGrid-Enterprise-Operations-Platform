import { EventsReplayStateService } from "../../../../core-engine/src/events/replay/services/EventsReplayStateService";

export class EventsReplayStateController {
  private service = new EventsReplayStateService();
