import { EventsReplayConfigService } from "../../../../core-engine/src/events/replay/services/EventsReplayConfigService";

export class EventsReplayConfigController {
  private service = new EventsReplayConfigService();
