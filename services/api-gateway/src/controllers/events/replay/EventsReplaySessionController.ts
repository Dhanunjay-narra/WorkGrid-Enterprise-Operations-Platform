import { EventsReplaySessionService } from "../../../../core-engine/src/events/replay/services/EventsReplaySessionService";

export class EventsReplaySessionController {
  private service = new EventsReplaySessionService();
