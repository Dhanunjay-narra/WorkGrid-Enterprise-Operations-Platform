import { EventsReplayTaskService } from "../../../../core-engine/src/events/replay/services/EventsReplayTaskService";

export class EventsReplayTaskController {
  private service = new EventsReplayTaskService();
