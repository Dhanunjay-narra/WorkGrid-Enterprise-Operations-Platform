import { EventsReplayItemService } from "../../../../core-engine/src/events/replay/services/EventsReplayItemService";

export class EventsReplayItemController {
  private service = new EventsReplayItemService();
