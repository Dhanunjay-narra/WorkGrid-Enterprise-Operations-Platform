import { EventsReplayRuleService } from "../../../../core-engine/src/events/replay/services/EventsReplayRuleService";

export class EventsReplayRuleController {
  private service = new EventsReplayRuleService();
