import { EventsReplaySummaryService } from "../../../../core-engine/src/events/replay/services/EventsReplaySummaryService";

export class EventsReplaySummaryController {
  private service = new EventsReplaySummaryService();
