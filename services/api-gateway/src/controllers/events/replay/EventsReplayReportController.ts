import { EventsReplayReportService } from "../../../../core-engine/src/events/replay/services/EventsReplayReportService";

export class EventsReplayReportController {
  private service = new EventsReplayReportService();
