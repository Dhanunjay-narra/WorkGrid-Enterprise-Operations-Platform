import { EventsReplayPayloadService } from "../../../../core-engine/src/events/replay/services/EventsReplayPayloadService";

export class EventsReplayPayloadController {
  private service = new EventsReplayPayloadService();
