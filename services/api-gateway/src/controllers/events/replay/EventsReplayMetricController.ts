import { EventsReplayMetricService } from "../../../../core-engine/src/events/replay/services/EventsReplayMetricService";

export class EventsReplayMetricController {
  private service = new EventsReplayMetricService();
