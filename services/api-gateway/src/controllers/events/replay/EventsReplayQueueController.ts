import { EventsReplayQueueService } from "../../../../core-engine/src/events/replay/services/EventsReplayQueueService";

export class EventsReplayQueueController {
  private service = new EventsReplayQueueService();
