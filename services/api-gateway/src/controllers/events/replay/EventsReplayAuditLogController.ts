import { EventsReplayAuditLogService } from "../../../../core-engine/src/events/replay/services/EventsReplayAuditLogService";

export class EventsReplayAuditLogController {
  private service = new EventsReplayAuditLogService();
