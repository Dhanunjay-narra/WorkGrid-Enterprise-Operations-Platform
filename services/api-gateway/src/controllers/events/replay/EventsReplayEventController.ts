import { EventsReplayEventService } from "../../../../core-engine/src/events/replay/services/EventsReplayEventService";

export class EventsReplayEventController {
  private service = new EventsReplayEventService();
