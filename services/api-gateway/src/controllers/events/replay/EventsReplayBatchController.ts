import { EventsReplayBatchService } from "../../../../core-engine/src/events/replay/services/EventsReplayBatchService";

export class EventsReplayBatchController {
  private service = new EventsReplayBatchService();
