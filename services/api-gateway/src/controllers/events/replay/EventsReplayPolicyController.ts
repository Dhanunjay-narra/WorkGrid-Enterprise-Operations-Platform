import { EventsReplayPolicyService } from "../../../../core-engine/src/events/replay/services/EventsReplayPolicyService";

export class EventsReplayPolicyController {
  private service = new EventsReplayPolicyService();
