import { EventsReplayMappingService } from "../../../../core-engine/src/events/replay/services/EventsReplayMappingService";

export class EventsReplayMappingController {
  private service = new EventsReplayMappingService();
