import { EventsReplayScheduleService } from "../../../../core-engine/src/events/replay/services/EventsReplayScheduleService";

export class EventsReplayScheduleController {
  private service = new EventsReplayScheduleService();
