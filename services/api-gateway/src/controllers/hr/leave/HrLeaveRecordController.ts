import { HrLeaveRecordService } from "../../../../core-engine/src/hr/leave/services/HrLeaveRecordService";

export class HrLeaveRecordController {
  private service = new HrLeaveRecordService();
