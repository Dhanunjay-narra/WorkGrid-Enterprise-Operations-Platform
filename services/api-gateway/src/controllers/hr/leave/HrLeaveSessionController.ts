import { HrLeaveSessionService } from "../../../../core-engine/src/hr/leave/services/HrLeaveSessionService";

export class HrLeaveSessionController {
  private service = new HrLeaveSessionService();
