import { HrLeaveProfileService } from "../../../../core-engine/src/hr/leave/services/HrLeaveProfileService";

export class HrLeaveProfileController {
  private service = new HrLeaveProfileService();
