import { HrLeaveReportService } from "../../../../core-engine/src/hr/leave/services/HrLeaveReportService";

export class HrLeaveReportController {
  private service = new HrLeaveReportService();
