import { HrLeaveEntryService } from "../../../../core-engine/src/hr/leave/services/HrLeaveEntryService";

export class HrLeaveEntryController {
  private service = new HrLeaveEntryService();
