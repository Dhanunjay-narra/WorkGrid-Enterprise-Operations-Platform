import { HrLeavePayloadService } from "../../../../core-engine/src/hr/leave/services/HrLeavePayloadService";

export class HrLeavePayloadController {
  private service = new HrLeavePayloadService();
