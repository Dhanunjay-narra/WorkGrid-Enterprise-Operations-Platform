import { HrLeaveRuleService } from "../../../../core-engine/src/hr/leave/services/HrLeaveRuleService";

export class HrLeaveRuleController {
  private service = new HrLeaveRuleService();
