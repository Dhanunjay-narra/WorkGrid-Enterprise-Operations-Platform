import { HrLeaveScheduleService } from "../../../../core-engine/src/hr/leave/services/HrLeaveScheduleService";

export class HrLeaveScheduleController {
  private service = new HrLeaveScheduleService();
