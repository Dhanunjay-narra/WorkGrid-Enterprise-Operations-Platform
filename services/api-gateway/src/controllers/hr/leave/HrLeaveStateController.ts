import { HrLeaveStateService } from "../../../../core-engine/src/hr/leave/services/HrLeaveStateService";

export class HrLeaveStateController {
  private service = new HrLeaveStateService();
