import { HrLeaveAssignmentService } from "../../../../core-engine/src/hr/leave/services/HrLeaveAssignmentService";

export class HrLeaveAssignmentController {
  private service = new HrLeaveAssignmentService();
