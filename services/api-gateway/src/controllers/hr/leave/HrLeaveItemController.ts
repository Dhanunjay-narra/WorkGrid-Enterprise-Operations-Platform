import { HrLeaveItemService } from "../../../../core-engine/src/hr/leave/services/HrLeaveItemService";

export class HrLeaveItemController {
  private service = new HrLeaveItemService();
