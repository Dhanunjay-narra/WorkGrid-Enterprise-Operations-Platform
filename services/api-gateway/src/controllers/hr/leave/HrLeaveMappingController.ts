import { HrLeaveMappingService } from "../../../../core-engine/src/hr/leave/services/HrLeaveMappingService";

export class HrLeaveMappingController {
  private service = new HrLeaveMappingService();
