import { HrLeaveAuditLogService } from "../../../../core-engine/src/hr/leave/services/HrLeaveAuditLogService";

export class HrLeaveAuditLogController {
  private service = new HrLeaveAuditLogService();
