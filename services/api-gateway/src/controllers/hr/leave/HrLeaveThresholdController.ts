import { HrLeaveThresholdService } from "../../../../core-engine/src/hr/leave/services/HrLeaveThresholdService";

export class HrLeaveThresholdController {
  private service = new HrLeaveThresholdService();
