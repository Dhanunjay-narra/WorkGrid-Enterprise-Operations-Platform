import { HrLeaveBatchService } from "../../../../core-engine/src/hr/leave/services/HrLeaveBatchService";

export class HrLeaveBatchController {
  private service = new HrLeaveBatchService();
