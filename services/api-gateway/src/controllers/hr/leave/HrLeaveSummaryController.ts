import { HrLeaveSummaryService } from "../../../../core-engine/src/hr/leave/services/HrLeaveSummaryService";

export class HrLeaveSummaryController {
  private service = new HrLeaveSummaryService();
