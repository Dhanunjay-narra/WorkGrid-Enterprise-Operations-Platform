import { HrLeaveTransactionService } from "../../../../core-engine/src/hr/leave/services/HrLeaveTransactionService";

export class HrLeaveTransactionController {
  private service = new HrLeaveTransactionService();
