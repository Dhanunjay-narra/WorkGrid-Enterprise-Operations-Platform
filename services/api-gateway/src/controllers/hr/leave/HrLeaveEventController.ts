import { HrLeaveEventService } from "../../../../core-engine/src/hr/leave/services/HrLeaveEventService";

export class HrLeaveEventController {
  private service = new HrLeaveEventService();
