import { HrLeaveSnapshotService } from "../../../../core-engine/src/hr/leave/services/HrLeaveSnapshotService";

export class HrLeaveSnapshotController {
  private service = new HrLeaveSnapshotService();
