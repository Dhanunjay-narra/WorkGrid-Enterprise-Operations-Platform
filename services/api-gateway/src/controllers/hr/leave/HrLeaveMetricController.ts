import { HrLeaveMetricService } from "../../../../core-engine/src/hr/leave/services/HrLeaveMetricService";

export class HrLeaveMetricController {
  private service = new HrLeaveMetricService();
