import { HrLeaveTaskService } from "../../../../core-engine/src/hr/leave/services/HrLeaveTaskService";

export class HrLeaveTaskController {
  private service = new HrLeaveTaskService();
