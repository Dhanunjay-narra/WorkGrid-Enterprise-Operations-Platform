import { HrLeaveNodeService } from "../../../../core-engine/src/hr/leave/services/HrLeaveNodeService";

export class HrLeaveNodeController {
  private service = new HrLeaveNodeService();
