import { HrLeaveConfigService } from "../../../../core-engine/src/hr/leave/services/HrLeaveConfigService";

export class HrLeaveConfigController {
  private service = new HrLeaveConfigService();
