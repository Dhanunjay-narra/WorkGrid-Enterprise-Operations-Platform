import { HrAttendanceReportService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceReportService";

export class HrAttendanceReportController {
  private service = new HrAttendanceReportService();
