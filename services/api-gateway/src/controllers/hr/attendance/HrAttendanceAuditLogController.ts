import { HrAttendanceAuditLogService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceAuditLogService";

export class HrAttendanceAuditLogController {
  private service = new HrAttendanceAuditLogService();
