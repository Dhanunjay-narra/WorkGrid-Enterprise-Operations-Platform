import { HrAttendanceRecordService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceRecordService";

export class HrAttendanceRecordController {
  private service = new HrAttendanceRecordService();
