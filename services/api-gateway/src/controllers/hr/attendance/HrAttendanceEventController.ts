import { HrAttendanceEventService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceEventService";

export class HrAttendanceEventController {
  private service = new HrAttendanceEventService();
