import { HrAttendancePolicyService } from "../../../../core-engine/src/hr/attendance/services/HrAttendancePolicyService";

export class HrAttendancePolicyController {
  private service = new HrAttendancePolicyService();
