import { HrAttendancePayloadService } from "../../../../core-engine/src/hr/attendance/services/HrAttendancePayloadService";

export class HrAttendancePayloadController {
  private service = new HrAttendancePayloadService();
