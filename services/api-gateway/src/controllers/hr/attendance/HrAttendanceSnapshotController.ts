import { HrAttendanceSnapshotService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceSnapshotService";

export class HrAttendanceSnapshotController {
  private service = new HrAttendanceSnapshotService();
