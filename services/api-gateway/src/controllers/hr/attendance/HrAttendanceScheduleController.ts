import { HrAttendanceScheduleService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceScheduleService";

export class HrAttendanceScheduleController {
  private service = new HrAttendanceScheduleService();
