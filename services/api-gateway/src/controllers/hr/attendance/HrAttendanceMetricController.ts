import { HrAttendanceMetricService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceMetricService";

export class HrAttendanceMetricController {
  private service = new HrAttendanceMetricService();
