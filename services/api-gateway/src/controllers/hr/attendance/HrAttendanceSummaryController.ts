import { HrAttendanceSummaryService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceSummaryService";

export class HrAttendanceSummaryController {
  private service = new HrAttendanceSummaryService();
