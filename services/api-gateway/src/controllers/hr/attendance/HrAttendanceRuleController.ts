import { HrAttendanceRuleService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceRuleService";

export class HrAttendanceRuleController {
  private service = new HrAttendanceRuleService();
