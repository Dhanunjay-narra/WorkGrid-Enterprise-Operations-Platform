import { HrAttendanceNodeService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceNodeService";

export class HrAttendanceNodeController {
  private service = new HrAttendanceNodeService();
