import { HrAttendanceProfileService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceProfileService";

export class HrAttendanceProfileController {
  private service = new HrAttendanceProfileService();
