import { HrAttendanceItemService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceItemService";

export class HrAttendanceItemController {
  private service = new HrAttendanceItemService();
