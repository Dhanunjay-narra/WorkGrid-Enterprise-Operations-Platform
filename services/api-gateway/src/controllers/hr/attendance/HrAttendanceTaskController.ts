import { HrAttendanceTaskService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceTaskService";

export class HrAttendanceTaskController {
  private service = new HrAttendanceTaskService();
