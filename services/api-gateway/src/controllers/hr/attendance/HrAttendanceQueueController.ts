import { HrAttendanceQueueService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceQueueService";

export class HrAttendanceQueueController {
  private service = new HrAttendanceQueueService();
