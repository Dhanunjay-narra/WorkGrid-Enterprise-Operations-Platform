import { HrAttendanceConfigService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceConfigService";

export class HrAttendanceConfigController {
  private service = new HrAttendanceConfigService();
