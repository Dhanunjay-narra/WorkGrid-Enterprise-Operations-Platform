import { HrAttendanceEntryService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceEntryService";

export class HrAttendanceEntryController {
  private service = new HrAttendanceEntryService();
