import { HrAttendanceSessionService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceSessionService";

export class HrAttendanceSessionController {
  private service = new HrAttendanceSessionService();
