import { HrAttendanceBatchService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceBatchService";

export class HrAttendanceBatchController {
  private service = new HrAttendanceBatchService();
