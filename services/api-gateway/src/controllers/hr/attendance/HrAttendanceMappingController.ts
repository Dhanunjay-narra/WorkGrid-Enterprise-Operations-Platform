import { HrAttendanceMappingService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceMappingService";

export class HrAttendanceMappingController {
  private service = new HrAttendanceMappingService();
