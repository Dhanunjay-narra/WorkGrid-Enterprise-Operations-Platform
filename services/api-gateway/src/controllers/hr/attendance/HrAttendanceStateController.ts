import { HrAttendanceStateService } from "../../../../core-engine/src/hr/attendance/services/HrAttendanceStateService";

export class HrAttendanceStateController {
  private service = new HrAttendanceStateService();
