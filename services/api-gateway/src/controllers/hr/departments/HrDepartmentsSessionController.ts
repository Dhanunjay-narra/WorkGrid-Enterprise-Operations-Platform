import { HrDepartmentsSessionService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsSessionService";

export class HrDepartmentsSessionController {
  private service = new HrDepartmentsSessionService();
