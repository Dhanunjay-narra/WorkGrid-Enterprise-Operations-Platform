import { HrDepartmentsSummaryService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsSummaryService";

export class HrDepartmentsSummaryController {
  private service = new HrDepartmentsSummaryService();
