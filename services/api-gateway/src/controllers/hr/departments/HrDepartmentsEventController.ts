import { HrDepartmentsEventService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsEventService";

export class HrDepartmentsEventController {
  private service = new HrDepartmentsEventService();
