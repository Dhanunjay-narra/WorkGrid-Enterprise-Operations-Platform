import { HrDepartmentsQueueService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsQueueService";

export class HrDepartmentsQueueController {
  private service = new HrDepartmentsQueueService();
