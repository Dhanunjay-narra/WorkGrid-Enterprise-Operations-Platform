import { HrDepartmentsNodeService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsNodeService";

export class HrDepartmentsNodeController {
  private service = new HrDepartmentsNodeService();
