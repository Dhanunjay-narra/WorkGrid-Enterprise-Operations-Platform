import { HrDepartmentsReportService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsReportService";

export class HrDepartmentsReportController {
  private service = new HrDepartmentsReportService();
