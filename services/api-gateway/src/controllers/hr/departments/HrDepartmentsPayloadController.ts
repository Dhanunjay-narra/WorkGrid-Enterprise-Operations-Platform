import { HrDepartmentsPayloadService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsPayloadService";

export class HrDepartmentsPayloadController {
  private service = new HrDepartmentsPayloadService();
