import { HrDepartmentsRecordService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsRecordService";

export class HrDepartmentsRecordController {
  private service = new HrDepartmentsRecordService();
