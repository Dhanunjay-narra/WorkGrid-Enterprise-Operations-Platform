import { HrDepartmentsItemService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsItemService";

export class HrDepartmentsItemController {
  private service = new HrDepartmentsItemService();
