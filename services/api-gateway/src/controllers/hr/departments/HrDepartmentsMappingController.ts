import { HrDepartmentsMappingService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsMappingService";

export class HrDepartmentsMappingController {
  private service = new HrDepartmentsMappingService();
