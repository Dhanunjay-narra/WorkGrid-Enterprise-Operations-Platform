import { HrDepartmentsEntryService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsEntryService";

export class HrDepartmentsEntryController {
  private service = new HrDepartmentsEntryService();
