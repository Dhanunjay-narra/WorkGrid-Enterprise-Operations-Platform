import { HrDepartmentsTaskService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsTaskService";

export class HrDepartmentsTaskController {
  private service = new HrDepartmentsTaskService();
