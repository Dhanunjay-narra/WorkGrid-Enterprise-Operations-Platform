import { HrDepartmentsPolicyService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsPolicyService";

export class HrDepartmentsPolicyController {
  private service = new HrDepartmentsPolicyService();
