import { HrDepartmentsConfigService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsConfigService";

export class HrDepartmentsConfigController {
  private service = new HrDepartmentsConfigService();
