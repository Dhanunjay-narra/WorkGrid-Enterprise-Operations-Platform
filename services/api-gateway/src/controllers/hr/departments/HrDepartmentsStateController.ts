import { HrDepartmentsStateService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsStateService";

export class HrDepartmentsStateController {
  private service = new HrDepartmentsStateService();
