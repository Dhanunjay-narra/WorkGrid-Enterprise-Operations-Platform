import { HrDepartmentsProfileService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsProfileService";

export class HrDepartmentsProfileController {
  private service = new HrDepartmentsProfileService();
