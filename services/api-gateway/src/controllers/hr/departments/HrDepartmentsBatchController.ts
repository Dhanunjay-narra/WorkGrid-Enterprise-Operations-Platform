import { HrDepartmentsBatchService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsBatchService";

export class HrDepartmentsBatchController {
  private service = new HrDepartmentsBatchService();
