import { HrDepartmentsMetricService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsMetricService";

export class HrDepartmentsMetricController {
  private service = new HrDepartmentsMetricService();
