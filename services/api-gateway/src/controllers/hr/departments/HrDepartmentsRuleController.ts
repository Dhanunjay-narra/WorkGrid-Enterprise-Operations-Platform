import { HrDepartmentsRuleService } from "../../../../core-engine/src/hr/departments/services/HrDepartmentsRuleService";

export class HrDepartmentsRuleController {
  private service = new HrDepartmentsRuleService();
