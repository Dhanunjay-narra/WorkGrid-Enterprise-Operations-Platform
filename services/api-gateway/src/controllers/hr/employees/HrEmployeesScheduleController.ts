import { HrEmployeesScheduleService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesScheduleService";

export class HrEmployeesScheduleController {
  private service = new HrEmployeesScheduleService();
