import { HrEmployeesSummaryService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesSummaryService";

export class HrEmployeesSummaryController {
  private service = new HrEmployeesSummaryService();
