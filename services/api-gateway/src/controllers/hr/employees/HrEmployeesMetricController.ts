import { HrEmployeesMetricService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesMetricService";

export class HrEmployeesMetricController {
  private service = new HrEmployeesMetricService();
