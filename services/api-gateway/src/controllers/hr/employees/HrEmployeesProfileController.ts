import { HrEmployeesProfileService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesProfileService";

export class HrEmployeesProfileController {
  private service = new HrEmployeesProfileService();
