import { HrEmployeesRuleService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesRuleService";

export class HrEmployeesRuleController {
  private service = new HrEmployeesRuleService();
