import { HrEmployeesReportService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesReportService";

export class HrEmployeesReportController {
  private service = new HrEmployeesReportService();
