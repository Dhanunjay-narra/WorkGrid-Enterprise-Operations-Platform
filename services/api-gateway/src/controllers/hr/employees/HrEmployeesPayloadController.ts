import { HrEmployeesPayloadService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesPayloadService";

export class HrEmployeesPayloadController {
  private service = new HrEmployeesPayloadService();
