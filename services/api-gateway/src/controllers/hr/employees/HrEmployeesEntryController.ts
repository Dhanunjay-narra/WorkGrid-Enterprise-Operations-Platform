import { HrEmployeesEntryService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesEntryService";

export class HrEmployeesEntryController {
  private service = new HrEmployeesEntryService();
