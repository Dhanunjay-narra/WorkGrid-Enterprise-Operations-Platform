import { HrEmployeesItemService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesItemService";

export class HrEmployeesItemController {
  private service = new HrEmployeesItemService();
