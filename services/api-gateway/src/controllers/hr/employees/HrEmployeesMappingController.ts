import { HrEmployeesMappingService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesMappingService";

export class HrEmployeesMappingController {
  private service = new HrEmployeesMappingService();
