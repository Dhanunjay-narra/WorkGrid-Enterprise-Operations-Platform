import { HrEmployeesPolicyService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesPolicyService";

export class HrEmployeesPolicyController {
  private service = new HrEmployeesPolicyService();
