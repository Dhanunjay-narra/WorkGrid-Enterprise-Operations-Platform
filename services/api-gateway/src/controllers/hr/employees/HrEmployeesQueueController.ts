import { HrEmployeesQueueService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesQueueService";

export class HrEmployeesQueueController {
  private service = new HrEmployeesQueueService();
