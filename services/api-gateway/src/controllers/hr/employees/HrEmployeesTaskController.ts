import { HrEmployeesTaskService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesTaskService";

export class HrEmployeesTaskController {
  private service = new HrEmployeesTaskService();
