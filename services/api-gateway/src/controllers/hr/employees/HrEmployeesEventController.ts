import { HrEmployeesEventService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesEventService";

export class HrEmployeesEventController {
  private service = new HrEmployeesEventService();
