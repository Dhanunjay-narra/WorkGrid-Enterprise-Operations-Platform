import { HrEmployeesConfigService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesConfigService";

export class HrEmployeesConfigController {
  private service = new HrEmployeesConfigService();
