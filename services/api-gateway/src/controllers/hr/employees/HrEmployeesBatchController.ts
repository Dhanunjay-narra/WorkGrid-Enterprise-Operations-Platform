import { HrEmployeesBatchService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesBatchService";

export class HrEmployeesBatchController {
  private service = new HrEmployeesBatchService();
