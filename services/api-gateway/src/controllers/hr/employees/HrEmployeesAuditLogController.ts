import { HrEmployeesAuditLogService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesAuditLogService";

export class HrEmployeesAuditLogController {
  private service = new HrEmployeesAuditLogService();
