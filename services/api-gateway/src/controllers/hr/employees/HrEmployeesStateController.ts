import { HrEmployeesStateService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesStateService";

export class HrEmployeesStateController {
  private service = new HrEmployeesStateService();
