import { HrEmployeesThresholdService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesThresholdService";

export class HrEmployeesThresholdController {
  private service = new HrEmployeesThresholdService();
