import { HrEmployeesSnapshotService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesSnapshotService";

export class HrEmployeesSnapshotController {
  private service = new HrEmployeesSnapshotService();
