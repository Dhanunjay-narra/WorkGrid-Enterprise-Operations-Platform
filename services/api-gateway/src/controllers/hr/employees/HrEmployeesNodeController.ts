import { HrEmployeesNodeService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesNodeService";

export class HrEmployeesNodeController {
  private service = new HrEmployeesNodeService();
