import { HrEmployeesRecordService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesRecordService";

export class HrEmployeesRecordController {
  private service = new HrEmployeesRecordService();
