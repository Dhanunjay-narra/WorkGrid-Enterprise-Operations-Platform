import { HrEmployeesSessionService } from "../../../../core-engine/src/hr/employees/services/HrEmployeesSessionService";

export class HrEmployeesSessionController {
  private service = new HrEmployeesSessionService();
