import { HrPerformanceEntryService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceEntryService";

export class HrPerformanceEntryController {
  private service = new HrPerformanceEntryService();
