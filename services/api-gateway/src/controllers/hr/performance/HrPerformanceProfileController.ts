import { HrPerformanceProfileService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceProfileService";

export class HrPerformanceProfileController {
  private service = new HrPerformanceProfileService();
