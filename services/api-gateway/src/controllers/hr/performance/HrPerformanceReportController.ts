import { HrPerformanceReportService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceReportService";

export class HrPerformanceReportController {
  private service = new HrPerformanceReportService();
