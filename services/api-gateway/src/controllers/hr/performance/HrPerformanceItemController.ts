import { HrPerformanceItemService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceItemService";

export class HrPerformanceItemController {
  private service = new HrPerformanceItemService();
