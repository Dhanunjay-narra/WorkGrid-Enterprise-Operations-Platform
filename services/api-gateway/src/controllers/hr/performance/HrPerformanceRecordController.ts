import { HrPerformanceRecordService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceRecordService";

export class HrPerformanceRecordController {
  private service = new HrPerformanceRecordService();
