import { HrPerformanceEventService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceEventService";

export class HrPerformanceEventController {
  private service = new HrPerformanceEventService();
