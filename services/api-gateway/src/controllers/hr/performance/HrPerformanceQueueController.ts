import { HrPerformanceQueueService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceQueueService";

export class HrPerformanceQueueController {
  private service = new HrPerformanceQueueService();
