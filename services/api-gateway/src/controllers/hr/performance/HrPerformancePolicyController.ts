import { HrPerformancePolicyService } from "../../../../core-engine/src/hr/performance/services/HrPerformancePolicyService";

export class HrPerformancePolicyController {
  private service = new HrPerformancePolicyService();
