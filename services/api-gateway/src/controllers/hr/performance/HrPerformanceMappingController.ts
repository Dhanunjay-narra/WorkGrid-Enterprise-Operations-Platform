import { HrPerformanceMappingService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceMappingService";

export class HrPerformanceMappingController {
  private service = new HrPerformanceMappingService();
