import { HrPerformanceStateService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceStateService";

export class HrPerformanceStateController {
  private service = new HrPerformanceStateService();
