import { HrPerformanceSessionService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceSessionService";

export class HrPerformanceSessionController {
  private service = new HrPerformanceSessionService();
