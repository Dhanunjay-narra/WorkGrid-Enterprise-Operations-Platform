import { HrPerformanceRuleService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceRuleService";

export class HrPerformanceRuleController {
  private service = new HrPerformanceRuleService();
