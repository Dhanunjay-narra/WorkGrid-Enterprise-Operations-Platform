import { HrPerformanceBatchService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceBatchService";

export class HrPerformanceBatchController {
  private service = new HrPerformanceBatchService();
