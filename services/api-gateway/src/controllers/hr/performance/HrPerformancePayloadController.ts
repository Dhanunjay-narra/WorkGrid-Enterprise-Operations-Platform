import { HrPerformancePayloadService } from "../../../../core-engine/src/hr/performance/services/HrPerformancePayloadService";

export class HrPerformancePayloadController {
  private service = new HrPerformancePayloadService();
