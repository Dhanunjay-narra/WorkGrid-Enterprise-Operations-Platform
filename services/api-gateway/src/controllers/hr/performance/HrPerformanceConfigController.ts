import { HrPerformanceConfigService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceConfigService";

export class HrPerformanceConfigController {
  private service = new HrPerformanceConfigService();
