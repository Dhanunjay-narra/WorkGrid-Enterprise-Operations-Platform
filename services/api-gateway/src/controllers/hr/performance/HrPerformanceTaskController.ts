import { HrPerformanceTaskService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceTaskService";

export class HrPerformanceTaskController {
  private service = new HrPerformanceTaskService();
