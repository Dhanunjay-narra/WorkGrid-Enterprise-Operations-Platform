import { HrPerformanceMetricService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceMetricService";

export class HrPerformanceMetricController {
  private service = new HrPerformanceMetricService();
