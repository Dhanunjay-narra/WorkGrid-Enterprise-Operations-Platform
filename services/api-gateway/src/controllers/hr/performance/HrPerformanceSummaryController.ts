import { HrPerformanceSummaryService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceSummaryService";

export class HrPerformanceSummaryController {
  private service = new HrPerformanceSummaryService();
