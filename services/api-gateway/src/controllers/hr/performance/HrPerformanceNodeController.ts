import { HrPerformanceNodeService } from "../../../../core-engine/src/hr/performance/services/HrPerformanceNodeService";

export class HrPerformanceNodeController {
  private service = new HrPerformanceNodeService();
