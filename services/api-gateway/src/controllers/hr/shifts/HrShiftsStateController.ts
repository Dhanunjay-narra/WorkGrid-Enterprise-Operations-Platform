import { HrShiftsStateService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsStateService";

export class HrShiftsStateController {
  private service = new HrShiftsStateService();
