import { HrShiftsEntryService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsEntryService";

export class HrShiftsEntryController {
  private service = new HrShiftsEntryService();
