import { HrShiftsTransactionService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsTransactionService";

export class HrShiftsTransactionController {
  private service = new HrShiftsTransactionService();
