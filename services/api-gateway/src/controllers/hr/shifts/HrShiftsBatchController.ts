import { HrShiftsBatchService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsBatchService";

export class HrShiftsBatchController {
  private service = new HrShiftsBatchService();
