import { HrShiftsPayloadService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsPayloadService";

export class HrShiftsPayloadController {
  private service = new HrShiftsPayloadService();
