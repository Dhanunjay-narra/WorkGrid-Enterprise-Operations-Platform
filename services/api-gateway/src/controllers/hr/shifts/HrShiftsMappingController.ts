import { HrShiftsMappingService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsMappingService";

export class HrShiftsMappingController {
  private service = new HrShiftsMappingService();
