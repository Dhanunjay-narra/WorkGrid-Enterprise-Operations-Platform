import { HrShiftsItemService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsItemService";

export class HrShiftsItemController {
  private service = new HrShiftsItemService();
