import { HrShiftsConfigService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsConfigService";

export class HrShiftsConfigController {
  private service = new HrShiftsConfigService();
