import { HrShiftsQueueService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsQueueService";

export class HrShiftsQueueController {
  private service = new HrShiftsQueueService();
