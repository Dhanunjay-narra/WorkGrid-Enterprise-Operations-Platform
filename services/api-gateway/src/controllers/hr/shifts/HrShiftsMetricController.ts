import { HrShiftsMetricService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsMetricService";

export class HrShiftsMetricController {
  private service = new HrShiftsMetricService();
