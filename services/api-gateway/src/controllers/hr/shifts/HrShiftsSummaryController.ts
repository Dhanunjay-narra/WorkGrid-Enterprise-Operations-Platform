import { HrShiftsSummaryService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsSummaryService";

export class HrShiftsSummaryController {
  private service = new HrShiftsSummaryService();
