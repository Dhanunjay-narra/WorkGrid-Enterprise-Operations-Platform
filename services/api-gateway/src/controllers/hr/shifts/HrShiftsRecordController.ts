import { HrShiftsRecordService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsRecordService";

export class HrShiftsRecordController {
  private service = new HrShiftsRecordService();
