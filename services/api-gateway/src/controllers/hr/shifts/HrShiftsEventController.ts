import { HrShiftsEventService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsEventService";

export class HrShiftsEventController {
  private service = new HrShiftsEventService();
