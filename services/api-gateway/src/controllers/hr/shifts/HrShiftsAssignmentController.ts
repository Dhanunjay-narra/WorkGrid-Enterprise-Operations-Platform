import { HrShiftsAssignmentService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsAssignmentService";

export class HrShiftsAssignmentController {
  private service = new HrShiftsAssignmentService();
