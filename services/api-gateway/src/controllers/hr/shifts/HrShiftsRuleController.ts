import { HrShiftsRuleService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsRuleService";

export class HrShiftsRuleController {
  private service = new HrShiftsRuleService();
