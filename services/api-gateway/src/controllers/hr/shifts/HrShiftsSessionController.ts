import { HrShiftsSessionService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsSessionService";

export class HrShiftsSessionController {
  private service = new HrShiftsSessionService();
