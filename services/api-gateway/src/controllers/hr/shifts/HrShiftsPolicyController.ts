import { HrShiftsPolicyService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsPolicyService";

export class HrShiftsPolicyController {
  private service = new HrShiftsPolicyService();
