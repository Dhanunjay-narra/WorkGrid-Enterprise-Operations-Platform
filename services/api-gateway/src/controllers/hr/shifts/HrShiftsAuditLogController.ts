import { HrShiftsAuditLogService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsAuditLogService";

export class HrShiftsAuditLogController {
  private service = new HrShiftsAuditLogService();
