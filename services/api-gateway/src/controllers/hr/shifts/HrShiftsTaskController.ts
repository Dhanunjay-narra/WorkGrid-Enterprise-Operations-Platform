import { HrShiftsTaskService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsTaskService";

export class HrShiftsTaskController {
  private service = new HrShiftsTaskService();
