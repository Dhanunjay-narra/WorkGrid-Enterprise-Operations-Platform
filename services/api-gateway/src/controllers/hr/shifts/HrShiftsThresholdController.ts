import { HrShiftsThresholdService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsThresholdService";

export class HrShiftsThresholdController {
  private service = new HrShiftsThresholdService();
