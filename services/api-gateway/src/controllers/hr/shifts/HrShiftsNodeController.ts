import { HrShiftsNodeService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsNodeService";

export class HrShiftsNodeController {
  private service = new HrShiftsNodeService();
