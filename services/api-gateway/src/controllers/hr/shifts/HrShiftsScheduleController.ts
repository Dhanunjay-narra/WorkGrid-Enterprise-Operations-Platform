import { HrShiftsScheduleService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsScheduleService";

export class HrShiftsScheduleController {
  private service = new HrShiftsScheduleService();
