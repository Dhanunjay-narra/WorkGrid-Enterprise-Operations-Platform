import { HrShiftsProfileService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsProfileService";

export class HrShiftsProfileController {
  private service = new HrShiftsProfileService();
