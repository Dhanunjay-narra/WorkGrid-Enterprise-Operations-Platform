import { HrShiftsSnapshotService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsSnapshotService";

export class HrShiftsSnapshotController {
  private service = new HrShiftsSnapshotService();
