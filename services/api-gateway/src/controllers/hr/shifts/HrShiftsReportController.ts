import { HrShiftsReportService } from "../../../../core-engine/src/hr/shifts/services/HrShiftsReportService";

export class HrShiftsReportController {
  private service = new HrShiftsReportService();
