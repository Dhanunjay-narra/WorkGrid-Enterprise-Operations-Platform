import { HrPayrollBatchService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollBatchService";

export class HrPayrollBatchController {
  private service = new HrPayrollBatchService();
