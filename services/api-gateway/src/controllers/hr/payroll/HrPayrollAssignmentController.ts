import { HrPayrollAssignmentService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollAssignmentService";

export class HrPayrollAssignmentController {
  private service = new HrPayrollAssignmentService();
