import { HrPayrollRecordService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollRecordService";

export class HrPayrollRecordController {
  private service = new HrPayrollRecordService();
