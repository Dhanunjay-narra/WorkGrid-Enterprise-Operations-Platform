import { HrPayrollTransactionService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollTransactionService";

export class HrPayrollTransactionController {
  private service = new HrPayrollTransactionService();
