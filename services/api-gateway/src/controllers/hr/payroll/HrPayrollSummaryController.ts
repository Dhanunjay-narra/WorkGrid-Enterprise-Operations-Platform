import { HrPayrollSummaryService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollSummaryService";

export class HrPayrollSummaryController {
  private service = new HrPayrollSummaryService();
