import { HrPayrollSnapshotService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollSnapshotService";

export class HrPayrollSnapshotController {
  private service = new HrPayrollSnapshotService();
