import { HrPayrollThresholdService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollThresholdService";

export class HrPayrollThresholdController {
  private service = new HrPayrollThresholdService();
