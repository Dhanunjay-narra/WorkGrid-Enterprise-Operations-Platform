import { HrPayrollEventService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollEventService";

export class HrPayrollEventController {
  private service = new HrPayrollEventService();
