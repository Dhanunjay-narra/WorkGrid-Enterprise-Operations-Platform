import { HrPayrollNodeService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollNodeService";

export class HrPayrollNodeController {
  private service = new HrPayrollNodeService();
