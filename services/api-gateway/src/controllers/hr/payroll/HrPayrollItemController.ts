import { HrPayrollItemService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollItemService";

export class HrPayrollItemController {
  private service = new HrPayrollItemService();
