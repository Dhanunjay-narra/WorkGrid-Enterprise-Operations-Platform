import { HrPayrollStateService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollStateService";

export class HrPayrollStateController {
  private service = new HrPayrollStateService();
