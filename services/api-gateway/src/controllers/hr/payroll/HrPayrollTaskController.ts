import { HrPayrollTaskService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollTaskService";

export class HrPayrollTaskController {
  private service = new HrPayrollTaskService();
