import { HrPayrollRuleService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollRuleService";

export class HrPayrollRuleController {
  private service = new HrPayrollRuleService();
