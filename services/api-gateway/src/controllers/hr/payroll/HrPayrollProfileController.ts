import { HrPayrollProfileService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollProfileService";

export class HrPayrollProfileController {
  private service = new HrPayrollProfileService();
