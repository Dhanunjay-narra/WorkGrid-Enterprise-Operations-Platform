import { HrPayrollEntryService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollEntryService";

export class HrPayrollEntryController {
  private service = new HrPayrollEntryService();
