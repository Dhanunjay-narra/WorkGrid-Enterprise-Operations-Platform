import { HrPayrollReportService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollReportService";

export class HrPayrollReportController {
  private service = new HrPayrollReportService();
