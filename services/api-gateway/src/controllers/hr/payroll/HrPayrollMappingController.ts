import { HrPayrollMappingService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollMappingService";

export class HrPayrollMappingController {
  private service = new HrPayrollMappingService();
