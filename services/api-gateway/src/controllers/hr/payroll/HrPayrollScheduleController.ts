import { HrPayrollScheduleService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollScheduleService";

export class HrPayrollScheduleController {
  private service = new HrPayrollScheduleService();
