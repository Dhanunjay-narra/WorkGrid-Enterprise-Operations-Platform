import { HrPayrollQueueService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollQueueService";

export class HrPayrollQueueController {
  private service = new HrPayrollQueueService();
