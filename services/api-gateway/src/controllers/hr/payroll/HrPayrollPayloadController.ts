import { HrPayrollPayloadService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollPayloadService";

export class HrPayrollPayloadController {
  private service = new HrPayrollPayloadService();
