import { HrPayrollMetricService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollMetricService";

export class HrPayrollMetricController {
  private service = new HrPayrollMetricService();
