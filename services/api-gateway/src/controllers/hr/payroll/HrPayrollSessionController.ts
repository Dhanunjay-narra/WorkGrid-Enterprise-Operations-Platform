import { HrPayrollSessionService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollSessionService";

export class HrPayrollSessionController {
  private service = new HrPayrollSessionService();
