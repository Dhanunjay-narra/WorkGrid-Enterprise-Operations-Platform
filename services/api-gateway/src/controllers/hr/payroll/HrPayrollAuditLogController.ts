import { HrPayrollAuditLogService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollAuditLogService";

export class HrPayrollAuditLogController {
  private service = new HrPayrollAuditLogService();
