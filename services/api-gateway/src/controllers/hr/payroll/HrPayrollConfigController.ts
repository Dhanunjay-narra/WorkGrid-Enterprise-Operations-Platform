import { HrPayrollConfigService } from "../../../../core-engine/src/hr/payroll/services/HrPayrollConfigService";

export class HrPayrollConfigController {
  private service = new HrPayrollConfigService();
