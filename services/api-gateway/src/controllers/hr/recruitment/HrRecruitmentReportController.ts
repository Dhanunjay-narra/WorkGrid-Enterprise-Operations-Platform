import { HrRecruitmentReportService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentReportService";

export class HrRecruitmentReportController {
  private service = new HrRecruitmentReportService();
