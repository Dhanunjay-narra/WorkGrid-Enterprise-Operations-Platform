import { HrRecruitmentPolicyService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentPolicyService";

export class HrRecruitmentPolicyController {
  private service = new HrRecruitmentPolicyService();
