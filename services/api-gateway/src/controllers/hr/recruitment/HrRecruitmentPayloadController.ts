import { HrRecruitmentPayloadService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentPayloadService";

export class HrRecruitmentPayloadController {
  private service = new HrRecruitmentPayloadService();
