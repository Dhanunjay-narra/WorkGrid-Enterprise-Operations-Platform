import { HrRecruitmentQueueService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentQueueService";

export class HrRecruitmentQueueController {
  private service = new HrRecruitmentQueueService();
