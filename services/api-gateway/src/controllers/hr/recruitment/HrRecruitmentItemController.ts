import { HrRecruitmentItemService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentItemService";

export class HrRecruitmentItemController {
  private service = new HrRecruitmentItemService();
