import { HrRecruitmentNodeService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentNodeService";

export class HrRecruitmentNodeController {
  private service = new HrRecruitmentNodeService();
