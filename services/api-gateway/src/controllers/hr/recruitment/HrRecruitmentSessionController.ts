import { HrRecruitmentSessionService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentSessionService";

export class HrRecruitmentSessionController {
  private service = new HrRecruitmentSessionService();
