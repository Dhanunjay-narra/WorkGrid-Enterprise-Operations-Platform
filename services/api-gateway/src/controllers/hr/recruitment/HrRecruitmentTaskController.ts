import { HrRecruitmentTaskService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentTaskService";

export class HrRecruitmentTaskController {
  private service = new HrRecruitmentTaskService();
