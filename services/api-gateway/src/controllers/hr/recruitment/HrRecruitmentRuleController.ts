import { HrRecruitmentRuleService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentRuleService";

export class HrRecruitmentRuleController {
  private service = new HrRecruitmentRuleService();
