import { HrRecruitmentEventService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentEventService";

export class HrRecruitmentEventController {
  private service = new HrRecruitmentEventService();
