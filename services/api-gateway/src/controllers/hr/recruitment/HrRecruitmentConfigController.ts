import { HrRecruitmentConfigService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentConfigService";

export class HrRecruitmentConfigController {
  private service = new HrRecruitmentConfigService();
