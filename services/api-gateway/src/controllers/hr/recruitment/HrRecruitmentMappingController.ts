import { HrRecruitmentMappingService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentMappingService";

export class HrRecruitmentMappingController {
  private service = new HrRecruitmentMappingService();
