import { HrRecruitmentEntryService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentEntryService";

export class HrRecruitmentEntryController {
  private service = new HrRecruitmentEntryService();
