import { HrRecruitmentBatchService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentBatchService";

export class HrRecruitmentBatchController {
  private service = new HrRecruitmentBatchService();
