import { HrRecruitmentSummaryService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentSummaryService";

export class HrRecruitmentSummaryController {
  private service = new HrRecruitmentSummaryService();
