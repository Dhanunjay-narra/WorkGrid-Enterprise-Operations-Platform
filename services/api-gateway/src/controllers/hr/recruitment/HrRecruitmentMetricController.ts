import { HrRecruitmentMetricService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentMetricService";

export class HrRecruitmentMetricController {
  private service = new HrRecruitmentMetricService();
