import { HrRecruitmentProfileService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentProfileService";

export class HrRecruitmentProfileController {
  private service = new HrRecruitmentProfileService();
