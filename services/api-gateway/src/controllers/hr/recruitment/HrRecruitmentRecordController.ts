import { HrRecruitmentRecordService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentRecordService";

export class HrRecruitmentRecordController {
  private service = new HrRecruitmentRecordService();
