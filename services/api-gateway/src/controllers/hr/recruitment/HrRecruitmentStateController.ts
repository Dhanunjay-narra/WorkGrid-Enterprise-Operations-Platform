import { HrRecruitmentStateService } from "../../../../core-engine/src/hr/recruitment/services/HrRecruitmentStateService";

export class HrRecruitmentStateController {
  private service = new HrRecruitmentStateService();
