import { WorkflowNodesTaskService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesTaskService";

export class WorkflowNodesTaskController {
  private service = new WorkflowNodesTaskService();
