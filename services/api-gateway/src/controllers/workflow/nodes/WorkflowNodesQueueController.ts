import { WorkflowNodesQueueService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesQueueService";

export class WorkflowNodesQueueController {
  private service = new WorkflowNodesQueueService();
