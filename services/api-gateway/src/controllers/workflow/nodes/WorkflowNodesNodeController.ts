import { WorkflowNodesNodeService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesNodeService";

export class WorkflowNodesNodeController {
  private service = new WorkflowNodesNodeService();
