import { WorkflowNodesStateService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesStateService";

export class WorkflowNodesStateController {
  private service = new WorkflowNodesStateService();
