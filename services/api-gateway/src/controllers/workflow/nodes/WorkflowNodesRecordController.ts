import { WorkflowNodesRecordService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesRecordService";

export class WorkflowNodesRecordController {
  private service = new WorkflowNodesRecordService();
