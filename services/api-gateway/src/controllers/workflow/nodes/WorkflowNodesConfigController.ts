import { WorkflowNodesConfigService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesConfigService";

export class WorkflowNodesConfigController {
  private service = new WorkflowNodesConfigService();
