import { WorkflowNodesItemService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesItemService";

export class WorkflowNodesItemController {
  private service = new WorkflowNodesItemService();
