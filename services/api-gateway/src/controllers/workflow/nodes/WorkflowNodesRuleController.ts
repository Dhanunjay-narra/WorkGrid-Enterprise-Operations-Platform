import { WorkflowNodesRuleService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesRuleService";

export class WorkflowNodesRuleController {
  private service = new WorkflowNodesRuleService();
