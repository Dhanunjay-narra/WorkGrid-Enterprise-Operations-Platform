import { WorkflowNodesProfileService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesProfileService";

export class WorkflowNodesProfileController {
  private service = new WorkflowNodesProfileService();
