import { WorkflowNodesBatchService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesBatchService";

export class WorkflowNodesBatchController {
  private service = new WorkflowNodesBatchService();
