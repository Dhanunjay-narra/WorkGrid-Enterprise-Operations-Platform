import { WorkflowNodesEntryService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesEntryService";

export class WorkflowNodesEntryController {
  private service = new WorkflowNodesEntryService();
