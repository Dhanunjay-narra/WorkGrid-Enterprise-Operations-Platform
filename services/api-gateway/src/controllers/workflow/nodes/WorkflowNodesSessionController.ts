import { WorkflowNodesSessionService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesSessionService";

export class WorkflowNodesSessionController {
  private service = new WorkflowNodesSessionService();
