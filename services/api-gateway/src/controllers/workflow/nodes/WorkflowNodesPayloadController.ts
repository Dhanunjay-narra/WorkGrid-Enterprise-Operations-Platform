import { WorkflowNodesPayloadService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesPayloadService";

export class WorkflowNodesPayloadController {
  private service = new WorkflowNodesPayloadService();
