import { WorkflowNodesEventService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesEventService";

export class WorkflowNodesEventController {
  private service = new WorkflowNodesEventService();
