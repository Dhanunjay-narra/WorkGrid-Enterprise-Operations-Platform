import { WorkflowNodesPolicyService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesPolicyService";

export class WorkflowNodesPolicyController {
  private service = new WorkflowNodesPolicyService();
