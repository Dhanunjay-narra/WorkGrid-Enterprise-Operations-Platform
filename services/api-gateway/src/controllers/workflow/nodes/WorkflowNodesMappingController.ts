import { WorkflowNodesMappingService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesMappingService";

export class WorkflowNodesMappingController {
  private service = new WorkflowNodesMappingService();
