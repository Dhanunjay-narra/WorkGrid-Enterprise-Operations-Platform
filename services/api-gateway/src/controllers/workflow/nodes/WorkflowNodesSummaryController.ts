import { WorkflowNodesSummaryService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesSummaryService";

export class WorkflowNodesSummaryController {
  private service = new WorkflowNodesSummaryService();
