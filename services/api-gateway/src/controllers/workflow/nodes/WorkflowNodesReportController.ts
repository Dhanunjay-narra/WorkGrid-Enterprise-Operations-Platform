import { WorkflowNodesReportService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesReportService";

export class WorkflowNodesReportController {
  private service = new WorkflowNodesReportService();
