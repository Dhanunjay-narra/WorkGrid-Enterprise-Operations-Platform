import { WorkflowNodesMetricService } from "../../../../core-engine/src/workflow/nodes/services/WorkflowNodesMetricService";

export class WorkflowNodesMetricController {
  private service = new WorkflowNodesMetricService();
