import { WorkflowCronsRuleService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsRuleService";

export class WorkflowCronsRuleController {
  private service = new WorkflowCronsRuleService();
