import { WorkflowCronsMetricService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsMetricService";

export class WorkflowCronsMetricController {
  private service = new WorkflowCronsMetricService();
