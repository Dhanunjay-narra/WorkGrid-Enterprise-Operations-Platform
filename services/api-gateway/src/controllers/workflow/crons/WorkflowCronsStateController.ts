import { WorkflowCronsStateService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsStateService";

export class WorkflowCronsStateController {
  private service = new WorkflowCronsStateService();
