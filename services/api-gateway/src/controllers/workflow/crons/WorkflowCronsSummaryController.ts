import { WorkflowCronsSummaryService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsSummaryService";

export class WorkflowCronsSummaryController {
  private service = new WorkflowCronsSummaryService();
