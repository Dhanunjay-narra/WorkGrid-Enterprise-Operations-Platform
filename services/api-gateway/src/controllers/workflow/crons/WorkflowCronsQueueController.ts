import { WorkflowCronsQueueService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsQueueService";

export class WorkflowCronsQueueController {
  private service = new WorkflowCronsQueueService();
