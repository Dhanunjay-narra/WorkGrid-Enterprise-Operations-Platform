import { WorkflowCronsRecordService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsRecordService";

export class WorkflowCronsRecordController {
  private service = new WorkflowCronsRecordService();
