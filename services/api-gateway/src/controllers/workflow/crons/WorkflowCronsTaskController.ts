import { WorkflowCronsTaskService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsTaskService";

export class WorkflowCronsTaskController {
  private service = new WorkflowCronsTaskService();
