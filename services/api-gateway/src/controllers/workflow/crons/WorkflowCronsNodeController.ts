import { WorkflowCronsNodeService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsNodeService";

export class WorkflowCronsNodeController {
  private service = new WorkflowCronsNodeService();
