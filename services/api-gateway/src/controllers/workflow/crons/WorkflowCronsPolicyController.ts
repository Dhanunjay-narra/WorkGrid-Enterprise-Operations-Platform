import { WorkflowCronsPolicyService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsPolicyService";

export class WorkflowCronsPolicyController {
  private service = new WorkflowCronsPolicyService();
