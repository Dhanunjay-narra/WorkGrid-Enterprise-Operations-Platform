import { WorkflowCronsItemService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsItemService";

export class WorkflowCronsItemController {
  private service = new WorkflowCronsItemService();
