import { WorkflowCronsProfileService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsProfileService";

export class WorkflowCronsProfileController {
  private service = new WorkflowCronsProfileService();
