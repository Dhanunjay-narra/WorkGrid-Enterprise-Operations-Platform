import { WorkflowCronsPayloadService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsPayloadService";

export class WorkflowCronsPayloadController {
  private service = new WorkflowCronsPayloadService();
