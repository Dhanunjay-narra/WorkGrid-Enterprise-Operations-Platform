import { WorkflowCronsConfigService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsConfigService";

export class WorkflowCronsConfigController {
  private service = new WorkflowCronsConfigService();
