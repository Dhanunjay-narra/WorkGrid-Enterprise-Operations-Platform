import { WorkflowCronsEntryService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsEntryService";

export class WorkflowCronsEntryController {
  private service = new WorkflowCronsEntryService();
