import { WorkflowCronsBatchService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsBatchService";

export class WorkflowCronsBatchController {
  private service = new WorkflowCronsBatchService();
