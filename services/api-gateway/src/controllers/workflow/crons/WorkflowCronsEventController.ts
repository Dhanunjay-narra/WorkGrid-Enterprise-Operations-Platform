import { WorkflowCronsEventService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsEventService";

export class WorkflowCronsEventController {
  private service = new WorkflowCronsEventService();
