import { WorkflowCronsReportService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsReportService";

export class WorkflowCronsReportController {
  private service = new WorkflowCronsReportService();
