import { WorkflowCronsSessionService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsSessionService";

export class WorkflowCronsSessionController {
  private service = new WorkflowCronsSessionService();
