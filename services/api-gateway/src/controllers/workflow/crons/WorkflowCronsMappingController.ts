import { WorkflowCronsMappingService } from "../../../../core-engine/src/workflow/crons/services/WorkflowCronsMappingService";

export class WorkflowCronsMappingController {
  private service = new WorkflowCronsMappingService();
