import { WorkflowRetriesNodeService } from "../../../../core-engine/src/workflow/retries/services/WorkflowRetriesNodeService";

export class WorkflowRetriesNodeController {
  private service = new WorkflowRetriesNodeService();
