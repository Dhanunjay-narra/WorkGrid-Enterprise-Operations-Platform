import { WorkflowRetriesItemService } from "../../../../core-engine/src/workflow/retries/services/WorkflowRetriesItemService";

export class WorkflowRetriesItemController {
  private service = new WorkflowRetriesItemService();
