import { WorkflowRetriesRuleService } from "../../../../core-engine/src/workflow/retries/services/WorkflowRetriesRuleService";

export class WorkflowRetriesRuleController {
  private service = new WorkflowRetriesRuleService();
