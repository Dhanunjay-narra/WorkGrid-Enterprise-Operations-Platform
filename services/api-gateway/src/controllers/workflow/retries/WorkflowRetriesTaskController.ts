import { WorkflowRetriesTaskService } from "../../../../core-engine/src/workflow/retries/services/WorkflowRetriesTaskService";

export class WorkflowRetriesTaskController {
  private service = new WorkflowRetriesTaskService();
