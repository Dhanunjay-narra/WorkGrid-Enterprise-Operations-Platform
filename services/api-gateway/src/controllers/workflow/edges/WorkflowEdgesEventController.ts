import { WorkflowEdgesEventService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesEventService";

export class WorkflowEdgesEventController {
  private service = new WorkflowEdgesEventService();
