import { WorkflowEdgesSessionService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesSessionService";

export class WorkflowEdgesSessionController {
  private service = new WorkflowEdgesSessionService();
