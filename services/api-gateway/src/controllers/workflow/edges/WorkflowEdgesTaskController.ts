import { WorkflowEdgesTaskService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesTaskService";

export class WorkflowEdgesTaskController {
  private service = new WorkflowEdgesTaskService();
