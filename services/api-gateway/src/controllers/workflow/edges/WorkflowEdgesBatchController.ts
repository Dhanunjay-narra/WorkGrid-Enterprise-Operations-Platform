import { WorkflowEdgesBatchService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesBatchService";

export class WorkflowEdgesBatchController {
  private service = new WorkflowEdgesBatchService();
