import { WorkflowEdgesQueueService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesQueueService";

export class WorkflowEdgesQueueController {
  private service = new WorkflowEdgesQueueService();
