import { WorkflowEdgesSummaryService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesSummaryService";

export class WorkflowEdgesSummaryController {
  private service = new WorkflowEdgesSummaryService();
