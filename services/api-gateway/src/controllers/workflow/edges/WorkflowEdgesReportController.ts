import { WorkflowEdgesReportService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesReportService";

export class WorkflowEdgesReportController {
  private service = new WorkflowEdgesReportService();
