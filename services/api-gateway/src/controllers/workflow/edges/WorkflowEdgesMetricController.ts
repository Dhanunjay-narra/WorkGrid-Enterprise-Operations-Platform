import { WorkflowEdgesMetricService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesMetricService";

export class WorkflowEdgesMetricController {
  private service = new WorkflowEdgesMetricService();
