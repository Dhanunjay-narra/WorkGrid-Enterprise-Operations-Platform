import { WorkflowEdgesRecordService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesRecordService";

export class WorkflowEdgesRecordController {
  private service = new WorkflowEdgesRecordService();
