import { WorkflowEdgesItemService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesItemService";

export class WorkflowEdgesItemController {
  private service = new WorkflowEdgesItemService();
