import { WorkflowEdgesConfigService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesConfigService";

export class WorkflowEdgesConfigController {
  private service = new WorkflowEdgesConfigService();
