import { WorkflowEdgesPolicyService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesPolicyService";

export class WorkflowEdgesPolicyController {
  private service = new WorkflowEdgesPolicyService();
