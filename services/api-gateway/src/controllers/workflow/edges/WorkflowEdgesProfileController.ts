import { WorkflowEdgesProfileService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesProfileService";

export class WorkflowEdgesProfileController {
  private service = new WorkflowEdgesProfileService();
