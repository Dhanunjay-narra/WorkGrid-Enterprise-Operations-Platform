import { WorkflowEdgesStateService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesStateService";

export class WorkflowEdgesStateController {
  private service = new WorkflowEdgesStateService();
