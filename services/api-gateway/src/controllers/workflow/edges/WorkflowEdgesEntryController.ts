import { WorkflowEdgesEntryService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesEntryService";

export class WorkflowEdgesEntryController {
  private service = new WorkflowEdgesEntryService();
