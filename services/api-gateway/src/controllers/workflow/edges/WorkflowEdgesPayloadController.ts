import { WorkflowEdgesPayloadService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesPayloadService";

export class WorkflowEdgesPayloadController {
  private service = new WorkflowEdgesPayloadService();
