import { WorkflowEdgesNodeService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesNodeService";

export class WorkflowEdgesNodeController {
  private service = new WorkflowEdgesNodeService();
