import { WorkflowEdgesRuleService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesRuleService";

export class WorkflowEdgesRuleController {
  private service = new WorkflowEdgesRuleService();
