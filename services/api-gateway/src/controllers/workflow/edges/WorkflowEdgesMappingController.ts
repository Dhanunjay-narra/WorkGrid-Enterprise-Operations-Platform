import { WorkflowEdgesMappingService } from "../../../../core-engine/src/workflow/edges/services/WorkflowEdgesMappingService";

export class WorkflowEdgesMappingController {
  private service = new WorkflowEdgesMappingService();
