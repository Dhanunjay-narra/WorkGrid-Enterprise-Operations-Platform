import { WorkflowDagProfileService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagProfileService";

export class WorkflowDagProfileController {
  private service = new WorkflowDagProfileService();
