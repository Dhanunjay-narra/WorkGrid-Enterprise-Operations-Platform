import { WorkflowDagAuditLogService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagAuditLogService";

export class WorkflowDagAuditLogController {
  private service = new WorkflowDagAuditLogService();
