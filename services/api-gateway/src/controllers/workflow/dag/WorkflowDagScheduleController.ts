import { WorkflowDagScheduleService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagScheduleService";

export class WorkflowDagScheduleController {
  private service = new WorkflowDagScheduleService();
