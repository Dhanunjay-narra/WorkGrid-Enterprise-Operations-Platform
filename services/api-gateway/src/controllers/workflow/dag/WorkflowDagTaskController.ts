import { WorkflowDagTaskService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagTaskService";

export class WorkflowDagTaskController {
  private service = new WorkflowDagTaskService();
