import { WorkflowDagThresholdService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagThresholdService";

export class WorkflowDagThresholdController {
  private service = new WorkflowDagThresholdService();
