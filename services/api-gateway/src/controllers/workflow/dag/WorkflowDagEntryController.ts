import { WorkflowDagEntryService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagEntryService";

export class WorkflowDagEntryController {
  private service = new WorkflowDagEntryService();
