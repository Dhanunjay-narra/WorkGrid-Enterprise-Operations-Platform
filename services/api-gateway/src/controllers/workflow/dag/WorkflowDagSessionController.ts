import { WorkflowDagSessionService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagSessionService";

export class WorkflowDagSessionController {
  private service = new WorkflowDagSessionService();
