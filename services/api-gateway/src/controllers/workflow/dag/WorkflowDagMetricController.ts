import { WorkflowDagMetricService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagMetricService";

export class WorkflowDagMetricController {
  private service = new WorkflowDagMetricService();
