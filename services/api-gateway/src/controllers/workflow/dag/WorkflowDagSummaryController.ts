import { WorkflowDagSummaryService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagSummaryService";

export class WorkflowDagSummaryController {
  private service = new WorkflowDagSummaryService();
