import { WorkflowDagConfigService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagConfigService";

export class WorkflowDagConfigController {
  private service = new WorkflowDagConfigService();
