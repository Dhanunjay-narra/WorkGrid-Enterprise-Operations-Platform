import { WorkflowDagQueueService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagQueueService";

export class WorkflowDagQueueController {
  private service = new WorkflowDagQueueService();
