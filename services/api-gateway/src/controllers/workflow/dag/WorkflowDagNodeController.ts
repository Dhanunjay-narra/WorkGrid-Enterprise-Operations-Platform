import { WorkflowDagNodeService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagNodeService";

export class WorkflowDagNodeController {
  private service = new WorkflowDagNodeService();
