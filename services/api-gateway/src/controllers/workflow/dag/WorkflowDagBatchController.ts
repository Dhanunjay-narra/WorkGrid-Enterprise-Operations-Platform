import { WorkflowDagBatchService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagBatchService";

export class WorkflowDagBatchController {
  private service = new WorkflowDagBatchService();
