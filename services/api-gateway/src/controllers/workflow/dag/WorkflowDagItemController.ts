import { WorkflowDagItemService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagItemService";

export class WorkflowDagItemController {
  private service = new WorkflowDagItemService();
