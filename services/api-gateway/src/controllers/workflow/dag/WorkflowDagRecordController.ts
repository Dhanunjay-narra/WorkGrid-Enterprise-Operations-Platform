import { WorkflowDagRecordService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagRecordService";

export class WorkflowDagRecordController {
  private service = new WorkflowDagRecordService();
