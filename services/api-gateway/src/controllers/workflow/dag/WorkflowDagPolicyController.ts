import { WorkflowDagPolicyService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagPolicyService";

export class WorkflowDagPolicyController {
  private service = new WorkflowDagPolicyService();
