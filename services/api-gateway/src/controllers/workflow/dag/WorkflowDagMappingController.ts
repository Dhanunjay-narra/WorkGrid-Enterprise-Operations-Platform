import { WorkflowDagMappingService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagMappingService";

export class WorkflowDagMappingController {
  private service = new WorkflowDagMappingService();
