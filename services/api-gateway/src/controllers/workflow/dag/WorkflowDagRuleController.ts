import { WorkflowDagRuleService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagRuleService";

export class WorkflowDagRuleController {
  private service = new WorkflowDagRuleService();
