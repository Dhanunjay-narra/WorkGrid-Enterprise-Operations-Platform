import { WorkflowDagPayloadService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagPayloadService";

export class WorkflowDagPayloadController {
  private service = new WorkflowDagPayloadService();
