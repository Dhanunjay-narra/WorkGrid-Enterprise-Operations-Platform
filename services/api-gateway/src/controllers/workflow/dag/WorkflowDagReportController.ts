import { WorkflowDagReportService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagReportService";

export class WorkflowDagReportController {
  private service = new WorkflowDagReportService();
