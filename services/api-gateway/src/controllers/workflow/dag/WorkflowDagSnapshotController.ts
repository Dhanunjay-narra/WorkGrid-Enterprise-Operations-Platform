import { WorkflowDagSnapshotService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagSnapshotService";

export class WorkflowDagSnapshotController {
  private service = new WorkflowDagSnapshotService();
