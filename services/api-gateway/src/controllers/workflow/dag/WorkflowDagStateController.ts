import { WorkflowDagStateService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagStateService";

export class WorkflowDagStateController {
  private service = new WorkflowDagStateService();
