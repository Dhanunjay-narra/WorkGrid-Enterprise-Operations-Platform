import { WorkflowDagEventService } from "../../../../core-engine/src/workflow/dag/services/WorkflowDagEventService";

export class WorkflowDagEventController {
  private service = new WorkflowDagEventService();
