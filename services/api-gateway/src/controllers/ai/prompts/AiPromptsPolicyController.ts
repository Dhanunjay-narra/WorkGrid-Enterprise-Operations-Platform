import { AiPromptsPolicyService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsPolicyService";

export class AiPromptsPolicyController {
  private service = new AiPromptsPolicyService();
