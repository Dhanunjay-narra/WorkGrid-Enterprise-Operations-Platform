import { AiPromptsMappingService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsMappingService";

export class AiPromptsMappingController {
  private service = new AiPromptsMappingService();
