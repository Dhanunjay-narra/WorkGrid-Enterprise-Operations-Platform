import { AiPromptsTransactionService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsTransactionService";

export class AiPromptsTransactionController {
  private service = new AiPromptsTransactionService();
