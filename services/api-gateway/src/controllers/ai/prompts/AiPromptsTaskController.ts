import { AiPromptsTaskService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsTaskService";

export class AiPromptsTaskController {
  private service = new AiPromptsTaskService();
