import { AiPromptsSessionService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsSessionService";

export class AiPromptsSessionController {
  private service = new AiPromptsSessionService();
