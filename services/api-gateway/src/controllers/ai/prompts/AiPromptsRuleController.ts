import { AiPromptsRuleService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsRuleService";

export class AiPromptsRuleController {
  private service = new AiPromptsRuleService();
