import { AiPromptsStateService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsStateService";

export class AiPromptsStateController {
  private service = new AiPromptsStateService();
