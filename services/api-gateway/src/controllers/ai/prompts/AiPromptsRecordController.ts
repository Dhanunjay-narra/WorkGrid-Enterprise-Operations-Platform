import { AiPromptsRecordService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsRecordService";

export class AiPromptsRecordController {
  private service = new AiPromptsRecordService();
