import { AiPromptsSnapshotService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsSnapshotService";

export class AiPromptsSnapshotController {
  private service = new AiPromptsSnapshotService();
