import { AiPromptsBatchService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsBatchService";

export class AiPromptsBatchController {
  private service = new AiPromptsBatchService();
