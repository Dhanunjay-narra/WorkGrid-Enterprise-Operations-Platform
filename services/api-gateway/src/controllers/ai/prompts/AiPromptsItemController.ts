import { AiPromptsItemService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsItemService";

export class AiPromptsItemController {
  private service = new AiPromptsItemService();
