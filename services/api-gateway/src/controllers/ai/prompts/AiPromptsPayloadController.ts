import { AiPromptsPayloadService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsPayloadService";

export class AiPromptsPayloadController {
  private service = new AiPromptsPayloadService();
