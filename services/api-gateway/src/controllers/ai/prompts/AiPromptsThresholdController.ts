import { AiPromptsThresholdService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsThresholdService";

export class AiPromptsThresholdController {
  private service = new AiPromptsThresholdService();
