import { AiPromptsQueueService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsQueueService";

export class AiPromptsQueueController {
  private service = new AiPromptsQueueService();
