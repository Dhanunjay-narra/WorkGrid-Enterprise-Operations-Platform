import { AiPromptsProfileService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsProfileService";

export class AiPromptsProfileController {
  private service = new AiPromptsProfileService();
