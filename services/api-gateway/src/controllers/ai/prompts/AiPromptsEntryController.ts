import { AiPromptsEntryService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsEntryService";

export class AiPromptsEntryController {
  private service = new AiPromptsEntryService();
