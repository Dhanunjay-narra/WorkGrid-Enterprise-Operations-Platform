import { AiPromptsAuditLogService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsAuditLogService";

export class AiPromptsAuditLogController {
  private service = new AiPromptsAuditLogService();
