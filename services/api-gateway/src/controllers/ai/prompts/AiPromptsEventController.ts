import { AiPromptsEventService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsEventService";

export class AiPromptsEventController {
  private service = new AiPromptsEventService();
