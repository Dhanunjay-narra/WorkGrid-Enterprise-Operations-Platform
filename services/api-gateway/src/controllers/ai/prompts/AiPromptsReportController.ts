import { AiPromptsReportService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsReportService";

export class AiPromptsReportController {
  private service = new AiPromptsReportService();
