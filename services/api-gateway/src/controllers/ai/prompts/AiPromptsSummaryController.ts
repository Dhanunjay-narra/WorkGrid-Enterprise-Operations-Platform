import { AiPromptsSummaryService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsSummaryService";

export class AiPromptsSummaryController {
  private service = new AiPromptsSummaryService();
