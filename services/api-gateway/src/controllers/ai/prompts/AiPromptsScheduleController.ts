import { AiPromptsScheduleService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsScheduleService";

export class AiPromptsScheduleController {
  private service = new AiPromptsScheduleService();
