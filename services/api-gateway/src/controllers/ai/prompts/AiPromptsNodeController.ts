import { AiPromptsNodeService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsNodeService";

export class AiPromptsNodeController {
  private service = new AiPromptsNodeService();
