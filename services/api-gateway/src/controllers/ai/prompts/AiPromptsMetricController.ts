import { AiPromptsMetricService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsMetricService";

export class AiPromptsMetricController {
  private service = new AiPromptsMetricService();
