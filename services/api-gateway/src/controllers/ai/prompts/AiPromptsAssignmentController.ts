import { AiPromptsAssignmentService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsAssignmentService";

export class AiPromptsAssignmentController {
  private service = new AiPromptsAssignmentService();
