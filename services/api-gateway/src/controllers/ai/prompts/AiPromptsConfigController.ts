import { AiPromptsConfigService } from "../../../../core-engine/src/ai/prompts/services/AiPromptsConfigService";

export class AiPromptsConfigController {
  private service = new AiPromptsConfigService();
