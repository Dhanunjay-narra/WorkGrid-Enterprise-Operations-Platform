import { AiToolsSummaryService } from "../../../../core-engine/src/ai/tools/services/AiToolsSummaryService";

export class AiToolsSummaryController {
  private service = new AiToolsSummaryService();
