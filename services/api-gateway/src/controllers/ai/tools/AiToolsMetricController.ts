import { AiToolsMetricService } from "../../../../core-engine/src/ai/tools/services/AiToolsMetricService";

export class AiToolsMetricController {
  private service = new AiToolsMetricService();
