import { AiToolsItemService } from "../../../../core-engine/src/ai/tools/services/AiToolsItemService";

export class AiToolsItemController {
  private service = new AiToolsItemService();
