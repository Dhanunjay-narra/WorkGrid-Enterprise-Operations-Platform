import { AiToolsNodeService } from "../../../../core-engine/src/ai/tools/services/AiToolsNodeService";

export class AiToolsNodeController {
  private service = new AiToolsNodeService();
