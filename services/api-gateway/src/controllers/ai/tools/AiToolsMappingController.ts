import { AiToolsMappingService } from "../../../../core-engine/src/ai/tools/services/AiToolsMappingService";

export class AiToolsMappingController {
  private service = new AiToolsMappingService();
