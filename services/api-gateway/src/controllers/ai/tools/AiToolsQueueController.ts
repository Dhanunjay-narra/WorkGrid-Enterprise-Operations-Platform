import { AiToolsQueueService } from "../../../../core-engine/src/ai/tools/services/AiToolsQueueService";

export class AiToolsQueueController {
  private service = new AiToolsQueueService();
