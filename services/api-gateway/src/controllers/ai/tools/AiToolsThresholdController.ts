import { AiToolsThresholdService } from "../../../../core-engine/src/ai/tools/services/AiToolsThresholdService";

export class AiToolsThresholdController {
  private service = new AiToolsThresholdService();
