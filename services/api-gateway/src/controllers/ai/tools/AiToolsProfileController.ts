import { AiToolsProfileService } from "../../../../core-engine/src/ai/tools/services/AiToolsProfileService";

export class AiToolsProfileController {
  private service = new AiToolsProfileService();
