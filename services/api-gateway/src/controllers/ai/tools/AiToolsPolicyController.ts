import { AiToolsPolicyService } from "../../../../core-engine/src/ai/tools/services/AiToolsPolicyService";

export class AiToolsPolicyController {
  private service = new AiToolsPolicyService();
