import { AiToolsEntryService } from "../../../../core-engine/src/ai/tools/services/AiToolsEntryService";

export class AiToolsEntryController {
  private service = new AiToolsEntryService();
