import { AiToolsAssignmentService } from "../../../../core-engine/src/ai/tools/services/AiToolsAssignmentService";

export class AiToolsAssignmentController {
  private service = new AiToolsAssignmentService();
