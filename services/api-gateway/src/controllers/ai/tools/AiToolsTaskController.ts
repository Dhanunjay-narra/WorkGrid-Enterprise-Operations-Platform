import { AiToolsTaskService } from "../../../../core-engine/src/ai/tools/services/AiToolsTaskService";

export class AiToolsTaskController {
  private service = new AiToolsTaskService();
