import { AiToolsScheduleService } from "../../../../core-engine/src/ai/tools/services/AiToolsScheduleService";

export class AiToolsScheduleController {
  private service = new AiToolsScheduleService();
