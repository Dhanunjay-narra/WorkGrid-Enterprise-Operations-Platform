import { AiToolsConfigService } from "../../../../core-engine/src/ai/tools/services/AiToolsConfigService";

export class AiToolsConfigController {
  private service = new AiToolsConfigService();
