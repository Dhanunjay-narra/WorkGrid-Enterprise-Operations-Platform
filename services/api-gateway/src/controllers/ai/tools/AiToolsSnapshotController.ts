import { AiToolsSnapshotService } from "../../../../core-engine/src/ai/tools/services/AiToolsSnapshotService";

export class AiToolsSnapshotController {
  private service = new AiToolsSnapshotService();
