import { AiToolsPayloadService } from "../../../../core-engine/src/ai/tools/services/AiToolsPayloadService";

export class AiToolsPayloadController {
  private service = new AiToolsPayloadService();
