import { AiToolsTransactionService } from "../../../../core-engine/src/ai/tools/services/AiToolsTransactionService";

export class AiToolsTransactionController {
  private service = new AiToolsTransactionService();
