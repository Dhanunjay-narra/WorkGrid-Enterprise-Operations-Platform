import { AiToolsStateService } from "../../../../core-engine/src/ai/tools/services/AiToolsStateService";

export class AiToolsStateController {
  private service = new AiToolsStateService();
