import { AiToolsRuleService } from "../../../../core-engine/src/ai/tools/services/AiToolsRuleService";

export class AiToolsRuleController {
  private service = new AiToolsRuleService();
