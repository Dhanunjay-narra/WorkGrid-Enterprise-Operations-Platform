import { AiToolsBatchService } from "../../../../core-engine/src/ai/tools/services/AiToolsBatchService";

export class AiToolsBatchController {
  private service = new AiToolsBatchService();
