import { AiToolsAuditLogService } from "../../../../core-engine/src/ai/tools/services/AiToolsAuditLogService";

export class AiToolsAuditLogController {
  private service = new AiToolsAuditLogService();
