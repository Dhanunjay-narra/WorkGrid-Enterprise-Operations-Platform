import { AiToolsReportService } from "../../../../core-engine/src/ai/tools/services/AiToolsReportService";

export class AiToolsReportController {
  private service = new AiToolsReportService();
