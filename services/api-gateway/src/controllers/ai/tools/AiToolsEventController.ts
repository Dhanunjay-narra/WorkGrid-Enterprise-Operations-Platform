import { AiToolsEventService } from "../../../../core-engine/src/ai/tools/services/AiToolsEventService";

export class AiToolsEventController {
  private service = new AiToolsEventService();
