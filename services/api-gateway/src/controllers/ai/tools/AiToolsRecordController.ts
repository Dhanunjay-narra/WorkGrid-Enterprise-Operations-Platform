import { AiToolsRecordService } from "../../../../core-engine/src/ai/tools/services/AiToolsRecordService";

export class AiToolsRecordController {
  private service = new AiToolsRecordService();
