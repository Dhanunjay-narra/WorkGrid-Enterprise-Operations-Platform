import { AiEmbeddingsConfigService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsConfigService";

export class AiEmbeddingsConfigController {
  private service = new AiEmbeddingsConfigService();
