import { AiEmbeddingsMappingService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsMappingService";

export class AiEmbeddingsMappingController {
  private service = new AiEmbeddingsMappingService();
