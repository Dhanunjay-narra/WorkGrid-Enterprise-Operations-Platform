import { AiEmbeddingsEntryService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsEntryService";

export class AiEmbeddingsEntryController {
  private service = new AiEmbeddingsEntryService();
