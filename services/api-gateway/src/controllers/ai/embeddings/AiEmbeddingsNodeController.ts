import { AiEmbeddingsNodeService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsNodeService";

export class AiEmbeddingsNodeController {
  private service = new AiEmbeddingsNodeService();
