import { AiEmbeddingsTaskService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsTaskService";

export class AiEmbeddingsTaskController {
  private service = new AiEmbeddingsTaskService();
