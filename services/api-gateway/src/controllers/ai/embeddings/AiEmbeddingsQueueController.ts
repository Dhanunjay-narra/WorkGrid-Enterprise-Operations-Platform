import { AiEmbeddingsQueueService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsQueueService";

export class AiEmbeddingsQueueController {
  private service = new AiEmbeddingsQueueService();
