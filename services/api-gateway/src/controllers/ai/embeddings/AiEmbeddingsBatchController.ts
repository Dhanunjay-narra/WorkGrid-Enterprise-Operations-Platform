import { AiEmbeddingsBatchService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsBatchService";

export class AiEmbeddingsBatchController {
  private service = new AiEmbeddingsBatchService();
