import { AiEmbeddingsPolicyService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsPolicyService";

export class AiEmbeddingsPolicyController {
  private service = new AiEmbeddingsPolicyService();
