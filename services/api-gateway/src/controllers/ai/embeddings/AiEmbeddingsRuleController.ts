import { AiEmbeddingsRuleService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsRuleService";

export class AiEmbeddingsRuleController {
  private service = new AiEmbeddingsRuleService();
