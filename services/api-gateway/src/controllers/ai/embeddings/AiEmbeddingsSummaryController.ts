import { AiEmbeddingsSummaryService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsSummaryService";

export class AiEmbeddingsSummaryController {
  private service = new AiEmbeddingsSummaryService();
