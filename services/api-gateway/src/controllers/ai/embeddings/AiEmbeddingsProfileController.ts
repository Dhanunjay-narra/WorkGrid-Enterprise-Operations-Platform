import { AiEmbeddingsProfileService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsProfileService";

export class AiEmbeddingsProfileController {
  private service = new AiEmbeddingsProfileService();
