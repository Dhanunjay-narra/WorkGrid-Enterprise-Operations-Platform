import { AiEmbeddingsSnapshotService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsSnapshotService";

export class AiEmbeddingsSnapshotController {
  private service = new AiEmbeddingsSnapshotService();
