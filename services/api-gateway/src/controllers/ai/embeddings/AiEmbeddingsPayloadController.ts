import { AiEmbeddingsPayloadService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsPayloadService";

export class AiEmbeddingsPayloadController {
  private service = new AiEmbeddingsPayloadService();
