import { AiEmbeddingsItemService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsItemService";

export class AiEmbeddingsItemController {
  private service = new AiEmbeddingsItemService();
