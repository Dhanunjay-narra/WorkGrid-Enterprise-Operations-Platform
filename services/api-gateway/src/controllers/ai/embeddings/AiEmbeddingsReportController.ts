import { AiEmbeddingsReportService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsReportService";

export class AiEmbeddingsReportController {
  private service = new AiEmbeddingsReportService();
