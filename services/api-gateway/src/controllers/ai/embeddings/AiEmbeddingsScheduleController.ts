import { AiEmbeddingsScheduleService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsScheduleService";

export class AiEmbeddingsScheduleController {
  private service = new AiEmbeddingsScheduleService();
