import { AiEmbeddingsAuditLogService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsAuditLogService";

export class AiEmbeddingsAuditLogController {
  private service = new AiEmbeddingsAuditLogService();
