import { AiEmbeddingsRecordService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsRecordService";

export class AiEmbeddingsRecordController {
  private service = new AiEmbeddingsRecordService();
