import { AiEmbeddingsMetricService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsMetricService";

export class AiEmbeddingsMetricController {
  private service = new AiEmbeddingsMetricService();
