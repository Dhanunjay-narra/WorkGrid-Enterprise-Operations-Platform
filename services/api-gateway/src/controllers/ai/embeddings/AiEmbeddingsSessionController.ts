import { AiEmbeddingsSessionService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsSessionService";

export class AiEmbeddingsSessionController {
  private service = new AiEmbeddingsSessionService();
