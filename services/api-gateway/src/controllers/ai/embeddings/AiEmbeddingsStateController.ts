import { AiEmbeddingsStateService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsStateService";

export class AiEmbeddingsStateController {
  private service = new AiEmbeddingsStateService();
