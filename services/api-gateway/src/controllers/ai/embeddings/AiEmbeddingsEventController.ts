import { AiEmbeddingsEventService } from "../../../../core-engine/src/ai/embeddings/services/AiEmbeddingsEventService";

export class AiEmbeddingsEventController {
  private service = new AiEmbeddingsEventService();
