import { AiEvaluationsConfigService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsConfigService";

export class AiEvaluationsConfigController {
  private service = new AiEvaluationsConfigService();
