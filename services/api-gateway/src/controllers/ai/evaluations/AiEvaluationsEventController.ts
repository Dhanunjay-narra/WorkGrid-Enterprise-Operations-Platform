import { AiEvaluationsEventService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsEventService";

export class AiEvaluationsEventController {
  private service = new AiEvaluationsEventService();
