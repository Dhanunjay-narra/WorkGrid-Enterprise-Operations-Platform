import { AiEvaluationsItemService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsItemService";

export class AiEvaluationsItemController {
  private service = new AiEvaluationsItemService();
