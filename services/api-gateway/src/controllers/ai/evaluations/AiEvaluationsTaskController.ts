import { AiEvaluationsTaskService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsTaskService";

export class AiEvaluationsTaskController {
  private service = new AiEvaluationsTaskService();
