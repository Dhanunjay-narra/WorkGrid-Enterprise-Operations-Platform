import { AiEvaluationsBatchService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsBatchService";

export class AiEvaluationsBatchController {
  private service = new AiEvaluationsBatchService();
