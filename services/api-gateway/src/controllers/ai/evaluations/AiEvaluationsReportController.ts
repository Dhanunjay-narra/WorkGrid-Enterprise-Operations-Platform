import { AiEvaluationsReportService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsReportService";

export class AiEvaluationsReportController {
  private service = new AiEvaluationsReportService();
