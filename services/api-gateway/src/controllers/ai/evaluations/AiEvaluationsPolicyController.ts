import { AiEvaluationsPolicyService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsPolicyService";

export class AiEvaluationsPolicyController {
  private service = new AiEvaluationsPolicyService();
