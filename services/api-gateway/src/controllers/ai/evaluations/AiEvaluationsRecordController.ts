import { AiEvaluationsRecordService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsRecordService";

export class AiEvaluationsRecordController {
  private service = new AiEvaluationsRecordService();
