import { AiEvaluationsStateService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsStateService";

export class AiEvaluationsStateController {
  private service = new AiEvaluationsStateService();
