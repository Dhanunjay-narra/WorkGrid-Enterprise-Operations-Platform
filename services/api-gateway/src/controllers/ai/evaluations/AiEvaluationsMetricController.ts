import { AiEvaluationsMetricService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsMetricService";

export class AiEvaluationsMetricController {
  private service = new AiEvaluationsMetricService();
