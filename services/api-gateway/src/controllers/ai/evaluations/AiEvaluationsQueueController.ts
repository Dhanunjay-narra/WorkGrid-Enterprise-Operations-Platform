import { AiEvaluationsQueueService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsQueueService";

export class AiEvaluationsQueueController {
  private service = new AiEvaluationsQueueService();
