import { AiEvaluationsSummaryService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsSummaryService";

export class AiEvaluationsSummaryController {
  private service = new AiEvaluationsSummaryService();
