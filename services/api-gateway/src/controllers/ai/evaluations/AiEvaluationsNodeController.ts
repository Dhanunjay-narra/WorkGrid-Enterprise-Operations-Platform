import { AiEvaluationsNodeService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsNodeService";

export class AiEvaluationsNodeController {
  private service = new AiEvaluationsNodeService();
