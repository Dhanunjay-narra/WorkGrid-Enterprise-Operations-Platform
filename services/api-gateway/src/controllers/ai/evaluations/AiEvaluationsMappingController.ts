import { AiEvaluationsMappingService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsMappingService";

export class AiEvaluationsMappingController {
  private service = new AiEvaluationsMappingService();
