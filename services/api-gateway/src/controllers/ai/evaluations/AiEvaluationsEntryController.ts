import { AiEvaluationsEntryService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsEntryService";

export class AiEvaluationsEntryController {
  private service = new AiEvaluationsEntryService();
