import { AiEvaluationsRuleService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsRuleService";

export class AiEvaluationsRuleController {
  private service = new AiEvaluationsRuleService();
