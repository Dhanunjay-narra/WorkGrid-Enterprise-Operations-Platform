import { AiEvaluationsSessionService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsSessionService";

export class AiEvaluationsSessionController {
  private service = new AiEvaluationsSessionService();
