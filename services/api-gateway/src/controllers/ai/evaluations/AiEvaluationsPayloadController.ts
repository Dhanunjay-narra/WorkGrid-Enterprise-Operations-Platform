import { AiEvaluationsPayloadService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsPayloadService";

export class AiEvaluationsPayloadController {
  private service = new AiEvaluationsPayloadService();
