import { AiEvaluationsProfileService } from "../../../../core-engine/src/ai/evaluations/services/AiEvaluationsProfileService";

export class AiEvaluationsProfileController {
  private service = new AiEvaluationsProfileService();
