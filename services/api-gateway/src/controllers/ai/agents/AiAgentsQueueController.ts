import { AiAgentsQueueService } from "../../../../core-engine/src/ai/agents/services/AiAgentsQueueService";

export class AiAgentsQueueController {
  private service = new AiAgentsQueueService();
