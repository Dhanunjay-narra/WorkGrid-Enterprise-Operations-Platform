import { AiAgentsConfigService } from "../../../../core-engine/src/ai/agents/services/AiAgentsConfigService";

export class AiAgentsConfigController {
  private service = new AiAgentsConfigService();
