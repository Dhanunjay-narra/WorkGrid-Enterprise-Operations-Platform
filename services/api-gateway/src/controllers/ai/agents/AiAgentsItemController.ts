import { AiAgentsItemService } from "../../../../core-engine/src/ai/agents/services/AiAgentsItemService";

export class AiAgentsItemController {
  private service = new AiAgentsItemService();
