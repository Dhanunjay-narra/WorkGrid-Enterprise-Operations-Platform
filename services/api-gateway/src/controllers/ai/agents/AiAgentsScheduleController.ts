import { AiAgentsScheduleService } from "../../../../core-engine/src/ai/agents/services/AiAgentsScheduleService";

export class AiAgentsScheduleController {
  private service = new AiAgentsScheduleService();
