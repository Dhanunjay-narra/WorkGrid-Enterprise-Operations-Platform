import { AiAgentsPolicyService } from "../../../../core-engine/src/ai/agents/services/AiAgentsPolicyService";

export class AiAgentsPolicyController {
  private service = new AiAgentsPolicyService();
