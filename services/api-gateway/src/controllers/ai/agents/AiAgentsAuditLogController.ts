import { AiAgentsAuditLogService } from "../../../../core-engine/src/ai/agents/services/AiAgentsAuditLogService";

export class AiAgentsAuditLogController {
  private service = new AiAgentsAuditLogService();
