import { AiAgentsNodeService } from "../../../../core-engine/src/ai/agents/services/AiAgentsNodeService";

export class AiAgentsNodeController {
  private service = new AiAgentsNodeService();
