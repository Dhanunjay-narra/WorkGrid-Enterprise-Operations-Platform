import { AiAgentsMetricService } from "../../../../core-engine/src/ai/agents/services/AiAgentsMetricService";

export class AiAgentsMetricController {
  private service = new AiAgentsMetricService();
