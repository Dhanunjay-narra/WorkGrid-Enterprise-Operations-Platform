import { AiAgentsStateService } from "../../../../core-engine/src/ai/agents/services/AiAgentsStateService";

export class AiAgentsStateController {
  private service = new AiAgentsStateService();
