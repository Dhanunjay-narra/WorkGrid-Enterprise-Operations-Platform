import { AiAgentsEntryService } from "../../../../core-engine/src/ai/agents/services/AiAgentsEntryService";

export class AiAgentsEntryController {
  private service = new AiAgentsEntryService();
