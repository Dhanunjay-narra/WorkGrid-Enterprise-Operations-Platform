import { AiAgentsRecordService } from "../../../../core-engine/src/ai/agents/services/AiAgentsRecordService";

export class AiAgentsRecordController {
  private service = new AiAgentsRecordService();
