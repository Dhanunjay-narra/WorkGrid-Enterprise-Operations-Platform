import { AiAgentsTransactionService } from "../../../../core-engine/src/ai/agents/services/AiAgentsTransactionService";

export class AiAgentsTransactionController {
  private service = new AiAgentsTransactionService();
