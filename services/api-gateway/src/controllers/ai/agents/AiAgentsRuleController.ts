import { AiAgentsRuleService } from "../../../../core-engine/src/ai/agents/services/AiAgentsRuleService";

export class AiAgentsRuleController {
  private service = new AiAgentsRuleService();
