import { AiAgentsAssignmentService } from "../../../../core-engine/src/ai/agents/services/AiAgentsAssignmentService";

export class AiAgentsAssignmentController {
  private service = new AiAgentsAssignmentService();
