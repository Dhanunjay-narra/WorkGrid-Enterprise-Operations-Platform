import { AiAgentsSummaryService } from "../../../../core-engine/src/ai/agents/services/AiAgentsSummaryService";

export class AiAgentsSummaryController {
  private service = new AiAgentsSummaryService();
