import { AiAgentsProfileService } from "../../../../core-engine/src/ai/agents/services/AiAgentsProfileService";

export class AiAgentsProfileController {
  private service = new AiAgentsProfileService();
