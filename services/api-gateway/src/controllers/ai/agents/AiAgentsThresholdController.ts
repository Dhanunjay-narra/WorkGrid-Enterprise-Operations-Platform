import { AiAgentsThresholdService } from "../../../../core-engine/src/ai/agents/services/AiAgentsThresholdService";

export class AiAgentsThresholdController {
  private service = new AiAgentsThresholdService();
