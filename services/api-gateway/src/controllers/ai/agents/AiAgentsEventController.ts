import { AiAgentsEventService } from "../../../../core-engine/src/ai/agents/services/AiAgentsEventService";

export class AiAgentsEventController {
  private service = new AiAgentsEventService();
