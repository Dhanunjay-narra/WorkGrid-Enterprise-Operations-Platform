import { AiAgentsSessionService } from "../../../../core-engine/src/ai/agents/services/AiAgentsSessionService";

export class AiAgentsSessionController {
  private service = new AiAgentsSessionService();
