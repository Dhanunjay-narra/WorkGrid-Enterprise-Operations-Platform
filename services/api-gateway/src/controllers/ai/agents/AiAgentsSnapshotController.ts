import { AiAgentsSnapshotService } from "../../../../core-engine/src/ai/agents/services/AiAgentsSnapshotService";

export class AiAgentsSnapshotController {
  private service = new AiAgentsSnapshotService();
