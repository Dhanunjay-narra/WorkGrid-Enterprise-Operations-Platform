import { AiAgentsReportService } from "../../../../core-engine/src/ai/agents/services/AiAgentsReportService";

export class AiAgentsReportController {
  private service = new AiAgentsReportService();
