import { AiAgentsPayloadService } from "../../../../core-engine/src/ai/agents/services/AiAgentsPayloadService";

export class AiAgentsPayloadController {
  private service = new AiAgentsPayloadService();
