import { AiAgentsTaskService } from "../../../../core-engine/src/ai/agents/services/AiAgentsTaskService";

export class AiAgentsTaskController {
  private service = new AiAgentsTaskService();
