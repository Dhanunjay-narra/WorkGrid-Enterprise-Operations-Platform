import { AiAgentsBatchService } from "../../../../core-engine/src/ai/agents/services/AiAgentsBatchService";

export class AiAgentsBatchController {
  private service = new AiAgentsBatchService();
