import { AiAgentsMappingService } from "../../../../core-engine/src/ai/agents/services/AiAgentsMappingService";

export class AiAgentsMappingController {
  private service = new AiAgentsMappingService();
