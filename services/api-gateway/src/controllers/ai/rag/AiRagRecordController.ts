import { AiRagRecordService } from "../../../../core-engine/src/ai/rag/services/AiRagRecordService";

export class AiRagRecordController {
  private service = new AiRagRecordService();
