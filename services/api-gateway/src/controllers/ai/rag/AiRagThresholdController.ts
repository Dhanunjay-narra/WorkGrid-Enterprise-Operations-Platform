import { AiRagThresholdService } from "../../../../core-engine/src/ai/rag/services/AiRagThresholdService";

export class AiRagThresholdController {
  private service = new AiRagThresholdService();
