import { AiRagTransactionService } from "../../../../core-engine/src/ai/rag/services/AiRagTransactionService";

export class AiRagTransactionController {
  private service = new AiRagTransactionService();
