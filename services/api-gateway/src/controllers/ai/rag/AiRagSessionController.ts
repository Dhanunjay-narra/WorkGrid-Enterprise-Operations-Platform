import { AiRagSessionService } from "../../../../core-engine/src/ai/rag/services/AiRagSessionService";

export class AiRagSessionController {
  private service = new AiRagSessionService();
