import { AiRagMappingService } from "../../../../core-engine/src/ai/rag/services/AiRagMappingService";

export class AiRagMappingController {
  private service = new AiRagMappingService();
