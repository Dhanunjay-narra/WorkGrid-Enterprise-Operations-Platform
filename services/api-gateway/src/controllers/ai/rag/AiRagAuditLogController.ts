import { AiRagAuditLogService } from "../../../../core-engine/src/ai/rag/services/AiRagAuditLogService";

export class AiRagAuditLogController {
  private service = new AiRagAuditLogService();
