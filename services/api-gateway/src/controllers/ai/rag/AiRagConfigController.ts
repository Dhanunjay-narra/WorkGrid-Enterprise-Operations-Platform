import { AiRagConfigService } from "../../../../core-engine/src/ai/rag/services/AiRagConfigService";

export class AiRagConfigController {
  private service = new AiRagConfigService();
