import { AiRagPolicyService } from "../../../../core-engine/src/ai/rag/services/AiRagPolicyService";

export class AiRagPolicyController {
  private service = new AiRagPolicyService();
