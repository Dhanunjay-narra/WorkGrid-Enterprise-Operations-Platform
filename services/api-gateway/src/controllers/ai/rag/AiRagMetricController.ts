import { AiRagMetricService } from "../../../../core-engine/src/ai/rag/services/AiRagMetricService";

export class AiRagMetricController {
  private service = new AiRagMetricService();
