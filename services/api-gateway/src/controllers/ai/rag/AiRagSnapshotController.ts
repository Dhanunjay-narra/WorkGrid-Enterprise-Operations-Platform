import { AiRagSnapshotService } from "../../../../core-engine/src/ai/rag/services/AiRagSnapshotService";

export class AiRagSnapshotController {
  private service = new AiRagSnapshotService();
