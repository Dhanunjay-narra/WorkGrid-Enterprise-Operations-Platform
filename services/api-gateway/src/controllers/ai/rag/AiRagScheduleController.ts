import { AiRagScheduleService } from "../../../../core-engine/src/ai/rag/services/AiRagScheduleService";

export class AiRagScheduleController {
  private service = new AiRagScheduleService();
