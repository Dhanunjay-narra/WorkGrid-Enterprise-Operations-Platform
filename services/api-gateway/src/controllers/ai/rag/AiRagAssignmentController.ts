import { AiRagAssignmentService } from "../../../../core-engine/src/ai/rag/services/AiRagAssignmentService";

export class AiRagAssignmentController {
  private service = new AiRagAssignmentService();
