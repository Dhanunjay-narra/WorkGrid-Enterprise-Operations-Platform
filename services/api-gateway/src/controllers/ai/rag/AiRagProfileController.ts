import { AiRagProfileService } from "../../../../core-engine/src/ai/rag/services/AiRagProfileService";

export class AiRagProfileController {
  private service = new AiRagProfileService();
