import { AiRagPayloadService } from "../../../../core-engine/src/ai/rag/services/AiRagPayloadService";

export class AiRagPayloadController {
  private service = new AiRagPayloadService();
