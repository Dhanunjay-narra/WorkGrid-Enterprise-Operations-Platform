import { AiRagSummaryService } from "../../../../core-engine/src/ai/rag/services/AiRagSummaryService";

export class AiRagSummaryController {
  private service = new AiRagSummaryService();
