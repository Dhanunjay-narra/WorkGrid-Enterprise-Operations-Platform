import { AiRagReportService } from "../../../../core-engine/src/ai/rag/services/AiRagReportService";

export class AiRagReportController {
  private service = new AiRagReportService();
