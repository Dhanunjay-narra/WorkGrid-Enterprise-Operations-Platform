import { AiGatewaySessionService } from "../../../../core-engine/src/ai/gateway/services/AiGatewaySessionService";

export class AiGatewaySessionController {
  private service = new AiGatewaySessionService();
