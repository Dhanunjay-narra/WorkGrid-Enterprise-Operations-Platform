import { AiGatewayMappingService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayMappingService";

export class AiGatewayMappingController {
  private service = new AiGatewayMappingService();
