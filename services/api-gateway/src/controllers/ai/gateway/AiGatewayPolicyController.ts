import { AiGatewayPolicyService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayPolicyService";

export class AiGatewayPolicyController {
  private service = new AiGatewayPolicyService();
