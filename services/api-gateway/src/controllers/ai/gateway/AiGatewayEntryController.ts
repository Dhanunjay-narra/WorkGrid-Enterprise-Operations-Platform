import { AiGatewayEntryService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayEntryService";

export class AiGatewayEntryController {
  private service = new AiGatewayEntryService();
