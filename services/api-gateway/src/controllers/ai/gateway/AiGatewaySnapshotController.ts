import { AiGatewaySnapshotService } from "../../../../core-engine/src/ai/gateway/services/AiGatewaySnapshotService";

export class AiGatewaySnapshotController {
  private service = new AiGatewaySnapshotService();
