import { AiGatewayItemService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayItemService";

export class AiGatewayItemController {
  private service = new AiGatewayItemService();
