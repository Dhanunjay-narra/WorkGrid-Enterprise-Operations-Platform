import { AiGatewayScheduleService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayScheduleService";

export class AiGatewayScheduleController {
  private service = new AiGatewayScheduleService();
