import { AiGatewayQueueService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayQueueService";

export class AiGatewayQueueController {
  private service = new AiGatewayQueueService();
