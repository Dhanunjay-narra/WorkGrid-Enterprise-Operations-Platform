import { AiGatewayMetricService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayMetricService";

export class AiGatewayMetricController {
  private service = new AiGatewayMetricService();
