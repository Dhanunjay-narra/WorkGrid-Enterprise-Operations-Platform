import { AiGatewaySummaryService } from "../../../../core-engine/src/ai/gateway/services/AiGatewaySummaryService";

export class AiGatewaySummaryController {
  private service = new AiGatewaySummaryService();
