import { AiGatewayTransactionService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayTransactionService";

export class AiGatewayTransactionController {
  private service = new AiGatewayTransactionService();
