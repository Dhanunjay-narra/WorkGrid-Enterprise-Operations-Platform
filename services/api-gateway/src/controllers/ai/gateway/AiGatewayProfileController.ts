import { AiGatewayProfileService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayProfileService";

export class AiGatewayProfileController {
  private service = new AiGatewayProfileService();
