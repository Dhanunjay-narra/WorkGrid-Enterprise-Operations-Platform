import { AiGatewayThresholdService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayThresholdService";

export class AiGatewayThresholdController {
  private service = new AiGatewayThresholdService();
