import { AiGatewayNodeService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayNodeService";

export class AiGatewayNodeController {
  private service = new AiGatewayNodeService();
