import { AiGatewayAuditLogService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayAuditLogService";

export class AiGatewayAuditLogController {
  private service = new AiGatewayAuditLogService();
