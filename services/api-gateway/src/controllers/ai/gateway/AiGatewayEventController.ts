import { AiGatewayEventService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayEventService";

export class AiGatewayEventController {
  private service = new AiGatewayEventService();
