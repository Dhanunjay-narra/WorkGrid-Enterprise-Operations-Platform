import { AiGatewayRecordService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayRecordService";

export class AiGatewayRecordController {
  private service = new AiGatewayRecordService();
