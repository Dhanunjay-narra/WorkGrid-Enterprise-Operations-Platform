import { AiGatewayBatchService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayBatchService";

export class AiGatewayBatchController {
  private service = new AiGatewayBatchService();
