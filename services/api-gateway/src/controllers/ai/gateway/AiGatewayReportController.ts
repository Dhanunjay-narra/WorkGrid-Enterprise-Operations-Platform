import { AiGatewayReportService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayReportService";

export class AiGatewayReportController {
  private service = new AiGatewayReportService();
