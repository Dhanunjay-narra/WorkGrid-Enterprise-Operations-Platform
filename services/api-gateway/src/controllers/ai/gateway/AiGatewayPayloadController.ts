import { AiGatewayPayloadService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayPayloadService";

export class AiGatewayPayloadController {
  private service = new AiGatewayPayloadService();
