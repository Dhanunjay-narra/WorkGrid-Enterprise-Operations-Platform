import { AiGatewayConfigService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayConfigService";

export class AiGatewayConfigController {
  private service = new AiGatewayConfigService();
