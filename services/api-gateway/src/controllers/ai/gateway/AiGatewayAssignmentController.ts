import { AiGatewayAssignmentService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayAssignmentService";

export class AiGatewayAssignmentController {
  private service = new AiGatewayAssignmentService();
