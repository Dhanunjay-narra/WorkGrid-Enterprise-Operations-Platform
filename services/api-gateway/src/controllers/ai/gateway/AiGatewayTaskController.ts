import { AiGatewayTaskService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayTaskService";

export class AiGatewayTaskController {
  private service = new AiGatewayTaskService();
