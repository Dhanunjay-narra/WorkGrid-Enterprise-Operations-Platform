import { AiGatewayStateService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayStateService";

export class AiGatewayStateController {
  private service = new AiGatewayStateService();
