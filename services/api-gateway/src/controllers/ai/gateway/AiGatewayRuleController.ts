import { AiGatewayRuleService } from "../../../../core-engine/src/ai/gateway/services/AiGatewayRuleService";

export class AiGatewayRuleController {
  private service = new AiGatewayRuleService();
