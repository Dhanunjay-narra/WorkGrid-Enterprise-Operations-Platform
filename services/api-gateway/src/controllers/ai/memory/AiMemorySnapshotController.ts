import { AiMemorySnapshotService } from "../../../../core-engine/src/ai/memory/services/AiMemorySnapshotService";

export class AiMemorySnapshotController {
  private service = new AiMemorySnapshotService();
