import { AiMemoryAuditLogService } from "../../../../core-engine/src/ai/memory/services/AiMemoryAuditLogService";

export class AiMemoryAuditLogController {
  private service = new AiMemoryAuditLogService();
