import { AiMemoryStateService } from "../../../../core-engine/src/ai/memory/services/AiMemoryStateService";

export class AiMemoryStateController {
  private service = new AiMemoryStateService();
