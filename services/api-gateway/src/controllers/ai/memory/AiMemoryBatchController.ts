import { AiMemoryBatchService } from "../../../../core-engine/src/ai/memory/services/AiMemoryBatchService";

export class AiMemoryBatchController {
  private service = new AiMemoryBatchService();
