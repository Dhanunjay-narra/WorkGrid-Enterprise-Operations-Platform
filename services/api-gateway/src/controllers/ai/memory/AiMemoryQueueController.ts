import { AiMemoryQueueService } from "../../../../core-engine/src/ai/memory/services/AiMemoryQueueService";

export class AiMemoryQueueController {
  private service = new AiMemoryQueueService();
