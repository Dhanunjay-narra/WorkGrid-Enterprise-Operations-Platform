import { AiMemorySessionService } from "../../../../core-engine/src/ai/memory/services/AiMemorySessionService";

export class AiMemorySessionController {
  private service = new AiMemorySessionService();
