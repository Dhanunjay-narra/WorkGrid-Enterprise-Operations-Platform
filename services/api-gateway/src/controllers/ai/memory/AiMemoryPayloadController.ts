import { AiMemoryPayloadService } from "../../../../core-engine/src/ai/memory/services/AiMemoryPayloadService";

export class AiMemoryPayloadController {
  private service = new AiMemoryPayloadService();
