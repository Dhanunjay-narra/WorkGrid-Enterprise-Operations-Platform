import { AiMemoryRuleService } from "../../../../core-engine/src/ai/memory/services/AiMemoryRuleService";

export class AiMemoryRuleController {
  private service = new AiMemoryRuleService();
