import { AiMemoryTaskService } from "../../../../core-engine/src/ai/memory/services/AiMemoryTaskService";

export class AiMemoryTaskController {
  private service = new AiMemoryTaskService();
