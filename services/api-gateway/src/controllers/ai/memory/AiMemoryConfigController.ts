import { AiMemoryConfigService } from "../../../../core-engine/src/ai/memory/services/AiMemoryConfigService";

export class AiMemoryConfigController {
  private service = new AiMemoryConfigService();
