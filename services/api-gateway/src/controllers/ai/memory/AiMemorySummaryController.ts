import { AiMemorySummaryService } from "../../../../core-engine/src/ai/memory/services/AiMemorySummaryService";

export class AiMemorySummaryController {
  private service = new AiMemorySummaryService();
