import { AiMemoryReportService } from "../../../../core-engine/src/ai/memory/services/AiMemoryReportService";

export class AiMemoryReportController {
  private service = new AiMemoryReportService();
