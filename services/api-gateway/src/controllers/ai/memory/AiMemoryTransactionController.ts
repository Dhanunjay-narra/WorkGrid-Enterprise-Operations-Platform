import { AiMemoryTransactionService } from "../../../../core-engine/src/ai/memory/services/AiMemoryTransactionService";

export class AiMemoryTransactionController {
  private service = new AiMemoryTransactionService();
