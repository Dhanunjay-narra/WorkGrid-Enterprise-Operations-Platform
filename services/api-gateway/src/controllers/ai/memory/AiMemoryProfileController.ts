import { AiMemoryProfileService } from "../../../../core-engine/src/ai/memory/services/AiMemoryProfileService";

export class AiMemoryProfileController {
  private service = new AiMemoryProfileService();
