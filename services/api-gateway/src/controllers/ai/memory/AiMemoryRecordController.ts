import { AiMemoryRecordService } from "../../../../core-engine/src/ai/memory/services/AiMemoryRecordService";

export class AiMemoryRecordController {
  private service = new AiMemoryRecordService();
