import { AiMemoryMappingService } from "../../../../core-engine/src/ai/memory/services/AiMemoryMappingService";

export class AiMemoryMappingController {
  private service = new AiMemoryMappingService();
