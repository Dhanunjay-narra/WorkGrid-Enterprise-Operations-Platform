import { AiMemoryItemService } from "../../../../core-engine/src/ai/memory/services/AiMemoryItemService";

export class AiMemoryItemController {
  private service = new AiMemoryItemService();
