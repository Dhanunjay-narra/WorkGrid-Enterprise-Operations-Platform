import { AiMemoryThresholdService } from "../../../../core-engine/src/ai/memory/services/AiMemoryThresholdService";

export class AiMemoryThresholdController {
  private service = new AiMemoryThresholdService();
