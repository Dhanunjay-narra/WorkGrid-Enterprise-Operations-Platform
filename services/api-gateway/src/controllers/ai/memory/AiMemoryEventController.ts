import { AiMemoryEventService } from "../../../../core-engine/src/ai/memory/services/AiMemoryEventService";

export class AiMemoryEventController {
  private service = new AiMemoryEventService();
