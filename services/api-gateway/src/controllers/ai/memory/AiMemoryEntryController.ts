import { AiMemoryEntryService } from "../../../../core-engine/src/ai/memory/services/AiMemoryEntryService";

export class AiMemoryEntryController {
  private service = new AiMemoryEntryService();
