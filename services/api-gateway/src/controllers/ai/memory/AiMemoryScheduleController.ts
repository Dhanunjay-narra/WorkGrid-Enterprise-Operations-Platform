import { AiMemoryScheduleService } from "../../../../core-engine/src/ai/memory/services/AiMemoryScheduleService";

export class AiMemoryScheduleController {
  private service = new AiMemoryScheduleService();
