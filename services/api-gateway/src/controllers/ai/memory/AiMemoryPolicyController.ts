import { AiMemoryPolicyService } from "../../../../core-engine/src/ai/memory/services/AiMemoryPolicyService";

export class AiMemoryPolicyController {
  private service = new AiMemoryPolicyService();
