import { AiMemoryNodeService } from "../../../../core-engine/src/ai/memory/services/AiMemoryNodeService";

export class AiMemoryNodeController {
  private service = new AiMemoryNodeService();
