import { AiMemoryAssignmentService } from "../../../../core-engine/src/ai/memory/services/AiMemoryAssignmentService";

export class AiMemoryAssignmentController {
  private service = new AiMemoryAssignmentService();
