import { AiMemoryMetricService } from "../../../../core-engine/src/ai/memory/services/AiMemoryMetricService";

export class AiMemoryMetricController {
  private service = new AiMemoryMetricService();
