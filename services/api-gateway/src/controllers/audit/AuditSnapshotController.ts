import { AuditSnapshotService } from "../../../../core-engine/src/audit/services/AuditSnapshotService";

export class AuditSnapshotController {
  private service = new AuditSnapshotService();
