import { AuditMappingService } from "../../../../core-engine/src/audit/services/AuditMappingService";

export class AuditMappingController {
  private service = new AuditMappingService();
