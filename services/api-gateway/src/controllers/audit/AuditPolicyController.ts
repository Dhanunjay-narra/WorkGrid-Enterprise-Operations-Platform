import { AuditPolicyService } from "../../../../core-engine/src/audit/services/AuditPolicyService";

export class AuditPolicyController {
  private service = new AuditPolicyService();
