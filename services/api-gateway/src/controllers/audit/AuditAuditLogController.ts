import { AuditAuditLogService } from "../../../../core-engine/src/audit/services/AuditAuditLogService";

export class AuditAuditLogController {
  private service = new AuditAuditLogService();
