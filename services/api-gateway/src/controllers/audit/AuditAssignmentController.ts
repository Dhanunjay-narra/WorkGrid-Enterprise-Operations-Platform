import { AuditAssignmentService } from "../../../../core-engine/src/audit/services/AuditAssignmentService";

export class AuditAssignmentController {
  private service = new AuditAssignmentService();
