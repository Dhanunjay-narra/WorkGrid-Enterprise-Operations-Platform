import { AuditPayloadService } from "../../../../core-engine/src/audit/services/AuditPayloadService";

export class AuditPayloadController {
  private service = new AuditPayloadService();
