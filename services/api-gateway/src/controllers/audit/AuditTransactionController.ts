import { AuditTransactionService } from "../../../../core-engine/src/audit/services/AuditTransactionService";

export class AuditTransactionController {
  private service = new AuditTransactionService();
