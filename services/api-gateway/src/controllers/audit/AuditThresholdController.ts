import { AuditThresholdService } from "../../../../core-engine/src/audit/services/AuditThresholdService";

export class AuditThresholdController {
  private service = new AuditThresholdService();
