import { AuditMetricService } from "../../../../core-engine/src/audit/services/AuditMetricService";

export class AuditMetricController {
  private service = new AuditMetricService();
