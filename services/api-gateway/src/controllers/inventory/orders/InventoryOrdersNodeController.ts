import { InventoryOrdersNodeService } from "../../../../core-engine/src/inventory/orders/services/InventoryOrdersNodeService";

export class InventoryOrdersNodeController {
  private service = new InventoryOrdersNodeService();
