import { InventoryOrdersTaskService } from "../../../../core-engine/src/inventory/orders/services/InventoryOrdersTaskService";

export class InventoryOrdersTaskController {
  private service = new InventoryOrdersTaskService();
