import { InventoryOrdersRuleService } from "../../../../core-engine/src/inventory/orders/services/InventoryOrdersRuleService";

export class InventoryOrdersRuleController {
  private service = new InventoryOrdersRuleService();
