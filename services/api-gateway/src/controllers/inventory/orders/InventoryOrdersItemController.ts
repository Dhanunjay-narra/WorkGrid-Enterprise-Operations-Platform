import { InventoryOrdersItemService } from "../../../../core-engine/src/inventory/orders/services/InventoryOrdersItemService";

export class InventoryOrdersItemController {
  private service = new InventoryOrdersItemService();
