import { InventoryStockPolicyService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockPolicyService";

export class InventoryStockPolicyController {
  private service = new InventoryStockPolicyService();
