import { InventoryStockMetricService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockMetricService";

export class InventoryStockMetricController {
  private service = new InventoryStockMetricService();
