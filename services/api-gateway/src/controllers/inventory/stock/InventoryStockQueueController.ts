import { InventoryStockQueueService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockQueueService";

export class InventoryStockQueueController {
  private service = new InventoryStockQueueService();
