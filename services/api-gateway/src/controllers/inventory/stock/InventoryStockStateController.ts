import { InventoryStockStateService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockStateService";

export class InventoryStockStateController {
  private service = new InventoryStockStateService();
