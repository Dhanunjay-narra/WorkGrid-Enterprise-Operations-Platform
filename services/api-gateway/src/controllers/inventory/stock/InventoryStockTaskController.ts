import { InventoryStockTaskService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockTaskService";

export class InventoryStockTaskController {
  private service = new InventoryStockTaskService();
