import { InventoryStockRuleService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockRuleService";

export class InventoryStockRuleController {
  private service = new InventoryStockRuleService();
