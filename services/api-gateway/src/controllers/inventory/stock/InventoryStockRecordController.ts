import { InventoryStockRecordService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockRecordService";

export class InventoryStockRecordController {
  private service = new InventoryStockRecordService();
