import { InventoryStockBatchService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockBatchService";

export class InventoryStockBatchController {
  private service = new InventoryStockBatchService();
