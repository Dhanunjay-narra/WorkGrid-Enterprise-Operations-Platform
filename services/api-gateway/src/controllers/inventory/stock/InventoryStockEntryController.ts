import { InventoryStockEntryService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockEntryService";

export class InventoryStockEntryController {
  private service = new InventoryStockEntryService();
