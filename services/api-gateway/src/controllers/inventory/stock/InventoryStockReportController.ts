import { InventoryStockReportService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockReportService";

export class InventoryStockReportController {
  private service = new InventoryStockReportService();
