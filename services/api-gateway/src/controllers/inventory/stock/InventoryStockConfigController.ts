import { InventoryStockConfigService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockConfigService";

export class InventoryStockConfigController {
  private service = new InventoryStockConfigService();
