import { InventoryStockItemService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockItemService";

export class InventoryStockItemController {
  private service = new InventoryStockItemService();
