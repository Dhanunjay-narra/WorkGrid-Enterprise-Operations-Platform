import { InventoryStockEventService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockEventService";

export class InventoryStockEventController {
  private service = new InventoryStockEventService();
