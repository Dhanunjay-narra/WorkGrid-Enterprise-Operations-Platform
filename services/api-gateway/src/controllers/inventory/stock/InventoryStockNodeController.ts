import { InventoryStockNodeService } from "../../../../core-engine/src/inventory/stock/services/InventoryStockNodeService";

export class InventoryStockNodeController {
  private service = new InventoryStockNodeService();
