import { InventorySkuReportService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuReportService";

export class InventorySkuReportController {
  private service = new InventorySkuReportService();
