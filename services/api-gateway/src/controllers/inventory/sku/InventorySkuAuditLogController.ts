import { InventorySkuAuditLogService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuAuditLogService";

export class InventorySkuAuditLogController {
  private service = new InventorySkuAuditLogService();
