import { InventorySkuBatchService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuBatchService";

export class InventorySkuBatchController {
  private service = new InventorySkuBatchService();
