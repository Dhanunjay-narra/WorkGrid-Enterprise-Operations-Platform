import { InventorySkuMetricService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuMetricService";

export class InventorySkuMetricController {
  private service = new InventorySkuMetricService();
