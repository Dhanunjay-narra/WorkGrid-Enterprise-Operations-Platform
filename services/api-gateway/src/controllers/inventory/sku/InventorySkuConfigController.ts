import { InventorySkuConfigService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuConfigService";

export class InventorySkuConfigController {
  private service = new InventorySkuConfigService();
