import { InventorySkuEventService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuEventService";

export class InventorySkuEventController {
  private service = new InventorySkuEventService();
