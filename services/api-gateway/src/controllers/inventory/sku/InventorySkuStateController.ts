import { InventorySkuStateService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuStateService";

export class InventorySkuStateController {
  private service = new InventorySkuStateService();
