import { InventorySkuPayloadService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuPayloadService";

export class InventorySkuPayloadController {
  private service = new InventorySkuPayloadService();
