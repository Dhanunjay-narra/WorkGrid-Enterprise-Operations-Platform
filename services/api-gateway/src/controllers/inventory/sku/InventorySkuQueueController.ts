import { InventorySkuQueueService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuQueueService";

export class InventorySkuQueueController {
  private service = new InventorySkuQueueService();
