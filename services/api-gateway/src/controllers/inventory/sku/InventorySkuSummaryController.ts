import { InventorySkuSummaryService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuSummaryService";

export class InventorySkuSummaryController {
  private service = new InventorySkuSummaryService();
