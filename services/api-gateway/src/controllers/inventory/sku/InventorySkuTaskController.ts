import { InventorySkuTaskService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuTaskService";

export class InventorySkuTaskController {
  private service = new InventorySkuTaskService();
