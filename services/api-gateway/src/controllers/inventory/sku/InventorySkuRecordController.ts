import { InventorySkuRecordService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuRecordService";

export class InventorySkuRecordController {
  private service = new InventorySkuRecordService();
