import { InventorySkuPolicyService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuPolicyService";

export class InventorySkuPolicyController {
  private service = new InventorySkuPolicyService();
