import { InventorySkuSessionService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuSessionService";

export class InventorySkuSessionController {
  private service = new InventorySkuSessionService();
