import { InventorySkuEntryService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuEntryService";

export class InventorySkuEntryController {
  private service = new InventorySkuEntryService();
