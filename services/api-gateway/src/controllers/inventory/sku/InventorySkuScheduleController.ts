import { InventorySkuScheduleService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuScheduleService";

export class InventorySkuScheduleController {
  private service = new InventorySkuScheduleService();
