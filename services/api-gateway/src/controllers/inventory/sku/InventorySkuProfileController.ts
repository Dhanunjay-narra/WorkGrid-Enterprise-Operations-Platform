import { InventorySkuProfileService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuProfileService";

export class InventorySkuProfileController {
  private service = new InventorySkuProfileService();
