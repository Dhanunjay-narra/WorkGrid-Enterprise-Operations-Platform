import { InventorySkuItemService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuItemService";

export class InventorySkuItemController {
  private service = new InventorySkuItemService();
