import { InventorySkuMappingService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuMappingService";

export class InventorySkuMappingController {
  private service = new InventorySkuMappingService();
