import { InventorySkuNodeService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuNodeService";

export class InventorySkuNodeController {
  private service = new InventorySkuNodeService();
