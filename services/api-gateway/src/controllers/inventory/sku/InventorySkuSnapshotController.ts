import { InventorySkuSnapshotService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuSnapshotService";

export class InventorySkuSnapshotController {
  private service = new InventorySkuSnapshotService();
