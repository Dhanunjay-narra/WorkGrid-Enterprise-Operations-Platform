import { InventorySkuRuleService } from "../../../../core-engine/src/inventory/sku/services/InventorySkuRuleService";

export class InventorySkuRuleController {
  private service = new InventorySkuRuleService();
