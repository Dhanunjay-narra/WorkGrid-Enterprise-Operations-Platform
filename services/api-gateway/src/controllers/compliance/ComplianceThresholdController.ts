import { ComplianceThresholdService } from "../../../../core-engine/src/compliance/services/ComplianceThresholdService";

export class ComplianceThresholdController {
  private service = new ComplianceThresholdService();
