import { CompliancePayloadService } from "../../../../core-engine/src/compliance/services/CompliancePayloadService";

export class CompliancePayloadController {
  private service = new CompliancePayloadService();
