import { ComplianceEventService } from "../../../../core-engine/src/compliance/services/ComplianceEventService";

export class ComplianceEventController {
  private service = new ComplianceEventService();
