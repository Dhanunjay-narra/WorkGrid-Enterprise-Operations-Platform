import { ComplianceSnapshotService } from "../../../../core-engine/src/compliance/services/ComplianceSnapshotService";

export class ComplianceSnapshotController {
  private service = new ComplianceSnapshotService();
