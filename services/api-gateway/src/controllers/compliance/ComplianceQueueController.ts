import { ComplianceQueueService } from "../../../../core-engine/src/compliance/services/ComplianceQueueService";

export class ComplianceQueueController {
  private service = new ComplianceQueueService();
