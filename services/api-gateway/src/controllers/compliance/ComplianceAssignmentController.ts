import { ComplianceAssignmentService } from "../../../../core-engine/src/compliance/services/ComplianceAssignmentService";

export class ComplianceAssignmentController {
  private service = new ComplianceAssignmentService();
