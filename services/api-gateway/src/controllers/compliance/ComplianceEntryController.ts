import { ComplianceEntryService } from "../../../../core-engine/src/compliance/services/ComplianceEntryService";

export class ComplianceEntryController {
  private service = new ComplianceEntryService();
