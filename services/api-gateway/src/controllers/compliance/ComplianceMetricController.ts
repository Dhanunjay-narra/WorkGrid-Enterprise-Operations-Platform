import { ComplianceMetricService } from "../../../../core-engine/src/compliance/services/ComplianceMetricService";

export class ComplianceMetricController {
  private service = new ComplianceMetricService();
