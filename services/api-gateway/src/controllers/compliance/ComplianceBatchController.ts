import { ComplianceBatchService } from "../../../../core-engine/src/compliance/services/ComplianceBatchService";

export class ComplianceBatchController {
  private service = new ComplianceBatchService();
