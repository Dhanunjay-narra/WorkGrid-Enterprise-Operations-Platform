import { ComplianceNodeService } from "../../../../core-engine/src/compliance/services/ComplianceNodeService";

export class ComplianceNodeController {
  private service = new ComplianceNodeService();
