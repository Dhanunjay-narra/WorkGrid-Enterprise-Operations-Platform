import { ComplianceStateService } from "../../../../core-engine/src/compliance/services/ComplianceStateService";

export class ComplianceStateController {
  private service = new ComplianceStateService();
