import { ComplianceSummaryService } from "../../../../core-engine/src/compliance/services/ComplianceSummaryService";

export class ComplianceSummaryController {
  private service = new ComplianceSummaryService();
