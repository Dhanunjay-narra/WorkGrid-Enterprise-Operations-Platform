import { ComplianceScheduleService } from "../../../../core-engine/src/compliance/services/ComplianceScheduleService";

export class ComplianceScheduleController {
  private service = new ComplianceScheduleService();
