import { ComplianceSessionService } from "../../../../core-engine/src/compliance/services/ComplianceSessionService";

export class ComplianceSessionController {
  private service = new ComplianceSessionService();
