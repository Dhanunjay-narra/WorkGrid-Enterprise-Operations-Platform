import { ComplianceTransactionService } from "../../../../core-engine/src/compliance/services/ComplianceTransactionService";

export class ComplianceTransactionController {
  private service = new ComplianceTransactionService();
