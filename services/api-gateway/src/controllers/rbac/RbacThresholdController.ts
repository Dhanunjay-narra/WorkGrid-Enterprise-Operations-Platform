import { RbacThresholdService } from "../../../../core-engine/src/rbac/services/RbacThresholdService";

export class RbacThresholdController {
  private service = new RbacThresholdService();
