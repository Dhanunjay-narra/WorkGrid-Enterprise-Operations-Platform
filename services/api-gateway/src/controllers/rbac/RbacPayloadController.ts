import { RbacPayloadService } from "../../../../core-engine/src/rbac/services/RbacPayloadService";

export class RbacPayloadController {
  private service = new RbacPayloadService();
