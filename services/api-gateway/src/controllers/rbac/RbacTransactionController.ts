import { RbacTransactionService } from "../../../../core-engine/src/rbac/services/RbacTransactionService";

export class RbacTransactionController {
  private service = new RbacTransactionService();
