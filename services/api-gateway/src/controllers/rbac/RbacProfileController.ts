import { RbacProfileService } from "../../../../core-engine/src/rbac/services/RbacProfileService";

export class RbacProfileController {
  private service = new RbacProfileService();
