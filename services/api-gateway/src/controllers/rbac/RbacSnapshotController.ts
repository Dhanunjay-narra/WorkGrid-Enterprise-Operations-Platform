import { RbacSnapshotService } from "../../../../core-engine/src/rbac/services/RbacSnapshotService";

export class RbacSnapshotController {
  private service = new RbacSnapshotService();
