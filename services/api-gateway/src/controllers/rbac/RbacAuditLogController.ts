import { RbacAuditLogService } from "../../../../core-engine/src/rbac/services/RbacAuditLogService";

export class RbacAuditLogController {
  private service = new RbacAuditLogService();
