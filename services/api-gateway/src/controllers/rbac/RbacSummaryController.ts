import { RbacSummaryService } from "../../../../core-engine/src/rbac/services/RbacSummaryService";

export class RbacSummaryController {
  private service = new RbacSummaryService();
