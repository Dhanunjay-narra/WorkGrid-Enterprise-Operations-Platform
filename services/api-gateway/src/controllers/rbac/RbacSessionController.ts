import { RbacSessionService } from "../../../../core-engine/src/rbac/services/RbacSessionService";

export class RbacSessionController {
  private service = new RbacSessionService();
