import { RbacMappingService } from "../../../../core-engine/src/rbac/services/RbacMappingService";

export class RbacMappingController {
  private service = new RbacMappingService();
