import { RbacScheduleService } from "../../../../core-engine/src/rbac/services/RbacScheduleService";

export class RbacScheduleController {
  private service = new RbacScheduleService();
