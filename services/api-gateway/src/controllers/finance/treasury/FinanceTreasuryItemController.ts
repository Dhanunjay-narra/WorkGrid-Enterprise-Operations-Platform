import { FinanceTreasuryItemService } from "../../../../core-engine/src/finance/treasury/services/FinanceTreasuryItemService";

export class FinanceTreasuryItemController {
  private service = new FinanceTreasuryItemService();
