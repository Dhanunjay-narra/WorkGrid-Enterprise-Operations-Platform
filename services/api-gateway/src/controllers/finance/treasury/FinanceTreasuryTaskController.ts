import { FinanceTreasuryTaskService } from "../../../../core-engine/src/finance/treasury/services/FinanceTreasuryTaskService";

export class FinanceTreasuryTaskController {
  private service = new FinanceTreasuryTaskService();
