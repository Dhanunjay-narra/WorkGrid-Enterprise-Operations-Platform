import { FinanceTreasuryRuleService } from "../../../../core-engine/src/finance/treasury/services/FinanceTreasuryRuleService";

export class FinanceTreasuryRuleController {
  private service = new FinanceTreasuryRuleService();
