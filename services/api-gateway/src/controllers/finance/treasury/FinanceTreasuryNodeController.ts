import { FinanceTreasuryNodeService } from "../../../../core-engine/src/finance/treasury/services/FinanceTreasuryNodeService";

export class FinanceTreasuryNodeController {
  private service = new FinanceTreasuryNodeService();
