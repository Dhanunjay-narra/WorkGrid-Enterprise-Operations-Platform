import { FinanceBankingReportService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingReportService";

export class FinanceBankingReportController {
  private service = new FinanceBankingReportService();
