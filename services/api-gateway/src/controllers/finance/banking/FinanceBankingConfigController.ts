import { FinanceBankingConfigService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingConfigService";

export class FinanceBankingConfigController {
  private service = new FinanceBankingConfigService();
