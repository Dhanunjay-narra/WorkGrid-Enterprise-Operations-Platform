import { FinanceBankingBatchService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingBatchService";

export class FinanceBankingBatchController {
  private service = new FinanceBankingBatchService();
