import { FinanceBankingTaskService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingTaskService";

export class FinanceBankingTaskController {
  private service = new FinanceBankingTaskService();
