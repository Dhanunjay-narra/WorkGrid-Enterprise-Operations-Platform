import { FinanceBankingMetricService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingMetricService";

export class FinanceBankingMetricController {
  private service = new FinanceBankingMetricService();
