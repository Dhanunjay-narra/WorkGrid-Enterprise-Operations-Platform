import { FinanceBankingQueueService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingQueueService";

export class FinanceBankingQueueController {
  private service = new FinanceBankingQueueService();
