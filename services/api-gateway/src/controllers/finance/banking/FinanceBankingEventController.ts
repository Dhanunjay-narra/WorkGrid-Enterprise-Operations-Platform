import { FinanceBankingEventService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingEventService";

export class FinanceBankingEventController {
  private service = new FinanceBankingEventService();
