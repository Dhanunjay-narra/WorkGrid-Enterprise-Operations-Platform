import { FinanceBankingNodeService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingNodeService";

export class FinanceBankingNodeController {
  private service = new FinanceBankingNodeService();
