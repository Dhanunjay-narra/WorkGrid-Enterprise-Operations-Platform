import { FinanceBankingRuleService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingRuleService";

export class FinanceBankingRuleController {
  private service = new FinanceBankingRuleService();
