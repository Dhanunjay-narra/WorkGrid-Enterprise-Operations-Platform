import { FinanceBankingRecordService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingRecordService";

export class FinanceBankingRecordController {
  private service = new FinanceBankingRecordService();
