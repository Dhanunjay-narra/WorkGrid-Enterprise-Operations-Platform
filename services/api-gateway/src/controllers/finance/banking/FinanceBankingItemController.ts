import { FinanceBankingItemService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingItemService";

export class FinanceBankingItemController {
  private service = new FinanceBankingItemService();
