import { FinanceBankingPolicyService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingPolicyService";

export class FinanceBankingPolicyController {
  private service = new FinanceBankingPolicyService();
