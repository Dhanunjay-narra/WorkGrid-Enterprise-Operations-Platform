import { FinanceBankingStateService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingStateService";

export class FinanceBankingStateController {
  private service = new FinanceBankingStateService();
