import { FinanceBankingEntryService } from "../../../../core-engine/src/finance/banking/services/FinanceBankingEntryService";

export class FinanceBankingEntryController {
  private service = new FinanceBankingEntryService();
