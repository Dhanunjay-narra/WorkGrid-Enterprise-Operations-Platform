import { FinanceBillsAuditLogService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsAuditLogService";

export class FinanceBillsAuditLogController {
  private service = new FinanceBillsAuditLogService();
