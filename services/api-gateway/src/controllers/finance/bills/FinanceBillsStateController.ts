import { FinanceBillsStateService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsStateService";

export class FinanceBillsStateController {
  private service = new FinanceBillsStateService();
