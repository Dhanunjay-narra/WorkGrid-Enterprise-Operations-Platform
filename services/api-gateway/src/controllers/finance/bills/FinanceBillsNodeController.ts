import { FinanceBillsNodeService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsNodeService";

export class FinanceBillsNodeController {
  private service = new FinanceBillsNodeService();
