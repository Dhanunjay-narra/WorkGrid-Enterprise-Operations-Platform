import { FinanceBillsItemService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsItemService";

export class FinanceBillsItemController {
  private service = new FinanceBillsItemService();
