import { FinanceBillsEventService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsEventService";

export class FinanceBillsEventController {
  private service = new FinanceBillsEventService();
