import { FinanceBillsSessionService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsSessionService";

export class FinanceBillsSessionController {
  private service = new FinanceBillsSessionService();
