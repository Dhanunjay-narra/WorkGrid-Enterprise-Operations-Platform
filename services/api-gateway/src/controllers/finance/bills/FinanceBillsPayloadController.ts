import { FinanceBillsPayloadService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsPayloadService";

export class FinanceBillsPayloadController {
  private service = new FinanceBillsPayloadService();
