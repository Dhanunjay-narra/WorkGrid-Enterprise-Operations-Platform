import { FinanceBillsScheduleService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsScheduleService";

export class FinanceBillsScheduleController {
  private service = new FinanceBillsScheduleService();
