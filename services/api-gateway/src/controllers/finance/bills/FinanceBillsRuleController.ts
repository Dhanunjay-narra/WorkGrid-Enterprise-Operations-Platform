import { FinanceBillsRuleService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsRuleService";

export class FinanceBillsRuleController {
  private service = new FinanceBillsRuleService();
