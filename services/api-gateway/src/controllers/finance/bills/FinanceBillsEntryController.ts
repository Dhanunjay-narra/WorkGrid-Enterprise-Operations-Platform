import { FinanceBillsEntryService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsEntryService";

export class FinanceBillsEntryController {
  private service = new FinanceBillsEntryService();
