import { FinanceBillsPolicyService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsPolicyService";

export class FinanceBillsPolicyController {
  private service = new FinanceBillsPolicyService();
