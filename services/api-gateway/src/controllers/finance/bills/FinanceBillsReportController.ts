import { FinanceBillsReportService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsReportService";

export class FinanceBillsReportController {
  private service = new FinanceBillsReportService();
