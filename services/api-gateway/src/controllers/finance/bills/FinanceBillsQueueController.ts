import { FinanceBillsQueueService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsQueueService";

export class FinanceBillsQueueController {
  private service = new FinanceBillsQueueService();
