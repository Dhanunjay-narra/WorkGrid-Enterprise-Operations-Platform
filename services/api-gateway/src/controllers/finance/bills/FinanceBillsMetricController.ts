import { FinanceBillsMetricService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsMetricService";

export class FinanceBillsMetricController {
  private service = new FinanceBillsMetricService();
