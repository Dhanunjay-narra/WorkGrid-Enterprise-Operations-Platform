import { FinanceBillsSummaryService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsSummaryService";

export class FinanceBillsSummaryController {
  private service = new FinanceBillsSummaryService();
