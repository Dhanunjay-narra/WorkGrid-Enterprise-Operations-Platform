import { FinanceBillsConfigService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsConfigService";

export class FinanceBillsConfigController {
  private service = new FinanceBillsConfigService();
