import { FinanceBillsMappingService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsMappingService";

export class FinanceBillsMappingController {
  private service = new FinanceBillsMappingService();
