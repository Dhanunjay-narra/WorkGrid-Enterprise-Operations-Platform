import { FinanceBillsBatchService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsBatchService";

export class FinanceBillsBatchController {
  private service = new FinanceBillsBatchService();
