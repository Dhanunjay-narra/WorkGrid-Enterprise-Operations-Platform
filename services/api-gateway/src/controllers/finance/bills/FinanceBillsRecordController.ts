import { FinanceBillsRecordService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsRecordService";

export class FinanceBillsRecordController {
  private service = new FinanceBillsRecordService();
