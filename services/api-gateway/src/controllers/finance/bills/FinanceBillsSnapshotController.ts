import { FinanceBillsSnapshotService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsSnapshotService";

export class FinanceBillsSnapshotController {
  private service = new FinanceBillsSnapshotService();
