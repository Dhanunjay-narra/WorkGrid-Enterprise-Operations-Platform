import { FinanceBillsTaskService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsTaskService";

export class FinanceBillsTaskController {
  private service = new FinanceBillsTaskService();
