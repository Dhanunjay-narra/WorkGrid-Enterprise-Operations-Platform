import { FinanceBillsProfileService } from "../../../../core-engine/src/finance/bills/services/FinanceBillsProfileService";

export class FinanceBillsProfileController {
  private service = new FinanceBillsProfileService();
