import { FinanceTaxesSnapshotService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesSnapshotService";

export class FinanceTaxesSnapshotController {
  private service = new FinanceTaxesSnapshotService();
