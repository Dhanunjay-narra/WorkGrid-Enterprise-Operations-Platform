import { FinanceTaxesSummaryService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesSummaryService";

export class FinanceTaxesSummaryController {
  private service = new FinanceTaxesSummaryService();
