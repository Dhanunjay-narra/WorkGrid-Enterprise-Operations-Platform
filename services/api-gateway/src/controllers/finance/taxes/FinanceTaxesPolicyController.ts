import { FinanceTaxesPolicyService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesPolicyService";

export class FinanceTaxesPolicyController {
  private service = new FinanceTaxesPolicyService();
