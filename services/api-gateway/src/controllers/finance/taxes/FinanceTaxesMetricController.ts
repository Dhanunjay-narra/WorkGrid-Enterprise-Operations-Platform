import { FinanceTaxesMetricService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesMetricService";

export class FinanceTaxesMetricController {
  private service = new FinanceTaxesMetricService();
