import { FinanceTaxesNodeService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesNodeService";

export class FinanceTaxesNodeController {
  private service = new FinanceTaxesNodeService();
