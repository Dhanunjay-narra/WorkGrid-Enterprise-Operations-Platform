import { FinanceTaxesItemService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesItemService";

export class FinanceTaxesItemController {
  private service = new FinanceTaxesItemService();
