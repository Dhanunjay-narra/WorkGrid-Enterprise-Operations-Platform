import { FinanceTaxesReportService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesReportService";

export class FinanceTaxesReportController {
  private service = new FinanceTaxesReportService();
