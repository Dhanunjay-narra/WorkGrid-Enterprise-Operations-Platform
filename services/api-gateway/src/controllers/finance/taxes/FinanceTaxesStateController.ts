import { FinanceTaxesStateService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesStateService";

export class FinanceTaxesStateController {
  private service = new FinanceTaxesStateService();
