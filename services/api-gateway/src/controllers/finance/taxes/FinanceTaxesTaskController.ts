import { FinanceTaxesTaskService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesTaskService";

export class FinanceTaxesTaskController {
  private service = new FinanceTaxesTaskService();
