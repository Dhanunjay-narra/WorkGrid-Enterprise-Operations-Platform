import { FinanceTaxesPayloadService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesPayloadService";

export class FinanceTaxesPayloadController {
  private service = new FinanceTaxesPayloadService();
