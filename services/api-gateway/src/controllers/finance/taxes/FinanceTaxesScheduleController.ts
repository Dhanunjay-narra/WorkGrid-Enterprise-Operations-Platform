import { FinanceTaxesScheduleService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesScheduleService";

export class FinanceTaxesScheduleController {
  private service = new FinanceTaxesScheduleService();
