import { FinanceTaxesConfigService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesConfigService";

export class FinanceTaxesConfigController {
  private service = new FinanceTaxesConfigService();
