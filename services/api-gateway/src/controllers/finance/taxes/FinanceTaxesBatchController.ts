import { FinanceTaxesBatchService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesBatchService";

export class FinanceTaxesBatchController {
  private service = new FinanceTaxesBatchService();
