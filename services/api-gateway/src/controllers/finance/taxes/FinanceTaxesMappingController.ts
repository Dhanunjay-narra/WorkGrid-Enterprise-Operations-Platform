import { FinanceTaxesMappingService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesMappingService";

export class FinanceTaxesMappingController {
  private service = new FinanceTaxesMappingService();
