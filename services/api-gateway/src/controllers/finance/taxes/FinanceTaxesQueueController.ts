import { FinanceTaxesQueueService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesQueueService";

export class FinanceTaxesQueueController {
  private service = new FinanceTaxesQueueService();
