import { FinanceTaxesRuleService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesRuleService";

export class FinanceTaxesRuleController {
  private service = new FinanceTaxesRuleService();
