import { FinanceTaxesAuditLogService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesAuditLogService";

export class FinanceTaxesAuditLogController {
  private service = new FinanceTaxesAuditLogService();
