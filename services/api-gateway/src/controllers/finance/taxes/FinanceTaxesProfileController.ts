import { FinanceTaxesProfileService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesProfileService";

export class FinanceTaxesProfileController {
  private service = new FinanceTaxesProfileService();
