import { FinanceTaxesSessionService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesSessionService";

export class FinanceTaxesSessionController {
  private service = new FinanceTaxesSessionService();
