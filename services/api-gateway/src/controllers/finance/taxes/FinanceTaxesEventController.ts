import { FinanceTaxesEventService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesEventService";

export class FinanceTaxesEventController {
  private service = new FinanceTaxesEventService();
