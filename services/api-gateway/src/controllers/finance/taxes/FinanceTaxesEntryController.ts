import { FinanceTaxesEntryService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesEntryService";

export class FinanceTaxesEntryController {
  private service = new FinanceTaxesEntryService();
