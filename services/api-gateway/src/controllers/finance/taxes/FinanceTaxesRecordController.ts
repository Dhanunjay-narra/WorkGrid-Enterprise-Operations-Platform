import { FinanceTaxesRecordService } from "../../../../core-engine/src/finance/taxes/services/FinanceTaxesRecordService";

export class FinanceTaxesRecordController {
  private service = new FinanceTaxesRecordService();
