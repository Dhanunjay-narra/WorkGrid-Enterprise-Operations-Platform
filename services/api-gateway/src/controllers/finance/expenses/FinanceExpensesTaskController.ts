import { FinanceExpensesTaskService } from "../../../../core-engine/src/finance/expenses/services/FinanceExpensesTaskService";

export class FinanceExpensesTaskController {
  private service = new FinanceExpensesTaskService();
