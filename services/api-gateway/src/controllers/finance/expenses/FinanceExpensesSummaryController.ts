import { FinanceExpensesSummaryService } from "../../../../core-engine/src/finance/expenses/services/FinanceExpensesSummaryService";

export class FinanceExpensesSummaryController {
  private service = new FinanceExpensesSummaryService();
