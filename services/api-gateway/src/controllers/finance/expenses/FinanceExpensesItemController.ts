import { FinanceExpensesItemService } from "../../../../core-engine/src/finance/expenses/services/FinanceExpensesItemService";

export class FinanceExpensesItemController {
  private service = new FinanceExpensesItemService();
