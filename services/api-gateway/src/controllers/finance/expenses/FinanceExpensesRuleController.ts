import { FinanceExpensesRuleService } from "../../../../core-engine/src/finance/expenses/services/FinanceExpensesRuleService";

export class FinanceExpensesRuleController {
  private service = new FinanceExpensesRuleService();
