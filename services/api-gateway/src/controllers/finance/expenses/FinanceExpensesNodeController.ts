import { FinanceExpensesNodeService } from "../../../../core-engine/src/finance/expenses/services/FinanceExpensesNodeService";

export class FinanceExpensesNodeController {
  private service = new FinanceExpensesNodeService();
