import { FinanceForecastItemService } from "../../../../core-engine/src/finance/forecast/services/FinanceForecastItemService";

export class FinanceForecastItemController {
  private service = new FinanceForecastItemService();
