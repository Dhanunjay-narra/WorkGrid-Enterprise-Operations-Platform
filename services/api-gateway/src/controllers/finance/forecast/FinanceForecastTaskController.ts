import { FinanceForecastTaskService } from "../../../../core-engine/src/finance/forecast/services/FinanceForecastTaskService";

export class FinanceForecastTaskController {
  private service = new FinanceForecastTaskService();
