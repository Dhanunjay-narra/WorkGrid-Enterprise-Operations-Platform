import { FinanceForecastRuleService } from "../../../../core-engine/src/finance/forecast/services/FinanceForecastRuleService";

export class FinanceForecastRuleController {
  private service = new FinanceForecastRuleService();
