import { FinanceForecastNodeService } from "../../../../core-engine/src/finance/forecast/services/FinanceForecastNodeService";

export class FinanceForecastNodeController {
  private service = new FinanceForecastNodeService();
