import { FinanceInvoicesItemService } from "../../../../core-engine/src/finance/invoices/services/FinanceInvoicesItemService";

export class FinanceInvoicesItemController {
  private service = new FinanceInvoicesItemService();
