import { FinanceInvoicesNodeService } from "../../../../core-engine/src/finance/invoices/services/FinanceInvoicesNodeService";

export class FinanceInvoicesNodeController {
  private service = new FinanceInvoicesNodeService();
