import { FinanceInvoicesTaskService } from "../../../../core-engine/src/finance/invoices/services/FinanceInvoicesTaskService";

export class FinanceInvoicesTaskController {
  private service = new FinanceInvoicesTaskService();
