import { FinanceInvoicesRuleService } from "../../../../core-engine/src/finance/invoices/services/FinanceInvoicesRuleService";

export class FinanceInvoicesRuleController {
  private service = new FinanceInvoicesRuleService();
