import { FinanceLedgerEventService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerEventService";

export class FinanceLedgerEventController {
  private service = new FinanceLedgerEventService();
