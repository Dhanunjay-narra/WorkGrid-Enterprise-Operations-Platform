import { FinanceLedgerTaskService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerTaskService";

export class FinanceLedgerTaskController {
  private service = new FinanceLedgerTaskService();
