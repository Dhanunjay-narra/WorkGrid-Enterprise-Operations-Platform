import { FinanceLedgerNodeService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerNodeService";

export class FinanceLedgerNodeController {
  private service = new FinanceLedgerNodeService();
