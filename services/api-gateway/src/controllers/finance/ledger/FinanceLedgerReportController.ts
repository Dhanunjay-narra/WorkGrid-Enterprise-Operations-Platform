import { FinanceLedgerReportService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerReportService";

export class FinanceLedgerReportController {
  private service = new FinanceLedgerReportService();
