import { FinanceLedgerItemService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerItemService";

export class FinanceLedgerItemController {
  private service = new FinanceLedgerItemService();
