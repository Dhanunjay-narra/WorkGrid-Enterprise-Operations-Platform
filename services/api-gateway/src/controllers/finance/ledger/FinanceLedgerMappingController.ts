import { FinanceLedgerMappingService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerMappingService";

export class FinanceLedgerMappingController {
  private service = new FinanceLedgerMappingService();
