import { FinanceLedgerPayloadService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerPayloadService";

export class FinanceLedgerPayloadController {
  private service = new FinanceLedgerPayloadService();
