import { FinanceLedgerRuleService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerRuleService";

export class FinanceLedgerRuleController {
  private service = new FinanceLedgerRuleService();
