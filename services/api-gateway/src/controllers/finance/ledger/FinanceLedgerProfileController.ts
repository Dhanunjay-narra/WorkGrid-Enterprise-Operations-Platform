import { FinanceLedgerProfileService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerProfileService";

export class FinanceLedgerProfileController {
  private service = new FinanceLedgerProfileService();
