import { FinanceLedgerSessionService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerSessionService";

export class FinanceLedgerSessionController {
  private service = new FinanceLedgerSessionService();
