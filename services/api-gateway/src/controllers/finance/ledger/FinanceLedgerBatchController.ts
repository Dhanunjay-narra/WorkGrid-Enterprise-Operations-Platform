import { FinanceLedgerBatchService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerBatchService";

export class FinanceLedgerBatchController {
  private service = new FinanceLedgerBatchService();
