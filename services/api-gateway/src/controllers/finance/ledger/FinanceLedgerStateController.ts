import { FinanceLedgerStateService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerStateService";

export class FinanceLedgerStateController {
  private service = new FinanceLedgerStateService();
