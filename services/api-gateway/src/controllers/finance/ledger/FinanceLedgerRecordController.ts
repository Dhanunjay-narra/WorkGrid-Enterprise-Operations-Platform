import { FinanceLedgerRecordService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerRecordService";

export class FinanceLedgerRecordController {
  private service = new FinanceLedgerRecordService();
