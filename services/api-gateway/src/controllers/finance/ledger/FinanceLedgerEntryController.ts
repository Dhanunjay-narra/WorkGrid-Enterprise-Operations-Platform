import { FinanceLedgerEntryService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerEntryService";

export class FinanceLedgerEntryController {
  private service = new FinanceLedgerEntryService();
