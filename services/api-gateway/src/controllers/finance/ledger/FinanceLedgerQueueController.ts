import { FinanceLedgerQueueService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerQueueService";

export class FinanceLedgerQueueController {
  private service = new FinanceLedgerQueueService();
