import { FinanceLedgerPolicyService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerPolicyService";

export class FinanceLedgerPolicyController {
  private service = new FinanceLedgerPolicyService();
