import { FinanceLedgerMetricService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerMetricService";

export class FinanceLedgerMetricController {
  private service = new FinanceLedgerMetricService();
