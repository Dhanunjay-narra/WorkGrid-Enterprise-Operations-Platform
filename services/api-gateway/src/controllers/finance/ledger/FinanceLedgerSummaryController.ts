import { FinanceLedgerSummaryService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerSummaryService";

export class FinanceLedgerSummaryController {
  private service = new FinanceLedgerSummaryService();
