import { FinanceLedgerConfigService } from "../../../../core-engine/src/finance/ledger/services/FinanceLedgerConfigService";

export class FinanceLedgerConfigController {
  private service = new FinanceLedgerConfigService();
