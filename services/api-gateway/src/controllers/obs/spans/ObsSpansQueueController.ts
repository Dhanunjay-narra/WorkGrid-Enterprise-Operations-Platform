import { ObsSpansQueueService } from "../../../../core-engine/src/obs/spans/services/ObsSpansQueueService";

export class ObsSpansQueueController {
  private service = new ObsSpansQueueService();
