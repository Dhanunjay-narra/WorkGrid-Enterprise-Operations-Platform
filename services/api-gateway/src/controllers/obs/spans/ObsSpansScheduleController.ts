import { ObsSpansScheduleService } from "../../../../core-engine/src/obs/spans/services/ObsSpansScheduleService";

export class ObsSpansScheduleController {
  private service = new ObsSpansScheduleService();
