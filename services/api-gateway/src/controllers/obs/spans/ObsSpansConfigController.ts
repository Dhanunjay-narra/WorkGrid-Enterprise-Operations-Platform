import { ObsSpansConfigService } from "../../../../core-engine/src/obs/spans/services/ObsSpansConfigService";

export class ObsSpansConfigController {
  private service = new ObsSpansConfigService();
