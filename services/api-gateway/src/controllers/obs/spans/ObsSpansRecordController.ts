import { ObsSpansRecordService } from "../../../../core-engine/src/obs/spans/services/ObsSpansRecordService";

export class ObsSpansRecordController {
  private service = new ObsSpansRecordService();
