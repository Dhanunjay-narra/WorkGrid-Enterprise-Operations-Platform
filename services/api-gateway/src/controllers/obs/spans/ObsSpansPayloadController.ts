import { ObsSpansPayloadService } from "../../../../core-engine/src/obs/spans/services/ObsSpansPayloadService";

export class ObsSpansPayloadController {
  private service = new ObsSpansPayloadService();
