import { ObsSpansSnapshotService } from "../../../../core-engine/src/obs/spans/services/ObsSpansSnapshotService";

export class ObsSpansSnapshotController {
  private service = new ObsSpansSnapshotService();
