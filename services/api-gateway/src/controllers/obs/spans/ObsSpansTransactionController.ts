import { ObsSpansTransactionService } from "../../../../core-engine/src/obs/spans/services/ObsSpansTransactionService";

export class ObsSpansTransactionController {
  private service = new ObsSpansTransactionService();
