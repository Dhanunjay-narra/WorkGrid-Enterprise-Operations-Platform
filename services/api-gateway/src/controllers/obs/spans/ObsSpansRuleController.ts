import { ObsSpansRuleService } from "../../../../core-engine/src/obs/spans/services/ObsSpansRuleService";

export class ObsSpansRuleController {
  private service = new ObsSpansRuleService();
