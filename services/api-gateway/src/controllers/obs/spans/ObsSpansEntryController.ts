import { ObsSpansEntryService } from "../../../../core-engine/src/obs/spans/services/ObsSpansEntryService";

export class ObsSpansEntryController {
  private service = new ObsSpansEntryService();
