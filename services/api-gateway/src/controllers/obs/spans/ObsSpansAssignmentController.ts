import { ObsSpansAssignmentService } from "../../../../core-engine/src/obs/spans/services/ObsSpansAssignmentService";

export class ObsSpansAssignmentController {
  private service = new ObsSpansAssignmentService();
