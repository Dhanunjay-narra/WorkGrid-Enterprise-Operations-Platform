import { ObsSpansReportService } from "../../../../core-engine/src/obs/spans/services/ObsSpansReportService";

export class ObsSpansReportController {
  private service = new ObsSpansReportService();
