import { ObsSpansSessionService } from "../../../../core-engine/src/obs/spans/services/ObsSpansSessionService";

export class ObsSpansSessionController {
  private service = new ObsSpansSessionService();
