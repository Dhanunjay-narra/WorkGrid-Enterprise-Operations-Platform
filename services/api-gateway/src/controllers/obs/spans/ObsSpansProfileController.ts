import { ObsSpansProfileService } from "../../../../core-engine/src/obs/spans/services/ObsSpansProfileService";

export class ObsSpansProfileController {
  private service = new ObsSpansProfileService();
