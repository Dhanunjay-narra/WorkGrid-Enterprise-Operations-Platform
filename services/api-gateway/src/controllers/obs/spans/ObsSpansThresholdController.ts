import { ObsSpansThresholdService } from "../../../../core-engine/src/obs/spans/services/ObsSpansThresholdService";

export class ObsSpansThresholdController {
  private service = new ObsSpansThresholdService();
