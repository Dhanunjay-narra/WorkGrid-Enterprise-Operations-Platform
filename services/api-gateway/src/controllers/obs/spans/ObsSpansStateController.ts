import { ObsSpansStateService } from "../../../../core-engine/src/obs/spans/services/ObsSpansStateService";

export class ObsSpansStateController {
  private service = new ObsSpansStateService();
