import { ObsSpansTaskService } from "../../../../core-engine/src/obs/spans/services/ObsSpansTaskService";

export class ObsSpansTaskController {
  private service = new ObsSpansTaskService();
