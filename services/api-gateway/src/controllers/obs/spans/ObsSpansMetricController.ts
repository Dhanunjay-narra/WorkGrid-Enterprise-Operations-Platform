import { ObsSpansMetricService } from "../../../../core-engine/src/obs/spans/services/ObsSpansMetricService";

export class ObsSpansMetricController {
  private service = new ObsSpansMetricService();
