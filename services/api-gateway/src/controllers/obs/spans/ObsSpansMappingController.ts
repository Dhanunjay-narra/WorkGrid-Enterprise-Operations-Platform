import { ObsSpansMappingService } from "../../../../core-engine/src/obs/spans/services/ObsSpansMappingService";

export class ObsSpansMappingController {
  private service = new ObsSpansMappingService();
