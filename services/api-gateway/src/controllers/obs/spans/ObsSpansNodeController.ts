import { ObsSpansNodeService } from "../../../../core-engine/src/obs/spans/services/ObsSpansNodeService";

export class ObsSpansNodeController {
  private service = new ObsSpansNodeService();
