import { ObsSpansPolicyService } from "../../../../core-engine/src/obs/spans/services/ObsSpansPolicyService";

export class ObsSpansPolicyController {
  private service = new ObsSpansPolicyService();
