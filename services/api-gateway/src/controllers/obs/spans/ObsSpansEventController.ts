import { ObsSpansEventService } from "../../../../core-engine/src/obs/spans/services/ObsSpansEventService";

export class ObsSpansEventController {
  private service = new ObsSpansEventService();
