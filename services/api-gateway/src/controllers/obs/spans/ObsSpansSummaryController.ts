import { ObsSpansSummaryService } from "../../../../core-engine/src/obs/spans/services/ObsSpansSummaryService";

export class ObsSpansSummaryController {
  private service = new ObsSpansSummaryService();
