import { ObsSpansAuditLogService } from "../../../../core-engine/src/obs/spans/services/ObsSpansAuditLogService";

export class ObsSpansAuditLogController {
  private service = new ObsSpansAuditLogService();
