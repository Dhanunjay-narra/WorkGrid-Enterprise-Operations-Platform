import { ObsSpansBatchService } from "../../../../core-engine/src/obs/spans/services/ObsSpansBatchService";

export class ObsSpansBatchController {
  private service = new ObsSpansBatchService();
