import { ObsSpansItemService } from "../../../../core-engine/src/obs/spans/services/ObsSpansItemService";

export class ObsSpansItemController {
  private service = new ObsSpansItemService();
