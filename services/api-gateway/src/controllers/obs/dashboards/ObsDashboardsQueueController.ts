import { ObsDashboardsQueueService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsQueueService";

export class ObsDashboardsQueueController {
  private service = new ObsDashboardsQueueService();
