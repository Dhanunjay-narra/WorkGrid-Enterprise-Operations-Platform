import { ObsDashboardsSummaryService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsSummaryService";

export class ObsDashboardsSummaryController {
  private service = new ObsDashboardsSummaryService();
