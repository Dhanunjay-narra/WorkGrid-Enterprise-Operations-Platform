import { ObsDashboardsBatchService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsBatchService";

export class ObsDashboardsBatchController {
  private service = new ObsDashboardsBatchService();
