import { ObsDashboardsMappingService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsMappingService";

export class ObsDashboardsMappingController {
  private service = new ObsDashboardsMappingService();
