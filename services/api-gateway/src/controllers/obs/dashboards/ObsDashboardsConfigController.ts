import { ObsDashboardsConfigService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsConfigService";

export class ObsDashboardsConfigController {
  private service = new ObsDashboardsConfigService();
