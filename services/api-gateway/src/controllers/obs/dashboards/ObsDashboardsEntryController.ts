import { ObsDashboardsEntryService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsEntryService";

export class ObsDashboardsEntryController {
  private service = new ObsDashboardsEntryService();
