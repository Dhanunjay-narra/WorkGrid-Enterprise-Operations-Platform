import { ObsDashboardsStateService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsStateService";

export class ObsDashboardsStateController {
  private service = new ObsDashboardsStateService();
