import { ObsDashboardsReportService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsReportService";

export class ObsDashboardsReportController {
  private service = new ObsDashboardsReportService();
