import { ObsDashboardsEventService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsEventService";

export class ObsDashboardsEventController {
  private service = new ObsDashboardsEventService();
