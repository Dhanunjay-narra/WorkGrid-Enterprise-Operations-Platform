import { ObsDashboardsSessionService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsSessionService";

export class ObsDashboardsSessionController {
  private service = new ObsDashboardsSessionService();
