import { ObsDashboardsRuleService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsRuleService";

export class ObsDashboardsRuleController {
  private service = new ObsDashboardsRuleService();
