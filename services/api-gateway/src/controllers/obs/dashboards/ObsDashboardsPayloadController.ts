import { ObsDashboardsPayloadService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsPayloadService";

export class ObsDashboardsPayloadController {
  private service = new ObsDashboardsPayloadService();
