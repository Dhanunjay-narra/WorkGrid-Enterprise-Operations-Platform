import { ObsDashboardsMetricService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsMetricService";

export class ObsDashboardsMetricController {
  private service = new ObsDashboardsMetricService();
