import { ObsDashboardsRecordService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsRecordService";

export class ObsDashboardsRecordController {
  private service = new ObsDashboardsRecordService();
