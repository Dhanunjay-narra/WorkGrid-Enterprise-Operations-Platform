import { ObsDashboardsProfileService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsProfileService";

export class ObsDashboardsProfileController {
  private service = new ObsDashboardsProfileService();
