import { ObsDashboardsNodeService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsNodeService";

export class ObsDashboardsNodeController {
  private service = new ObsDashboardsNodeService();
