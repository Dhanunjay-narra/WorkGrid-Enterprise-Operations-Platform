import { ObsDashboardsItemService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsItemService";

export class ObsDashboardsItemController {
  private service = new ObsDashboardsItemService();
