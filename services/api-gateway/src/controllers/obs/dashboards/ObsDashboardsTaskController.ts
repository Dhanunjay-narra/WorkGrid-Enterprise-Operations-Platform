import { ObsDashboardsTaskService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsTaskService";

export class ObsDashboardsTaskController {
  private service = new ObsDashboardsTaskService();
