import { ObsDashboardsPolicyService } from "../../../../core-engine/src/obs/dashboards/services/ObsDashboardsPolicyService";

export class ObsDashboardsPolicyController {
  private service = new ObsDashboardsPolicyService();
