import { ObsAlertsStateService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsStateService";

export class ObsAlertsStateController {
  private service = new ObsAlertsStateService();
