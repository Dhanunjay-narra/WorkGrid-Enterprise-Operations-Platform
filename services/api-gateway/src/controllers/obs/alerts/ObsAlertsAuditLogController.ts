import { ObsAlertsAuditLogService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsAuditLogService";

export class ObsAlertsAuditLogController {
  private service = new ObsAlertsAuditLogService();
