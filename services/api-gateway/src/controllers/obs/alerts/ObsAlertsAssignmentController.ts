import { ObsAlertsAssignmentService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsAssignmentService";

export class ObsAlertsAssignmentController {
  private service = new ObsAlertsAssignmentService();
