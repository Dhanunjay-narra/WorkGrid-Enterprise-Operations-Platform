import { ObsAlertsPolicyService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsPolicyService";

export class ObsAlertsPolicyController {
  private service = new ObsAlertsPolicyService();
