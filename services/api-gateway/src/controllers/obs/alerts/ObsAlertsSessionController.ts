import { ObsAlertsSessionService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsSessionService";

export class ObsAlertsSessionController {
  private service = new ObsAlertsSessionService();
