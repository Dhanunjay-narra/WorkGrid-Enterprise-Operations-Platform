import { ObsAlertsProfileService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsProfileService";

export class ObsAlertsProfileController {
  private service = new ObsAlertsProfileService();
