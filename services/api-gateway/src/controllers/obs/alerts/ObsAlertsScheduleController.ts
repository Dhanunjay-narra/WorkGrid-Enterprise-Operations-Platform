import { ObsAlertsScheduleService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsScheduleService";

export class ObsAlertsScheduleController {
  private service = new ObsAlertsScheduleService();
