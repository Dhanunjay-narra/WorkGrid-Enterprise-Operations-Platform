import { ObsAlertsSummaryService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsSummaryService";

export class ObsAlertsSummaryController {
  private service = new ObsAlertsSummaryService();
