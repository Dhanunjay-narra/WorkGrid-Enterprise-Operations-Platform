import { ObsAlertsTransactionService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsTransactionService";

export class ObsAlertsTransactionController {
  private service = new ObsAlertsTransactionService();
