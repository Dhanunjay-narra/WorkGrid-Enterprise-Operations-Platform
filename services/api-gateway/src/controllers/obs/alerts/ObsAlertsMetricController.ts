import { ObsAlertsMetricService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsMetricService";

export class ObsAlertsMetricController {
  private service = new ObsAlertsMetricService();
