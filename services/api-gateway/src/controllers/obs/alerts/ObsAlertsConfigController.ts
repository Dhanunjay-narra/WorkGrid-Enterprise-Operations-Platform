import { ObsAlertsConfigService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsConfigService";

export class ObsAlertsConfigController {
  private service = new ObsAlertsConfigService();
