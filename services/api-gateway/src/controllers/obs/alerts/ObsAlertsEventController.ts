import { ObsAlertsEventService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsEventService";

export class ObsAlertsEventController {
  private service = new ObsAlertsEventService();
