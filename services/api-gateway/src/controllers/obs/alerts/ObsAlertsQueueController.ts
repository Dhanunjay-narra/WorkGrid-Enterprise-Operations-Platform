import { ObsAlertsQueueService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsQueueService";

export class ObsAlertsQueueController {
  private service = new ObsAlertsQueueService();
