import { ObsAlertsMappingService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsMappingService";

export class ObsAlertsMappingController {
  private service = new ObsAlertsMappingService();
