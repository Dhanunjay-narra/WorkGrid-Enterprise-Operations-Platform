import { ObsAlertsRecordService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsRecordService";

export class ObsAlertsRecordController {
  private service = new ObsAlertsRecordService();
