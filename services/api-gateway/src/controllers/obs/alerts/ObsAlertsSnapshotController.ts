import { ObsAlertsSnapshotService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsSnapshotService";

export class ObsAlertsSnapshotController {
  private service = new ObsAlertsSnapshotService();
