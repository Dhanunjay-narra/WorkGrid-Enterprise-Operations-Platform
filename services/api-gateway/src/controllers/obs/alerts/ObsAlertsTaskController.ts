import { ObsAlertsTaskService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsTaskService";

export class ObsAlertsTaskController {
  private service = new ObsAlertsTaskService();
