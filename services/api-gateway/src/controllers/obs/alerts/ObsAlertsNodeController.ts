import { ObsAlertsNodeService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsNodeService";

export class ObsAlertsNodeController {
  private service = new ObsAlertsNodeService();
