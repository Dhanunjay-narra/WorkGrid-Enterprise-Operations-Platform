import { ObsAlertsBatchService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsBatchService";

export class ObsAlertsBatchController {
  private service = new ObsAlertsBatchService();
