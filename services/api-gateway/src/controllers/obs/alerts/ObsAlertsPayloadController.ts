import { ObsAlertsPayloadService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsPayloadService";

export class ObsAlertsPayloadController {
  private service = new ObsAlertsPayloadService();
