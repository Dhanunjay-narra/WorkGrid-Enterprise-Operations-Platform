import { ObsAlertsThresholdService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsThresholdService";

export class ObsAlertsThresholdController {
  private service = new ObsAlertsThresholdService();
