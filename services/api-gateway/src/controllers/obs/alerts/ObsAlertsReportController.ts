import { ObsAlertsReportService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsReportService";

export class ObsAlertsReportController {
  private service = new ObsAlertsReportService();
