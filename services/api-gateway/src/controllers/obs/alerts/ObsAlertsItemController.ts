import { ObsAlertsItemService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsItemService";

export class ObsAlertsItemController {
  private service = new ObsAlertsItemService();
