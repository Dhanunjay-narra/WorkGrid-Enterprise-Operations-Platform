import { ObsAlertsEntryService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsEntryService";

export class ObsAlertsEntryController {
  private service = new ObsAlertsEntryService();
