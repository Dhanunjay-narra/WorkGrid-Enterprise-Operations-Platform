import { ObsAlertsRuleService } from "../../../../core-engine/src/obs/alerts/services/ObsAlertsRuleService";

export class ObsAlertsRuleController {
  private service = new ObsAlertsRuleService();
