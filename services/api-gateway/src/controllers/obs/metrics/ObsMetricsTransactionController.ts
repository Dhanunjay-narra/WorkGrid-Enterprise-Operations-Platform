import { ObsMetricsTransactionService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsTransactionService";

export class ObsMetricsTransactionController {
  private service = new ObsMetricsTransactionService();
