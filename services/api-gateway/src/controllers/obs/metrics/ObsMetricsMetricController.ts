import { ObsMetricsMetricService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsMetricService";

export class ObsMetricsMetricController {
  private service = new ObsMetricsMetricService();
