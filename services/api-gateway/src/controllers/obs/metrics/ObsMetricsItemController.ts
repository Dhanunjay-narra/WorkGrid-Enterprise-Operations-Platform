import { ObsMetricsItemService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsItemService";

export class ObsMetricsItemController {
  private service = new ObsMetricsItemService();
