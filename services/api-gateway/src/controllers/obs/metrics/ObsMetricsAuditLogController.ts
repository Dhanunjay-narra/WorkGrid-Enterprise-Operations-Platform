import { ObsMetricsAuditLogService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsAuditLogService";

export class ObsMetricsAuditLogController {
  private service = new ObsMetricsAuditLogService();
