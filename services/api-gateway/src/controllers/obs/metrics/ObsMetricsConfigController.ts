import { ObsMetricsConfigService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsConfigService";

export class ObsMetricsConfigController {
  private service = new ObsMetricsConfigService();
