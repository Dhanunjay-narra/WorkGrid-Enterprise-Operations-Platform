import { ObsMetricsSessionService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsSessionService";

export class ObsMetricsSessionController {
  private service = new ObsMetricsSessionService();
