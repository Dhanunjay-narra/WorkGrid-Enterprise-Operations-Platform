import { ObsMetricsEntryService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsEntryService";

export class ObsMetricsEntryController {
  private service = new ObsMetricsEntryService();
