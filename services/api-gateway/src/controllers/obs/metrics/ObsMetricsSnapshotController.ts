import { ObsMetricsSnapshotService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsSnapshotService";

export class ObsMetricsSnapshotController {
  private service = new ObsMetricsSnapshotService();
