import { ObsMetricsThresholdService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsThresholdService";

export class ObsMetricsThresholdController {
  private service = new ObsMetricsThresholdService();
