import { ObsMetricsStateService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsStateService";

export class ObsMetricsStateController {
  private service = new ObsMetricsStateService();
