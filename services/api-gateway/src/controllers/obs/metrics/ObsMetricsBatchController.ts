import { ObsMetricsBatchService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsBatchService";

export class ObsMetricsBatchController {
  private service = new ObsMetricsBatchService();
