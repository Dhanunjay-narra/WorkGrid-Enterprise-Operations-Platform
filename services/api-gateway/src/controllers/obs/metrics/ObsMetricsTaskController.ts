import { ObsMetricsTaskService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsTaskService";

export class ObsMetricsTaskController {
  private service = new ObsMetricsTaskService();
