import { ObsMetricsMappingService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsMappingService";

export class ObsMetricsMappingController {
  private service = new ObsMetricsMappingService();
