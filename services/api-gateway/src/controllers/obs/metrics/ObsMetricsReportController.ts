import { ObsMetricsReportService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsReportService";

export class ObsMetricsReportController {
  private service = new ObsMetricsReportService();
