import { ObsMetricsPolicyService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsPolicyService";

export class ObsMetricsPolicyController {
  private service = new ObsMetricsPolicyService();
