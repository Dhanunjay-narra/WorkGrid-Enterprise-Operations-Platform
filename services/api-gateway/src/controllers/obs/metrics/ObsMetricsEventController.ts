import { ObsMetricsEventService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsEventService";

export class ObsMetricsEventController {
  private service = new ObsMetricsEventService();
