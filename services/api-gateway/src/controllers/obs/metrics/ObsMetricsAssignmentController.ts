import { ObsMetricsAssignmentService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsAssignmentService";

export class ObsMetricsAssignmentController {
  private service = new ObsMetricsAssignmentService();
