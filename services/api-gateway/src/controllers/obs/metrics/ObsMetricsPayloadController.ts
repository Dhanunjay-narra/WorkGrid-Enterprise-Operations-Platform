import { ObsMetricsPayloadService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsPayloadService";

export class ObsMetricsPayloadController {
  private service = new ObsMetricsPayloadService();
