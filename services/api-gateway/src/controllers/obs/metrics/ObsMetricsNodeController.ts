import { ObsMetricsNodeService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsNodeService";

export class ObsMetricsNodeController {
  private service = new ObsMetricsNodeService();
