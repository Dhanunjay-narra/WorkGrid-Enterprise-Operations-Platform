import { ObsMetricsSummaryService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsSummaryService";

export class ObsMetricsSummaryController {
  private service = new ObsMetricsSummaryService();
