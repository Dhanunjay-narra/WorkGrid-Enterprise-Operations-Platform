import { ObsMetricsRecordService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsRecordService";

export class ObsMetricsRecordController {
  private service = new ObsMetricsRecordService();
