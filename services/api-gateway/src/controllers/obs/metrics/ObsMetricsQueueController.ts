import { ObsMetricsQueueService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsQueueService";

export class ObsMetricsQueueController {
  private service = new ObsMetricsQueueService();
