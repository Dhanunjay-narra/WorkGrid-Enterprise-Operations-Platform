import { ObsMetricsRuleService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsRuleService";

export class ObsMetricsRuleController {
  private service = new ObsMetricsRuleService();
