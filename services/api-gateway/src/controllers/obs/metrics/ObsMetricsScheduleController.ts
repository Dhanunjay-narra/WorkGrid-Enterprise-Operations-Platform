import { ObsMetricsScheduleService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsScheduleService";

export class ObsMetricsScheduleController {
  private service = new ObsMetricsScheduleService();
