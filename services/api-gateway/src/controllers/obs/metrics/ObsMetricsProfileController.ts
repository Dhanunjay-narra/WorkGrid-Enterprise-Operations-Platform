import { ObsMetricsProfileService } from "../../../../core-engine/src/obs/metrics/services/ObsMetricsProfileService";

export class ObsMetricsProfileController {
  private service = new ObsMetricsProfileService();
