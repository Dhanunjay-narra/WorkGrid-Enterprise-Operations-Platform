import { ObsLoggingAuditLogService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingAuditLogService";

export class ObsLoggingAuditLogController {
  private service = new ObsLoggingAuditLogService();
