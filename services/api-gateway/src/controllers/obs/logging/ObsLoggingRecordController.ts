import { ObsLoggingRecordService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingRecordService";

export class ObsLoggingRecordController {
  private service = new ObsLoggingRecordService();
