import { ObsLoggingThresholdService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingThresholdService";

export class ObsLoggingThresholdController {
  private service = new ObsLoggingThresholdService();
