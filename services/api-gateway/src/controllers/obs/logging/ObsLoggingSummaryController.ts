import { ObsLoggingSummaryService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingSummaryService";

export class ObsLoggingSummaryController {
  private service = new ObsLoggingSummaryService();
