import { ObsLoggingPayloadService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingPayloadService";

export class ObsLoggingPayloadController {
  private service = new ObsLoggingPayloadService();
