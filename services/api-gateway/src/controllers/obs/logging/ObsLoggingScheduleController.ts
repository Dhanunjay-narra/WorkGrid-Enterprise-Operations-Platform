import { ObsLoggingScheduleService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingScheduleService";

export class ObsLoggingScheduleController {
  private service = new ObsLoggingScheduleService();
