import { ObsLoggingReportService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingReportService";

export class ObsLoggingReportController {
  private service = new ObsLoggingReportService();
