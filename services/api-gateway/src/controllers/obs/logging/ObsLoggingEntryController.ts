import { ObsLoggingEntryService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingEntryService";

export class ObsLoggingEntryController {
  private service = new ObsLoggingEntryService();
