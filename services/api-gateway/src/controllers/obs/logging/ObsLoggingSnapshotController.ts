import { ObsLoggingSnapshotService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingSnapshotService";

export class ObsLoggingSnapshotController {
  private service = new ObsLoggingSnapshotService();
