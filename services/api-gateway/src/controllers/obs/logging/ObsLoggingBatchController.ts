import { ObsLoggingBatchService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingBatchService";

export class ObsLoggingBatchController {
  private service = new ObsLoggingBatchService();
