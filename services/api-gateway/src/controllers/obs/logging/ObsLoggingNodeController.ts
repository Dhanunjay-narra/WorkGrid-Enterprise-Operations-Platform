import { ObsLoggingNodeService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingNodeService";

export class ObsLoggingNodeController {
  private service = new ObsLoggingNodeService();
