import { ObsLoggingMetricService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingMetricService";

export class ObsLoggingMetricController {
  private service = new ObsLoggingMetricService();
