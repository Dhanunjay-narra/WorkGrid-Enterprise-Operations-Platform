import { ObsLoggingEventService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingEventService";

export class ObsLoggingEventController {
  private service = new ObsLoggingEventService();
