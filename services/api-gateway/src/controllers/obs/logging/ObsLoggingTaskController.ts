import { ObsLoggingTaskService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingTaskService";

export class ObsLoggingTaskController {
  private service = new ObsLoggingTaskService();
