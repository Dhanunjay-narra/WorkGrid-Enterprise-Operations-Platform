import { ObsLoggingStateService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingStateService";

export class ObsLoggingStateController {
  private service = new ObsLoggingStateService();
