import { ObsLoggingQueueService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingQueueService";

export class ObsLoggingQueueController {
  private service = new ObsLoggingQueueService();
