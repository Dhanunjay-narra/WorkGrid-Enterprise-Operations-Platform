import { ObsLoggingSessionService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingSessionService";

export class ObsLoggingSessionController {
  private service = new ObsLoggingSessionService();
