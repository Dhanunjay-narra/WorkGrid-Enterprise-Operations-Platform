import { ObsLoggingPolicyService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingPolicyService";

export class ObsLoggingPolicyController {
  private service = new ObsLoggingPolicyService();
