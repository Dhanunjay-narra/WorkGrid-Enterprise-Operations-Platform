import { ObsLoggingProfileService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingProfileService";

export class ObsLoggingProfileController {
  private service = new ObsLoggingProfileService();
