import { ObsLoggingItemService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingItemService";

export class ObsLoggingItemController {
  private service = new ObsLoggingItemService();
