import { ObsLoggingConfigService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingConfigService";

export class ObsLoggingConfigController {
  private service = new ObsLoggingConfigService();
