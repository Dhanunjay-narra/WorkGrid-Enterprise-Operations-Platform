import { ObsLoggingMappingService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingMappingService";

export class ObsLoggingMappingController {
  private service = new ObsLoggingMappingService();
