import { ObsLoggingRuleService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingRuleService";

export class ObsLoggingRuleController {
  private service = new ObsLoggingRuleService();
