import { ObsLoggingAssignmentService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingAssignmentService";

export class ObsLoggingAssignmentController {
  private service = new ObsLoggingAssignmentService();
