import { ObsLoggingTransactionService } from "../../../../core-engine/src/obs/logging/services/ObsLoggingTransactionService";

export class ObsLoggingTransactionController {
  private service = new ObsLoggingTransactionService();
