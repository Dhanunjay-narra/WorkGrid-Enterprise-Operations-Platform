import { ObsTracingAssignmentService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingAssignmentService";

export class ObsTracingAssignmentController {
  private service = new ObsTracingAssignmentService();
