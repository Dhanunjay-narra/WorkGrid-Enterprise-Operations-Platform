import { ObsTracingBatchService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingBatchService";

export class ObsTracingBatchController {
  private service = new ObsTracingBatchService();
