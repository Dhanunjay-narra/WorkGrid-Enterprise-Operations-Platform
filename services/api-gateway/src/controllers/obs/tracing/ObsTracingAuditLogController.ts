import { ObsTracingAuditLogService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingAuditLogService";

export class ObsTracingAuditLogController {
  private service = new ObsTracingAuditLogService();
