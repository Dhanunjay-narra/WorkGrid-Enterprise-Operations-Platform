import { ObsTracingEventService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingEventService";

export class ObsTracingEventController {
  private service = new ObsTracingEventService();
