import { ObsTracingEntryService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingEntryService";

export class ObsTracingEntryController {
  private service = new ObsTracingEntryService();
