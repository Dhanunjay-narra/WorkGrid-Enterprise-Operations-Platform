import { ObsTracingTaskService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingTaskService";

export class ObsTracingTaskController {
  private service = new ObsTracingTaskService();
