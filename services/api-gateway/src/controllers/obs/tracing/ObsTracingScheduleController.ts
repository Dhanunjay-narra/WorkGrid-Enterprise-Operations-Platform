import { ObsTracingScheduleService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingScheduleService";

export class ObsTracingScheduleController {
  private service = new ObsTracingScheduleService();
