import { ObsTracingSessionService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingSessionService";

export class ObsTracingSessionController {
  private service = new ObsTracingSessionService();
