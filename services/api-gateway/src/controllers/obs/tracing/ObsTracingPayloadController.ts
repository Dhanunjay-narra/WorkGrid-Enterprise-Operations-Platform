import { ObsTracingPayloadService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingPayloadService";

export class ObsTracingPayloadController {
  private service = new ObsTracingPayloadService();
