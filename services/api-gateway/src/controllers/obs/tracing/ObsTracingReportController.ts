import { ObsTracingReportService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingReportService";

export class ObsTracingReportController {
  private service = new ObsTracingReportService();
