import { ObsTracingStateService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingStateService";

export class ObsTracingStateController {
  private service = new ObsTracingStateService();
