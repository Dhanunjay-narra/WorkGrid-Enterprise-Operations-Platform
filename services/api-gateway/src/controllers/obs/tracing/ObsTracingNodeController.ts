import { ObsTracingNodeService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingNodeService";

export class ObsTracingNodeController {
  private service = new ObsTracingNodeService();
