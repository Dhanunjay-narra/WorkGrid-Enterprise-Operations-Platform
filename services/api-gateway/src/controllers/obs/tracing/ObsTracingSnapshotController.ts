import { ObsTracingSnapshotService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingSnapshotService";

export class ObsTracingSnapshotController {
  private service = new ObsTracingSnapshotService();
