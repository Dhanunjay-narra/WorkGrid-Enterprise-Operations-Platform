import { ObsTracingItemService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingItemService";

export class ObsTracingItemController {
  private service = new ObsTracingItemService();
