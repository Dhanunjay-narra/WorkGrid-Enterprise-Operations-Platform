import { ObsTracingMappingService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingMappingService";

export class ObsTracingMappingController {
  private service = new ObsTracingMappingService();
