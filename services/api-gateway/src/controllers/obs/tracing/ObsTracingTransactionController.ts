import { ObsTracingTransactionService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingTransactionService";

export class ObsTracingTransactionController {
  private service = new ObsTracingTransactionService();
