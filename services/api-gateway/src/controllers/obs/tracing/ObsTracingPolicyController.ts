import { ObsTracingPolicyService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingPolicyService";

export class ObsTracingPolicyController {
  private service = new ObsTracingPolicyService();
