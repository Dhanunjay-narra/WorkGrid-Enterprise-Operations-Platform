import { ObsTracingSummaryService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingSummaryService";

export class ObsTracingSummaryController {
  private service = new ObsTracingSummaryService();
