import { ObsTracingRuleService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingRuleService";

export class ObsTracingRuleController {
  private service = new ObsTracingRuleService();
