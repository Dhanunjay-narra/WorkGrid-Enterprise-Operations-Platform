import { ObsTracingQueueService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingQueueService";

export class ObsTracingQueueController {
  private service = new ObsTracingQueueService();
