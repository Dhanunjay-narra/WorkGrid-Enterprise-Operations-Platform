import { ObsTracingRecordService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingRecordService";

export class ObsTracingRecordController {
  private service = new ObsTracingRecordService();
