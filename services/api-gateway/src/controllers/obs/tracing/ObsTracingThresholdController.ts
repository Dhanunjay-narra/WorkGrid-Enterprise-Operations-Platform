import { ObsTracingThresholdService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingThresholdService";

export class ObsTracingThresholdController {
  private service = new ObsTracingThresholdService();
