import { ObsTracingMetricService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingMetricService";

export class ObsTracingMetricController {
  private service = new ObsTracingMetricService();
