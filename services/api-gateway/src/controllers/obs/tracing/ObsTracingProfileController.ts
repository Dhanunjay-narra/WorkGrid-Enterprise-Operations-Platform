import { ObsTracingProfileService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingProfileService";

export class ObsTracingProfileController {
  private service = new ObsTracingProfileService();
