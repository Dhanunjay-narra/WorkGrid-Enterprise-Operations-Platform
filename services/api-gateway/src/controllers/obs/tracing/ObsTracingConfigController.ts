import { ObsTracingConfigService } from "../../../../core-engine/src/obs/tracing/services/ObsTracingConfigService";

export class ObsTracingConfigController {
  private service = new ObsTracingConfigService();
