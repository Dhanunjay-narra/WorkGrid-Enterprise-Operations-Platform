import { ObsProfilingEventService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingEventService";

export class ObsProfilingEventController {
  private service = new ObsProfilingEventService();
