import { ObsProfilingQueueService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingQueueService";

export class ObsProfilingQueueController {
  private service = new ObsProfilingQueueService();
