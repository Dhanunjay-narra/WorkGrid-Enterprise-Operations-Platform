import { ObsProfilingBatchService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingBatchService";

export class ObsProfilingBatchController {
  private service = new ObsProfilingBatchService();
