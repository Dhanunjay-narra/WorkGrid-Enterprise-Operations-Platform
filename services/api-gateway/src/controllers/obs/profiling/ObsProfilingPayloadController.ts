import { ObsProfilingPayloadService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingPayloadService";

export class ObsProfilingPayloadController {
  private service = new ObsProfilingPayloadService();
