import { ObsProfilingConfigService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingConfigService";

export class ObsProfilingConfigController {
  private service = new ObsProfilingConfigService();
