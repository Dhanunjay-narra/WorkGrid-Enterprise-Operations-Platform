import { ObsProfilingRecordService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingRecordService";

export class ObsProfilingRecordController {
  private service = new ObsProfilingRecordService();
