import { ObsProfilingSummaryService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingSummaryService";

export class ObsProfilingSummaryController {
  private service = new ObsProfilingSummaryService();
