import { ObsProfilingProfileService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingProfileService";

export class ObsProfilingProfileController {
  private service = new ObsProfilingProfileService();
