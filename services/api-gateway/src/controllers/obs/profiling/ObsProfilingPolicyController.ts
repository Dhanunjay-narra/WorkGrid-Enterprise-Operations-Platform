import { ObsProfilingPolicyService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingPolicyService";

export class ObsProfilingPolicyController {
  private service = new ObsProfilingPolicyService();
