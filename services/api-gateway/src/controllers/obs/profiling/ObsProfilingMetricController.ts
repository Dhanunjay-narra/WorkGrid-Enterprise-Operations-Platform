import { ObsProfilingMetricService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingMetricService";

export class ObsProfilingMetricController {
  private service = new ObsProfilingMetricService();
