import { ObsProfilingSnapshotService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingSnapshotService";

export class ObsProfilingSnapshotController {
  private service = new ObsProfilingSnapshotService();
