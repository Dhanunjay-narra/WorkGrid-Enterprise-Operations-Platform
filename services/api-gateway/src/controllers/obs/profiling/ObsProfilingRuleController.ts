import { ObsProfilingRuleService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingRuleService";

export class ObsProfilingRuleController {
  private service = new ObsProfilingRuleService();
