import { ObsProfilingSessionService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingSessionService";

export class ObsProfilingSessionController {
  private service = new ObsProfilingSessionService();
