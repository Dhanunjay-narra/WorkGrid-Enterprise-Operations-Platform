import { ObsProfilingReportService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingReportService";

export class ObsProfilingReportController {
  private service = new ObsProfilingReportService();
