import { ObsProfilingScheduleService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingScheduleService";

export class ObsProfilingScheduleController {
  private service = new ObsProfilingScheduleService();
