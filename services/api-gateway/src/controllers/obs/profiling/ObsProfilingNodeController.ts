import { ObsProfilingNodeService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingNodeService";

export class ObsProfilingNodeController {
  private service = new ObsProfilingNodeService();
