import { ObsProfilingMappingService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingMappingService";

export class ObsProfilingMappingController {
  private service = new ObsProfilingMappingService();
