import { ObsProfilingStateService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingStateService";

export class ObsProfilingStateController {
  private service = new ObsProfilingStateService();
