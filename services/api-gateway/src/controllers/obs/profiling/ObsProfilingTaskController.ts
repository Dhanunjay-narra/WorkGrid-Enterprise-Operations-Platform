import { ObsProfilingTaskService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingTaskService";

export class ObsProfilingTaskController {
  private service = new ObsProfilingTaskService();
