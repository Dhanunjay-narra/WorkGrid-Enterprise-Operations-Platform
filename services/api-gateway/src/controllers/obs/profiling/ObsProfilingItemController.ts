import { ObsProfilingItemService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingItemService";

export class ObsProfilingItemController {
  private service = new ObsProfilingItemService();
