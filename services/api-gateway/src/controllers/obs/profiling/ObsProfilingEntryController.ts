import { ObsProfilingEntryService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingEntryService";

export class ObsProfilingEntryController {
  private service = new ObsProfilingEntryService();
