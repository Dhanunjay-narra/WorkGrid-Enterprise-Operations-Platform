import { ObsProfilingAuditLogService } from "../../../../core-engine/src/obs/profiling/services/ObsProfilingAuditLogService";

export class ObsProfilingAuditLogController {
  private service = new ObsProfilingAuditLogService();
