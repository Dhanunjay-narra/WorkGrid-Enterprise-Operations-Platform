import { ObsProbesItemService } from "../../../../core-engine/src/obs/probes/services/ObsProbesItemService";

export class ObsProbesItemController {
  private service = new ObsProbesItemService();
