import { ObsProbesAuditLogService } from "../../../../core-engine/src/obs/probes/services/ObsProbesAuditLogService";

export class ObsProbesAuditLogController {
  private service = new ObsProbesAuditLogService();
