import { ObsProbesEntryService } from "../../../../core-engine/src/obs/probes/services/ObsProbesEntryService";

export class ObsProbesEntryController {
  private service = new ObsProbesEntryService();
