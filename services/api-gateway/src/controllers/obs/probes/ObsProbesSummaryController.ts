import { ObsProbesSummaryService } from "../../../../core-engine/src/obs/probes/services/ObsProbesSummaryService";

export class ObsProbesSummaryController {
  private service = new ObsProbesSummaryService();
