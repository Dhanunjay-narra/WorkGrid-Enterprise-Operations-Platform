import { ObsProbesMetricService } from "../../../../core-engine/src/obs/probes/services/ObsProbesMetricService";

export class ObsProbesMetricController {
  private service = new ObsProbesMetricService();
