import { ObsProbesEventService } from "../../../../core-engine/src/obs/probes/services/ObsProbesEventService";

export class ObsProbesEventController {
  private service = new ObsProbesEventService();
