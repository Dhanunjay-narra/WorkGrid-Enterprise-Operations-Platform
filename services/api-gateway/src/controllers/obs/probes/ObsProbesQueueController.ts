import { ObsProbesQueueService } from "../../../../core-engine/src/obs/probes/services/ObsProbesQueueService";

export class ObsProbesQueueController {
  private service = new ObsProbesQueueService();
