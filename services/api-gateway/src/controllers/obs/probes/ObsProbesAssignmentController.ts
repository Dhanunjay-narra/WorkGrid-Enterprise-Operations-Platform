import { ObsProbesAssignmentService } from "../../../../core-engine/src/obs/probes/services/ObsProbesAssignmentService";

export class ObsProbesAssignmentController {
  private service = new ObsProbesAssignmentService();
