import { ObsProbesThresholdService } from "../../../../core-engine/src/obs/probes/services/ObsProbesThresholdService";

export class ObsProbesThresholdController {
  private service = new ObsProbesThresholdService();
