import { ObsProbesSessionService } from "../../../../core-engine/src/obs/probes/services/ObsProbesSessionService";

export class ObsProbesSessionController {
  private service = new ObsProbesSessionService();
