import { ObsProbesScheduleService } from "../../../../core-engine/src/obs/probes/services/ObsProbesScheduleService";

export class ObsProbesScheduleController {
  private service = new ObsProbesScheduleService();
