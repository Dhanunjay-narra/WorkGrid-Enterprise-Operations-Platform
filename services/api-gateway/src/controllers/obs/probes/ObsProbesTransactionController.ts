import { ObsProbesTransactionService } from "../../../../core-engine/src/obs/probes/services/ObsProbesTransactionService";

export class ObsProbesTransactionController {
  private service = new ObsProbesTransactionService();
