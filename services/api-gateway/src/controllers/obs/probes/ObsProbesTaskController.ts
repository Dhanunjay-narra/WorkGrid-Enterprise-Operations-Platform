import { ObsProbesTaskService } from "../../../../core-engine/src/obs/probes/services/ObsProbesTaskService";

export class ObsProbesTaskController {
  private service = new ObsProbesTaskService();
