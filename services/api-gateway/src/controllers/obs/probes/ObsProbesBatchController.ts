import { ObsProbesBatchService } from "../../../../core-engine/src/obs/probes/services/ObsProbesBatchService";

export class ObsProbesBatchController {
  private service = new ObsProbesBatchService();
