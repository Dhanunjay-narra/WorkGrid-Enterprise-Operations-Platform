import { ObsProbesStateService } from "../../../../core-engine/src/obs/probes/services/ObsProbesStateService";

export class ObsProbesStateController {
  private service = new ObsProbesStateService();
