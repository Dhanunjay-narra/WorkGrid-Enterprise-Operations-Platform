import { ObsProbesRuleService } from "../../../../core-engine/src/obs/probes/services/ObsProbesRuleService";

export class ObsProbesRuleController {
  private service = new ObsProbesRuleService();
