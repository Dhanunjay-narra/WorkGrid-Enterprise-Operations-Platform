import { ObsProbesPayloadService } from "../../../../core-engine/src/obs/probes/services/ObsProbesPayloadService";

export class ObsProbesPayloadController {
  private service = new ObsProbesPayloadService();
