import { ObsProbesPolicyService } from "../../../../core-engine/src/obs/probes/services/ObsProbesPolicyService";

export class ObsProbesPolicyController {
  private service = new ObsProbesPolicyService();
