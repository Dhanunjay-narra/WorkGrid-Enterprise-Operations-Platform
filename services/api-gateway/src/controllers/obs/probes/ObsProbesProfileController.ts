import { ObsProbesProfileService } from "../../../../core-engine/src/obs/probes/services/ObsProbesProfileService";

export class ObsProbesProfileController {
  private service = new ObsProbesProfileService();
