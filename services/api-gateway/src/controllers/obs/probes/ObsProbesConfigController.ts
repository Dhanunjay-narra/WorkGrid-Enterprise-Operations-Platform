import { ObsProbesConfigService } from "../../../../core-engine/src/obs/probes/services/ObsProbesConfigService";

export class ObsProbesConfigController {
  private service = new ObsProbesConfigService();
