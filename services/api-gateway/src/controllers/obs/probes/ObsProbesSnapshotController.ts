import { ObsProbesSnapshotService } from "../../../../core-engine/src/obs/probes/services/ObsProbesSnapshotService";

export class ObsProbesSnapshotController {
  private service = new ObsProbesSnapshotService();
