import { ObsProbesRecordService } from "../../../../core-engine/src/obs/probes/services/ObsProbesRecordService";

export class ObsProbesRecordController {
  private service = new ObsProbesRecordService();
