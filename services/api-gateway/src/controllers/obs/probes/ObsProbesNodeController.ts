import { ObsProbesNodeService } from "../../../../core-engine/src/obs/probes/services/ObsProbesNodeService";

export class ObsProbesNodeController {
  private service = new ObsProbesNodeService();
