import { ObsProbesMappingService } from "../../../../core-engine/src/obs/probes/services/ObsProbesMappingService";

export class ObsProbesMappingController {
  private service = new ObsProbesMappingService();
