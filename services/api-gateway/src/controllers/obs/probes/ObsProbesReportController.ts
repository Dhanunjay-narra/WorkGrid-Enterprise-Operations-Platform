import { ObsProbesReportService } from "../../../../core-engine/src/obs/probes/services/ObsProbesReportService";

export class ObsProbesReportController {
  private service = new ObsProbesReportService();
